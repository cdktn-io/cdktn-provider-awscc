...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/kafkaconnect_connector
...
export class DataAwsccKafkaconnectConnector extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccKafkaconnectConnector that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/kafkaconnect_connector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/kafkaconnect_connector awscc_kafkaconnect_connector} Data Source
  *
  * @param scope The scope in which to define this construct
