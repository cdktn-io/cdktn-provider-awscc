...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/wellarchitected_workload
...
export class DataAwsccWellarchitectedWorkload extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccWellarchitectedWorkload that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/wellarchitected_workload#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/wellarchitected_workload awscc_wellarchitected_workload} Data Source
  *
  * @param scope The scope in which to define this construct
