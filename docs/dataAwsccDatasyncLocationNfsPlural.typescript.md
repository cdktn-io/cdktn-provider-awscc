...
```typescript
import { dataAwsccDatasyncLocationNfsPlural } from '@cdktn/provider-awscc'

new dataAwsccDatasyncLocationNfsPlural.DataAwsccDatasyncLocationNfsPlural(scope: Construct, id: string, config?: DataAwsccDatasyncLocationNfsPluralConfig)
```
...
dataAwsccDatasyncLocationNfsPlural.DataAwsccDatasyncLocationNfsPlural.isConstruct(x: any)
```
...
dataAwsccDatasyncLocationNfsPlural.DataAwsccDatasyncLocationNfsPlural.isTerraformElement(x: any)
```
...
dataAwsccDatasyncLocationNfsPlural.DataAwsccDatasyncLocationNfsPlural.isTerraformDataSource(x: any)
```
...
dataAwsccDatasyncLocationNfsPlural.DataAwsccDatasyncLocationNfsPlural.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationNfsPlural.DataAwsccDatasyncLocationNfsPlural.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationNfsPlural.DataAwsccDatasyncLocationNfsPlural.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationNfsPlural.DataAwsccDatasyncLocationNfsPlural.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationNfsPlural.DataAwsccDatasyncLocationNfsPlural.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationNfsPlural.DataAwsccDatasyncLocationNfsPlural.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccDatasyncLocationNfsPluralConfig: dataAwsccDatasyncLocationNfsPlural.DataAwsccDatasyncLocationNfsPluralConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationNfsPlural.DataAwsccDatasyncLocationNfsPluralConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationNfsPlural.DataAwsccDatasyncLocationNfsPluralConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationNfsPlural.DataAwsccDatasyncLocationNfsPluralConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationNfsPlural.DataAwsccDatasyncLocationNfsPluralConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
