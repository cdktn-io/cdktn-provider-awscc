...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/docdb_db_subnet_group
...
export interface DocdbDbSubnetGroupConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly tags?: DocdbDbSubnetGroupTags[] | cdktn.IResolvable;
}
export interface DocdbDbSubnetGroupTags {
  /**
...
export function docdbDbSubnetGroupTagsToTerraform(struct?: DocdbDbSubnetGroupTags | cdktn.IResolvable): any {
...
export function docdbDbSubnetGroupTagsToHclTerraform(struct?: DocdbDbSubnetGroupTags | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DocdbDbSubnetGroupTagsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DocdbDbSubnetGroupTags | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DocdbDbSubnetGroupTags | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class DocdbDbSubnetGroupTagsList extends cdktn.ComplexList {
  public internalValue? : DocdbDbSubnetGroupTags[] | cdktn.IResolvable
  ...
  */
  public get(index: number): DocdbDbSubnetGroupTagsOutputReference {
    return new DocdbDbSubnetGroupTagsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
*/
export class DocdbDbSubnetGroup extends cdktn.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "awscc_docdb_db_subnet_group";
  ...
  * @param importToId The construct id used in the generated config for the DocdbDbSubnetGroup to import
  * @param importFromId The id of the existing DocdbDbSubnetGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/docdb_db_subnet_group#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DocdbDbSubnetGroup to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "awscc_docdb_db_subnet_group", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/docdb_db_subnet_group awscc_docdb_db_subnet_group} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DocdbDbSubnetGroupConfig
  */
  public constructor(scope: Construct, id: string, config: DocdbDbSubnetGroupConfig) {
    super(scope, id, {
      terraformResourceType: 'awscc_docdb_db_subnet_group',
  ...
  private _tags = new DocdbDbSubnetGroupTagsList(this, "tags", false);
  public get tags() {
    return this._tags;
  }
  public putTags(value: DocdbDbSubnetGroupTags[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      tags: cdktn.listMapper(docdbDbSubnetGroupTagsToTerraform, false)(this._tags.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      tags: {
        value: cdktn.listMapperHcl(docdbDbSubnetGroupTagsToHclTerraform, false)(this._tags.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DocdbDbSubnetGroupTagsList",
      },
    };
