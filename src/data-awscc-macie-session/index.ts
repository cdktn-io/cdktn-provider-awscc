...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/macie_session
...
export class DataAwsccMacieSession extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccMacieSession that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/macie_session#import import section} in the documentation of this resource for the id to use
