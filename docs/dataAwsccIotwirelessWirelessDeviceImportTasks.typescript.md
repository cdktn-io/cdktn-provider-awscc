...
```typescript
import { dataAwsccIotwirelessWirelessDeviceImportTasks } from '@cdktn/provider-awscc'

new dataAwsccIotwirelessWirelessDeviceImportTasks.DataAwsccIotwirelessWirelessDeviceImportTasks(scope: Construct, id: string, config?: DataAwsccIotwirelessWirelessDeviceImportTasksConfig)
```
...
dataAwsccIotwirelessWirelessDeviceImportTasks.DataAwsccIotwirelessWirelessDeviceImportTasks.isConstruct(x: any)
```
...
dataAwsccIotwirelessWirelessDeviceImportTasks.DataAwsccIotwirelessWirelessDeviceImportTasks.isTerraformElement(x: any)
```
...
dataAwsccIotwirelessWirelessDeviceImportTasks.DataAwsccIotwirelessWirelessDeviceImportTasks.isTerraformDataSource(x: any)
```
...
dataAwsccIotwirelessWirelessDeviceImportTasks.DataAwsccIotwirelessWirelessDeviceImportTasks.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotwirelessWirelessDeviceImportTasks.DataAwsccIotwirelessWirelessDeviceImportTasks.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotwirelessWirelessDeviceImportTasks.DataAwsccIotwirelessWirelessDeviceImportTasks.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotwirelessWirelessDeviceImportTasks.DataAwsccIotwirelessWirelessDeviceImportTasks.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotwirelessWirelessDeviceImportTasks.DataAwsccIotwirelessWirelessDeviceImportTasks.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotwirelessWirelessDeviceImportTasks.DataAwsccIotwirelessWirelessDeviceImportTasks.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccIotwirelessWirelessDeviceImportTasksConfig: dataAwsccIotwirelessWirelessDeviceImportTasks.DataAwsccIotwirelessWirelessDeviceImportTasksConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotwirelessWirelessDeviceImportTasks.DataAwsccIotwirelessWirelessDeviceImportTasksConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotwirelessWirelessDeviceImportTasks.DataAwsccIotwirelessWirelessDeviceImportTasksConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotwirelessWirelessDeviceImportTasks.DataAwsccIotwirelessWirelessDeviceImportTasksConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotwirelessWirelessDeviceImportTasks.DataAwsccIotwirelessWirelessDeviceImportTasksConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
