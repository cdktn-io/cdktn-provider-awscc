...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/opsworkscm_server
...
export class OpsworkscmServer extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OpsworkscmServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/opsworkscm_server#import import section} in the documentation of this resource for the id to use
