...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/route53_hosted_zone
...
export class Route53HostedZone extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53HostedZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/route53_hosted_zone#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/route53_hosted_zone awscc_route53_hosted_zone} Resource
  *
  * @param scope The scope in which to define this construct
