...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/location_maps
...
export class DataAwsccLocationMaps extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccLocationMaps that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/location_maps#import import section} in the documentation of this resource for the id to use
