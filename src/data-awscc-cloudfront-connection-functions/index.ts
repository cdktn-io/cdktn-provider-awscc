...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/cloudfront_connection_functions
...
export class DataAwsccCloudfrontConnectionFunctions extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCloudfrontConnectionFunctions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/cloudfront_connection_functions#import import section} in the documentation of this resource for the id to use
