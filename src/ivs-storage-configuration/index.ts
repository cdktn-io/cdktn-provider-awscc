...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ivs_storage_configuration
...
export class IvsStorageConfiguration extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IvsStorageConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ivs_storage_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ivs_storage_configuration awscc_ivs_storage_configuration} Resource
  *
  * @param scope The scope in which to define this construct
