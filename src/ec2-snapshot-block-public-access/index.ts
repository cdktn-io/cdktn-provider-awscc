...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/ec2_snapshot_block_public_access
...
export class Ec2SnapshotBlockPublicAccess extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2SnapshotBlockPublicAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/ec2_snapshot_block_public_access#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/ec2_snapshot_block_public_access awscc_ec2_snapshot_block_public_access} Resource
  *
  * @param scope The scope in which to define this construct
