...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/apigateway_domain_name
...
export class ApigatewayDomainName extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApigatewayDomainName that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/apigateway_domain_name#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/apigateway_domain_name awscc_apigateway_domain_name} Resource
  *
  * @param scope The scope in which to define this construct
