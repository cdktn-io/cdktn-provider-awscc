...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccuxcaccountcustomization"

dataawsccuxcaccountcustomization.NewDataAwsccUxcAccountCustomization(scope Construct, id *string, config DataAwsccUxcAccountCustomizationConfig) DataAwsccUxcAccountCustomization
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccUxcAccountCustomization.DataAwsccUxcAccountCustomization.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
dataawsccuxcaccountcustomization.DataAwsccUxcAccountCustomization_IsConstruct(x interface{}) *bool
```
...
dataawsccuxcaccountcustomization.DataAwsccUxcAccountCustomization_IsTerraformElement(x interface{}) *bool
```
...
dataawsccuxcaccountcustomization.DataAwsccUxcAccountCustomization_IsTerraformDataSource(x interface{}) *bool
```
...
dataawsccuxcaccountcustomization.DataAwsccUxcAccountCustomization_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccUxcAccountCustomization.DataAwsccUxcAccountCustomization.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccUxcAccountCustomization.DataAwsccUxcAccountCustomization.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccUxcAccountCustomization.DataAwsccUxcAccountCustomization.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccUxcAccountCustomization.DataAwsccUxcAccountCustomization.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccUxcAccountCustomization.DataAwsccUxcAccountCustomization.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccUxcAccountCustomization.DataAwsccUxcAccountCustomization.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccUxcAccountCustomization.DataAwsccUxcAccountCustomization.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccUxcAccountCustomization.DataAwsccUxcAccountCustomization.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
...
&dataawsccuxcaccountcustomization.DataAwsccUxcAccountCustomizationConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccUxcAccountCustomization.DataAwsccUxcAccountCustomizationConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccUxcAccountCustomization.DataAwsccUxcAccountCustomizationConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccUxcAccountCustomization.DataAwsccUxcAccountCustomizationConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccUxcAccountCustomization.DataAwsccUxcAccountCustomizationConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccUxcAccountCustomization.DataAwsccUxcAccountCustomizationConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccUxcAccountCustomization.DataAwsccUxcAccountCustomizationConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccUxcAccountCustomization.DataAwsccUxcAccountCustomizationConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
