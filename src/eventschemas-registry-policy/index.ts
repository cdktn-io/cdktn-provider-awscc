...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/eventschemas_registry_policy
...
export class EventschemasRegistryPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EventschemasRegistryPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/eventschemas_registry_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/eventschemas_registry_policy awscc_eventschemas_registry_policy} Resource
  *
  * @param scope The scope in which to define this construct
