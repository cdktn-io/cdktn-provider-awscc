...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/quicksight_dlp_setting
...
export class QuicksightDlpSetting extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing QuicksightDlpSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/quicksight_dlp_setting#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/quicksight_dlp_setting awscc_quicksight_dlp_setting} Resource
  *
  * @param scope The scope in which to define this construct
