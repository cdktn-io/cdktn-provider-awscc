...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/cloudtrail_event_data_stores
...
export class DataAwsccCloudtrailEventDataStores extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCloudtrailEventDataStores that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/cloudtrail_event_data_stores#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/cloudtrail_event_data_stores awscc_cloudtrail_event_data_stores} Data Source
  *
  * @param scope The scope in which to define this construct
