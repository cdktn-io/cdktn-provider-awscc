...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ram_permission
...
export class RamPermission extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RamPermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ram_permission#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ram_permission awscc_ram_permission} Resource
  *
  * @param scope The scope in which to define this construct
