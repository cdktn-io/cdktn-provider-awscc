...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/sagemaker_actions
...
export class DataAwsccSagemakerActions extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccSagemakerActions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/sagemaker_actions#import import section} in the documentation of this resource for the id to use
