...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/directconnect_connections
...
export class DataAwsccDirectconnectConnections extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDirectconnectConnections that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/directconnect_connections#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/directconnect_connections awscc_directconnect_connections} Data Source
  *
  * @param scope The scope in which to define this construct
