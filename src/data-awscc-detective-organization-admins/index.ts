...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/detective_organization_admins
...
export class DataAwsccDetectiveOrganizationAdmins extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDetectiveOrganizationAdmins that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/detective_organization_admins#import import section} in the documentation of this resource for the id to use
