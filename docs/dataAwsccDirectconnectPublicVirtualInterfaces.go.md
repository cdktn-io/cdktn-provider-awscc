...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccdirectconnectpublicvirtualinterfaces"

dataawsccdirectconnectpublicvirtualinterfaces.NewDataAwsccDirectconnectPublicVirtualInterfaces(scope Construct, id *string, config DataAwsccDirectconnectPublicVirtualInterfacesConfig) DataAwsccDirectconnectPublicVirtualInterfaces
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfaces.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
dataawsccdirectconnectpublicvirtualinterfaces.DataAwsccDirectconnectPublicVirtualInterfaces_IsConstruct(x interface{}) *bool
```
...
dataawsccdirectconnectpublicvirtualinterfaces.DataAwsccDirectconnectPublicVirtualInterfaces_IsTerraformElement(x interface{}) *bool
```
...
dataawsccdirectconnectpublicvirtualinterfaces.DataAwsccDirectconnectPublicVirtualInterfaces_IsTerraformDataSource(x interface{}) *bool
```
...
dataawsccdirectconnectpublicvirtualinterfaces.DataAwsccDirectconnectPublicVirtualInterfaces_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfaces.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfaces.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfaces.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfaces.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfaces.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfaces.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfaces.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfaces.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfacesConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfacesConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfacesConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfacesConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfacesConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfacesConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfacesConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
