...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/controltower_enabled_control
...
export interface ControltowerEnabledControlConfig extends cdktn.TerraformMetaArguments {
  ...
  * Arn of the control.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/controltower_enabled_control#control_identifier ControltowerEnabledControl#control_identifier}
  */
  readonly controlIdentifier: string;
  /**
  * Arn for Organizational unit to which the control needs to be applied
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/controltower_enabled_control#target_identifier ControltowerEnabledControl#target_identifier}
  */
  readonly targetIdentifier: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/controltower_enabled_control awscc_controltower_enabled_control}
*/
export class ControltowerEnabledControl extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ControltowerEnabledControl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/controltower_enabled_control#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/controltower_enabled_control awscc_controltower_enabled_control} Resource
  *
  * @param scope The scope in which to define this construct
