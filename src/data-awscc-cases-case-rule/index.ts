...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/cases_case_rule
...
export class DataAwsccCasesCaseRule extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCasesCaseRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/cases_case_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/cases_case_rule awscc_cases_case_rule} Data Source
  *
  * @param scope The scope in which to define this construct
