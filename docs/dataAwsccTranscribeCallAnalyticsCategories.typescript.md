...
```typescript
import { dataAwsccTranscribeCallAnalyticsCategories } from '@cdktn/provider-awscc'

new dataAwsccTranscribeCallAnalyticsCategories.DataAwsccTranscribeCallAnalyticsCategories(scope: Construct, id: string, config?: DataAwsccTranscribeCallAnalyticsCategoriesConfig)
```
...
dataAwsccTranscribeCallAnalyticsCategories.DataAwsccTranscribeCallAnalyticsCategories.isConstruct(x: any)
```
...
dataAwsccTranscribeCallAnalyticsCategories.DataAwsccTranscribeCallAnalyticsCategories.isTerraformElement(x: any)
```
...
dataAwsccTranscribeCallAnalyticsCategories.DataAwsccTranscribeCallAnalyticsCategories.isTerraformDataSource(x: any)
```
...
dataAwsccTranscribeCallAnalyticsCategories.DataAwsccTranscribeCallAnalyticsCategories.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccTranscribeCallAnalyticsCategories.DataAwsccTranscribeCallAnalyticsCategories.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccTranscribeCallAnalyticsCategories.DataAwsccTranscribeCallAnalyticsCategories.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccTranscribeCallAnalyticsCategories.DataAwsccTranscribeCallAnalyticsCategories.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccTranscribeCallAnalyticsCategories.DataAwsccTranscribeCallAnalyticsCategories.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccTranscribeCallAnalyticsCategories.DataAwsccTranscribeCallAnalyticsCategories.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccTranscribeCallAnalyticsCategoriesConfig: dataAwsccTranscribeCallAnalyticsCategories.DataAwsccTranscribeCallAnalyticsCategoriesConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccTranscribeCallAnalyticsCategories.DataAwsccTranscribeCallAnalyticsCategoriesConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccTranscribeCallAnalyticsCategories.DataAwsccTranscribeCallAnalyticsCategoriesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccTranscribeCallAnalyticsCategories.DataAwsccTranscribeCallAnalyticsCategoriesConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccTranscribeCallAnalyticsCategories.DataAwsccTranscribeCallAnalyticsCategoriesConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
