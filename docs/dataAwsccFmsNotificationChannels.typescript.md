...
```typescript
import { dataAwsccFmsNotificationChannels } from '@cdktn/provider-awscc'

new dataAwsccFmsNotificationChannels.DataAwsccFmsNotificationChannels(scope: Construct, id: string, config?: DataAwsccFmsNotificationChannelsConfig)
```
...
dataAwsccFmsNotificationChannels.DataAwsccFmsNotificationChannels.isConstruct(x: any)
```
...
dataAwsccFmsNotificationChannels.DataAwsccFmsNotificationChannels.isTerraformElement(x: any)
```
...
dataAwsccFmsNotificationChannels.DataAwsccFmsNotificationChannels.isTerraformDataSource(x: any)
```
...
dataAwsccFmsNotificationChannels.DataAwsccFmsNotificationChannels.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccFmsNotificationChannels.DataAwsccFmsNotificationChannels.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccFmsNotificationChannels.DataAwsccFmsNotificationChannels.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccFmsNotificationChannels.DataAwsccFmsNotificationChannels.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccFmsNotificationChannels.DataAwsccFmsNotificationChannels.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccFmsNotificationChannels.DataAwsccFmsNotificationChannels.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccFmsNotificationChannels.DataAwsccFmsNotificationChannels.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccFmsNotificationChannels.DataAwsccFmsNotificationChannels.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
...
const dataAwsccFmsNotificationChannelsConfig: dataAwsccFmsNotificationChannels.DataAwsccFmsNotificationChannelsConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccFmsNotificationChannels.DataAwsccFmsNotificationChannelsConfig.property.connection">connection</a></code> | <code>cdktn.SSHProvisionerConnection \| cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccFmsNotificationChannels.DataAwsccFmsNotificationChannelsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccFmsNotificationChannels.DataAwsccFmsNotificationChannelsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccFmsNotificationChannels.DataAwsccFmsNotificationChannelsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccFmsNotificationChannels.DataAwsccFmsNotificationChannelsConfig.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccFmsNotificationChannels.DataAwsccFmsNotificationChannelsConfig.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccFmsNotificationChannels.DataAwsccFmsNotificationChannelsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
