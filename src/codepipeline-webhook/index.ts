...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/codepipeline_webhook
...
export class CodepipelineWebhook extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CodepipelineWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/codepipeline_webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/codepipeline_webhook awscc_codepipeline_webhook} Resource
  *
  * @param scope The scope in which to define this construct
