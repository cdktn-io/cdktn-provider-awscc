...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/dsql_clusters
...
export class DataAwsccDsqlClusters extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDsqlClusters that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/dsql_clusters#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/dsql_clusters awscc_dsql_clusters} Data Source
  *
  * @param scope The scope in which to define this construct
