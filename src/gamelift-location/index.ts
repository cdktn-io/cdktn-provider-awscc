...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/gamelift_location
...
export class GameliftLocation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GameliftLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/gamelift_location#import import section} in the documentation of this resource for the id to use
