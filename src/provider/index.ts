...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs
...
export class AwsccProvider extends cdktn.TerraformProvider {
  ...
  * @param importFromId The id of the existing AwsccProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs#import import section} in the documentation of this resource for the id to use
