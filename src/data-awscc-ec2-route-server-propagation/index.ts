...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ec2_route_server_propagation
...
export class DataAwsccEc2RouteServerPropagation extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEc2RouteServerPropagation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ec2_route_server_propagation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ec2_route_server_propagation awscc_ec2_route_server_propagation} Data Source
  *
  * @param scope The scope in which to define this construct
