...
```typescript
import { dataAwsccGroundstationConfigs } from '@cdktn/provider-awscc'

new dataAwsccGroundstationConfigs.DataAwsccGroundstationConfigs(scope: Construct, id: string, config?: DataAwsccGroundstationConfigsConfig)
```
...
dataAwsccGroundstationConfigs.DataAwsccGroundstationConfigs.isConstruct(x: any)
```
...
dataAwsccGroundstationConfigs.DataAwsccGroundstationConfigs.isTerraformElement(x: any)
```
...
dataAwsccGroundstationConfigs.DataAwsccGroundstationConfigs.isTerraformDataSource(x: any)
```
...
dataAwsccGroundstationConfigs.DataAwsccGroundstationConfigs.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationConfigs.DataAwsccGroundstationConfigs.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationConfigs.DataAwsccGroundstationConfigs.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationConfigs.DataAwsccGroundstationConfigs.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationConfigs.DataAwsccGroundstationConfigs.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationConfigs.DataAwsccGroundstationConfigs.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccGroundstationConfigsConfig: dataAwsccGroundstationConfigs.DataAwsccGroundstationConfigsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationConfigs.DataAwsccGroundstationConfigsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationConfigs.DataAwsccGroundstationConfigsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationConfigs.DataAwsccGroundstationConfigsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationConfigs.DataAwsccGroundstationConfigsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
