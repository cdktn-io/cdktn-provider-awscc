...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/ivs_stream_key
...
export class IvsStreamKey extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IvsStreamKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/ivs_stream_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/ivs_stream_key awscc_ivs_stream_key} Resource
  *
  * @param scope The scope in which to define this construct
