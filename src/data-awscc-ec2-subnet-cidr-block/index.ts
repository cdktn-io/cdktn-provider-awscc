...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/ec2_subnet_cidr_block
...
export class DataAwsccEc2SubnetCidrBlock extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEc2SubnetCidrBlock that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/ec2_subnet_cidr_block#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/ec2_subnet_cidr_block awscc_ec2_subnet_cidr_block} Data Source
  *
  * @param scope The scope in which to define this construct
