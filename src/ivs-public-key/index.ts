...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ivs_public_key
...
export class IvsPublicKey extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IvsPublicKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ivs_public_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ivs_public_key awscc_ivs_public_key} Resource
  *
  * @param scope The scope in which to define this construct
