...
export class DetectiveOrganizationAdmin extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DetectiveOrganizationAdmin that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/detective_organization_admin#import import section} in the documentation of this resource for the id to use
