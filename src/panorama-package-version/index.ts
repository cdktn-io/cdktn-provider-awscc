...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/panorama_package_version
...
export class PanoramaPackageVersion extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PanoramaPackageVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/panorama_package_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/panorama_package_version awscc_panorama_package_version} Resource
  *
  * @param scope The scope in which to define this construct
