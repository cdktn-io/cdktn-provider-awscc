...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/panorama_application_instance
...
export class PanoramaApplicationInstance extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PanoramaApplicationInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/panorama_application_instance#import import section} in the documentation of this resource for the id to use
