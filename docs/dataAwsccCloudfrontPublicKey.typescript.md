...
```typescript
import { dataAwsccCloudfrontPublicKey } from '@cdktn/provider-awscc'

new dataAwsccCloudfrontPublicKey.DataAwsccCloudfrontPublicKey(scope: Construct, id: string, config: DataAwsccCloudfrontPublicKeyConfig)
```
...
dataAwsccCloudfrontPublicKey.DataAwsccCloudfrontPublicKey.isConstruct(x: any)
```
...
dataAwsccCloudfrontPublicKey.DataAwsccCloudfrontPublicKey.isTerraformElement(x: any)
```
...
dataAwsccCloudfrontPublicKey.DataAwsccCloudfrontPublicKey.isTerraformDataSource(x: any)
```
...
dataAwsccCloudfrontPublicKey.DataAwsccCloudfrontPublicKey.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudfrontPublicKey.DataAwsccCloudfrontPublicKey.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudfrontPublicKey.DataAwsccCloudfrontPublicKey.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudfrontPublicKey.DataAwsccCloudfrontPublicKey.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudfrontPublicKey.DataAwsccCloudfrontPublicKey.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudfrontPublicKey.DataAwsccCloudfrontPublicKey.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
```typescript
public readonly publicKeyConfig: DataAwsccCloudfrontPublicKeyPublicKeyConfigOutputReference;
```
...
const dataAwsccCloudfrontPublicKeyConfig: dataAwsccCloudfrontPublicKey.DataAwsccCloudfrontPublicKeyConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudfrontPublicKey.DataAwsccCloudfrontPublicKeyConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudfrontPublicKey.DataAwsccCloudfrontPublicKeyConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudfrontPublicKey.DataAwsccCloudfrontPublicKeyConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudfrontPublicKey.DataAwsccCloudfrontPublicKeyConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const dataAwsccCloudfrontPublicKeyPublicKeyConfig: dataAwsccCloudfrontPublicKey.DataAwsccCloudfrontPublicKeyPublicKeyConfig = { ... }
```
...
new dataAwsccCloudfrontPublicKey.DataAwsccCloudfrontPublicKeyPublicKeyConfigOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudfrontPublicKey.DataAwsccCloudfrontPublicKeyPublicKeyConfigOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public readonly internalValue: DataAwsccCloudfrontPublicKeyPublicKeyConfig;
```
