...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/notifications_notification_hubs
...
export class DataAwsccNotificationsNotificationHubs extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccNotificationsNotificationHubs that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/notifications_notification_hubs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/notifications_notification_hubs awscc_notifications_notification_hubs} Data Source
  *
  * @param scope The scope in which to define this construct
