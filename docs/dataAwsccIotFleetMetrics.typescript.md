...
```typescript
import { dataAwsccIotFleetMetrics } from '@cdktn/provider-awscc'

new dataAwsccIotFleetMetrics.DataAwsccIotFleetMetrics(scope: Construct, id: string, config?: DataAwsccIotFleetMetricsConfig)
```
...
dataAwsccIotFleetMetrics.DataAwsccIotFleetMetrics.isConstruct(x: any)
```
...
dataAwsccIotFleetMetrics.DataAwsccIotFleetMetrics.isTerraformElement(x: any)
```
...
dataAwsccIotFleetMetrics.DataAwsccIotFleetMetrics.isTerraformDataSource(x: any)
```
...
dataAwsccIotFleetMetrics.DataAwsccIotFleetMetrics.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotFleetMetrics.DataAwsccIotFleetMetrics.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotFleetMetrics.DataAwsccIotFleetMetrics.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotFleetMetrics.DataAwsccIotFleetMetrics.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotFleetMetrics.DataAwsccIotFleetMetrics.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotFleetMetrics.DataAwsccIotFleetMetrics.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccIotFleetMetricsConfig: dataAwsccIotFleetMetrics.DataAwsccIotFleetMetricsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotFleetMetrics.DataAwsccIotFleetMetricsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotFleetMetrics.DataAwsccIotFleetMetricsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotFleetMetrics.DataAwsccIotFleetMetricsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotFleetMetrics.DataAwsccIotFleetMetricsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
