...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/bedrockmantle_projects
...
export class DataAwsccBedrockmantleProjects extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccBedrockmantleProjects that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/bedrockmantle_projects#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/bedrockmantle_projects awscc_bedrockmantle_projects} Data Source
  *
  * @param scope The scope in which to define this construct
