...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/cloudwatch_composite_alarm
...
export class DataAwsccCloudwatchCompositeAlarm extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCloudwatchCompositeAlarm that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/cloudwatch_composite_alarm#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/cloudwatch_composite_alarm awscc_cloudwatch_composite_alarm} Data Source
  *
  * @param scope The scope in which to define this construct
