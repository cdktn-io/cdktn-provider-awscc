...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/paymentcryptography_key
...
export class PaymentcryptographyKey extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PaymentcryptographyKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/paymentcryptography_key#import import section} in the documentation of this resource for the id to use
