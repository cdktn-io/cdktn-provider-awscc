...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/s3tables_namespace
...
export class DataAwsccS3TablesNamespace extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccS3TablesNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/s3tables_namespace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/s3tables_namespace awscc_s3tables_namespace} Data Source
  *
  * @param scope The scope in which to define this construct
