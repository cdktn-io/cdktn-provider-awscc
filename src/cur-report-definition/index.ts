...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/cur_report_definition
...
export class CurReportDefinition extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CurReportDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/cur_report_definition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/cur_report_definition awscc_cur_report_definition} Resource
  *
  * @param scope The scope in which to define this construct
