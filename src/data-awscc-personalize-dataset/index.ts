...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/personalize_dataset
...
export class DataAwsccPersonalizeDataset extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccPersonalizeDataset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/personalize_dataset#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/personalize_dataset awscc_personalize_dataset} Data Source
  *
  * @param scope The scope in which to define this construct
