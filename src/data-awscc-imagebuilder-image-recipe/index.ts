...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/imagebuilder_image_recipe
...
export class DataAwsccImagebuilderImageRecipe extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccImagebuilderImageRecipe that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/imagebuilder_image_recipe#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/imagebuilder_image_recipe awscc_imagebuilder_image_recipe} Data Source
  *
  * @param scope The scope in which to define this construct
