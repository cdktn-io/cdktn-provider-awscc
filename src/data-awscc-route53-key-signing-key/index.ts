...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/route53_key_signing_key
...
export class DataAwsccRoute53KeySigningKey extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRoute53KeySigningKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/route53_key_signing_key#import import section} in the documentation of this resource for the id to use
