...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/deadline_limit
...
export class DataAwsccDeadlineLimit extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDeadlineLimit that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/deadline_limit#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/deadline_limit awscc_deadline_limit} Data Source
  *
  * @param scope The scope in which to define this construct
