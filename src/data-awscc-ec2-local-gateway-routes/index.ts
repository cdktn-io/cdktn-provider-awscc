...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/ec2_local_gateway_routes
...
export class DataAwsccEc2LocalGatewayRoutes extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEc2LocalGatewayRoutes that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/ec2_local_gateway_routes#import import section} in the documentation of this resource for the id to use
