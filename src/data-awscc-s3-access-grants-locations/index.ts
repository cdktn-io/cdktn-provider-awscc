...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/s3_access_grants_locations
...
export class DataAwsccS3AccessGrantsLocations extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccS3AccessGrantsLocations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/s3_access_grants_locations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/s3_access_grants_locations awscc_s3_access_grants_locations} Data Source
  *
  * @param scope The scope in which to define this construct
