...
```typescript
import { dataAwsccMedialiveCloudwatchAlarmTemplateGroups } from '@cdktn/provider-awscc'

new dataAwsccMedialiveCloudwatchAlarmTemplateGroups.DataAwsccMedialiveCloudwatchAlarmTemplateGroups(scope: Construct, id: string, config?: DataAwsccMedialiveCloudwatchAlarmTemplateGroupsConfig)
```
...
dataAwsccMedialiveCloudwatchAlarmTemplateGroups.DataAwsccMedialiveCloudwatchAlarmTemplateGroups.isConstruct(x: any)
```
...
dataAwsccMedialiveCloudwatchAlarmTemplateGroups.DataAwsccMedialiveCloudwatchAlarmTemplateGroups.isTerraformElement(x: any)
```
...
dataAwsccMedialiveCloudwatchAlarmTemplateGroups.DataAwsccMedialiveCloudwatchAlarmTemplateGroups.isTerraformDataSource(x: any)
```
...
dataAwsccMedialiveCloudwatchAlarmTemplateGroups.DataAwsccMedialiveCloudwatchAlarmTemplateGroups.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveCloudwatchAlarmTemplateGroups.DataAwsccMedialiveCloudwatchAlarmTemplateGroups.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveCloudwatchAlarmTemplateGroups.DataAwsccMedialiveCloudwatchAlarmTemplateGroups.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveCloudwatchAlarmTemplateGroups.DataAwsccMedialiveCloudwatchAlarmTemplateGroups.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveCloudwatchAlarmTemplateGroups.DataAwsccMedialiveCloudwatchAlarmTemplateGroups.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveCloudwatchAlarmTemplateGroups.DataAwsccMedialiveCloudwatchAlarmTemplateGroups.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccMedialiveCloudwatchAlarmTemplateGroupsConfig: dataAwsccMedialiveCloudwatchAlarmTemplateGroups.DataAwsccMedialiveCloudwatchAlarmTemplateGroupsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveCloudwatchAlarmTemplateGroups.DataAwsccMedialiveCloudwatchAlarmTemplateGroupsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveCloudwatchAlarmTemplateGroups.DataAwsccMedialiveCloudwatchAlarmTemplateGroupsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveCloudwatchAlarmTemplateGroups.DataAwsccMedialiveCloudwatchAlarmTemplateGroupsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveCloudwatchAlarmTemplateGroups.DataAwsccMedialiveCloudwatchAlarmTemplateGroupsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
