...
```typescript
import { dataAwsccWickrNetwork } from '@cdktn/provider-awscc'

new dataAwsccWickrNetwork.DataAwsccWickrNetwork(scope: Construct, id: string, config: DataAwsccWickrNetworkConfig)
```
...
dataAwsccWickrNetwork.DataAwsccWickrNetwork.isConstruct(x: any)
```
...
dataAwsccWickrNetwork.DataAwsccWickrNetwork.isTerraformElement(x: any)
```
...
dataAwsccWickrNetwork.DataAwsccWickrNetwork.isTerraformDataSource(x: any)
```
...
dataAwsccWickrNetwork.DataAwsccWickrNetwork.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWickrNetwork.DataAwsccWickrNetwork.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWickrNetwork.DataAwsccWickrNetwork.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWickrNetwork.DataAwsccWickrNetwork.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccWickrNetwork.DataAwsccWickrNetwork.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWickrNetwork.DataAwsccWickrNetwork.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWickrNetwork.DataAwsccWickrNetwork.property.migrationState">migrationState</a></code> | <code>number</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWickrNetwork.DataAwsccWickrNetwork.property.standing">standing</a></code> | <code>number</code> | *No description.* |
...
const dataAwsccWickrNetworkConfig: dataAwsccWickrNetwork.DataAwsccWickrNetworkConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWickrNetwork.DataAwsccWickrNetworkConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccWickrNetwork.DataAwsccWickrNetworkConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccWickrNetwork.DataAwsccWickrNetworkConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWickrNetwork.DataAwsccWickrNetworkConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
