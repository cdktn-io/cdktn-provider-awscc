...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccgroundstationdataflowendpointgroupv2s"

dataawsccgroundstationdataflowendpointgroupv2s.NewDataAwsccGroundstationDataflowEndpointGroupV2S(scope Construct, id *string, config DataAwsccGroundstationDataflowEndpointGroupV2SConfig) DataAwsccGroundstationDataflowEndpointGroupV2S
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2S.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
dataawsccgroundstationdataflowendpointgroupv2s.DataAwsccGroundstationDataflowEndpointGroupV2S_IsConstruct(x interface{}) *bool
```
...
dataawsccgroundstationdataflowendpointgroupv2s.DataAwsccGroundstationDataflowEndpointGroupV2S_IsTerraformElement(x interface{}) *bool
```
...
dataawsccgroundstationdataflowendpointgroupv2s.DataAwsccGroundstationDataflowEndpointGroupV2S_IsTerraformDataSource(x interface{}) *bool
```
...
dataawsccgroundstationdataflowendpointgroupv2s.DataAwsccGroundstationDataflowEndpointGroupV2S_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2S.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2S.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2S.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2S.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2S.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2S.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2S.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2S.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
...
&dataawsccgroundstationdataflowendpointgroupv2s.DataAwsccGroundstationDataflowEndpointGroupV2SConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2SConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2SConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2SConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2SConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2SConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2SConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2SConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
