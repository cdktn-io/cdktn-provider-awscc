...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccelasticloadbalancingv2loadbalancers"

dataawsccelasticloadbalancingv2loadbalancers.NewDataAwsccElasticloadbalancingv2LoadBalancers(scope Construct, id *string, config DataAwsccElasticloadbalancingv2LoadBalancersConfig) DataAwsccElasticloadbalancingv2LoadBalancers
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccElasticloadbalancingv2LoadBalancers.DataAwsccElasticloadbalancingv2LoadBalancers.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
dataawsccelasticloadbalancingv2loadbalancers.DataAwsccElasticloadbalancingv2LoadBalancers_IsConstruct(x interface{}) *bool
```
...
dataawsccelasticloadbalancingv2loadbalancers.DataAwsccElasticloadbalancingv2LoadBalancers_IsTerraformElement(x interface{}) *bool
```
...
dataawsccelasticloadbalancingv2loadbalancers.DataAwsccElasticloadbalancingv2LoadBalancers_IsTerraformDataSource(x interface{}) *bool
```
...
dataawsccelasticloadbalancingv2loadbalancers.DataAwsccElasticloadbalancingv2LoadBalancers_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccElasticloadbalancingv2LoadBalancers.DataAwsccElasticloadbalancingv2LoadBalancers.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccElasticloadbalancingv2LoadBalancers.DataAwsccElasticloadbalancingv2LoadBalancers.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccElasticloadbalancingv2LoadBalancers.DataAwsccElasticloadbalancingv2LoadBalancers.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccElasticloadbalancingv2LoadBalancers.DataAwsccElasticloadbalancingv2LoadBalancers.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccElasticloadbalancingv2LoadBalancers.DataAwsccElasticloadbalancingv2LoadBalancers.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccElasticloadbalancingv2LoadBalancers.DataAwsccElasticloadbalancingv2LoadBalancers.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccElasticloadbalancingv2LoadBalancers.DataAwsccElasticloadbalancingv2LoadBalancers.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccElasticloadbalancingv2LoadBalancers.DataAwsccElasticloadbalancingv2LoadBalancers.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
...
&dataawsccelasticloadbalancingv2loadbalancers.DataAwsccElasticloadbalancingv2LoadBalancersConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccElasticloadbalancingv2LoadBalancers.DataAwsccElasticloadbalancingv2LoadBalancersConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccElasticloadbalancingv2LoadBalancers.DataAwsccElasticloadbalancingv2LoadBalancersConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccElasticloadbalancingv2LoadBalancers.DataAwsccElasticloadbalancingv2LoadBalancersConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccElasticloadbalancingv2LoadBalancers.DataAwsccElasticloadbalancingv2LoadBalancersConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccElasticloadbalancingv2LoadBalancers.DataAwsccElasticloadbalancingv2LoadBalancersConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccElasticloadbalancingv2LoadBalancers.DataAwsccElasticloadbalancingv2LoadBalancersConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccElasticloadbalancingv2LoadBalancers.DataAwsccElasticloadbalancingv2LoadBalancersConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
