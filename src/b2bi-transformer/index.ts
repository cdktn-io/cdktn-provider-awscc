...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/b2bi_transformer
...
export class B2BiTransformer extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing B2BiTransformer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/b2bi_transformer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/b2bi_transformer awscc_b2bi_transformer} Resource
  *
  * @param scope The scope in which to define this construct
