...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/iotevents_alarm_model
...
export class DataAwsccIoteventsAlarmModel extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIoteventsAlarmModel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/iotevents_alarm_model#import import section} in the documentation of this resource for the id to use
