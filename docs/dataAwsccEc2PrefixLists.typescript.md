...
```typescript
import { dataAwsccEc2PrefixLists } from '@cdktn/provider-awscc'

new dataAwsccEc2PrefixLists.DataAwsccEc2PrefixLists(scope: Construct, id: string, config?: DataAwsccEc2PrefixListsConfig)
```
...
dataAwsccEc2PrefixLists.DataAwsccEc2PrefixLists.isConstruct(x: any)
```
...
dataAwsccEc2PrefixLists.DataAwsccEc2PrefixLists.isTerraformElement(x: any)
```
...
dataAwsccEc2PrefixLists.DataAwsccEc2PrefixLists.isTerraformDataSource(x: any)
```
...
dataAwsccEc2PrefixLists.DataAwsccEc2PrefixLists.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2PrefixLists.DataAwsccEc2PrefixLists.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2PrefixLists.DataAwsccEc2PrefixLists.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2PrefixLists.DataAwsccEc2PrefixLists.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2PrefixLists.DataAwsccEc2PrefixLists.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2PrefixLists.DataAwsccEc2PrefixLists.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccEc2PrefixListsConfig: dataAwsccEc2PrefixLists.DataAwsccEc2PrefixListsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2PrefixLists.DataAwsccEc2PrefixListsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2PrefixLists.DataAwsccEc2PrefixListsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2PrefixLists.DataAwsccEc2PrefixListsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2PrefixLists.DataAwsccEc2PrefixListsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
