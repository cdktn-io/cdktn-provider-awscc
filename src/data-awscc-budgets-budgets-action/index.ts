...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/budgets_budgets_action
...
export class DataAwsccBudgetsBudgetsAction extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccBudgetsBudgetsAction that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/budgets_budgets_action#import import section} in the documentation of this resource for the id to use
