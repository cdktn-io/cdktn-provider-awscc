...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/mediatailor_vod_source
...
export class DataAwsccMediatailorVodSource extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccMediatailorVodSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/mediatailor_vod_source#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/mediatailor_vod_source awscc_mediatailor_vod_source} Data Source
  *
  * @param scope The scope in which to define this construct
