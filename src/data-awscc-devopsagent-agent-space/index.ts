...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/devopsagent_agent_space
...
export class DataAwsccDevopsagentAgentSpace extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDevopsagentAgentSpace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/devopsagent_agent_space#import import section} in the documentation of this resource for the id to use
