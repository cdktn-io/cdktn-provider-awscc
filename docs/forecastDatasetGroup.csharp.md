...
new ForecastDatasetGroup(Construct Scope, string Id, ForecastDatasetGroupConfig Config);
```
...
```csharp
private void PutTags(IResolvable|ForecastDatasetGroupTags[] Value)
```
...
- *Type:* Io.Cdktn.IResolvable|<a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTags">ForecastDatasetGroupTags</a>[]
...
ForecastDatasetGroup.IsConstruct(object X);
```
...
ForecastDatasetGroup.IsTerraformElement(object X);
```
...
ForecastDatasetGroup.IsTerraformResource(object X);
```
...
ForecastDatasetGroup.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.tagsInput">TagsInput</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTags">ForecastDatasetGroupTags</a>[]</code> | *No description.* |
...
```csharp
public ForecastDatasetGroupTagsList Tags { get; }
```
...
```csharp
public string[] DatasetArnsInput { get; }
```
...
```csharp
public string DatasetGroupNameInput { get; }
```
...
```csharp
public IResolvable|ForecastDatasetGroupTags[] TagsInput { get; }
```
...
new ForecastDatasetGroupConfig {
    ...
    string Domain,
    string[] DatasetArns = null,
    IResolvable|ForecastDatasetGroupTags[] Tags = null
};
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupConfig.property.tags">Tags</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTags">ForecastDatasetGroupTags</a>[]</code> | The tags of Application Insights application. |
...
```csharp
public IResolvable|ForecastDatasetGroupTags[] Tags { get; set; }
```
...
new ForecastDatasetGroupTagsList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTagsList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTagsList.resolve.parameter._context"></a>
...
```csharp
private ForecastDatasetGroupTagsOutputReference Get(double Index)
```
...
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTagsList.property.internalValue">InternalValue</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTags">ForecastDatasetGroupTags</a>[]</code> | *No description.* |
...
```csharp
public IResolvable|ForecastDatasetGroupTags[] InternalValue { get; }
```
...
new ForecastDatasetGroupTagsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTagsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTagsOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTagsOutputReference.resolve.parameter._context"></a>
...
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTagsOutputReference.property.internalValue">InternalValue</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTags">ForecastDatasetGroupTags</a></code> | *No description.* |
