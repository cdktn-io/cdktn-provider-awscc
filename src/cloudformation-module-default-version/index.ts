...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/cloudformation_module_default_version
...
export class CloudformationModuleDefaultVersion extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudformationModuleDefaultVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/cloudformation_module_default_version#import import section} in the documentation of this resource for the id to use
