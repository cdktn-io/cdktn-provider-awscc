...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/ec2_transit_gateway_multicast_domain_associations
...
export class DataAwsccEc2TransitGatewayMulticastDomainAssociations extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEc2TransitGatewayMulticastDomainAssociations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/ec2_transit_gateway_multicast_domain_associations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/ec2_transit_gateway_multicast_domain_associations awscc_ec2_transit_gateway_multicast_domain_associations} Data Source
  *
  * @param scope The scope in which to define this construct
