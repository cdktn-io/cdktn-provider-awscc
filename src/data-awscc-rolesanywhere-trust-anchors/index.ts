...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/rolesanywhere_trust_anchors
...
export class DataAwsccRolesanywhereTrustAnchors extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRolesanywhereTrustAnchors that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/rolesanywhere_trust_anchors#import import section} in the documentation of this resource for the id to use
