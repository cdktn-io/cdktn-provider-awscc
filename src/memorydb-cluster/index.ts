...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/memorydb_cluster
...
export class MemorydbCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MemorydbCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/memorydb_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/memorydb_cluster awscc_memorydb_cluster} Resource
  *
  * @param scope The scope in which to define this construct
