...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/iot_resource_specific_logging
...
export class IotResourceSpecificLogging extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotResourceSpecificLogging that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/iot_resource_specific_logging#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/iot_resource_specific_logging awscc_iot_resource_specific_logging} Resource
  *
  * @param scope The scope in which to define this construct
