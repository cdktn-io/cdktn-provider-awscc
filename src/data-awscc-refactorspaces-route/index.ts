...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/refactorspaces_route
...
export class DataAwsccRefactorspacesRoute extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRefactorspacesRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/refactorspaces_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/refactorspaces_route awscc_refactorspaces_route} Data Source
  *
  * @param scope The scope in which to define this construct
