...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/logs_query_definition
...
export class LogsQueryDefinition extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LogsQueryDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/logs_query_definition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/logs_query_definition awscc_logs_query_definition} Resource
  *
  * @param scope The scope in which to define this construct
