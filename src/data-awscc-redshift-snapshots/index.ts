...
export interface DataAwsccRedshiftSnapshotsConfig extends cdktn.TerraformMetaArguments {
}
...
export class DataAwsccRedshiftSnapshots extends cdktn.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "awscc_redshift_snapshots";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "awscc_redshift_snapshots", importId: importFromId, provider });
      }
  ...
  * @param options DataAwsccRedshiftSnapshotsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataAwsccRedshiftSnapshotsConfig = {}) {
    super(scope, id, {
