...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/connect_quick_connect
...
export interface ConnectQuickConnectQuickConnectConfigFlowConfig {
  /**
...
export function connectQuickConnectQuickConnectConfigFlowConfigToTerraform(struct?: ConnectQuickConnectQuickConnectConfigFlowConfig | cdktn.IResolvable): any {
...
export function connectQuickConnectQuickConnectConfigFlowConfigToHclTerraform(struct?: ConnectQuickConnectQuickConnectConfigFlowConfig | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class ConnectQuickConnectQuickConnectConfigFlowConfigOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ConnectQuickConnectQuickConnectConfigFlowConfig | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: ConnectQuickConnectQuickConnectConfigFlowConfig | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export interface ConnectQuickConnectQuickConnectConfig {
  ...
  */
  readonly flowConfig?: ConnectQuickConnectQuickConnectConfigFlowConfig;
  /**
...
export function connectQuickConnectQuickConnectConfigToTerraform(struct?: ConnectQuickConnectQuickConnectConfig | cdktn.IResolvable): any {
  ...
  return {
    flow_config: connectQuickConnectQuickConnectConfigFlowConfigToTerraform(struct!.flowConfig),
...
export function connectQuickConnectQuickConnectConfigToHclTerraform(struct?: ConnectQuickConnectQuickConnectConfig | cdktn.IResolvable): any {
  ...
  const attrs = {
    flow_config: {
      value: connectQuickConnectQuickConnectConfigFlowConfigToHclTerraform(struct!.flowConfig),
      isBlock: true,
      type: "struct",
      storageClassType: "ConnectQuickConnectQuickConnectConfigFlowConfig",
    },
    phone_config: {
...
export class ConnectQuickConnectQuickConnectConfigOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _flowConfig = new ConnectQuickConnectQuickConnectConfigFlowConfigOutputReference(this, "flow_config");
  public get flowConfig() {
    return this._flowConfig;
  }
  public putFlowConfig(value: ConnectQuickConnectQuickConnectConfigFlowConfig) {
...
export class ConnectQuickConnect extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectQuickConnect that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/connect_quick_connect#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/connect_quick_connect awscc_connect_quick_connect} Resource
  *
  * @param scope The scope in which to define this construct
