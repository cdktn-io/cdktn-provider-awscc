...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/redshift_snapshot_schedules
...
export class DataAwsccRedshiftSnapshotSchedules extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRedshiftSnapshotSchedules that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/redshift_snapshot_schedules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/redshift_snapshot_schedules awscc_redshift_snapshot_schedules} Data Source
  *
  * @param scope The scope in which to define this construct
