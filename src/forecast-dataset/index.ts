...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/forecast_dataset
...
export class ForecastDataset extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ForecastDataset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/forecast_dataset#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/forecast_dataset awscc_forecast_dataset} Resource
  *
  * @param scope The scope in which to define this construct
