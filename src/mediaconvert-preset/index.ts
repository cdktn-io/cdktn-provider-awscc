...
export class MediaconvertPreset extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MediaconvertPreset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/mediaconvert_preset#import import section} in the documentation of this resource for the id to use
