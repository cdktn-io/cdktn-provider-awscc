...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/connect_agent_status
...
export class ConnectAgentStatus extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectAgentStatus that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/connect_agent_status#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/connect_agent_status awscc_connect_agent_status} Resource
  *
  * @param scope The scope in which to define this construct
