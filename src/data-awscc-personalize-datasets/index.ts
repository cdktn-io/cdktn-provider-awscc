...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/personalize_datasets
...
export class DataAwsccPersonalizeDatasets extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccPersonalizeDatasets that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/personalize_datasets#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/personalize_datasets awscc_personalize_datasets} Data Source
  *
  * @param scope The scope in which to define this construct
