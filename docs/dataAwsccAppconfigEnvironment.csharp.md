...
Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/appconfig_environment awscc_appconfig_environment}.
...
new DataAwsccAppconfigEnvironment(Construct Scope, string Id, DataAwsccAppconfigEnvironmentConfig Config);
```
...
DataAwsccAppconfigEnvironment.IsConstruct(object X);
```
...
DataAwsccAppconfigEnvironment.IsTerraformElement(object X);
```
...
DataAwsccAppconfigEnvironment.IsTerraformDataSource(object X);
```
...
DataAwsccAppconfigEnvironment.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/appconfig_environment#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppconfigEnvironment.DataAwsccAppconfigEnvironment.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppconfigEnvironment.DataAwsccAppconfigEnvironment.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppconfigEnvironment.DataAwsccAppconfigEnvironment.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppconfigEnvironment.DataAwsccAppconfigEnvironment.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppconfigEnvironment.DataAwsccAppconfigEnvironment.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppconfigEnvironment.DataAwsccAppconfigEnvironment.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppconfigEnvironment.DataAwsccAppconfigEnvironment.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
...
```csharp
public DataAwsccAppconfigEnvironmentMonitorsList Monitors { get; }
```
...
```csharp
public DataAwsccAppconfigEnvironmentTagsList Tags { get; }
```
...
new DataAwsccAppconfigEnvironmentConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppconfigEnvironment.DataAwsccAppconfigEnvironmentConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppconfigEnvironment.DataAwsccAppconfigEnvironmentConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppconfigEnvironment.DataAwsccAppconfigEnvironmentConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppconfigEnvironment.DataAwsccAppconfigEnvironmentConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppconfigEnvironment.DataAwsccAppconfigEnvironmentConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppconfigEnvironment.DataAwsccAppconfigEnvironmentConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppconfigEnvironment.DataAwsccAppconfigEnvironmentConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/appconfig_environment#id DataAwsccAppconfigEnvironment#id}
...
new DataAwsccAppconfigEnvironmentMonitors {
...
new DataAwsccAppconfigEnvironmentTags {
...
new DataAwsccAppconfigEnvironmentMonitorsList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppconfigEnvironment.DataAwsccAppconfigEnvironmentMonitorsList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.dataAwsccAppconfigEnvironment.DataAwsccAppconfigEnvironmentMonitorsList.resolve.parameter._context"></a>
...
```csharp
private DataAwsccAppconfigEnvironmentMonitorsOutputReference Get(double Index)
```
...
new DataAwsccAppconfigEnvironmentMonitorsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppconfigEnvironment.DataAwsccAppconfigEnvironmentMonitorsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppconfigEnvironment.DataAwsccAppconfigEnvironmentMonitorsOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.dataAwsccAppconfigEnvironment.DataAwsccAppconfigEnvironmentMonitorsOutputReference.resolve.parameter._context"></a>
...
```csharp
public DataAwsccAppconfigEnvironmentMonitors InternalValue { get; }
```
...
new DataAwsccAppconfigEnvironmentTagsList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppconfigEnvironment.DataAwsccAppconfigEnvironmentTagsList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.dataAwsccAppconfigEnvironment.DataAwsccAppconfigEnvironmentTagsList.resolve.parameter._context"></a>
...
```csharp
private DataAwsccAppconfigEnvironmentTagsOutputReference Get(double Index)
```
...
new DataAwsccAppconfigEnvironmentTagsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppconfigEnvironment.DataAwsccAppconfigEnvironmentTagsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppconfigEnvironment.DataAwsccAppconfigEnvironmentTagsOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.dataAwsccAppconfigEnvironment.DataAwsccAppconfigEnvironmentTagsOutputReference.resolve.parameter._context"></a>
...
```csharp
public DataAwsccAppconfigEnvironmentTags InternalValue { get; }
```
