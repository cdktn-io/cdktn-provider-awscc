...
new DataAwsccVpclatticeResourceGateway(Construct Scope, string Id, DataAwsccVpclatticeResourceGatewayConfig Config);
```
...
DataAwsccVpclatticeResourceGateway.IsConstruct(object X);
```
...
DataAwsccVpclatticeResourceGateway.IsTerraformElement(object X);
```
...
DataAwsccVpclatticeResourceGateway.IsTerraformDataSource(object X);
```
...
DataAwsccVpclatticeResourceGateway.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeResourceGateway.DataAwsccVpclatticeResourceGateway.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeResourceGateway.DataAwsccVpclatticeResourceGateway.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeResourceGateway.DataAwsccVpclatticeResourceGateway.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeResourceGateway.DataAwsccVpclatticeResourceGateway.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeResourceGateway.DataAwsccVpclatticeResourceGateway.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeResourceGateway.DataAwsccVpclatticeResourceGateway.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeResourceGateway.DataAwsccVpclatticeResourceGateway.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeResourceGateway.DataAwsccVpclatticeResourceGateway.property.ipv4AddressesPerEni">Ipv4AddressesPerEni</a></code> | <code>double</code> | *No description.* |
...
```csharp
public DataAwsccVpclatticeResourceGatewayTagsList Tags { get; }
```
...
new DataAwsccVpclatticeResourceGatewayConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeResourceGateway.DataAwsccVpclatticeResourceGatewayConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeResourceGateway.DataAwsccVpclatticeResourceGatewayConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeResourceGateway.DataAwsccVpclatticeResourceGatewayConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeResourceGateway.DataAwsccVpclatticeResourceGatewayConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeResourceGateway.DataAwsccVpclatticeResourceGatewayConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeResourceGateway.DataAwsccVpclatticeResourceGatewayConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeResourceGateway.DataAwsccVpclatticeResourceGatewayConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
new DataAwsccVpclatticeResourceGatewayTags {
...
new DataAwsccVpclatticeResourceGatewayTagsList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeResourceGateway.DataAwsccVpclatticeResourceGatewayTagsList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.dataAwsccVpclatticeResourceGateway.DataAwsccVpclatticeResourceGatewayTagsList.resolve.parameter._context"></a>
...
```csharp
private DataAwsccVpclatticeResourceGatewayTagsOutputReference Get(double Index)
```
...
new DataAwsccVpclatticeResourceGatewayTagsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeResourceGateway.DataAwsccVpclatticeResourceGatewayTagsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeResourceGateway.DataAwsccVpclatticeResourceGatewayTagsOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.dataAwsccVpclatticeResourceGateway.DataAwsccVpclatticeResourceGatewayTagsOutputReference.resolve.parameter._context"></a>
...
```csharp
public DataAwsccVpclatticeResourceGatewayTags InternalValue { get; }
```
