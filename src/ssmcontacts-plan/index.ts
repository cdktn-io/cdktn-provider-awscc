...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ssmcontacts_plan
...
export class SsmcontactsPlan extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SsmcontactsPlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ssmcontacts_plan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ssmcontacts_plan awscc_ssmcontacts_plan} Resource
  *
  * @param scope The scope in which to define this construct
