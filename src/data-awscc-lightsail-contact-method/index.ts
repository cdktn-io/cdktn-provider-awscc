...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/lightsail_contact_method
...
export class DataAwsccLightsailContactMethod extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccLightsailContactMethod that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/lightsail_contact_method#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/lightsail_contact_method awscc_lightsail_contact_method} Data Source
  *
  * @param scope The scope in which to define this construct
