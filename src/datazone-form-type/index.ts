...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/datazone_form_type
...
export class DatazoneFormType extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DatazoneFormType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/datazone_form_type#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/datazone_form_type awscc_datazone_form_type} Resource
  *
  * @param scope The scope in which to define this construct
