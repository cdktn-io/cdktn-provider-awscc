...
export class Ec2IpamPrefixListResolverTarget extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2IpamPrefixListResolverTarget that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/ec2_ipam_prefix_list_resolver_target#import import section} in the documentation of this resource for the id to use
