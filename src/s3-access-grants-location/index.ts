...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/s3_access_grants_location
...
export class S3AccessGrantsLocation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3AccessGrantsLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/s3_access_grants_location#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/s3_access_grants_location awscc_s3_access_grants_location} Resource
  *
  * @param scope The scope in which to define this construct
