...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/ecr_repository_creation_template
...
export class EcrRepositoryCreationTemplate extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EcrRepositoryCreationTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/ecr_repository_creation_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/ecr_repository_creation_template awscc_ecr_repository_creation_template} Resource
  *
  * @param scope The scope in which to define this construct
