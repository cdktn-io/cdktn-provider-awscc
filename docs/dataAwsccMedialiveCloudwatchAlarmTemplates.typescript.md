...
```typescript
import { dataAwsccMedialiveCloudwatchAlarmTemplates } from '@cdktn/provider-awscc'

new dataAwsccMedialiveCloudwatchAlarmTemplates.DataAwsccMedialiveCloudwatchAlarmTemplates(scope: Construct, id: string, config?: DataAwsccMedialiveCloudwatchAlarmTemplatesConfig)
```
...
dataAwsccMedialiveCloudwatchAlarmTemplates.DataAwsccMedialiveCloudwatchAlarmTemplates.isConstruct(x: any)
```
...
dataAwsccMedialiveCloudwatchAlarmTemplates.DataAwsccMedialiveCloudwatchAlarmTemplates.isTerraformElement(x: any)
```
...
dataAwsccMedialiveCloudwatchAlarmTemplates.DataAwsccMedialiveCloudwatchAlarmTemplates.isTerraformDataSource(x: any)
```
...
dataAwsccMedialiveCloudwatchAlarmTemplates.DataAwsccMedialiveCloudwatchAlarmTemplates.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveCloudwatchAlarmTemplates.DataAwsccMedialiveCloudwatchAlarmTemplates.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveCloudwatchAlarmTemplates.DataAwsccMedialiveCloudwatchAlarmTemplates.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveCloudwatchAlarmTemplates.DataAwsccMedialiveCloudwatchAlarmTemplates.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveCloudwatchAlarmTemplates.DataAwsccMedialiveCloudwatchAlarmTemplates.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveCloudwatchAlarmTemplates.DataAwsccMedialiveCloudwatchAlarmTemplates.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccMedialiveCloudwatchAlarmTemplatesConfig: dataAwsccMedialiveCloudwatchAlarmTemplates.DataAwsccMedialiveCloudwatchAlarmTemplatesConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveCloudwatchAlarmTemplates.DataAwsccMedialiveCloudwatchAlarmTemplatesConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveCloudwatchAlarmTemplates.DataAwsccMedialiveCloudwatchAlarmTemplatesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveCloudwatchAlarmTemplates.DataAwsccMedialiveCloudwatchAlarmTemplatesConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveCloudwatchAlarmTemplates.DataAwsccMedialiveCloudwatchAlarmTemplatesConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
