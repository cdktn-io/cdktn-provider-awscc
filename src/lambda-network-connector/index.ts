...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/lambda_network_connector
...
export class LambdaNetworkConnector extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LambdaNetworkConnector that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/lambda_network_connector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/lambda_network_connector awscc_lambda_network_connector} Resource
  *
  * @param scope The scope in which to define this construct
