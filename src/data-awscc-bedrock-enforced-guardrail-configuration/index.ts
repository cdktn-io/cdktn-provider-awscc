...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/bedrock_enforced_guardrail_configuration
...
export class DataAwsccBedrockEnforcedGuardrailConfiguration extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccBedrockEnforcedGuardrailConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/bedrock_enforced_guardrail_configuration#import import section} in the documentation of this resource for the id to use
