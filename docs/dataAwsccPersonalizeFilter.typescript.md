...
```typescript
import { dataAwsccPersonalizeFilter } from '@cdktn/provider-awscc'

new dataAwsccPersonalizeFilter.DataAwsccPersonalizeFilter(scope: Construct, id: string, config: DataAwsccPersonalizeFilterConfig)
```
...
dataAwsccPersonalizeFilter.DataAwsccPersonalizeFilter.isConstruct(x: any)
```
...
dataAwsccPersonalizeFilter.DataAwsccPersonalizeFilter.isTerraformElement(x: any)
```
...
dataAwsccPersonalizeFilter.DataAwsccPersonalizeFilter.isTerraformDataSource(x: any)
```
...
dataAwsccPersonalizeFilter.DataAwsccPersonalizeFilter.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccPersonalizeFilter.DataAwsccPersonalizeFilter.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccPersonalizeFilter.DataAwsccPersonalizeFilter.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccPersonalizeFilter.DataAwsccPersonalizeFilter.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccPersonalizeFilter.DataAwsccPersonalizeFilter.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccPersonalizeFilter.DataAwsccPersonalizeFilter.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
```typescript
public readonly tags: DataAwsccPersonalizeFilterTagsList;
```
...
const dataAwsccPersonalizeFilterConfig: dataAwsccPersonalizeFilter.DataAwsccPersonalizeFilterConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccPersonalizeFilter.DataAwsccPersonalizeFilterConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccPersonalizeFilter.DataAwsccPersonalizeFilterConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccPersonalizeFilter.DataAwsccPersonalizeFilterConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccPersonalizeFilter.DataAwsccPersonalizeFilterConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const dataAwsccPersonalizeFilterTags: dataAwsccPersonalizeFilter.DataAwsccPersonalizeFilterTags = { ... }
```
...
new dataAwsccPersonalizeFilter.DataAwsccPersonalizeFilterTagsList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccPersonalizeFilter.DataAwsccPersonalizeFilterTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccPersonalizeFilter.DataAwsccPersonalizeFilterTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
new dataAwsccPersonalizeFilter.DataAwsccPersonalizeFilterTagsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccPersonalizeFilter.DataAwsccPersonalizeFilterTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccPersonalizeFilter.DataAwsccPersonalizeFilterTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccPersonalizeFilter.DataAwsccPersonalizeFilterTagsOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```typescript
public readonly internalValue: DataAwsccPersonalizeFilterTags;
```
