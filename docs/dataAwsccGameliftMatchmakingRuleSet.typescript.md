...
```typescript
import { dataAwsccGameliftMatchmakingRuleSet } from '@cdktn/provider-awscc'

new dataAwsccGameliftMatchmakingRuleSet.DataAwsccGameliftMatchmakingRuleSet(scope: Construct, id: string, config: DataAwsccGameliftMatchmakingRuleSetConfig)
```
...
dataAwsccGameliftMatchmakingRuleSet.DataAwsccGameliftMatchmakingRuleSet.isConstruct(x: any)
```
...
dataAwsccGameliftMatchmakingRuleSet.DataAwsccGameliftMatchmakingRuleSet.isTerraformElement(x: any)
```
...
dataAwsccGameliftMatchmakingRuleSet.DataAwsccGameliftMatchmakingRuleSet.isTerraformDataSource(x: any)
```
...
dataAwsccGameliftMatchmakingRuleSet.DataAwsccGameliftMatchmakingRuleSet.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingRuleSet.DataAwsccGameliftMatchmakingRuleSet.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingRuleSet.DataAwsccGameliftMatchmakingRuleSet.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingRuleSet.DataAwsccGameliftMatchmakingRuleSet.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingRuleSet.DataAwsccGameliftMatchmakingRuleSet.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingRuleSet.DataAwsccGameliftMatchmakingRuleSet.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
```typescript
public readonly tags: DataAwsccGameliftMatchmakingRuleSetTagsList;
```
...
const dataAwsccGameliftMatchmakingRuleSetConfig: dataAwsccGameliftMatchmakingRuleSet.DataAwsccGameliftMatchmakingRuleSetConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingRuleSet.DataAwsccGameliftMatchmakingRuleSetConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingRuleSet.DataAwsccGameliftMatchmakingRuleSetConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingRuleSet.DataAwsccGameliftMatchmakingRuleSetConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingRuleSet.DataAwsccGameliftMatchmakingRuleSetConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const dataAwsccGameliftMatchmakingRuleSetTags: dataAwsccGameliftMatchmakingRuleSet.DataAwsccGameliftMatchmakingRuleSetTags = { ... }
```
...
new dataAwsccGameliftMatchmakingRuleSet.DataAwsccGameliftMatchmakingRuleSetTagsList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingRuleSet.DataAwsccGameliftMatchmakingRuleSetTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingRuleSet.DataAwsccGameliftMatchmakingRuleSetTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
new dataAwsccGameliftMatchmakingRuleSet.DataAwsccGameliftMatchmakingRuleSetTagsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingRuleSet.DataAwsccGameliftMatchmakingRuleSetTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingRuleSet.DataAwsccGameliftMatchmakingRuleSetTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
...
```typescript
public readonly internalValue: DataAwsccGameliftMatchmakingRuleSetTags;
```
