...
```typescript
import { dataAwsccGuarddutyPublishingDestinations } from '@cdktn/provider-awscc'

new dataAwsccGuarddutyPublishingDestinations.DataAwsccGuarddutyPublishingDestinations(scope: Construct, id: string, config?: DataAwsccGuarddutyPublishingDestinationsConfig)
```
...
dataAwsccGuarddutyPublishingDestinations.DataAwsccGuarddutyPublishingDestinations.isConstruct(x: any)
```
...
dataAwsccGuarddutyPublishingDestinations.DataAwsccGuarddutyPublishingDestinations.isTerraformElement(x: any)
```
...
dataAwsccGuarddutyPublishingDestinations.DataAwsccGuarddutyPublishingDestinations.isTerraformDataSource(x: any)
```
...
dataAwsccGuarddutyPublishingDestinations.DataAwsccGuarddutyPublishingDestinations.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGuarddutyPublishingDestinations.DataAwsccGuarddutyPublishingDestinations.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGuarddutyPublishingDestinations.DataAwsccGuarddutyPublishingDestinations.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGuarddutyPublishingDestinations.DataAwsccGuarddutyPublishingDestinations.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGuarddutyPublishingDestinations.DataAwsccGuarddutyPublishingDestinations.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGuarddutyPublishingDestinations.DataAwsccGuarddutyPublishingDestinations.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccGuarddutyPublishingDestinationsConfig: dataAwsccGuarddutyPublishingDestinations.DataAwsccGuarddutyPublishingDestinationsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGuarddutyPublishingDestinations.DataAwsccGuarddutyPublishingDestinationsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGuarddutyPublishingDestinations.DataAwsccGuarddutyPublishingDestinationsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGuarddutyPublishingDestinations.DataAwsccGuarddutyPublishingDestinationsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGuarddutyPublishingDestinations.DataAwsccGuarddutyPublishingDestinationsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
