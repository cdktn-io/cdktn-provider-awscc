...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/lambda_network_connectors
...
export class DataAwsccLambdaNetworkConnectors extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccLambdaNetworkConnectors that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/lambda_network_connectors#import import section} in the documentation of this resource for the id to use
