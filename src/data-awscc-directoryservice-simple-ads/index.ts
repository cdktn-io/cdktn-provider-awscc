...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/directoryservice_simple_ads
...
export class DataAwsccDirectoryserviceSimpleAds extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDirectoryserviceSimpleAds that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/directoryservice_simple_ads#import import section} in the documentation of this resource for the id to use
