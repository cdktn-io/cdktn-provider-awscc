...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/guardduty_master
...
export class DataAwsccGuarddutyMaster extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccGuarddutyMaster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/guardduty_master#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/guardduty_master awscc_guardduty_master} Data Source
  *
  * @param scope The scope in which to define this construct
