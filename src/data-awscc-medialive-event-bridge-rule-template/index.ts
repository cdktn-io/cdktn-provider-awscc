...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/medialive_event_bridge_rule_template
...
export class DataAwsccMedialiveEventBridgeRuleTemplate extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccMedialiveEventBridgeRuleTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/medialive_event_bridge_rule_template#import import section} in the documentation of this resource for the id to use
