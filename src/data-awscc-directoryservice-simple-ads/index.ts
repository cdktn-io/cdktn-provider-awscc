...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/directoryservice_simple_ads
...
export class DataAwsccDirectoryserviceSimpleAds extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDirectoryserviceSimpleAds that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/directoryservice_simple_ads#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/directoryservice_simple_ads awscc_directoryservice_simple_ads} Data Source
  *
  * @param scope The scope in which to define this construct
