...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/mediapackage_packaging_configurations
...
export class DataAwsccMediapackagePackagingConfigurations extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccMediapackagePackagingConfigurations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/mediapackage_packaging_configurations#import import section} in the documentation of this resource for the id to use
