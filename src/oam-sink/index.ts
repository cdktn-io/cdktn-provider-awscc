...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/oam_sink
...
export class OamSink extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OamSink that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/oam_sink#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/oam_sink awscc_oam_sink} Resource
  *
  * @param scope The scope in which to define this construct
