...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/redshiftserverless_snapshot
...
export class DataAwsccRedshiftserverlessSnapshot extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRedshiftserverlessSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/redshiftserverless_snapshot#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/redshiftserverless_snapshot awscc_redshiftserverless_snapshot} Data Source
  *
  * @param scope The scope in which to define this construct
