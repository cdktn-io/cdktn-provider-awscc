...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/sso_assignment
...
export class SsoAssignment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SsoAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/sso_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/sso_assignment awscc_sso_assignment} Resource
  *
  * @param scope The scope in which to define this construct
