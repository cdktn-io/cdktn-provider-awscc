...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/apigateway_authorizer
...
export class ApigatewayAuthorizer extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApigatewayAuthorizer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/apigateway_authorizer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/apigateway_authorizer awscc_apigateway_authorizer} Resource
  *
  * @param scope The scope in which to define this construct
