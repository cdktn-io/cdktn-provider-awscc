...
```typescript
import { dataAwsccGameliftAliases } from '@cdktn/provider-awscc'

new dataAwsccGameliftAliases.DataAwsccGameliftAliases(scope: Construct, id: string, config?: DataAwsccGameliftAliasesConfig)
```
...
dataAwsccGameliftAliases.DataAwsccGameliftAliases.isConstruct(x: any)
```
...
dataAwsccGameliftAliases.DataAwsccGameliftAliases.isTerraformElement(x: any)
```
...
dataAwsccGameliftAliases.DataAwsccGameliftAliases.isTerraformDataSource(x: any)
```
...
dataAwsccGameliftAliases.DataAwsccGameliftAliases.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftAliases.DataAwsccGameliftAliases.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftAliases.DataAwsccGameliftAliases.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftAliases.DataAwsccGameliftAliases.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftAliases.DataAwsccGameliftAliases.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftAliases.DataAwsccGameliftAliases.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccGameliftAliasesConfig: dataAwsccGameliftAliases.DataAwsccGameliftAliasesConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftAliases.DataAwsccGameliftAliasesConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftAliases.DataAwsccGameliftAliasesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftAliases.DataAwsccGameliftAliasesConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftAliases.DataAwsccGameliftAliasesConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
