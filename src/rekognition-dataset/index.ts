...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/rekognition_dataset
...
export class RekognitionDataset extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RekognitionDataset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/rekognition_dataset#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/rekognition_dataset awscc_rekognition_dataset} Resource
  *
  * @param scope The scope in which to define this construct
