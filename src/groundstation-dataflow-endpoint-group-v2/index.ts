...
export class GroundstationDataflowEndpointGroupV2 extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GroundstationDataflowEndpointGroupV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/groundstation_dataflow_endpoint_group_v2#import import section} in the documentation of this resource for the id to use
