...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/ecr_signing_configurations
...
export class DataAwsccEcrSigningConfigurations extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEcrSigningConfigurations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/ecr_signing_configurations#import import section} in the documentation of this resource for the id to use
