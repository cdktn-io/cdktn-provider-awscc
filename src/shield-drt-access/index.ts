...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/shield_drt_access
...
export class ShieldDrtAccess extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ShieldDrtAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/shield_drt_access#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/shield_drt_access awscc_shield_drt_access} Resource
  *
  * @param scope The scope in which to define this construct
