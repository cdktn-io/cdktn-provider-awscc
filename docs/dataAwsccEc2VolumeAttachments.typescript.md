...
```typescript
import { dataAwsccEc2VolumeAttachments } from '@cdktn/provider-awscc'

new dataAwsccEc2VolumeAttachments.DataAwsccEc2VolumeAttachments(scope: Construct, id: string, config?: DataAwsccEc2VolumeAttachmentsConfig)
```
...
dataAwsccEc2VolumeAttachments.DataAwsccEc2VolumeAttachments.isConstruct(x: any)
```
...
dataAwsccEc2VolumeAttachments.DataAwsccEc2VolumeAttachments.isTerraformElement(x: any)
```
...
dataAwsccEc2VolumeAttachments.DataAwsccEc2VolumeAttachments.isTerraformDataSource(x: any)
```
...
dataAwsccEc2VolumeAttachments.DataAwsccEc2VolumeAttachments.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VolumeAttachments.DataAwsccEc2VolumeAttachments.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VolumeAttachments.DataAwsccEc2VolumeAttachments.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VolumeAttachments.DataAwsccEc2VolumeAttachments.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VolumeAttachments.DataAwsccEc2VolumeAttachments.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VolumeAttachments.DataAwsccEc2VolumeAttachments.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccEc2VolumeAttachmentsConfig: dataAwsccEc2VolumeAttachments.DataAwsccEc2VolumeAttachmentsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VolumeAttachments.DataAwsccEc2VolumeAttachmentsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VolumeAttachments.DataAwsccEc2VolumeAttachmentsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VolumeAttachments.DataAwsccEc2VolumeAttachmentsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VolumeAttachments.DataAwsccEc2VolumeAttachmentsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
