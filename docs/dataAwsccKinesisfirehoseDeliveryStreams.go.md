...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawscckinesisfirehosedeliverystreams"

dataawscckinesisfirehosedeliverystreams.NewDataAwsccKinesisfirehoseDeliveryStreams(scope Construct, id *string, config DataAwsccKinesisfirehoseDeliveryStreamsConfig) DataAwsccKinesisfirehoseDeliveryStreams
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKinesisfirehoseDeliveryStreams.DataAwsccKinesisfirehoseDeliveryStreams.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
dataawscckinesisfirehosedeliverystreams.DataAwsccKinesisfirehoseDeliveryStreams_IsConstruct(x interface{}) *bool
```
...
dataawscckinesisfirehosedeliverystreams.DataAwsccKinesisfirehoseDeliveryStreams_IsTerraformElement(x interface{}) *bool
```
...
dataawscckinesisfirehosedeliverystreams.DataAwsccKinesisfirehoseDeliveryStreams_IsTerraformDataSource(x interface{}) *bool
```
...
dataawscckinesisfirehosedeliverystreams.DataAwsccKinesisfirehoseDeliveryStreams_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKinesisfirehoseDeliveryStreams.DataAwsccKinesisfirehoseDeliveryStreams.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKinesisfirehoseDeliveryStreams.DataAwsccKinesisfirehoseDeliveryStreams.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccKinesisfirehoseDeliveryStreams.DataAwsccKinesisfirehoseDeliveryStreams.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccKinesisfirehoseDeliveryStreams.DataAwsccKinesisfirehoseDeliveryStreams.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKinesisfirehoseDeliveryStreams.DataAwsccKinesisfirehoseDeliveryStreams.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccKinesisfirehoseDeliveryStreams.DataAwsccKinesisfirehoseDeliveryStreams.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKinesisfirehoseDeliveryStreams.DataAwsccKinesisfirehoseDeliveryStreams.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKinesisfirehoseDeliveryStreams.DataAwsccKinesisfirehoseDeliveryStreams.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKinesisfirehoseDeliveryStreams.DataAwsccKinesisfirehoseDeliveryStreamsConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKinesisfirehoseDeliveryStreams.DataAwsccKinesisfirehoseDeliveryStreamsConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKinesisfirehoseDeliveryStreams.DataAwsccKinesisfirehoseDeliveryStreamsConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKinesisfirehoseDeliveryStreams.DataAwsccKinesisfirehoseDeliveryStreamsConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKinesisfirehoseDeliveryStreams.DataAwsccKinesisfirehoseDeliveryStreamsConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKinesisfirehoseDeliveryStreams.DataAwsccKinesisfirehoseDeliveryStreamsConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKinesisfirehoseDeliveryStreams.DataAwsccKinesisfirehoseDeliveryStreamsConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
