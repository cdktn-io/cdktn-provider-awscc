...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/connectcampaigns_campaign
...
export class ConnectcampaignsCampaign extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectcampaignsCampaign that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/connectcampaigns_campaign#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/connectcampaigns_campaign awscc_connectcampaigns_campaign} Resource
  *
  * @param scope The scope in which to define this construct
