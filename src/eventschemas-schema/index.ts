...
export class EventschemasSchema extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EventschemasSchema that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/eventschemas_schema#import import section} in the documentation of this resource for the id to use
