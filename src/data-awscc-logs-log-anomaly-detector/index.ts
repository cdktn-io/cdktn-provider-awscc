...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/logs_log_anomaly_detector
...
export class DataAwsccLogsLogAnomalyDetector extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccLogsLogAnomalyDetector that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/logs_log_anomaly_detector#import import section} in the documentation of this resource for the id to use
