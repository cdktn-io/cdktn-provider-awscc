...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/logs_account_policy
...
export class LogsAccountPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LogsAccountPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/logs_account_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/logs_account_policy awscc_logs_account_policy} Resource
  *
  * @param scope The scope in which to define this construct
