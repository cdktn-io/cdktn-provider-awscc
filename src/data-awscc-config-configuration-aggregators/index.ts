...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/config_configuration_aggregators
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/config_configuration_aggregators awscc_config_configuration_aggregators}
*/
export class DataAwsccConfigConfigurationAggregators extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccConfigConfigurationAggregators that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/config_configuration_aggregators#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/config_configuration_aggregators awscc_config_configuration_aggregators} Data Source
  *
  * @param scope The scope in which to define this construct
