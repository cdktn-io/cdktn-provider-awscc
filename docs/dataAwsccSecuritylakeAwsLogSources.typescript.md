...
```typescript
import { dataAwsccSecuritylakeAwsLogSources } from '@cdktn/provider-awscc'

new dataAwsccSecuritylakeAwsLogSources.DataAwsccSecuritylakeAwsLogSources(scope: Construct, id: string, config?: DataAwsccSecuritylakeAwsLogSourcesConfig)
```
...
dataAwsccSecuritylakeAwsLogSources.DataAwsccSecuritylakeAwsLogSources.isConstruct(x: any)
```
...
dataAwsccSecuritylakeAwsLogSources.DataAwsccSecuritylakeAwsLogSources.isTerraformElement(x: any)
```
...
dataAwsccSecuritylakeAwsLogSources.DataAwsccSecuritylakeAwsLogSources.isTerraformDataSource(x: any)
```
...
dataAwsccSecuritylakeAwsLogSources.DataAwsccSecuritylakeAwsLogSources.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecuritylakeAwsLogSources.DataAwsccSecuritylakeAwsLogSources.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecuritylakeAwsLogSources.DataAwsccSecuritylakeAwsLogSources.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecuritylakeAwsLogSources.DataAwsccSecuritylakeAwsLogSources.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecuritylakeAwsLogSources.DataAwsccSecuritylakeAwsLogSources.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecuritylakeAwsLogSources.DataAwsccSecuritylakeAwsLogSources.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccSecuritylakeAwsLogSourcesConfig: dataAwsccSecuritylakeAwsLogSources.DataAwsccSecuritylakeAwsLogSourcesConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecuritylakeAwsLogSources.DataAwsccSecuritylakeAwsLogSourcesConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecuritylakeAwsLogSources.DataAwsccSecuritylakeAwsLogSourcesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecuritylakeAwsLogSources.DataAwsccSecuritylakeAwsLogSourcesConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecuritylakeAwsLogSources.DataAwsccSecuritylakeAwsLogSourcesConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
