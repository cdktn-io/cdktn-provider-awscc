...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/s3tables_table_bucket_policies
...
export class DataAwsccS3TablesTableBucketPolicies extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccS3TablesTableBucketPolicies that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/s3tables_table_bucket_policies#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/s3tables_table_bucket_policies awscc_s3tables_table_bucket_policies} Data Source
  *
  * @param scope The scope in which to define this construct
