...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/rds_custom_db_engine_version
...
export class DataAwsccRdsCustomDbEngineVersion extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRdsCustomDbEngineVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/rds_custom_db_engine_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/rds_custom_db_engine_version awscc_rds_custom_db_engine_version} Data Source
  *
  * @param scope The scope in which to define this construct
