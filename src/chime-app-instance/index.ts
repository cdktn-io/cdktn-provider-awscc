...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/chime_app_instance
...
export class ChimeAppInstance extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ChimeAppInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/chime_app_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/chime_app_instance awscc_chime_app_instance} Resource
  *
  * @param scope The scope in which to define this construct
