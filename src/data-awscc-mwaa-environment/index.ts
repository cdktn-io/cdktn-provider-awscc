...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/mwaa_environment
...
export class DataAwsccMwaaEnvironment extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccMwaaEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/mwaa_environment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/mwaa_environment awscc_mwaa_environment} Data Source
  *
  * @param scope The scope in which to define this construct
