...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/fsx_volume
...
export class FsxVolume extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FsxVolume that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/fsx_volume#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/fsx_volume awscc_fsx_volume} Resource
  *
  * @param scope The scope in which to define this construct
