...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/s3outposts_endpoint
...
export class S3OutpostsEndpoint extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3OutpostsEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/s3outposts_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/s3outposts_endpoint awscc_s3outposts_endpoint} Resource
  *
  * @param scope The scope in which to define this construct
