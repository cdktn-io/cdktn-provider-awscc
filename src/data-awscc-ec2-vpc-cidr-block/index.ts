...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/ec2_vpc_cidr_block
...
export class DataAwsccEc2VpcCidrBlock extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEc2VpcCidrBlock that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/ec2_vpc_cidr_block#import import section} in the documentation of this resource for the id to use
