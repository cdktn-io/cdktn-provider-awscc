...
new DataAwsccObservabilityadminTelemetryEnrichments(Construct Scope, string Id, DataAwsccObservabilityadminTelemetryEnrichmentsConfig Config = null);
```
...
DataAwsccObservabilityadminTelemetryEnrichments.IsConstruct(object X);
```
...
DataAwsccObservabilityadminTelemetryEnrichments.IsTerraformElement(object X);
```
...
DataAwsccObservabilityadminTelemetryEnrichments.IsTerraformDataSource(object X);
```
...
DataAwsccObservabilityadminTelemetryEnrichments.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccObservabilityadminTelemetryEnrichments.DataAwsccObservabilityadminTelemetryEnrichments.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccObservabilityadminTelemetryEnrichments.DataAwsccObservabilityadminTelemetryEnrichments.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccObservabilityadminTelemetryEnrichments.DataAwsccObservabilityadminTelemetryEnrichments.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccObservabilityadminTelemetryEnrichments.DataAwsccObservabilityadminTelemetryEnrichments.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccObservabilityadminTelemetryEnrichments.DataAwsccObservabilityadminTelemetryEnrichments.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccObservabilityadminTelemetryEnrichments.DataAwsccObservabilityadminTelemetryEnrichments.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccObservabilityadminTelemetryEnrichments.DataAwsccObservabilityadminTelemetryEnrichments.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
...
new DataAwsccObservabilityadminTelemetryEnrichmentsConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccObservabilityadminTelemetryEnrichments.DataAwsccObservabilityadminTelemetryEnrichmentsConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccObservabilityadminTelemetryEnrichments.DataAwsccObservabilityadminTelemetryEnrichmentsConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccObservabilityadminTelemetryEnrichments.DataAwsccObservabilityadminTelemetryEnrichmentsConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccObservabilityadminTelemetryEnrichments.DataAwsccObservabilityadminTelemetryEnrichmentsConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccObservabilityadminTelemetryEnrichments.DataAwsccObservabilityadminTelemetryEnrichmentsConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccObservabilityadminTelemetryEnrichments.DataAwsccObservabilityadminTelemetryEnrichmentsConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccObservabilityadminTelemetryEnrichments.DataAwsccObservabilityadminTelemetryEnrichmentsConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
