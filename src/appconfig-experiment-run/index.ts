...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appconfig_experiment_run
...
export class AppconfigExperimentRun extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AppconfigExperimentRun that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appconfig_experiment_run#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appconfig_experiment_run awscc_appconfig_experiment_run} Resource
  *
  * @param scope The scope in which to define this construct
