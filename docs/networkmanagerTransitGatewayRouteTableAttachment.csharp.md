...
```csharp
public NetworkmanagerTransitGatewayRouteTableAttachmentProposedNetworkFunctionGroupChange InternalValue { get; }
```
...
```csharp
public NetworkmanagerTransitGatewayRouteTableAttachmentProposedNetworkFunctionGroupChangeTags InternalValue { get; }
```
...
```csharp
public NetworkmanagerTransitGatewayRouteTableAttachmentProposedSegmentChange InternalValue { get; }
```
...
```csharp
public NetworkmanagerTransitGatewayRouteTableAttachmentProposedSegmentChangeTags InternalValue { get; }
```
