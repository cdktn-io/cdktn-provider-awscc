...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iotwireless_fuota_task
...
export class IotwirelessFuotaTask extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotwirelessFuotaTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iotwireless_fuota_task#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iotwireless_fuota_task awscc_iotwireless_fuota_task} Resource
  *
  * @param scope The scope in which to define this construct
