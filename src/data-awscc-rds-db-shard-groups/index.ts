...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/rds_db_shard_groups
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/rds_db_shard_groups awscc_rds_db_shard_groups}
*/
export class DataAwsccRdsDbShardGroups extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRdsDbShardGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/rds_db_shard_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/rds_db_shard_groups awscc_rds_db_shard_groups} Data Source
  *
  * @param scope The scope in which to define this construct
