...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/fms_protocols_list
...
export class DataAwsccFmsProtocolsList extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccFmsProtocolsList that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/fms_protocols_list#import import section} in the documentation of this resource for the id to use
