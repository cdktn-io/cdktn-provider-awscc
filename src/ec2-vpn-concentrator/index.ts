...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/ec2_vpn_concentrator
...
export class Ec2VpnConcentrator extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2VpnConcentrator that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/ec2_vpn_concentrator#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/ec2_vpn_concentrator awscc_ec2_vpn_concentrator} Resource
  *
  * @param scope The scope in which to define this construct
