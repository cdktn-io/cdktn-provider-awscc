...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/iotsitewise_portal
...
export class IotsitewisePortal extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotsitewisePortal that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/iotsitewise_portal#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/iotsitewise_portal awscc_iotsitewise_portal} Resource
  *
  * @param scope The scope in which to define this construct
