...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/securityagent_security_requirement_packs
...
export class DataAwsccSecurityagentSecurityRequirementPacks extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccSecurityagentSecurityRequirementPacks that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/securityagent_security_requirement_packs#import import section} in the documentation of this resource for the id to use
