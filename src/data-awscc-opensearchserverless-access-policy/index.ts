...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/opensearchserverless_access_policy
...
export class DataAwsccOpensearchserverlessAccessPolicy extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccOpensearchserverlessAccessPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/opensearchserverless_access_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/opensearchserverless_access_policy awscc_opensearchserverless_access_policy} Data Source
  *
  * @param scope The scope in which to define this construct
