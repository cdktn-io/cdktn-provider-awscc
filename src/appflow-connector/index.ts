...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/appflow_connector
...
export class AppflowConnector extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AppflowConnector that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/appflow_connector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/appflow_connector awscc_appflow_connector} Resource
  *
  * @param scope The scope in which to define this construct
