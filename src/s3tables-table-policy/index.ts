...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/s3tables_table_policy
...
export class S3TablesTablePolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3TablesTablePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/s3tables_table_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/s3tables_table_policy awscc_s3tables_table_policy} Resource
  *
  * @param scope The scope in which to define this construct
