...
```typescript
import { dataAwsccFrauddetectorVariable } from '@cdktn/provider-awscc'

new dataAwsccFrauddetectorVariable.DataAwsccFrauddetectorVariable(scope: Construct, id: string, config: DataAwsccFrauddetectorVariableConfig)
```
...
dataAwsccFrauddetectorVariable.DataAwsccFrauddetectorVariable.isConstruct(x: any)
```
...
dataAwsccFrauddetectorVariable.DataAwsccFrauddetectorVariable.isTerraformElement(x: any)
```
...
dataAwsccFrauddetectorVariable.DataAwsccFrauddetectorVariable.isTerraformDataSource(x: any)
```
...
dataAwsccFrauddetectorVariable.DataAwsccFrauddetectorVariable.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccFrauddetectorVariable.DataAwsccFrauddetectorVariable.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccFrauddetectorVariable.DataAwsccFrauddetectorVariable.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccFrauddetectorVariable.DataAwsccFrauddetectorVariable.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccFrauddetectorVariable.DataAwsccFrauddetectorVariable.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccFrauddetectorVariable.DataAwsccFrauddetectorVariable.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
```typescript
public readonly tags: DataAwsccFrauddetectorVariableTagsList;
```
...
const dataAwsccFrauddetectorVariableConfig: dataAwsccFrauddetectorVariable.DataAwsccFrauddetectorVariableConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccFrauddetectorVariable.DataAwsccFrauddetectorVariableConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccFrauddetectorVariable.DataAwsccFrauddetectorVariableConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccFrauddetectorVariable.DataAwsccFrauddetectorVariableConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccFrauddetectorVariable.DataAwsccFrauddetectorVariableConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const dataAwsccFrauddetectorVariableTags: dataAwsccFrauddetectorVariable.DataAwsccFrauddetectorVariableTags = { ... }
```
...
new dataAwsccFrauddetectorVariable.DataAwsccFrauddetectorVariableTagsList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccFrauddetectorVariable.DataAwsccFrauddetectorVariableTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccFrauddetectorVariable.DataAwsccFrauddetectorVariableTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
new dataAwsccFrauddetectorVariable.DataAwsccFrauddetectorVariableTagsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccFrauddetectorVariable.DataAwsccFrauddetectorVariableTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccFrauddetectorVariable.DataAwsccFrauddetectorVariableTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccFrauddetectorVariable.DataAwsccFrauddetectorVariableTagsOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```typescript
public readonly internalValue: DataAwsccFrauddetectorVariableTags;
```
