...
```typescript
import { dataAwsccRtbfabricRequesterGateways } from '@cdktn/provider-awscc'

new dataAwsccRtbfabricRequesterGateways.DataAwsccRtbfabricRequesterGateways(scope: Construct, id: string, config?: DataAwsccRtbfabricRequesterGatewaysConfig)
```
...
dataAwsccRtbfabricRequesterGateways.DataAwsccRtbfabricRequesterGateways.isConstruct(x: any)
```
...
dataAwsccRtbfabricRequesterGateways.DataAwsccRtbfabricRequesterGateways.isTerraformElement(x: any)
```
...
dataAwsccRtbfabricRequesterGateways.DataAwsccRtbfabricRequesterGateways.isTerraformDataSource(x: any)
```
...
dataAwsccRtbfabricRequesterGateways.DataAwsccRtbfabricRequesterGateways.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRtbfabricRequesterGateways.DataAwsccRtbfabricRequesterGateways.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRtbfabricRequesterGateways.DataAwsccRtbfabricRequesterGateways.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRtbfabricRequesterGateways.DataAwsccRtbfabricRequesterGateways.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRtbfabricRequesterGateways.DataAwsccRtbfabricRequesterGateways.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRtbfabricRequesterGateways.DataAwsccRtbfabricRequesterGateways.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccRtbfabricRequesterGatewaysConfig: dataAwsccRtbfabricRequesterGateways.DataAwsccRtbfabricRequesterGatewaysConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRtbfabricRequesterGateways.DataAwsccRtbfabricRequesterGatewaysConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRtbfabricRequesterGateways.DataAwsccRtbfabricRequesterGatewaysConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRtbfabricRequesterGateways.DataAwsccRtbfabricRequesterGatewaysConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRtbfabricRequesterGateways.DataAwsccRtbfabricRequesterGatewaysConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
