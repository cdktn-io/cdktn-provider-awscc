...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/apigateway_model
...
export class ApigatewayModel extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApigatewayModel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/apigateway_model#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/apigateway_model awscc_apigateway_model} Resource
  *
  * @param scope The scope in which to define this construct
