...
export interface OdbOdbNetworkTags {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/odb_odb_network#key OdbOdbNetwork#key}
  */
  readonly key?: string;
  /**
...
export class OdbOdbNetwork extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OdbOdbNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/odb_odb_network#import import section} in the documentation of this resource for the id to use
