...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/auditmanager_assessments
...
export class DataAwsccAuditmanagerAssessments extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccAuditmanagerAssessments that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/auditmanager_assessments#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/auditmanager_assessments awscc_auditmanager_assessments} Data Source
  *
  * @param scope The scope in which to define this construct
