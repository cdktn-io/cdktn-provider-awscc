...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/iotanalytics_dataset
...
export class DataAwsccIotanalyticsDataset extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIotanalyticsDataset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/iotanalytics_dataset#import import section} in the documentation of this resource for the id to use
