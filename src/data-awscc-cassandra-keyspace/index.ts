...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/cassandra_keyspace
...
export class DataAwsccCassandraKeyspace extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCassandraKeyspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/cassandra_keyspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/cassandra_keyspace awscc_cassandra_keyspace} Data Source
  *
  * @param scope The scope in which to define this construct
