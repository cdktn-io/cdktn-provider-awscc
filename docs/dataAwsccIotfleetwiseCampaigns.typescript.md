...
Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/iotfleetwise_campaigns awscc_iotfleetwise_campaigns}.
...
```typescript
import { dataAwsccIotfleetwiseCampaigns } from '@cdktn/provider-awscc'

new dataAwsccIotfleetwiseCampaigns.DataAwsccIotfleetwiseCampaigns(scope: Construct, id: string, config?: DataAwsccIotfleetwiseCampaignsConfig)
```
...
dataAwsccIotfleetwiseCampaigns.DataAwsccIotfleetwiseCampaigns.isConstruct(x: any)
```
...
dataAwsccIotfleetwiseCampaigns.DataAwsccIotfleetwiseCampaigns.isTerraformElement(x: any)
```
...
dataAwsccIotfleetwiseCampaigns.DataAwsccIotfleetwiseCampaigns.isTerraformDataSource(x: any)
```
...
dataAwsccIotfleetwiseCampaigns.DataAwsccIotfleetwiseCampaigns.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/iotfleetwise_campaigns#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotfleetwiseCampaigns.DataAwsccIotfleetwiseCampaigns.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotfleetwiseCampaigns.DataAwsccIotfleetwiseCampaigns.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotfleetwiseCampaigns.DataAwsccIotfleetwiseCampaigns.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotfleetwiseCampaigns.DataAwsccIotfleetwiseCampaigns.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotfleetwiseCampaigns.DataAwsccIotfleetwiseCampaigns.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotfleetwiseCampaigns.DataAwsccIotfleetwiseCampaigns.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotfleetwiseCampaigns.DataAwsccIotfleetwiseCampaigns.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
...
const dataAwsccIotfleetwiseCampaignsConfig: dataAwsccIotfleetwiseCampaigns.DataAwsccIotfleetwiseCampaignsConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotfleetwiseCampaigns.DataAwsccIotfleetwiseCampaignsConfig.property.connection">connection</a></code> | <code>cdktn.SSHProvisionerConnection \| cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotfleetwiseCampaigns.DataAwsccIotfleetwiseCampaignsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotfleetwiseCampaigns.DataAwsccIotfleetwiseCampaignsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotfleetwiseCampaigns.DataAwsccIotfleetwiseCampaignsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotfleetwiseCampaigns.DataAwsccIotfleetwiseCampaignsConfig.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotfleetwiseCampaigns.DataAwsccIotfleetwiseCampaignsConfig.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotfleetwiseCampaigns.DataAwsccIotfleetwiseCampaignsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
