...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ec2_key_pair
...
export class Ec2KeyPair extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2KeyPair that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ec2_key_pair#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ec2_key_pair awscc_ec2_key_pair} Resource
  *
  * @param scope The scope in which to define this construct
