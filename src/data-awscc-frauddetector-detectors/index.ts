...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/frauddetector_detectors
...
export class DataAwsccFrauddetectorDetectors extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccFrauddetectorDetectors that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/frauddetector_detectors#import import section} in the documentation of this resource for the id to use
