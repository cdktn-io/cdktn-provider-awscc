...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/panorama_package_version
...
export class DataAwsccPanoramaPackageVersion extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccPanoramaPackageVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/panorama_package_version#import import section} in the documentation of this resource for the id to use
