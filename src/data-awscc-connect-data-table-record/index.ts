...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/connect_data_table_record
...
export class DataAwsccConnectDataTableRecord extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccConnectDataTableRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/connect_data_table_record#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/connect_data_table_record awscc_connect_data_table_record} Data Source
  *
  * @param scope The scope in which to define this construct
