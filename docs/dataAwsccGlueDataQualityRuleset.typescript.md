...
```typescript
import { dataAwsccGlueDataQualityRuleset } from '@cdktn/provider-awscc'

new dataAwsccGlueDataQualityRuleset.DataAwsccGlueDataQualityRuleset(scope: Construct, id: string, config: DataAwsccGlueDataQualityRulesetConfig)
```
...
dataAwsccGlueDataQualityRuleset.DataAwsccGlueDataQualityRuleset.isConstruct(x: any)
```
...
dataAwsccGlueDataQualityRuleset.DataAwsccGlueDataQualityRuleset.isTerraformElement(x: any)
```
...
dataAwsccGlueDataQualityRuleset.DataAwsccGlueDataQualityRuleset.isTerraformDataSource(x: any)
```
...
dataAwsccGlueDataQualityRuleset.DataAwsccGlueDataQualityRuleset.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGlueDataQualityRuleset.DataAwsccGlueDataQualityRuleset.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGlueDataQualityRuleset.DataAwsccGlueDataQualityRuleset.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGlueDataQualityRuleset.DataAwsccGlueDataQualityRuleset.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGlueDataQualityRuleset.DataAwsccGlueDataQualityRuleset.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGlueDataQualityRuleset.DataAwsccGlueDataQualityRuleset.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
```typescript
public readonly targetTable: DataAwsccGlueDataQualityRulesetTargetTableOutputReference;
```
...
const dataAwsccGlueDataQualityRulesetConfig: dataAwsccGlueDataQualityRuleset.DataAwsccGlueDataQualityRulesetConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGlueDataQualityRuleset.DataAwsccGlueDataQualityRulesetConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGlueDataQualityRuleset.DataAwsccGlueDataQualityRulesetConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGlueDataQualityRuleset.DataAwsccGlueDataQualityRulesetConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGlueDataQualityRuleset.DataAwsccGlueDataQualityRulesetConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const dataAwsccGlueDataQualityRulesetTargetTable: dataAwsccGlueDataQualityRuleset.DataAwsccGlueDataQualityRulesetTargetTable = { ... }
```
...
new dataAwsccGlueDataQualityRuleset.DataAwsccGlueDataQualityRulesetTargetTableOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGlueDataQualityRuleset.DataAwsccGlueDataQualityRulesetTargetTableOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public readonly internalValue: DataAwsccGlueDataQualityRulesetTargetTable;
```
