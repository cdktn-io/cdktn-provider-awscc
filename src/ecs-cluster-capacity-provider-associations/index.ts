...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ecs_cluster_capacity_provider_associations
...
export class EcsClusterCapacityProviderAssociations extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EcsClusterCapacityProviderAssociations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ecs_cluster_capacity_provider_associations#import import section} in the documentation of this resource for the id to use
