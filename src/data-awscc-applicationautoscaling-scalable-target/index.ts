...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/applicationautoscaling_scalable_target
...
export interface DataAwsccApplicationautoscalingScalableTargetTags {
}

export function dataAwsccApplicationautoscalingScalableTargetTagsToTerraform(struct?: DataAwsccApplicationautoscalingScalableTargetTags): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsccApplicationautoscalingScalableTargetTagsToHclTerraform(struct?: DataAwsccApplicationautoscalingScalableTargetTags): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsccApplicationautoscalingScalableTargetTagsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAwsccApplicationautoscalingScalableTargetTags | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsccApplicationautoscalingScalableTargetTags | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataAwsccApplicationautoscalingScalableTargetTagsList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataAwsccApplicationautoscalingScalableTargetTagsOutputReference {
    return new DataAwsccApplicationautoscalingScalableTargetTagsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAwsccApplicationautoscalingScalableTarget extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccApplicationautoscalingScalableTarget that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/applicationautoscaling_scalable_target#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _tags = new DataAwsccApplicationautoscalingScalableTargetTagsList(this, "tags", true);
  public get tags() {
    return this._tags;
  }
