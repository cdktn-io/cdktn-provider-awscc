...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/scn_dataset
...
export class ScnDataset extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ScnDataset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/scn_dataset#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/scn_dataset awscc_scn_dataset} Resource
  *
  * @param scope The scope in which to define this construct
