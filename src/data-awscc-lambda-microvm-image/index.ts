...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/lambda_microvm_image
...
export class DataAwsccLambdaMicrovmImage extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccLambdaMicrovmImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/lambda_microvm_image#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/lambda_microvm_image awscc_lambda_microvm_image} Data Source
  *
  * @param scope The scope in which to define this construct
