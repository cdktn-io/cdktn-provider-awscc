...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/aps_scraper
...
export class DataAwsccApsScraper extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccApsScraper that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/aps_scraper#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/aps_scraper awscc_aps_scraper} Data Source
  *
  * @param scope The scope in which to define this construct
