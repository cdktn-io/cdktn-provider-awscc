...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/omics_run_cache
...
export class OmicsRunCache extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OmicsRunCache that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/omics_run_cache#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/omics_run_cache awscc_omics_run_cache} Resource
  *
  * @param scope The scope in which to define this construct
