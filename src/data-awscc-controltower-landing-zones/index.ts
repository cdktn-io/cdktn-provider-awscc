...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/controltower_landing_zones
...
export class DataAwsccControltowerLandingZones extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccControltowerLandingZones that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/controltower_landing_zones#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/controltower_landing_zones awscc_controltower_landing_zones} Data Source
  *
  * @param scope The scope in which to define this construct
