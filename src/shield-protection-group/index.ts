...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/shield_protection_group
...
export class ShieldProtectionGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ShieldProtectionGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/shield_protection_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/shield_protection_group awscc_shield_protection_group} Resource
  *
  * @param scope The scope in which to define this construct
