...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/events_archive
...
export class DataAwsccEventsArchive extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEventsArchive that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/events_archive#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/events_archive awscc_events_archive} Data Source
  *
  * @param scope The scope in which to define this construct
