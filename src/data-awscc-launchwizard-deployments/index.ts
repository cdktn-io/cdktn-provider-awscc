...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/launchwizard_deployments
...
export class DataAwsccLaunchwizardDeployments extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccLaunchwizardDeployments that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/launchwizard_deployments#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/launchwizard_deployments awscc_launchwizard_deployments} Data Source
  *
  * @param scope The scope in which to define this construct
