...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/iam_saml_provider
...
export class IamSamlProvider extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IamSamlProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/iam_saml_provider#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/iam_saml_provider awscc_iam_saml_provider} Resource
  *
  * @param scope The scope in which to define this construct
