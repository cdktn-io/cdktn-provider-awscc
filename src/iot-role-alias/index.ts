...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/iot_role_alias
...
export class IotRoleAlias extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotRoleAlias that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/iot_role_alias#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/iot_role_alias awscc_iot_role_alias} Resource
  *
  * @param scope The scope in which to define this construct
