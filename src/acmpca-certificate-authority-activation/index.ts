...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/acmpca_certificate_authority_activation
...
export class AcmpcaCertificateAuthorityActivation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AcmpcaCertificateAuthorityActivation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/acmpca_certificate_authority_activation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/acmpca_certificate_authority_activation awscc_acmpca_certificate_authority_activation} Resource
  *
  * @param scope The scope in which to define this construct
