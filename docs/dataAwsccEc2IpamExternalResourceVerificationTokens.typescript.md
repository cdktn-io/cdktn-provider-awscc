...
Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ec2_ipam_external_resource_verification_tokens awscc_ec2_ipam_external_resource_verification_tokens}.
...
```typescript
import { dataAwsccEc2IpamExternalResourceVerificationTokens } from '@cdktn/provider-awscc'

new dataAwsccEc2IpamExternalResourceVerificationTokens.DataAwsccEc2IpamExternalResourceVerificationTokens(scope: Construct, id: string, config?: DataAwsccEc2IpamExternalResourceVerificationTokensConfig)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2IpamExternalResourceVerificationTokens.DataAwsccEc2IpamExternalResourceVerificationTokens.Initializer.parameter.scope">scope</a></code> | <code>constructs.Construct</code> | The scope in which to define this construct. |
...
dataAwsccEc2IpamExternalResourceVerificationTokens.DataAwsccEc2IpamExternalResourceVerificationTokens.isConstruct(x: any)
```
...
dataAwsccEc2IpamExternalResourceVerificationTokens.DataAwsccEc2IpamExternalResourceVerificationTokens.isTerraformElement(x: any)
```
...
dataAwsccEc2IpamExternalResourceVerificationTokens.DataAwsccEc2IpamExternalResourceVerificationTokens.isTerraformDataSource(x: any)
```
...
dataAwsccEc2IpamExternalResourceVerificationTokens.DataAwsccEc2IpamExternalResourceVerificationTokens.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ec2_ipam_external_resource_verification_tokens#import import section} in the documentation of this resource for the id to use
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2IpamExternalResourceVerificationTokens.DataAwsccEc2IpamExternalResourceVerificationTokens.property.node">node</a></code> | <code>constructs.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2IpamExternalResourceVerificationTokens.DataAwsccEc2IpamExternalResourceVerificationTokens.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2IpamExternalResourceVerificationTokens.DataAwsccEc2IpamExternalResourceVerificationTokens.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2IpamExternalResourceVerificationTokens.DataAwsccEc2IpamExternalResourceVerificationTokens.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2IpamExternalResourceVerificationTokens.DataAwsccEc2IpamExternalResourceVerificationTokens.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2IpamExternalResourceVerificationTokens.DataAwsccEc2IpamExternalResourceVerificationTokens.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2IpamExternalResourceVerificationTokens.DataAwsccEc2IpamExternalResourceVerificationTokens.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2IpamExternalResourceVerificationTokens.DataAwsccEc2IpamExternalResourceVerificationTokens.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
...
const dataAwsccEc2IpamExternalResourceVerificationTokensConfig: dataAwsccEc2IpamExternalResourceVerificationTokens.DataAwsccEc2IpamExternalResourceVerificationTokensConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2IpamExternalResourceVerificationTokens.DataAwsccEc2IpamExternalResourceVerificationTokensConfig.property.connection">connection</a></code> | <code>cdktn.SSHProvisionerConnection \| cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2IpamExternalResourceVerificationTokens.DataAwsccEc2IpamExternalResourceVerificationTokensConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2IpamExternalResourceVerificationTokens.DataAwsccEc2IpamExternalResourceVerificationTokensConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2IpamExternalResourceVerificationTokens.DataAwsccEc2IpamExternalResourceVerificationTokensConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2IpamExternalResourceVerificationTokens.DataAwsccEc2IpamExternalResourceVerificationTokensConfig.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2IpamExternalResourceVerificationTokens.DataAwsccEc2IpamExternalResourceVerificationTokensConfig.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2IpamExternalResourceVerificationTokens.DataAwsccEc2IpamExternalResourceVerificationTokensConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
