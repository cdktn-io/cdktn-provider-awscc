...
Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/kafkaconnect_worker_configuration awscc_kafkaconnect_worker_configuration}.
...
```typescript
import { dataAwsccKafkaconnectWorkerConfiguration } from '@cdktn/provider-awscc'

new dataAwsccKafkaconnectWorkerConfiguration.DataAwsccKafkaconnectWorkerConfiguration(scope: Construct, id: string, config: DataAwsccKafkaconnectWorkerConfigurationConfig)
```
...
dataAwsccKafkaconnectWorkerConfiguration.DataAwsccKafkaconnectWorkerConfiguration.isConstruct(x: any)
```
...
dataAwsccKafkaconnectWorkerConfiguration.DataAwsccKafkaconnectWorkerConfiguration.isTerraformElement(x: any)
```
...
dataAwsccKafkaconnectWorkerConfiguration.DataAwsccKafkaconnectWorkerConfiguration.isTerraformDataSource(x: any)
```
...
dataAwsccKafkaconnectWorkerConfiguration.DataAwsccKafkaconnectWorkerConfiguration.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/kafkaconnect_worker_configuration#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectWorkerConfiguration.DataAwsccKafkaconnectWorkerConfiguration.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectWorkerConfiguration.DataAwsccKafkaconnectWorkerConfiguration.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectWorkerConfiguration.DataAwsccKafkaconnectWorkerConfiguration.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectWorkerConfiguration.DataAwsccKafkaconnectWorkerConfiguration.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectWorkerConfiguration.DataAwsccKafkaconnectWorkerConfiguration.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectWorkerConfiguration.DataAwsccKafkaconnectWorkerConfiguration.property.revision">revision</a></code> | <code>number</code> | *No description.* |
...
```typescript
public readonly tags: DataAwsccKafkaconnectWorkerConfigurationTagsList;
```
...
const dataAwsccKafkaconnectWorkerConfigurationConfig: dataAwsccKafkaconnectWorkerConfiguration.DataAwsccKafkaconnectWorkerConfigurationConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectWorkerConfiguration.DataAwsccKafkaconnectWorkerConfigurationConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectWorkerConfiguration.DataAwsccKafkaconnectWorkerConfigurationConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectWorkerConfiguration.DataAwsccKafkaconnectWorkerConfigurationConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectWorkerConfiguration.DataAwsccKafkaconnectWorkerConfigurationConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/kafkaconnect_worker_configuration#id DataAwsccKafkaconnectWorkerConfiguration#id}
...
const dataAwsccKafkaconnectWorkerConfigurationTags: dataAwsccKafkaconnectWorkerConfiguration.DataAwsccKafkaconnectWorkerConfigurationTags = { ... }
```
...
new dataAwsccKafkaconnectWorkerConfiguration.DataAwsccKafkaconnectWorkerConfigurationTagsList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectWorkerConfiguration.DataAwsccKafkaconnectWorkerConfigurationTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectWorkerConfiguration.DataAwsccKafkaconnectWorkerConfigurationTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```typescript
public get(index: number): DataAwsccKafkaconnectWorkerConfigurationTagsOutputReference
```
...
new dataAwsccKafkaconnectWorkerConfiguration.DataAwsccKafkaconnectWorkerConfigurationTagsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectWorkerConfiguration.DataAwsccKafkaconnectWorkerConfigurationTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectWorkerConfiguration.DataAwsccKafkaconnectWorkerConfigurationTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
...
```typescript
public readonly internalValue: DataAwsccKafkaconnectWorkerConfigurationTags;
```
