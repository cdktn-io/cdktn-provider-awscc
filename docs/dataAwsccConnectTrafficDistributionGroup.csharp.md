...
new DataAwsccConnectTrafficDistributionGroup(Construct Scope, string Id, DataAwsccConnectTrafficDistributionGroupConfig Config);
```
...
DataAwsccConnectTrafficDistributionGroup.IsConstruct(object X);
```
...
DataAwsccConnectTrafficDistributionGroup.IsTerraformElement(object X);
```
...
DataAwsccConnectTrafficDistributionGroup.IsTerraformDataSource(object X);
```
...
DataAwsccConnectTrafficDistributionGroup.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccConnectTrafficDistributionGroup.DataAwsccConnectTrafficDistributionGroup.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccConnectTrafficDistributionGroup.DataAwsccConnectTrafficDistributionGroup.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccConnectTrafficDistributionGroup.DataAwsccConnectTrafficDistributionGroup.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccConnectTrafficDistributionGroup.DataAwsccConnectTrafficDistributionGroup.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccConnectTrafficDistributionGroup.DataAwsccConnectTrafficDistributionGroup.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccConnectTrafficDistributionGroup.DataAwsccConnectTrafficDistributionGroup.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccConnectTrafficDistributionGroup.DataAwsccConnectTrafficDistributionGroup.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccConnectTrafficDistributionGroup.DataAwsccConnectTrafficDistributionGroup.property.isDefault">IsDefault</a></code> | <code>Io.Cdktn.IResolvable</code> | *No description.* |
...
```csharp
public DataAwsccConnectTrafficDistributionGroupTagsList Tags { get; }
```
...
new DataAwsccConnectTrafficDistributionGroupConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccConnectTrafficDistributionGroup.DataAwsccConnectTrafficDistributionGroupConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccConnectTrafficDistributionGroup.DataAwsccConnectTrafficDistributionGroupConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccConnectTrafficDistributionGroup.DataAwsccConnectTrafficDistributionGroupConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccConnectTrafficDistributionGroup.DataAwsccConnectTrafficDistributionGroupConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccConnectTrafficDistributionGroup.DataAwsccConnectTrafficDistributionGroupConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccConnectTrafficDistributionGroup.DataAwsccConnectTrafficDistributionGroupConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccConnectTrafficDistributionGroup.DataAwsccConnectTrafficDistributionGroupConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
new DataAwsccConnectTrafficDistributionGroupTags {
...
new DataAwsccConnectTrafficDistributionGroupTagsList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccConnectTrafficDistributionGroup.DataAwsccConnectTrafficDistributionGroupTagsList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.dataAwsccConnectTrafficDistributionGroup.DataAwsccConnectTrafficDistributionGroupTagsList.resolve.parameter._context"></a>
...
```csharp
private DataAwsccConnectTrafficDistributionGroupTagsOutputReference Get(double Index)
```
...
new DataAwsccConnectTrafficDistributionGroupTagsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccConnectTrafficDistributionGroup.DataAwsccConnectTrafficDistributionGroupTagsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccConnectTrafficDistributionGroup.DataAwsccConnectTrafficDistributionGroupTagsOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.dataAwsccConnectTrafficDistributionGroup.DataAwsccConnectTrafficDistributionGroupTagsOutputReference.resolve.parameter._context"></a>
...
```csharp
public DataAwsccConnectTrafficDistributionGroupTags InternalValue { get; }
```
