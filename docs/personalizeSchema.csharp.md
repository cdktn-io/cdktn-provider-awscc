...
```csharp
private void PutTags(IResolvable|PersonalizeSchemaTags[] Value)
```
...
- *Type:* Io.Cdktn.IResolvable|<a href="#@cdktn/provider-awscc.personalizeSchema.PersonalizeSchemaTags">PersonalizeSchemaTags</a>[]
...
| <code><a href="#@cdktn/provider-awscc.personalizeSchema.PersonalizeSchema.property.tagsInput">TagsInput</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.personalizeSchema.PersonalizeSchemaTags">PersonalizeSchemaTags</a>[]</code> | *No description.* |
...
```csharp
public PersonalizeSchemaTagsList Tags { get; }
```
...
```csharp
public IResolvable|PersonalizeSchemaTags[] TagsInput { get; }
```
...
new PersonalizeSchemaConfig {
    ...
    string Schema,
    string Domain = null,
    IResolvable|PersonalizeSchemaTags[] Tags = null
};
```
...
| <code><a href="#@cdktn/provider-awscc.personalizeSchema.PersonalizeSchemaConfig.property.tags">Tags</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.personalizeSchema.PersonalizeSchemaTags">PersonalizeSchemaTags</a>[]</code> | The tags used to organize, track, or control access for this resource. |
...
```csharp
public IResolvable|PersonalizeSchemaTags[] Tags { get; set; }
```
...
new PersonalizeSchemaTagsList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.personalizeSchema.PersonalizeSchemaTagsList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.personalizeSchema.PersonalizeSchemaTagsList.resolve.parameter._context"></a>
...
```csharp
private PersonalizeSchemaTagsOutputReference Get(double Index)
```
...
| <code><a href="#@cdktn/provider-awscc.personalizeSchema.PersonalizeSchemaTagsList.property.internalValue">InternalValue</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.personalizeSchema.PersonalizeSchemaTags">PersonalizeSchemaTags</a>[]</code> | *No description.* |
...
```csharp
public IResolvable|PersonalizeSchemaTags[] InternalValue { get; }
```
...
new PersonalizeSchemaTagsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.personalizeSchema.PersonalizeSchemaTagsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.personalizeSchema.PersonalizeSchemaTagsOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.personalizeSchema.PersonalizeSchemaTagsOutputReference.resolve.parameter._context"></a>
...
| <code><a href="#@cdktn/provider-awscc.personalizeSchema.PersonalizeSchemaTagsOutputReference.property.internalValue">InternalValue</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.personalizeSchema.PersonalizeSchemaTags">PersonalizeSchemaTags</a></code> | *No description.* |
