...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/connect_quick_connect
...
export interface DataAwsccConnectQuickConnectQuickConnectConfigFlowConfig {
}

export function dataAwsccConnectQuickConnectQuickConnectConfigFlowConfigToTerraform(struct?: DataAwsccConnectQuickConnectQuickConnectConfigFlowConfig): any {
...
export function dataAwsccConnectQuickConnectQuickConnectConfigFlowConfigToHclTerraform(struct?: DataAwsccConnectQuickConnectQuickConnectConfigFlowConfig): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsccConnectQuickConnectQuickConnectConfigFlowConfigOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAwsccConnectQuickConnectQuickConnectConfigFlowConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsccConnectQuickConnectQuickConnectConfigFlowConfig | undefined) {
    if (value === undefined) {
...
export class DataAwsccConnectQuickConnectQuickConnectConfigOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  // flow_config - computed: true, optional: false, required: false
  private _flowConfig = new DataAwsccConnectQuickConnectQuickConnectConfigFlowConfigOutputReference(this, "flow_config");
...
export class DataAwsccConnectQuickConnect extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccConnectQuickConnect that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/connect_quick_connect#import import section} in the documentation of this resource for the id to use
