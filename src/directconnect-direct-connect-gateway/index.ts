...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/directconnect_direct_connect_gateway
...
export interface DirectconnectDirectConnectGatewayConfig extends cdktn.TerraformMetaArguments {
  /**
...
export interface DirectconnectDirectConnectGatewayTags {
  /**
...
export function directconnectDirectConnectGatewayTagsToTerraform(struct?: DirectconnectDirectConnectGatewayTags | cdktn.IResolvable): any {
...
export function directconnectDirectConnectGatewayTagsToHclTerraform(struct?: DirectconnectDirectConnectGatewayTags | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DirectconnectDirectConnectGatewayTagsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DirectconnectDirectConnectGatewayTags | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DirectconnectDirectConnectGatewayTags | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class DirectconnectDirectConnectGatewayTagsList extends cdktn.ComplexList {
  public internalValue? : DirectconnectDirectConnectGatewayTags[] | cdktn.IResolvable
  ...
  */
  public get(index: number): DirectconnectDirectConnectGatewayTagsOutputReference {
    return new DirectconnectDirectConnectGatewayTagsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DirectconnectDirectConnectGateway extends cdktn.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "awscc_directconnect_direct_connect_gateway";
  ...
  * @param importFromId The id of the existing DirectconnectDirectConnectGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/directconnect_direct_connect_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "awscc_directconnect_direct_connect_gateway", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/directconnect_direct_connect_gateway awscc_directconnect_direct_connect_gateway} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DirectconnectDirectConnectGatewayConfig
  */
  public constructor(scope: Construct, id: string, config: DirectconnectDirectConnectGatewayConfig) {
    super(scope, id, {
    ...
    this._directConnectGatewayName = config.directConnectGatewayName;
  ...
  // direct_connect_gateway_arn - computed: true, optional: false, required: false
  ...
  public set directConnectGatewayName(value: string) {
    this._directConnectGatewayName = value;
  }
  // Temporarily expose input value. Use with caution.
  public get directConnectGatewayNameInput() {
    return this._directConnectGatewayName;
  }
  ...
  private _tags = new DirectconnectDirectConnectGatewayTagsList(this, "tags", true);
  public get tags() {
    return this._tags;
  }
  public putTags(value: DirectconnectDirectConnectGatewayTags[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      direct_connect_gateway_name: cdktn.stringToTerraform(this._directConnectGatewayName),
      tags: cdktn.listMapper(directconnectDirectConnectGatewayTagsToTerraform, false)(this._tags.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      direct_connect_gateway_name: {
        value: cdktn.stringToHclTerraform(this._directConnectGatewayName),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      tags: {
        value: cdktn.listMapperHcl(directconnectDirectConnectGatewayTagsToHclTerraform, false)(this._tags.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "DirectconnectDirectConnectGatewayTagsList",
      },
    };
