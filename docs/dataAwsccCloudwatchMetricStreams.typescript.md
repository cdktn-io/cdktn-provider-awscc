...
```typescript
import { dataAwsccCloudwatchMetricStreams } from '@cdktn/provider-awscc'

new dataAwsccCloudwatchMetricStreams.DataAwsccCloudwatchMetricStreams(scope: Construct, id: string, config?: DataAwsccCloudwatchMetricStreamsConfig)
```
...
dataAwsccCloudwatchMetricStreams.DataAwsccCloudwatchMetricStreams.isConstruct(x: any)
```
...
dataAwsccCloudwatchMetricStreams.DataAwsccCloudwatchMetricStreams.isTerraformElement(x: any)
```
...
dataAwsccCloudwatchMetricStreams.DataAwsccCloudwatchMetricStreams.isTerraformDataSource(x: any)
```
...
dataAwsccCloudwatchMetricStreams.DataAwsccCloudwatchMetricStreams.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchMetricStreams.DataAwsccCloudwatchMetricStreams.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchMetricStreams.DataAwsccCloudwatchMetricStreams.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchMetricStreams.DataAwsccCloudwatchMetricStreams.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchMetricStreams.DataAwsccCloudwatchMetricStreams.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchMetricStreams.DataAwsccCloudwatchMetricStreams.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchMetricStreams.DataAwsccCloudwatchMetricStreams.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchMetricStreams.DataAwsccCloudwatchMetricStreams.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
...
const dataAwsccCloudwatchMetricStreamsConfig: dataAwsccCloudwatchMetricStreams.DataAwsccCloudwatchMetricStreamsConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchMetricStreams.DataAwsccCloudwatchMetricStreamsConfig.property.connection">connection</a></code> | <code>cdktn.SSHProvisionerConnection \| cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchMetricStreams.DataAwsccCloudwatchMetricStreamsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchMetricStreams.DataAwsccCloudwatchMetricStreamsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchMetricStreams.DataAwsccCloudwatchMetricStreamsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchMetricStreams.DataAwsccCloudwatchMetricStreamsConfig.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchMetricStreams.DataAwsccCloudwatchMetricStreamsConfig.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchMetricStreams.DataAwsccCloudwatchMetricStreamsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
