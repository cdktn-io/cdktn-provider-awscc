...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/quicksight_knowledge_bases
...
export class DataAwsccQuicksightKnowledgeBases extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccQuicksightKnowledgeBases that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/quicksight_knowledge_bases#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/quicksight_knowledge_bases awscc_quicksight_knowledge_bases} Data Source
  *
  * @param scope The scope in which to define this construct
