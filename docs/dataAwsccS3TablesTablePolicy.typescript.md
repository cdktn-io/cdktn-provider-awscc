...
```typescript
import { dataAwsccS3TablesTablePolicy } from '@cdktn/provider-awscc'

new dataAwsccS3TablesTablePolicy.DataAwsccS3TablesTablePolicy(scope: Construct, id: string, config: DataAwsccS3TablesTablePolicyConfig)
```
...
dataAwsccS3TablesTablePolicy.DataAwsccS3TablesTablePolicy.isConstruct(x: any)
```
...
dataAwsccS3TablesTablePolicy.DataAwsccS3TablesTablePolicy.isTerraformElement(x: any)
```
...
dataAwsccS3TablesTablePolicy.DataAwsccS3TablesTablePolicy.isTerraformDataSource(x: any)
```
...
dataAwsccS3TablesTablePolicy.DataAwsccS3TablesTablePolicy.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3TablesTablePolicy.DataAwsccS3TablesTablePolicy.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3TablesTablePolicy.DataAwsccS3TablesTablePolicy.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3TablesTablePolicy.DataAwsccS3TablesTablePolicy.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3TablesTablePolicy.DataAwsccS3TablesTablePolicy.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3TablesTablePolicy.DataAwsccS3TablesTablePolicy.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccS3TablesTablePolicyConfig: dataAwsccS3TablesTablePolicy.DataAwsccS3TablesTablePolicyConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3TablesTablePolicy.DataAwsccS3TablesTablePolicyConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3TablesTablePolicy.DataAwsccS3TablesTablePolicyConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3TablesTablePolicy.DataAwsccS3TablesTablePolicyConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3TablesTablePolicy.DataAwsccS3TablesTablePolicyConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
