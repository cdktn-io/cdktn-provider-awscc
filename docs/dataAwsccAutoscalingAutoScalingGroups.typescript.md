...
```typescript
import { dataAwsccAutoscalingAutoScalingGroups } from '@cdktn/provider-awscc'

new dataAwsccAutoscalingAutoScalingGroups.DataAwsccAutoscalingAutoScalingGroups(scope: Construct, id: string, config?: DataAwsccAutoscalingAutoScalingGroupsConfig)
```
...
dataAwsccAutoscalingAutoScalingGroups.DataAwsccAutoscalingAutoScalingGroups.isConstruct(x: any)
```
...
dataAwsccAutoscalingAutoScalingGroups.DataAwsccAutoscalingAutoScalingGroups.isTerraformElement(x: any)
```
...
dataAwsccAutoscalingAutoScalingGroups.DataAwsccAutoscalingAutoScalingGroups.isTerraformDataSource(x: any)
```
...
dataAwsccAutoscalingAutoScalingGroups.DataAwsccAutoscalingAutoScalingGroups.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAutoscalingAutoScalingGroups.DataAwsccAutoscalingAutoScalingGroups.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAutoscalingAutoScalingGroups.DataAwsccAutoscalingAutoScalingGroups.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAutoscalingAutoScalingGroups.DataAwsccAutoscalingAutoScalingGroups.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAutoscalingAutoScalingGroups.DataAwsccAutoscalingAutoScalingGroups.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAutoscalingAutoScalingGroups.DataAwsccAutoscalingAutoScalingGroups.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccAutoscalingAutoScalingGroupsConfig: dataAwsccAutoscalingAutoScalingGroups.DataAwsccAutoscalingAutoScalingGroupsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAutoscalingAutoScalingGroups.DataAwsccAutoscalingAutoScalingGroupsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAutoscalingAutoScalingGroups.DataAwsccAutoscalingAutoScalingGroupsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAutoscalingAutoScalingGroups.DataAwsccAutoscalingAutoScalingGroupsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAutoscalingAutoScalingGroups.DataAwsccAutoscalingAutoScalingGroupsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
