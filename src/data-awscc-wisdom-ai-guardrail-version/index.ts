...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/wisdom_ai_guardrail_version
...
export class DataAwsccWisdomAiGuardrailVersion extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccWisdomAiGuardrailVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/wisdom_ai_guardrail_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/wisdom_ai_guardrail_version awscc_wisdom_ai_guardrail_version} Data Source
  *
  * @param scope The scope in which to define this construct
