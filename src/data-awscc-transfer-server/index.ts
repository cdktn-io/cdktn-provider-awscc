...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/transfer_server
...
export interface DataAwsccTransferServerProtocolDetailsProxyConfig {
}

export function dataAwsccTransferServerProtocolDetailsProxyConfigToTerraform(struct?: DataAwsccTransferServerProtocolDetailsProxyConfig): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsccTransferServerProtocolDetailsProxyConfigToHclTerraform(struct?: DataAwsccTransferServerProtocolDetailsProxyConfig): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsccTransferServerProtocolDetailsProxyConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAwsccTransferServerProtocolDetailsProxyConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsccTransferServerProtocolDetailsProxyConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  // sftp_mode - computed: true, optional: false, required: false
  public get sftpMode() {
...
export class DataAwsccTransferServerProtocolDetailsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _proxyConfig = new DataAwsccTransferServerProtocolDetailsProxyConfigOutputReference(this, "proxy_config");
...
export class DataAwsccTransferServer extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccTransferServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/transfer_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/transfer_server awscc_transfer_server} Data Source
  *
  * @param scope The scope in which to define this construct
