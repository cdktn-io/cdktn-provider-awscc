...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/ec2_ec2_fleet
...
export class Ec2Ec2Fleet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2Ec2Fleet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/ec2_ec2_fleet#import import section} in the documentation of this resource for the id to use
