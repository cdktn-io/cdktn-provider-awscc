...
```typescript
import { applicationsignalsDiscovery } from '@cdktn/provider-awscc'

new applicationsignalsDiscovery.ApplicationsignalsDiscovery(scope: Construct, id: string, config?: ApplicationsignalsDiscoveryConfig)
```
...
applicationsignalsDiscovery.ApplicationsignalsDiscovery.isConstruct(x: any)
```
...
applicationsignalsDiscovery.ApplicationsignalsDiscovery.isTerraformElement(x: any)
```
...
applicationsignalsDiscovery.ApplicationsignalsDiscovery.isTerraformResource(x: any)
```
...
applicationsignalsDiscovery.ApplicationsignalsDiscovery.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.applicationsignalsDiscovery.ApplicationsignalsDiscovery.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.applicationsignalsDiscovery.ApplicationsignalsDiscovery.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.applicationsignalsDiscovery.ApplicationsignalsDiscovery.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.applicationsignalsDiscovery.ApplicationsignalsDiscovery.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.applicationsignalsDiscovery.ApplicationsignalsDiscovery.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.applicationsignalsDiscovery.ApplicationsignalsDiscovery.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const applicationsignalsDiscoveryConfig: applicationsignalsDiscovery.ApplicationsignalsDiscoveryConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.applicationsignalsDiscovery.ApplicationsignalsDiscoveryConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.applicationsignalsDiscovery.ApplicationsignalsDiscoveryConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.applicationsignalsDiscovery.ApplicationsignalsDiscoveryConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.applicationsignalsDiscovery.ApplicationsignalsDiscoveryConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
