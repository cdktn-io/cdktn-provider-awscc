...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/databrew_project
...
export class DatabrewProject extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DatabrewProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/databrew_project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/databrew_project awscc_databrew_project} Resource
  *
  * @param scope The scope in which to define this construct
