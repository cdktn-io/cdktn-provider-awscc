...
```typescript
import { dataAwsccApplicationsignalsServiceLevelObjectives } from '@cdktn/provider-awscc'

new dataAwsccApplicationsignalsServiceLevelObjectives.DataAwsccApplicationsignalsServiceLevelObjectives(scope: Construct, id: string, config?: DataAwsccApplicationsignalsServiceLevelObjectivesConfig)
```
...
dataAwsccApplicationsignalsServiceLevelObjectives.DataAwsccApplicationsignalsServiceLevelObjectives.isConstruct(x: any)
```
...
dataAwsccApplicationsignalsServiceLevelObjectives.DataAwsccApplicationsignalsServiceLevelObjectives.isTerraformElement(x: any)
```
...
dataAwsccApplicationsignalsServiceLevelObjectives.DataAwsccApplicationsignalsServiceLevelObjectives.isTerraformDataSource(x: any)
```
...
dataAwsccApplicationsignalsServiceLevelObjectives.DataAwsccApplicationsignalsServiceLevelObjectives.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApplicationsignalsServiceLevelObjectives.DataAwsccApplicationsignalsServiceLevelObjectives.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApplicationsignalsServiceLevelObjectives.DataAwsccApplicationsignalsServiceLevelObjectives.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApplicationsignalsServiceLevelObjectives.DataAwsccApplicationsignalsServiceLevelObjectives.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApplicationsignalsServiceLevelObjectives.DataAwsccApplicationsignalsServiceLevelObjectives.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApplicationsignalsServiceLevelObjectives.DataAwsccApplicationsignalsServiceLevelObjectives.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccApplicationsignalsServiceLevelObjectivesConfig: dataAwsccApplicationsignalsServiceLevelObjectives.DataAwsccApplicationsignalsServiceLevelObjectivesConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApplicationsignalsServiceLevelObjectives.DataAwsccApplicationsignalsServiceLevelObjectivesConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApplicationsignalsServiceLevelObjectives.DataAwsccApplicationsignalsServiceLevelObjectivesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApplicationsignalsServiceLevelObjectives.DataAwsccApplicationsignalsServiceLevelObjectivesConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApplicationsignalsServiceLevelObjectives.DataAwsccApplicationsignalsServiceLevelObjectivesConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
