...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/billing_billing_view
...
export class BillingBillingView extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BillingBillingView that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/billing_billing_view#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/billing_billing_view awscc_billing_billing_view} Resource
  *
  * @param scope The scope in which to define this construct
