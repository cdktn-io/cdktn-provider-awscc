...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/efs_mount_target
...
export class EfsMountTarget extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EfsMountTarget that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/efs_mount_target#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/efs_mount_target awscc_efs_mount_target} Resource
  *
  * @param scope The scope in which to define this construct
