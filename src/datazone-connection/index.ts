...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_connection
...
export class DatazoneConnection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DatazoneConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_connection awscc_datazone_connection} Resource
  *
  * @param scope The scope in which to define this construct
