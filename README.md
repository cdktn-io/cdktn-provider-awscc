...
# CDKTN prebuilt bindings for hashicorp/awscc provider version 1.101.0

This repo builds and publishes the [Terraform awscc provider](https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs) bindings for [CDK Terrain](https://cdktn.io).
...
- [Terraform awscc provider](https://registry.terraform.io/providers/hashicorp/awscc/1.101.0)
