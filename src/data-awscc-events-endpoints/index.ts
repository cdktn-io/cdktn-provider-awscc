...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/events_endpoints
...
export class DataAwsccEventsEndpoints extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEventsEndpoints that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/events_endpoints#import import section} in the documentation of this resource for the id to use
