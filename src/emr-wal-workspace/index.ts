...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/emr_wal_workspace
...
export class EmrWalWorkspace extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EmrWalWorkspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/emr_wal_workspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/emr_wal_workspace awscc_emr_wal_workspace} Resource
  *
  * @param scope The scope in which to define this construct
