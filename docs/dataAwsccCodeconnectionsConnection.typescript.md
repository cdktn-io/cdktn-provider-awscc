...
```typescript
import { dataAwsccCodeconnectionsConnection } from '@cdktn/provider-awscc'

new dataAwsccCodeconnectionsConnection.DataAwsccCodeconnectionsConnection(scope: Construct, id: string, config: DataAwsccCodeconnectionsConnectionConfig)
```
...
dataAwsccCodeconnectionsConnection.DataAwsccCodeconnectionsConnection.isConstruct(x: any)
```
...
dataAwsccCodeconnectionsConnection.DataAwsccCodeconnectionsConnection.isTerraformElement(x: any)
```
...
dataAwsccCodeconnectionsConnection.DataAwsccCodeconnectionsConnection.isTerraformDataSource(x: any)
```
...
dataAwsccCodeconnectionsConnection.DataAwsccCodeconnectionsConnection.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnection.DataAwsccCodeconnectionsConnection.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnection.DataAwsccCodeconnectionsConnection.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnection.DataAwsccCodeconnectionsConnection.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnection.DataAwsccCodeconnectionsConnection.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnection.DataAwsccCodeconnectionsConnection.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
```typescript
public readonly tags: DataAwsccCodeconnectionsConnectionTagsList;
```
...
const dataAwsccCodeconnectionsConnectionConfig: dataAwsccCodeconnectionsConnection.DataAwsccCodeconnectionsConnectionConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnection.DataAwsccCodeconnectionsConnectionConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnection.DataAwsccCodeconnectionsConnectionConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnection.DataAwsccCodeconnectionsConnectionConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnection.DataAwsccCodeconnectionsConnectionConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const dataAwsccCodeconnectionsConnectionTags: dataAwsccCodeconnectionsConnection.DataAwsccCodeconnectionsConnectionTags = { ... }
```
...
new dataAwsccCodeconnectionsConnection.DataAwsccCodeconnectionsConnectionTagsList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnection.DataAwsccCodeconnectionsConnectionTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnection.DataAwsccCodeconnectionsConnectionTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
new dataAwsccCodeconnectionsConnection.DataAwsccCodeconnectionsConnectionTagsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnection.DataAwsccCodeconnectionsConnectionTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnection.DataAwsccCodeconnectionsConnectionTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
...
```typescript
public readonly internalValue: DataAwsccCodeconnectionsConnectionTags;
```
