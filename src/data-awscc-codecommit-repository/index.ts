...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/codecommit_repository
...
export class DataAwsccCodecommitRepository extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCodecommitRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/codecommit_repository#import import section} in the documentation of this resource for the id to use
