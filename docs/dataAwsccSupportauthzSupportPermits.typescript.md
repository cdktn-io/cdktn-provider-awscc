...
```typescript
import { dataAwsccSupportauthzSupportPermits } from '@cdktn/provider-awscc'

new dataAwsccSupportauthzSupportPermits.DataAwsccSupportauthzSupportPermits(scope: Construct, id: string, config?: DataAwsccSupportauthzSupportPermitsConfig)
```
...
dataAwsccSupportauthzSupportPermits.DataAwsccSupportauthzSupportPermits.isConstruct(x: any)
```
...
dataAwsccSupportauthzSupportPermits.DataAwsccSupportauthzSupportPermits.isTerraformElement(x: any)
```
...
dataAwsccSupportauthzSupportPermits.DataAwsccSupportauthzSupportPermits.isTerraformDataSource(x: any)
```
...
dataAwsccSupportauthzSupportPermits.DataAwsccSupportauthzSupportPermits.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSupportauthzSupportPermits.DataAwsccSupportauthzSupportPermits.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSupportauthzSupportPermits.DataAwsccSupportauthzSupportPermits.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSupportauthzSupportPermits.DataAwsccSupportauthzSupportPermits.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSupportauthzSupportPermits.DataAwsccSupportauthzSupportPermits.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSupportauthzSupportPermits.DataAwsccSupportauthzSupportPermits.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccSupportauthzSupportPermitsConfig: dataAwsccSupportauthzSupportPermits.DataAwsccSupportauthzSupportPermitsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSupportauthzSupportPermits.DataAwsccSupportauthzSupportPermitsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSupportauthzSupportPermits.DataAwsccSupportauthzSupportPermitsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSupportauthzSupportPermits.DataAwsccSupportauthzSupportPermitsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSupportauthzSupportPermits.DataAwsccSupportauthzSupportPermitsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
