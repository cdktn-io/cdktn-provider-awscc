...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/cases_field
...
export class CasesField extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CasesField that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/cases_field#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/cases_field awscc_cases_field} Resource
  *
  * @param scope The scope in which to define this construct
