...
```typescript
import { dataAwsccStoragegatewayTapePools } from '@cdktn/provider-awscc'

new dataAwsccStoragegatewayTapePools.DataAwsccStoragegatewayTapePools(scope: Construct, id: string, config?: DataAwsccStoragegatewayTapePoolsConfig)
```
...
dataAwsccStoragegatewayTapePools.DataAwsccStoragegatewayTapePools.isConstruct(x: any)
```
...
dataAwsccStoragegatewayTapePools.DataAwsccStoragegatewayTapePools.isTerraformElement(x: any)
```
...
dataAwsccStoragegatewayTapePools.DataAwsccStoragegatewayTapePools.isTerraformDataSource(x: any)
```
...
dataAwsccStoragegatewayTapePools.DataAwsccStoragegatewayTapePools.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccStoragegatewayTapePools.DataAwsccStoragegatewayTapePools.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccStoragegatewayTapePools.DataAwsccStoragegatewayTapePools.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccStoragegatewayTapePools.DataAwsccStoragegatewayTapePools.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccStoragegatewayTapePools.DataAwsccStoragegatewayTapePools.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccStoragegatewayTapePools.DataAwsccStoragegatewayTapePools.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccStoragegatewayTapePoolsConfig: dataAwsccStoragegatewayTapePools.DataAwsccStoragegatewayTapePoolsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccStoragegatewayTapePools.DataAwsccStoragegatewayTapePoolsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccStoragegatewayTapePools.DataAwsccStoragegatewayTapePoolsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccStoragegatewayTapePools.DataAwsccStoragegatewayTapePoolsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccStoragegatewayTapePools.DataAwsccStoragegatewayTapePoolsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
