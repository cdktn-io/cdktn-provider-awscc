...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/robomaker_robot_application_version
...
export class DataAwsccRobomakerRobotApplicationVersion extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRobomakerRobotApplicationVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/robomaker_robot_application_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/robomaker_robot_application_version awscc_robomaker_robot_application_version} Data Source
  *
  * @param scope The scope in which to define this construct
