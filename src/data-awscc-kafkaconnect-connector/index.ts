...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/kafkaconnect_connector
...
export class DataAwsccKafkaconnectConnector extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccKafkaconnectConnector that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/kafkaconnect_connector#import import section} in the documentation of this resource for the id to use
