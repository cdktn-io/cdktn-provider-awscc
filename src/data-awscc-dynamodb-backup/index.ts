...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/dynamodb_backup
...
export class DataAwsccDynamodbBackup extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDynamodbBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/dynamodb_backup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/dynamodb_backup awscc_dynamodb_backup} Data Source
  *
  * @param scope The scope in which to define this construct
