...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/s3outposts_bucket
...
export class S3OutpostsBucket extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3OutpostsBucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/s3outposts_bucket#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/s3outposts_bucket awscc_s3outposts_bucket} Resource
  *
  * @param scope The scope in which to define this construct
