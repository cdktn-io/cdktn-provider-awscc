...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccbackuplogicallyairgappedbackupvaults"

dataawsccbackuplogicallyairgappedbackupvaults.NewDataAwsccBackupLogicallyAirGappedBackupVaults(scope Construct, id *string, config DataAwsccBackupLogicallyAirGappedBackupVaultsConfig) DataAwsccBackupLogicallyAirGappedBackupVaults
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBackupLogicallyAirGappedBackupVaults.DataAwsccBackupLogicallyAirGappedBackupVaults.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
dataawsccbackuplogicallyairgappedbackupvaults.DataAwsccBackupLogicallyAirGappedBackupVaults_IsConstruct(x interface{}) *bool
```
...
dataawsccbackuplogicallyairgappedbackupvaults.DataAwsccBackupLogicallyAirGappedBackupVaults_IsTerraformElement(x interface{}) *bool
```
...
dataawsccbackuplogicallyairgappedbackupvaults.DataAwsccBackupLogicallyAirGappedBackupVaults_IsTerraformDataSource(x interface{}) *bool
```
...
dataawsccbackuplogicallyairgappedbackupvaults.DataAwsccBackupLogicallyAirGappedBackupVaults_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBackupLogicallyAirGappedBackupVaults.DataAwsccBackupLogicallyAirGappedBackupVaults.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBackupLogicallyAirGappedBackupVaults.DataAwsccBackupLogicallyAirGappedBackupVaults.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBackupLogicallyAirGappedBackupVaults.DataAwsccBackupLogicallyAirGappedBackupVaults.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBackupLogicallyAirGappedBackupVaults.DataAwsccBackupLogicallyAirGappedBackupVaults.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBackupLogicallyAirGappedBackupVaults.DataAwsccBackupLogicallyAirGappedBackupVaults.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBackupLogicallyAirGappedBackupVaults.DataAwsccBackupLogicallyAirGappedBackupVaults.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBackupLogicallyAirGappedBackupVaults.DataAwsccBackupLogicallyAirGappedBackupVaults.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBackupLogicallyAirGappedBackupVaults.DataAwsccBackupLogicallyAirGappedBackupVaultsConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBackupLogicallyAirGappedBackupVaults.DataAwsccBackupLogicallyAirGappedBackupVaultsConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBackupLogicallyAirGappedBackupVaults.DataAwsccBackupLogicallyAirGappedBackupVaultsConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBackupLogicallyAirGappedBackupVaults.DataAwsccBackupLogicallyAirGappedBackupVaultsConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBackupLogicallyAirGappedBackupVaults.DataAwsccBackupLogicallyAirGappedBackupVaultsConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBackupLogicallyAirGappedBackupVaults.DataAwsccBackupLogicallyAirGappedBackupVaultsConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBackupLogicallyAirGappedBackupVaults.DataAwsccBackupLogicallyAirGappedBackupVaultsConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
