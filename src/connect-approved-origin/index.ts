...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/connect_approved_origin
...
export class ConnectApprovedOrigin extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectApprovedOrigin that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/connect_approved_origin#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/connect_approved_origin awscc_connect_approved_origin} Resource
  *
  * @param scope The scope in which to define this construct
