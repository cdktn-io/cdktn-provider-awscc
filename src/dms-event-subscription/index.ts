...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/dms_event_subscription
...
export interface DmsEventSubscriptionConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly tags?: DmsEventSubscriptionTags[] | cdktn.IResolvable;
}
export interface DmsEventSubscriptionTags {
  /**
...
export function dmsEventSubscriptionTagsToTerraform(struct?: DmsEventSubscriptionTags | cdktn.IResolvable): any {
...
export function dmsEventSubscriptionTagsToHclTerraform(struct?: DmsEventSubscriptionTags | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DmsEventSubscriptionTagsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DmsEventSubscriptionTags | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DmsEventSubscriptionTags | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class DmsEventSubscriptionTagsList extends cdktn.ComplexList {
  public internalValue? : DmsEventSubscriptionTags[] | cdktn.IResolvable
  ...
  */
  public get(index: number): DmsEventSubscriptionTagsOutputReference {
    return new DmsEventSubscriptionTagsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DmsEventSubscription extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DmsEventSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/dms_event_subscription#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/dms_event_subscription awscc_dms_event_subscription} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _tags = new DmsEventSubscriptionTagsList(this, "tags", false);
  public get tags() {
    return this._tags;
  }
  public putTags(value: DmsEventSubscriptionTags[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      tags: cdktn.listMapper(dmsEventSubscriptionTagsToTerraform, false)(this._tags.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      tags: {
        value: cdktn.listMapperHcl(dmsEventSubscriptionTagsToHclTerraform, false)(this._tags.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DmsEventSubscriptionTagsList",
      },
    };
