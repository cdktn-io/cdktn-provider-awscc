...
```typescript
import { dataAwsccGlueTriggers } from '@cdktn/provider-awscc'

new dataAwsccGlueTriggers.DataAwsccGlueTriggers(scope: Construct, id: string, config?: DataAwsccGlueTriggersConfig)
```
...
dataAwsccGlueTriggers.DataAwsccGlueTriggers.isConstruct(x: any)
```
...
dataAwsccGlueTriggers.DataAwsccGlueTriggers.isTerraformElement(x: any)
```
...
dataAwsccGlueTriggers.DataAwsccGlueTriggers.isTerraformDataSource(x: any)
```
...
dataAwsccGlueTriggers.DataAwsccGlueTriggers.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGlueTriggers.DataAwsccGlueTriggers.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGlueTriggers.DataAwsccGlueTriggers.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGlueTriggers.DataAwsccGlueTriggers.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGlueTriggers.DataAwsccGlueTriggers.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGlueTriggers.DataAwsccGlueTriggers.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccGlueTriggersConfig: dataAwsccGlueTriggers.DataAwsccGlueTriggersConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGlueTriggers.DataAwsccGlueTriggersConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGlueTriggers.DataAwsccGlueTriggersConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGlueTriggers.DataAwsccGlueTriggersConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGlueTriggers.DataAwsccGlueTriggersConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
