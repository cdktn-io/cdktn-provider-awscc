...
```typescript
import { dataAwsccEntityresolutionIdNamespaces } from '@cdktn/provider-awscc'

new dataAwsccEntityresolutionIdNamespaces.DataAwsccEntityresolutionIdNamespaces(scope: Construct, id: string, config?: DataAwsccEntityresolutionIdNamespacesConfig)
```
...
dataAwsccEntityresolutionIdNamespaces.DataAwsccEntityresolutionIdNamespaces.isConstruct(x: any)
```
...
dataAwsccEntityresolutionIdNamespaces.DataAwsccEntityresolutionIdNamespaces.isTerraformElement(x: any)
```
...
dataAwsccEntityresolutionIdNamespaces.DataAwsccEntityresolutionIdNamespaces.isTerraformDataSource(x: any)
```
...
dataAwsccEntityresolutionIdNamespaces.DataAwsccEntityresolutionIdNamespaces.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEntityresolutionIdNamespaces.DataAwsccEntityresolutionIdNamespaces.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEntityresolutionIdNamespaces.DataAwsccEntityresolutionIdNamespaces.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEntityresolutionIdNamespaces.DataAwsccEntityresolutionIdNamespaces.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEntityresolutionIdNamespaces.DataAwsccEntityresolutionIdNamespaces.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEntityresolutionIdNamespaces.DataAwsccEntityresolutionIdNamespaces.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccEntityresolutionIdNamespacesConfig: dataAwsccEntityresolutionIdNamespaces.DataAwsccEntityresolutionIdNamespacesConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEntityresolutionIdNamespaces.DataAwsccEntityresolutionIdNamespacesConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEntityresolutionIdNamespaces.DataAwsccEntityresolutionIdNamespacesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEntityresolutionIdNamespaces.DataAwsccEntityresolutionIdNamespacesConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEntityresolutionIdNamespaces.DataAwsccEntityresolutionIdNamespacesConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
