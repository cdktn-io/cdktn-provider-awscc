...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ecs_task_set
...
export class EcsTaskSet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EcsTaskSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ecs_task_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ecs_task_set awscc_ecs_task_set} Resource
  *
  * @param scope The scope in which to define this construct
