...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/devopsguruloganomalydetectionintegration"

devopsguruloganomalydetectionintegration.NewDevopsguruLogAnomalyDetectionIntegration(scope Construct, id *string, config DevopsguruLogAnomalyDetectionIntegrationConfig) DevopsguruLogAnomalyDetectionIntegration
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.devopsguruLogAnomalyDetectionIntegration.DevopsguruLogAnomalyDetectionIntegration.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
devopsguruloganomalydetectionintegration.DevopsguruLogAnomalyDetectionIntegration_IsConstruct(x interface{}) *bool
```
...
devopsguruloganomalydetectionintegration.DevopsguruLogAnomalyDetectionIntegration_IsTerraformElement(x interface{}) *bool
```
...
devopsguruloganomalydetectionintegration.DevopsguruLogAnomalyDetectionIntegration_IsTerraformResource(x interface{}) *bool
```
...
devopsguruloganomalydetectionintegration.DevopsguruLogAnomalyDetectionIntegration_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.devopsguruLogAnomalyDetectionIntegration.DevopsguruLogAnomalyDetectionIntegration.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.devopsguruLogAnomalyDetectionIntegration.DevopsguruLogAnomalyDetectionIntegration.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.devopsguruLogAnomalyDetectionIntegration.DevopsguruLogAnomalyDetectionIntegration.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.devopsguruLogAnomalyDetectionIntegration.DevopsguruLogAnomalyDetectionIntegration.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.devopsguruLogAnomalyDetectionIntegration.DevopsguruLogAnomalyDetectionIntegration.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.devopsguruLogAnomalyDetectionIntegration.DevopsguruLogAnomalyDetectionIntegration.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.devopsguruLogAnomalyDetectionIntegration.DevopsguruLogAnomalyDetectionIntegration.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.devopsguruLogAnomalyDetectionIntegration.DevopsguruLogAnomalyDetectionIntegration.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.devopsguruLogAnomalyDetectionIntegration.DevopsguruLogAnomalyDetectionIntegration.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.devopsguruLogAnomalyDetectionIntegration.DevopsguruLogAnomalyDetectionIntegration.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.devopsguruLogAnomalyDetectionIntegration.DevopsguruLogAnomalyDetectionIntegrationConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.devopsguruLogAnomalyDetectionIntegration.DevopsguruLogAnomalyDetectionIntegrationConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.devopsguruLogAnomalyDetectionIntegration.DevopsguruLogAnomalyDetectionIntegrationConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.devopsguruLogAnomalyDetectionIntegration.DevopsguruLogAnomalyDetectionIntegrationConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.devopsguruLogAnomalyDetectionIntegration.DevopsguruLogAnomalyDetectionIntegrationConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.devopsguruLogAnomalyDetectionIntegration.DevopsguruLogAnomalyDetectionIntegrationConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.devopsguruLogAnomalyDetectionIntegration.DevopsguruLogAnomalyDetectionIntegrationConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
