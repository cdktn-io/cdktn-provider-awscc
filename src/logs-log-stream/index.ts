...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/logs_log_stream
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/logs_log_stream awscc_logs_log_stream}
*/
export class LogsLogStream extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LogsLogStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/logs_log_stream#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/logs_log_stream awscc_logs_log_stream} Resource
  *
  * @param scope The scope in which to define this construct
