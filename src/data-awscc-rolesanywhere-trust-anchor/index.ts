...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/rolesanywhere_trust_anchor
...
export class DataAwsccRolesanywhereTrustAnchor extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRolesanywhereTrustAnchor that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/rolesanywhere_trust_anchor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/rolesanywhere_trust_anchor awscc_rolesanywhere_trust_anchor} Data Source
  *
  * @param scope The scope in which to define this construct
