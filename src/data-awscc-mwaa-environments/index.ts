...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/mwaa_environments
...
export class DataAwsccMwaaEnvironments extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccMwaaEnvironments that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/mwaa_environments#import import section} in the documentation of this resource for the id to use
