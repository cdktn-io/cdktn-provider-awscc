...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/vpclattice_listener
...
export class VpclatticeListener extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VpclatticeListener that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/vpclattice_listener#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/vpclattice_listener awscc_vpclattice_listener} Resource
  *
  * @param scope The scope in which to define this construct
