...
```typescript
import { dataAwsccMedialiveEventBridgeRuleTemplates } from '@cdktn/provider-awscc'

new dataAwsccMedialiveEventBridgeRuleTemplates.DataAwsccMedialiveEventBridgeRuleTemplates(scope: Construct, id: string, config?: DataAwsccMedialiveEventBridgeRuleTemplatesConfig)
```
...
dataAwsccMedialiveEventBridgeRuleTemplates.DataAwsccMedialiveEventBridgeRuleTemplates.isConstruct(x: any)
```
...
dataAwsccMedialiveEventBridgeRuleTemplates.DataAwsccMedialiveEventBridgeRuleTemplates.isTerraformElement(x: any)
```
...
dataAwsccMedialiveEventBridgeRuleTemplates.DataAwsccMedialiveEventBridgeRuleTemplates.isTerraformDataSource(x: any)
```
...
dataAwsccMedialiveEventBridgeRuleTemplates.DataAwsccMedialiveEventBridgeRuleTemplates.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveEventBridgeRuleTemplates.DataAwsccMedialiveEventBridgeRuleTemplates.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveEventBridgeRuleTemplates.DataAwsccMedialiveEventBridgeRuleTemplates.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveEventBridgeRuleTemplates.DataAwsccMedialiveEventBridgeRuleTemplates.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveEventBridgeRuleTemplates.DataAwsccMedialiveEventBridgeRuleTemplates.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveEventBridgeRuleTemplates.DataAwsccMedialiveEventBridgeRuleTemplates.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveEventBridgeRuleTemplates.DataAwsccMedialiveEventBridgeRuleTemplates.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveEventBridgeRuleTemplates.DataAwsccMedialiveEventBridgeRuleTemplates.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
...
const dataAwsccMedialiveEventBridgeRuleTemplatesConfig: dataAwsccMedialiveEventBridgeRuleTemplates.DataAwsccMedialiveEventBridgeRuleTemplatesConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveEventBridgeRuleTemplates.DataAwsccMedialiveEventBridgeRuleTemplatesConfig.property.connection">connection</a></code> | <code>cdktn.SSHProvisionerConnection \| cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveEventBridgeRuleTemplates.DataAwsccMedialiveEventBridgeRuleTemplatesConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveEventBridgeRuleTemplates.DataAwsccMedialiveEventBridgeRuleTemplatesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveEventBridgeRuleTemplates.DataAwsccMedialiveEventBridgeRuleTemplatesConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveEventBridgeRuleTemplates.DataAwsccMedialiveEventBridgeRuleTemplatesConfig.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveEventBridgeRuleTemplates.DataAwsccMedialiveEventBridgeRuleTemplatesConfig.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveEventBridgeRuleTemplates.DataAwsccMedialiveEventBridgeRuleTemplatesConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
