...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/apigateway_documentation_part
...
export class DataAwsccApigatewayDocumentationPart extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccApigatewayDocumentationPart that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/apigateway_documentation_part#import import section} in the documentation of this resource for the id to use
