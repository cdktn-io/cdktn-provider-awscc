...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/iam_instance_profile
...
export class DataAwsccIamInstanceProfile extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIamInstanceProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/iam_instance_profile#import import section} in the documentation of this resource for the id to use
