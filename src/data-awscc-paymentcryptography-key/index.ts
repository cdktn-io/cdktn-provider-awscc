...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/paymentcryptography_key
...
export class DataAwsccPaymentcryptographyKey extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccPaymentcryptographyKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/paymentcryptography_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/paymentcryptography_key awscc_paymentcryptography_key} Data Source
  *
  * @param scope The scope in which to define this construct
