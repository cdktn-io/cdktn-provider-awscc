...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/bedrock_prompt
...
export class DataAwsccBedrockPrompt extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccBedrockPrompt that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/bedrock_prompt#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/bedrock_prompt awscc_bedrock_prompt} Data Source
  *
  * @param scope The scope in which to define this construct
