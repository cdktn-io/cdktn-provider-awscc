...
```typescript
import { lookoutvisionProject } from '@cdktn/provider-awscc'

new lookoutvisionProject.LookoutvisionProject(scope: Construct, id: string, config: LookoutvisionProjectConfig)
```
...
lookoutvisionProject.LookoutvisionProject.isConstruct(x: any)
```
...
lookoutvisionProject.LookoutvisionProject.isTerraformElement(x: any)
```
...
lookoutvisionProject.LookoutvisionProject.isTerraformResource(x: any)
```
...
lookoutvisionProject.LookoutvisionProject.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.lookoutvisionProject.LookoutvisionProject.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.lookoutvisionProject.LookoutvisionProject.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.lookoutvisionProject.LookoutvisionProject.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.lookoutvisionProject.LookoutvisionProject.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.lookoutvisionProject.LookoutvisionProject.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.lookoutvisionProject.LookoutvisionProject.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const lookoutvisionProjectConfig: lookoutvisionProject.LookoutvisionProjectConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.lookoutvisionProject.LookoutvisionProjectConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.lookoutvisionProject.LookoutvisionProjectConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.lookoutvisionProject.LookoutvisionProjectConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.lookoutvisionProject.LookoutvisionProjectConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
