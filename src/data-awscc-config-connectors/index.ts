...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/config_connectors
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/config_connectors awscc_config_connectors}
*/
export class DataAwsccConfigConnectors extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccConfigConnectors that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/config_connectors#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/config_connectors awscc_config_connectors} Data Source
  *
  * @param scope The scope in which to define this construct
