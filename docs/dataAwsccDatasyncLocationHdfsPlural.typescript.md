...
```typescript
import { dataAwsccDatasyncLocationHdfsPlural } from '@cdktn/provider-awscc'

new dataAwsccDatasyncLocationHdfsPlural.DataAwsccDatasyncLocationHdfsPlural(scope: Construct, id: string, config?: DataAwsccDatasyncLocationHdfsPluralConfig)
```
...
dataAwsccDatasyncLocationHdfsPlural.DataAwsccDatasyncLocationHdfsPlural.isConstruct(x: any)
```
...
dataAwsccDatasyncLocationHdfsPlural.DataAwsccDatasyncLocationHdfsPlural.isTerraformElement(x: any)
```
...
dataAwsccDatasyncLocationHdfsPlural.DataAwsccDatasyncLocationHdfsPlural.isTerraformDataSource(x: any)
```
...
dataAwsccDatasyncLocationHdfsPlural.DataAwsccDatasyncLocationHdfsPlural.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationHdfsPlural.DataAwsccDatasyncLocationHdfsPlural.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationHdfsPlural.DataAwsccDatasyncLocationHdfsPlural.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationHdfsPlural.DataAwsccDatasyncLocationHdfsPlural.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationHdfsPlural.DataAwsccDatasyncLocationHdfsPlural.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationHdfsPlural.DataAwsccDatasyncLocationHdfsPlural.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccDatasyncLocationHdfsPluralConfig: dataAwsccDatasyncLocationHdfsPlural.DataAwsccDatasyncLocationHdfsPluralConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationHdfsPlural.DataAwsccDatasyncLocationHdfsPluralConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationHdfsPlural.DataAwsccDatasyncLocationHdfsPluralConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationHdfsPlural.DataAwsccDatasyncLocationHdfsPluralConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationHdfsPlural.DataAwsccDatasyncLocationHdfsPluralConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
