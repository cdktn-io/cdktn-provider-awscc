...
new DataAwsccEc2VpcdhcpOptionsAssociations(Construct Scope, string Id, DataAwsccEc2VpcdhcpOptionsAssociationsConfig Config = null);
```
...
DataAwsccEc2VpcdhcpOptionsAssociations.IsConstruct(object X);
```
...
DataAwsccEc2VpcdhcpOptionsAssociations.IsTerraformElement(object X);
```
...
DataAwsccEc2VpcdhcpOptionsAssociations.IsTerraformDataSource(object X);
```
...
DataAwsccEc2VpcdhcpOptionsAssociations.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VpcdhcpOptionsAssociations.DataAwsccEc2VpcdhcpOptionsAssociations.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VpcdhcpOptionsAssociations.DataAwsccEc2VpcdhcpOptionsAssociations.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VpcdhcpOptionsAssociations.DataAwsccEc2VpcdhcpOptionsAssociations.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VpcdhcpOptionsAssociations.DataAwsccEc2VpcdhcpOptionsAssociations.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VpcdhcpOptionsAssociations.DataAwsccEc2VpcdhcpOptionsAssociations.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VpcdhcpOptionsAssociations.DataAwsccEc2VpcdhcpOptionsAssociations.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VpcdhcpOptionsAssociations.DataAwsccEc2VpcdhcpOptionsAssociations.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
...
new DataAwsccEc2VpcdhcpOptionsAssociationsConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VpcdhcpOptionsAssociations.DataAwsccEc2VpcdhcpOptionsAssociationsConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VpcdhcpOptionsAssociations.DataAwsccEc2VpcdhcpOptionsAssociationsConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VpcdhcpOptionsAssociations.DataAwsccEc2VpcdhcpOptionsAssociationsConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VpcdhcpOptionsAssociations.DataAwsccEc2VpcdhcpOptionsAssociationsConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VpcdhcpOptionsAssociations.DataAwsccEc2VpcdhcpOptionsAssociationsConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VpcdhcpOptionsAssociations.DataAwsccEc2VpcdhcpOptionsAssociationsConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VpcdhcpOptionsAssociations.DataAwsccEc2VpcdhcpOptionsAssociationsConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
