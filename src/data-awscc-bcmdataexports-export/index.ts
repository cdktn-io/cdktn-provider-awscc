...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/bcmdataexports_export
...
export class DataAwsccBcmdataexportsExport extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccBcmdataexportsExport that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/bcmdataexports_export#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/bcmdataexports_export awscc_bcmdataexports_export} Data Source
  *
  * @param scope The scope in which to define this construct
