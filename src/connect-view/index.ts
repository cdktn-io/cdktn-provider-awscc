...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/connect_view
...
export class ConnectView extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectView that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/connect_view#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/connect_view awscc_connect_view} Resource
  *
  * @param scope The scope in which to define this construct
