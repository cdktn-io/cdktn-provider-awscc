...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/deadline_metered_product
...
export class DataAwsccDeadlineMeteredProduct extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDeadlineMeteredProduct that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/deadline_metered_product#import import section} in the documentation of this resource for the id to use
