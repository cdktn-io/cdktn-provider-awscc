...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_placement_group
...
export interface Ec2PlacementGroupConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_placement_group#parent_group_id Ec2PlacementGroup#parent_group_id}
  */
  readonly parentGroupId?: string;
  /**
  * The number of partitions. Valid only when **Strategy** is set to `partition`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_placement_group#partition_count Ec2PlacementGroup#partition_count}
  */
  readonly partitionCount?: number;
  /**
  * The Spread Level of Placement Group is an enum where it accepts either host or rack when strategy is spread
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_placement_group#spread_level Ec2PlacementGroup#spread_level}
  */
  readonly spreadLevel?: string;
  /**
  * The placement strategy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_placement_group#strategy Ec2PlacementGroup#strategy}
  */
  readonly strategy?: string;
  /**
  * An array of key-value pairs to apply to this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_placement_group#tags Ec2PlacementGroup#tags}
  */
...
export interface Ec2PlacementGroupTags {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_placement_group#key Ec2PlacementGroup#key}
  */
  readonly key?: string;
  /**
  * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_placement_group#value Ec2PlacementGroup#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_placement_group awscc_ec2_placement_group}
*/
export class Ec2PlacementGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2PlacementGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_placement_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_placement_group awscc_ec2_placement_group} Resource
  *
  * @param scope The scope in which to define this construct
