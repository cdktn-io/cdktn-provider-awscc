...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/cleanrooms_collaborations
...
export class DataAwsccCleanroomsCollaborations extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCleanroomsCollaborations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/cleanrooms_collaborations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/cleanrooms_collaborations awscc_cleanrooms_collaborations} Data Source
  *
  * @param scope The scope in which to define this construct
