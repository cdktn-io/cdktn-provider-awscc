...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/redshift_usage_limits
...
export class DataAwsccRedshiftUsageLimits extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRedshiftUsageLimits that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/redshift_usage_limits#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/redshift_usage_limits awscc_redshift_usage_limits} Data Source
  *
  * @param scope The scope in which to define this construct
