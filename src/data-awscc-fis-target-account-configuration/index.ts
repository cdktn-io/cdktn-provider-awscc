...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/fis_target_account_configuration
...
export interface DataAwsccFisTargetAccountConfigurationConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/fis_target_account_configuration#id DataAwsccFisTargetAccountConfiguration#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/fis_target_account_configuration awscc_fis_target_account_configuration}
*/
export class DataAwsccFisTargetAccountConfiguration extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccFisTargetAccountConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/fis_target_account_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/fis_target_account_configuration awscc_fis_target_account_configuration} Data Source
  *
  * @param scope The scope in which to define this construct
