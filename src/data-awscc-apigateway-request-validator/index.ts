...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/apigateway_request_validator
...
export class DataAwsccApigatewayRequestValidator extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccApigatewayRequestValidator that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/apigateway_request_validator#import import section} in the documentation of this resource for the id to use
