...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/s3_access_grants_instance
...
export class S3AccessGrantsInstance extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3AccessGrantsInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/s3_access_grants_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/s3_access_grants_instance awscc_s3_access_grants_instance} Resource
  *
  * @param scope The scope in which to define this construct
