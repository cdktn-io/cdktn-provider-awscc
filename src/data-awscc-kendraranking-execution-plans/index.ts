...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/kendraranking_execution_plans
...
export class DataAwsccKendrarankingExecutionPlans extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccKendrarankingExecutionPlans that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/kendraranking_execution_plans#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/kendraranking_execution_plans awscc_kendraranking_execution_plans} Data Source
  *
  * @param scope The scope in which to define this construct
