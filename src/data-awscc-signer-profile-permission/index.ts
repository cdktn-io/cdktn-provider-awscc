...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/signer_profile_permission
...
export interface DataAwsccSignerProfilePermissionConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/signer_profile_permission#id DataAwsccSignerProfilePermission#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/signer_profile_permission awscc_signer_profile_permission}
*/
export class DataAwsccSignerProfilePermission extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccSignerProfilePermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/signer_profile_permission#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/signer_profile_permission awscc_signer_profile_permission} Data Source
  *
  * @param scope The scope in which to define this construct
