...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/rolesanywhere_profile
...
export class RolesanywhereProfile extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RolesanywhereProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/rolesanywhere_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/rolesanywhere_profile awscc_rolesanywhere_profile} Resource
  *
  * @param scope The scope in which to define this construct
