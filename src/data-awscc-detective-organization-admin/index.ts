...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/detective_organization_admin
...
export class DataAwsccDetectiveOrganizationAdmin extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDetectiveOrganizationAdmin that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/detective_organization_admin#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/detective_organization_admin awscc_detective_organization_admin} Data Source
  *
  * @param scope The scope in which to define this construct
