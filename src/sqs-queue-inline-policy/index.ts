...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/sqs_queue_inline_policy
...
export class SqsQueueInlinePolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SqsQueueInlinePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/sqs_queue_inline_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/sqs_queue_inline_policy awscc_sqs_queue_inline_policy} Resource
  *
  * @param scope The scope in which to define this construct
