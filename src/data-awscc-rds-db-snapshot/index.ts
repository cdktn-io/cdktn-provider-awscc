...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/rds_db_snapshot
...
export class DataAwsccRdsDbSnapshot extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRdsDbSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/rds_db_snapshot#import import section} in the documentation of this resource for the id to use
