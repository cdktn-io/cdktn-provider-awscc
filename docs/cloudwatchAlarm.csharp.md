...
```csharp
private void PutWarmUpConfiguration(CloudwatchAlarmWarmUpConfiguration Value)
```
...
| <code><a href="#@cdktn/provider-awscc.cloudwatchAlarm.CloudwatchAlarm.property.warmUpConfigurationInput">WarmUpConfigurationInput</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.cloudwatchAlarm.CloudwatchAlarmWarmUpConfiguration">CloudwatchAlarmWarmUpConfiguration</a></code> | *No description.* |
...
```csharp
public CloudwatchAlarmWarmUpConfigurationOutputReference WarmUpConfiguration { get; }
```
...
```csharp
public IResolvable|CloudwatchAlarmWarmUpConfiguration WarmUpConfigurationInput { get; }
```

- *Type:* Io.Cdktn.IResolvable|<a href="#@cdktn/provider-awscc.cloudwatchAlarm.CloudwatchAlarmWarmUpConfiguration">CloudwatchAlarmWarmUpConfiguration</a>
...
new CloudwatchAlarmConfig {
    ...
    string Unit = null,
    CloudwatchAlarmWarmUpConfiguration WarmUpConfiguration = null
};
```
...
```csharp
public CloudwatchAlarmWarmUpConfiguration WarmUpConfiguration { get; set; }
```
...
new CloudwatchAlarmWarmUpConfiguration {
...
| <code><a href="#@cdktn/provider-awscc.cloudwatchAlarm.CloudwatchAlarmWarmUpConfiguration.property.warmUpPeriodDurationInMinutes">WarmUpPeriodDurationInMinutes</a></code> | <code>double</code> | The length of the warm-up period, in minutes. |
...
new CloudwatchAlarmWarmUpConfigurationOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.cloudwatchAlarm.CloudwatchAlarmWarmUpConfigurationOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.cloudwatchAlarm.CloudwatchAlarmWarmUpConfigurationOutputReference.resolve.parameter._context"></a>
...
| <code><a href="#@cdktn/provider-awscc.cloudwatchAlarm.CloudwatchAlarmWarmUpConfigurationOutputReference.property.onlyStartEvaluatingAfterWarmUpPeriodEndsInput">OnlyStartEvaluatingAfterWarmUpPeriodEndsInput</a></code> | <code>bool\|Io.Cdktn.IResolvable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.cloudwatchAlarm.CloudwatchAlarmWarmUpConfigurationOutputReference.property.warmUpPeriodDurationInMinutesInput">WarmUpPeriodDurationInMinutesInput</a></code> | <code>double</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.cloudwatchAlarm.CloudwatchAlarmWarmUpConfigurationOutputReference.property.onlyStartEvaluatingAfterWarmUpPeriodEnds">OnlyStartEvaluatingAfterWarmUpPeriodEnds</a></code> | <code>bool\|Io.Cdktn.IResolvable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.cloudwatchAlarm.CloudwatchAlarmWarmUpConfigurationOutputReference.property.warmUpPeriodDurationInMinutes">WarmUpPeriodDurationInMinutes</a></code> | <code>double</code> | *No description.* |
...
```csharp
public IResolvable|CloudwatchAlarmWarmUpConfiguration InternalValue { get; }
```
