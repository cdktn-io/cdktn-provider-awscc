...
```typescript
import { dataAwsccGuarddutyMembers } from '@cdktn/provider-awscc'

new dataAwsccGuarddutyMembers.DataAwsccGuarddutyMembers(scope: Construct, id: string, config?: DataAwsccGuarddutyMembersConfig)
```
...
dataAwsccGuarddutyMembers.DataAwsccGuarddutyMembers.isConstruct(x: any)
```
...
dataAwsccGuarddutyMembers.DataAwsccGuarddutyMembers.isTerraformElement(x: any)
```
...
dataAwsccGuarddutyMembers.DataAwsccGuarddutyMembers.isTerraformDataSource(x: any)
```
...
dataAwsccGuarddutyMembers.DataAwsccGuarddutyMembers.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGuarddutyMembers.DataAwsccGuarddutyMembers.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGuarddutyMembers.DataAwsccGuarddutyMembers.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGuarddutyMembers.DataAwsccGuarddutyMembers.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGuarddutyMembers.DataAwsccGuarddutyMembers.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGuarddutyMembers.DataAwsccGuarddutyMembers.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccGuarddutyMembersConfig: dataAwsccGuarddutyMembers.DataAwsccGuarddutyMembersConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGuarddutyMembers.DataAwsccGuarddutyMembersConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGuarddutyMembers.DataAwsccGuarddutyMembersConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGuarddutyMembers.DataAwsccGuarddutyMembersConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGuarddutyMembers.DataAwsccGuarddutyMembersConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
