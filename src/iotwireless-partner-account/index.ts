...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/iotwireless_partner_account
...
export class IotwirelessPartnerAccount extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotwirelessPartnerAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/iotwireless_partner_account#import import section} in the documentation of this resource for the id to use
