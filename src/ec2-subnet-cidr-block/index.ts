...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/ec2_subnet_cidr_block
...
export class Ec2SubnetCidrBlock extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2SubnetCidrBlock that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/ec2_subnet_cidr_block#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/ec2_subnet_cidr_block awscc_ec2_subnet_cidr_block} Resource
  *
  * @param scope The scope in which to define this construct
