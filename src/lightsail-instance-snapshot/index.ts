...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/lightsail_instance_snapshot
...
export class LightsailInstanceSnapshot extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LightsailInstanceSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/lightsail_instance_snapshot#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/lightsail_instance_snapshot awscc_lightsail_instance_snapshot} Resource
  *
  * @param scope The scope in which to define this construct
