...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/lightsail_alarm
...
export class LightsailAlarm extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LightsailAlarm that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/lightsail_alarm#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/lightsail_alarm awscc_lightsail_alarm} Resource
  *
  * @param scope The scope in which to define this construct
