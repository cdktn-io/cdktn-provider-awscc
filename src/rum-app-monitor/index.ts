...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/rum_app_monitor
...
export class RumAppMonitor extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RumAppMonitor that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/rum_app_monitor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/rum_app_monitor awscc_rum_app_monitor} Resource
  *
  * @param scope The scope in which to define this construct
