...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/invoicing_procurement_portal_preference
...
export class DataAwsccInvoicingProcurementPortalPreference extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccInvoicingProcurementPortalPreference that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/invoicing_procurement_portal_preference#import import section} in the documentation of this resource for the id to use
