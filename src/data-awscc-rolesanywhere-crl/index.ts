...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/rolesanywhere_crl
...
export class DataAwsccRolesanywhereCrl extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRolesanywhereCrl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/rolesanywhere_crl#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/rolesanywhere_crl awscc_rolesanywhere_crl} Data Source
  *
  * @param scope The scope in which to define this construct
