...
```typescript
import { dataAwsccChimeAppInstances } from '@cdktn/provider-awscc'

new dataAwsccChimeAppInstances.DataAwsccChimeAppInstances(scope: Construct, id: string, config?: DataAwsccChimeAppInstancesConfig)
```
...
dataAwsccChimeAppInstances.DataAwsccChimeAppInstances.isConstruct(x: any)
```
...
dataAwsccChimeAppInstances.DataAwsccChimeAppInstances.isTerraformElement(x: any)
```
...
dataAwsccChimeAppInstances.DataAwsccChimeAppInstances.isTerraformDataSource(x: any)
```
...
dataAwsccChimeAppInstances.DataAwsccChimeAppInstances.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeAppInstances.DataAwsccChimeAppInstances.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeAppInstances.DataAwsccChimeAppInstances.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeAppInstances.DataAwsccChimeAppInstances.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeAppInstances.DataAwsccChimeAppInstances.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeAppInstances.DataAwsccChimeAppInstances.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccChimeAppInstancesConfig: dataAwsccChimeAppInstances.DataAwsccChimeAppInstancesConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeAppInstances.DataAwsccChimeAppInstancesConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeAppInstances.DataAwsccChimeAppInstancesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeAppInstances.DataAwsccChimeAppInstancesConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeAppInstances.DataAwsccChimeAppInstancesConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
