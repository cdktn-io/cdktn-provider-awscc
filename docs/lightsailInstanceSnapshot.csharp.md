...
new LightsailInstanceSnapshot(Construct Scope, string Id, LightsailInstanceSnapshotConfig Config);
```
...
```csharp
private void PutTags(IResolvable|LightsailInstanceSnapshotTags[] Value)
```
...
- *Type:* Io.Cdktn.IResolvable|<a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshotTags">LightsailInstanceSnapshotTags</a>[]
...
LightsailInstanceSnapshot.IsConstruct(object X);
```
...
LightsailInstanceSnapshot.IsTerraformElement(object X);
```
...
LightsailInstanceSnapshot.IsTerraformResource(object X);
```
...
LightsailInstanceSnapshot.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshot.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshot.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshot.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshot.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshot.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshot.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshot.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshot.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshot.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshot.property.isFromAutoSnapshot">IsFromAutoSnapshot</a></code> | <code>Io.Cdktn.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshot.property.sizeInGb">SizeInGb</a></code> | <code>double</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshot.property.tagsInput">TagsInput</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshotTags">LightsailInstanceSnapshotTags</a>[]</code> | *No description.* |
...
```csharp
public LightsailInstanceSnapshotLocationOutputReference Location { get; }
```
...
```csharp
public LightsailInstanceSnapshotTagsList Tags { get; }
```
...
```csharp
public string InstanceSnapshotNameInput { get; }
```
...
```csharp
public IResolvable|LightsailInstanceSnapshotTags[] TagsInput { get; }
```
...
new LightsailInstanceSnapshotConfig {
    ...
    IResolvable|LightsailInstanceSnapshotTags[] Tags = null
};
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshotConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshotConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshotConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshotConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshotConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshotConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshotConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
```csharp
public IResolvable|LightsailInstanceSnapshotTags[] Tags { get; set; }
```
...
new LightsailInstanceSnapshotLocation {
...
new LightsailInstanceSnapshotTags {
    string Key = null,
    string Value = null
};
```
...
new LightsailInstanceSnapshotLocationOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshotLocationOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshotLocationOutputReference.resolve.parameter._context"></a>
...
```csharp
public LightsailInstanceSnapshotLocation InternalValue { get; }
```
...
new LightsailInstanceSnapshotTagsList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshotTagsList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshotTagsList.resolve.parameter._context"></a>
...
```csharp
private LightsailInstanceSnapshotTagsOutputReference Get(double Index)
```
...
| <code><a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshotTagsList.property.internalValue">InternalValue</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshotTags">LightsailInstanceSnapshotTags</a>[]</code> | *No description.* |
...
```csharp
public IResolvable|LightsailInstanceSnapshotTags[] InternalValue { get; }
```
...
new LightsailInstanceSnapshotTagsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshotTagsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshotTagsOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.lightsailInstanceSnapshot.LightsailInstanceSnapshotTagsOutputReference.resolve.parameter._context"></a>
