...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ssm_service_setting
...
export class SsmServiceSetting extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SsmServiceSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ssm_service_setting#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ssm_service_setting awscc_ssm_service_setting} Resource
  *
  * @param scope The scope in which to define this construct
