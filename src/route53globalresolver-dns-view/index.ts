...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/route53globalresolver_dns_view
...
export class Route53GlobalresolverDnsView extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53GlobalresolverDnsView that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/route53globalresolver_dns_view#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/route53globalresolver_dns_view awscc_route53globalresolver_dns_view} Resource
  *
  * @param scope The scope in which to define this construct
