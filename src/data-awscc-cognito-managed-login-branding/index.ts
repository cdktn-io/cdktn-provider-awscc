...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/cognito_managed_login_branding
...
export class DataAwsccCognitoManagedLoginBranding extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCognitoManagedLoginBranding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/cognito_managed_login_branding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/cognito_managed_login_branding awscc_cognito_managed_login_branding} Data Source
  *
  * @param scope The scope in which to define this construct
