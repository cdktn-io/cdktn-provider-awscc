...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/rolesanywhere_crls
...
export class DataAwsccRolesanywhereCrls extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRolesanywhereCrls that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/rolesanywhere_crls#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/rolesanywhere_crls awscc_rolesanywhere_crls} Data Source
  *
  * @param scope The scope in which to define this construct
