...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/ec2_transit_gateway_multicast_group_sources
...
export class DataAwsccEc2TransitGatewayMulticastGroupSources extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEc2TransitGatewayMulticastGroupSources that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/ec2_transit_gateway_multicast_group_sources#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/ec2_transit_gateway_multicast_group_sources awscc_ec2_transit_gateway_multicast_group_sources} Data Source
  *
  * @param scope The scope in which to define this construct
