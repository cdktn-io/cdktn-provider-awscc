...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/notifications_notification_hub
...
export class DataAwsccNotificationsNotificationHub extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccNotificationsNotificationHub that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/notifications_notification_hub#import import section} in the documentation of this resource for the id to use
