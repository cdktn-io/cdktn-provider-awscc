...
```go
func Tags() DataAwsccApplicationautoscalingScalableTargetTagsList
```
...
&dataawsccapplicationautoscalingscalabletarget.DataAwsccApplicationautoscalingScalableTargetTags {
...
dataawsccapplicationautoscalingscalabletarget.NewDataAwsccApplicationautoscalingScalableTargetTagsList(terraformResource IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccApplicationautoscalingScalableTargetTagsList
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApplicationautoscalingScalableTarget.DataAwsccApplicationautoscalingScalableTargetTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `_context`<sup>Required</sup> <a name="_context" id="@cdktn/provider-awscc.dataAwsccApplicationautoscalingScalableTarget.DataAwsccApplicationautoscalingScalableTargetTagsList.resolve.parameter._context"></a>
...
```go
func Get(index *f64) DataAwsccApplicationautoscalingScalableTargetTagsOutputReference
```
...
dataawsccapplicationautoscalingscalabletarget.NewDataAwsccApplicationautoscalingScalableTargetTagsOutputReference(terraformResource IInterpolatingParent, terraformAttribute *string, complexObjectIndex *f64, complexObjectIsFromSet *bool) DataAwsccApplicationautoscalingScalableTargetTagsOutputReference
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApplicationautoscalingScalableTarget.DataAwsccApplicationautoscalingScalableTargetTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>*f64</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApplicationautoscalingScalableTarget.DataAwsccApplicationautoscalingScalableTargetTagsOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>*bool</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
###### `_context`<sup>Required</sup> <a name="_context" id="@cdktn/provider-awscc.dataAwsccApplicationautoscalingScalableTarget.DataAwsccApplicationautoscalingScalableTargetTagsOutputReference.resolve.parameter._context"></a>
...
```go
func InternalValue() DataAwsccApplicationautoscalingScalableTargetTags
```
