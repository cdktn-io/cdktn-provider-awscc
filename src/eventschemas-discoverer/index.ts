...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/eventschemas_discoverer
...
export class EventschemasDiscoverer extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EventschemasDiscoverer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/eventschemas_discoverer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/eventschemas_discoverer awscc_eventschemas_discoverer} Resource
  *
  * @param scope The scope in which to define this construct
