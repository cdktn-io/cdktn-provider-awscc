...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/bedrockagentcore_runtimes
...
export class DataAwsccBedrockagentcoreRuntimes extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccBedrockagentcoreRuntimes that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/bedrockagentcore_runtimes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/bedrockagentcore_runtimes awscc_bedrockagentcore_runtimes} Data Source
  *
  * @param scope The scope in which to define this construct
