...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/personalize_metric_attributions
...
export class DataAwsccPersonalizeMetricAttributions extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccPersonalizeMetricAttributions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/personalize_metric_attributions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/personalize_metric_attributions awscc_personalize_metric_attributions} Data Source
  *
  * @param scope The scope in which to define this construct
