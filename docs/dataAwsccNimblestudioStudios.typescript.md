...
```typescript
import { dataAwsccNimblestudioStudios } from '@cdktn/provider-awscc'

new dataAwsccNimblestudioStudios.DataAwsccNimblestudioStudios(scope: Construct, id: string, config?: DataAwsccNimblestudioStudiosConfig)
```
...
dataAwsccNimblestudioStudios.DataAwsccNimblestudioStudios.isConstruct(x: any)
```
...
dataAwsccNimblestudioStudios.DataAwsccNimblestudioStudios.isTerraformElement(x: any)
```
...
dataAwsccNimblestudioStudios.DataAwsccNimblestudioStudios.isTerraformDataSource(x: any)
```
...
dataAwsccNimblestudioStudios.DataAwsccNimblestudioStudios.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNimblestudioStudios.DataAwsccNimblestudioStudios.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNimblestudioStudios.DataAwsccNimblestudioStudios.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNimblestudioStudios.DataAwsccNimblestudioStudios.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNimblestudioStudios.DataAwsccNimblestudioStudios.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNimblestudioStudios.DataAwsccNimblestudioStudios.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccNimblestudioStudiosConfig: dataAwsccNimblestudioStudios.DataAwsccNimblestudioStudiosConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNimblestudioStudios.DataAwsccNimblestudioStudiosConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNimblestudioStudios.DataAwsccNimblestudioStudiosConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNimblestudioStudios.DataAwsccNimblestudioStudiosConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNimblestudioStudios.DataAwsccNimblestudioStudiosConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
