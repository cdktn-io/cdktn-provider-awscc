...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/fsx_volume
...
export interface DataAwsccFsxVolumeConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/fsx_volume#id DataAwsccFsxVolume#id}
  *
...
export class DataAwsccFsxVolume extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccFsxVolume that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/fsx_volume#import import section} in the documentation of this resource for the id to use
