...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/glue_catalog
...
export class GlueCatalog extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GlueCatalog that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/glue_catalog#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/glue_catalog awscc_glue_catalog} Resource
  *
  * @param scope The scope in which to define this construct
