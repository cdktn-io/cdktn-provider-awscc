...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/securityhub_organization_configurations
...
export class DataAwsccSecurityhubOrganizationConfigurations extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccSecurityhubOrganizationConfigurations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/securityhub_organization_configurations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/securityhub_organization_configurations awscc_securityhub_organization_configurations} Data Source
  *
  * @param scope The scope in which to define this construct
