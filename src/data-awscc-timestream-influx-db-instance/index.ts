...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/timestream_influx_db_instance
...
export class DataAwsccTimestreamInfluxDbInstance extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccTimestreamInfluxDbInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/timestream_influx_db_instance#import import section} in the documentation of this resource for the id to use
