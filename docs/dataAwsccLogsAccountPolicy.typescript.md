...
```typescript
import { dataAwsccLogsAccountPolicy } from '@cdktn/provider-awscc'

new dataAwsccLogsAccountPolicy.DataAwsccLogsAccountPolicy(scope: Construct, id: string, config: DataAwsccLogsAccountPolicyConfig)
```
...
dataAwsccLogsAccountPolicy.DataAwsccLogsAccountPolicy.isConstruct(x: any)
```
...
dataAwsccLogsAccountPolicy.DataAwsccLogsAccountPolicy.isTerraformElement(x: any)
```
...
dataAwsccLogsAccountPolicy.DataAwsccLogsAccountPolicy.isTerraformDataSource(x: any)
```
...
dataAwsccLogsAccountPolicy.DataAwsccLogsAccountPolicy.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccLogsAccountPolicy.DataAwsccLogsAccountPolicy.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccLogsAccountPolicy.DataAwsccLogsAccountPolicy.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccLogsAccountPolicy.DataAwsccLogsAccountPolicy.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLogsAccountPolicy.DataAwsccLogsAccountPolicy.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccLogsAccountPolicy.DataAwsccLogsAccountPolicy.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccLogsAccountPolicyConfig: dataAwsccLogsAccountPolicy.DataAwsccLogsAccountPolicyConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccLogsAccountPolicy.DataAwsccLogsAccountPolicyConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLogsAccountPolicy.DataAwsccLogsAccountPolicyConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLogsAccountPolicy.DataAwsccLogsAccountPolicyConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccLogsAccountPolicy.DataAwsccLogsAccountPolicyConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
