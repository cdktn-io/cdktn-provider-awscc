...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ssm_ops_item
...
export interface SsmOpsItemConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ssm_ops_item#category SsmOpsItem#category}
  */
  readonly category?: string;
  /**
  * The description of the OpsItem.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ssm_ops_item#description SsmOpsItem#description}
  */
  readonly description: string;
  /**
  * The priority of the OpsItem.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ssm_ops_item#priority SsmOpsItem#priority}
  */
  readonly priority?: number;
  /**
  * The severity of the OpsItem.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ssm_ops_item#severity SsmOpsItem#severity}
  */
  readonly severity?: string;
  /**
  * The origin of the OpsItem.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ssm_ops_item#source SsmOpsItem#source}
  */
  readonly source: string;
  /**
  * Tags for the OpsItem.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ssm_ops_item#tags SsmOpsItem#tags}
  */
  readonly tags?: SsmOpsItemTags[] | cdktn.IResolvable;
  /**
  * The title of the OpsItem.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ssm_ops_item#title SsmOpsItem#title}
  */
  readonly title: string;
}
export interface SsmOpsItemTags {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ssm_ops_item#key SsmOpsItem#key}
  */
  readonly key?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ssm_ops_item#value SsmOpsItem#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ssm_ops_item awscc_ssm_ops_item}
*/
export class SsmOpsItem extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SsmOpsItem that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ssm_ops_item#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ssm_ops_item awscc_ssm_ops_item} Resource
  *
  * @param scope The scope in which to define this construct
