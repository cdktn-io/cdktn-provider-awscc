...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/devopsguru_resource_collection
...
export class DataAwsccDevopsguruResourceCollection extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDevopsguruResourceCollection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/devopsguru_resource_collection#import import section} in the documentation of this resource for the id to use
