...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/guardduty_master
...
export class GuarddutyMaster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GuarddutyMaster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/guardduty_master#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/guardduty_master awscc_guardduty_master} Resource
  *
  * @param scope The scope in which to define this construct
