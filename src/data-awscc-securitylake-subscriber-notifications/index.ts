...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/securitylake_subscriber_notifications
...
export class DataAwsccSecuritylakeSubscriberNotifications extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccSecuritylakeSubscriberNotifications that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/securitylake_subscriber_notifications#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/securitylake_subscriber_notifications awscc_securitylake_subscriber_notifications} Data Source
  *
  * @param scope The scope in which to define this construct
