...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/sagemaker_pipelines
...
export class DataAwsccSagemakerPipelines extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccSagemakerPipelines that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/sagemaker_pipelines#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/sagemaker_pipelines awscc_sagemaker_pipelines} Data Source
  *
  * @param scope The scope in which to define this construct
