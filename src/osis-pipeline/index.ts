...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/osis_pipeline
...
export class OsisPipeline extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OsisPipeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/osis_pipeline#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/osis_pipeline awscc_osis_pipeline} Resource
  *
  * @param scope The scope in which to define this construct
