...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/route53_dnssec
...
export class Route53Dnssec extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53Dnssec that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/route53_dnssec#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/route53_dnssec awscc_route53_dnssec} Resource
  *
  * @param scope The scope in which to define this construct
