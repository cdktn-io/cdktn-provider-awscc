...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/config_delivery_channel
...
export class DataAwsccConfigDeliveryChannel extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccConfigDeliveryChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/config_delivery_channel#import import section} in the documentation of this resource for the id to use
