...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/codeconnections_connection
...
export class CodeconnectionsConnection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CodeconnectionsConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/codeconnections_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/codeconnections_connection awscc_codeconnections_connection} Resource
  *
  * @param scope The scope in which to define this construct
