...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/refactorspaces_route
...
export class RefactorspacesRoute extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RefactorspacesRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/refactorspaces_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/refactorspaces_route awscc_refactorspaces_route} Resource
  *
  * @param scope The scope in which to define this construct
