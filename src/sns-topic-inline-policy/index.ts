...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/sns_topic_inline_policy
...
export interface SnsTopicInlinePolicyConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/sns_topic_inline_policy#policy_document SnsTopicInlinePolicy#policy_document}
  */
  readonly policyDocument: string;
  /**
  * The Amazon Resource Name (ARN) of the topic to which you want to add the policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/sns_topic_inline_policy#topic_arn SnsTopicInlinePolicy#topic_arn}
  */
  readonly topicArn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/sns_topic_inline_policy awscc_sns_topic_inline_policy}
*/
export class SnsTopicInlinePolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SnsTopicInlinePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/sns_topic_inline_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/sns_topic_inline_policy awscc_sns_topic_inline_policy} Resource
  *
  * @param scope The scope in which to define this construct
