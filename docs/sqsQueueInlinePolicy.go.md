...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/sqsqueueinlinepolicy"

sqsqueueinlinepolicy.NewSqsQueueInlinePolicy(scope Construct, id *string, config SqsQueueInlinePolicyConfig) SqsQueueInlinePolicy
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicy.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicy.Initializer.parameter.id">id</a></code> | <code>*string</code> | The scoped construct ID. |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicy.Initializer.parameter.config">config</a></code> | <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicyConfig">SqsQueueInlinePolicyConfig</a></code> | *No description.* |
...
##### `config`<sup>Required</sup> <a name="config" id="@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicy.Initializer.parameter.config"></a>

- *Type:* <a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicyConfig">SqsQueueInlinePolicyConfig</a>
...
sqsqueueinlinepolicy.SqsQueueInlinePolicy_IsConstruct(x interface{}) *bool
```
...
sqsqueueinlinepolicy.SqsQueueInlinePolicy_IsTerraformElement(x interface{}) *bool
```
...
sqsqueueinlinepolicy.SqsQueueInlinePolicy_IsTerraformResource(x interface{}) *bool
```
...
sqsqueueinlinepolicy.SqsQueueInlinePolicy_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicy.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicy.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicy.property.fqn">Fqn</a></code> | <code>*string</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicy.property.friendlyUniqueId">FriendlyUniqueId</a></code> | <code>*string</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicy.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicy.property.terraformResourceType">TerraformResourceType</a></code> | <code>*string</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicy.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicy.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicy.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicy.property.dependsOn">DependsOn</a></code> | <code>*[]*string</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicy.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicy.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicy.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicy.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicy.property.id">Id</a></code> | <code>*string</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicy.property.policyDocumentInput">PolicyDocumentInput</a></code> | <code>*string</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicy.property.queueInput">QueueInput</a></code> | <code>*string</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicy.property.policyDocument">PolicyDocument</a></code> | <code>*string</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicy.property.queue">Queue</a></code> | <code>*string</code> | *No description.* |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicy.property.tfResourceType">TfResourceType</a></code> | <code>*string</code> | *No description.* |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicyConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicyConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicyConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicyConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicyConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicyConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicyConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicyConfig.property.policyDocument">PolicyDocument</a></code> | <code>*string</code> | A policy document that contains permissions to add to the specified SQS queue. |
| <code><a href="#@cdktn/provider-awscc.sqsQueueInlinePolicy.SqsQueueInlinePolicyConfig.property.queue">Queue</a></code> | <code>*string</code> | The URL of the SQS queue. |
