...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/qldb_stream
...
export class QldbStream extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing QldbStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/qldb_stream#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/qldb_stream awscc_qldb_stream} Resource
  *
  * @param scope The scope in which to define this construct
