...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/eks_identity_provider_config
...
export class DataAwsccEksIdentityProviderConfig extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEksIdentityProviderConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/eks_identity_provider_config#import import section} in the documentation of this resource for the id to use
