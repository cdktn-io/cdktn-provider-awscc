...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/identitystore_user
...
export interface DataAwsccIdentitystoreUserConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/identitystore_user#id DataAwsccIdentitystoreUser#id}
  *
...
export class DataAwsccIdentitystoreUser extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIdentitystoreUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/identitystore_user#import import section} in the documentation of this resource for the id to use
