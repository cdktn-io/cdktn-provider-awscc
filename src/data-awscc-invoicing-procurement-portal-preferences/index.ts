...
export interface DataAwsccInvoicingProcurementPortalPreferencesConfig extends cdktn.TerraformMetaArguments {
}
...
export class DataAwsccInvoicingProcurementPortalPreferences extends cdktn.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "awscc_invoicing_procurement_portal_preferences";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "awscc_invoicing_procurement_portal_preferences", importId: importFromId, provider });
      }
  ...
  * @param options DataAwsccInvoicingProcurementPortalPreferencesConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataAwsccInvoicingProcurementPortalPreferencesConfig = {}) {
    super(scope, id, {
