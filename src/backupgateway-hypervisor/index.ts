...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/backupgateway_hypervisor
...
export class BackupgatewayHypervisor extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BackupgatewayHypervisor that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/backupgateway_hypervisor#import import section} in the documentation of this resource for the id to use
