...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/rbin_rule
...
export class RbinRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RbinRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/rbin_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/rbin_rule awscc_rbin_rule} Resource
  *
  * @param scope The scope in which to define this construct
