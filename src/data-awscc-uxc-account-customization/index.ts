...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/uxc_account_customization
...
export class DataAwsccUxcAccountCustomization extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccUxcAccountCustomization that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/uxc_account_customization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/uxc_account_customization awscc_uxc_account_customization} Data Source
  *
  * @param scope The scope in which to define this construct
