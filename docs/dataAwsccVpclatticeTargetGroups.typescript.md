...
```typescript
import { dataAwsccVpclatticeTargetGroups } from '@cdktn/provider-awscc'

new dataAwsccVpclatticeTargetGroups.DataAwsccVpclatticeTargetGroups(scope: Construct, id: string, config?: DataAwsccVpclatticeTargetGroupsConfig)
```
...
dataAwsccVpclatticeTargetGroups.DataAwsccVpclatticeTargetGroups.isConstruct(x: any)
```
...
dataAwsccVpclatticeTargetGroups.DataAwsccVpclatticeTargetGroups.isTerraformElement(x: any)
```
...
dataAwsccVpclatticeTargetGroups.DataAwsccVpclatticeTargetGroups.isTerraformDataSource(x: any)
```
...
dataAwsccVpclatticeTargetGroups.DataAwsccVpclatticeTargetGroups.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeTargetGroups.DataAwsccVpclatticeTargetGroups.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeTargetGroups.DataAwsccVpclatticeTargetGroups.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeTargetGroups.DataAwsccVpclatticeTargetGroups.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeTargetGroups.DataAwsccVpclatticeTargetGroups.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeTargetGroups.DataAwsccVpclatticeTargetGroups.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccVpclatticeTargetGroupsConfig: dataAwsccVpclatticeTargetGroups.DataAwsccVpclatticeTargetGroupsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeTargetGroups.DataAwsccVpclatticeTargetGroupsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeTargetGroups.DataAwsccVpclatticeTargetGroupsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeTargetGroups.DataAwsccVpclatticeTargetGroupsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccVpclatticeTargetGroups.DataAwsccVpclatticeTargetGroupsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
