...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/outposts_site
...
export class OutpostsSite extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OutpostsSite that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/outposts_site#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/outposts_site awscc_outposts_site} Resource
  *
  * @param scope The scope in which to define this construct
