...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/eventschemas_registries
...
export class DataAwsccEventschemasRegistries extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEventschemasRegistries that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/eventschemas_registries#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/eventschemas_registries awscc_eventschemas_registries} Data Source
  *
  * @param scope The scope in which to define this construct
