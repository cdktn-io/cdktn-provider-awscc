...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/lightsail_contact_method
...
export interface LightsailContactMethodConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/lightsail_contact_method#contact_endpoint LightsailContactMethod#contact_endpoint}
  */
  readonly contactEndpoint: string;
  /**
  * The protocol of the contact method, such as Email or SMS (text messaging).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/lightsail_contact_method#protocol LightsailContactMethod#protocol}
  */
  readonly protocol: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/lightsail_contact_method awscc_lightsail_contact_method}
*/
export class LightsailContactMethod extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LightsailContactMethod that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/lightsail_contact_method#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/lightsail_contact_method awscc_lightsail_contact_method} Resource
  *
  * @param scope The scope in which to define this construct
