...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/deadline_metered_product
...
export class DataAwsccDeadlineMeteredProduct extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDeadlineMeteredProduct that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/deadline_metered_product#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/deadline_metered_product awscc_deadline_metered_product} Data Source
  *
  * @param scope The scope in which to define this construct
