...
export interface OdbCloudVmClusterDbNodesTags {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/odb_cloud_vm_cluster#key OdbCloudVmCluster#key}
  */
  readonly key?: string;
  /**
...
export class OdbCloudVmCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OdbCloudVmCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/odb_cloud_vm_cluster#import import section} in the documentation of this resource for the id to use
