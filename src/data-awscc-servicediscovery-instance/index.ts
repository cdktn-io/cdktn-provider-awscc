...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/servicediscovery_instance
...
export interface DataAwsccServicediscoveryInstanceConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataAwsccServicediscoveryInstance extends cdktn.TerraformDataSource {
  ...
  * @param importToId The construct id used in the generated config for the DataAwsccServicediscoveryInstance to import
  * @param importFromId The id of the existing DataAwsccServicediscoveryInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/servicediscovery_instance#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAwsccServicediscoveryInstance to import is found
  */
  ...
  * @param options DataAwsccServicediscoveryInstanceConfig
  */
  public constructor(scope: Construct, id: string, config: DataAwsccServicediscoveryInstanceConfig) {
    super(scope, id, {
  ...
  // instance_attributes - computed: true, optional: false, required: false
