...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ssm_cloud_connector
...
export class SsmCloudConnector extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SsmCloudConnector that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ssm_cloud_connector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ssm_cloud_connector awscc_ssm_cloud_connector} Resource
  *
  * @param scope The scope in which to define this construct
