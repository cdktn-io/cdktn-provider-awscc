...
```typescript
import { dataAwsccCodeconnectionsHost } from '@cdktn/provider-awscc'

new dataAwsccCodeconnectionsHost.DataAwsccCodeconnectionsHost(scope: Construct, id: string, config: DataAwsccCodeconnectionsHostConfig)
```
...
dataAwsccCodeconnectionsHost.DataAwsccCodeconnectionsHost.isConstruct(x: any)
```
...
dataAwsccCodeconnectionsHost.DataAwsccCodeconnectionsHost.isTerraformElement(x: any)
```
...
dataAwsccCodeconnectionsHost.DataAwsccCodeconnectionsHost.isTerraformDataSource(x: any)
```
...
dataAwsccCodeconnectionsHost.DataAwsccCodeconnectionsHost.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsHost.DataAwsccCodeconnectionsHost.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsHost.DataAwsccCodeconnectionsHost.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsHost.DataAwsccCodeconnectionsHost.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsHost.DataAwsccCodeconnectionsHost.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsHost.DataAwsccCodeconnectionsHost.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
```typescript
public readonly tags: DataAwsccCodeconnectionsHostTagsList;
```
...
```typescript
public readonly vpcConfiguration: DataAwsccCodeconnectionsHostVpcConfigurationOutputReference;
```
...
const dataAwsccCodeconnectionsHostConfig: dataAwsccCodeconnectionsHost.DataAwsccCodeconnectionsHostConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsHost.DataAwsccCodeconnectionsHostConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsHost.DataAwsccCodeconnectionsHostConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsHost.DataAwsccCodeconnectionsHostConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsHost.DataAwsccCodeconnectionsHostConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const dataAwsccCodeconnectionsHostTags: dataAwsccCodeconnectionsHost.DataAwsccCodeconnectionsHostTags = { ... }
```
...
const dataAwsccCodeconnectionsHostVpcConfiguration: dataAwsccCodeconnectionsHost.DataAwsccCodeconnectionsHostVpcConfiguration = { ... }
```
...
new dataAwsccCodeconnectionsHost.DataAwsccCodeconnectionsHostTagsList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsHost.DataAwsccCodeconnectionsHostTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsHost.DataAwsccCodeconnectionsHostTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
new dataAwsccCodeconnectionsHost.DataAwsccCodeconnectionsHostTagsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsHost.DataAwsccCodeconnectionsHostTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsHost.DataAwsccCodeconnectionsHostTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsHost.DataAwsccCodeconnectionsHostTagsOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```typescript
public readonly internalValue: DataAwsccCodeconnectionsHostTags;
```
...
new dataAwsccCodeconnectionsHost.DataAwsccCodeconnectionsHostVpcConfigurationOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsHost.DataAwsccCodeconnectionsHostVpcConfigurationOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public readonly internalValue: DataAwsccCodeconnectionsHostVpcConfiguration;
```
