...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/bedrockagentcore_policy_engines
...
export class DataAwsccBedrockagentcorePolicyEngines extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccBedrockagentcorePolicyEngines that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/bedrockagentcore_policy_engines#import import section} in the documentation of this resource for the id to use
