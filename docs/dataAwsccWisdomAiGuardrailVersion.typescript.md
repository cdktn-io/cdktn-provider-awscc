...
```typescript
import { dataAwsccWisdomAiGuardrailVersion } from '@cdktn/provider-awscc'

new dataAwsccWisdomAiGuardrailVersion.DataAwsccWisdomAiGuardrailVersion(scope: Construct, id: string, config: DataAwsccWisdomAiGuardrailVersionConfig)
```
...
dataAwsccWisdomAiGuardrailVersion.DataAwsccWisdomAiGuardrailVersion.isConstruct(x: any)
```
...
dataAwsccWisdomAiGuardrailVersion.DataAwsccWisdomAiGuardrailVersion.isTerraformElement(x: any)
```
...
dataAwsccWisdomAiGuardrailVersion.DataAwsccWisdomAiGuardrailVersion.isTerraformDataSource(x: any)
```
...
dataAwsccWisdomAiGuardrailVersion.DataAwsccWisdomAiGuardrailVersion.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWisdomAiGuardrailVersion.DataAwsccWisdomAiGuardrailVersion.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWisdomAiGuardrailVersion.DataAwsccWisdomAiGuardrailVersion.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWisdomAiGuardrailVersion.DataAwsccWisdomAiGuardrailVersion.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccWisdomAiGuardrailVersion.DataAwsccWisdomAiGuardrailVersion.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWisdomAiGuardrailVersion.DataAwsccWisdomAiGuardrailVersion.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWisdomAiGuardrailVersion.DataAwsccWisdomAiGuardrailVersion.property.modifiedTimeSeconds">modifiedTimeSeconds</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccWisdomAiGuardrailVersion.DataAwsccWisdomAiGuardrailVersion.property.versionNumber">versionNumber</a></code> | <code>number</code> | *No description.* |
...
const dataAwsccWisdomAiGuardrailVersionConfig: dataAwsccWisdomAiGuardrailVersion.DataAwsccWisdomAiGuardrailVersionConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWisdomAiGuardrailVersion.DataAwsccWisdomAiGuardrailVersionConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccWisdomAiGuardrailVersion.DataAwsccWisdomAiGuardrailVersionConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccWisdomAiGuardrailVersion.DataAwsccWisdomAiGuardrailVersionConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWisdomAiGuardrailVersion.DataAwsccWisdomAiGuardrailVersionConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
