...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/ec2_enclave_certificate_iam_role_associations
...
export class DataAwsccEc2EnclaveCertificateIamRoleAssociations extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEc2EnclaveCertificateIamRoleAssociations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/ec2_enclave_certificate_iam_role_associations#import import section} in the documentation of this resource for the id to use
