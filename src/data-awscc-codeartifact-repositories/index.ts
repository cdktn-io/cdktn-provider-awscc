...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/codeartifact_repositories
...
export class DataAwsccCodeartifactRepositories extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCodeartifactRepositories that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/codeartifact_repositories#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/codeartifact_repositories awscc_codeartifact_repositories} Data Source
  *
  * @param scope The scope in which to define this construct
