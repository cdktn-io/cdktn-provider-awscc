...
```typescript
import { dataAwsccSsmDocuments } from '@cdktn/provider-awscc'

new dataAwsccSsmDocuments.DataAwsccSsmDocuments(scope: Construct, id: string, config?: DataAwsccSsmDocumentsConfig)
```
...
dataAwsccSsmDocuments.DataAwsccSsmDocuments.isConstruct(x: any)
```
...
dataAwsccSsmDocuments.DataAwsccSsmDocuments.isTerraformElement(x: any)
```
...
dataAwsccSsmDocuments.DataAwsccSsmDocuments.isTerraformDataSource(x: any)
```
...
dataAwsccSsmDocuments.DataAwsccSsmDocuments.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmDocuments.DataAwsccSsmDocuments.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmDocuments.DataAwsccSsmDocuments.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmDocuments.DataAwsccSsmDocuments.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmDocuments.DataAwsccSsmDocuments.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmDocuments.DataAwsccSsmDocuments.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccSsmDocumentsConfig: dataAwsccSsmDocuments.DataAwsccSsmDocumentsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmDocuments.DataAwsccSsmDocumentsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmDocuments.DataAwsccSsmDocumentsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmDocuments.DataAwsccSsmDocumentsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmDocuments.DataAwsccSsmDocumentsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
