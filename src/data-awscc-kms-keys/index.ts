...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/kms_keys
...
export class DataAwsccKmsKeys extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccKmsKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/kms_keys#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/kms_keys awscc_kms_keys} Data Source
  *
  * @param scope The scope in which to define this construct
