...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/sagemaker_human_task_uis
...
export class DataAwsccSagemakerHumanTaskUis extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccSagemakerHumanTaskUis that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/sagemaker_human_task_uis#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/sagemaker_human_task_uis awscc_sagemaker_human_task_uis} Data Source
  *
  * @param scope The scope in which to define this construct
