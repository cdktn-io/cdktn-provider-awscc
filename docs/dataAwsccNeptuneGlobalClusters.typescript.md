...
```typescript
import { dataAwsccNeptuneGlobalClusters } from '@cdktn/provider-awscc'

new dataAwsccNeptuneGlobalClusters.DataAwsccNeptuneGlobalClusters(scope: Construct, id: string, config?: DataAwsccNeptuneGlobalClustersConfig)
```
...
dataAwsccNeptuneGlobalClusters.DataAwsccNeptuneGlobalClusters.isConstruct(x: any)
```
...
dataAwsccNeptuneGlobalClusters.DataAwsccNeptuneGlobalClusters.isTerraformElement(x: any)
```
...
dataAwsccNeptuneGlobalClusters.DataAwsccNeptuneGlobalClusters.isTerraformDataSource(x: any)
```
...
dataAwsccNeptuneGlobalClusters.DataAwsccNeptuneGlobalClusters.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNeptuneGlobalClusters.DataAwsccNeptuneGlobalClusters.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNeptuneGlobalClusters.DataAwsccNeptuneGlobalClusters.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNeptuneGlobalClusters.DataAwsccNeptuneGlobalClusters.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNeptuneGlobalClusters.DataAwsccNeptuneGlobalClusters.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNeptuneGlobalClusters.DataAwsccNeptuneGlobalClusters.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccNeptuneGlobalClustersConfig: dataAwsccNeptuneGlobalClusters.DataAwsccNeptuneGlobalClustersConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNeptuneGlobalClusters.DataAwsccNeptuneGlobalClustersConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNeptuneGlobalClusters.DataAwsccNeptuneGlobalClustersConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNeptuneGlobalClusters.DataAwsccNeptuneGlobalClustersConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNeptuneGlobalClusters.DataAwsccNeptuneGlobalClustersConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
