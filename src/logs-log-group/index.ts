...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/logs_log_group
...
export class LogsLogGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LogsLogGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/logs_log_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/logs_log_group awscc_logs_log_group} Resource
  *
  * @param scope The scope in which to define this construct
