...
```typescript
import { sagemakerImage } from '@cdktn/provider-awscc'
...
```typescript
public putTags(value: IResolvable | SagemakerImageTags[]): void
```
...
```typescript
public resetImageDescription(): void
```
...
```typescript
public resetImageDisplayName(): void
```
...
| <code><a href="#@cdktn/provider-awscc.sagemakerImage.SagemakerImage.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.sagemakerImage.SagemakerImage.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.sagemakerImage.SagemakerImage.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.sagemakerImage.SagemakerImage.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.sagemakerImage.SagemakerImage.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.sagemakerImage.SagemakerImage.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.sagemakerImage.SagemakerImage.property.tagsInput">tagsInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.sagemakerImage.SagemakerImageTags">SagemakerImageTags</a>[]</code> | *No description.* |
...
```typescript
public readonly tags: SagemakerImageTagsList;
```
...
```typescript
public readonly imageDescriptionInput: string;
```
...
```typescript
public readonly imageDisplayNameInput: string;
```
...
```typescript
public readonly imageRoleArnInput: string;
```
...
```typescript
public readonly tagsInput: IResolvable | SagemakerImageTags[];
```
...
| <code><a href="#@cdktn/provider-awscc.sagemakerImage.SagemakerImageConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sagemakerImage.SagemakerImageConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sagemakerImage.SagemakerImageConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.sagemakerImage.SagemakerImageConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.sagemakerImage.SagemakerImageConfig.property.tags">tags</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.sagemakerImage.SagemakerImageTags">SagemakerImageTags</a>[]</code> | An array of key-value pairs to apply to this resource. |
...
```typescript
public readonly tags: IResolvable | SagemakerImageTags[];
```
...
const sagemakerImageTags: sagemakerImage.SagemakerImageTags = { ... }
```
...
new sagemakerImage.SagemakerImageTagsList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.sagemakerImage.SagemakerImageTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.sagemakerImage.SagemakerImageTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| <code><a href="#@cdktn/provider-awscc.sagemakerImage.SagemakerImageTagsList.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.sagemakerImage.SagemakerImageTags">SagemakerImageTags</a>[]</code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | SagemakerImageTags[];
```
...
new sagemakerImage.SagemakerImageTagsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.sagemakerImage.SagemakerImageTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.sagemakerImage.SagemakerImageTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-awscc.sagemakerImage.SagemakerImageTagsOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| <code><a href="#@cdktn/provider-awscc.sagemakerImage.SagemakerImageTagsOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.sagemakerImage.SagemakerImageTags">SagemakerImageTags</a></code> | *No description.* |
