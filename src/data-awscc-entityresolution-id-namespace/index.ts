...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/entityresolution_id_namespace
...
export class DataAwsccEntityresolutionIdNamespace extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEntityresolutionIdNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/entityresolution_id_namespace#import import section} in the documentation of this resource for the id to use
