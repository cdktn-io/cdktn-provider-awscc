...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ses_receipt_rule_set
...
export class SesReceiptRuleSet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SesReceiptRuleSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ses_receipt_rule_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ses_receipt_rule_set awscc_ses_receipt_rule_set} Resource
  *
  * @param scope The scope in which to define this construct
