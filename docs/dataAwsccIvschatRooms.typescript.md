...
```typescript
import { dataAwsccIvschatRooms } from '@cdktn/provider-awscc'

new dataAwsccIvschatRooms.DataAwsccIvschatRooms(scope: Construct, id: string, config?: DataAwsccIvschatRoomsConfig)
```
...
dataAwsccIvschatRooms.DataAwsccIvschatRooms.isConstruct(x: any)
```
...
dataAwsccIvschatRooms.DataAwsccIvschatRooms.isTerraformElement(x: any)
```
...
dataAwsccIvschatRooms.DataAwsccIvschatRooms.isTerraformDataSource(x: any)
```
...
dataAwsccIvschatRooms.DataAwsccIvschatRooms.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIvschatRooms.DataAwsccIvschatRooms.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIvschatRooms.DataAwsccIvschatRooms.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIvschatRooms.DataAwsccIvschatRooms.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIvschatRooms.DataAwsccIvschatRooms.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIvschatRooms.DataAwsccIvschatRooms.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccIvschatRoomsConfig: dataAwsccIvschatRooms.DataAwsccIvschatRoomsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIvschatRooms.DataAwsccIvschatRoomsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIvschatRooms.DataAwsccIvschatRoomsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIvschatRooms.DataAwsccIvschatRoomsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIvschatRooms.DataAwsccIvschatRoomsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
