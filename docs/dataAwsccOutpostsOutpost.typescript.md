...
```typescript
import { dataAwsccOutpostsOutpost } from '@cdktn/provider-awscc'

new dataAwsccOutpostsOutpost.DataAwsccOutpostsOutpost(scope: Construct, id: string, config: DataAwsccOutpostsOutpostConfig)
```
...
dataAwsccOutpostsOutpost.DataAwsccOutpostsOutpost.isConstruct(x: any)
```
...
dataAwsccOutpostsOutpost.DataAwsccOutpostsOutpost.isTerraformElement(x: any)
```
...
dataAwsccOutpostsOutpost.DataAwsccOutpostsOutpost.isTerraformDataSource(x: any)
```
...
dataAwsccOutpostsOutpost.DataAwsccOutpostsOutpost.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccOutpostsOutpost.DataAwsccOutpostsOutpost.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccOutpostsOutpost.DataAwsccOutpostsOutpost.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccOutpostsOutpost.DataAwsccOutpostsOutpost.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccOutpostsOutpost.DataAwsccOutpostsOutpost.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccOutpostsOutpost.DataAwsccOutpostsOutpost.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
```typescript
public readonly tags: DataAwsccOutpostsOutpostTagsList;
```
...
const dataAwsccOutpostsOutpostConfig: dataAwsccOutpostsOutpost.DataAwsccOutpostsOutpostConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccOutpostsOutpost.DataAwsccOutpostsOutpostConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccOutpostsOutpost.DataAwsccOutpostsOutpostConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccOutpostsOutpost.DataAwsccOutpostsOutpostConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccOutpostsOutpost.DataAwsccOutpostsOutpostConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const dataAwsccOutpostsOutpostTags: dataAwsccOutpostsOutpost.DataAwsccOutpostsOutpostTags = { ... }
```
...
new dataAwsccOutpostsOutpost.DataAwsccOutpostsOutpostTagsList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccOutpostsOutpost.DataAwsccOutpostsOutpostTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccOutpostsOutpost.DataAwsccOutpostsOutpostTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```typescript
public get(index: number): DataAwsccOutpostsOutpostTagsOutputReference
```
...
new dataAwsccOutpostsOutpost.DataAwsccOutpostsOutpostTagsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccOutpostsOutpost.DataAwsccOutpostsOutpostTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccOutpostsOutpost.DataAwsccOutpostsOutpostTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccOutpostsOutpost.DataAwsccOutpostsOutpostTagsOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```typescript
public readonly internalValue: DataAwsccOutpostsOutpostTags;
```
