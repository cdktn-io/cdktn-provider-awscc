...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/resourceexplorer2_view
...
export class DataAwsccResourceexplorer2View extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccResourceexplorer2View that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/resourceexplorer2_view#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/resourceexplorer2_view awscc_resourceexplorer2_view} Data Source
  *
  * @param scope The scope in which to define this construct
