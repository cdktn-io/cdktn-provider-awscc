...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_queue
...
export interface PcsQueueConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_queue#cluster_id PcsQueue#cluster_id}
  */
  readonly clusterId: string;
  /**
  * The list of compute node group configurations associated with the queue. Queues assign jobs to associated compute node groups.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_queue#compute_node_group_configurations PcsQueue#compute_node_group_configurations}
  */
  readonly computeNodeGroupConfigurations?: PcsQueueComputeNodeGroupConfigurations[] | cdktn.IResolvable;
  /**
  * The name that identifies the queue.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_queue#name PcsQueue#name}
  */
  readonly name?: string;
  /**
  * The Slurm configuration for the queue.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_queue#slurm_configuration PcsQueue#slurm_configuration}
  */
  readonly slurmConfiguration?: PcsQueueSlurmConfiguration;
  /**
  * 1 or more tags added to the resource. Each tag consists of a tag key and tag value. The tag value is optional and can be an empty string.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_queue#tags PcsQueue#tags}
  */
...
export interface PcsQueueComputeNodeGroupConfigurations {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_queue#compute_node_group_id PcsQueue#compute_node_group_id}
  */
...
export interface PcsQueueSlurmConfigurationSlurmCustomSettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_queue#parameter_name PcsQueue#parameter_name}
  */
  readonly parameterName?: string;
  /**
  * The value for the configured Slurm setting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_queue#parameter_value PcsQueue#parameter_value}
  */
...
export interface PcsQueueSlurmConfiguration {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_queue#slurm_custom_settings PcsQueue#slurm_custom_settings}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_queue awscc_pcs_queue}
*/
export class PcsQueue extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PcsQueue that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_queue#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_queue awscc_pcs_queue} Resource
  *
  * @param scope The scope in which to define this construct
