...
```typescript
import { dataAwsccApigatewayv2RouteResponses } from '@cdktn/provider-awscc'

new dataAwsccApigatewayv2RouteResponses.DataAwsccApigatewayv2RouteResponses(scope: Construct, id: string, config?: DataAwsccApigatewayv2RouteResponsesConfig)
```
...
dataAwsccApigatewayv2RouteResponses.DataAwsccApigatewayv2RouteResponses.isConstruct(x: any)
```
...
dataAwsccApigatewayv2RouteResponses.DataAwsccApigatewayv2RouteResponses.isTerraformElement(x: any)
```
...
dataAwsccApigatewayv2RouteResponses.DataAwsccApigatewayv2RouteResponses.isTerraformDataSource(x: any)
```
...
dataAwsccApigatewayv2RouteResponses.DataAwsccApigatewayv2RouteResponses.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2RouteResponses.DataAwsccApigatewayv2RouteResponses.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2RouteResponses.DataAwsccApigatewayv2RouteResponses.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2RouteResponses.DataAwsccApigatewayv2RouteResponses.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2RouteResponses.DataAwsccApigatewayv2RouteResponses.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2RouteResponses.DataAwsccApigatewayv2RouteResponses.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccApigatewayv2RouteResponsesConfig: dataAwsccApigatewayv2RouteResponses.DataAwsccApigatewayv2RouteResponsesConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2RouteResponses.DataAwsccApigatewayv2RouteResponsesConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2RouteResponses.DataAwsccApigatewayv2RouteResponsesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2RouteResponses.DataAwsccApigatewayv2RouteResponsesConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2RouteResponses.DataAwsccApigatewayv2RouteResponsesConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
