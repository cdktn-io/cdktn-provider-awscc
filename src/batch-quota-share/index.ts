...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/batch_quota_share
...
export class BatchQuotaShare extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BatchQuotaShare that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/batch_quota_share#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/batch_quota_share awscc_batch_quota_share} Resource
  *
  * @param scope The scope in which to define this construct
