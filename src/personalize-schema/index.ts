...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/personalize_schema
...
export class PersonalizeSchema extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PersonalizeSchema that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/personalize_schema#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/personalize_schema awscc_personalize_schema} Resource
  *
  * @param scope The scope in which to define this construct
