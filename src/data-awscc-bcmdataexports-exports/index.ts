...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/bcmdataexports_exports
...
export class DataAwsccBcmdataexportsExports extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccBcmdataexportsExports that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/bcmdataexports_exports#import import section} in the documentation of this resource for the id to use
