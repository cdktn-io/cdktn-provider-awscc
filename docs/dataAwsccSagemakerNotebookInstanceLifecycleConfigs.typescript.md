...
```typescript
import { dataAwsccSagemakerNotebookInstanceLifecycleConfigs } from '@cdktn/provider-awscc'

new dataAwsccSagemakerNotebookInstanceLifecycleConfigs.DataAwsccSagemakerNotebookInstanceLifecycleConfigs(scope: Construct, id: string, config?: DataAwsccSagemakerNotebookInstanceLifecycleConfigsConfig)
```
...
dataAwsccSagemakerNotebookInstanceLifecycleConfigs.DataAwsccSagemakerNotebookInstanceLifecycleConfigs.isConstruct(x: any)
```
...
dataAwsccSagemakerNotebookInstanceLifecycleConfigs.DataAwsccSagemakerNotebookInstanceLifecycleConfigs.isTerraformElement(x: any)
```
...
dataAwsccSagemakerNotebookInstanceLifecycleConfigs.DataAwsccSagemakerNotebookInstanceLifecycleConfigs.isTerraformDataSource(x: any)
```
...
dataAwsccSagemakerNotebookInstanceLifecycleConfigs.DataAwsccSagemakerNotebookInstanceLifecycleConfigs.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerNotebookInstanceLifecycleConfigs.DataAwsccSagemakerNotebookInstanceLifecycleConfigs.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerNotebookInstanceLifecycleConfigs.DataAwsccSagemakerNotebookInstanceLifecycleConfigs.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerNotebookInstanceLifecycleConfigs.DataAwsccSagemakerNotebookInstanceLifecycleConfigs.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerNotebookInstanceLifecycleConfigs.DataAwsccSagemakerNotebookInstanceLifecycleConfigs.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerNotebookInstanceLifecycleConfigs.DataAwsccSagemakerNotebookInstanceLifecycleConfigs.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccSagemakerNotebookInstanceLifecycleConfigsConfig: dataAwsccSagemakerNotebookInstanceLifecycleConfigs.DataAwsccSagemakerNotebookInstanceLifecycleConfigsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerNotebookInstanceLifecycleConfigs.DataAwsccSagemakerNotebookInstanceLifecycleConfigsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerNotebookInstanceLifecycleConfigs.DataAwsccSagemakerNotebookInstanceLifecycleConfigsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerNotebookInstanceLifecycleConfigs.DataAwsccSagemakerNotebookInstanceLifecycleConfigsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerNotebookInstanceLifecycleConfigs.DataAwsccSagemakerNotebookInstanceLifecycleConfigsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
