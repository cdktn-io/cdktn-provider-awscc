...
export interface KendraDataSourceDataSourceConfigurationConfluenceConfigurationBlogConfiguration {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/kendra_data_source#blog_field_mappings KendraDataSource#blog_field_mappings}
  */
...
export class KendraDataSource extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing KendraDataSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/kendra_data_source#import import section} in the documentation of this resource for the id to use
