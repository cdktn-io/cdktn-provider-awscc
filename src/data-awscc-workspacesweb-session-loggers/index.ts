...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/workspacesweb_session_loggers
...
export class DataAwsccWorkspaceswebSessionLoggers extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccWorkspaceswebSessionLoggers that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/workspacesweb_session_loggers#import import section} in the documentation of this resource for the id to use
