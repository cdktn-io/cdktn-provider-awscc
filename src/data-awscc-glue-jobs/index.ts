...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/glue_jobs
...
export class DataAwsccGlueJobs extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccGlueJobs that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/glue_jobs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/glue_jobs awscc_glue_jobs} Data Source
  *
  * @param scope The scope in which to define this construct
