...
```typescript
import { dataAwsccManagedblockchainAccessors } from '@cdktn/provider-awscc'

new dataAwsccManagedblockchainAccessors.DataAwsccManagedblockchainAccessors(scope: Construct, id: string, config?: DataAwsccManagedblockchainAccessorsConfig)
```
...
dataAwsccManagedblockchainAccessors.DataAwsccManagedblockchainAccessors.isConstruct(x: any)
```
...
dataAwsccManagedblockchainAccessors.DataAwsccManagedblockchainAccessors.isTerraformElement(x: any)
```
...
dataAwsccManagedblockchainAccessors.DataAwsccManagedblockchainAccessors.isTerraformDataSource(x: any)
```
...
dataAwsccManagedblockchainAccessors.DataAwsccManagedblockchainAccessors.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccManagedblockchainAccessors.DataAwsccManagedblockchainAccessors.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccManagedblockchainAccessors.DataAwsccManagedblockchainAccessors.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccManagedblockchainAccessors.DataAwsccManagedblockchainAccessors.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccManagedblockchainAccessors.DataAwsccManagedblockchainAccessors.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccManagedblockchainAccessors.DataAwsccManagedblockchainAccessors.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccManagedblockchainAccessorsConfig: dataAwsccManagedblockchainAccessors.DataAwsccManagedblockchainAccessorsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccManagedblockchainAccessors.DataAwsccManagedblockchainAccessorsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccManagedblockchainAccessors.DataAwsccManagedblockchainAccessorsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccManagedblockchainAccessors.DataAwsccManagedblockchainAccessorsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccManagedblockchainAccessors.DataAwsccManagedblockchainAccessorsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
