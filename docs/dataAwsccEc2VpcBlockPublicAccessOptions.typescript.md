...
```typescript
import { dataAwsccEc2VpcBlockPublicAccessOptions } from '@cdktn/provider-awscc'

new dataAwsccEc2VpcBlockPublicAccessOptions.DataAwsccEc2VpcBlockPublicAccessOptions(scope: Construct, id: string, config: DataAwsccEc2VpcBlockPublicAccessOptionsConfig)
```
...
dataAwsccEc2VpcBlockPublicAccessOptions.DataAwsccEc2VpcBlockPublicAccessOptions.isConstruct(x: any)
```
...
dataAwsccEc2VpcBlockPublicAccessOptions.DataAwsccEc2VpcBlockPublicAccessOptions.isTerraformElement(x: any)
```
...
dataAwsccEc2VpcBlockPublicAccessOptions.DataAwsccEc2VpcBlockPublicAccessOptions.isTerraformDataSource(x: any)
```
...
dataAwsccEc2VpcBlockPublicAccessOptions.DataAwsccEc2VpcBlockPublicAccessOptions.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VpcBlockPublicAccessOptions.DataAwsccEc2VpcBlockPublicAccessOptions.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VpcBlockPublicAccessOptions.DataAwsccEc2VpcBlockPublicAccessOptions.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VpcBlockPublicAccessOptions.DataAwsccEc2VpcBlockPublicAccessOptions.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VpcBlockPublicAccessOptions.DataAwsccEc2VpcBlockPublicAccessOptions.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VpcBlockPublicAccessOptions.DataAwsccEc2VpcBlockPublicAccessOptions.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccEc2VpcBlockPublicAccessOptionsConfig: dataAwsccEc2VpcBlockPublicAccessOptions.DataAwsccEc2VpcBlockPublicAccessOptionsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VpcBlockPublicAccessOptions.DataAwsccEc2VpcBlockPublicAccessOptionsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VpcBlockPublicAccessOptions.DataAwsccEc2VpcBlockPublicAccessOptionsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VpcBlockPublicAccessOptions.DataAwsccEc2VpcBlockPublicAccessOptionsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VpcBlockPublicAccessOptions.DataAwsccEc2VpcBlockPublicAccessOptionsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
