...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/invoicing_invoice_units
...
export class DataAwsccInvoicingInvoiceUnits extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccInvoicingInvoiceUnits that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/invoicing_invoice_units#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/invoicing_invoice_units awscc_invoicing_invoice_units} Data Source
  *
  * @param scope The scope in which to define this construct
