...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/rds_db_instance
...
export function rdsDbInstanceAdditionalStorageVolumesToTerraform(struct?: RdsDbInstanceAdditionalStorageVolumes | cdktn.IResolvable): any {
  ...
  return {
    ...
    storage_operation_percent_progress: cdktn.numberToTerraform(struct!.storageOperationPercentProgress),
    storage_operation_status: cdktn.stringToTerraform(struct!.storageOperationStatus),
...
export function rdsDbInstanceAdditionalStorageVolumesToHclTerraform(struct?: RdsDbInstanceAdditionalStorageVolumes | cdktn.IResolvable): any {
  ...
  const attrs = {
    ...
    storage_operation_percent_progress: {
      value: cdktn.numberToHclTerraform(struct!.storageOperationPercentProgress),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    storage_operation_status: {
      value: cdktn.stringToHclTerraform(struct!.storageOperationStatus),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class RdsDbInstanceAdditionalStorageVolumesOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): RdsDbInstanceAdditionalStorageVolumes | cdktn.IResolvable | undefined {
    ...
    if (this._storageOperationPercentProgress !== undefined) {
      hasAnyValues = true;
      internalValueResult.storageOperationPercentProgress = this._storageOperationPercentProgress;
    }
    if (this._storageOperationStatus !== undefined) {
      hasAnyValues = true;
      internalValueResult.storageOperationStatus = this._storageOperationStatus;
    }
  ...
  public set internalValue(value: RdsDbInstanceAdditionalStorageVolumes | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      ...
      this._storageOperationPercentProgress = undefined;
      this._storageOperationStatus = undefined;
      ...
      this._storageOperationPercentProgress = value.storageOperationPercentProgress;
      this._storageOperationStatus = value.storageOperationStatus;
  ...
  // storage_operation_percent_progress - computed: true, optional: true, required: false
  private _storageOperationPercentProgress?: number; 
  public get storageOperationPercentProgress() {
    return this.getNumberAttribute('storage_operation_percent_progress');
  }
  public set storageOperationPercentProgress(value: number) {
    this._storageOperationPercentProgress = value;
  }
  public resetStorageOperationPercentProgress() {
    this._storageOperationPercentProgress = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get storageOperationPercentProgressInput() {
    return this._storageOperationPercentProgress;
  }

  // storage_operation_status - computed: true, optional: true, required: false
  private _storageOperationStatus?: string; 
  public get storageOperationStatus() {
    return this.getStringAttribute('storage_operation_status');
  }
  public set storageOperationStatus(value: string) {
    this._storageOperationStatus = value;
  }
  public resetStorageOperationStatus() {
    this._storageOperationStatus = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get storageOperationStatusInput() {
    return this._storageOperationStatus;
  }
...
export class RdsDbInstance extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RdsDbInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/rds_db_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/rds_db_instance awscc_rds_db_instance} Resource
  *
  * @param scope The scope in which to define this construct
