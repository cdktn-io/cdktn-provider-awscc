...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/deadline_queue_environment
...
export class DeadlineQueueEnvironment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DeadlineQueueEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/deadline_queue_environment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/deadline_queue_environment awscc_deadline_queue_environment} Resource
  *
  * @param scope The scope in which to define this construct
