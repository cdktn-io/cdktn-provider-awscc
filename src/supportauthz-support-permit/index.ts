...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/supportauthz_support_permit
...
export interface SupportauthzSupportPermitConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/supportauthz_support_permit#description SupportauthzSupportPermit#description}
  */
  readonly description?: string;
  /**
  * The name of the support permit.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/supportauthz_support_permit#name SupportauthzSupportPermit#name}
  */
  readonly name: string;
  /**
  * The grant definition: which actions on which resources, optionally constrained by time conditions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/supportauthz_support_permit#permit SupportauthzSupportPermit#permit}
  */
  readonly permit: SupportauthzSupportPermitPermit;
  /**
  * The signing key used by the permit. Exactly one key type must be provided.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/supportauthz_support_permit#signing_key_info SupportauthzSupportPermit#signing_key_info}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/supportauthz_support_permit#support_case_display_id SupportauthzSupportPermit#support_case_display_id}
  */
  readonly supportCaseDisplayId?: string;
  /**
  * A list of key-value pairs to apply to this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/supportauthz_support_permit#tags SupportauthzSupportPermit#tags}
  */
...
export interface SupportauthzSupportPermitPermitActions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/supportauthz_support_permit#actions SupportauthzSupportPermit#actions}
  */
  readonly actions?: string[];
  /**
  * Grants all actions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/supportauthz_support_permit#all_actions SupportauthzSupportPermit#all_actions}
  */
...
export interface SupportauthzSupportPermitPermitConditions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/supportauthz_support_permit#allow_after SupportauthzSupportPermit#allow_after}
  */
  readonly allowAfter?: string;
  /**
  * The permit is active only before this time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/supportauthz_support_permit#allow_before SupportauthzSupportPermit#allow_before}
  */
...
export interface SupportauthzSupportPermitPermitResources {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/supportauthz_support_permit#all_resources_in_region SupportauthzSupportPermit#all_resources_in_region}
  */
  readonly allResourcesInRegion?: string;
  /**
  * An explicit list of resource ARNs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/supportauthz_support_permit#resources SupportauthzSupportPermit#resources}
  */
...
export interface SupportauthzSupportPermitPermit {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/supportauthz_support_permit#conditions SupportauthzSupportPermit#conditions}
  */
...
export interface SupportauthzSupportPermitTags {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/supportauthz_support_permit#key SupportauthzSupportPermit#key}
  */
  readonly key?: string;
  /**
  * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/supportauthz_support_permit#value SupportauthzSupportPermit#value}
  */
...
export class SupportauthzSupportPermit extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SupportauthzSupportPermit that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/supportauthz_support_permit#import import section} in the documentation of this resource for the id to use
