...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/mediapackagev2_channel
...
export class DataAwsccMediapackagev2Channel extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccMediapackagev2Channel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/mediapackagev2_channel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/mediapackagev2_channel awscc_mediapackagev2_channel} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // output_locking_mode - computed: true, optional: false, required: false
