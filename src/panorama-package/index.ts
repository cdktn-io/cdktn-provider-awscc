...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/panorama_package
...
export class PanoramaPackage extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PanoramaPackage that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/panorama_package#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/panorama_package awscc_panorama_package} Resource
  *
  * @param scope The scope in which to define this construct
