...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/wisdom_ai_agent_version
...
export interface DataAwsccWisdomAiAgentVersionConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataAwsccWisdomAiAgentVersion extends cdktn.TerraformDataSource {
  ...
  * @param importToId The construct id used in the generated config for the DataAwsccWisdomAiAgentVersion to import
  * @param importFromId The id of the existing DataAwsccWisdomAiAgentVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/wisdom_ai_agent_version#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAwsccWisdomAiAgentVersion to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/wisdom_ai_agent_version awscc_wisdom_ai_agent_version} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataAwsccWisdomAiAgentVersionConfig
  */
  public constructor(scope: Construct, id: string, config: DataAwsccWisdomAiAgentVersionConfig) {
    super(scope, id, {
