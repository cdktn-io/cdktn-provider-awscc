...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/resiliencehubv2_systems
...
export class DataAwsccResiliencehubv2Systems extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccResiliencehubv2Systems that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/resiliencehubv2_systems#import import section} in the documentation of this resource for the id to use
