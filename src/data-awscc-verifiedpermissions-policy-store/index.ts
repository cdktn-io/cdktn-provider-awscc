...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/verifiedpermissions_policy_store
...
export class DataAwsccVerifiedpermissionsPolicyStore extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccVerifiedpermissionsPolicyStore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/verifiedpermissions_policy_store#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/verifiedpermissions_policy_store awscc_verifiedpermissions_policy_store} Data Source
  *
  * @param scope The scope in which to define this construct
