...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/connect_security_keys
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/connect_security_keys awscc_connect_security_keys}
*/
export class DataAwsccConnectSecurityKeys extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccConnectSecurityKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/connect_security_keys#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/connect_security_keys awscc_connect_security_keys} Data Source
  *
  * @param scope The scope in which to define this construct
