...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/connecttrafficdistributiongroup"

connecttrafficdistributiongroup.NewConnectTrafficDistributionGroup(scope Construct, id *string, config ConnectTrafficDistributionGroupConfig) ConnectTrafficDistributionGroup
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
connecttrafficdistributiongroup.ConnectTrafficDistributionGroup_IsConstruct(x interface{}) *bool
```
...
connecttrafficdistributiongroup.ConnectTrafficDistributionGroup_IsTerraformElement(x interface{}) *bool
```
...
connecttrafficdistributiongroup.ConnectTrafficDistributionGroup_IsTerraformResource(x interface{}) *bool
```
...
connecttrafficdistributiongroup.ConnectTrafficDistributionGroup_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.isDefault">IsDefault</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.tagsInput">TagsInput</a></code> | <code>interface{}</code> | *No description.* |
...
```go
func Tags() ConnectTrafficDistributionGroupTagsList
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupConfig.property.tags">Tags</a></code> | <code>interface{}</code> | One or more tags. |
...
connecttrafficdistributiongroup.NewConnectTrafficDistributionGroupTagsList(terraformResource IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ConnectTrafficDistributionGroupTagsList
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.IInterpolatingParent</code> | The parent resource. |
...
```go
func Get(index *f64) ConnectTrafficDistributionGroupTagsOutputReference
```
...
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupTagsList.property.internalValue">InternalValue</a></code> | <code>interface{}</code> | *No description.* |
...
connecttrafficdistributiongroup.NewConnectTrafficDistributionGroupTagsOutputReference(terraformResource IInterpolatingParent, terraformAttribute *string, complexObjectIndex *f64, complexObjectIsFromSet *bool) ConnectTrafficDistributionGroupTagsOutputReference
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>*f64</code> | the index of this item in the list. |
...
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupTagsOutputReference.property.internalValue">InternalValue</a></code> | <code>interface{}</code> | *No description.* |
