...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/ec2_verified_access_instance
...
export class Ec2VerifiedAccessInstance extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2VerifiedAccessInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/ec2_verified_access_instance#import import section} in the documentation of this resource for the id to use
