...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pinpoint_in_app_template
...
export class PinpointInAppTemplate extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PinpointInAppTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pinpoint_in_app_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pinpoint_in_app_template awscc_pinpoint_in_app_template} Resource
  *
  * @param scope The scope in which to define this construct
