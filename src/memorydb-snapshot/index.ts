...
export interface MemorydbSnapshotTags {
  /**
  * The key of the tag.
  *
...
export function memorydbSnapshotTagsToTerraform(struct?: MemorydbSnapshotTags | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function memorydbSnapshotTagsToHclTerraform(struct?: MemorydbSnapshotTags | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class MemorydbSnapshotTagsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): MemorydbSnapshotTags | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: MemorydbSnapshotTags | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class MemorydbSnapshotTagsList extends cdktn.ComplexList {
  public internalValue? : MemorydbSnapshotTags[] | cdktn.IResolvable
  ...
  */
  public get(index: number): MemorydbSnapshotTagsOutputReference {
    return new MemorydbSnapshotTagsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class MemorydbSnapshot extends cdktn.TerraformResource {
  ...
  */
  ...
  private _clusterConfiguration = new MemorydbSnapshotClusterConfigurationOutputReference(this, "cluster_configuration");
  ...
  private _tags = new MemorydbSnapshotTagsList(this, "tags", true);
  public get tags() {
    return this._tags;
  }
  public putTags(value: MemorydbSnapshotTags[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      tags: cdktn.listMapper(memorydbSnapshotTagsToTerraform, false)(this._tags.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      tags: {
        value: cdktn.listMapperHcl(memorydbSnapshotTagsToHclTerraform, false)(this._tags.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "MemorydbSnapshotTagsList",
      },
    };
