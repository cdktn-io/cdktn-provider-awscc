...
```typescript
import { dataAwsccSagemakerModelPackageGroup } from '@cdktn/provider-awscc'

new dataAwsccSagemakerModelPackageGroup.DataAwsccSagemakerModelPackageGroup(scope: Construct, id: string, config: DataAwsccSagemakerModelPackageGroupConfig)
```
...
dataAwsccSagemakerModelPackageGroup.DataAwsccSagemakerModelPackageGroup.isConstruct(x: any)
```
...
dataAwsccSagemakerModelPackageGroup.DataAwsccSagemakerModelPackageGroup.isTerraformElement(x: any)
```
...
dataAwsccSagemakerModelPackageGroup.DataAwsccSagemakerModelPackageGroup.isTerraformDataSource(x: any)
```
...
dataAwsccSagemakerModelPackageGroup.DataAwsccSagemakerModelPackageGroup.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerModelPackageGroup.DataAwsccSagemakerModelPackageGroup.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerModelPackageGroup.DataAwsccSagemakerModelPackageGroup.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerModelPackageGroup.DataAwsccSagemakerModelPackageGroup.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerModelPackageGroup.DataAwsccSagemakerModelPackageGroup.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerModelPackageGroup.DataAwsccSagemakerModelPackageGroup.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
```typescript
public readonly tags: DataAwsccSagemakerModelPackageGroupTagsList;
```
...
const dataAwsccSagemakerModelPackageGroupConfig: dataAwsccSagemakerModelPackageGroup.DataAwsccSagemakerModelPackageGroupConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerModelPackageGroup.DataAwsccSagemakerModelPackageGroupConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerModelPackageGroup.DataAwsccSagemakerModelPackageGroupConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerModelPackageGroup.DataAwsccSagemakerModelPackageGroupConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerModelPackageGroup.DataAwsccSagemakerModelPackageGroupConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const dataAwsccSagemakerModelPackageGroupTags: dataAwsccSagemakerModelPackageGroup.DataAwsccSagemakerModelPackageGroupTags = { ... }
```
...
new dataAwsccSagemakerModelPackageGroup.DataAwsccSagemakerModelPackageGroupTagsList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerModelPackageGroup.DataAwsccSagemakerModelPackageGroupTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerModelPackageGroup.DataAwsccSagemakerModelPackageGroupTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```typescript
public get(index: number): DataAwsccSagemakerModelPackageGroupTagsOutputReference
```
...
new dataAwsccSagemakerModelPackageGroup.DataAwsccSagemakerModelPackageGroupTagsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerModelPackageGroup.DataAwsccSagemakerModelPackageGroupTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerModelPackageGroup.DataAwsccSagemakerModelPackageGroupTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
...
```typescript
public readonly internalValue: DataAwsccSagemakerModelPackageGroupTags;
```
