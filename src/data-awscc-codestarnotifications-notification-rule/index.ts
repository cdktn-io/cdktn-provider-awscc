...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/codestarnotifications_notification_rule
...
export class DataAwsccCodestarnotificationsNotificationRule extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCodestarnotificationsNotificationRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/codestarnotifications_notification_rule#import import section} in the documentation of this resource for the id to use
