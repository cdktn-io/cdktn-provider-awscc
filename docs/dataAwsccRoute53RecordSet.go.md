...
```go
func GeoProximityLocation() DataAwsccRoute53RecordSetGeoProximityLocationOutputReference
```
...
dataawsccroute53recordset.NewDataAwsccRoute53RecordSetGeoProximityLocationCoordinatesOutputReference(terraformResource IInterpolatingParent, terraformAttribute *string) DataAwsccRoute53RecordSetGeoProximityLocationCoordinatesOutputReference
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53RecordSet.DataAwsccRoute53RecordSetGeoProximityLocationCoordinatesOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.IInterpolatingParent</code> | The parent resource. |
...
```go
func InternalValue() DataAwsccRoute53RecordSetGeoProximityLocationCoordinates
```
...
dataawsccroute53recordset.NewDataAwsccRoute53RecordSetGeoProximityLocationOutputReference(terraformResource IInterpolatingParent, terraformAttribute *string) DataAwsccRoute53RecordSetGeoProximityLocationOutputReference
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53RecordSet.DataAwsccRoute53RecordSetGeoProximityLocationOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53RecordSet.DataAwsccRoute53RecordSetGeoProximityLocationOutputReference.property.bias">Bias</a></code> | <code>*f64</code> | *No description.* |
...
```go
func Coordinates() DataAwsccRoute53RecordSetGeoProximityLocationCoordinatesOutputReference
```
...
```go
func InternalValue() DataAwsccRoute53RecordSetGeoProximityLocation
```
