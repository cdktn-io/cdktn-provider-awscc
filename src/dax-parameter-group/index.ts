...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/dax_parameter_group
...
export class DaxParameterGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DaxParameterGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/dax_parameter_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/dax_parameter_group awscc_dax_parameter_group} Resource
  *
  * @param scope The scope in which to define this construct
