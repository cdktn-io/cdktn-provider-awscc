...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/evidently_experiment
...
export interface DataAwsccEvidentlyExperimentConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/evidently_experiment#id DataAwsccEvidentlyExperiment#id}
  *
...
export class DataAwsccEvidentlyExperiment extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEvidentlyExperiment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/evidently_experiment#import import section} in the documentation of this resource for the id to use
