...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/aps_workspace
...
export class DataAwsccApsWorkspace extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccApsWorkspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/aps_workspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/aps_workspace awscc_aps_workspace} Data Source
  *
  * @param scope The scope in which to define this construct
