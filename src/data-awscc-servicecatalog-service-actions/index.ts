...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/servicecatalog_service_actions
...
export class DataAwsccServicecatalogServiceActions extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccServicecatalogServiceActions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/servicecatalog_service_actions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/servicecatalog_service_actions awscc_servicecatalog_service_actions} Data Source
  *
  * @param scope The scope in which to define this construct
