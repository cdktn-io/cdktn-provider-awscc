...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/interconnect_connections
...
export class DataAwsccInterconnectConnections extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccInterconnectConnections that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/interconnect_connections#import import section} in the documentation of this resource for the id to use
