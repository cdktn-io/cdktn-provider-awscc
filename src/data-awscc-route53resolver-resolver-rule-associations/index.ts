...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/route53resolver_resolver_rule_associations
...
export class DataAwsccRoute53ResolverResolverRuleAssociations extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRoute53ResolverResolverRuleAssociations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/route53resolver_resolver_rule_associations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/route53resolver_resolver_rule_associations awscc_route53resolver_resolver_rule_associations} Data Source
  *
  * @param scope The scope in which to define this construct
