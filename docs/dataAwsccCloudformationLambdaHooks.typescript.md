...
```typescript
import { dataAwsccCloudformationLambdaHooks } from '@cdktn/provider-awscc'

new dataAwsccCloudformationLambdaHooks.DataAwsccCloudformationLambdaHooks(scope: Construct, id: string, config?: DataAwsccCloudformationLambdaHooksConfig)
```
...
dataAwsccCloudformationLambdaHooks.DataAwsccCloudformationLambdaHooks.isConstruct(x: any)
```
...
dataAwsccCloudformationLambdaHooks.DataAwsccCloudformationLambdaHooks.isTerraformElement(x: any)
```
...
dataAwsccCloudformationLambdaHooks.DataAwsccCloudformationLambdaHooks.isTerraformDataSource(x: any)
```
...
dataAwsccCloudformationLambdaHooks.DataAwsccCloudformationLambdaHooks.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationLambdaHooks.DataAwsccCloudformationLambdaHooks.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationLambdaHooks.DataAwsccCloudformationLambdaHooks.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationLambdaHooks.DataAwsccCloudformationLambdaHooks.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationLambdaHooks.DataAwsccCloudformationLambdaHooks.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationLambdaHooks.DataAwsccCloudformationLambdaHooks.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccCloudformationLambdaHooksConfig: dataAwsccCloudformationLambdaHooks.DataAwsccCloudformationLambdaHooksConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationLambdaHooks.DataAwsccCloudformationLambdaHooksConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationLambdaHooks.DataAwsccCloudformationLambdaHooksConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationLambdaHooks.DataAwsccCloudformationLambdaHooksConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationLambdaHooks.DataAwsccCloudformationLambdaHooksConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
