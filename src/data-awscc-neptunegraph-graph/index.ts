...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/neptunegraph_graph
...
export class DataAwsccNeptunegraphGraph extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccNeptunegraphGraph that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/neptunegraph_graph#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/neptunegraph_graph awscc_neptunegraph_graph} Data Source
  *
  * @param scope The scope in which to define this construct
