...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/iam_service_linked_role
...
export class IamServiceLinkedRole extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IamServiceLinkedRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/iam_service_linked_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/iam_service_linked_role awscc_iam_service_linked_role} Resource
  *
  * @param scope The scope in which to define this construct
