...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iotwireless_device_profile
...
export class IotwirelessDeviceProfile extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotwirelessDeviceProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iotwireless_device_profile#import import section} in the documentation of this resource for the id to use
