...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/iotsecuretunneling_tunnel
...
export class IotsecuretunnelingTunnel extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotsecuretunnelingTunnel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/iotsecuretunneling_tunnel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/iotsecuretunneling_tunnel awscc_iotsecuretunneling_tunnel} Resource
  *
  * @param scope The scope in which to define this construct
