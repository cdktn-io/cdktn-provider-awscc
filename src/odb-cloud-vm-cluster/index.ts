...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/odb_cloud_vm_cluster
...
export class OdbCloudVmCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OdbCloudVmCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/odb_cloud_vm_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/odb_cloud_vm_cluster awscc_odb_cloud_vm_cluster} Resource
  *
  * @param scope The scope in which to define this construct
