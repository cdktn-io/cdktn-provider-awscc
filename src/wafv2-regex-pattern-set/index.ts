...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/wafv2_regex_pattern_set
...
export class Wafv2RegexPatternSet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Wafv2RegexPatternSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/wafv2_regex_pattern_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/wafv2_regex_pattern_set awscc_wafv2_regex_pattern_set} Resource
  *
  * @param scope The scope in which to define this construct
