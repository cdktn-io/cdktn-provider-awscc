...
```typescript
import { snsTopicInlinePolicy } from '@cdktn/provider-awscc'

new snsTopicInlinePolicy.SnsTopicInlinePolicy(scope: Construct, id: string, config: SnsTopicInlinePolicyConfig)
```
...
snsTopicInlinePolicy.SnsTopicInlinePolicy.isConstruct(x: any)
```
...
snsTopicInlinePolicy.SnsTopicInlinePolicy.isTerraformElement(x: any)
```
...
snsTopicInlinePolicy.SnsTopicInlinePolicy.isTerraformResource(x: any)
```
...
snsTopicInlinePolicy.SnsTopicInlinePolicy.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.snsTopicInlinePolicy.SnsTopicInlinePolicy.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.snsTopicInlinePolicy.SnsTopicInlinePolicy.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.snsTopicInlinePolicy.SnsTopicInlinePolicy.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.snsTopicInlinePolicy.SnsTopicInlinePolicy.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.snsTopicInlinePolicy.SnsTopicInlinePolicy.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.snsTopicInlinePolicy.SnsTopicInlinePolicy.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const snsTopicInlinePolicyConfig: snsTopicInlinePolicy.SnsTopicInlinePolicyConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.snsTopicInlinePolicy.SnsTopicInlinePolicyConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.snsTopicInlinePolicy.SnsTopicInlinePolicyConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.snsTopicInlinePolicy.SnsTopicInlinePolicyConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.snsTopicInlinePolicy.SnsTopicInlinePolicyConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
