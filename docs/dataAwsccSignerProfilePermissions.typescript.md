...
```typescript
import { dataAwsccSignerProfilePermissions } from '@cdktn/provider-awscc'

new dataAwsccSignerProfilePermissions.DataAwsccSignerProfilePermissions(scope: Construct, id: string, config?: DataAwsccSignerProfilePermissionsConfig)
```
...
dataAwsccSignerProfilePermissions.DataAwsccSignerProfilePermissions.isConstruct(x: any)
```
...
dataAwsccSignerProfilePermissions.DataAwsccSignerProfilePermissions.isTerraformElement(x: any)
```
...
dataAwsccSignerProfilePermissions.DataAwsccSignerProfilePermissions.isTerraformDataSource(x: any)
```
...
dataAwsccSignerProfilePermissions.DataAwsccSignerProfilePermissions.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSignerProfilePermissions.DataAwsccSignerProfilePermissions.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSignerProfilePermissions.DataAwsccSignerProfilePermissions.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSignerProfilePermissions.DataAwsccSignerProfilePermissions.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSignerProfilePermissions.DataAwsccSignerProfilePermissions.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSignerProfilePermissions.DataAwsccSignerProfilePermissions.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccSignerProfilePermissionsConfig: dataAwsccSignerProfilePermissions.DataAwsccSignerProfilePermissionsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSignerProfilePermissions.DataAwsccSignerProfilePermissionsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSignerProfilePermissions.DataAwsccSignerProfilePermissionsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSignerProfilePermissions.DataAwsccSignerProfilePermissionsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSignerProfilePermissions.DataAwsccSignerProfilePermissionsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
