...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/odb_odb_network
...
export class OdbOdbNetwork extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OdbOdbNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/odb_odb_network#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/odb_odb_network awscc_odb_odb_network} Resource
  *
  * @param scope The scope in which to define this construct
