...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/dms_migration_projects
...
export class DataAwsccDmsMigrationProjects extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDmsMigrationProjects that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/dms_migration_projects#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/dms_migration_projects awscc_dms_migration_projects} Data Source
  *
  * @param scope The scope in which to define this construct
