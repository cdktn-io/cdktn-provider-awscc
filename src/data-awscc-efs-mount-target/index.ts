...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/efs_mount_target
...
export class DataAwsccEfsMountTarget extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEfsMountTarget that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/efs_mount_target#import import section} in the documentation of this resource for the id to use
