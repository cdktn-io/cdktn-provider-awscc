...
```typescript
import { dataAwsccIotTopicRules } from '@cdktn/provider-awscc'

new dataAwsccIotTopicRules.DataAwsccIotTopicRules(scope: Construct, id: string, config?: DataAwsccIotTopicRulesConfig)
```
...
dataAwsccIotTopicRules.DataAwsccIotTopicRules.isConstruct(x: any)
```
...
dataAwsccIotTopicRules.DataAwsccIotTopicRules.isTerraformElement(x: any)
```
...
dataAwsccIotTopicRules.DataAwsccIotTopicRules.isTerraformDataSource(x: any)
```
...
dataAwsccIotTopicRules.DataAwsccIotTopicRules.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotTopicRules.DataAwsccIotTopicRules.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotTopicRules.DataAwsccIotTopicRules.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotTopicRules.DataAwsccIotTopicRules.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotTopicRules.DataAwsccIotTopicRules.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotTopicRules.DataAwsccIotTopicRules.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccIotTopicRulesConfig: dataAwsccIotTopicRules.DataAwsccIotTopicRulesConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotTopicRules.DataAwsccIotTopicRulesConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotTopicRules.DataAwsccIotTopicRulesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotTopicRules.DataAwsccIotTopicRulesConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotTopicRules.DataAwsccIotTopicRulesConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
