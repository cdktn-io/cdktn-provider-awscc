...
```typescript
import { dataAwsccSecurityhubAggregatorV2 } from '@cdktn/provider-awscc'

new dataAwsccSecurityhubAggregatorV2.DataAwsccSecurityhubAggregatorV2(scope: Construct, id: string, config: DataAwsccSecurityhubAggregatorV2Config)
```
...
dataAwsccSecurityhubAggregatorV2.DataAwsccSecurityhubAggregatorV2.isConstruct(x: any)
```
...
dataAwsccSecurityhubAggregatorV2.DataAwsccSecurityhubAggregatorV2.isTerraformElement(x: any)
```
...
dataAwsccSecurityhubAggregatorV2.DataAwsccSecurityhubAggregatorV2.isTerraformDataSource(x: any)
```
...
dataAwsccSecurityhubAggregatorV2.DataAwsccSecurityhubAggregatorV2.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAggregatorV2.DataAwsccSecurityhubAggregatorV2.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAggregatorV2.DataAwsccSecurityhubAggregatorV2.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAggregatorV2.DataAwsccSecurityhubAggregatorV2.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAggregatorV2.DataAwsccSecurityhubAggregatorV2.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAggregatorV2.DataAwsccSecurityhubAggregatorV2.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
```typescript
public readonly aggregatorV2Arn: string;
```
...
const dataAwsccSecurityhubAggregatorV2Config: dataAwsccSecurityhubAggregatorV2.DataAwsccSecurityhubAggregatorV2Config = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAggregatorV2.DataAwsccSecurityhubAggregatorV2Config.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAggregatorV2.DataAwsccSecurityhubAggregatorV2Config.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAggregatorV2.DataAwsccSecurityhubAggregatorV2Config.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAggregatorV2.DataAwsccSecurityhubAggregatorV2Config.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
