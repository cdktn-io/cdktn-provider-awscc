...
new DataAwsccBedrockagentcoreHarnessEndpoint(Construct Scope, string Id, DataAwsccBedrockagentcoreHarnessEndpointConfig Config);
```
...
DataAwsccBedrockagentcoreHarnessEndpoint.IsConstruct(object X);
```
...
DataAwsccBedrockagentcoreHarnessEndpoint.IsTerraformElement(object X);
```
...
DataAwsccBedrockagentcoreHarnessEndpoint.IsTerraformDataSource(object X);
```
...
DataAwsccBedrockagentcoreHarnessEndpoint.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBedrockagentcoreHarnessEndpoint.DataAwsccBedrockagentcoreHarnessEndpoint.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBedrockagentcoreHarnessEndpoint.DataAwsccBedrockagentcoreHarnessEndpoint.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBedrockagentcoreHarnessEndpoint.DataAwsccBedrockagentcoreHarnessEndpoint.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBedrockagentcoreHarnessEndpoint.DataAwsccBedrockagentcoreHarnessEndpoint.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBedrockagentcoreHarnessEndpoint.DataAwsccBedrockagentcoreHarnessEndpoint.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBedrockagentcoreHarnessEndpoint.DataAwsccBedrockagentcoreHarnessEndpoint.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBedrockagentcoreHarnessEndpoint.DataAwsccBedrockagentcoreHarnessEndpoint.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
...
```csharp
public DataAwsccBedrockagentcoreHarnessEndpointTagsList Tags { get; }
```
...
new DataAwsccBedrockagentcoreHarnessEndpointConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBedrockagentcoreHarnessEndpoint.DataAwsccBedrockagentcoreHarnessEndpointConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBedrockagentcoreHarnessEndpoint.DataAwsccBedrockagentcoreHarnessEndpointConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBedrockagentcoreHarnessEndpoint.DataAwsccBedrockagentcoreHarnessEndpointConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBedrockagentcoreHarnessEndpoint.DataAwsccBedrockagentcoreHarnessEndpointConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBedrockagentcoreHarnessEndpoint.DataAwsccBedrockagentcoreHarnessEndpointConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBedrockagentcoreHarnessEndpoint.DataAwsccBedrockagentcoreHarnessEndpointConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBedrockagentcoreHarnessEndpoint.DataAwsccBedrockagentcoreHarnessEndpointConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
new DataAwsccBedrockagentcoreHarnessEndpointTags {
...
new DataAwsccBedrockagentcoreHarnessEndpointTagsList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBedrockagentcoreHarnessEndpoint.DataAwsccBedrockagentcoreHarnessEndpointTagsList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.dataAwsccBedrockagentcoreHarnessEndpoint.DataAwsccBedrockagentcoreHarnessEndpointTagsList.resolve.parameter._context"></a>
...
```csharp
private DataAwsccBedrockagentcoreHarnessEndpointTagsOutputReference Get(double Index)
```
...
new DataAwsccBedrockagentcoreHarnessEndpointTagsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBedrockagentcoreHarnessEndpoint.DataAwsccBedrockagentcoreHarnessEndpointTagsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBedrockagentcoreHarnessEndpoint.DataAwsccBedrockagentcoreHarnessEndpointTagsOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.dataAwsccBedrockagentcoreHarnessEndpoint.DataAwsccBedrockagentcoreHarnessEndpointTagsOutputReference.resolve.parameter._context"></a>
...
```csharp
public DataAwsccBedrockagentcoreHarnessEndpointTags InternalValue { get; }
```
