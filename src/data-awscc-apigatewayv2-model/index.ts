...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/apigatewayv2_model
...
export class DataAwsccApigatewayv2Model extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccApigatewayv2Model that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/apigatewayv2_model#import import section} in the documentation of this resource for the id to use
