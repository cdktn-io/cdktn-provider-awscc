...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/lightsail_contact_method
...
export class DataAwsccLightsailContactMethod extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccLightsailContactMethod that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/lightsail_contact_method#import import section} in the documentation of this resource for the id to use
