...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/drs_source_network
...
export class DrsSourceNetwork extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DrsSourceNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/drs_source_network#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/drs_source_network awscc_drs_source_network} Resource
  *
  * @param scope The scope in which to define this construct
