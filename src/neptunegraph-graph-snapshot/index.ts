...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/neptunegraph_graph_snapshot
...
export class NeptunegraphGraphSnapshot extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NeptunegraphGraphSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/neptunegraph_graph_snapshot#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/neptunegraph_graph_snapshot awscc_neptunegraph_graph_snapshot} Resource
  *
  * @param scope The scope in which to define this construct
