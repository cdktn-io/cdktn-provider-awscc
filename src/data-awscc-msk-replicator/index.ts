...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/msk_replicator
...
export class DataAwsccMskReplicator extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccMskReplicator that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/msk_replicator#import import section} in the documentation of this resource for the id to use
