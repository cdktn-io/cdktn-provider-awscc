...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/certificatemanager_acme_domain_validation
...
export class DataAwsccCertificatemanagerAcmeDomainValidation extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCertificatemanagerAcmeDomainValidation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/certificatemanager_acme_domain_validation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/certificatemanager_acme_domain_validation awscc_certificatemanager_acme_domain_validation} Data Source
  *
  * @param scope The scope in which to define this construct
