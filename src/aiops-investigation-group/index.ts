...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/aiops_investigation_group
...
export class AiopsInvestigationGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AiopsInvestigationGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/aiops_investigation_group#import import section} in the documentation of this resource for the id to use
