...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/elasticloadbalancingv2_trust_stores
...
export class DataAwsccElasticloadbalancingv2TrustStores extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccElasticloadbalancingv2TrustStores that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/elasticloadbalancingv2_trust_stores#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/elasticloadbalancingv2_trust_stores awscc_elasticloadbalancingv2_trust_stores} Data Source
  *
  * @param scope The scope in which to define this construct
