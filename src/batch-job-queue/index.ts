...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/batch_job_queue
...
export class BatchJobQueue extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BatchJobQueue that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/batch_job_queue#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/batch_job_queue awscc_batch_job_queue} Resource
  *
  * @param scope The scope in which to define this construct
