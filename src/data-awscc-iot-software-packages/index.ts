...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/iot_software_packages
...
export class DataAwsccIotSoftwarePackages extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIotSoftwarePackages that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/iot_software_packages#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/iot_software_packages awscc_iot_software_packages} Data Source
  *
  * @param scope The scope in which to define this construct
