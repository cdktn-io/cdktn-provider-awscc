...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/mediapackagev2_channel_group
...
export class Mediapackagev2ChannelGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Mediapackagev2ChannelGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/mediapackagev2_channel_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/mediapackagev2_channel_group awscc_mediapackagev2_channel_group} Resource
  *
  * @param scope The scope in which to define this construct
