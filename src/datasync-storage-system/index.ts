...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/datasync_storage_system
...
export class DatasyncStorageSystem extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DatasyncStorageSystem that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/datasync_storage_system#import import section} in the documentation of this resource for the id to use
