...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/docdb_event_subscription
...
export class DocdbEventSubscription extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DocdbEventSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/docdb_event_subscription#import import section} in the documentation of this resource for the id to use
