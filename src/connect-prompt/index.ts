...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/connect_prompt
...
export class ConnectPrompt extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectPrompt that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/connect_prompt#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/connect_prompt awscc_connect_prompt} Resource
  *
  * @param scope The scope in which to define this construct
