...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/datazone_environment
...
export class DataAwsccDatazoneEnvironment extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDatazoneEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/datazone_environment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/datazone_environment awscc_datazone_environment} Data Source
  *
  * @param scope The scope in which to define this construct
