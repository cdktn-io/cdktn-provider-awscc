...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/evidently_experiment
...
export class DataAwsccEvidentlyExperiment extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEvidentlyExperiment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/evidently_experiment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/evidently_experiment awscc_evidently_experiment} Data Source
  *
  * @param scope The scope in which to define this construct
