...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/gamelift_game_session_queue
...
export class GameliftGameSessionQueue extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GameliftGameSessionQueue that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/gamelift_game_session_queue#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/gamelift_game_session_queue awscc_gamelift_game_session_queue} Resource
  *
  * @param scope The scope in which to define this construct
