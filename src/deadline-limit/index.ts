...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/deadline_limit
...
export class DeadlineLimit extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DeadlineLimit that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/deadline_limit#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/deadline_limit awscc_deadline_limit} Resource
  *
  * @param scope The scope in which to define this construct
