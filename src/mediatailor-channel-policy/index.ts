...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediatailor_channel_policy
...
export class MediatailorChannelPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MediatailorChannelPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediatailor_channel_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediatailor_channel_policy awscc_mediatailor_channel_policy} Resource
  *
  * @param scope The scope in which to define this construct
