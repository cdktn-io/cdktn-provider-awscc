...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/odb_odb_peering_connection
...
export interface OdbOdbPeeringConnectionConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/odb_odb_peering_connection#additional_peer_network_cidrs OdbOdbPeeringConnection#additional_peer_network_cidrs}
  */
  readonly additionalPeerNetworkCidrs?: string[];
  /**
  * The name of the ODB peering connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/odb_odb_peering_connection#display_name OdbOdbPeeringConnection#display_name}
  */
  readonly displayName?: string;
  /**
  * The unique identifier of the ODB network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/odb_odb_peering_connection#odb_network_id OdbOdbPeeringConnection#odb_network_id}
  */
  readonly odbNetworkId?: string;
  /**
  * The unique identifier of the peer network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/odb_odb_peering_connection#peer_network_id OdbOdbPeeringConnection#peer_network_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/odb_odb_peering_connection#peer_network_route_table_ids OdbOdbPeeringConnection#peer_network_route_table_ids}
  */
  readonly peerNetworkRouteTableIds?: string[];
  /**
  * Tags to assign to the Odb peering connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/odb_odb_peering_connection#tags OdbOdbPeeringConnection#tags}
  */
...
export interface OdbOdbPeeringConnectionTags {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/odb_odb_peering_connection#key OdbOdbPeeringConnection#key}
  */
  readonly key?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/odb_odb_peering_connection#value OdbOdbPeeringConnection#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/odb_odb_peering_connection awscc_odb_odb_peering_connection}
*/
export class OdbOdbPeeringConnection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OdbOdbPeeringConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/odb_odb_peering_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/odb_odb_peering_connection awscc_odb_odb_peering_connection} Resource
  *
  * @param scope The scope in which to define this construct
