...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iotfleetwise_fleet
...
export class IotfleetwiseFleet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotfleetwiseFleet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iotfleetwise_fleet#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iotfleetwise_fleet awscc_iotfleetwise_fleet} Resource
  *
  * @param scope The scope in which to define this construct
