...
export interface DataAwsccFmsApplicationsListsConfig extends cdktn.TerraformMetaArguments {
}
...
export class DataAwsccFmsApplicationsLists extends cdktn.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "awscc_fms_applications_lists";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "awscc_fms_applications_lists", importId: importFromId, provider });
      }
  ...
  * @param options DataAwsccFmsApplicationsListsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataAwsccFmsApplicationsListsConfig = {}) {
    super(scope, id, {
