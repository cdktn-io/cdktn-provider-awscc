...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/batch_job_definitions
...
export class DataAwsccBatchJobDefinitions extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccBatchJobDefinitions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/batch_job_definitions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/batch_job_definitions awscc_batch_job_definitions} Data Source
  *
  * @param scope The scope in which to define this construct
