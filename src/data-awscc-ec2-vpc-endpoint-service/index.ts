...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/ec2_vpc_endpoint_service
...
export interface DataAwsccEc2VpcEndpointServiceConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function dataAwsccEc2VpcEndpointServiceTagsToTerraform(struct?: DataAwsccEc2VpcEndpointServiceTags): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsccEc2VpcEndpointServiceTagsToHclTerraform(struct?: DataAwsccEc2VpcEndpointServiceTags): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsccEc2VpcEndpointServiceTagsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAwsccEc2VpcEndpointServiceTags | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsccEc2VpcEndpointServiceTags | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataAwsccEc2VpcEndpointServiceTagsList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataAwsccEc2VpcEndpointServiceTagsOutputReference {
    return new DataAwsccEc2VpcEndpointServiceTagsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAwsccEc2VpcEndpointService extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEc2VpcEndpointService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/ec2_vpc_endpoint_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/ec2_vpc_endpoint_service awscc_ec2_vpc_endpoint_service} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataAwsccEc2VpcEndpointServiceConfig
  */
  public constructor(scope: Construct, id: string, config: DataAwsccEc2VpcEndpointServiceConfig) {
    super(scope, id, {
  ...
  // contributor_insights_enabled - computed: true, optional: false, required: false
  public get contributorInsightsEnabled() {
    return this.getBooleanAttribute('contributor_insights_enabled');
  }

  // gateway_load_balancer_arns - computed: true, optional: false, required: false
  ...
  // network_load_balancer_arns - computed: true, optional: false, required: false
  ...
  private _tags = new DataAwsccEc2VpcEndpointServiceTagsList(this, "tags", false);
  public get tags() {
    return this._tags;
  }
