...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/directoryservice_simple_ad
...
export class DataAwsccDirectoryserviceSimpleAd extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDirectoryserviceSimpleAd that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/directoryservice_simple_ad#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/directoryservice_simple_ad awscc_directoryservice_simple_ad} Data Source
  *
  * @param scope The scope in which to define this construct
