...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/codedeploy_deployment_configs
...
export class DataAwsccCodedeployDeploymentConfigs extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCodedeployDeploymentConfigs that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/codedeploy_deployment_configs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/codedeploy_deployment_configs awscc_codedeploy_deployment_configs} Data Source
  *
  * @param scope The scope in which to define this construct
