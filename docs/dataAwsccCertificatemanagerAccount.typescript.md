...
```typescript
import { dataAwsccCertificatemanagerAccount } from '@cdktn/provider-awscc'

new dataAwsccCertificatemanagerAccount.DataAwsccCertificatemanagerAccount(scope: Construct, id: string, config: DataAwsccCertificatemanagerAccountConfig)
```
...
dataAwsccCertificatemanagerAccount.DataAwsccCertificatemanagerAccount.isConstruct(x: any)
```
...
dataAwsccCertificatemanagerAccount.DataAwsccCertificatemanagerAccount.isTerraformElement(x: any)
```
...
dataAwsccCertificatemanagerAccount.DataAwsccCertificatemanagerAccount.isTerraformDataSource(x: any)
```
...
dataAwsccCertificatemanagerAccount.DataAwsccCertificatemanagerAccount.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCertificatemanagerAccount.DataAwsccCertificatemanagerAccount.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCertificatemanagerAccount.DataAwsccCertificatemanagerAccount.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCertificatemanagerAccount.DataAwsccCertificatemanagerAccount.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCertificatemanagerAccount.DataAwsccCertificatemanagerAccount.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCertificatemanagerAccount.DataAwsccCertificatemanagerAccount.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
```typescript
public readonly expiryEventsConfiguration: DataAwsccCertificatemanagerAccountExpiryEventsConfigurationOutputReference;
```
...
const dataAwsccCertificatemanagerAccountConfig: dataAwsccCertificatemanagerAccount.DataAwsccCertificatemanagerAccountConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCertificatemanagerAccount.DataAwsccCertificatemanagerAccountConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCertificatemanagerAccount.DataAwsccCertificatemanagerAccountConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCertificatemanagerAccount.DataAwsccCertificatemanagerAccountConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCertificatemanagerAccount.DataAwsccCertificatemanagerAccountConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const dataAwsccCertificatemanagerAccountExpiryEventsConfiguration: dataAwsccCertificatemanagerAccount.DataAwsccCertificatemanagerAccountExpiryEventsConfiguration = { ... }
```
...
new dataAwsccCertificatemanagerAccount.DataAwsccCertificatemanagerAccountExpiryEventsConfigurationOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCertificatemanagerAccount.DataAwsccCertificatemanagerAccountExpiryEventsConfigurationOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCertificatemanagerAccount.DataAwsccCertificatemanagerAccountExpiryEventsConfigurationOutputReference.property.daysBeforeExpiry">daysBeforeExpiry</a></code> | <code>number</code> | *No description.* |
...
```typescript
public readonly internalValue: DataAwsccCertificatemanagerAccountExpiryEventsConfiguration;
```
