...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/iotfleethub_application
...
export class IotfleethubApplication extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotfleethubApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/iotfleethub_application#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/iotfleethub_application awscc_iotfleethub_application} Resource
  *
  * @param scope The scope in which to define this construct
