...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/rtbfabric_requester_gateways
...
export class DataAwsccRtbfabricRequesterGateways extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRtbfabricRequesterGateways that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/rtbfabric_requester_gateways#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/rtbfabric_requester_gateways awscc_rtbfabric_requester_gateways} Data Source
  *
  * @param scope The scope in which to define this construct
