...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/ec2_transit_gateway_multicast_group_members
...
export class DataAwsccEc2TransitGatewayMulticastGroupMembers extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEc2TransitGatewayMulticastGroupMembers that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/ec2_transit_gateway_multicast_group_members#import import section} in the documentation of this resource for the id to use
