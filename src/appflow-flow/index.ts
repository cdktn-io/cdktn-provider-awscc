...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/appflow_flow
...
export class AppflowFlow extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AppflowFlow that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/appflow_flow#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/appflow_flow awscc_appflow_flow} Resource
  *
  * @param scope The scope in which to define this construct
