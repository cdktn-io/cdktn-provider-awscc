...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/apigateway_authorizer
...
export class DataAwsccApigatewayAuthorizer extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccApigatewayAuthorizer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/apigateway_authorizer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/apigateway_authorizer awscc_apigateway_authorizer} Data Source
  *
  * @param scope The scope in which to define this construct
