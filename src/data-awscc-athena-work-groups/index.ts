...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/athena_work_groups
...
export class DataAwsccAthenaWorkGroups extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccAthenaWorkGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/athena_work_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/athena_work_groups awscc_athena_work_groups} Data Source
  *
  * @param scope The scope in which to define this construct
