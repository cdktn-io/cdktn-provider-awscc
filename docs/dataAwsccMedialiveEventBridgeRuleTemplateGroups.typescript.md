...
```typescript
import { dataAwsccMedialiveEventBridgeRuleTemplateGroups } from '@cdktn/provider-awscc'

new dataAwsccMedialiveEventBridgeRuleTemplateGroups.DataAwsccMedialiveEventBridgeRuleTemplateGroups(scope: Construct, id: string, config?: DataAwsccMedialiveEventBridgeRuleTemplateGroupsConfig)
```
...
dataAwsccMedialiveEventBridgeRuleTemplateGroups.DataAwsccMedialiveEventBridgeRuleTemplateGroups.isConstruct(x: any)
```
...
dataAwsccMedialiveEventBridgeRuleTemplateGroups.DataAwsccMedialiveEventBridgeRuleTemplateGroups.isTerraformElement(x: any)
```
...
dataAwsccMedialiveEventBridgeRuleTemplateGroups.DataAwsccMedialiveEventBridgeRuleTemplateGroups.isTerraformDataSource(x: any)
```
...
dataAwsccMedialiveEventBridgeRuleTemplateGroups.DataAwsccMedialiveEventBridgeRuleTemplateGroups.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveEventBridgeRuleTemplateGroups.DataAwsccMedialiveEventBridgeRuleTemplateGroups.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveEventBridgeRuleTemplateGroups.DataAwsccMedialiveEventBridgeRuleTemplateGroups.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveEventBridgeRuleTemplateGroups.DataAwsccMedialiveEventBridgeRuleTemplateGroups.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveEventBridgeRuleTemplateGroups.DataAwsccMedialiveEventBridgeRuleTemplateGroups.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveEventBridgeRuleTemplateGroups.DataAwsccMedialiveEventBridgeRuleTemplateGroups.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccMedialiveEventBridgeRuleTemplateGroupsConfig: dataAwsccMedialiveEventBridgeRuleTemplateGroups.DataAwsccMedialiveEventBridgeRuleTemplateGroupsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveEventBridgeRuleTemplateGroups.DataAwsccMedialiveEventBridgeRuleTemplateGroupsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveEventBridgeRuleTemplateGroups.DataAwsccMedialiveEventBridgeRuleTemplateGroupsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveEventBridgeRuleTemplateGroups.DataAwsccMedialiveEventBridgeRuleTemplateGroupsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMedialiveEventBridgeRuleTemplateGroups.DataAwsccMedialiveEventBridgeRuleTemplateGroupsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
