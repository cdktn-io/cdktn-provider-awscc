...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/cloudtrail_event_data_store
...
export class CloudtrailEventDataStore extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudtrailEventDataStore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/cloudtrail_event_data_store#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/cloudtrail_event_data_store awscc_cloudtrail_event_data_store} Resource
  *
  * @param scope The scope in which to define this construct
