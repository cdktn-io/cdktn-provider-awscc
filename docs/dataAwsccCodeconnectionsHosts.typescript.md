...
```typescript
import { dataAwsccCodeconnectionsHosts } from '@cdktn/provider-awscc'

new dataAwsccCodeconnectionsHosts.DataAwsccCodeconnectionsHosts(scope: Construct, id: string, config?: DataAwsccCodeconnectionsHostsConfig)
```
...
dataAwsccCodeconnectionsHosts.DataAwsccCodeconnectionsHosts.isConstruct(x: any)
```
...
dataAwsccCodeconnectionsHosts.DataAwsccCodeconnectionsHosts.isTerraformElement(x: any)
```
...
dataAwsccCodeconnectionsHosts.DataAwsccCodeconnectionsHosts.isTerraformDataSource(x: any)
```
...
dataAwsccCodeconnectionsHosts.DataAwsccCodeconnectionsHosts.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsHosts.DataAwsccCodeconnectionsHosts.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsHosts.DataAwsccCodeconnectionsHosts.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsHosts.DataAwsccCodeconnectionsHosts.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsHosts.DataAwsccCodeconnectionsHosts.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsHosts.DataAwsccCodeconnectionsHosts.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccCodeconnectionsHostsConfig: dataAwsccCodeconnectionsHosts.DataAwsccCodeconnectionsHostsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsHosts.DataAwsccCodeconnectionsHostsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsHosts.DataAwsccCodeconnectionsHostsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsHosts.DataAwsccCodeconnectionsHostsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsHosts.DataAwsccCodeconnectionsHostsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
