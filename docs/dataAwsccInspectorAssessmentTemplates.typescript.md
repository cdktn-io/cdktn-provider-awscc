...
```typescript
import { dataAwsccInspectorAssessmentTemplates } from '@cdktn/provider-awscc'

new dataAwsccInspectorAssessmentTemplates.DataAwsccInspectorAssessmentTemplates(scope: Construct, id: string, config?: DataAwsccInspectorAssessmentTemplatesConfig)
```
...
dataAwsccInspectorAssessmentTemplates.DataAwsccInspectorAssessmentTemplates.isConstruct(x: any)
```
...
dataAwsccInspectorAssessmentTemplates.DataAwsccInspectorAssessmentTemplates.isTerraformElement(x: any)
```
...
dataAwsccInspectorAssessmentTemplates.DataAwsccInspectorAssessmentTemplates.isTerraformDataSource(x: any)
```
...
dataAwsccInspectorAssessmentTemplates.DataAwsccInspectorAssessmentTemplates.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorAssessmentTemplates.DataAwsccInspectorAssessmentTemplates.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorAssessmentTemplates.DataAwsccInspectorAssessmentTemplates.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorAssessmentTemplates.DataAwsccInspectorAssessmentTemplates.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorAssessmentTemplates.DataAwsccInspectorAssessmentTemplates.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorAssessmentTemplates.DataAwsccInspectorAssessmentTemplates.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccInspectorAssessmentTemplatesConfig: dataAwsccInspectorAssessmentTemplates.DataAwsccInspectorAssessmentTemplatesConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorAssessmentTemplates.DataAwsccInspectorAssessmentTemplatesConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorAssessmentTemplates.DataAwsccInspectorAssessmentTemplatesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorAssessmentTemplates.DataAwsccInspectorAssessmentTemplatesConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorAssessmentTemplates.DataAwsccInspectorAssessmentTemplatesConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
