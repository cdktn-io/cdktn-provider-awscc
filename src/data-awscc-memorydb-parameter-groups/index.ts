...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/memorydb_parameter_groups
...
export class DataAwsccMemorydbParameterGroups extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccMemorydbParameterGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/memorydb_parameter_groups#import import section} in the documentation of this resource for the id to use
