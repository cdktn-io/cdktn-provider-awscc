...
Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/detective_organization_admins awscc_detective_organization_admins}.
...
new DataAwsccDetectiveOrganizationAdmins(Construct Scope, string Id, DataAwsccDetectiveOrganizationAdminsConfig Config = null);
```
...
DataAwsccDetectiveOrganizationAdmins.IsConstruct(object X);
```
...
DataAwsccDetectiveOrganizationAdmins.IsTerraformElement(object X);
```
...
DataAwsccDetectiveOrganizationAdmins.IsTerraformDataSource(object X);
```
...
DataAwsccDetectiveOrganizationAdmins.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/detective_organization_admins#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDetectiveOrganizationAdmins.DataAwsccDetectiveOrganizationAdmins.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDetectiveOrganizationAdmins.DataAwsccDetectiveOrganizationAdmins.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDetectiveOrganizationAdmins.DataAwsccDetectiveOrganizationAdmins.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDetectiveOrganizationAdmins.DataAwsccDetectiveOrganizationAdmins.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDetectiveOrganizationAdmins.DataAwsccDetectiveOrganizationAdmins.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDetectiveOrganizationAdmins.DataAwsccDetectiveOrganizationAdmins.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDetectiveOrganizationAdmins.DataAwsccDetectiveOrganizationAdmins.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
...
new DataAwsccDetectiveOrganizationAdminsConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDetectiveOrganizationAdmins.DataAwsccDetectiveOrganizationAdminsConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDetectiveOrganizationAdmins.DataAwsccDetectiveOrganizationAdminsConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDetectiveOrganizationAdmins.DataAwsccDetectiveOrganizationAdminsConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDetectiveOrganizationAdmins.DataAwsccDetectiveOrganizationAdminsConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDetectiveOrganizationAdmins.DataAwsccDetectiveOrganizationAdminsConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDetectiveOrganizationAdmins.DataAwsccDetectiveOrganizationAdminsConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDetectiveOrganizationAdmins.DataAwsccDetectiveOrganizationAdminsConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
