...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/healthlake_fhir_datastore
...
export class HealthlakeFhirDatastore extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing HealthlakeFhirDatastore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/healthlake_fhir_datastore#import import section} in the documentation of this resource for the id to use
