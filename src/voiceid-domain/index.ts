...
export class VoiceidDomain extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VoiceidDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/voiceid_domain#import import section} in the documentation of this resource for the id to use
