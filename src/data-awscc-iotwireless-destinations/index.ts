...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/iotwireless_destinations
...
export class DataAwsccIotwirelessDestinations extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIotwirelessDestinations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/iotwireless_destinations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/iotwireless_destinations awscc_iotwireless_destinations} Data Source
  *
  * @param scope The scope in which to define this construct
