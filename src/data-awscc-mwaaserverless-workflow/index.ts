...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/mwaaserverless_workflow
...
export interface DataAwsccMwaaserverlessWorkflowConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/mwaaserverless_workflow#id DataAwsccMwaaserverlessWorkflow#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/mwaaserverless_workflow awscc_mwaaserverless_workflow}
*/
export class DataAwsccMwaaserverlessWorkflow extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccMwaaserverlessWorkflow that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/mwaaserverless_workflow#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/mwaaserverless_workflow awscc_mwaaserverless_workflow} Data Source
  *
  * @param scope The scope in which to define this construct
