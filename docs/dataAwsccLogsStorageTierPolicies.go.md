...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawscclogsstoragetierpolicies"

dataawscclogsstoragetierpolicies.NewDataAwsccLogsStorageTierPolicies(scope Construct, id *string, config DataAwsccLogsStorageTierPoliciesConfig) DataAwsccLogsStorageTierPolicies
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLogsStorageTierPolicies.DataAwsccLogsStorageTierPolicies.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
dataawscclogsstoragetierpolicies.DataAwsccLogsStorageTierPolicies_IsConstruct(x interface{}) *bool
```
...
dataawscclogsstoragetierpolicies.DataAwsccLogsStorageTierPolicies_IsTerraformElement(x interface{}) *bool
```
...
dataawscclogsstoragetierpolicies.DataAwsccLogsStorageTierPolicies_IsTerraformDataSource(x interface{}) *bool
```
...
dataawscclogsstoragetierpolicies.DataAwsccLogsStorageTierPolicies_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLogsStorageTierPolicies.DataAwsccLogsStorageTierPolicies.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLogsStorageTierPolicies.DataAwsccLogsStorageTierPolicies.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccLogsStorageTierPolicies.DataAwsccLogsStorageTierPolicies.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccLogsStorageTierPolicies.DataAwsccLogsStorageTierPolicies.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLogsStorageTierPolicies.DataAwsccLogsStorageTierPolicies.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccLogsStorageTierPolicies.DataAwsccLogsStorageTierPolicies.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLogsStorageTierPolicies.DataAwsccLogsStorageTierPolicies.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLogsStorageTierPolicies.DataAwsccLogsStorageTierPolicies.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLogsStorageTierPolicies.DataAwsccLogsStorageTierPoliciesConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLogsStorageTierPolicies.DataAwsccLogsStorageTierPoliciesConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLogsStorageTierPolicies.DataAwsccLogsStorageTierPoliciesConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLogsStorageTierPolicies.DataAwsccLogsStorageTierPoliciesConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLogsStorageTierPolicies.DataAwsccLogsStorageTierPoliciesConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLogsStorageTierPolicies.DataAwsccLogsStorageTierPoliciesConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLogsStorageTierPolicies.DataAwsccLogsStorageTierPoliciesConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
