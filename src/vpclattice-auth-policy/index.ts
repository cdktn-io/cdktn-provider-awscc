...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/vpclattice_auth_policy
...
export class VpclatticeAuthPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VpclatticeAuthPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/vpclattice_auth_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/vpclattice_auth_policy awscc_vpclattice_auth_policy} Resource
  *
  * @param scope The scope in which to define this construct
