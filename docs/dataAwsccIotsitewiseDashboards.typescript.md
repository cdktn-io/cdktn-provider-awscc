...
```typescript
import { dataAwsccIotsitewiseDashboards } from '@cdktn/provider-awscc'

new dataAwsccIotsitewiseDashboards.DataAwsccIotsitewiseDashboards(scope: Construct, id: string, config?: DataAwsccIotsitewiseDashboardsConfig)
```
...
dataAwsccIotsitewiseDashboards.DataAwsccIotsitewiseDashboards.isConstruct(x: any)
```
...
dataAwsccIotsitewiseDashboards.DataAwsccIotsitewiseDashboards.isTerraformElement(x: any)
```
...
dataAwsccIotsitewiseDashboards.DataAwsccIotsitewiseDashboards.isTerraformDataSource(x: any)
```
...
dataAwsccIotsitewiseDashboards.DataAwsccIotsitewiseDashboards.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotsitewiseDashboards.DataAwsccIotsitewiseDashboards.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotsitewiseDashboards.DataAwsccIotsitewiseDashboards.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotsitewiseDashboards.DataAwsccIotsitewiseDashboards.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotsitewiseDashboards.DataAwsccIotsitewiseDashboards.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotsitewiseDashboards.DataAwsccIotsitewiseDashboards.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccIotsitewiseDashboardsConfig: dataAwsccIotsitewiseDashboards.DataAwsccIotsitewiseDashboardsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotsitewiseDashboards.DataAwsccIotsitewiseDashboardsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotsitewiseDashboards.DataAwsccIotsitewiseDashboardsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotsitewiseDashboards.DataAwsccIotsitewiseDashboardsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotsitewiseDashboards.DataAwsccIotsitewiseDashboardsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
