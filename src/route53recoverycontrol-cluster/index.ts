...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/route53recoverycontrol_cluster
...
export class Route53RecoverycontrolCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53RecoverycontrolCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/route53recoverycontrol_cluster#import import section} in the documentation of this resource for the id to use
