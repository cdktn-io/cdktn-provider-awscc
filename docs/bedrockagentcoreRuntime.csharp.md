...
```csharp
private void PutCapacityProviderConfiguration(BedrockagentcoreRuntimeCapacityProviderConfiguration Value)
```
...
```csharp
private void ResetCapacityProviderConfiguration()
```
...
```csharp
public BedrockagentcoreRuntimeCapacityProviderConfigurationOutputReference CapacityProviderConfiguration { get; }
```
...
```csharp
public IResolvable|BedrockagentcoreRuntimeCapacityProviderConfiguration CapacityProviderConfigurationInput { get; }
```

- *Type:* Io.Cdktn.IResolvable|<a href="#@cdktn/provider-awscc.bedrockagentcoreRuntime.BedrockagentcoreRuntimeCapacityProviderConfiguration">BedrockagentcoreRuntimeCapacityProviderConfiguration</a>
...
new BedrockagentcoreRuntimeCapacityProviderConfiguration {
...
new BedrockagentcoreRuntimeConfig {
    ...
    BedrockagentcoreRuntimeCapacityProviderConfiguration CapacityProviderConfiguration = null,
    ...
    BedrockagentcoreRuntimeNetworkConfiguration NetworkConfiguration = null,
...
```csharp
public BedrockagentcoreRuntimeCapacityProviderConfiguration CapacityProviderConfiguration { get; set; }
```
...
new BedrockagentcoreRuntimeFilesystemConfigurations {
    BedrockagentcoreRuntimeFilesystemConfigurationsCapacityProviderVolume CapacityProviderVolume = null,
...
```csharp
public BedrockagentcoreRuntimeFilesystemConfigurationsCapacityProviderVolume CapacityProviderVolume { get; set; }
```
...
new BedrockagentcoreRuntimeFilesystemConfigurationsCapacityProviderVolume {
...
new BedrockagentcoreRuntimeCapacityProviderConfigurationOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.bedrockagentcoreRuntime.BedrockagentcoreRuntimeCapacityProviderConfigurationOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.bedrockagentcoreRuntime.BedrockagentcoreRuntimeCapacityProviderConfigurationOutputReference.resolve.parameter._context"></a>
...
```csharp
public IResolvable|BedrockagentcoreRuntimeCapacityProviderConfiguration InternalValue { get; }
```
...
new BedrockagentcoreRuntimeFilesystemConfigurationsCapacityProviderVolumeOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.bedrockagentcoreRuntime.BedrockagentcoreRuntimeFilesystemConfigurationsCapacityProviderVolumeOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.bedrockagentcoreRuntime.BedrockagentcoreRuntimeFilesystemConfigurationsCapacityProviderVolumeOutputReference.resolve.parameter._context"></a>
...
```csharp
public IResolvable|BedrockagentcoreRuntimeFilesystemConfigurationsCapacityProviderVolume InternalValue { get; }
```

- *Type:* Io.Cdktn.IResolvable|<a href="#@cdktn/provider-awscc.bedrockagentcoreRuntime.BedrockagentcoreRuntimeFilesystemConfigurationsCapacityProviderVolume">BedrockagentcoreRuntimeFilesystemConfigurationsCapacityProviderVolume</a>
...
```csharp
private void PutCapacityProviderVolume(BedrockagentcoreRuntimeFilesystemConfigurationsCapacityProviderVolume Value)
```
...
```csharp
private void ResetCapacityProviderVolume()
```
...
```csharp
public BedrockagentcoreRuntimeFilesystemConfigurationsCapacityProviderVolumeOutputReference CapacityProviderVolume { get; }
```
...
```csharp
public IResolvable|BedrockagentcoreRuntimeFilesystemConfigurationsCapacityProviderVolume CapacityProviderVolumeInput { get; }
```
