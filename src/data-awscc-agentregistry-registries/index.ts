...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/agentregistry_registries
...
export class DataAwsccAgentregistryRegistries extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccAgentregistryRegistries that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/agentregistry_registries#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/agentregistry_registries awscc_agentregistry_registries} Data Source
  *
  * @param scope The scope in which to define this construct
