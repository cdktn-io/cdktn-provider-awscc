...
```typescript
import { dataAwsccOdbOdbPeeringConnections } from '@cdktn/provider-awscc'

new dataAwsccOdbOdbPeeringConnections.DataAwsccOdbOdbPeeringConnections(scope: Construct, id: string, config?: DataAwsccOdbOdbPeeringConnectionsConfig)
```
...
dataAwsccOdbOdbPeeringConnections.DataAwsccOdbOdbPeeringConnections.isConstruct(x: any)
```
...
dataAwsccOdbOdbPeeringConnections.DataAwsccOdbOdbPeeringConnections.isTerraformElement(x: any)
```
...
dataAwsccOdbOdbPeeringConnections.DataAwsccOdbOdbPeeringConnections.isTerraformDataSource(x: any)
```
...
dataAwsccOdbOdbPeeringConnections.DataAwsccOdbOdbPeeringConnections.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccOdbOdbPeeringConnections.DataAwsccOdbOdbPeeringConnections.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccOdbOdbPeeringConnections.DataAwsccOdbOdbPeeringConnections.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccOdbOdbPeeringConnections.DataAwsccOdbOdbPeeringConnections.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccOdbOdbPeeringConnections.DataAwsccOdbOdbPeeringConnections.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccOdbOdbPeeringConnections.DataAwsccOdbOdbPeeringConnections.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccOdbOdbPeeringConnectionsConfig: dataAwsccOdbOdbPeeringConnections.DataAwsccOdbOdbPeeringConnectionsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccOdbOdbPeeringConnections.DataAwsccOdbOdbPeeringConnectionsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccOdbOdbPeeringConnections.DataAwsccOdbOdbPeeringConnectionsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccOdbOdbPeeringConnections.DataAwsccOdbOdbPeeringConnectionsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccOdbOdbPeeringConnections.DataAwsccOdbOdbPeeringConnectionsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
