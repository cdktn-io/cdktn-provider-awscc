...
```typescript
import { dataAwsccEc2VerifiedAccessEndpoints } from '@cdktn/provider-awscc'

new dataAwsccEc2VerifiedAccessEndpoints.DataAwsccEc2VerifiedAccessEndpoints(scope: Construct, id: string, config?: DataAwsccEc2VerifiedAccessEndpointsConfig)
```
...
dataAwsccEc2VerifiedAccessEndpoints.DataAwsccEc2VerifiedAccessEndpoints.isConstruct(x: any)
```
...
dataAwsccEc2VerifiedAccessEndpoints.DataAwsccEc2VerifiedAccessEndpoints.isTerraformElement(x: any)
```
...
dataAwsccEc2VerifiedAccessEndpoints.DataAwsccEc2VerifiedAccessEndpoints.isTerraformDataSource(x: any)
```
...
dataAwsccEc2VerifiedAccessEndpoints.DataAwsccEc2VerifiedAccessEndpoints.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VerifiedAccessEndpoints.DataAwsccEc2VerifiedAccessEndpoints.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VerifiedAccessEndpoints.DataAwsccEc2VerifiedAccessEndpoints.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VerifiedAccessEndpoints.DataAwsccEc2VerifiedAccessEndpoints.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VerifiedAccessEndpoints.DataAwsccEc2VerifiedAccessEndpoints.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VerifiedAccessEndpoints.DataAwsccEc2VerifiedAccessEndpoints.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccEc2VerifiedAccessEndpointsConfig: dataAwsccEc2VerifiedAccessEndpoints.DataAwsccEc2VerifiedAccessEndpointsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VerifiedAccessEndpoints.DataAwsccEc2VerifiedAccessEndpointsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VerifiedAccessEndpoints.DataAwsccEc2VerifiedAccessEndpointsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VerifiedAccessEndpoints.DataAwsccEc2VerifiedAccessEndpointsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2VerifiedAccessEndpoints.DataAwsccEc2VerifiedAccessEndpointsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
