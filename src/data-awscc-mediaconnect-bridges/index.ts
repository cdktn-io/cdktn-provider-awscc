...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/mediaconnect_bridges
...
export class DataAwsccMediaconnectBridges extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccMediaconnectBridges that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/mediaconnect_bridges#import import section} in the documentation of this resource for the id to use
