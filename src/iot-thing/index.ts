...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iot_thing
...
export class IotThing extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotThing that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iot_thing#import import section} in the documentation of this resource for the id to use
