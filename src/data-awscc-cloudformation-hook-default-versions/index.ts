...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/cloudformation_hook_default_versions
...
export class DataAwsccCloudformationHookDefaultVersions extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCloudformationHookDefaultVersions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/cloudformation_hook_default_versions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/cloudformation_hook_default_versions awscc_cloudformation_hook_default_versions} Data Source
  *
  * @param scope The scope in which to define this construct
