...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/b2bi_profile
...
export class B2BiProfile extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing B2BiProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/b2bi_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/b2bi_profile awscc_b2bi_profile} Resource
  *
  * @param scope The scope in which to define this construct
