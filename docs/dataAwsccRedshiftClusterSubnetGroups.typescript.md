...
```typescript
import { dataAwsccRedshiftClusterSubnetGroups } from '@cdktn/provider-awscc'

new dataAwsccRedshiftClusterSubnetGroups.DataAwsccRedshiftClusterSubnetGroups(scope: Construct, id: string, config?: DataAwsccRedshiftClusterSubnetGroupsConfig)
```
...
dataAwsccRedshiftClusterSubnetGroups.DataAwsccRedshiftClusterSubnetGroups.isConstruct(x: any)
```
...
dataAwsccRedshiftClusterSubnetGroups.DataAwsccRedshiftClusterSubnetGroups.isTerraformElement(x: any)
```
...
dataAwsccRedshiftClusterSubnetGroups.DataAwsccRedshiftClusterSubnetGroups.isTerraformDataSource(x: any)
```
...
dataAwsccRedshiftClusterSubnetGroups.DataAwsccRedshiftClusterSubnetGroups.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRedshiftClusterSubnetGroups.DataAwsccRedshiftClusterSubnetGroups.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRedshiftClusterSubnetGroups.DataAwsccRedshiftClusterSubnetGroups.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRedshiftClusterSubnetGroups.DataAwsccRedshiftClusterSubnetGroups.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRedshiftClusterSubnetGroups.DataAwsccRedshiftClusterSubnetGroups.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRedshiftClusterSubnetGroups.DataAwsccRedshiftClusterSubnetGroups.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccRedshiftClusterSubnetGroupsConfig: dataAwsccRedshiftClusterSubnetGroups.DataAwsccRedshiftClusterSubnetGroupsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRedshiftClusterSubnetGroups.DataAwsccRedshiftClusterSubnetGroupsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRedshiftClusterSubnetGroups.DataAwsccRedshiftClusterSubnetGroupsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRedshiftClusterSubnetGroups.DataAwsccRedshiftClusterSubnetGroupsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRedshiftClusterSubnetGroups.DataAwsccRedshiftClusterSubnetGroupsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
