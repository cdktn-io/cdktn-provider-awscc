...
```typescript
import { smsvoiceRegistration } from '@cdktn/provider-awscc'

new smsvoiceRegistration.SmsvoiceRegistration(scope: Construct, id: string, config: SmsvoiceRegistrationConfig)
```
...
```typescript
public putTags(value: IResolvable | SmsvoiceRegistrationTags[]): void
```
...
smsvoiceRegistration.SmsvoiceRegistration.isConstruct(x: any)
```
...
smsvoiceRegistration.SmsvoiceRegistration.isTerraformElement(x: any)
```
...
smsvoiceRegistration.SmsvoiceRegistration.isTerraformResource(x: any)
```
...
smsvoiceRegistration.SmsvoiceRegistration.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.smsvoiceRegistration.SmsvoiceRegistration.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.smsvoiceRegistration.SmsvoiceRegistration.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.smsvoiceRegistration.SmsvoiceRegistration.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.smsvoiceRegistration.SmsvoiceRegistration.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.smsvoiceRegistration.SmsvoiceRegistration.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.smsvoiceRegistration.SmsvoiceRegistration.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.smsvoiceRegistration.SmsvoiceRegistration.property.currentVersionNumber">currentVersionNumber</a></code> | <code>number</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.smsvoiceRegistration.SmsvoiceRegistration.property.tagsInput">tagsInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.smsvoiceRegistration.SmsvoiceRegistrationTags">SmsvoiceRegistrationTags</a>[]</code> | *No description.* |
...
```typescript
public readonly tags: SmsvoiceRegistrationTagsList;
```
...
```typescript
public readonly tagsInput: IResolvable | SmsvoiceRegistrationTags[];
```
...
const smsvoiceRegistrationConfig: smsvoiceRegistration.SmsvoiceRegistrationConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.smsvoiceRegistration.SmsvoiceRegistrationConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.smsvoiceRegistration.SmsvoiceRegistrationConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.smsvoiceRegistration.SmsvoiceRegistrationConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.smsvoiceRegistration.SmsvoiceRegistrationConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
```typescript
public readonly tags: IResolvable | SmsvoiceRegistrationTags[];
```
...
const smsvoiceRegistrationTags: smsvoiceRegistration.SmsvoiceRegistrationTags = { ... }
```
...
new smsvoiceRegistration.SmsvoiceRegistrationTagsList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.smsvoiceRegistration.SmsvoiceRegistrationTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.smsvoiceRegistration.SmsvoiceRegistrationTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| <code><a href="#@cdktn/provider-awscc.smsvoiceRegistration.SmsvoiceRegistrationTagsList.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.smsvoiceRegistration.SmsvoiceRegistrationTags">SmsvoiceRegistrationTags</a>[]</code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | SmsvoiceRegistrationTags[];
```
...
new smsvoiceRegistration.SmsvoiceRegistrationTagsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.smsvoiceRegistration.SmsvoiceRegistrationTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.smsvoiceRegistration.SmsvoiceRegistrationTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-awscc.smsvoiceRegistration.SmsvoiceRegistrationTagsOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| <code><a href="#@cdktn/provider-awscc.smsvoiceRegistration.SmsvoiceRegistrationTagsOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.smsvoiceRegistration.SmsvoiceRegistrationTags">SmsvoiceRegistrationTags</a></code> | *No description.* |
