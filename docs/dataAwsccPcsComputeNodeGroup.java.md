...
| <code><a href="#@cdktn/provider-awscc.dataAwsccPcsComputeNodeGroup.DataAwsccPcsComputeNodeGroupSlurmConfigurationOutputReference.property.gresCustomSettings">gresCustomSettings</a></code> | <code>io.cdktn.cdktn.StringMapList</code> | *No description.* |
...
```java
public StringMapList getGresCustomSettings();
```
