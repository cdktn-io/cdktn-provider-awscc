...
```typescript
import { dataAwsccCloudtrailEventDataStores } from '@cdktn/provider-awscc'

new dataAwsccCloudtrailEventDataStores.DataAwsccCloudtrailEventDataStores(scope: Construct, id: string, config?: DataAwsccCloudtrailEventDataStoresConfig)
```
...
dataAwsccCloudtrailEventDataStores.DataAwsccCloudtrailEventDataStores.isConstruct(x: any)
```
...
dataAwsccCloudtrailEventDataStores.DataAwsccCloudtrailEventDataStores.isTerraformElement(x: any)
```
...
dataAwsccCloudtrailEventDataStores.DataAwsccCloudtrailEventDataStores.isTerraformDataSource(x: any)
```
...
dataAwsccCloudtrailEventDataStores.DataAwsccCloudtrailEventDataStores.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudtrailEventDataStores.DataAwsccCloudtrailEventDataStores.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudtrailEventDataStores.DataAwsccCloudtrailEventDataStores.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudtrailEventDataStores.DataAwsccCloudtrailEventDataStores.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudtrailEventDataStores.DataAwsccCloudtrailEventDataStores.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudtrailEventDataStores.DataAwsccCloudtrailEventDataStores.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccCloudtrailEventDataStoresConfig: dataAwsccCloudtrailEventDataStores.DataAwsccCloudtrailEventDataStoresConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudtrailEventDataStores.DataAwsccCloudtrailEventDataStoresConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudtrailEventDataStores.DataAwsccCloudtrailEventDataStoresConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudtrailEventDataStores.DataAwsccCloudtrailEventDataStoresConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudtrailEventDataStores.DataAwsccCloudtrailEventDataStoresConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
