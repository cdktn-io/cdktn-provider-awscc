...
```typescript
import { dataAwsccElasticloadbalancingv2TargetGroups } from '@cdktn/provider-awscc'

new dataAwsccElasticloadbalancingv2TargetGroups.DataAwsccElasticloadbalancingv2TargetGroups(scope: Construct, id: string, config?: DataAwsccElasticloadbalancingv2TargetGroupsConfig)
```
...
dataAwsccElasticloadbalancingv2TargetGroups.DataAwsccElasticloadbalancingv2TargetGroups.isConstruct(x: any)
```
...
dataAwsccElasticloadbalancingv2TargetGroups.DataAwsccElasticloadbalancingv2TargetGroups.isTerraformElement(x: any)
```
...
dataAwsccElasticloadbalancingv2TargetGroups.DataAwsccElasticloadbalancingv2TargetGroups.isTerraformDataSource(x: any)
```
...
dataAwsccElasticloadbalancingv2TargetGroups.DataAwsccElasticloadbalancingv2TargetGroups.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccElasticloadbalancingv2TargetGroups.DataAwsccElasticloadbalancingv2TargetGroups.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccElasticloadbalancingv2TargetGroups.DataAwsccElasticloadbalancingv2TargetGroups.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccElasticloadbalancingv2TargetGroups.DataAwsccElasticloadbalancingv2TargetGroups.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccElasticloadbalancingv2TargetGroups.DataAwsccElasticloadbalancingv2TargetGroups.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccElasticloadbalancingv2TargetGroups.DataAwsccElasticloadbalancingv2TargetGroups.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccElasticloadbalancingv2TargetGroupsConfig: dataAwsccElasticloadbalancingv2TargetGroups.DataAwsccElasticloadbalancingv2TargetGroupsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccElasticloadbalancingv2TargetGroups.DataAwsccElasticloadbalancingv2TargetGroupsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccElasticloadbalancingv2TargetGroups.DataAwsccElasticloadbalancingv2TargetGroupsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccElasticloadbalancingv2TargetGroups.DataAwsccElasticloadbalancingv2TargetGroupsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccElasticloadbalancingv2TargetGroups.DataAwsccElasticloadbalancingv2TargetGroupsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
