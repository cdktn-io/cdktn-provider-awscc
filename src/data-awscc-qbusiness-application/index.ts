...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/qbusiness_application
...
export class DataAwsccQbusinessApplication extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccQbusinessApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/qbusiness_application#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/qbusiness_application awscc_qbusiness_application} Data Source
  *
  * @param scope The scope in which to define this construct
