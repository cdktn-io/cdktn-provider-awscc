...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/rtbfabric_responder_gateway
...
export class RtbfabricResponderGateway extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RtbfabricResponderGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/rtbfabric_responder_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/rtbfabric_responder_gateway awscc_rtbfabric_responder_gateway} Resource
  *
  * @param scope The scope in which to define this construct
