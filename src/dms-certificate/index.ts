...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/dms_certificate
...
export class DmsCertificate extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DmsCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/dms_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/dms_certificate awscc_dms_certificate} Resource
  *
  * @param scope The scope in which to define this construct
