...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/events_event_bus_policy
...
export class EventsEventBusPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EventsEventBusPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/events_event_bus_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/events_event_bus_policy awscc_events_event_bus_policy} Resource
  *
  * @param scope The scope in which to define this construct
