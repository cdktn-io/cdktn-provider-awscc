...
new SesContactList(Construct Scope, string Id, SesContactListConfig Config = null);
```
...
```csharp
private void PutTags(IResolvable|SesContactListTags[] Value)
```

###### `Value`<sup>Required</sup> <a name="Value" id="@cdktn/provider-awscc.sesContactList.SesContactList.putTags.parameter.value"></a>

- *Type:* Io.Cdktn.IResolvable|<a href="#@cdktn/provider-awscc.sesContactList.SesContactListTags">SesContactListTags</a>[]
...
```csharp
private void PutTopics(IResolvable|SesContactListTopics[] Value)
```

###### `Value`<sup>Required</sup> <a name="Value" id="@cdktn/provider-awscc.sesContactList.SesContactList.putTopics.parameter.value"></a>

- *Type:* Io.Cdktn.IResolvable|<a href="#@cdktn/provider-awscc.sesContactList.SesContactListTopics">SesContactListTopics</a>[]
...
```csharp
private void ResetContactListName()
```
...
SesContactList.IsConstruct(object X);
```
...
SesContactList.IsTerraformElement(object X);
```
...
SesContactList.IsTerraformResource(object X);
```
...
SesContactList.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactList.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactList.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactList.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactList.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactList.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactList.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactList.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactList.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactList.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactList.property.tagsInput">TagsInput</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.sesContactList.SesContactListTags">SesContactListTags</a>[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactList.property.topicsInput">TopicsInput</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.sesContactList.SesContactListTopics">SesContactListTopics</a>[]</code> | *No description.* |
...
```csharp
public SesContactListTagsList Tags { get; }
```
...
```csharp
public SesContactListTopicsList Topics { get; }
```
...
```csharp
public IResolvable|SesContactListTags[] TagsInput { get; }
```
...
```csharp
public IResolvable|SesContactListTopics[] TopicsInput { get; }
```
...
new SesContactListConfig {
    ...
    IResolvable|SesContactListTags[] Tags = null,
    IResolvable|SesContactListTopics[] Topics = null
};
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactListConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactListConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactListConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactListConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactListConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactListConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactListConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactListConfig.property.tags">Tags</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.sesContactList.SesContactListTags">SesContactListTags</a>[]</code> | The tags (keys and values) associated with the contact list. |
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactListConfig.property.topics">Topics</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.sesContactList.SesContactListTopics">SesContactListTopics</a>[]</code> | The topics associated with the contact list. |
...
```csharp
public IResolvable|SesContactListTags[] Tags { get; set; }
```
...
```csharp
public IResolvable|SesContactListTopics[] Topics { get; set; }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactListTags.property.key">Key</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ses_contact_list#key SesContactList#key}. |
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactListTags.property.value">Value</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ses_contact_list#value SesContactList#value}. |
...
new SesContactListTopics {
    string DefaultSubscriptionStatus = null,
    string Description = null,
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactListTopics.property.defaultSubscriptionStatus">DefaultSubscriptionStatus</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ses_contact_list#default_subscription_status SesContactList#default_subscription_status}. |
...
new SesContactListTagsList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactListTagsList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.sesContactList.SesContactListTagsList.resolve.parameter._context"></a>
...
```csharp
private SesContactListTagsOutputReference Get(double Index)
```
...
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactListTagsList.property.internalValue">InternalValue</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.sesContactList.SesContactListTags">SesContactListTags</a>[]</code> | *No description.* |
...
```csharp
public IResolvable|SesContactListTags[] InternalValue { get; }
```
...
new SesContactListTagsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactListTagsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactListTagsOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.sesContactList.SesContactListTagsOutputReference.resolve.parameter._context"></a>
...
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactListTagsOutputReference.property.internalValue">InternalValue</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.sesContactList.SesContactListTags">SesContactListTags</a></code> | *No description.* |
...
new SesContactListTopicsList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactListTopicsList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.sesContactList.SesContactListTopicsList.resolve.parameter._context"></a>
...
```csharp
private SesContactListTopicsOutputReference Get(double Index)
```
...
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactListTopicsList.property.internalValue">InternalValue</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.sesContactList.SesContactListTopics">SesContactListTopics</a>[]</code> | *No description.* |
...
```csharp
public IResolvable|SesContactListTopics[] InternalValue { get; }
```
...
new SesContactListTopicsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactListTopicsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactListTopicsOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.sesContactList.SesContactListTopicsOutputReference.resolve.parameter._context"></a>
...
```csharp
private void ResetDefaultSubscriptionStatus()
```
...
| <code><a href="#@cdktn/provider-awscc.sesContactList.SesContactListTopicsOutputReference.property.internalValue">InternalValue</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.sesContactList.SesContactListTopics">SesContactListTopics</a></code> | *No description.* |
