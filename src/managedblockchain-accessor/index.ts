...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/managedblockchain_accessor
...
export class ManagedblockchainAccessor extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagedblockchainAccessor that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/managedblockchain_accessor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/managedblockchain_accessor awscc_managedblockchain_accessor} Resource
  *
  * @param scope The scope in which to define this construct
