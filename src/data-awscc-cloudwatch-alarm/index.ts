...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/cloudwatch_alarm
...
export interface DataAwsccCloudwatchAlarmEvaluationWindowWallClockWindow {
}

export function dataAwsccCloudwatchAlarmEvaluationWindowWallClockWindowToTerraform(struct?: DataAwsccCloudwatchAlarmEvaluationWindowWallClockWindow): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsccCloudwatchAlarmEvaluationWindowWallClockWindowToHclTerraform(struct?: DataAwsccCloudwatchAlarmEvaluationWindowWallClockWindow): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsccCloudwatchAlarmEvaluationWindowWallClockWindowOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAwsccCloudwatchAlarmEvaluationWindowWallClockWindow | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsccCloudwatchAlarmEvaluationWindowWallClockWindow | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export interface DataAwsccCloudwatchAlarmEvaluationWindow {
}

export function dataAwsccCloudwatchAlarmEvaluationWindowToTerraform(struct?: DataAwsccCloudwatchAlarmEvaluationWindow): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsccCloudwatchAlarmEvaluationWindowToHclTerraform(struct?: DataAwsccCloudwatchAlarmEvaluationWindow): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsccCloudwatchAlarmEvaluationWindowOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAwsccCloudwatchAlarmEvaluationWindow | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsccCloudwatchAlarmEvaluationWindow | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  // wall_clock_window - computed: true, optional: false, required: false
  private _wallClockWindow = new DataAwsccCloudwatchAlarmEvaluationWindowWallClockWindowOutputReference(this, "wall_clock_window");
...
export class DataAwsccCloudwatchAlarm extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCloudwatchAlarm that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/cloudwatch_alarm#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/cloudwatch_alarm awscc_cloudwatch_alarm} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _evaluationWindow = new DataAwsccCloudwatchAlarmEvaluationWindowOutputReference(this, "evaluation_window");
