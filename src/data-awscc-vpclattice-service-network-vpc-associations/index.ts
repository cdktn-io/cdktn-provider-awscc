...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/vpclattice_service_network_vpc_associations
...
export class DataAwsccVpclatticeServiceNetworkVpcAssociations extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccVpclatticeServiceNetworkVpcAssociations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/vpclattice_service_network_vpc_associations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/vpclattice_service_network_vpc_associations awscc_vpclattice_service_network_vpc_associations} Data Source
  *
  * @param scope The scope in which to define this construct
