...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/logs_log_stream
...
export interface LogsLogStreamConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/logs_log_stream#log_group_name LogsLogStream#log_group_name}
  */
  readonly logGroupName: string;
  /**
  * The name of the log stream. The name must be unique wihtin the log group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/logs_log_stream#log_stream_name LogsLogStream#log_stream_name}
  */
...
export class LogsLogStream extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LogsLogStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/logs_log_stream#import import section} in the documentation of this resource for the id to use
