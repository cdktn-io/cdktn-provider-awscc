...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/glue_schema
...
export class GlueSchema extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GlueSchema that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/glue_schema#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/glue_schema awscc_glue_schema} Resource
  *
  * @param scope The scope in which to define this construct
