...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/ec2_placement_group
...
export class Ec2PlacementGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2PlacementGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/ec2_placement_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/ec2_placement_group awscc_ec2_placement_group} Resource
  *
  * @param scope The scope in which to define this construct
