...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/iotwireless_task_definition
...
export class DataAwsccIotwirelessTaskDefinition extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIotwirelessTaskDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/iotwireless_task_definition#import import section} in the documentation of this resource for the id to use
