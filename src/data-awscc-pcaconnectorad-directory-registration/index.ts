...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/pcaconnectorad_directory_registration
...
export class DataAwsccPcaconnectoradDirectoryRegistration extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccPcaconnectoradDirectoryRegistration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/pcaconnectorad_directory_registration#import import section} in the documentation of this resource for the id to use
