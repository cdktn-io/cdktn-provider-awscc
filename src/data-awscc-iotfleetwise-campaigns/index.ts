...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/iotfleetwise_campaigns
...
export class DataAwsccIotfleetwiseCampaigns extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIotfleetwiseCampaigns that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/iotfleetwise_campaigns#import import section} in the documentation of this resource for the id to use
