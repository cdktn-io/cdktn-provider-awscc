...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/directconnect_public_virtual_interface
...
export class DataAwsccDirectconnectPublicVirtualInterface extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDirectconnectPublicVirtualInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/directconnect_public_virtual_interface#import import section} in the documentation of this resource for the id to use
