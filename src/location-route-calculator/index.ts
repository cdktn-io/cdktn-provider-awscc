...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/location_route_calculator
...
export class LocationRouteCalculator extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LocationRouteCalculator that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/location_route_calculator#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/location_route_calculator awscc_location_route_calculator} Resource
  *
  * @param scope The scope in which to define this construct
