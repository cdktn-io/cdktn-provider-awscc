...
```typescript
import { dataAwsccSqsQueueInlinePolicy } from '@cdktn/provider-awscc'

new dataAwsccSqsQueueInlinePolicy.DataAwsccSqsQueueInlinePolicy(scope: Construct, id: string, config: DataAwsccSqsQueueInlinePolicyConfig)
```
...
dataAwsccSqsQueueInlinePolicy.DataAwsccSqsQueueInlinePolicy.isConstruct(x: any)
```
...
dataAwsccSqsQueueInlinePolicy.DataAwsccSqsQueueInlinePolicy.isTerraformElement(x: any)
```
...
dataAwsccSqsQueueInlinePolicy.DataAwsccSqsQueueInlinePolicy.isTerraformDataSource(x: any)
```
...
dataAwsccSqsQueueInlinePolicy.DataAwsccSqsQueueInlinePolicy.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSqsQueueInlinePolicy.DataAwsccSqsQueueInlinePolicy.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSqsQueueInlinePolicy.DataAwsccSqsQueueInlinePolicy.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSqsQueueInlinePolicy.DataAwsccSqsQueueInlinePolicy.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSqsQueueInlinePolicy.DataAwsccSqsQueueInlinePolicy.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSqsQueueInlinePolicy.DataAwsccSqsQueueInlinePolicy.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccSqsQueueInlinePolicyConfig: dataAwsccSqsQueueInlinePolicy.DataAwsccSqsQueueInlinePolicyConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSqsQueueInlinePolicy.DataAwsccSqsQueueInlinePolicyConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSqsQueueInlinePolicy.DataAwsccSqsQueueInlinePolicyConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSqsQueueInlinePolicy.DataAwsccSqsQueueInlinePolicyConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSqsQueueInlinePolicy.DataAwsccSqsQueueInlinePolicyConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
