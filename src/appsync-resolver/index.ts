...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver
...
export class AppsyncResolver extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AppsyncResolver that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver awscc_appsync_resolver} Resource
  *
  * @param scope The scope in which to define this construct
