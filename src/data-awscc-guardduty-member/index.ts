...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/guardduty_member
...
export class DataAwsccGuarddutyMember extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccGuarddutyMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/guardduty_member#import import section} in the documentation of this resource for the id to use
