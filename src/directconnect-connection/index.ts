...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/directconnect_connection
...
export class DirectconnectConnection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DirectconnectConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/directconnect_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/directconnect_connection awscc_directconnect_connection} Resource
  *
  * @param scope The scope in which to define this construct
