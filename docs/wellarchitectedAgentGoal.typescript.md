...
```typescript
import { wellarchitectedAgentGoal } from '@cdktn/provider-awscc'

new wellarchitectedAgentGoal.WellarchitectedAgentGoal(scope: Construct, id: string, config: WellarchitectedAgentGoalConfig)
```
...
wellarchitectedAgentGoal.WellarchitectedAgentGoal.isConstruct(x: any)
```
...
wellarchitectedAgentGoal.WellarchitectedAgentGoal.isTerraformElement(x: any)
```
...
wellarchitectedAgentGoal.WellarchitectedAgentGoal.isTerraformResource(x: any)
```
...
wellarchitectedAgentGoal.WellarchitectedAgentGoal.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.wellarchitectedAgentGoal.WellarchitectedAgentGoal.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.wellarchitectedAgentGoal.WellarchitectedAgentGoal.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.wellarchitectedAgentGoal.WellarchitectedAgentGoal.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.wellarchitectedAgentGoal.WellarchitectedAgentGoal.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.wellarchitectedAgentGoal.WellarchitectedAgentGoal.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.wellarchitectedAgentGoal.WellarchitectedAgentGoal.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const wellarchitectedAgentGoalConfig: wellarchitectedAgentGoal.WellarchitectedAgentGoalConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.wellarchitectedAgentGoal.WellarchitectedAgentGoalConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.wellarchitectedAgentGoal.WellarchitectedAgentGoalConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.wellarchitectedAgentGoal.WellarchitectedAgentGoalConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.wellarchitectedAgentGoal.WellarchitectedAgentGoalConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
