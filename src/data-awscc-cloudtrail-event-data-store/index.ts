...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/cloudtrail_event_data_store
...
export class DataAwsccCloudtrailEventDataStore extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCloudtrailEventDataStore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/cloudtrail_event_data_store#import import section} in the documentation of this resource for the id to use
