...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_subscription_target
...
export class DatazoneSubscriptionTarget extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DatazoneSubscriptionTarget that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_subscription_target#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_subscription_target awscc_datazone_subscription_target} Resource
  *
  * @param scope The scope in which to define this construct
