...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/servicediscovery_services
...
export class DataAwsccServicediscoveryServices extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccServicediscoveryServices that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/servicediscovery_services#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/servicediscovery_services awscc_servicediscovery_services} Data Source
  *
  * @param scope The scope in which to define this construct
