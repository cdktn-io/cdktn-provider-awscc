...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccnotificationsmanagednotificationaccountcontactassociations"

dataawsccnotificationsmanagednotificationaccountcontactassociations.NewDataAwsccNotificationsManagedNotificationAccountContactAssociations(scope Construct, id *string, config DataAwsccNotificationsManagedNotificationAccountContactAssociationsConfig) DataAwsccNotificationsManagedNotificationAccountContactAssociations
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsManagedNotificationAccountContactAssociations.DataAwsccNotificationsManagedNotificationAccountContactAssociations.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
dataawsccnotificationsmanagednotificationaccountcontactassociations.DataAwsccNotificationsManagedNotificationAccountContactAssociations_IsConstruct(x interface{}) *bool
```
...
dataawsccnotificationsmanagednotificationaccountcontactassociations.DataAwsccNotificationsManagedNotificationAccountContactAssociations_IsTerraformElement(x interface{}) *bool
```
...
dataawsccnotificationsmanagednotificationaccountcontactassociations.DataAwsccNotificationsManagedNotificationAccountContactAssociations_IsTerraformDataSource(x interface{}) *bool
```
...
dataawsccnotificationsmanagednotificationaccountcontactassociations.DataAwsccNotificationsManagedNotificationAccountContactAssociations_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsManagedNotificationAccountContactAssociations.DataAwsccNotificationsManagedNotificationAccountContactAssociations.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsManagedNotificationAccountContactAssociations.DataAwsccNotificationsManagedNotificationAccountContactAssociations.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsManagedNotificationAccountContactAssociations.DataAwsccNotificationsManagedNotificationAccountContactAssociations.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsManagedNotificationAccountContactAssociations.DataAwsccNotificationsManagedNotificationAccountContactAssociations.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsManagedNotificationAccountContactAssociations.DataAwsccNotificationsManagedNotificationAccountContactAssociations.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsManagedNotificationAccountContactAssociations.DataAwsccNotificationsManagedNotificationAccountContactAssociations.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsManagedNotificationAccountContactAssociations.DataAwsccNotificationsManagedNotificationAccountContactAssociations.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsManagedNotificationAccountContactAssociations.DataAwsccNotificationsManagedNotificationAccountContactAssociationsConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsManagedNotificationAccountContactAssociations.DataAwsccNotificationsManagedNotificationAccountContactAssociationsConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsManagedNotificationAccountContactAssociations.DataAwsccNotificationsManagedNotificationAccountContactAssociationsConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsManagedNotificationAccountContactAssociations.DataAwsccNotificationsManagedNotificationAccountContactAssociationsConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsManagedNotificationAccountContactAssociations.DataAwsccNotificationsManagedNotificationAccountContactAssociationsConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsManagedNotificationAccountContactAssociations.DataAwsccNotificationsManagedNotificationAccountContactAssociationsConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsManagedNotificationAccountContactAssociations.DataAwsccNotificationsManagedNotificationAccountContactAssociationsConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
