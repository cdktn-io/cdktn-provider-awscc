...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/apigatewayv2_vpc_link
...
export class Apigatewayv2VpcLink extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Apigatewayv2VpcLink that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/apigatewayv2_vpc_link#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/apigatewayv2_vpc_link awscc_apigatewayv2_vpc_link} Resource
  *
  * @param scope The scope in which to define this construct
