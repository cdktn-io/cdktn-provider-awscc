...
export class S3OutpostsBucketPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3OutpostsBucketPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/s3outposts_bucket_policy#import import section} in the documentation of this resource for the id to use
