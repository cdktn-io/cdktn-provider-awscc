...
Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/ec2_security_group_vpc_associations awscc_ec2_security_group_vpc_associations}.
...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccec2securitygroupvpcassociations"

dataawsccec2securitygroupvpcassociations.NewDataAwsccEc2SecurityGroupVpcAssociations(scope Construct, id *string, config DataAwsccEc2SecurityGroupVpcAssociationsConfig) DataAwsccEc2SecurityGroupVpcAssociations
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SecurityGroupVpcAssociations.DataAwsccEc2SecurityGroupVpcAssociations.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
dataawsccec2securitygroupvpcassociations.DataAwsccEc2SecurityGroupVpcAssociations_IsConstruct(x interface{}) *bool
```
...
dataawsccec2securitygroupvpcassociations.DataAwsccEc2SecurityGroupVpcAssociations_IsTerraformElement(x interface{}) *bool
```
...
dataawsccec2securitygroupvpcassociations.DataAwsccEc2SecurityGroupVpcAssociations_IsTerraformDataSource(x interface{}) *bool
```
...
dataawsccec2securitygroupvpcassociations.DataAwsccEc2SecurityGroupVpcAssociations_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/ec2_security_group_vpc_associations#import import section} in the documentation of this resource for the id to use
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SecurityGroupVpcAssociations.DataAwsccEc2SecurityGroupVpcAssociations.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SecurityGroupVpcAssociations.DataAwsccEc2SecurityGroupVpcAssociations.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SecurityGroupVpcAssociations.DataAwsccEc2SecurityGroupVpcAssociations.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SecurityGroupVpcAssociations.DataAwsccEc2SecurityGroupVpcAssociations.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SecurityGroupVpcAssociations.DataAwsccEc2SecurityGroupVpcAssociations.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SecurityGroupVpcAssociations.DataAwsccEc2SecurityGroupVpcAssociations.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SecurityGroupVpcAssociations.DataAwsccEc2SecurityGroupVpcAssociations.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SecurityGroupVpcAssociations.DataAwsccEc2SecurityGroupVpcAssociations.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
...
&dataawsccec2securitygroupvpcassociations.DataAwsccEc2SecurityGroupVpcAssociationsConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SecurityGroupVpcAssociations.DataAwsccEc2SecurityGroupVpcAssociationsConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SecurityGroupVpcAssociations.DataAwsccEc2SecurityGroupVpcAssociationsConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SecurityGroupVpcAssociations.DataAwsccEc2SecurityGroupVpcAssociationsConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SecurityGroupVpcAssociations.DataAwsccEc2SecurityGroupVpcAssociationsConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SecurityGroupVpcAssociations.DataAwsccEc2SecurityGroupVpcAssociationsConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SecurityGroupVpcAssociations.DataAwsccEc2SecurityGroupVpcAssociationsConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SecurityGroupVpcAssociations.DataAwsccEc2SecurityGroupVpcAssociationsConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
