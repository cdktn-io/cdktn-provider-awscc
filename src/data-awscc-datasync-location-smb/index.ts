...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/datasync_location_smb
...
export class DataAwsccDatasyncLocationSmb extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDatasyncLocationSmb that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/datasync_location_smb#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/datasync_location_smb awscc_datasync_location_smb} Data Source
  *
  * @param scope The scope in which to define this construct
