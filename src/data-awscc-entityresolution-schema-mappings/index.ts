...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/entityresolution_schema_mappings
...
export class DataAwsccEntityresolutionSchemaMappings extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEntityresolutionSchemaMappings that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/entityresolution_schema_mappings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/entityresolution_schema_mappings awscc_entityresolution_schema_mappings} Data Source
  *
  * @param scope The scope in which to define this construct
