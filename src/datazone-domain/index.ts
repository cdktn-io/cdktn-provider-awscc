...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/datazone_domain
...
export interface DatazoneDomainConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/datazone_domain#description DatazoneDomain#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/datazone_domain#domain_execution_role DatazoneDomain#domain_execution_role}
  */
  readonly domainExecutionRole?: string;
  /**
  * The version of the domain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/datazone_domain#domain_version DatazoneDomain#domain_version}
  */
  readonly domainVersion?: string;
  /**
  * The identifier of the AWS Key Management Service (KMS) key that is used to encrypt the Amazon DataZone domain, metadata, and reporting data.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/datazone_domain#kms_key_identifier DatazoneDomain#kms_key_identifier}
  */
  readonly kmsKeyIdentifier?: string;
  /**
  * The name of the Amazon DataZone domain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/datazone_domain#name DatazoneDomain#name}
  */
  readonly name: string;
  /**
  * The service role of the domain that is created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/datazone_domain#service_role DatazoneDomain#service_role}
  */
  readonly serviceRole?: string;
  /**
  * The single-sign on configuration of the Amazon DataZone domain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/datazone_domain#single_sign_on DatazoneDomain#single_sign_on}
  */
  readonly singleSignOn?: DatazoneDomainSingleSignOn;
  /**
  * The tags specified for the Amazon DataZone domain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/datazone_domain#tags DatazoneDomain#tags}
  */
...
export interface DatazoneDomainSingleSignOn {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/datazone_domain#idc_instance_arn DatazoneDomain#idc_instance_arn}
  */
  readonly idcInstanceArn?: string;
  /**
  * The type of single sign-on in Amazon DataZone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/datazone_domain#type DatazoneDomain#type}
  */
  readonly type?: string;
  /**
  * The single sign-on user assignment in Amazon DataZone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/datazone_domain#user_assignment DatazoneDomain#user_assignment}
  */
...
export interface DatazoneDomainTags {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/datazone_domain#key DatazoneDomain#key}
  */
  readonly key?: string;
  /**
  * The value for the tag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/datazone_domain#value DatazoneDomain#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/datazone_domain awscc_datazone_domain}
*/
export class DatazoneDomain extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DatazoneDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/datazone_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/datazone_domain awscc_datazone_domain} Resource
  *
  * @param scope The scope in which to define this construct
