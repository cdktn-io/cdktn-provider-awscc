...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/cloudtrail_trails
...
export class DataAwsccCloudtrailTrails extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCloudtrailTrails that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/cloudtrail_trails#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/cloudtrail_trails awscc_cloudtrail_trails} Data Source
  *
  * @param scope The scope in which to define this construct
