...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/robomaker_robot_application
...
export class DataAwsccRobomakerRobotApplication extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRobomakerRobotApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/robomaker_robot_application#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/robomaker_robot_application awscc_robomaker_robot_application} Data Source
  *
  * @param scope The scope in which to define this construct
