...
```typescript
import { dataAwsccPiPerfReports } from '@cdktn/provider-awscc'

new dataAwsccPiPerfReports.DataAwsccPiPerfReports(scope: Construct, id: string, config: DataAwsccPiPerfReportsConfig)
```
...
dataAwsccPiPerfReports.DataAwsccPiPerfReports.isConstruct(x: any)
```
...
dataAwsccPiPerfReports.DataAwsccPiPerfReports.isTerraformElement(x: any)
```
...
dataAwsccPiPerfReports.DataAwsccPiPerfReports.isTerraformDataSource(x: any)
```
...
dataAwsccPiPerfReports.DataAwsccPiPerfReports.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccPiPerfReports.DataAwsccPiPerfReports.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccPiPerfReports.DataAwsccPiPerfReports.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccPiPerfReports.DataAwsccPiPerfReports.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccPiPerfReports.DataAwsccPiPerfReports.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccPiPerfReports.DataAwsccPiPerfReports.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
```typescript
public readonly tags: DataAwsccPiPerfReportsTagsList;
```
...
const dataAwsccPiPerfReportsConfig: dataAwsccPiPerfReports.DataAwsccPiPerfReportsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccPiPerfReports.DataAwsccPiPerfReportsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccPiPerfReports.DataAwsccPiPerfReportsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccPiPerfReports.DataAwsccPiPerfReportsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccPiPerfReports.DataAwsccPiPerfReportsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const dataAwsccPiPerfReportsTags: dataAwsccPiPerfReports.DataAwsccPiPerfReportsTags = { ... }
```
...
new dataAwsccPiPerfReports.DataAwsccPiPerfReportsTagsList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccPiPerfReports.DataAwsccPiPerfReportsTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccPiPerfReports.DataAwsccPiPerfReportsTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
new dataAwsccPiPerfReports.DataAwsccPiPerfReportsTagsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccPiPerfReports.DataAwsccPiPerfReportsTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccPiPerfReports.DataAwsccPiPerfReportsTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccPiPerfReports.DataAwsccPiPerfReportsTagsOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```typescript
public readonly internalValue: DataAwsccPiPerfReportsTags;
```
