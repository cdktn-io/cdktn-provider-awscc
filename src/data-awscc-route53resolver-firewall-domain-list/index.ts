...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/route53resolver_firewall_domain_list
...
export class DataAwsccRoute53ResolverFirewallDomainList extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRoute53ResolverFirewallDomainList that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/route53resolver_firewall_domain_list#import import section} in the documentation of this resource for the id to use
