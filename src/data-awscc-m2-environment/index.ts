...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/m2_environment
...
export class DataAwsccM2Environment extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccM2Environment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/m2_environment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/m2_environment awscc_m2_environment} Data Source
  *
  * @param scope The scope in which to define this construct
