...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/backup_backup_vault
...
export class DataAwsccBackupBackupVault extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccBackupBackupVault that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/backup_backup_vault#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/backup_backup_vault awscc_backup_backup_vault} Data Source
  *
  * @param scope The scope in which to define this construct
