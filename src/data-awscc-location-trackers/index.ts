...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/location_trackers
...
export class DataAwsccLocationTrackers extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccLocationTrackers that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/location_trackers#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/location_trackers awscc_location_trackers} Data Source
  *
  * @param scope The scope in which to define this construct
