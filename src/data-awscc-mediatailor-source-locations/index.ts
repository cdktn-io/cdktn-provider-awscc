...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/mediatailor_source_locations
...
export class DataAwsccMediatailorSourceLocations extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccMediatailorSourceLocations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/mediatailor_source_locations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/mediatailor_source_locations awscc_mediatailor_source_locations} Data Source
  *
  * @param scope The scope in which to define this construct
