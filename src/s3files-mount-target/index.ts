...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/s3files_mount_target
...
export class S3FilesMountTarget extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3FilesMountTarget that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/s3files_mount_target#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/s3files_mount_target awscc_s3files_mount_target} Resource
  *
  * @param scope The scope in which to define this construct
