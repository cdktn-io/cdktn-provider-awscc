...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/glue_data_catalog_encryption_settings
...
export class DataAwsccGlueDataCatalogEncryptionSettings extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccGlueDataCatalogEncryptionSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/glue_data_catalog_encryption_settings#import import section} in the documentation of this resource for the id to use
