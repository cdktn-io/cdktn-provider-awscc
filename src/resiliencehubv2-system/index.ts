...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/resiliencehubv2_system
...
export interface Resiliencehubv2SystemTags {
  /**
  * The tag key.
  *
...
export function resiliencehubv2SystemTagsToTerraform(struct?: Resiliencehubv2SystemTags | cdktn.IResolvable): any {
...
export function resiliencehubv2SystemTagsToHclTerraform(struct?: Resiliencehubv2SystemTags | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class Resiliencehubv2SystemTagsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): Resiliencehubv2SystemTags | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: Resiliencehubv2SystemTags | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class Resiliencehubv2SystemTagsList extends cdktn.ComplexList {
  public internalValue? : Resiliencehubv2SystemTags[] | cdktn.IResolvable
  ...
  */
  public get(index: number): Resiliencehubv2SystemTagsOutputReference {
    return new Resiliencehubv2SystemTagsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class Resiliencehubv2System extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Resiliencehubv2System that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/resiliencehubv2_system#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/resiliencehubv2_system awscc_resiliencehubv2_system} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _tags = new Resiliencehubv2SystemTagsList(this, "tags", false);
  public get tags() {
    return this._tags;
  }
  public putTags(value: Resiliencehubv2SystemTags[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      tags: cdktn.listMapper(resiliencehubv2SystemTagsToTerraform, false)(this._tags.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      tags: {
        value: cdktn.listMapperHcl(resiliencehubv2SystemTagsToHclTerraform, false)(this._tags.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "Resiliencehubv2SystemTagsList",
      },
    };
