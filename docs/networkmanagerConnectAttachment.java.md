...
```java
public NetworkmanagerConnectAttachmentProposedNetworkFunctionGroupChange getInternalValue();
```
...
```java
public NetworkmanagerConnectAttachmentProposedNetworkFunctionGroupChangeTags getInternalValue();
```
...
```java
public NetworkmanagerConnectAttachmentProposedSegmentChange getInternalValue();
```
...
```java
public NetworkmanagerConnectAttachmentProposedSegmentChangeTags getInternalValue();
```
