...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iottwinmaker_sync_job
...
export class IottwinmakerSyncJob extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IottwinmakerSyncJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iottwinmaker_sync_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iottwinmaker_sync_job awscc_iottwinmaker_sync_job} Resource
  *
  * @param scope The scope in which to define this construct
