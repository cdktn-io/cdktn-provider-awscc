...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/redshift_clusters
...
export class DataAwsccRedshiftClusters extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRedshiftClusters that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/redshift_clusters#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/redshift_clusters awscc_redshift_clusters} Data Source
  *
  * @param scope The scope in which to define this construct
