...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccec2egressonlyinternetgateways"

dataawsccec2egressonlyinternetgateways.NewDataAwsccEc2EgressOnlyInternetGateways(scope Construct, id *string, config DataAwsccEc2EgressOnlyInternetGatewaysConfig) DataAwsccEc2EgressOnlyInternetGateways
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2EgressOnlyInternetGateways.DataAwsccEc2EgressOnlyInternetGateways.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
dataawsccec2egressonlyinternetgateways.DataAwsccEc2EgressOnlyInternetGateways_IsConstruct(x interface{}) *bool
```
...
dataawsccec2egressonlyinternetgateways.DataAwsccEc2EgressOnlyInternetGateways_IsTerraformElement(x interface{}) *bool
```
...
dataawsccec2egressonlyinternetgateways.DataAwsccEc2EgressOnlyInternetGateways_IsTerraformDataSource(x interface{}) *bool
```
...
dataawsccec2egressonlyinternetgateways.DataAwsccEc2EgressOnlyInternetGateways_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2EgressOnlyInternetGateways.DataAwsccEc2EgressOnlyInternetGateways.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2EgressOnlyInternetGateways.DataAwsccEc2EgressOnlyInternetGateways.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2EgressOnlyInternetGateways.DataAwsccEc2EgressOnlyInternetGateways.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2EgressOnlyInternetGateways.DataAwsccEc2EgressOnlyInternetGateways.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2EgressOnlyInternetGateways.DataAwsccEc2EgressOnlyInternetGateways.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2EgressOnlyInternetGateways.DataAwsccEc2EgressOnlyInternetGateways.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2EgressOnlyInternetGateways.DataAwsccEc2EgressOnlyInternetGateways.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2EgressOnlyInternetGateways.DataAwsccEc2EgressOnlyInternetGateways.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
...
&dataawsccec2egressonlyinternetgateways.DataAwsccEc2EgressOnlyInternetGatewaysConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2EgressOnlyInternetGateways.DataAwsccEc2EgressOnlyInternetGatewaysConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2EgressOnlyInternetGateways.DataAwsccEc2EgressOnlyInternetGatewaysConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2EgressOnlyInternetGateways.DataAwsccEc2EgressOnlyInternetGatewaysConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2EgressOnlyInternetGateways.DataAwsccEc2EgressOnlyInternetGatewaysConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2EgressOnlyInternetGateways.DataAwsccEc2EgressOnlyInternetGatewaysConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2EgressOnlyInternetGateways.DataAwsccEc2EgressOnlyInternetGatewaysConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2EgressOnlyInternetGateways.DataAwsccEc2EgressOnlyInternetGatewaysConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
