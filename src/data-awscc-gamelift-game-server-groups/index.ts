...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/gamelift_game_server_groups
...
export class DataAwsccGameliftGameServerGroups extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccGameliftGameServerGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/gamelift_game_server_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/gamelift_game_server_groups awscc_gamelift_game_server_groups} Data Source
  *
  * @param scope The scope in which to define this construct
