...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/cleanroomsml_configured_model_algorithm
...
export class DataAwsccCleanroomsmlConfiguredModelAlgorithm extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCleanroomsmlConfiguredModelAlgorithm that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/cleanroomsml_configured_model_algorithm#import import section} in the documentation of this resource for the id to use
