...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/quicksight_dlp_setting
...
export class DataAwsccQuicksightDlpSetting extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccQuicksightDlpSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/quicksight_dlp_setting#import import section} in the documentation of this resource for the id to use
