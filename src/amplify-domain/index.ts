...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/amplify_domain
...
export class AmplifyDomain extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AmplifyDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/amplify_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/amplify_domain awscc_amplify_domain} Resource
  *
  * @param scope The scope in which to define this construct
