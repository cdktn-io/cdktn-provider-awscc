...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/apigateway_usage_plan
...
export class DataAwsccApigatewayUsagePlan extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccApigatewayUsagePlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/apigateway_usage_plan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/apigateway_usage_plan awscc_apigateway_usage_plan} Data Source
  *
  * @param scope The scope in which to define this construct
