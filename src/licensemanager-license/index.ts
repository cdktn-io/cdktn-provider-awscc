...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/licensemanager_license
...
export class LicensemanagerLicense extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LicensemanagerLicense that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/licensemanager_license#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/licensemanager_license awscc_licensemanager_license} Resource
  *
  * @param scope The scope in which to define this construct
