...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/guardduty_threat_intel_set
...
export class GuarddutyThreatIntelSet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GuarddutyThreatIntelSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/guardduty_threat_intel_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/guardduty_threat_intel_set awscc_guardduty_threat_intel_set} Resource
  *
  * @param scope The scope in which to define this construct
