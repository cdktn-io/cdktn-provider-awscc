...
```typescript
import { dataAwsccLambdaFunctions } from '@cdktn/provider-awscc'

new dataAwsccLambdaFunctions.DataAwsccLambdaFunctions(scope: Construct, id: string, config?: DataAwsccLambdaFunctionsConfig)
```
...
dataAwsccLambdaFunctions.DataAwsccLambdaFunctions.isConstruct(x: any)
```
...
dataAwsccLambdaFunctions.DataAwsccLambdaFunctions.isTerraformElement(x: any)
```
...
dataAwsccLambdaFunctions.DataAwsccLambdaFunctions.isTerraformDataSource(x: any)
```
...
dataAwsccLambdaFunctions.DataAwsccLambdaFunctions.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccLambdaFunctions.DataAwsccLambdaFunctions.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccLambdaFunctions.DataAwsccLambdaFunctions.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccLambdaFunctions.DataAwsccLambdaFunctions.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLambdaFunctions.DataAwsccLambdaFunctions.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccLambdaFunctions.DataAwsccLambdaFunctions.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccLambdaFunctionsConfig: dataAwsccLambdaFunctions.DataAwsccLambdaFunctionsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccLambdaFunctions.DataAwsccLambdaFunctionsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLambdaFunctions.DataAwsccLambdaFunctionsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLambdaFunctions.DataAwsccLambdaFunctionsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccLambdaFunctions.DataAwsccLambdaFunctionsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
