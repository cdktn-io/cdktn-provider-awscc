...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/cognito_user_pool_regional_configuration_attachment
...
export interface DataAwsccCognitoUserPoolRegionalConfigurationAttachmentConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/cognito_user_pool_regional_configuration_attachment#id DataAwsccCognitoUserPoolRegionalConfigurationAttachment#id}
  *
...
export interface DataAwsccCognitoUserPoolRegionalConfigurationAttachmentSmsConfigurationEumsSms {
}

export function dataAwsccCognitoUserPoolRegionalConfigurationAttachmentSmsConfigurationEumsSmsToTerraform(struct?: DataAwsccCognitoUserPoolRegionalConfigurationAttachmentSmsConfigurationEumsSms): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsccCognitoUserPoolRegionalConfigurationAttachmentSmsConfigurationEumsSmsToHclTerraform(struct?: DataAwsccCognitoUserPoolRegionalConfigurationAttachmentSmsConfigurationEumsSms): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsccCognitoUserPoolRegionalConfigurationAttachmentSmsConfigurationEumsSmsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAwsccCognitoUserPoolRegionalConfigurationAttachmentSmsConfigurationEumsSms | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsccCognitoUserPoolRegionalConfigurationAttachmentSmsConfigurationEumsSms | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  // caller_arn - computed: true, optional: false, required: false
  ...
  // in_entity_id - computed: true, optional: false, required: false
  public get inEntityId() {
    return this.getStringAttribute('in_entity_id');
  }

  // in_template_id - computed: true, optional: false, required: false
  public get inTemplateId() {
    return this.getStringAttribute('in_template_id');
  }

  // origination_identity - computed: true, optional: false, required: false
...
export class DataAwsccCognitoUserPoolRegionalConfigurationAttachmentSmsConfigurationOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  // eums_sms - computed: true, optional: false, required: false
  private _eumsSms = new DataAwsccCognitoUserPoolRegionalConfigurationAttachmentSmsConfigurationEumsSmsOutputReference(this, "eums_sms");
  public get eumsSms() {
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/cognito_user_pool_regional_configuration_attachment awscc_cognito_user_pool_regional_configuration_attachment}
*/
export class DataAwsccCognitoUserPoolRegionalConfigurationAttachment extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCognitoUserPoolRegionalConfigurationAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/cognito_user_pool_regional_configuration_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/cognito_user_pool_regional_configuration_attachment awscc_cognito_user_pool_regional_configuration_attachment} Data Source
  *
  * @param scope The scope in which to define this construct
