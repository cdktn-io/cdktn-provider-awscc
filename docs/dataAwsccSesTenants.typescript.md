...
```typescript
import { dataAwsccSesTenants } from '@cdktn/provider-awscc'

new dataAwsccSesTenants.DataAwsccSesTenants(scope: Construct, id: string, config?: DataAwsccSesTenantsConfig)
```
...
dataAwsccSesTenants.DataAwsccSesTenants.isConstruct(x: any)
```
...
dataAwsccSesTenants.DataAwsccSesTenants.isTerraformElement(x: any)
```
...
dataAwsccSesTenants.DataAwsccSesTenants.isTerraformDataSource(x: any)
```
...
dataAwsccSesTenants.DataAwsccSesTenants.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesTenants.DataAwsccSesTenants.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesTenants.DataAwsccSesTenants.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesTenants.DataAwsccSesTenants.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesTenants.DataAwsccSesTenants.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesTenants.DataAwsccSesTenants.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccSesTenantsConfig: dataAwsccSesTenants.DataAwsccSesTenantsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesTenants.DataAwsccSesTenantsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesTenants.DataAwsccSesTenantsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesTenants.DataAwsccSesTenantsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesTenants.DataAwsccSesTenantsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
