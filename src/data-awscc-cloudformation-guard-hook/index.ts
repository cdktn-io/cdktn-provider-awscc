...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/cloudformation_guard_hook
...
export interface DataAwsccCloudformationGuardHookConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/cloudformation_guard_hook#id DataAwsccCloudformationGuardHook#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/cloudformation_guard_hook awscc_cloudformation_guard_hook}
*/
export class DataAwsccCloudformationGuardHook extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCloudformationGuardHook that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/cloudformation_guard_hook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/cloudformation_guard_hook awscc_cloudformation_guard_hook} Data Source
  *
  * @param scope The scope in which to define this construct
