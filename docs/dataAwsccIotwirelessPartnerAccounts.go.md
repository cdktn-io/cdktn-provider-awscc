...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawscciotwirelesspartneraccounts"

dataawscciotwirelesspartneraccounts.NewDataAwsccIotwirelessPartnerAccounts(scope Construct, id *string, config DataAwsccIotwirelessPartnerAccountsConfig) DataAwsccIotwirelessPartnerAccounts
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotwirelessPartnerAccounts.DataAwsccIotwirelessPartnerAccounts.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
dataawscciotwirelesspartneraccounts.DataAwsccIotwirelessPartnerAccounts_IsConstruct(x interface{}) *bool
```
...
dataawscciotwirelesspartneraccounts.DataAwsccIotwirelessPartnerAccounts_IsTerraformElement(x interface{}) *bool
```
...
dataawscciotwirelesspartneraccounts.DataAwsccIotwirelessPartnerAccounts_IsTerraformDataSource(x interface{}) *bool
```
...
dataawscciotwirelesspartneraccounts.DataAwsccIotwirelessPartnerAccounts_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotwirelessPartnerAccounts.DataAwsccIotwirelessPartnerAccounts.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotwirelessPartnerAccounts.DataAwsccIotwirelessPartnerAccounts.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotwirelessPartnerAccounts.DataAwsccIotwirelessPartnerAccounts.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotwirelessPartnerAccounts.DataAwsccIotwirelessPartnerAccounts.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotwirelessPartnerAccounts.DataAwsccIotwirelessPartnerAccounts.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotwirelessPartnerAccounts.DataAwsccIotwirelessPartnerAccounts.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotwirelessPartnerAccounts.DataAwsccIotwirelessPartnerAccounts.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotwirelessPartnerAccounts.DataAwsccIotwirelessPartnerAccounts.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
...
&dataawscciotwirelesspartneraccounts.DataAwsccIotwirelessPartnerAccountsConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotwirelessPartnerAccounts.DataAwsccIotwirelessPartnerAccountsConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotwirelessPartnerAccounts.DataAwsccIotwirelessPartnerAccountsConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotwirelessPartnerAccounts.DataAwsccIotwirelessPartnerAccountsConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotwirelessPartnerAccounts.DataAwsccIotwirelessPartnerAccountsConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotwirelessPartnerAccounts.DataAwsccIotwirelessPartnerAccountsConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotwirelessPartnerAccounts.DataAwsccIotwirelessPartnerAccountsConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIotwirelessPartnerAccounts.DataAwsccIotwirelessPartnerAccountsConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
