...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/bedrock_intelligent_prompt_router
...
export class DataAwsccBedrockIntelligentPromptRouter extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccBedrockIntelligentPromptRouter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/bedrock_intelligent_prompt_router#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/bedrock_intelligent_prompt_router awscc_bedrock_intelligent_prompt_router} Data Source
  *
  * @param scope The scope in which to define this construct
