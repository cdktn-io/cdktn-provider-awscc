...
new DataAwsccSecurityhubDelegatedAdmin(Construct Scope, string Id, DataAwsccSecurityhubDelegatedAdminConfig Config);
```
...
DataAwsccSecurityhubDelegatedAdmin.IsConstruct(object X);
```
...
DataAwsccSecurityhubDelegatedAdmin.IsTerraformElement(object X);
```
...
DataAwsccSecurityhubDelegatedAdmin.IsTerraformDataSource(object X);
```
...
DataAwsccSecurityhubDelegatedAdmin.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubDelegatedAdmin.DataAwsccSecurityhubDelegatedAdmin.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubDelegatedAdmin.DataAwsccSecurityhubDelegatedAdmin.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubDelegatedAdmin.DataAwsccSecurityhubDelegatedAdmin.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubDelegatedAdmin.DataAwsccSecurityhubDelegatedAdmin.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubDelegatedAdmin.DataAwsccSecurityhubDelegatedAdmin.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubDelegatedAdmin.DataAwsccSecurityhubDelegatedAdmin.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubDelegatedAdmin.DataAwsccSecurityhubDelegatedAdmin.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
...
```csharp
public string DelegatedAdminIdentifier { get; }
```
...
new DataAwsccSecurityhubDelegatedAdminConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubDelegatedAdmin.DataAwsccSecurityhubDelegatedAdminConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubDelegatedAdmin.DataAwsccSecurityhubDelegatedAdminConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubDelegatedAdmin.DataAwsccSecurityhubDelegatedAdminConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubDelegatedAdmin.DataAwsccSecurityhubDelegatedAdminConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubDelegatedAdmin.DataAwsccSecurityhubDelegatedAdminConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubDelegatedAdmin.DataAwsccSecurityhubDelegatedAdminConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubDelegatedAdmin.DataAwsccSecurityhubDelegatedAdminConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
