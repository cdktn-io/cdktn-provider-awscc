...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/eventschemasdiscoverer"

eventschemasdiscoverer.NewEventschemasDiscoverer(scope Construct, id *string, config EventschemasDiscovererConfig) EventschemasDiscoverer
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscoverer.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
eventschemasdiscoverer.EventschemasDiscoverer_IsConstruct(x interface{}) *bool
```
...
eventschemasdiscoverer.EventschemasDiscoverer_IsTerraformElement(x interface{}) *bool
```
...
eventschemasdiscoverer.EventschemasDiscoverer_IsTerraformResource(x interface{}) *bool
```
...
eventschemasdiscoverer.EventschemasDiscoverer_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscoverer.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscoverer.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscoverer.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscoverer.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscoverer.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscoverer.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscoverer.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscoverer.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscoverer.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscoverer.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscoverer.property.crossAccountInput">CrossAccountInput</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscoverer.property.tagsInput">TagsInput</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscoverer.property.crossAccount">CrossAccount</a></code> | <code>interface{}</code> | *No description.* |
...
```go
func Tags() EventschemasDiscovererTagsList
```
...
```go
func CrossAccountInput() interface{}
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscovererConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscovererConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscovererConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscovererConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscovererConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscovererConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscovererConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscovererConfig.property.crossAccount">CrossAccount</a></code> | <code>interface{}</code> | Defines whether event schemas from other accounts are discovered. Default is True. |
...
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscovererConfig.property.tags">Tags</a></code> | <code>interface{}</code> | Tags associated with the resource. |
...
eventschemasdiscoverer.NewEventschemasDiscovererTagsList(terraformResource IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EventschemasDiscovererTagsList
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscovererTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.IInterpolatingParent</code> | The parent resource. |
...
```go
func Get(index *f64) EventschemasDiscovererTagsOutputReference
```
...
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscovererTagsList.property.internalValue">InternalValue</a></code> | <code>interface{}</code> | *No description.* |
...
eventschemasdiscoverer.NewEventschemasDiscovererTagsOutputReference(terraformResource IInterpolatingParent, terraformAttribute *string, complexObjectIndex *f64, complexObjectIsFromSet *bool) EventschemasDiscovererTagsOutputReference
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscovererTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscovererTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>*f64</code> | the index of this item in the list. |
...
| <code><a href="#@cdktn/provider-awscc.eventschemasDiscoverer.EventschemasDiscovererTagsOutputReference.property.internalValue">InternalValue</a></code> | <code>interface{}</code> | *No description.* |
