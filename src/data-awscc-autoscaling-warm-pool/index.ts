...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/autoscaling_warm_pool
...
export class DataAwsccAutoscalingWarmPool extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccAutoscalingWarmPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/autoscaling_warm_pool#import import section} in the documentation of this resource for the id to use
