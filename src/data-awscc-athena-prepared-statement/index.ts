...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/athena_prepared_statement
...
export interface DataAwsccAthenaPreparedStatementConfig extends cdktn.TerraformMetaArguments {
  /**
  * Uniquely identifies the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/athena_prepared_statement#id DataAwsccAthenaPreparedStatement#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/athena_prepared_statement awscc_athena_prepared_statement}
*/
export class DataAwsccAthenaPreparedStatement extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccAthenaPreparedStatement that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/athena_prepared_statement#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/athena_prepared_statement awscc_athena_prepared_statement} Data Source
  *
  * @param scope The scope in which to define this construct
