...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/resourceexplorer2_view
...
export class Resourceexplorer2View extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Resourceexplorer2View that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/resourceexplorer2_view#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/resourceexplorer2_view awscc_resourceexplorer2_view} Resource
  *
  * @param scope The scope in which to define this construct
