...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ec2_route_table
...
export class Ec2RouteTable extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2RouteTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ec2_route_table#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ec2_route_table awscc_ec2_route_table} Resource
  *
  * @param scope The scope in which to define this construct
