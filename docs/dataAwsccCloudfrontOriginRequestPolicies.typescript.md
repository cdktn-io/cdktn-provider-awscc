...
```typescript
import { dataAwsccCloudfrontOriginRequestPolicies } from '@cdktn/provider-awscc'

new dataAwsccCloudfrontOriginRequestPolicies.DataAwsccCloudfrontOriginRequestPolicies(scope: Construct, id: string, config?: DataAwsccCloudfrontOriginRequestPoliciesConfig)
```
...
dataAwsccCloudfrontOriginRequestPolicies.DataAwsccCloudfrontOriginRequestPolicies.isConstruct(x: any)
```
...
dataAwsccCloudfrontOriginRequestPolicies.DataAwsccCloudfrontOriginRequestPolicies.isTerraformElement(x: any)
```
...
dataAwsccCloudfrontOriginRequestPolicies.DataAwsccCloudfrontOriginRequestPolicies.isTerraformDataSource(x: any)
```
...
dataAwsccCloudfrontOriginRequestPolicies.DataAwsccCloudfrontOriginRequestPolicies.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudfrontOriginRequestPolicies.DataAwsccCloudfrontOriginRequestPolicies.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudfrontOriginRequestPolicies.DataAwsccCloudfrontOriginRequestPolicies.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudfrontOriginRequestPolicies.DataAwsccCloudfrontOriginRequestPolicies.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudfrontOriginRequestPolicies.DataAwsccCloudfrontOriginRequestPolicies.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudfrontOriginRequestPolicies.DataAwsccCloudfrontOriginRequestPolicies.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccCloudfrontOriginRequestPoliciesConfig: dataAwsccCloudfrontOriginRequestPolicies.DataAwsccCloudfrontOriginRequestPoliciesConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudfrontOriginRequestPolicies.DataAwsccCloudfrontOriginRequestPoliciesConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudfrontOriginRequestPolicies.DataAwsccCloudfrontOriginRequestPoliciesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudfrontOriginRequestPolicies.DataAwsccCloudfrontOriginRequestPoliciesConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudfrontOriginRequestPolicies.DataAwsccCloudfrontOriginRequestPoliciesConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
