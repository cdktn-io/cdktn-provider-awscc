...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/cleanrooms_privacy_budget_template
...
export interface DataAwsccCleanroomsPrivacyBudgetTemplateConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/cleanrooms_privacy_budget_template#id DataAwsccCleanroomsPrivacyBudgetTemplate#id}
  *
...
export class DataAwsccCleanroomsPrivacyBudgetTemplate extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCleanroomsPrivacyBudgetTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/cleanrooms_privacy_budget_template#import import section} in the documentation of this resource for the id to use
