...
export interface CloudfrontConnectionGroupTags {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/cloudfront_connection_group#key CloudfrontConnectionGroup#key}
  */
  readonly key?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/cloudfront_connection_group#value CloudfrontConnectionGroup#value}
  */
...
export class CloudfrontConnectionGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudfrontConnectionGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/cloudfront_connection_group#import import section} in the documentation of this resource for the id to use
