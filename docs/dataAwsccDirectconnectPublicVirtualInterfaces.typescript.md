...
```typescript
import { dataAwsccDirectconnectPublicVirtualInterfaces } from '@cdktn/provider-awscc'

new dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfaces(scope: Construct, id: string, config?: DataAwsccDirectconnectPublicVirtualInterfacesConfig)
```
...
dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfaces.isConstruct(x: any)
```
...
dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfaces.isTerraformElement(x: any)
```
...
dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfaces.isTerraformDataSource(x: any)
```
...
dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfaces.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfaces.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfaces.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfaces.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfaces.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfaces.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccDirectconnectPublicVirtualInterfacesConfig: dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfacesConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfacesConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfacesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfacesConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDirectconnectPublicVirtualInterfaces.DataAwsccDirectconnectPublicVirtualInterfacesConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
