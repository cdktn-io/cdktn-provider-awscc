...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/xray_sampling_rule
...
export class DataAwsccXraySamplingRule extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccXraySamplingRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/xray_sampling_rule#import import section} in the documentation of this resource for the id to use
