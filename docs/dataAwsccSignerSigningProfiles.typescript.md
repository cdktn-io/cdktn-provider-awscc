...
```typescript
import { dataAwsccSignerSigningProfiles } from '@cdktn/provider-awscc'

new dataAwsccSignerSigningProfiles.DataAwsccSignerSigningProfiles(scope: Construct, id: string, config?: DataAwsccSignerSigningProfilesConfig)
```
...
dataAwsccSignerSigningProfiles.DataAwsccSignerSigningProfiles.isConstruct(x: any)
```
...
dataAwsccSignerSigningProfiles.DataAwsccSignerSigningProfiles.isTerraformElement(x: any)
```
...
dataAwsccSignerSigningProfiles.DataAwsccSignerSigningProfiles.isTerraformDataSource(x: any)
```
...
dataAwsccSignerSigningProfiles.DataAwsccSignerSigningProfiles.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSignerSigningProfiles.DataAwsccSignerSigningProfiles.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSignerSigningProfiles.DataAwsccSignerSigningProfiles.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSignerSigningProfiles.DataAwsccSignerSigningProfiles.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSignerSigningProfiles.DataAwsccSignerSigningProfiles.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSignerSigningProfiles.DataAwsccSignerSigningProfiles.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccSignerSigningProfilesConfig: dataAwsccSignerSigningProfiles.DataAwsccSignerSigningProfilesConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSignerSigningProfiles.DataAwsccSignerSigningProfilesConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSignerSigningProfiles.DataAwsccSignerSigningProfilesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSignerSigningProfiles.DataAwsccSignerSigningProfilesConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSignerSigningProfiles.DataAwsccSignerSigningProfilesConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
