...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/braket_spending_limit
...
export class BraketSpendingLimit extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BraketSpendingLimit that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/braket_spending_limit#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/braket_spending_limit awscc_braket_spending_limit} Resource
  *
  * @param scope The scope in which to define this construct
