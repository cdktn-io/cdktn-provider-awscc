...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/glue_schema_version_metadata
...
export class DataAwsccGlueSchemaVersionMetadata extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccGlueSchemaVersionMetadata that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/glue_schema_version_metadata#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/glue_schema_version_metadata awscc_glue_schema_version_metadata} Data Source
  *
  * @param scope The scope in which to define this construct
