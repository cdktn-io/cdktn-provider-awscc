...
```typescript
import { dataAwsccGroundstationDataflowEndpointGroupV2S } from '@cdktn/provider-awscc'

new dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2S(scope: Construct, id: string, config?: DataAwsccGroundstationDataflowEndpointGroupV2SConfig)
```
...
dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2S.isConstruct(x: any)
```
...
dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2S.isTerraformElement(x: any)
```
...
dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2S.isTerraformDataSource(x: any)
```
...
dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2S.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2S.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2S.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2S.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2S.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2S.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2S.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2S.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
...
const dataAwsccGroundstationDataflowEndpointGroupV2SConfig: dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2SConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2SConfig.property.connection">connection</a></code> | <code>cdktn.SSHProvisionerConnection \| cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2SConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2SConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2SConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2SConfig.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2SConfig.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGroundstationDataflowEndpointGroupV2S.DataAwsccGroundstationDataflowEndpointGroupV2SConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
