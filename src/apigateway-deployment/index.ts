...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/apigateway_deployment
...
export class ApigatewayDeployment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApigatewayDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/apigateway_deployment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/apigateway_deployment awscc_apigateway_deployment} Resource
  *
  * @param scope The scope in which to define this construct
