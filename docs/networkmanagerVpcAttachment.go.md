...
```go
func InternalValue() NetworkmanagerVpcAttachmentProposedNetworkFunctionGroupChange
```
...
```go
func InternalValue() NetworkmanagerVpcAttachmentProposedNetworkFunctionGroupChangeTags
```
...
```go
func InternalValue() NetworkmanagerVpcAttachmentProposedSegmentChange
```
...
```go
func InternalValue() NetworkmanagerVpcAttachmentProposedSegmentChangeTags
```
