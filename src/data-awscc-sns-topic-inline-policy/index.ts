...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/sns_topic_inline_policy
...
export class DataAwsccSnsTopicInlinePolicy extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccSnsTopicInlinePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/sns_topic_inline_policy#import import section} in the documentation of this resource for the id to use
