...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/lambda_layer_version
...
export class LambdaLayerVersion extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LambdaLayerVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/lambda_layer_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/lambda_layer_version awscc_lambda_layer_version} Resource
  *
  * @param scope The scope in which to define this construct
