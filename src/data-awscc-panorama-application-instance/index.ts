...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/panorama_application_instance
...
export class DataAwsccPanoramaApplicationInstance extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccPanoramaApplicationInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/panorama_application_instance#import import section} in the documentation of this resource for the id to use
