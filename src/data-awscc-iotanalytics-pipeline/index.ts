...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/iotanalytics_pipeline
...
export class DataAwsccIotanalyticsPipeline extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIotanalyticsPipeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/iotanalytics_pipeline#import import section} in the documentation of this resource for the id to use
