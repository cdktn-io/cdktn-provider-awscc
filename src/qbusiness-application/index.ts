...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/qbusiness_application
...
export class QbusinessApplication extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing QbusinessApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/qbusiness_application#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/qbusiness_application awscc_qbusiness_application} Resource
  *
  * @param scope The scope in which to define this construct
