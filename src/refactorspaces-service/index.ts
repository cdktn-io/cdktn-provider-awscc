...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/refactorspaces_service
...
export class RefactorspacesService extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RefactorspacesService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/refactorspaces_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/refactorspaces_service awscc_refactorspaces_service} Resource
  *
  * @param scope The scope in which to define this construct
