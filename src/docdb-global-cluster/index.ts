...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/docdb_global_cluster
...
export class DocdbGlobalCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DocdbGlobalCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/docdb_global_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/docdb_global_cluster awscc_docdb_global_cluster} Resource
  *
  * @param scope The scope in which to define this construct
