...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/datasync_location_hdfs
...
export class DataAwsccDatasyncLocationHdfs extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDatasyncLocationHdfs that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/datasync_location_hdfs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/datasync_location_hdfs awscc_datasync_location_hdfs} Data Source
  *
  * @param scope The scope in which to define this construct
