...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/connect_contact_flow
...
export class ConnectContactFlow extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectContactFlow that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/connect_contact_flow#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/connect_contact_flow awscc_connect_contact_flow} Resource
  *
  * @param scope The scope in which to define this construct
