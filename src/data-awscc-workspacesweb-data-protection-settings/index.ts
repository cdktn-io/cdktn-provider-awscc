...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/workspacesweb_data_protection_settings
...
export class DataAwsccWorkspaceswebDataProtectionSettings extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccWorkspaceswebDataProtectionSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/workspacesweb_data_protection_settings#import import section} in the documentation of this resource for the id to use
