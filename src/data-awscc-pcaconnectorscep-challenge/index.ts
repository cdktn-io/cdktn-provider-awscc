...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/pcaconnectorscep_challenge
...
export class DataAwsccPcaconnectorscepChallenge extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccPcaconnectorscepChallenge that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/pcaconnectorscep_challenge#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/pcaconnectorscep_challenge awscc_pcaconnectorscep_challenge} Data Source
  *
  * @param scope The scope in which to define this construct
