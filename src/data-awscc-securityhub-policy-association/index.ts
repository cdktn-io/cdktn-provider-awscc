...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/securityhub_policy_association
...
export interface DataAwsccSecurityhubPolicyAssociationConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataAwsccSecurityhubPolicyAssociation extends cdktn.TerraformDataSource {
  ...
  * @param importToId The construct id used in the generated config for the DataAwsccSecurityhubPolicyAssociation to import
  * @param importFromId The id of the existing DataAwsccSecurityhubPolicyAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/securityhub_policy_association#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAwsccSecurityhubPolicyAssociation to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/securityhub_policy_association awscc_securityhub_policy_association} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataAwsccSecurityhubPolicyAssociationConfig
  */
  public constructor(scope: Construct, id: string, config: DataAwsccSecurityhubPolicyAssociationConfig) {
    super(scope, id, {
