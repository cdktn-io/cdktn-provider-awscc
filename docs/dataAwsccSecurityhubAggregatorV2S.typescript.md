...
```typescript
import { dataAwsccSecurityhubAggregatorV2S } from '@cdktn/provider-awscc'

new dataAwsccSecurityhubAggregatorV2S.DataAwsccSecurityhubAggregatorV2S(scope: Construct, id: string, config?: DataAwsccSecurityhubAggregatorV2SConfig)
```
...
dataAwsccSecurityhubAggregatorV2S.DataAwsccSecurityhubAggregatorV2S.isConstruct(x: any)
```
...
dataAwsccSecurityhubAggregatorV2S.DataAwsccSecurityhubAggregatorV2S.isTerraformElement(x: any)
```
...
dataAwsccSecurityhubAggregatorV2S.DataAwsccSecurityhubAggregatorV2S.isTerraformDataSource(x: any)
```
...
dataAwsccSecurityhubAggregatorV2S.DataAwsccSecurityhubAggregatorV2S.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAggregatorV2S.DataAwsccSecurityhubAggregatorV2S.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAggregatorV2S.DataAwsccSecurityhubAggregatorV2S.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAggregatorV2S.DataAwsccSecurityhubAggregatorV2S.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAggregatorV2S.DataAwsccSecurityhubAggregatorV2S.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAggregatorV2S.DataAwsccSecurityhubAggregatorV2S.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccSecurityhubAggregatorV2SConfig: dataAwsccSecurityhubAggregatorV2S.DataAwsccSecurityhubAggregatorV2SConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAggregatorV2S.DataAwsccSecurityhubAggregatorV2SConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAggregatorV2S.DataAwsccSecurityhubAggregatorV2SConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAggregatorV2S.DataAwsccSecurityhubAggregatorV2SConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAggregatorV2S.DataAwsccSecurityhubAggregatorV2SConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
