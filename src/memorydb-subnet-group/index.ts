...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/memorydb_subnet_group
...
export class MemorydbSubnetGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MemorydbSubnetGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/memorydb_subnet_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/memorydb_subnet_group awscc_memorydb_subnet_group} Resource
  *
  * @param scope The scope in which to define this construct
