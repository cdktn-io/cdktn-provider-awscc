...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/drs_launch_configuration_template
...
export class DataAwsccDrsLaunchConfigurationTemplate extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDrsLaunchConfigurationTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/drs_launch_configuration_template#import import section} in the documentation of this resource for the id to use
