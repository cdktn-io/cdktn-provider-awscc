...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/databrew_job
...
export class DatabrewJob extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DatabrewJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/databrew_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/databrew_job awscc_databrew_job} Resource
  *
  * @param scope The scope in which to define this construct
