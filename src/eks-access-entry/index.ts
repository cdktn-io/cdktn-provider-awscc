...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/eks_access_entry
...
export interface EksAccessEntryConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/eks_access_entry#access_policies EksAccessEntry#access_policies}
  */
  readonly accessPolicies?: EksAccessEntryAccessPolicies[] | cdktn.IResolvable;
  /**
  * The cluster that the access entry is created for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/eks_access_entry#cluster_name EksAccessEntry#cluster_name}
  */
  readonly clusterName: string;
  /**
  * The Kubernetes groups that the access entry is associated with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/eks_access_entry#kubernetes_groups EksAccessEntry#kubernetes_groups}
  */
  readonly kubernetesGroups?: string[];
  /**
  * The principal ARN that the access entry is created for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/eks_access_entry#principal_arn EksAccessEntry#principal_arn}
  */
  readonly principalArn: string;
  /**
  * An array of key-value pairs to apply to this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/eks_access_entry#tags EksAccessEntry#tags}
  */
  readonly tags?: EksAccessEntryTags[] | cdktn.IResolvable;
  /**
  * The node type to associate with the access entry.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/eks_access_entry#type EksAccessEntry#type}
  */
  readonly type?: string;
  /**
  * The Kubernetes user that the access entry is associated with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/eks_access_entry#username EksAccessEntry#username}
  */
...
export interface EksAccessEntryAccessPoliciesAccessScope {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/eks_access_entry#namespaces EksAccessEntry#namespaces}
  */
...
export interface EksAccessEntryTags {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/eks_access_entry#key EksAccessEntry#key}
  */
  readonly key?: string;
  /**
  * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/eks_access_entry#value EksAccessEntry#value}
  */
...
export class EksAccessEntry extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EksAccessEntry that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/eks_access_entry#import import section} in the documentation of this resource for the id to use
