...
export class QbusinessRetriever extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing QbusinessRetriever that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/qbusiness_retriever#import import section} in the documentation of this resource for the id to use
