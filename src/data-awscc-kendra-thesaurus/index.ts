...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/kendra_thesaurus
...
export class DataAwsccKendraThesaurus extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccKendraThesaurus that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/kendra_thesaurus#import import section} in the documentation of this resource for the id to use
