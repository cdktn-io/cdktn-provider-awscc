...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/personalize_event_tracker
...
export class PersonalizeEventTracker extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PersonalizeEventTracker that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/personalize_event_tracker#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/personalize_event_tracker awscc_personalize_event_tracker} Resource
  *
  * @param scope The scope in which to define this construct
