...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/connect_phone_number
...
export class ConnectPhoneNumber extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectPhoneNumber that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/connect_phone_number#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/connect_phone_number awscc_connect_phone_number} Resource
  *
  * @param scope The scope in which to define this construct
