...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/elementalinference_dictionary
...
export class DataAwsccElementalinferenceDictionary extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccElementalinferenceDictionary that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/elementalinference_dictionary#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/elementalinference_dictionary awscc_elementalinference_dictionary} Data Source
  *
  * @param scope The scope in which to define this construct
