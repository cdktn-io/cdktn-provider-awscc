...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/appstream_directory_config
...
export class DataAwsccAppstreamDirectoryConfig extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccAppstreamDirectoryConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/appstream_directory_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/appstream_directory_config awscc_appstream_directory_config} Data Source
  *
  * @param scope The scope in which to define this construct
