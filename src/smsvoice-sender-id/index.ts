...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/smsvoice_sender_id
...
export class SmsvoiceSenderId extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SmsvoiceSenderId that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/smsvoice_sender_id#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/smsvoice_sender_id awscc_smsvoice_sender_id} Resource
  *
  * @param scope The scope in which to define this construct
