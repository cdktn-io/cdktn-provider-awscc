...
```typescript
import { dataAwsccEc2FpgaImage } from '@cdktn/provider-awscc'

new dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImage(scope: Construct, id: string, config: DataAwsccEc2FpgaImageConfig)
```
...
dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImage.isConstruct(x: any)
```
...
dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImage.isTerraformElement(x: any)
```
...
dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImage.isTerraformDataSource(x: any)
```
...
dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImage.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImage.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImage.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImage.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImage.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImage.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImage.property.dataRetentionSupport">dataRetentionSupport</a></code> | <code>cdktn.IResolvable</code> | *No description.* |
...
```typescript
public readonly inputStorageLocation: DataAwsccEc2FpgaImageInputStorageLocationOutputReference;
```
...
```typescript
public readonly logsStorageLocation: DataAwsccEc2FpgaImageLogsStorageLocationOutputReference;
```
...
```typescript
public readonly tags: DataAwsccEc2FpgaImageTagsList;
```
...
const dataAwsccEc2FpgaImageConfig: dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImageConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImageConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImageConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImageConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImageConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const dataAwsccEc2FpgaImageInputStorageLocation: dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImageInputStorageLocation = { ... }
```
...
const dataAwsccEc2FpgaImageLogsStorageLocation: dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImageLogsStorageLocation = { ... }
```
...
const dataAwsccEc2FpgaImageTags: dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImageTags = { ... }
```
...
new dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImageInputStorageLocationOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImageInputStorageLocationOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public readonly internalValue: DataAwsccEc2FpgaImageInputStorageLocation;
```
...
new dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImageLogsStorageLocationOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImageLogsStorageLocationOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public readonly internalValue: DataAwsccEc2FpgaImageLogsStorageLocation;
```
...
new dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImageTagsList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImageTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImageTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
new dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImageTagsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImageTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImageTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2FpgaImage.DataAwsccEc2FpgaImageTagsOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```typescript
public readonly internalValue: DataAwsccEc2FpgaImageTags;
```
