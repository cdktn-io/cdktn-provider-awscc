...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/omics_annotation_store
...
export class OmicsAnnotationStore extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OmicsAnnotationStore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/omics_annotation_store#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/omics_annotation_store awscc_omics_annotation_store} Resource
  *
  * @param scope The scope in which to define this construct
