...
new DataAwsccCognitoUserPoolUiCustomizationAttachment(Construct Scope, string Id, DataAwsccCognitoUserPoolUiCustomizationAttachmentConfig Config);
```
...
DataAwsccCognitoUserPoolUiCustomizationAttachment.IsConstruct(object X);
```
...
DataAwsccCognitoUserPoolUiCustomizationAttachment.IsTerraformElement(object X);
```
...
DataAwsccCognitoUserPoolUiCustomizationAttachment.IsTerraformDataSource(object X);
```
...
DataAwsccCognitoUserPoolUiCustomizationAttachment.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCognitoUserPoolUiCustomizationAttachment.DataAwsccCognitoUserPoolUiCustomizationAttachment.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCognitoUserPoolUiCustomizationAttachment.DataAwsccCognitoUserPoolUiCustomizationAttachment.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCognitoUserPoolUiCustomizationAttachment.DataAwsccCognitoUserPoolUiCustomizationAttachment.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCognitoUserPoolUiCustomizationAttachment.DataAwsccCognitoUserPoolUiCustomizationAttachment.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCognitoUserPoolUiCustomizationAttachment.DataAwsccCognitoUserPoolUiCustomizationAttachment.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCognitoUserPoolUiCustomizationAttachment.DataAwsccCognitoUserPoolUiCustomizationAttachment.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCognitoUserPoolUiCustomizationAttachment.DataAwsccCognitoUserPoolUiCustomizationAttachment.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
...
new DataAwsccCognitoUserPoolUiCustomizationAttachmentConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCognitoUserPoolUiCustomizationAttachment.DataAwsccCognitoUserPoolUiCustomizationAttachmentConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCognitoUserPoolUiCustomizationAttachment.DataAwsccCognitoUserPoolUiCustomizationAttachmentConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCognitoUserPoolUiCustomizationAttachment.DataAwsccCognitoUserPoolUiCustomizationAttachmentConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCognitoUserPoolUiCustomizationAttachment.DataAwsccCognitoUserPoolUiCustomizationAttachmentConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCognitoUserPoolUiCustomizationAttachment.DataAwsccCognitoUserPoolUiCustomizationAttachmentConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCognitoUserPoolUiCustomizationAttachment.DataAwsccCognitoUserPoolUiCustomizationAttachmentConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCognitoUserPoolUiCustomizationAttachment.DataAwsccCognitoUserPoolUiCustomizationAttachmentConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
