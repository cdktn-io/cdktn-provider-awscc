...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_user_profile
...
export function sagemakerUserProfileUserSettingsJupyterLabAppSettingsEmrSettingsToTerraform(struct?: SagemakerUserProfileUserSettingsJupyterLabAppSettingsEmrSettings | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function sagemakerUserProfileUserSettingsJupyterLabAppSettingsEmrSettingsToHclTerraform(struct?: SagemakerUserProfileUserSettingsJupyterLabAppSettingsEmrSettings | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class SagemakerUserProfileUserSettingsJupyterLabAppSettingsEmrSettingsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SagemakerUserProfileUserSettingsJupyterLabAppSettingsEmrSettings | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: SagemakerUserProfileUserSettingsJupyterLabAppSettingsEmrSettings | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export function sagemakerUserProfileUserSettingsJupyterLabAppSettingsToHclTerraform(struct?: SagemakerUserProfileUserSettingsJupyterLabAppSettings | cdktn.IResolvable): any {
  ...
  const attrs = {
    ...
    emr_settings: {
      ...
      isBlock: true,
      type: "struct",
      storageClassType: "SagemakerUserProfileUserSettingsJupyterLabAppSettingsEmrSettings",
    },
    lifecycle_config_arns: {
      value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(struct!.lifecycleConfigArns),
      isBlock: false,
...
export class SagemakerUserProfile extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SagemakerUserProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_user_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_user_profile awscc_sagemaker_user_profile} Resource
  *
  * @param scope The scope in which to define this construct
