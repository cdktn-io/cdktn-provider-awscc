...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/msk_vpc_connection
...
export class DataAwsccMskVpcConnection extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccMskVpcConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/msk_vpc_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/msk_vpc_connection awscc_msk_vpc_connection} Data Source
  *
  * @param scope The scope in which to define this construct
