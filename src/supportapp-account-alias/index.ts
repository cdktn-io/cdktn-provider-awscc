...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/supportapp_account_alias
...
export class SupportappAccountAlias extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SupportappAccountAlias that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/supportapp_account_alias#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/supportapp_account_alias awscc_supportapp_account_alias} Resource
  *
  * @param scope The scope in which to define this construct
