...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/macie_session
...
export class MacieSession extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MacieSession that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/macie_session#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/macie_session awscc_macie_session} Resource
  *
  * @param scope The scope in which to define this construct
