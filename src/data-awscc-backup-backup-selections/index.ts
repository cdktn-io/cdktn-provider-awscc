...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/backup_backup_selections
...
export class DataAwsccBackupBackupSelections extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccBackupBackupSelections that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/backup_backup_selections#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/backup_backup_selections awscc_backup_backup_selections} Data Source
  *
  * @param scope The scope in which to define this construct
