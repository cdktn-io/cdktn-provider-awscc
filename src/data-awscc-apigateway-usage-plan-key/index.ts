...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/apigateway_usage_plan_key
...
export class DataAwsccApigatewayUsagePlanKey extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccApigatewayUsagePlanKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/apigateway_usage_plan_key#import import section} in the documentation of this resource for the id to use
