...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/connect_queue
...
export class DataAwsccConnectQueue extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccConnectQueue that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/connect_queue#import import section} in the documentation of this resource for the id to use
