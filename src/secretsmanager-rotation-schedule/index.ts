...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/secretsmanager_rotation_schedule
...
export class SecretsmanagerRotationSchedule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretsmanagerRotationSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/secretsmanager_rotation_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/secretsmanager_rotation_schedule awscc_secretsmanager_rotation_schedule} Resource
  *
  * @param scope The scope in which to define this construct
