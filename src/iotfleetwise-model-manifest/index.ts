...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/iotfleetwise_model_manifest
...
export class IotfleetwiseModelManifest extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotfleetwiseModelManifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/iotfleetwise_model_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/iotfleetwise_model_manifest awscc_iotfleetwise_model_manifest} Resource
  *
  * @param scope The scope in which to define this construct
