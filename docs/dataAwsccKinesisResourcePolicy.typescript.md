...
```typescript
import { dataAwsccKinesisResourcePolicy } from '@cdktn/provider-awscc'

new dataAwsccKinesisResourcePolicy.DataAwsccKinesisResourcePolicy(scope: Construct, id: string, config: DataAwsccKinesisResourcePolicyConfig)
```
...
dataAwsccKinesisResourcePolicy.DataAwsccKinesisResourcePolicy.isConstruct(x: any)
```
...
dataAwsccKinesisResourcePolicy.DataAwsccKinesisResourcePolicy.isTerraformElement(x: any)
```
...
dataAwsccKinesisResourcePolicy.DataAwsccKinesisResourcePolicy.isTerraformDataSource(x: any)
```
...
dataAwsccKinesisResourcePolicy.DataAwsccKinesisResourcePolicy.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccKinesisResourcePolicy.DataAwsccKinesisResourcePolicy.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccKinesisResourcePolicy.DataAwsccKinesisResourcePolicy.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccKinesisResourcePolicy.DataAwsccKinesisResourcePolicy.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKinesisResourcePolicy.DataAwsccKinesisResourcePolicy.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccKinesisResourcePolicy.DataAwsccKinesisResourcePolicy.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccKinesisResourcePolicyConfig: dataAwsccKinesisResourcePolicy.DataAwsccKinesisResourcePolicyConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccKinesisResourcePolicy.DataAwsccKinesisResourcePolicyConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKinesisResourcePolicy.DataAwsccKinesisResourcePolicyConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKinesisResourcePolicy.DataAwsccKinesisResourcePolicyConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccKinesisResourcePolicy.DataAwsccKinesisResourcePolicyConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
