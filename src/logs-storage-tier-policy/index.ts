...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_storage_tier_policy
...
export class LogsStorageTierPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LogsStorageTierPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_storage_tier_policy#import import section} in the documentation of this resource for the id to use
