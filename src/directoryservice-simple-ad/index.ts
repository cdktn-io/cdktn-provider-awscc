...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/directoryservice_simple_ad
...
export interface DirectoryserviceSimpleAdConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/directoryservice_simple_ad#create_alias DirectoryserviceSimpleAd#create_alias}
  */
  readonly createAlias?: boolean | cdktn.IResolvable;
  /**
  * Description for the directory.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/directoryservice_simple_ad#description DirectoryserviceSimpleAd#description}
  */
  readonly description?: string;
  /**
  * Whether to enable single sign-on for a Simple Active Directory in AWS.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/directoryservice_simple_ad#enable_sso DirectoryserviceSimpleAd#enable_sso}
  */
  readonly enableSso?: boolean | cdktn.IResolvable;
  /**
  * The fully qualified domain name for the AWS Managed Simple AD directory.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/directoryservice_simple_ad#name DirectoryserviceSimpleAd#name}
  */
  readonly name: string;
  /**
  * The password for the default administrative user named Admin.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/directoryservice_simple_ad#password DirectoryserviceSimpleAd#password}
  */
  readonly password?: string;
  /**
  * The NetBIOS name for your domain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/directoryservice_simple_ad#short_name DirectoryserviceSimpleAd#short_name}
  */
  readonly shortName?: string;
  /**
  * The size of the directory.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/directoryservice_simple_ad#size DirectoryserviceSimpleAd#size}
  */
  readonly size: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/directoryservice_simple_ad#tags DirectoryserviceSimpleAd#tags}
  */
  readonly tags?: DirectoryserviceSimpleAdTags[] | cdktn.IResolvable;
  /**
  * VPC settings of the Simple AD directory server in AWS.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/directoryservice_simple_ad#vpc_settings DirectoryserviceSimpleAd#vpc_settings}
  */
...
export interface DirectoryserviceSimpleAdVpcSettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/directoryservice_simple_ad#subnet_ids DirectoryserviceSimpleAd#subnet_ids}
  */
  readonly subnetIds: string[];
  /**
  * The identifier of the VPC in which to create the directory.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/directoryservice_simple_ad#vpc_id DirectoryserviceSimpleAd#vpc_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/directoryservice_simple_ad awscc_directoryservice_simple_ad}
*/
export class DirectoryserviceSimpleAd extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DirectoryserviceSimpleAd that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/directoryservice_simple_ad#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/directoryservice_simple_ad awscc_directoryservice_simple_ad} Resource
  *
  * @param scope The scope in which to define this construct
