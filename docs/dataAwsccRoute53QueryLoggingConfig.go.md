...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccroute53queryloggingconfig"

dataawsccroute53queryloggingconfig.NewDataAwsccRoute53QueryLoggingConfig(scope Construct, id *string, config DataAwsccRoute53QueryLoggingConfigConfig) DataAwsccRoute53QueryLoggingConfig
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53QueryLoggingConfig.DataAwsccRoute53QueryLoggingConfig.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
dataawsccroute53queryloggingconfig.DataAwsccRoute53QueryLoggingConfig_IsConstruct(x interface{}) *bool
```
...
dataawsccroute53queryloggingconfig.DataAwsccRoute53QueryLoggingConfig_IsTerraformElement(x interface{}) *bool
```
...
dataawsccroute53queryloggingconfig.DataAwsccRoute53QueryLoggingConfig_IsTerraformDataSource(x interface{}) *bool
```
...
dataawsccroute53queryloggingconfig.DataAwsccRoute53QueryLoggingConfig_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53QueryLoggingConfig.DataAwsccRoute53QueryLoggingConfig.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53QueryLoggingConfig.DataAwsccRoute53QueryLoggingConfig.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53QueryLoggingConfig.DataAwsccRoute53QueryLoggingConfig.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53QueryLoggingConfig.DataAwsccRoute53QueryLoggingConfig.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53QueryLoggingConfig.DataAwsccRoute53QueryLoggingConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53QueryLoggingConfig.DataAwsccRoute53QueryLoggingConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53QueryLoggingConfig.DataAwsccRoute53QueryLoggingConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53QueryLoggingConfig.DataAwsccRoute53QueryLoggingConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
...
&dataawsccroute53queryloggingconfig.DataAwsccRoute53QueryLoggingConfigConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53QueryLoggingConfig.DataAwsccRoute53QueryLoggingConfigConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53QueryLoggingConfig.DataAwsccRoute53QueryLoggingConfigConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53QueryLoggingConfig.DataAwsccRoute53QueryLoggingConfigConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53QueryLoggingConfig.DataAwsccRoute53QueryLoggingConfigConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53QueryLoggingConfig.DataAwsccRoute53QueryLoggingConfigConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53QueryLoggingConfig.DataAwsccRoute53QueryLoggingConfigConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53QueryLoggingConfig.DataAwsccRoute53QueryLoggingConfigConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
