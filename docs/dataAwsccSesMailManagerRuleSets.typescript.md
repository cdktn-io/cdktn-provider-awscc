...
```typescript
import { dataAwsccSesMailManagerRuleSets } from '@cdktn/provider-awscc'

new dataAwsccSesMailManagerRuleSets.DataAwsccSesMailManagerRuleSets(scope: Construct, id: string, config?: DataAwsccSesMailManagerRuleSetsConfig)
```
...
dataAwsccSesMailManagerRuleSets.DataAwsccSesMailManagerRuleSets.isConstruct(x: any)
```
...
dataAwsccSesMailManagerRuleSets.DataAwsccSesMailManagerRuleSets.isTerraformElement(x: any)
```
...
dataAwsccSesMailManagerRuleSets.DataAwsccSesMailManagerRuleSets.isTerraformDataSource(x: any)
```
...
dataAwsccSesMailManagerRuleSets.DataAwsccSesMailManagerRuleSets.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerRuleSets.DataAwsccSesMailManagerRuleSets.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerRuleSets.DataAwsccSesMailManagerRuleSets.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerRuleSets.DataAwsccSesMailManagerRuleSets.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerRuleSets.DataAwsccSesMailManagerRuleSets.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerRuleSets.DataAwsccSesMailManagerRuleSets.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccSesMailManagerRuleSetsConfig: dataAwsccSesMailManagerRuleSets.DataAwsccSesMailManagerRuleSetsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerRuleSets.DataAwsccSesMailManagerRuleSetsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerRuleSets.DataAwsccSesMailManagerRuleSetsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerRuleSets.DataAwsccSesMailManagerRuleSetsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerRuleSets.DataAwsccSesMailManagerRuleSetsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
