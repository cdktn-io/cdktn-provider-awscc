...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iot_command
...
export class IotCommand extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotCommand that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iot_command#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iot_command awscc_iot_command} Resource
  *
  * @param scope The scope in which to define this construct
