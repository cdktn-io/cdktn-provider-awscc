...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/route53profiles_profile_associations
...
export class DataAwsccRoute53ProfilesProfileAssociations extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRoute53ProfilesProfileAssociations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/route53profiles_profile_associations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/route53profiles_profile_associations awscc_route53profiles_profile_associations} Data Source
  *
  * @param scope The scope in which to define this construct
