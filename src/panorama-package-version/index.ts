...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/panorama_package_version
...
export interface PanoramaPackageVersionConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/panorama_package_version#mark_latest PanoramaPackageVersion#mark_latest}
  */
  readonly markLatest?: boolean | cdktn.IResolvable;
  /**
  * An owner account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/panorama_package_version#owner_account PanoramaPackageVersion#owner_account}
  */
  readonly ownerAccount?: string;
  /**
  * A package ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/panorama_package_version#package_id PanoramaPackageVersion#package_id}
  */
  readonly packageId: string;
  /**
  * A package version.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/panorama_package_version#package_version PanoramaPackageVersion#package_version}
  */
  readonly packageVersion: string;
  /**
  * A patch version.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/panorama_package_version#patch_version PanoramaPackageVersion#patch_version}
  */
  readonly patchVersion: string;
  /**
  * If the version was marked latest, the new version to maker as latest.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/panorama_package_version#updated_latest_patch_version PanoramaPackageVersion#updated_latest_patch_version}
  */
  readonly updatedLatestPatchVersion?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/panorama_package_version awscc_panorama_package_version}
*/
export class PanoramaPackageVersion extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PanoramaPackageVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/panorama_package_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/panorama_package_version awscc_panorama_package_version} Resource
  *
  * @param scope The scope in which to define this construct
