...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/apigateway_base_path_mapping
...
export class ApigatewayBasePathMapping extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApigatewayBasePathMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/apigateway_base_path_mapping#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/apigateway_base_path_mapping awscc_apigateway_base_path_mapping} Resource
  *
  * @param scope The scope in which to define this construct
