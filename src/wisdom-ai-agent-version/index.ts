...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/wisdom_ai_agent_version
...
export class WisdomAiAgentVersion extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WisdomAiAgentVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/wisdom_ai_agent_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/wisdom_ai_agent_version awscc_wisdom_ai_agent_version} Resource
  *
  * @param scope The scope in which to define this construct
