...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/mediapackagev2_origin_endpoint
...
export interface Mediapackagev2OriginEndpointConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly streamNameOutputMode?: string;
  /**
...
export interface Mediapackagev2OriginEndpointSegment {
  ...
  */
  readonly outputTimestampMode?: string;
  /**
  * <p>The SCTE configuration.</p>
  *
...
export function mediapackagev2OriginEndpointSegmentToTerraform(struct?: Mediapackagev2OriginEndpointSegment | cdktn.IResolvable): any {
  ...
  return {
    ...
    output_timestamp_mode: cdktn.stringToTerraform(struct!.outputTimestampMode),
...
export function mediapackagev2OriginEndpointSegmentToHclTerraform(struct?: Mediapackagev2OriginEndpointSegment | cdktn.IResolvable): any {
  ...
  const attrs = {
    ...
    output_timestamp_mode: {
      value: cdktn.stringToHclTerraform(struct!.outputTimestampMode),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class Mediapackagev2OriginEndpointSegmentOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): Mediapackagev2OriginEndpointSegment | cdktn.IResolvable | undefined {
    ...
    if (this._outputTimestampMode !== undefined) {
      hasAnyValues = true;
      internalValueResult.outputTimestampMode = this._outputTimestampMode;
    }
  ...
  public set internalValue(value: Mediapackagev2OriginEndpointSegment | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      ...
      this._outputTimestampMode = undefined;
      ...
      this._outputTimestampMode = value.outputTimestampMode;
  ...
  // output_timestamp_mode - computed: true, optional: true, required: false
  private _outputTimestampMode?: string; 
  public get outputTimestampMode() {
    return this.getStringAttribute('output_timestamp_mode');
  }
  public set outputTimestampMode(value: string) {
    this._outputTimestampMode = value;
  }
  public resetOutputTimestampMode() {
    this._outputTimestampMode = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get outputTimestampModeInput() {
    return this._outputTimestampMode;
  }
...
export class Mediapackagev2OriginEndpoint extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Mediapackagev2OriginEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/mediapackagev2_origin_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/mediapackagev2_origin_endpoint awscc_mediapackagev2_origin_endpoint} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: Mediapackagev2OriginEndpointConfig) {
    ...
    this._streamNameOutputMode = config.streamNameOutputMode;
  ...
  // stream_name_output_mode - computed: true, optional: true, required: false
  private _streamNameOutputMode?: string; 
  public get streamNameOutputMode() {
    return this.getStringAttribute('stream_name_output_mode');
  }
  public set streamNameOutputMode(value: string) {
    this._streamNameOutputMode = value;
  }
  public resetStreamNameOutputMode() {
    this._streamNameOutputMode = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get streamNameOutputModeInput() {
    return this._streamNameOutputMode;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      stream_name_output_mode: cdktn.stringToTerraform(this._streamNameOutputMode),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      stream_name_output_mode: {
        value: cdktn.stringToHclTerraform(this._streamNameOutputMode),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
