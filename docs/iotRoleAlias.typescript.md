...
```typescript
import { iotRoleAlias } from '@cdktn/provider-awscc'
...
```typescript
public putTags(value: IResolvable | IotRoleAliasTags[]): void
```
...
| <code><a href="#@cdktn/provider-awscc.iotRoleAlias.IotRoleAlias.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.iotRoleAlias.IotRoleAlias.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.iotRoleAlias.IotRoleAlias.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.iotRoleAlias.IotRoleAlias.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.iotRoleAlias.IotRoleAlias.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.iotRoleAlias.IotRoleAlias.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.iotRoleAlias.IotRoleAlias.property.credentialDurationSecondsInput">credentialDurationSecondsInput</a></code> | <code>number</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.iotRoleAlias.IotRoleAlias.property.tagsInput">tagsInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.iotRoleAlias.IotRoleAliasTags">IotRoleAliasTags</a>[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.iotRoleAlias.IotRoleAlias.property.credentialDurationSeconds">credentialDurationSeconds</a></code> | <code>number</code> | *No description.* |
...
```typescript
public readonly tags: IotRoleAliasTagsList;
```
...
```typescript
public readonly credentialDurationSecondsInput: number;
```
...
```typescript
public readonly roleAliasInput: string;
```
...
```typescript
public readonly tagsInput: IResolvable | IotRoleAliasTags[];
```
...
| <code><a href="#@cdktn/provider-awscc.iotRoleAlias.IotRoleAliasConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.iotRoleAlias.IotRoleAliasConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.iotRoleAlias.IotRoleAliasConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.iotRoleAlias.IotRoleAliasConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.iotRoleAlias.IotRoleAliasConfig.property.credentialDurationSeconds">credentialDurationSeconds</a></code> | <code>number</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/iot_role_alias#credential_duration_seconds IotRoleAlias#credential_duration_seconds}. |
...
```typescript
public readonly tags: IResolvable | IotRoleAliasTags[];
```
...
const iotRoleAliasTags: iotRoleAlias.IotRoleAliasTags = { ... }
```
...
new iotRoleAlias.IotRoleAliasTagsList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.iotRoleAlias.IotRoleAliasTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.iotRoleAlias.IotRoleAliasTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| <code><a href="#@cdktn/provider-awscc.iotRoleAlias.IotRoleAliasTagsList.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.iotRoleAlias.IotRoleAliasTags">IotRoleAliasTags</a>[]</code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | IotRoleAliasTags[];
```
...
new iotRoleAlias.IotRoleAliasTagsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.iotRoleAlias.IotRoleAliasTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.iotRoleAlias.IotRoleAliasTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-awscc.iotRoleAlias.IotRoleAliasTagsOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| <code><a href="#@cdktn/provider-awscc.iotRoleAlias.IotRoleAliasTagsOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.iotRoleAlias.IotRoleAliasTags">IotRoleAliasTags</a></code> | *No description.* |
