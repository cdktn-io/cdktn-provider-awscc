...
```typescript
import { dataAwsccDocdbEventSubscriptions } from '@cdktn/provider-awscc'

new dataAwsccDocdbEventSubscriptions.DataAwsccDocdbEventSubscriptions(scope: Construct, id: string, config?: DataAwsccDocdbEventSubscriptionsConfig)
```
...
dataAwsccDocdbEventSubscriptions.DataAwsccDocdbEventSubscriptions.isConstruct(x: any)
```
...
dataAwsccDocdbEventSubscriptions.DataAwsccDocdbEventSubscriptions.isTerraformElement(x: any)
```
...
dataAwsccDocdbEventSubscriptions.DataAwsccDocdbEventSubscriptions.isTerraformDataSource(x: any)
```
...
dataAwsccDocdbEventSubscriptions.DataAwsccDocdbEventSubscriptions.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbEventSubscriptions.DataAwsccDocdbEventSubscriptions.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbEventSubscriptions.DataAwsccDocdbEventSubscriptions.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbEventSubscriptions.DataAwsccDocdbEventSubscriptions.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbEventSubscriptions.DataAwsccDocdbEventSubscriptions.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbEventSubscriptions.DataAwsccDocdbEventSubscriptions.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccDocdbEventSubscriptionsConfig: dataAwsccDocdbEventSubscriptions.DataAwsccDocdbEventSubscriptionsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbEventSubscriptions.DataAwsccDocdbEventSubscriptionsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbEventSubscriptions.DataAwsccDocdbEventSubscriptionsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbEventSubscriptions.DataAwsccDocdbEventSubscriptionsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbEventSubscriptions.DataAwsccDocdbEventSubscriptionsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
