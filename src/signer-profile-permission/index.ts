...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/signer_profile_permission
...
export class SignerProfilePermission extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SignerProfilePermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/signer_profile_permission#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/signer_profile_permission awscc_signer_profile_permission} Resource
  *
  * @param scope The scope in which to define this construct
