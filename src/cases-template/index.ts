...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/cases_template
...
export class CasesTemplate extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CasesTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/cases_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/cases_template awscc_cases_template} Resource
  *
  * @param scope The scope in which to define this construct
