...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_agent
...
export class DatasyncAgent extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DatasyncAgent that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_agent#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_agent awscc_datasync_agent} Resource
  *
  * @param scope The scope in which to define this construct
