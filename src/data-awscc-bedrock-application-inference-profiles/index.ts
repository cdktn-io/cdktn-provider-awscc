...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/bedrock_application_inference_profiles
...
export class DataAwsccBedrockApplicationInferenceProfiles extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccBedrockApplicationInferenceProfiles that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/bedrock_application_inference_profiles#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/bedrock_application_inference_profiles awscc_bedrock_application_inference_profiles} Data Source
  *
  * @param scope The scope in which to define this construct
