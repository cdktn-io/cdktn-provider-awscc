...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/logs_log_anomaly_detector
...
export class LogsLogAnomalyDetector extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LogsLogAnomalyDetector that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/logs_log_anomaly_detector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/logs_log_anomaly_detector awscc_logs_log_anomaly_detector} Resource
  *
  * @param scope The scope in which to define this construct
