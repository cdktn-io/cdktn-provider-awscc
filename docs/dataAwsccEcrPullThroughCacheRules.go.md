...
Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/ecr_pull_through_cache_rules awscc_ecr_pull_through_cache_rules}.
...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccecrpullthroughcacherules"

dataawsccecrpullthroughcacherules.NewDataAwsccEcrPullThroughCacheRules(scope Construct, id *string, config DataAwsccEcrPullThroughCacheRulesConfig) DataAwsccEcrPullThroughCacheRules
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRules.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
dataawsccecrpullthroughcacherules.DataAwsccEcrPullThroughCacheRules_IsConstruct(x interface{}) *bool
```
...
dataawsccecrpullthroughcacherules.DataAwsccEcrPullThroughCacheRules_IsTerraformElement(x interface{}) *bool
```
...
dataawsccecrpullthroughcacherules.DataAwsccEcrPullThroughCacheRules_IsTerraformDataSource(x interface{}) *bool
```
...
dataawsccecrpullthroughcacherules.DataAwsccEcrPullThroughCacheRules_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/ecr_pull_through_cache_rules#import import section} in the documentation of this resource for the id to use
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRules.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRules.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRules.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRules.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRules.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRules.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRules.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRules.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
...
&dataawsccecrpullthroughcacherules.DataAwsccEcrPullThroughCacheRulesConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRulesConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRulesConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRulesConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRulesConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRulesConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRulesConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRulesConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
