...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/paymentcryptography_keys
...
export class DataAwsccPaymentcryptographyKeys extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccPaymentcryptographyKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/paymentcryptography_keys#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/paymentcryptography_keys awscc_paymentcryptography_keys} Data Source
  *
  * @param scope The scope in which to define this construct
