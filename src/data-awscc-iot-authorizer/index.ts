...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/iot_authorizer
...
export class DataAwsccIotAuthorizer extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIotAuthorizer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/iot_authorizer#import import section} in the documentation of this resource for the id to use
