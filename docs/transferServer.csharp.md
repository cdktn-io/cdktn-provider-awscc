...
new TransferServerProtocolDetails {
    ...
    TransferServerProtocolDetailsProxyConfig ProxyConfig = null,
...
```csharp
public TransferServerProtocolDetailsProxyConfig ProxyConfig { get; set; }
```
...
new TransferServerProtocolDetailsProxyConfig {
    string SftpMode = null
};
```
...
```csharp
public string SftpMode { get; set; }
```
...
```csharp
private void PutProxyConfig(TransferServerProtocolDetailsProxyConfig Value)
```
...
```csharp
public TransferServerProtocolDetailsProxyConfigOutputReference ProxyConfig { get; }
```
...
```csharp
public IResolvable|TransferServerProtocolDetailsProxyConfig ProxyConfigInput { get; }
```

- *Type:* Io.Cdktn.IResolvable|<a href="#@cdktn/provider-awscc.transferServer.TransferServerProtocolDetailsProxyConfig">TransferServerProtocolDetailsProxyConfig</a>
...
new TransferServerProtocolDetailsProxyConfigOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.transferServer.TransferServerProtocolDetailsProxyConfigOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.transferServer.TransferServerProtocolDetailsProxyConfigOutputReference.resolve.parameter._context"></a>
...
```csharp
public string SftpModeInput { get; }
```
...
```csharp
public IResolvable|TransferServerProtocolDetailsProxyConfig InternalValue { get; }
```
