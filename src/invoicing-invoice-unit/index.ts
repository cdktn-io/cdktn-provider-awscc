...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/invoicing_invoice_unit
...
export class InvoicingInvoiceUnit extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing InvoicingInvoiceUnit that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/invoicing_invoice_unit#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/invoicing_invoice_unit awscc_invoicing_invoice_unit} Resource
  *
  * @param scope The scope in which to define this construct
