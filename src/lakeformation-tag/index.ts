...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/lakeformation_tag
...
export class LakeformationTag extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LakeformationTag that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/lakeformation_tag#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/lakeformation_tag awscc_lakeformation_tag} Resource
  *
  * @param scope The scope in which to define this construct
