...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/lightsail_load_balancer_tls_certificate
...
export class DataAwsccLightsailLoadBalancerTlsCertificate extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccLightsailLoadBalancerTlsCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/lightsail_load_balancer_tls_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/lightsail_load_balancer_tls_certificate awscc_lightsail_load_balancer_tls_certificate} Data Source
  *
  * @param scope The scope in which to define this construct
