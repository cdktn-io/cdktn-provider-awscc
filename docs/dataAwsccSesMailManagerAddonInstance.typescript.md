...
```typescript
import { dataAwsccSesMailManagerAddonInstance } from '@cdktn/provider-awscc'

new dataAwsccSesMailManagerAddonInstance.DataAwsccSesMailManagerAddonInstance(scope: Construct, id: string, config: DataAwsccSesMailManagerAddonInstanceConfig)
```
...
dataAwsccSesMailManagerAddonInstance.DataAwsccSesMailManagerAddonInstance.isConstruct(x: any)
```
...
dataAwsccSesMailManagerAddonInstance.DataAwsccSesMailManagerAddonInstance.isTerraformElement(x: any)
```
...
dataAwsccSesMailManagerAddonInstance.DataAwsccSesMailManagerAddonInstance.isTerraformDataSource(x: any)
```
...
dataAwsccSesMailManagerAddonInstance.DataAwsccSesMailManagerAddonInstance.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerAddonInstance.DataAwsccSesMailManagerAddonInstance.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerAddonInstance.DataAwsccSesMailManagerAddonInstance.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerAddonInstance.DataAwsccSesMailManagerAddonInstance.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerAddonInstance.DataAwsccSesMailManagerAddonInstance.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerAddonInstance.DataAwsccSesMailManagerAddonInstance.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
```typescript
public readonly tags: DataAwsccSesMailManagerAddonInstanceTagsList;
```
...
const dataAwsccSesMailManagerAddonInstanceConfig: dataAwsccSesMailManagerAddonInstance.DataAwsccSesMailManagerAddonInstanceConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerAddonInstance.DataAwsccSesMailManagerAddonInstanceConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerAddonInstance.DataAwsccSesMailManagerAddonInstanceConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerAddonInstance.DataAwsccSesMailManagerAddonInstanceConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerAddonInstance.DataAwsccSesMailManagerAddonInstanceConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const dataAwsccSesMailManagerAddonInstanceTags: dataAwsccSesMailManagerAddonInstance.DataAwsccSesMailManagerAddonInstanceTags = { ... }
```
...
new dataAwsccSesMailManagerAddonInstance.DataAwsccSesMailManagerAddonInstanceTagsList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerAddonInstance.DataAwsccSesMailManagerAddonInstanceTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerAddonInstance.DataAwsccSesMailManagerAddonInstanceTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
new dataAwsccSesMailManagerAddonInstance.DataAwsccSesMailManagerAddonInstanceTagsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerAddonInstance.DataAwsccSesMailManagerAddonInstanceTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerAddonInstance.DataAwsccSesMailManagerAddonInstanceTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
...
```typescript
public readonly internalValue: DataAwsccSesMailManagerAddonInstanceTags;
```
