...
Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/secretsmanager_resource_policies awscc_secretsmanager_resource_policies}.
...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccsecretsmanagerresourcepolicies"

dataawsccsecretsmanagerresourcepolicies.NewDataAwsccSecretsmanagerResourcePolicies(scope Construct, id *string, config DataAwsccSecretsmanagerResourcePoliciesConfig) DataAwsccSecretsmanagerResourcePolicies
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecretsmanagerResourcePolicies.DataAwsccSecretsmanagerResourcePolicies.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
dataawsccsecretsmanagerresourcepolicies.DataAwsccSecretsmanagerResourcePolicies_IsConstruct(x interface{}) *bool
```
...
dataawsccsecretsmanagerresourcepolicies.DataAwsccSecretsmanagerResourcePolicies_IsTerraformElement(x interface{}) *bool
```
...
dataawsccsecretsmanagerresourcepolicies.DataAwsccSecretsmanagerResourcePolicies_IsTerraformDataSource(x interface{}) *bool
```
...
dataawsccsecretsmanagerresourcepolicies.DataAwsccSecretsmanagerResourcePolicies_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/secretsmanager_resource_policies#import import section} in the documentation of this resource for the id to use
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecretsmanagerResourcePolicies.DataAwsccSecretsmanagerResourcePolicies.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecretsmanagerResourcePolicies.DataAwsccSecretsmanagerResourcePolicies.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecretsmanagerResourcePolicies.DataAwsccSecretsmanagerResourcePolicies.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecretsmanagerResourcePolicies.DataAwsccSecretsmanagerResourcePolicies.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecretsmanagerResourcePolicies.DataAwsccSecretsmanagerResourcePolicies.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecretsmanagerResourcePolicies.DataAwsccSecretsmanagerResourcePolicies.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecretsmanagerResourcePolicies.DataAwsccSecretsmanagerResourcePolicies.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecretsmanagerResourcePolicies.DataAwsccSecretsmanagerResourcePolicies.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
...
&dataawsccsecretsmanagerresourcepolicies.DataAwsccSecretsmanagerResourcePoliciesConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecretsmanagerResourcePolicies.DataAwsccSecretsmanagerResourcePoliciesConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecretsmanagerResourcePolicies.DataAwsccSecretsmanagerResourcePoliciesConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecretsmanagerResourcePolicies.DataAwsccSecretsmanagerResourcePoliciesConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecretsmanagerResourcePolicies.DataAwsccSecretsmanagerResourcePoliciesConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecretsmanagerResourcePolicies.DataAwsccSecretsmanagerResourcePoliciesConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecretsmanagerResourcePolicies.DataAwsccSecretsmanagerResourcePoliciesConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecretsmanagerResourcePolicies.DataAwsccSecretsmanagerResourcePoliciesConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
