...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ec2_route
...
export class Ec2Route extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2Route that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ec2_route#import import section} in the documentation of this resource for the id to use
