...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/wisdom_quick_response
...
export class DataAwsccWisdomQuickResponse extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccWisdomQuickResponse that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/wisdom_quick_response#import import section} in the documentation of this resource for the id to use
