...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/s3objectlambda_access_point
...
export class DataAwsccS3ObjectlambdaAccessPoint extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccS3ObjectlambdaAccessPoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/s3objectlambda_access_point#import import section} in the documentation of this resource for the id to use
