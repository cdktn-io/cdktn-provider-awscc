...
```typescript
import { dataAwsccLightsailBuckets } from '@cdktn/provider-awscc'

new dataAwsccLightsailBuckets.DataAwsccLightsailBuckets(scope: Construct, id: string, config?: DataAwsccLightsailBucketsConfig)
```
...
dataAwsccLightsailBuckets.DataAwsccLightsailBuckets.isConstruct(x: any)
```
...
dataAwsccLightsailBuckets.DataAwsccLightsailBuckets.isTerraformElement(x: any)
```
...
dataAwsccLightsailBuckets.DataAwsccLightsailBuckets.isTerraformDataSource(x: any)
```
...
dataAwsccLightsailBuckets.DataAwsccLightsailBuckets.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccLightsailBuckets.DataAwsccLightsailBuckets.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccLightsailBuckets.DataAwsccLightsailBuckets.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccLightsailBuckets.DataAwsccLightsailBuckets.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLightsailBuckets.DataAwsccLightsailBuckets.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccLightsailBuckets.DataAwsccLightsailBuckets.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccLightsailBucketsConfig: dataAwsccLightsailBuckets.DataAwsccLightsailBucketsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccLightsailBuckets.DataAwsccLightsailBucketsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLightsailBuckets.DataAwsccLightsailBucketsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLightsailBuckets.DataAwsccLightsailBucketsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccLightsailBuckets.DataAwsccLightsailBucketsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
