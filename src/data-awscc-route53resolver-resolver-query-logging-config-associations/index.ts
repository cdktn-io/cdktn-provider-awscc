...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/route53resolver_resolver_query_logging_config_associations
...
export class DataAwsccRoute53ResolverResolverQueryLoggingConfigAssociations extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRoute53ResolverResolverQueryLoggingConfigAssociations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/route53resolver_resolver_query_logging_config_associations#import import section} in the documentation of this resource for the id to use
