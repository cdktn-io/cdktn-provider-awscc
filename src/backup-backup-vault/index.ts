...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/backup_backup_vault
...
export class BackupBackupVault extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BackupBackupVault that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/backup_backup_vault#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/backup_backup_vault awscc_backup_backup_vault} Resource
  *
  * @param scope The scope in which to define this construct
