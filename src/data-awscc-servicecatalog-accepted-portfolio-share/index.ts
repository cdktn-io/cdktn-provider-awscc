...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/servicecatalog_accepted_portfolio_share
...
export class DataAwsccServicecatalogAcceptedPortfolioShare extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccServicecatalogAcceptedPortfolioShare that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/servicecatalog_accepted_portfolio_share#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/servicecatalog_accepted_portfolio_share awscc_servicecatalog_accepted_portfolio_share} Data Source
  *
  * @param scope The scope in which to define this construct
