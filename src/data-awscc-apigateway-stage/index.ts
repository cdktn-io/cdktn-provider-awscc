...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/apigateway_stage
...
export class DataAwsccApigatewayStage extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccApigatewayStage that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/apigateway_stage#import import section} in the documentation of this resource for the id to use
