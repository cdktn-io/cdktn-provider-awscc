...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/iottwinmaker_scene
...
export class IottwinmakerScene extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IottwinmakerScene that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/iottwinmaker_scene#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/iottwinmaker_scene awscc_iottwinmaker_scene} Resource
  *
  * @param scope The scope in which to define this construct
