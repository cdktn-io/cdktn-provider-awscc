...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_network_acl
...
export class Ec2NetworkAcl extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2NetworkAcl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_network_acl#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_network_acl awscc_ec2_network_acl} Resource
  *
  * @param scope The scope in which to define this construct
