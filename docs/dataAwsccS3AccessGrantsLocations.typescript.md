...
```typescript
import { dataAwsccS3AccessGrantsLocations } from '@cdktn/provider-awscc'

new dataAwsccS3AccessGrantsLocations.DataAwsccS3AccessGrantsLocations(scope: Construct, id: string, config?: DataAwsccS3AccessGrantsLocationsConfig)
```
...
dataAwsccS3AccessGrantsLocations.DataAwsccS3AccessGrantsLocations.isConstruct(x: any)
```
...
dataAwsccS3AccessGrantsLocations.DataAwsccS3AccessGrantsLocations.isTerraformElement(x: any)
```
...
dataAwsccS3AccessGrantsLocations.DataAwsccS3AccessGrantsLocations.isTerraformDataSource(x: any)
```
...
dataAwsccS3AccessGrantsLocations.DataAwsccS3AccessGrantsLocations.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3AccessGrantsLocations.DataAwsccS3AccessGrantsLocations.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3AccessGrantsLocations.DataAwsccS3AccessGrantsLocations.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3AccessGrantsLocations.DataAwsccS3AccessGrantsLocations.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3AccessGrantsLocations.DataAwsccS3AccessGrantsLocations.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3AccessGrantsLocations.DataAwsccS3AccessGrantsLocations.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccS3AccessGrantsLocationsConfig: dataAwsccS3AccessGrantsLocations.DataAwsccS3AccessGrantsLocationsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3AccessGrantsLocations.DataAwsccS3AccessGrantsLocationsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3AccessGrantsLocations.DataAwsccS3AccessGrantsLocationsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3AccessGrantsLocations.DataAwsccS3AccessGrantsLocationsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3AccessGrantsLocations.DataAwsccS3AccessGrantsLocationsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
