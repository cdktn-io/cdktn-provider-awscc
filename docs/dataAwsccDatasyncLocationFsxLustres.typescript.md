...
```typescript
import { dataAwsccDatasyncLocationFsxLustres } from '@cdktn/provider-awscc'

new dataAwsccDatasyncLocationFsxLustres.DataAwsccDatasyncLocationFsxLustres(scope: Construct, id: string, config?: DataAwsccDatasyncLocationFsxLustresConfig)
```
...
dataAwsccDatasyncLocationFsxLustres.DataAwsccDatasyncLocationFsxLustres.isConstruct(x: any)
```
...
dataAwsccDatasyncLocationFsxLustres.DataAwsccDatasyncLocationFsxLustres.isTerraformElement(x: any)
```
...
dataAwsccDatasyncLocationFsxLustres.DataAwsccDatasyncLocationFsxLustres.isTerraformDataSource(x: any)
```
...
dataAwsccDatasyncLocationFsxLustres.DataAwsccDatasyncLocationFsxLustres.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationFsxLustres.DataAwsccDatasyncLocationFsxLustres.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationFsxLustres.DataAwsccDatasyncLocationFsxLustres.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationFsxLustres.DataAwsccDatasyncLocationFsxLustres.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationFsxLustres.DataAwsccDatasyncLocationFsxLustres.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationFsxLustres.DataAwsccDatasyncLocationFsxLustres.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationFsxLustres.DataAwsccDatasyncLocationFsxLustres.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationFsxLustres.DataAwsccDatasyncLocationFsxLustres.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
...
const dataAwsccDatasyncLocationFsxLustresConfig: dataAwsccDatasyncLocationFsxLustres.DataAwsccDatasyncLocationFsxLustresConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationFsxLustres.DataAwsccDatasyncLocationFsxLustresConfig.property.connection">connection</a></code> | <code>cdktn.SSHProvisionerConnection \| cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationFsxLustres.DataAwsccDatasyncLocationFsxLustresConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationFsxLustres.DataAwsccDatasyncLocationFsxLustresConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationFsxLustres.DataAwsccDatasyncLocationFsxLustresConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationFsxLustres.DataAwsccDatasyncLocationFsxLustresConfig.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationFsxLustres.DataAwsccDatasyncLocationFsxLustresConfig.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDatasyncLocationFsxLustres.DataAwsccDatasyncLocationFsxLustresConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
