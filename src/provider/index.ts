...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs
...
export class AwsccProvider extends cdktn.TerraformProvider {
  ...
  * @param importFromId The id of the existing AwsccProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs awscc} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsccProviderConfig = {}) {
    super(scope, id, {
      ...
      terraformProviderSource: 'hashicorp/awscc'
    });
