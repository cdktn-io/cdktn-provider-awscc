...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iot_authorizer
...
export class IotAuthorizer extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotAuthorizer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iot_authorizer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iot_authorizer awscc_iot_authorizer} Resource
  *
  * @param scope The scope in which to define this construct
