...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/finspace_environment
...
export class DataAwsccFinspaceEnvironment extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccFinspaceEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/finspace_environment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/finspace_environment awscc_finspace_environment} Data Source
  *
  * @param scope The scope in which to define this construct
