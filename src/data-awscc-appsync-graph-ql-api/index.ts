...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/appsync_graph_ql_api
...
export class DataAwsccAppsyncGraphQlApi extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccAppsyncGraphQlApi that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/appsync_graph_ql_api#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/appsync_graph_ql_api awscc_appsync_graph_ql_api} Data Source
  *
  * @param scope The scope in which to define this construct
