...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/licensemanager_license
...
export class DataAwsccLicensemanagerLicense extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccLicensemanagerLicense that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/licensemanager_license#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/licensemanager_license awscc_licensemanager_license} Data Source
  *
  * @param scope The scope in which to define this construct
