...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/emrserverless_application
...
export class EmrserverlessApplication extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EmrserverlessApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/emrserverless_application#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/emrserverless_application awscc_emrserverless_application} Resource
  *
  * @param scope The scope in which to define this construct
