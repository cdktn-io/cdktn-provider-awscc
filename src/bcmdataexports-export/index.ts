...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/bcmdataexports_export
...
export class BcmdataexportsExport extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BcmdataexportsExport that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/bcmdataexports_export#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/bcmdataexports_export awscc_bcmdataexports_export} Resource
  *
  * @param scope The scope in which to define this construct
