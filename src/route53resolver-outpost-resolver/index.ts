...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/route53resolver_outpost_resolver
...
export class Route53ResolverOutpostResolver extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53ResolverOutpostResolver that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/route53resolver_outpost_resolver#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/route53resolver_outpost_resolver awscc_route53resolver_outpost_resolver} Resource
  *
  * @param scope The scope in which to define this construct
