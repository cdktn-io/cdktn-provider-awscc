...
new DataAwsccServicediscoveryPrivateDnsNamespaces(Construct Scope, string Id, DataAwsccServicediscoveryPrivateDnsNamespacesConfig Config = null);
```
...
DataAwsccServicediscoveryPrivateDnsNamespaces.IsConstruct(object X);
```
...
DataAwsccServicediscoveryPrivateDnsNamespaces.IsTerraformElement(object X);
```
...
DataAwsccServicediscoveryPrivateDnsNamespaces.IsTerraformDataSource(object X);
```
...
DataAwsccServicediscoveryPrivateDnsNamespaces.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccServicediscoveryPrivateDnsNamespaces.DataAwsccServicediscoveryPrivateDnsNamespaces.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccServicediscoveryPrivateDnsNamespaces.DataAwsccServicediscoveryPrivateDnsNamespaces.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccServicediscoveryPrivateDnsNamespaces.DataAwsccServicediscoveryPrivateDnsNamespaces.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccServicediscoveryPrivateDnsNamespaces.DataAwsccServicediscoveryPrivateDnsNamespaces.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccServicediscoveryPrivateDnsNamespaces.DataAwsccServicediscoveryPrivateDnsNamespaces.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccServicediscoveryPrivateDnsNamespaces.DataAwsccServicediscoveryPrivateDnsNamespaces.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccServicediscoveryPrivateDnsNamespaces.DataAwsccServicediscoveryPrivateDnsNamespaces.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
...
new DataAwsccServicediscoveryPrivateDnsNamespacesConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccServicediscoveryPrivateDnsNamespaces.DataAwsccServicediscoveryPrivateDnsNamespacesConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccServicediscoveryPrivateDnsNamespaces.DataAwsccServicediscoveryPrivateDnsNamespacesConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccServicediscoveryPrivateDnsNamespaces.DataAwsccServicediscoveryPrivateDnsNamespacesConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccServicediscoveryPrivateDnsNamespaces.DataAwsccServicediscoveryPrivateDnsNamespacesConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccServicediscoveryPrivateDnsNamespaces.DataAwsccServicediscoveryPrivateDnsNamespacesConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccServicediscoveryPrivateDnsNamespaces.DataAwsccServicediscoveryPrivateDnsNamespacesConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccServicediscoveryPrivateDnsNamespaces.DataAwsccServicediscoveryPrivateDnsNamespacesConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
