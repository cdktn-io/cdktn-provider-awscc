...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/ssmcontacts_contacts
...
export class DataAwsccSsmcontactsContacts extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccSsmcontactsContacts that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/ssmcontacts_contacts#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/ssmcontacts_contacts awscc_ssmcontacts_contacts} Data Source
  *
  * @param scope The scope in which to define this construct
