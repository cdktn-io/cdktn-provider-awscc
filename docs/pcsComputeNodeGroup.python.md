...
def put_slurm_configuration(
  gres_custom_settings: IResolvable | typing.List[typing.Mapping[str]] = None,
...
###### `gres_custom_settings`<sup>Optional</sup> <a name="gres_custom_settings" id="@cdktn/provider-awscc.pcsComputeNodeGroup.PcsComputeNodeGroup.putSlurmConfiguration.parameter.gresCustomSettings"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.pcsComputeNodeGroup.PcsComputeNodeGroupSlurmConfiguration.property.gresCustomSettings">gres_custom_settings</a></code> | <code>cdktn.IResolvable \| typing.List[typing.Mapping[str]]</code> | Additional Slurm gres.conf records for the compute node group. Each item is a map of gres.conf attribute names to values describing one gres.conf record (for example a GPU topology, MIG, MPS, or custom GRES entry). AWS PCS adds the NodeName= prefix and merges these records with the GPU record it derives from the instance type. |
...
##### `gres_custom_settings`<sup>Optional</sup> <a name="gres_custom_settings" id="@cdktn/provider-awscc.pcsComputeNodeGroup.PcsComputeNodeGroupSlurmConfiguration.property.gresCustomSettings"></a>

```python
gres_custom_settings: IResolvable | typing.List[typing.Mapping[str]]
```
...
| <code><a href="#@cdktn/provider-awscc.pcsComputeNodeGroup.PcsComputeNodeGroupSlurmConfigurationOutputReference.resetGresCustomSettings">reset_gres_custom_settings</a></code> | *No description.* |
...
##### `reset_gres_custom_settings` <a name="reset_gres_custom_settings" id="@cdktn/provider-awscc.pcsComputeNodeGroup.PcsComputeNodeGroupSlurmConfigurationOutputReference.resetGresCustomSettings"></a>

```python
def reset_gres_custom_settings() -> None
```
...
| <code><a href="#@cdktn/provider-awscc.pcsComputeNodeGroup.PcsComputeNodeGroupSlurmConfigurationOutputReference.property.gresCustomSettingsInput">gres_custom_settings_input</a></code> | <code>cdktn.IResolvable \| typing.List[typing.Mapping[str]]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.pcsComputeNodeGroup.PcsComputeNodeGroupSlurmConfigurationOutputReference.property.gresCustomSettings">gres_custom_settings</a></code> | <code>cdktn.IResolvable \| typing.List[typing.Mapping[str]]</code> | *No description.* |
...
##### `gres_custom_settings_input`<sup>Optional</sup> <a name="gres_custom_settings_input" id="@cdktn/provider-awscc.pcsComputeNodeGroup.PcsComputeNodeGroupSlurmConfigurationOutputReference.property.gresCustomSettingsInput"></a>

```python
gres_custom_settings_input: IResolvable | typing.List[typing.Mapping[str]]
```
...
##### `gres_custom_settings`<sup>Required</sup> <a name="gres_custom_settings" id="@cdktn/provider-awscc.pcsComputeNodeGroup.PcsComputeNodeGroupSlurmConfigurationOutputReference.property.gresCustomSettings"></a>
