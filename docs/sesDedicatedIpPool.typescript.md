...
```typescript
import { sesDedicatedIpPool } from '@cdktn/provider-awscc'

new sesDedicatedIpPool.SesDedicatedIpPool(scope: Construct, id: string, config?: SesDedicatedIpPoolConfig)
```
...
```typescript
public putTags(value: IResolvable | SesDedicatedIpPoolTags[]): void
```
...
sesDedicatedIpPool.SesDedicatedIpPool.isConstruct(x: any)
```
...
sesDedicatedIpPool.SesDedicatedIpPool.isTerraformElement(x: any)
```
...
sesDedicatedIpPool.SesDedicatedIpPool.isTerraformResource(x: any)
```
...
sesDedicatedIpPool.SesDedicatedIpPool.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.sesDedicatedIpPool.SesDedicatedIpPool.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.sesDedicatedIpPool.SesDedicatedIpPool.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.sesDedicatedIpPool.SesDedicatedIpPool.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.sesDedicatedIpPool.SesDedicatedIpPool.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.sesDedicatedIpPool.SesDedicatedIpPool.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.sesDedicatedIpPool.SesDedicatedIpPool.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.sesDedicatedIpPool.SesDedicatedIpPool.property.tagsInput">tagsInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.sesDedicatedIpPool.SesDedicatedIpPoolTags">SesDedicatedIpPoolTags</a>[]</code> | *No description.* |
...
```typescript
public readonly tags: SesDedicatedIpPoolTagsList;
```
...
```typescript
public readonly tagsInput: IResolvable | SesDedicatedIpPoolTags[];
```
...
const sesDedicatedIpPoolConfig: sesDedicatedIpPool.SesDedicatedIpPoolConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.sesDedicatedIpPool.SesDedicatedIpPoolConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sesDedicatedIpPool.SesDedicatedIpPoolConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.sesDedicatedIpPool.SesDedicatedIpPoolConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.sesDedicatedIpPool.SesDedicatedIpPoolConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.sesDedicatedIpPool.SesDedicatedIpPoolConfig.property.tags">tags</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.sesDedicatedIpPool.SesDedicatedIpPoolTags">SesDedicatedIpPoolTags</a>[]</code> | The tags (keys and values) associated with the dedicated IP pool. |
...
```typescript
public readonly tags: IResolvable | SesDedicatedIpPoolTags[];
```
...
const sesDedicatedIpPoolTags: sesDedicatedIpPool.SesDedicatedIpPoolTags = { ... }
```
...
new sesDedicatedIpPool.SesDedicatedIpPoolTagsList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.sesDedicatedIpPool.SesDedicatedIpPoolTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.sesDedicatedIpPool.SesDedicatedIpPoolTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| <code><a href="#@cdktn/provider-awscc.sesDedicatedIpPool.SesDedicatedIpPoolTagsList.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.sesDedicatedIpPool.SesDedicatedIpPoolTags">SesDedicatedIpPoolTags</a>[]</code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | SesDedicatedIpPoolTags[];
```
...
new sesDedicatedIpPool.SesDedicatedIpPoolTagsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.sesDedicatedIpPool.SesDedicatedIpPoolTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.sesDedicatedIpPool.SesDedicatedIpPoolTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-awscc.sesDedicatedIpPool.SesDedicatedIpPoolTagsOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| <code><a href="#@cdktn/provider-awscc.sesDedicatedIpPool.SesDedicatedIpPoolTagsOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.sesDedicatedIpPool.SesDedicatedIpPoolTags">SesDedicatedIpPoolTags</a></code> | *No description.* |
