...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/dataexchange_event_action
...
export class DataAwsccDataexchangeEventAction extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDataexchangeEventAction that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/dataexchange_event_action#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/dataexchange_event_action awscc_dataexchange_event_action} Data Source
  *
  * @param scope The scope in which to define this construct
