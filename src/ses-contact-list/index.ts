...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ses_contact_list
...
export class SesContactList extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SesContactList that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ses_contact_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ses_contact_list awscc_ses_contact_list} Resource
  *
  * @param scope The scope in which to define this construct
