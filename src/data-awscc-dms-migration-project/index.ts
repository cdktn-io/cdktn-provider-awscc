...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/dms_migration_project
...
export class DataAwsccDmsMigrationProject extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDmsMigrationProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/dms_migration_project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/dms_migration_project awscc_dms_migration_project} Data Source
  *
  * @param scope The scope in which to define this construct
