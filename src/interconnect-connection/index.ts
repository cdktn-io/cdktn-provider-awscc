...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/interconnect_connection
...
export class InterconnectConnection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing InterconnectConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/interconnect_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/interconnect_connection awscc_interconnect_connection} Resource
  *
  * @param scope The scope in which to define this construct
