...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/identitystore_group
...
export class IdentitystoreGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentitystoreGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/identitystore_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/identitystore_group awscc_identitystore_group} Resource
  *
  * @param scope The scope in which to define this construct
