...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/s3_bucket_policy
...
export class S3BucketPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3BucketPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/s3_bucket_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/s3_bucket_policy awscc_s3_bucket_policy} Resource
  *
  * @param scope The scope in which to define this construct
