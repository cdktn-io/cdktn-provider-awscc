...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/guardduty_ip_set
...
export class GuarddutyIpSet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GuarddutyIpSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/guardduty_ip_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/guardduty_ip_set awscc_guardduty_ip_set} Resource
  *
  * @param scope The scope in which to define this construct
