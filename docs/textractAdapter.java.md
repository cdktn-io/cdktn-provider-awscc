...
```java
import io.cdktn.providers.awscc.textract_adapter.TextractAdapter;

TextractAdapter.Builder.create(Construct scope, java.lang.String id)
...
//  .tags(IResolvable|java.util.List<TextractAdapterTags>)
    .build();
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.Initializer.parameter.scope">scope</a></code> | <code>software.constructs.Construct</code> | The scope in which to define this construct. |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.Initializer.parameter.id">id</a></code> | <code>java.lang.String</code> | The scoped construct ID. |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.Initializer.parameter.connection">connection</a></code> | <code>io.cdktn.cdktn.SSHProvisionerConnection\|io.cdktn.cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.Initializer.parameter.count">count</a></code> | <code>java.lang.Number\|io.cdktn.cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.Initializer.parameter.dependsOn">dependsOn</a></code> | <code>java.util.List<io.cdktn.cdktn.ITerraformDependable></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.Initializer.parameter.forEach">forEach</a></code> | <code>io.cdktn.cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.Initializer.parameter.lifecycle">lifecycle</a></code> | <code>io.cdktn.cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.Initializer.parameter.provider">provider</a></code> | <code>io.cdktn.cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.Initializer.parameter.provisioners">provisioners</a></code> | <code>java.util.List<io.cdktn.cdktn.FileProvisioner\|io.cdktn.cdktn.LocalExecProvisioner\|io.cdktn.cdktn.RemoteExecProvisioner></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.Initializer.parameter.adapterName">adapterName</a></code> | <code>java.lang.String</code> | The name to be assigned to the adapter being created. |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.Initializer.parameter.featureTypes">featureTypes</a></code> | <code>java.util.List<java.lang.String></code> | The type of feature that the adapter is being trained on. Currently, supported feature types are: QUERIES. |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.Initializer.parameter.autoUpdate">autoUpdate</a></code> | <code>java.lang.String</code> | Controls whether or not the adapter should automatically update. |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.Initializer.parameter.description">description</a></code> | <code>java.lang.String</code> | The description to be assigned to the adapter being created. |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.Initializer.parameter.tags">tags</a></code> | <code>io.cdktn.cdktn.IResolvable\|java.util.List<<a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterTags">TextractAdapterTags</a>></code> | A list of tags to be added to the adapter. |
...
##### `dependsOn`<sup>Optional</sup> <a name="dependsOn" id="@cdktn/provider-awscc.textractAdapter.TextractAdapter.Initializer.parameter.dependsOn"></a>

- *Type:* java.util.List<io.cdktn.cdktn.ITerraformDependable>

---

##### `forEach`<sup>Optional</sup> <a name="forEach" id="@cdktn/provider-awscc.textractAdapter.TextractAdapter.Initializer.parameter.forEach"></a>
...
##### `adapterName`<sup>Required</sup> <a name="adapterName" id="@cdktn/provider-awscc.textractAdapter.TextractAdapter.Initializer.parameter.adapterName"></a>
...
##### `featureTypes`<sup>Required</sup> <a name="featureTypes" id="@cdktn/provider-awscc.textractAdapter.TextractAdapter.Initializer.parameter.featureTypes"></a>
...
##### `autoUpdate`<sup>Optional</sup> <a name="autoUpdate" id="@cdktn/provider-awscc.textractAdapter.TextractAdapter.Initializer.parameter.autoUpdate"></a>
...
- *Type:* io.cdktn.cdktn.IResolvable|java.util.List<<a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterTags">TextractAdapterTags</a>>
...
```java
public void putTags(IResolvable|java.util.List<TextractAdapterTags> value)
```
...
TextractAdapter.isConstruct(java.lang.Object x)
```
...
TextractAdapter.isTerraformElement(java.lang.Object x)
```
...
TextractAdapter.isTerraformResource(java.lang.Object x)
```
...
TextractAdapter.generateConfigForImport(Construct scope, java.lang.String importToId, java.lang.String importFromId),TextractAdapter.generateConfigForImport(Construct scope, java.lang.String importToId, java.lang.String importFromId, TerraformProvider provider)
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.node">node</a></code> | <code>software.constructs.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.cdktfStack">cdktfStack</a></code> | <code>io.cdktn.cdktn.TerraformStack</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.fqn">fqn</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.friendlyUniqueId">friendlyUniqueId</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>java.util.Map<java.lang.String, java.lang.Object></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.terraformResourceType">terraformResourceType</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>io.cdktn.cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.connection">connection</a></code> | <code>io.cdktn.cdktn.SSHProvisionerConnection\|io.cdktn.cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.count">count</a></code> | <code>java.lang.Number\|io.cdktn.cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.dependsOn">dependsOn</a></code> | <code>java.util.List<java.lang.String></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.forEach">forEach</a></code> | <code>io.cdktn.cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.lifecycle">lifecycle</a></code> | <code>io.cdktn.cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.provider">provider</a></code> | <code>io.cdktn.cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.provisioners">provisioners</a></code> | <code>java.util.List<io.cdktn.cdktn.FileProvisioner\|io.cdktn.cdktn.LocalExecProvisioner\|io.cdktn.cdktn.RemoteExecProvisioner></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.adapterId">adapterId</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.arn">arn</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.creationTime">creationTime</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.id">id</a></code> | <code>java.lang.String</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.adapterNameInput">adapterNameInput</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.autoUpdateInput">autoUpdateInput</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.descriptionInput">descriptionInput</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.featureTypesInput">featureTypesInput</a></code> | <code>java.util.List<java.lang.String></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.tagsInput">tagsInput</a></code> | <code>io.cdktn.cdktn.IResolvable\|java.util.List<<a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterTags">TextractAdapterTags</a>></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.adapterName">adapterName</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.autoUpdate">autoUpdate</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.description">description</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.featureTypes">featureTypes</a></code> | <code>java.util.List<java.lang.String></code> | *No description.* |
...
```java
public TextractAdapterTagsList getTags();
```
...
```java
public java.lang.String getAdapterNameInput();
```
...
```java
public IResolvable|java.util.List<TextractAdapterTags> getTagsInput();
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapter.property.tfResourceType">tfResourceType</a></code> | <code>java.lang.String</code> | *No description.* |
...
```java
import io.cdktn.providers.awscc.textract_adapter.TextractAdapterConfig;

TextractAdapterConfig.builder()
//  .connection(SSHProvisionerConnection|WinrmProvisionerConnection)
//  .count(java.lang.Number|TerraformCount)
//  .dependsOn(java.util.List<ITerraformDependable>)
//  .forEach(ITerraformIterator)
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterConfig.property.connection">connection</a></code> | <code>io.cdktn.cdktn.SSHProvisionerConnection\|io.cdktn.cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterConfig.property.count">count</a></code> | <code>java.lang.Number\|io.cdktn.cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterConfig.property.dependsOn">dependsOn</a></code> | <code>java.util.List<io.cdktn.cdktn.ITerraformDependable></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterConfig.property.forEach">forEach</a></code> | <code>io.cdktn.cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterConfig.property.lifecycle">lifecycle</a></code> | <code>io.cdktn.cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterConfig.property.provider">provider</a></code> | <code>io.cdktn.cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterConfig.property.provisioners">provisioners</a></code> | <code>java.util.List<io.cdktn.cdktn.FileProvisioner\|io.cdktn.cdktn.LocalExecProvisioner\|io.cdktn.cdktn.RemoteExecProvisioner></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterConfig.property.adapterName">adapterName</a></code> | <code>java.lang.String</code> | The name to be assigned to the adapter being created. |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterConfig.property.featureTypes">featureTypes</a></code> | <code>java.util.List<java.lang.String></code> | The type of feature that the adapter is being trained on. Currently, supported feature types are: QUERIES. |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterConfig.property.autoUpdate">autoUpdate</a></code> | <code>java.lang.String</code> | Controls whether or not the adapter should automatically update. |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterConfig.property.description">description</a></code> | <code>java.lang.String</code> | The description to be assigned to the adapter being created. |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterConfig.property.tags">tags</a></code> | <code>io.cdktn.cdktn.IResolvable\|java.util.List<<a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterTags">TextractAdapterTags</a>></code> | A list of tags to be added to the adapter. |
...
```java
public IResolvable|java.util.List<TextractAdapterTags> getTags();
```
...
```java
import io.cdktn.providers.awscc.textract_adapter.TextractAdapterTags;

TextractAdapterTags.builder()
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterTags.property.key">key</a></code> | <code>java.lang.String</code> | The key name of the tag. |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterTags.property.value">value</a></code> | <code>java.lang.String</code> | The value for the tag. |
...
```java
import io.cdktn.providers.awscc.textract_adapter.TextractAdapterTagsList;

new TextractAdapterTagsList(IInterpolatingParent terraformResource, java.lang.String terraformAttribute, java.lang.Boolean wrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>io.cdktn.cdktn.IInterpolatingParent</code> | The parent resource. |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterTagsList.Initializer.parameter.terraformAttribute">terraformAttribute</a></code> | <code>java.lang.String</code> | The attribute on the parent resource this class is referencing. |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>java.lang.Boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```java
public TextractAdapterTagsOutputReference get(java.lang.Number index)
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterTagsList.property.creationStack">creationStack</a></code> | <code>java.util.List<java.lang.String></code> | The creation stack of this resolvable which will be appended to errors thrown during resolution. |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterTagsList.property.fqn">fqn</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterTagsList.property.internalValue">internalValue</a></code> | <code>io.cdktn.cdktn.IResolvable\|java.util.List<<a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterTags">TextractAdapterTags</a>></code> | *No description.* |
...
```java
public IResolvable|java.util.List<TextractAdapterTags> getInternalValue();
```
...
```java
import io.cdktn.providers.awscc.textract_adapter.TextractAdapterTagsOutputReference;

new TextractAdapterTagsOutputReference(IInterpolatingParent terraformResource, java.lang.String terraformAttribute, java.lang.Number complexObjectIndex, java.lang.Boolean complexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>io.cdktn.cdktn.IInterpolatingParent</code> | The parent resource. |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterTagsOutputReference.Initializer.parameter.terraformAttribute">terraformAttribute</a></code> | <code>java.lang.String</code> | The attribute on the parent resource this class is referencing. |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>java.lang.Number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterTagsOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>java.lang.Boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterTagsOutputReference.property.creationStack">creationStack</a></code> | <code>java.util.List<java.lang.String></code> | The creation stack of this resolvable which will be appended to errors thrown during resolution. |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterTagsOutputReference.property.fqn">fqn</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterTagsOutputReference.property.keyInput">keyInput</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterTagsOutputReference.property.valueInput">valueInput</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterTagsOutputReference.property.key">key</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterTagsOutputReference.property.value">value</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterTagsOutputReference.property.internalValue">internalValue</a></code> | <code>io.cdktn.cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterTags">TextractAdapterTags</a></code> | *No description.* |
...
```java
public IResolvable|TextractAdapterTags getInternalValue();
```

- *Type:* io.cdktn.cdktn.IResolvable|<a href="#@cdktn/provider-awscc.textractAdapter.TextractAdapterTags">TextractAdapterTags</a>
