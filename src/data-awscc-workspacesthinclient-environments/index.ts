...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/workspacesthinclient_environments
...
export class DataAwsccWorkspacesthinclientEnvironments extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccWorkspacesthinclientEnvironments that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/workspacesthinclient_environments#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/workspacesthinclient_environments awscc_workspacesthinclient_environments} Data Source
  *
  * @param scope The scope in which to define this construct
