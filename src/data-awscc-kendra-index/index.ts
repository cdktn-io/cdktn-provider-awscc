...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/kendra_index
...
export class DataAwsccKendraIndex extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccKendraIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/kendra_index#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/kendra_index awscc_kendra_index} Data Source
  *
  * @param scope The scope in which to define this construct
