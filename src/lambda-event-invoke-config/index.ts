...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/lambda_event_invoke_config
...
export class LambdaEventInvokeConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LambdaEventInvokeConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/lambda_event_invoke_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/lambda_event_invoke_config awscc_lambda_event_invoke_config} Resource
  *
  * @param scope The scope in which to define this construct
