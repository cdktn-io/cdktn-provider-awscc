...
new PersonalizeEventTracker(Construct Scope, string Id, PersonalizeEventTrackerConfig Config);
```
...
```csharp
private void PutTags(IResolvable|PersonalizeEventTrackerTags[] Value)
```
...
- *Type:* Io.Cdktn.IResolvable|<a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTrackerTags">PersonalizeEventTrackerTags</a>[]
...
PersonalizeEventTracker.IsConstruct(object X);
```
...
PersonalizeEventTracker.IsTerraformElement(object X);
```
...
PersonalizeEventTracker.IsTerraformResource(object X);
```
...
PersonalizeEventTracker.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTracker.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTracker.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTracker.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTracker.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTracker.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTracker.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTracker.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTracker.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTracker.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTracker.property.tagsInput">TagsInput</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTrackerTags">PersonalizeEventTrackerTags</a>[]</code> | *No description.* |
...
```csharp
public PersonalizeEventTrackerTagsList Tags { get; }
```
...
```csharp
public IResolvable|PersonalizeEventTrackerTags[] TagsInput { get; }
```
...
new PersonalizeEventTrackerConfig {
    ...
    string Name,
    IResolvable|PersonalizeEventTrackerTags[] Tags = null
};
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTrackerConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTrackerConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTrackerConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTrackerConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTrackerConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTrackerConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTrackerConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTrackerConfig.property.tags">Tags</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTrackerTags">PersonalizeEventTrackerTags</a>[]</code> | A list of tags to apply to the event tracker. |
...
```csharp
public IResolvable|PersonalizeEventTrackerTags[] Tags { get; set; }
```
...
new PersonalizeEventTrackerTags {
    string Key = null,
    string Value = null
};
```
...
new PersonalizeEventTrackerTagsList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTrackerTagsList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTrackerTagsList.resolve.parameter._context"></a>
...
```csharp
private PersonalizeEventTrackerTagsOutputReference Get(double Index)
```
...
| <code><a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTrackerTagsList.property.internalValue">InternalValue</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTrackerTags">PersonalizeEventTrackerTags</a>[]</code> | *No description.* |
...
```csharp
public IResolvable|PersonalizeEventTrackerTags[] InternalValue { get; }
```
...
new PersonalizeEventTrackerTagsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTrackerTagsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTrackerTagsOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTrackerTagsOutputReference.resolve.parameter._context"></a>
...
| <code><a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTrackerTagsOutputReference.property.internalValue">InternalValue</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.personalizeEventTracker.PersonalizeEventTrackerTags">PersonalizeEventTrackerTags</a></code> | *No description.* |
