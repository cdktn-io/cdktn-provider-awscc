...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/pcaconnectorscep_challenge
...
export class PcaconnectorscepChallenge extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PcaconnectorscepChallenge that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/pcaconnectorscep_challenge#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/pcaconnectorscep_challenge awscc_pcaconnectorscep_challenge} Resource
  *
  * @param scope The scope in which to define this construct
