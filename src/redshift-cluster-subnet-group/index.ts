...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/redshift_cluster_subnet_group
...
export interface RedshiftClusterSubnetGroupConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/redshift_cluster_subnet_group#description RedshiftClusterSubnetGroup#description}
  */
  readonly description: string;
  /**
  * The list of VPC subnet IDs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/redshift_cluster_subnet_group#subnet_ids RedshiftClusterSubnetGroup#subnet_ids}
  */
  readonly subnetIds: string[];
  /**
  * The list of tags for the cluster parameter group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/redshift_cluster_subnet_group#tags RedshiftClusterSubnetGroup#tags}
  */
...
export interface RedshiftClusterSubnetGroupTags {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/redshift_cluster_subnet_group#key RedshiftClusterSubnetGroup#key}
  */
  readonly key?: string;
  /**
  * The value for the tag. You can specify a value that is 1 to 255 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/redshift_cluster_subnet_group#value RedshiftClusterSubnetGroup#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/redshift_cluster_subnet_group awscc_redshift_cluster_subnet_group}
*/
export class RedshiftClusterSubnetGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RedshiftClusterSubnetGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/redshift_cluster_subnet_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/redshift_cluster_subnet_group awscc_redshift_cluster_subnet_group} Resource
  *
  * @param scope The scope in which to define this construct
