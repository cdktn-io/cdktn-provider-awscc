...
```typescript
import { dataAwsccApigatewayRequestValidator } from '@cdktn/provider-awscc'

new dataAwsccApigatewayRequestValidator.DataAwsccApigatewayRequestValidator(scope: Construct, id: string, config: DataAwsccApigatewayRequestValidatorConfig)
```
...
dataAwsccApigatewayRequestValidator.DataAwsccApigatewayRequestValidator.isConstruct(x: any)
```
...
dataAwsccApigatewayRequestValidator.DataAwsccApigatewayRequestValidator.isTerraformElement(x: any)
```
...
dataAwsccApigatewayRequestValidator.DataAwsccApigatewayRequestValidator.isTerraformDataSource(x: any)
```
...
dataAwsccApigatewayRequestValidator.DataAwsccApigatewayRequestValidator.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayRequestValidator.DataAwsccApigatewayRequestValidator.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayRequestValidator.DataAwsccApigatewayRequestValidator.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayRequestValidator.DataAwsccApigatewayRequestValidator.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayRequestValidator.DataAwsccApigatewayRequestValidator.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayRequestValidator.DataAwsccApigatewayRequestValidator.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayRequestValidator.DataAwsccApigatewayRequestValidator.property.validateRequestBody">validateRequestBody</a></code> | <code>cdktn.IResolvable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayRequestValidator.DataAwsccApigatewayRequestValidator.property.validateRequestParameters">validateRequestParameters</a></code> | <code>cdktn.IResolvable</code> | *No description.* |
...
```typescript
public readonly validateRequestBody: IResolvable;
```
...
```typescript
public readonly validateRequestParameters: IResolvable;
```
...
const dataAwsccApigatewayRequestValidatorConfig: dataAwsccApigatewayRequestValidator.DataAwsccApigatewayRequestValidatorConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayRequestValidator.DataAwsccApigatewayRequestValidatorConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayRequestValidator.DataAwsccApigatewayRequestValidatorConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayRequestValidator.DataAwsccApigatewayRequestValidatorConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayRequestValidator.DataAwsccApigatewayRequestValidatorConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
