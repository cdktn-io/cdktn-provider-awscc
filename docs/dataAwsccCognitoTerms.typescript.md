...
```typescript
import { dataAwsccCognitoTerms } from '@cdktn/provider-awscc'

new dataAwsccCognitoTerms.DataAwsccCognitoTerms(scope: Construct, id: string, config: DataAwsccCognitoTermsConfig)
```
...
dataAwsccCognitoTerms.DataAwsccCognitoTerms.isConstruct(x: any)
```
...
dataAwsccCognitoTerms.DataAwsccCognitoTerms.isTerraformElement(x: any)
```
...
dataAwsccCognitoTerms.DataAwsccCognitoTerms.isTerraformDataSource(x: any)
```
...
dataAwsccCognitoTerms.DataAwsccCognitoTerms.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCognitoTerms.DataAwsccCognitoTerms.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCognitoTerms.DataAwsccCognitoTerms.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCognitoTerms.DataAwsccCognitoTerms.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCognitoTerms.DataAwsccCognitoTerms.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCognitoTerms.DataAwsccCognitoTerms.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccCognitoTermsConfig: dataAwsccCognitoTerms.DataAwsccCognitoTermsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCognitoTerms.DataAwsccCognitoTermsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCognitoTerms.DataAwsccCognitoTermsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCognitoTerms.DataAwsccCognitoTermsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCognitoTerms.DataAwsccCognitoTermsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
