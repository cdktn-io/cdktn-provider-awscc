...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/iotwireless_wireless_gateway
...
export class IotwirelessWirelessGateway extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotwirelessWirelessGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/iotwireless_wireless_gateway#import import section} in the documentation of this resource for the id to use
