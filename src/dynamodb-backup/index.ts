...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/dynamodb_backup
...
export class DynamodbBackup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DynamodbBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/dynamodb_backup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/dynamodb_backup awscc_dynamodb_backup} Resource
  *
  * @param scope The scope in which to define this construct
