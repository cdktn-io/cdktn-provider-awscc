...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/launchwizard_deployment
...
export class LaunchwizardDeployment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LaunchwizardDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/launchwizard_deployment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/launchwizard_deployment awscc_launchwizard_deployment} Resource
  *
  * @param scope The scope in which to define this construct
