...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/healthimaging_datastore
...
export class HealthimagingDatastore extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing HealthimagingDatastore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/healthimaging_datastore#import import section} in the documentation of this resource for the id to use
