...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ec2_host
...
export class Ec2Host extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2Host that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ec2_host#import import section} in the documentation of this resource for the id to use
