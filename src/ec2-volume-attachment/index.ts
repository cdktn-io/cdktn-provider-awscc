...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ec2_volume_attachment
...
export class Ec2VolumeAttachment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2VolumeAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ec2_volume_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ec2_volume_attachment awscc_ec2_volume_attachment} Resource
  *
  * @param scope The scope in which to define this construct
