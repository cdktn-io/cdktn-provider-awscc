...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/pcs_compute_node_group
...
export class DataAwsccPcsComputeNodeGroupSlurmConfigurationOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  // gres_custom_settings - computed: true, optional: false, required: false
  private _gresCustomSettings = new cdktn.StringMapList(this, "gres_custom_settings", false);
  public get gresCustomSettings() {
    return this._gresCustomSettings;
  }
...
export class DataAwsccPcsComputeNodeGroup extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccPcsComputeNodeGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/pcs_compute_node_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/pcs_compute_node_group awscc_pcs_compute_node_group} Data Source
  *
  * @param scope The scope in which to define this construct
