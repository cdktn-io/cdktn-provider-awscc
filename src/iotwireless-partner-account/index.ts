...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/iotwireless_partner_account
...
export class IotwirelessPartnerAccount extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotwirelessPartnerAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/iotwireless_partner_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/iotwireless_partner_account awscc_iotwireless_partner_account} Resource
  *
  * @param scope The scope in which to define this construct
