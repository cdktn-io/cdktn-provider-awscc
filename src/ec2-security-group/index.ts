...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_security_group
...
export class Ec2SecurityGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2SecurityGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_security_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_security_group awscc_ec2_security_group} Resource
  *
  * @param scope The scope in which to define this construct
