...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/iam_service_linked_role
...
export class DataAwsccIamServiceLinkedRole extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIamServiceLinkedRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/iam_service_linked_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/iam_service_linked_role awscc_iam_service_linked_role} Data Source
  *
  * @param scope The scope in which to define this construct
