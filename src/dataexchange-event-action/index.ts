...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/dataexchange_event_action
...
export class DataexchangeEventAction extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DataexchangeEventAction that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/dataexchange_event_action#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/dataexchange_event_action awscc_dataexchange_event_action} Resource
  *
  * @param scope The scope in which to define this construct
