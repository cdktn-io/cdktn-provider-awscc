...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/appstream_image_builders
...
export class DataAwsccAppstreamImageBuilders extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccAppstreamImageBuilders that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/appstream_image_builders#import import section} in the documentation of this resource for the id to use
