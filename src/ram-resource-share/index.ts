...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ram_resource_share
...
export class RamResourceShare extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RamResourceShare that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ram_resource_share#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ram_resource_share awscc_ram_resource_share} Resource
  *
  * @param scope The scope in which to define this construct
