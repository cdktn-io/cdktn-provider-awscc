...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/resiliencehub_resiliency_policy
...
export class ResiliencehubResiliencyPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ResiliencehubResiliencyPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/resiliencehub_resiliency_policy#import import section} in the documentation of this resource for the id to use
