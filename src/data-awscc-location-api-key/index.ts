...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/location_api_key
...
export class DataAwsccLocationApiKey extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccLocationApiKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/location_api_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/location_api_key awscc_location_api_key} Data Source
  *
  * @param scope The scope in which to define this construct
