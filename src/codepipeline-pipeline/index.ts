...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/codepipeline_pipeline
...
export class CodepipelinePipeline extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CodepipelinePipeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/codepipeline_pipeline#import import section} in the documentation of this resource for the id to use
