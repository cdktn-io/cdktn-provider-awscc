...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/rds_cluster_snapshot
...
export interface RdsClusterSnapshotConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly tags?: RdsClusterSnapshotTags[] | cdktn.IResolvable;
}
export interface RdsClusterSnapshotTags {
  /**
...
export function rdsClusterSnapshotTagsToTerraform(struct?: RdsClusterSnapshotTags | cdktn.IResolvable): any {
...
export function rdsClusterSnapshotTagsToHclTerraform(struct?: RdsClusterSnapshotTags | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class RdsClusterSnapshotTagsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): RdsClusterSnapshotTags | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: RdsClusterSnapshotTags | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class RdsClusterSnapshotTagsList extends cdktn.ComplexList {
  public internalValue? : RdsClusterSnapshotTags[] | cdktn.IResolvable
  ...
  */
  public get(index: number): RdsClusterSnapshotTagsOutputReference {
    return new RdsClusterSnapshotTagsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
*/
export class RdsClusterSnapshot extends cdktn.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the RdsClusterSnapshot to import
  * @param importFromId The id of the existing RdsClusterSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/rds_cluster_snapshot#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the RdsClusterSnapshot to import is found
  */
  ...
  * @param options RdsClusterSnapshotConfig
  */
  public constructor(scope: Construct, id: string, config: RdsClusterSnapshotConfig) {
    super(scope, id, {
  ...
  private _tags = new RdsClusterSnapshotTagsList(this, "tags", false);
  public get tags() {
    return this._tags;
  }
  public putTags(value: RdsClusterSnapshotTags[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      tags: cdktn.listMapper(rdsClusterSnapshotTagsToTerraform, false)(this._tags.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      tags: {
        value: cdktn.listMapperHcl(rdsClusterSnapshotTagsToHclTerraform, false)(this._tags.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "RdsClusterSnapshotTagsList",
      },
    };
