...
```typescript
import { dataAwsccApigatewayv2ApiMappings } from '@cdktn/provider-awscc'

new dataAwsccApigatewayv2ApiMappings.DataAwsccApigatewayv2ApiMappings(scope: Construct, id: string, config?: DataAwsccApigatewayv2ApiMappingsConfig)
```
...
dataAwsccApigatewayv2ApiMappings.DataAwsccApigatewayv2ApiMappings.isConstruct(x: any)
```
...
dataAwsccApigatewayv2ApiMappings.DataAwsccApigatewayv2ApiMappings.isTerraformElement(x: any)
```
...
dataAwsccApigatewayv2ApiMappings.DataAwsccApigatewayv2ApiMappings.isTerraformDataSource(x: any)
```
...
dataAwsccApigatewayv2ApiMappings.DataAwsccApigatewayv2ApiMappings.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2ApiMappings.DataAwsccApigatewayv2ApiMappings.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2ApiMappings.DataAwsccApigatewayv2ApiMappings.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2ApiMappings.DataAwsccApigatewayv2ApiMappings.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2ApiMappings.DataAwsccApigatewayv2ApiMappings.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2ApiMappings.DataAwsccApigatewayv2ApiMappings.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccApigatewayv2ApiMappingsConfig: dataAwsccApigatewayv2ApiMappings.DataAwsccApigatewayv2ApiMappingsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2ApiMappings.DataAwsccApigatewayv2ApiMappingsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2ApiMappings.DataAwsccApigatewayv2ApiMappingsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2ApiMappings.DataAwsccApigatewayv2ApiMappingsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2ApiMappings.DataAwsccApigatewayv2ApiMappingsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
