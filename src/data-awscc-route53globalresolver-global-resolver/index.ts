...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/route53globalresolver_global_resolver
...
export class DataAwsccRoute53GlobalresolverGlobalResolver extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRoute53GlobalresolverGlobalResolver that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/route53globalresolver_global_resolver#import import section} in the documentation of this resource for the id to use
