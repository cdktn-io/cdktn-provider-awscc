...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_resource_policy
...
export class LogsResourcePolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LogsResourcePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_resource_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_resource_policy awscc_logs_resource_policy} Resource
  *
  * @param scope The scope in which to define this construct
