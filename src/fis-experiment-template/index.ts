...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/fis_experiment_template
...
export class FisExperimentTemplate extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FisExperimentTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/fis_experiment_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/fis_experiment_template awscc_fis_experiment_template} Resource
  *
  * @param scope The scope in which to define this construct
