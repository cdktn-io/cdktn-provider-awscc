...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/glue_user_defined_function
...
export class DataAwsccGlueUserDefinedFunction extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccGlueUserDefinedFunction that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/glue_user_defined_function#import import section} in the documentation of this resource for the id to use
