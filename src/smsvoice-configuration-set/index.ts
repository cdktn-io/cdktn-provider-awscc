...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/smsvoice_configuration_set
...
export class SmsvoiceConfigurationSet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SmsvoiceConfigurationSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/smsvoice_configuration_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/smsvoice_configuration_set awscc_smsvoice_configuration_set} Resource
  *
  * @param scope The scope in which to define this construct
