...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/securityhub_hub_v2s
...
export class DataAwsccSecurityhubHubV2S extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccSecurityhubHubV2S that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/securityhub_hub_v2s#import import section} in the documentation of this resource for the id to use
