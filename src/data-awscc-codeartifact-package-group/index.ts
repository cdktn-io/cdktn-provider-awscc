...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/codeartifact_package_group
...
export class DataAwsccCodeartifactPackageGroup extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCodeartifactPackageGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/codeartifact_package_group#import import section} in the documentation of this resource for the id to use
