...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/securityhub_aggregator_v2
...
export class DataAwsccSecurityhubAggregatorV2 extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccSecurityhubAggregatorV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/securityhub_aggregator_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/securityhub_aggregator_v2 awscc_securityhub_aggregator_v2} Data Source
  *
  * @param scope The scope in which to define this construct
