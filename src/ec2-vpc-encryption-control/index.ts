...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_encryption_control
...
export class Ec2VpcEncryptionControl extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2VpcEncryptionControl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_encryption_control#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_encryption_control awscc_ec2_vpc_encryption_control} Resource
  *
  * @param scope The scope in which to define this construct
