...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ses_mail_manager_address_list
...
export class SesMailManagerAddressList extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SesMailManagerAddressList that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ses_mail_manager_address_list#import import section} in the documentation of this resource for the id to use
