...
```go
func InternalValue() NetworkmanagerDirectConnectGatewayAttachmentProposedNetworkFunctionGroupChange
```
...
```go
func InternalValue() NetworkmanagerDirectConnectGatewayAttachmentProposedNetworkFunctionGroupChangeTags
```
...
```go
func InternalValue() NetworkmanagerDirectConnectGatewayAttachmentProposedSegmentChange
```
...
```go
func InternalValue() NetworkmanagerDirectConnectGatewayAttachmentProposedSegmentChangeTags
```
