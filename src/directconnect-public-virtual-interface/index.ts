...
export class DirectconnectPublicVirtualInterface extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DirectconnectPublicVirtualInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/directconnect_public_virtual_interface#import import section} in the documentation of this resource for the id to use
