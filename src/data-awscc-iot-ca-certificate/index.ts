...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/iot_ca_certificate
...
export class DataAwsccIotCaCertificate extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIotCaCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/iot_ca_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/iot_ca_certificate awscc_iot_ca_certificate} Data Source
  *
  * @param scope The scope in which to define this construct
