...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/iotsitewise_portal
...
export class DataAwsccIotsitewisePortal extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIotsitewisePortal that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/iotsitewise_portal#import import section} in the documentation of this resource for the id to use
