...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/logs_subscription_filter
...
export class DataAwsccLogsSubscriptionFilter extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccLogsSubscriptionFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/logs_subscription_filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/logs_subscription_filter awscc_logs_subscription_filter} Data Source
  *
  * @param scope The scope in which to define this construct
