...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/iot_job_template
...
export class IotJobTemplate extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotJobTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/iot_job_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/iot_job_template awscc_iot_job_template} Resource
  *
  * @param scope The scope in which to define this construct
