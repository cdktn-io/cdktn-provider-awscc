...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ec2_ipam_prefix_list_resolver
...
export class Ec2IpamPrefixListResolver extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2IpamPrefixListResolver that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ec2_ipam_prefix_list_resolver#import import section} in the documentation of this resource for the id to use
