...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iot_provisioning_template
...
export class IotProvisioningTemplate extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotProvisioningTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iot_provisioning_template#import import section} in the documentation of this resource for the id to use
