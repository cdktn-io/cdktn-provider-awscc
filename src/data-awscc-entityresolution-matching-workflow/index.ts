...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/entityresolution_matching_workflow
...
export class DataAwsccEntityresolutionMatchingWorkflow extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEntityresolutionMatchingWorkflow that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/entityresolution_matching_workflow#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/entityresolution_matching_workflow awscc_entityresolution_matching_workflow} Data Source
  *
  * @param scope The scope in which to define this construct
