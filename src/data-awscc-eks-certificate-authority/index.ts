...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/eks_certificate_authority
...
export class DataAwsccEksCertificateAuthority extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEksCertificateAuthority that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/eks_certificate_authority#import import section} in the documentation of this resource for the id to use
