...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/athena_capacity_reservation
...
export class AthenaCapacityReservation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AthenaCapacityReservation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/athena_capacity_reservation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/athena_capacity_reservation awscc_athena_capacity_reservation} Resource
  *
  * @param scope The scope in which to define this construct
