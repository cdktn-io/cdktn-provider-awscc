...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/connect_email_address
...
export class ConnectEmailAddress extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectEmailAddress that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/connect_email_address#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/connect_email_address awscc_connect_email_address} Resource
  *
  * @param scope The scope in which to define this construct
