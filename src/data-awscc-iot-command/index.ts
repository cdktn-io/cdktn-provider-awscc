...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/iot_command
...
export class DataAwsccIotCommand extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIotCommand that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/iot_command#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/iot_command awscc_iot_command} Data Source
  *
  * @param scope The scope in which to define this construct
