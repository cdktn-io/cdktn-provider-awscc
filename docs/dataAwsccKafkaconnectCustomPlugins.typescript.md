...
Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/kafkaconnect_custom_plugins awscc_kafkaconnect_custom_plugins}.
...
```typescript
import { dataAwsccKafkaconnectCustomPlugins } from '@cdktn/provider-awscc'

new dataAwsccKafkaconnectCustomPlugins.DataAwsccKafkaconnectCustomPlugins(scope: Construct, id: string, config?: DataAwsccKafkaconnectCustomPluginsConfig)
```
...
dataAwsccKafkaconnectCustomPlugins.DataAwsccKafkaconnectCustomPlugins.isConstruct(x: any)
```
...
dataAwsccKafkaconnectCustomPlugins.DataAwsccKafkaconnectCustomPlugins.isTerraformElement(x: any)
```
...
dataAwsccKafkaconnectCustomPlugins.DataAwsccKafkaconnectCustomPlugins.isTerraformDataSource(x: any)
```
...
dataAwsccKafkaconnectCustomPlugins.DataAwsccKafkaconnectCustomPlugins.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/kafkaconnect_custom_plugins#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectCustomPlugins.DataAwsccKafkaconnectCustomPlugins.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectCustomPlugins.DataAwsccKafkaconnectCustomPlugins.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectCustomPlugins.DataAwsccKafkaconnectCustomPlugins.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectCustomPlugins.DataAwsccKafkaconnectCustomPlugins.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectCustomPlugins.DataAwsccKafkaconnectCustomPlugins.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectCustomPlugins.DataAwsccKafkaconnectCustomPlugins.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectCustomPlugins.DataAwsccKafkaconnectCustomPlugins.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
...
const dataAwsccKafkaconnectCustomPluginsConfig: dataAwsccKafkaconnectCustomPlugins.DataAwsccKafkaconnectCustomPluginsConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectCustomPlugins.DataAwsccKafkaconnectCustomPluginsConfig.property.connection">connection</a></code> | <code>cdktn.SSHProvisionerConnection \| cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectCustomPlugins.DataAwsccKafkaconnectCustomPluginsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectCustomPlugins.DataAwsccKafkaconnectCustomPluginsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectCustomPlugins.DataAwsccKafkaconnectCustomPluginsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectCustomPlugins.DataAwsccKafkaconnectCustomPluginsConfig.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectCustomPlugins.DataAwsccKafkaconnectCustomPluginsConfig.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccKafkaconnectCustomPlugins.DataAwsccKafkaconnectCustomPluginsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
