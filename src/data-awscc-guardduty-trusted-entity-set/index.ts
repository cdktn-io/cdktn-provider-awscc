...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/guardduty_trusted_entity_set
...
export class DataAwsccGuarddutyTrustedEntitySet extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccGuarddutyTrustedEntitySet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/guardduty_trusted_entity_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/guardduty_trusted_entity_set awscc_guardduty_trusted_entity_set} Data Source
  *
  * @param scope The scope in which to define this construct
