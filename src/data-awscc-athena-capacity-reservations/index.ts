...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/athena_capacity_reservations
...
export class DataAwsccAthenaCapacityReservations extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccAthenaCapacityReservations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/athena_capacity_reservations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/athena_capacity_reservations awscc_athena_capacity_reservations} Data Source
  *
  * @param scope The scope in which to define this construct
