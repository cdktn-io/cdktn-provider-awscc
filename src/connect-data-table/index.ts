...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/connect_data_table
...
export class ConnectDataTable extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectDataTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/connect_data_table#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/connect_data_table awscc_connect_data_table} Resource
  *
  * @param scope The scope in which to define this construct
