...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/connect_predefined_attribute
...
export class ConnectPredefinedAttribute extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectPredefinedAttribute that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/connect_predefined_attribute#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/connect_predefined_attribute awscc_connect_predefined_attribute} Resource
  *
  * @param scope The scope in which to define this construct
