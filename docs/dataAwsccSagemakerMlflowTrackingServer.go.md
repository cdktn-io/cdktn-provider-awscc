...
Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/sagemaker_mlflow_tracking_server awscc_sagemaker_mlflow_tracking_server}.
...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccsagemakermlflowtrackingserver"

dataawsccsagemakermlflowtrackingserver.NewDataAwsccSagemakerMlflowTrackingServer(scope Construct, id *string, config DataAwsccSagemakerMlflowTrackingServerConfig) DataAwsccSagemakerMlflowTrackingServer
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerMlflowTrackingServer.DataAwsccSagemakerMlflowTrackingServer.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
dataawsccsagemakermlflowtrackingserver.DataAwsccSagemakerMlflowTrackingServer_IsConstruct(x interface{}) *bool
```
...
dataawsccsagemakermlflowtrackingserver.DataAwsccSagemakerMlflowTrackingServer_IsTerraformElement(x interface{}) *bool
```
...
dataawsccsagemakermlflowtrackingserver.DataAwsccSagemakerMlflowTrackingServer_IsTerraformDataSource(x interface{}) *bool
```
...
dataawsccsagemakermlflowtrackingserver.DataAwsccSagemakerMlflowTrackingServer_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/sagemaker_mlflow_tracking_server#import import section} in the documentation of this resource for the id to use
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerMlflowTrackingServer.DataAwsccSagemakerMlflowTrackingServer.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerMlflowTrackingServer.DataAwsccSagemakerMlflowTrackingServer.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerMlflowTrackingServer.DataAwsccSagemakerMlflowTrackingServer.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerMlflowTrackingServer.DataAwsccSagemakerMlflowTrackingServer.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerMlflowTrackingServer.DataAwsccSagemakerMlflowTrackingServer.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerMlflowTrackingServer.DataAwsccSagemakerMlflowTrackingServer.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerMlflowTrackingServer.DataAwsccSagemakerMlflowTrackingServer.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerMlflowTrackingServer.DataAwsccSagemakerMlflowTrackingServer.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerMlflowTrackingServer.DataAwsccSagemakerMlflowTrackingServer.property.automaticModelRegistration">AutomaticModelRegistration</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.IResolvable</code> | *No description.* |
...
```go
func AutomaticModelRegistration() IResolvable
```
...
```go
func Tags() DataAwsccSagemakerMlflowTrackingServerTagsList
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerMlflowTrackingServer.DataAwsccSagemakerMlflowTrackingServerConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerMlflowTrackingServer.DataAwsccSagemakerMlflowTrackingServerConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerMlflowTrackingServer.DataAwsccSagemakerMlflowTrackingServerConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerMlflowTrackingServer.DataAwsccSagemakerMlflowTrackingServerConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerMlflowTrackingServer.DataAwsccSagemakerMlflowTrackingServerConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerMlflowTrackingServer.DataAwsccSagemakerMlflowTrackingServerConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerMlflowTrackingServer.DataAwsccSagemakerMlflowTrackingServerConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/sagemaker_mlflow_tracking_server#id DataAwsccSagemakerMlflowTrackingServer#id}
...
dataawsccsagemakermlflowtrackingserver.NewDataAwsccSagemakerMlflowTrackingServerTagsList(terraformResource IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccSagemakerMlflowTrackingServerTagsList
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerMlflowTrackingServer.DataAwsccSagemakerMlflowTrackingServerTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerMlflowTrackingServer.DataAwsccSagemakerMlflowTrackingServerTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>*bool</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```go
func Get(index *f64) DataAwsccSagemakerMlflowTrackingServerTagsOutputReference
```
...
dataawsccsagemakermlflowtrackingserver.NewDataAwsccSagemakerMlflowTrackingServerTagsOutputReference(terraformResource IInterpolatingParent, terraformAttribute *string, complexObjectIndex *f64, complexObjectIsFromSet *bool) DataAwsccSagemakerMlflowTrackingServerTagsOutputReference
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerMlflowTrackingServer.DataAwsccSagemakerMlflowTrackingServerTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerMlflowTrackingServer.DataAwsccSagemakerMlflowTrackingServerTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>*f64</code> | the index of this item in the list. |
...
```go
func InternalValue() DataAwsccSagemakerMlflowTrackingServerTags
```
