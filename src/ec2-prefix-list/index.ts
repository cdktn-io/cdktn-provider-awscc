...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_prefix_list
...
export class Ec2PrefixList extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2PrefixList that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_prefix_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_prefix_list awscc_ec2_prefix_list} Resource
  *
  * @param scope The scope in which to define this construct
