...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/s3files_file_system
...
export class DataAwsccS3FilesFileSystem extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccS3FilesFileSystem that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/s3files_file_system#import import section} in the documentation of this resource for the id to use
