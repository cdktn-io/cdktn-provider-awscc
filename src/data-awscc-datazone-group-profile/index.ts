...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/datazone_group_profile
...
export class DataAwsccDatazoneGroupProfile extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDatazoneGroupProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/datazone_group_profile#import import section} in the documentation of this resource for the id to use
