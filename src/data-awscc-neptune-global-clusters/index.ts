...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/neptune_global_clusters
...
export class DataAwsccNeptuneGlobalClusters extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccNeptuneGlobalClusters that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/neptune_global_clusters#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/neptune_global_clusters awscc_neptune_global_clusters} Data Source
  *
  * @param scope The scope in which to define this construct
