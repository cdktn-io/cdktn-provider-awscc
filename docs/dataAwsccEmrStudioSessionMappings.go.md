...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccemrstudiosessionmappings"

dataawsccemrstudiosessionmappings.NewDataAwsccEmrStudioSessionMappings(scope Construct, id *string, config DataAwsccEmrStudioSessionMappingsConfig) DataAwsccEmrStudioSessionMappings
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEmrStudioSessionMappings.DataAwsccEmrStudioSessionMappings.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
dataawsccemrstudiosessionmappings.DataAwsccEmrStudioSessionMappings_IsConstruct(x interface{}) *bool
```
...
dataawsccemrstudiosessionmappings.DataAwsccEmrStudioSessionMappings_IsTerraformElement(x interface{}) *bool
```
...
dataawsccemrstudiosessionmappings.DataAwsccEmrStudioSessionMappings_IsTerraformDataSource(x interface{}) *bool
```
...
dataawsccemrstudiosessionmappings.DataAwsccEmrStudioSessionMappings_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEmrStudioSessionMappings.DataAwsccEmrStudioSessionMappings.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEmrStudioSessionMappings.DataAwsccEmrStudioSessionMappings.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEmrStudioSessionMappings.DataAwsccEmrStudioSessionMappings.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEmrStudioSessionMappings.DataAwsccEmrStudioSessionMappings.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEmrStudioSessionMappings.DataAwsccEmrStudioSessionMappings.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEmrStudioSessionMappings.DataAwsccEmrStudioSessionMappings.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEmrStudioSessionMappings.DataAwsccEmrStudioSessionMappings.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEmrStudioSessionMappings.DataAwsccEmrStudioSessionMappings.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEmrStudioSessionMappings.DataAwsccEmrStudioSessionMappingsConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEmrStudioSessionMappings.DataAwsccEmrStudioSessionMappingsConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEmrStudioSessionMappings.DataAwsccEmrStudioSessionMappingsConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEmrStudioSessionMappings.DataAwsccEmrStudioSessionMappingsConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEmrStudioSessionMappings.DataAwsccEmrStudioSessionMappingsConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEmrStudioSessionMappings.DataAwsccEmrStudioSessionMappingsConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEmrStudioSessionMappings.DataAwsccEmrStudioSessionMappingsConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
