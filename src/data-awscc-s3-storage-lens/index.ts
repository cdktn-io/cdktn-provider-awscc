...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/s3_storage_lens
...
export class DataAwsccS3StorageLens extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccS3StorageLens that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/s3_storage_lens#import import section} in the documentation of this resource for the id to use
