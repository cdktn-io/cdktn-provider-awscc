...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/cognito_identity_pools
...
export class DataAwsccCognitoIdentityPools extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCognitoIdentityPools that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/cognito_identity_pools#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/cognito_identity_pools awscc_cognito_identity_pools} Data Source
  *
  * @param scope The scope in which to define this construct
