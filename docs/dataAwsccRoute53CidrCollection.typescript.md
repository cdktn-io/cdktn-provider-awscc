...
```typescript
import { dataAwsccRoute53CidrCollection } from '@cdktn/provider-awscc'

new dataAwsccRoute53CidrCollection.DataAwsccRoute53CidrCollection(scope: Construct, id: string, config: DataAwsccRoute53CidrCollectionConfig)
```
...
dataAwsccRoute53CidrCollection.DataAwsccRoute53CidrCollection.isConstruct(x: any)
```
...
dataAwsccRoute53CidrCollection.DataAwsccRoute53CidrCollection.isTerraformElement(x: any)
```
...
dataAwsccRoute53CidrCollection.DataAwsccRoute53CidrCollection.isTerraformDataSource(x: any)
```
...
dataAwsccRoute53CidrCollection.DataAwsccRoute53CidrCollection.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53CidrCollection.DataAwsccRoute53CidrCollection.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53CidrCollection.DataAwsccRoute53CidrCollection.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53CidrCollection.DataAwsccRoute53CidrCollection.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53CidrCollection.DataAwsccRoute53CidrCollection.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53CidrCollection.DataAwsccRoute53CidrCollection.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
```typescript
public readonly locations: DataAwsccRoute53CidrCollectionLocationsList;
```
...
const dataAwsccRoute53CidrCollectionConfig: dataAwsccRoute53CidrCollection.DataAwsccRoute53CidrCollectionConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53CidrCollection.DataAwsccRoute53CidrCollectionConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53CidrCollection.DataAwsccRoute53CidrCollectionConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53CidrCollection.DataAwsccRoute53CidrCollectionConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53CidrCollection.DataAwsccRoute53CidrCollectionConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const dataAwsccRoute53CidrCollectionLocations: dataAwsccRoute53CidrCollection.DataAwsccRoute53CidrCollectionLocations = { ... }
```
...
new dataAwsccRoute53CidrCollection.DataAwsccRoute53CidrCollectionLocationsList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53CidrCollection.DataAwsccRoute53CidrCollectionLocationsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53CidrCollection.DataAwsccRoute53CidrCollectionLocationsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
new dataAwsccRoute53CidrCollection.DataAwsccRoute53CidrCollectionLocationsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53CidrCollection.DataAwsccRoute53CidrCollectionLocationsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53CidrCollection.DataAwsccRoute53CidrCollectionLocationsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
...
```typescript
public readonly internalValue: DataAwsccRoute53CidrCollectionLocations;
```
