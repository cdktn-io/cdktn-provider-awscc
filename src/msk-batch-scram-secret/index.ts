...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/msk_batch_scram_secret
...
export class MskBatchScramSecret extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MskBatchScramSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/msk_batch_scram_secret#import import section} in the documentation of this resource for the id to use
