...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/s3_access_grant
...
export class S3AccessGrant extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3AccessGrant that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/s3_access_grant#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/s3_access_grant awscc_s3_access_grant} Resource
  *
  * @param scope The scope in which to define this construct
