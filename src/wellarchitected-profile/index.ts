...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/wellarchitected_profile
...
export class WellarchitectedProfile extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WellarchitectedProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/wellarchitected_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/wellarchitected_profile awscc_wellarchitected_profile} Resource
  *
  * @param scope The scope in which to define this construct
