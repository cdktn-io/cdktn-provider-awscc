...
dataawsccagentregistryregistryrecord.NewDataAwsccAgentregistryRegistryRecordDescriptorsAguiOutputReference(terraformResource IInterpolatingParent, terraformAttribute *string) DataAwsccAgentregistryRegistryRecordDescriptorsAguiOutputReference
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAgentregistryRegistryRecord.DataAwsccAgentregistryRegistryRecordDescriptorsAguiOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.IInterpolatingParent</code> | The parent resource. |
...
```go
func Source() DataAwsccAgentregistryRegistryRecordDescriptorsAguiSourceOutputReference
```
...
```go
func InternalValue() DataAwsccAgentregistryRegistryRecordDescriptorsAgui
```
...
dataawsccagentregistryregistryrecord.NewDataAwsccAgentregistryRegistryRecordDescriptorsAguiSourceFromUrlOutputReference(terraformResource IInterpolatingParent, terraformAttribute *string) DataAwsccAgentregistryRegistryRecordDescriptorsAguiSourceFromUrlOutputReference
```
...
```go
func InternalValue() DataAwsccAgentregistryRegistryRecordDescriptorsAguiSourceFromUrl
```
...
dataawsccagentregistryregistryrecord.NewDataAwsccAgentregistryRegistryRecordDescriptorsAguiSourceOutputReference(terraformResource IInterpolatingParent, terraformAttribute *string) DataAwsccAgentregistryRegistryRecordDescriptorsAguiSourceOutputReference
```
...
```go
func FromUrl() DataAwsccAgentregistryRegistryRecordDescriptorsAguiSourceFromUrlOutputReference
```
...
```go
func InternalValue() DataAwsccAgentregistryRegistryRecordDescriptorsAguiSource
```
...
dataawsccagentregistryregistryrecord.NewDataAwsccAgentregistryRegistryRecordDescriptorsHttpOutputReference(terraformResource IInterpolatingParent, terraformAttribute *string) DataAwsccAgentregistryRegistryRecordDescriptorsHttpOutputReference
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAgentregistryRegistryRecord.DataAwsccAgentregistryRegistryRecordDescriptorsHttpOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.IInterpolatingParent</code> | The parent resource. |
...
```go
func Source() DataAwsccAgentregistryRegistryRecordDescriptorsHttpSourceOutputReference
```
...
```go
func InternalValue() DataAwsccAgentregistryRegistryRecordDescriptorsHttp
```
...
dataawsccagentregistryregistryrecord.NewDataAwsccAgentregistryRegistryRecordDescriptorsHttpSourceFromUrlOutputReference(terraformResource IInterpolatingParent, terraformAttribute *string) DataAwsccAgentregistryRegistryRecordDescriptorsHttpSourceFromUrlOutputReference
```
...
```go
func InternalValue() DataAwsccAgentregistryRegistryRecordDescriptorsHttpSourceFromUrl
```
...
dataawsccagentregistryregistryrecord.NewDataAwsccAgentregistryRegistryRecordDescriptorsHttpSourceOutputReference(terraformResource IInterpolatingParent, terraformAttribute *string) DataAwsccAgentregistryRegistryRecordDescriptorsHttpSourceOutputReference
```
...
```go
func FromUrl() DataAwsccAgentregistryRegistryRecordDescriptorsHttpSourceFromUrlOutputReference
```
...
```go
func InternalValue() DataAwsccAgentregistryRegistryRecordDescriptorsHttpSource
```
...
```go
func Agui() DataAwsccAgentregistryRegistryRecordDescriptorsAguiOutputReference
```
...
```go
func Http() DataAwsccAgentregistryRegistryRecordDescriptorsHttpOutputReference
```
