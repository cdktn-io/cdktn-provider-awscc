...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/b2bi_capability
...
export class B2BiCapability extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing B2BiCapability that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/b2bi_capability#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/b2bi_capability awscc_b2bi_capability} Resource
  *
  * @param scope The scope in which to define this construct
