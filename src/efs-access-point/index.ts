...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/efs_access_point
...
export class EfsAccessPoint extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EfsAccessPoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/efs_access_point#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/efs_access_point awscc_efs_access_point} Resource
  *
  * @param scope The scope in which to define this construct
