...
export class MedialiveChannelPlacementGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MedialiveChannelPlacementGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/medialive_channel_placement_group#import import section} in the documentation of this resource for the id to use
