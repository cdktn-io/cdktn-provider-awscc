...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/deadline_fleet
...
export class DataAwsccDeadlineFleet extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDeadlineFleet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/deadline_fleet#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/deadline_fleet awscc_deadline_fleet} Data Source
  *
  * @param scope The scope in which to define this construct
