...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/budgets_budgets_actions
...
export class DataAwsccBudgetsBudgetsActions extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccBudgetsBudgetsActions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/budgets_budgets_actions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/budgets_budgets_actions awscc_budgets_budgets_actions} Data Source
  *
  * @param scope The scope in which to define this construct
