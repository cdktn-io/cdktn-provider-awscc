...
```typescript
import { dataAwsccEc2IpamResourceDiscoveryAssociations } from '@cdktn/provider-awscc'

new dataAwsccEc2IpamResourceDiscoveryAssociations.DataAwsccEc2IpamResourceDiscoveryAssociations(scope: Construct, id: string, config?: DataAwsccEc2IpamResourceDiscoveryAssociationsConfig)
```
...
dataAwsccEc2IpamResourceDiscoveryAssociations.DataAwsccEc2IpamResourceDiscoveryAssociations.isConstruct(x: any)
```
...
dataAwsccEc2IpamResourceDiscoveryAssociations.DataAwsccEc2IpamResourceDiscoveryAssociations.isTerraformElement(x: any)
```
...
dataAwsccEc2IpamResourceDiscoveryAssociations.DataAwsccEc2IpamResourceDiscoveryAssociations.isTerraformDataSource(x: any)
```
...
dataAwsccEc2IpamResourceDiscoveryAssociations.DataAwsccEc2IpamResourceDiscoveryAssociations.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2IpamResourceDiscoveryAssociations.DataAwsccEc2IpamResourceDiscoveryAssociations.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2IpamResourceDiscoveryAssociations.DataAwsccEc2IpamResourceDiscoveryAssociations.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2IpamResourceDiscoveryAssociations.DataAwsccEc2IpamResourceDiscoveryAssociations.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2IpamResourceDiscoveryAssociations.DataAwsccEc2IpamResourceDiscoveryAssociations.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2IpamResourceDiscoveryAssociations.DataAwsccEc2IpamResourceDiscoveryAssociations.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccEc2IpamResourceDiscoveryAssociationsConfig: dataAwsccEc2IpamResourceDiscoveryAssociations.DataAwsccEc2IpamResourceDiscoveryAssociationsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2IpamResourceDiscoveryAssociations.DataAwsccEc2IpamResourceDiscoveryAssociationsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2IpamResourceDiscoveryAssociations.DataAwsccEc2IpamResourceDiscoveryAssociationsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2IpamResourceDiscoveryAssociations.DataAwsccEc2IpamResourceDiscoveryAssociationsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2IpamResourceDiscoveryAssociations.DataAwsccEc2IpamResourceDiscoveryAssociationsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
