...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/detective_organization_admin
...
export class DetectiveOrganizationAdmin extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DetectiveOrganizationAdmin that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/detective_organization_admin#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/detective_organization_admin awscc_detective_organization_admin} Resource
  *
  * @param scope The scope in which to define this construct
