...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/devopsguru_log_anomaly_detection_integrations
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/devopsguru_log_anomaly_detection_integrations awscc_devopsguru_log_anomaly_detection_integrations}
*/
export class DataAwsccDevopsguruLogAnomalyDetectionIntegrations extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDevopsguruLogAnomalyDetectionIntegrations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/devopsguru_log_anomaly_detection_integrations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/devopsguru_log_anomaly_detection_integrations awscc_devopsguru_log_anomaly_detection_integrations} Data Source
  *
  * @param scope The scope in which to define this construct
