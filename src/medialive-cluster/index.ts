...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/medialive_cluster
...
export class MedialiveCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MedialiveCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/medialive_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/medialive_cluster awscc_medialive_cluster} Resource
  *
  * @param scope The scope in which to define this construct
