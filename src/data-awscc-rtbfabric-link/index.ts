...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/rtbfabric_link
...
export class DataAwsccRtbfabricLink extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRtbfabricLink that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/rtbfabric_link#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/rtbfabric_link awscc_rtbfabric_link} Data Source
  *
  * @param scope The scope in which to define this construct
