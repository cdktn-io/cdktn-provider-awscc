...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_block_public_access_options
...
export class Ec2VpcBlockPublicAccessOptions extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2VpcBlockPublicAccessOptions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_block_public_access_options#import import section} in the documentation of this resource for the id to use
