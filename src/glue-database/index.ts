...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/glue_database
...
export class GlueDatabase extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GlueDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/glue_database#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/glue_database awscc_glue_database} Resource
  *
  * @param scope The scope in which to define this construct
