...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/gamelift_container_group_definitions
...
export class DataAwsccGameliftContainerGroupDefinitions extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccGameliftContainerGroupDefinitions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/gamelift_container_group_definitions#import import section} in the documentation of this resource for the id to use
