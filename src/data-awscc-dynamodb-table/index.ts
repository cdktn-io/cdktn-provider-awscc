...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/dynamodb_table
...
export interface DataAwsccDynamodbTableStreamSpecificationTags {
}

export function dataAwsccDynamodbTableStreamSpecificationTagsToTerraform(struct?: DataAwsccDynamodbTableStreamSpecificationTags): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsccDynamodbTableStreamSpecificationTagsToHclTerraform(struct?: DataAwsccDynamodbTableStreamSpecificationTags): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsccDynamodbTableStreamSpecificationTagsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAwsccDynamodbTableStreamSpecificationTags | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsccDynamodbTableStreamSpecificationTags | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataAwsccDynamodbTableStreamSpecificationTagsList extends cdktn.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataAwsccDynamodbTableStreamSpecificationTagsOutputReference {
    return new DataAwsccDynamodbTableStreamSpecificationTagsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAwsccDynamodbTableStreamSpecificationOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _tags = new DataAwsccDynamodbTableStreamSpecificationTagsList(this, "tags", true);
  public get tags() {
    return this._tags;
  }
}
...
export class DataAwsccDynamodbTable extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDynamodbTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/dynamodb_table#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/dynamodb_table awscc_dynamodb_table} Data Source
  *
  * @param scope The scope in which to define this construct
