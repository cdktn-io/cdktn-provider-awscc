...
```typescript
import { dataAwsccS3OutpostsAccessPoints } from '@cdktn/provider-awscc'

new dataAwsccS3OutpostsAccessPoints.DataAwsccS3OutpostsAccessPoints(scope: Construct, id: string, config?: DataAwsccS3OutpostsAccessPointsConfig)
```
...
dataAwsccS3OutpostsAccessPoints.DataAwsccS3OutpostsAccessPoints.isConstruct(x: any)
```
...
dataAwsccS3OutpostsAccessPoints.DataAwsccS3OutpostsAccessPoints.isTerraformElement(x: any)
```
...
dataAwsccS3OutpostsAccessPoints.DataAwsccS3OutpostsAccessPoints.isTerraformDataSource(x: any)
```
...
dataAwsccS3OutpostsAccessPoints.DataAwsccS3OutpostsAccessPoints.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3OutpostsAccessPoints.DataAwsccS3OutpostsAccessPoints.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3OutpostsAccessPoints.DataAwsccS3OutpostsAccessPoints.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3OutpostsAccessPoints.DataAwsccS3OutpostsAccessPoints.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3OutpostsAccessPoints.DataAwsccS3OutpostsAccessPoints.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3OutpostsAccessPoints.DataAwsccS3OutpostsAccessPoints.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccS3OutpostsAccessPointsConfig: dataAwsccS3OutpostsAccessPoints.DataAwsccS3OutpostsAccessPointsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3OutpostsAccessPoints.DataAwsccS3OutpostsAccessPointsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3OutpostsAccessPoints.DataAwsccS3OutpostsAccessPointsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3OutpostsAccessPoints.DataAwsccS3OutpostsAccessPointsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3OutpostsAccessPoints.DataAwsccS3OutpostsAccessPointsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
