...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/eks_access_entry
...
export class EksAccessEntry extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EksAccessEntry that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/eks_access_entry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/eks_access_entry awscc_eks_access_entry} Resource
  *
  * @param scope The scope in which to define this construct
