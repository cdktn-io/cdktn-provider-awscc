...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/accountaccess_entitlement
...
export class DataAwsccAccountaccessEntitlement extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccAccountaccessEntitlement that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/accountaccess_entitlement#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/accountaccess_entitlement awscc_accountaccess_entitlement} Data Source
  *
  * @param scope The scope in which to define this construct
