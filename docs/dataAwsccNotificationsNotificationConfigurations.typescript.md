...
```typescript
import { dataAwsccNotificationsNotificationConfigurations } from '@cdktn/provider-awscc'

new dataAwsccNotificationsNotificationConfigurations.DataAwsccNotificationsNotificationConfigurations(scope: Construct, id: string, config?: DataAwsccNotificationsNotificationConfigurationsConfig)
```
...
dataAwsccNotificationsNotificationConfigurations.DataAwsccNotificationsNotificationConfigurations.isConstruct(x: any)
```
...
dataAwsccNotificationsNotificationConfigurations.DataAwsccNotificationsNotificationConfigurations.isTerraformElement(x: any)
```
...
dataAwsccNotificationsNotificationConfigurations.DataAwsccNotificationsNotificationConfigurations.isTerraformDataSource(x: any)
```
...
dataAwsccNotificationsNotificationConfigurations.DataAwsccNotificationsNotificationConfigurations.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsNotificationConfigurations.DataAwsccNotificationsNotificationConfigurations.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsNotificationConfigurations.DataAwsccNotificationsNotificationConfigurations.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsNotificationConfigurations.DataAwsccNotificationsNotificationConfigurations.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsNotificationConfigurations.DataAwsccNotificationsNotificationConfigurations.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsNotificationConfigurations.DataAwsccNotificationsNotificationConfigurations.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccNotificationsNotificationConfigurationsConfig: dataAwsccNotificationsNotificationConfigurations.DataAwsccNotificationsNotificationConfigurationsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsNotificationConfigurations.DataAwsccNotificationsNotificationConfigurationsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsNotificationConfigurations.DataAwsccNotificationsNotificationConfigurationsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsNotificationConfigurations.DataAwsccNotificationsNotificationConfigurationsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsNotificationConfigurations.DataAwsccNotificationsNotificationConfigurationsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
