...
new DataAwsccMediaconnectBridgeOutput(Construct Scope, string Id, DataAwsccMediaconnectBridgeOutputConfig Config);
```
...
DataAwsccMediaconnectBridgeOutput.IsConstruct(object X);
```
...
DataAwsccMediaconnectBridgeOutput.IsTerraformElement(object X);
```
...
DataAwsccMediaconnectBridgeOutput.IsTerraformDataSource(object X);
```
...
DataAwsccMediaconnectBridgeOutput.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/mediaconnect_bridge_output#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconnectBridgeOutput.DataAwsccMediaconnectBridgeOutput.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconnectBridgeOutput.DataAwsccMediaconnectBridgeOutput.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconnectBridgeOutput.DataAwsccMediaconnectBridgeOutput.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconnectBridgeOutput.DataAwsccMediaconnectBridgeOutput.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconnectBridgeOutput.DataAwsccMediaconnectBridgeOutput.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconnectBridgeOutput.DataAwsccMediaconnectBridgeOutput.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconnectBridgeOutput.DataAwsccMediaconnectBridgeOutput.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
...
```csharp
public DataAwsccMediaconnectBridgeOutputNetworkOutputOutputReference NetworkOutput { get; }
```
...
new DataAwsccMediaconnectBridgeOutputConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconnectBridgeOutput.DataAwsccMediaconnectBridgeOutputConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconnectBridgeOutput.DataAwsccMediaconnectBridgeOutputConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconnectBridgeOutput.DataAwsccMediaconnectBridgeOutputConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconnectBridgeOutput.DataAwsccMediaconnectBridgeOutputConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconnectBridgeOutput.DataAwsccMediaconnectBridgeOutputConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconnectBridgeOutput.DataAwsccMediaconnectBridgeOutputConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconnectBridgeOutput.DataAwsccMediaconnectBridgeOutputConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
new DataAwsccMediaconnectBridgeOutputNetworkOutput {
...
new DataAwsccMediaconnectBridgeOutputNetworkOutputOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconnectBridgeOutput.DataAwsccMediaconnectBridgeOutputNetworkOutputOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.dataAwsccMediaconnectBridgeOutput.DataAwsccMediaconnectBridgeOutputNetworkOutputOutputReference.resolve.parameter._context"></a>
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconnectBridgeOutput.DataAwsccMediaconnectBridgeOutputNetworkOutputOutputReference.property.port">Port</a></code> | <code>double</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconnectBridgeOutput.DataAwsccMediaconnectBridgeOutputNetworkOutputOutputReference.property.ttl">Ttl</a></code> | <code>double</code> | *No description.* |
...
```csharp
public DataAwsccMediaconnectBridgeOutputNetworkOutput InternalValue { get; }
```
