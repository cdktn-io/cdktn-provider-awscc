...
```typescript
import { dataAwsccBudgetsBudgetsActions } from '@cdktn/provider-awscc'

new dataAwsccBudgetsBudgetsActions.DataAwsccBudgetsBudgetsActions(scope: Construct, id: string, config?: DataAwsccBudgetsBudgetsActionsConfig)
```
...
dataAwsccBudgetsBudgetsActions.DataAwsccBudgetsBudgetsActions.isConstruct(x: any)
```
...
dataAwsccBudgetsBudgetsActions.DataAwsccBudgetsBudgetsActions.isTerraformElement(x: any)
```
...
dataAwsccBudgetsBudgetsActions.DataAwsccBudgetsBudgetsActions.isTerraformDataSource(x: any)
```
...
dataAwsccBudgetsBudgetsActions.DataAwsccBudgetsBudgetsActions.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBudgetsBudgetsActions.DataAwsccBudgetsBudgetsActions.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBudgetsBudgetsActions.DataAwsccBudgetsBudgetsActions.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBudgetsBudgetsActions.DataAwsccBudgetsBudgetsActions.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBudgetsBudgetsActions.DataAwsccBudgetsBudgetsActions.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBudgetsBudgetsActions.DataAwsccBudgetsBudgetsActions.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccBudgetsBudgetsActionsConfig: dataAwsccBudgetsBudgetsActions.DataAwsccBudgetsBudgetsActionsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBudgetsBudgetsActions.DataAwsccBudgetsBudgetsActionsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBudgetsBudgetsActions.DataAwsccBudgetsBudgetsActionsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBudgetsBudgetsActions.DataAwsccBudgetsBudgetsActionsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBudgetsBudgetsActions.DataAwsccBudgetsBudgetsActionsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
