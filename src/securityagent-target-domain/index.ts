...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/securityagent_target_domain
...
export class SecurityagentTargetDomain extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityagentTargetDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/securityagent_target_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/securityagent_target_domain awscc_securityagent_target_domain} Resource
  *
  * @param scope The scope in which to define this construct
