...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/voiceid_domains
...
export class DataAwsccVoiceidDomains extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccVoiceidDomains that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/voiceid_domains#import import section} in the documentation of this resource for the id to use
