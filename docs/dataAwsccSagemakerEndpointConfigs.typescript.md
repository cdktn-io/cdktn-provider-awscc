...
```typescript
import { dataAwsccSagemakerEndpointConfigs } from '@cdktn/provider-awscc'

new dataAwsccSagemakerEndpointConfigs.DataAwsccSagemakerEndpointConfigs(scope: Construct, id: string, config?: DataAwsccSagemakerEndpointConfigsConfig)
```
...
dataAwsccSagemakerEndpointConfigs.DataAwsccSagemakerEndpointConfigs.isConstruct(x: any)
```
...
dataAwsccSagemakerEndpointConfigs.DataAwsccSagemakerEndpointConfigs.isTerraformElement(x: any)
```
...
dataAwsccSagemakerEndpointConfigs.DataAwsccSagemakerEndpointConfigs.isTerraformDataSource(x: any)
```
...
dataAwsccSagemakerEndpointConfigs.DataAwsccSagemakerEndpointConfigs.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerEndpointConfigs.DataAwsccSagemakerEndpointConfigs.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerEndpointConfigs.DataAwsccSagemakerEndpointConfigs.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerEndpointConfigs.DataAwsccSagemakerEndpointConfigs.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerEndpointConfigs.DataAwsccSagemakerEndpointConfigs.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerEndpointConfigs.DataAwsccSagemakerEndpointConfigs.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccSagemakerEndpointConfigsConfig: dataAwsccSagemakerEndpointConfigs.DataAwsccSagemakerEndpointConfigsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerEndpointConfigs.DataAwsccSagemakerEndpointConfigsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerEndpointConfigs.DataAwsccSagemakerEndpointConfigsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerEndpointConfigs.DataAwsccSagemakerEndpointConfigsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerEndpointConfigs.DataAwsccSagemakerEndpointConfigsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
