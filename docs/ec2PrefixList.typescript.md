...
```typescript
import { ec2PrefixList } from '@cdktn/provider-awscc'

new ec2PrefixList.Ec2PrefixList(scope: Construct, id: string, config: Ec2PrefixListConfig)
```
...
```typescript
public putEntries(value: IResolvable | Ec2PrefixListEntries[]): void
```
...
```typescript
public putTags(value: IResolvable | Ec2PrefixListTags[]): void
```
...
ec2PrefixList.Ec2PrefixList.isConstruct(x: any)
```
...
ec2PrefixList.Ec2PrefixList.isTerraformElement(x: any)
```
...
ec2PrefixList.Ec2PrefixList.isTerraformResource(x: any)
```
...
ec2PrefixList.Ec2PrefixList.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixList.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixList.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixList.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixList.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixList.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixList.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixList.property.version">version</a></code> | <code>number</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixList.property.entriesInput">entriesInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListEntries">Ec2PrefixListEntries</a>[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixList.property.maxEntriesInput">maxEntriesInput</a></code> | <code>number</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixList.property.tagsInput">tagsInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListTags">Ec2PrefixListTags</a>[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixList.property.maxEntries">maxEntries</a></code> | <code>number</code> | *No description.* |
...
```typescript
public readonly entries: Ec2PrefixListEntriesList;
```
...
```typescript
public readonly tags: Ec2PrefixListTagsList;
```
...
```typescript
public readonly entriesInput: IResolvable | Ec2PrefixListEntries[];
```
...
```typescript
public readonly prefixListNameInput: string;
```
...
```typescript
public readonly tagsInput: IResolvable | Ec2PrefixListTags[];
```
...
const ec2PrefixListConfig: ec2PrefixList.Ec2PrefixListConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListConfig.property.entries">entries</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListEntries">Ec2PrefixListEntries</a>[]</code> | Entries of Prefix List. |
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListConfig.property.maxEntries">maxEntries</a></code> | <code>number</code> | Max Entries of Prefix List. |
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListConfig.property.tags">tags</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListTags">Ec2PrefixListTags</a>[]</code> | Tags for Prefix List. |
...
```typescript
public readonly entries: IResolvable | Ec2PrefixListEntries[];
```
...
```typescript
public readonly tags: IResolvable | Ec2PrefixListTags[];
```
...
const ec2PrefixListEntries: ec2PrefixList.Ec2PrefixListEntries = { ... }
```
...
const ec2PrefixListTags: ec2PrefixList.Ec2PrefixListTags = { ... }
```
...
new ec2PrefixList.Ec2PrefixListEntriesList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListEntriesList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListEntriesList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListEntriesList.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListEntries">Ec2PrefixListEntries</a>[]</code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | Ec2PrefixListEntries[];
```
...
new ec2PrefixList.Ec2PrefixListEntriesOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListEntriesOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListEntriesOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListEntriesOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListEntriesOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListEntries">Ec2PrefixListEntries</a></code> | *No description.* |
...
new ec2PrefixList.Ec2PrefixListTagsList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListTagsList.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListTags">Ec2PrefixListTags</a>[]</code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | Ec2PrefixListTags[];
```
...
new ec2PrefixList.Ec2PrefixListTagsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListTagsOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| <code><a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListTagsOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.ec2PrefixList.Ec2PrefixListTags">Ec2PrefixListTags</a></code> | *No description.* |
