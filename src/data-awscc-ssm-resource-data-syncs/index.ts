...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ssm_resource_data_syncs
...
export class DataAwsccSsmResourceDataSyncs extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccSsmResourceDataSyncs that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ssm_resource_data_syncs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ssm_resource_data_syncs awscc_ssm_resource_data_syncs} Data Source
  *
  * @param scope The scope in which to define this construct
