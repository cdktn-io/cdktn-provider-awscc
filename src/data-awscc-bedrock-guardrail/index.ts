...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/bedrock_guardrail
...
export class DataAwsccBedrockGuardrail extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccBedrockGuardrail that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/bedrock_guardrail#import import section} in the documentation of this resource for the id to use
