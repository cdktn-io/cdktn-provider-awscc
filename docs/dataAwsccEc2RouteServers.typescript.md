...
```typescript
import { dataAwsccEc2RouteServers } from '@cdktn/provider-awscc'

new dataAwsccEc2RouteServers.DataAwsccEc2RouteServers(scope: Construct, id: string, config?: DataAwsccEc2RouteServersConfig)
```
...
dataAwsccEc2RouteServers.DataAwsccEc2RouteServers.isConstruct(x: any)
```
...
dataAwsccEc2RouteServers.DataAwsccEc2RouteServers.isTerraformElement(x: any)
```
...
dataAwsccEc2RouteServers.DataAwsccEc2RouteServers.isTerraformDataSource(x: any)
```
...
dataAwsccEc2RouteServers.DataAwsccEc2RouteServers.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2RouteServers.DataAwsccEc2RouteServers.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2RouteServers.DataAwsccEc2RouteServers.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2RouteServers.DataAwsccEc2RouteServers.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2RouteServers.DataAwsccEc2RouteServers.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2RouteServers.DataAwsccEc2RouteServers.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccEc2RouteServersConfig: dataAwsccEc2RouteServers.DataAwsccEc2RouteServersConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2RouteServers.DataAwsccEc2RouteServersConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2RouteServers.DataAwsccEc2RouteServersConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2RouteServers.DataAwsccEc2RouteServersConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2RouteServers.DataAwsccEc2RouteServersConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
