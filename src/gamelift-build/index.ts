...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/gamelift_build
...
export class GameliftBuild extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GameliftBuild that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/gamelift_build#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/gamelift_build awscc_gamelift_build} Resource
  *
  * @param scope The scope in which to define this construct
