...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccdmsreplicationsubnetgroups"

dataawsccdmsreplicationsubnetgroups.NewDataAwsccDmsReplicationSubnetGroups(scope Construct, id *string, config DataAwsccDmsReplicationSubnetGroupsConfig) DataAwsccDmsReplicationSubnetGroups
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDmsReplicationSubnetGroups.DataAwsccDmsReplicationSubnetGroups.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
dataawsccdmsreplicationsubnetgroups.DataAwsccDmsReplicationSubnetGroups_IsConstruct(x interface{}) *bool
```
...
dataawsccdmsreplicationsubnetgroups.DataAwsccDmsReplicationSubnetGroups_IsTerraformElement(x interface{}) *bool
```
...
dataawsccdmsreplicationsubnetgroups.DataAwsccDmsReplicationSubnetGroups_IsTerraformDataSource(x interface{}) *bool
```
...
dataawsccdmsreplicationsubnetgroups.DataAwsccDmsReplicationSubnetGroups_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/dms_replication_subnet_groups#import import section} in the documentation of this resource for the id to use
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDmsReplicationSubnetGroups.DataAwsccDmsReplicationSubnetGroups.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDmsReplicationSubnetGroups.DataAwsccDmsReplicationSubnetGroups.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDmsReplicationSubnetGroups.DataAwsccDmsReplicationSubnetGroups.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDmsReplicationSubnetGroups.DataAwsccDmsReplicationSubnetGroups.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDmsReplicationSubnetGroups.DataAwsccDmsReplicationSubnetGroups.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDmsReplicationSubnetGroups.DataAwsccDmsReplicationSubnetGroups.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDmsReplicationSubnetGroups.DataAwsccDmsReplicationSubnetGroups.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDmsReplicationSubnetGroups.DataAwsccDmsReplicationSubnetGroups.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
...
&dataawsccdmsreplicationsubnetgroups.DataAwsccDmsReplicationSubnetGroupsConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDmsReplicationSubnetGroups.DataAwsccDmsReplicationSubnetGroupsConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDmsReplicationSubnetGroups.DataAwsccDmsReplicationSubnetGroupsConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDmsReplicationSubnetGroups.DataAwsccDmsReplicationSubnetGroupsConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDmsReplicationSubnetGroups.DataAwsccDmsReplicationSubnetGroupsConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDmsReplicationSubnetGroups.DataAwsccDmsReplicationSubnetGroupsConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDmsReplicationSubnetGroups.DataAwsccDmsReplicationSubnetGroupsConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDmsReplicationSubnetGroups.DataAwsccDmsReplicationSubnetGroupsConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
