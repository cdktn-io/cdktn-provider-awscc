...
```typescript
import { dataAwsccRoute53CidrCollections } from '@cdktn/provider-awscc'

new dataAwsccRoute53CidrCollections.DataAwsccRoute53CidrCollections(scope: Construct, id: string, config?: DataAwsccRoute53CidrCollectionsConfig)
```
...
dataAwsccRoute53CidrCollections.DataAwsccRoute53CidrCollections.isConstruct(x: any)
```
...
dataAwsccRoute53CidrCollections.DataAwsccRoute53CidrCollections.isTerraformElement(x: any)
```
...
dataAwsccRoute53CidrCollections.DataAwsccRoute53CidrCollections.isTerraformDataSource(x: any)
```
...
dataAwsccRoute53CidrCollections.DataAwsccRoute53CidrCollections.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53CidrCollections.DataAwsccRoute53CidrCollections.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53CidrCollections.DataAwsccRoute53CidrCollections.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53CidrCollections.DataAwsccRoute53CidrCollections.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53CidrCollections.DataAwsccRoute53CidrCollections.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53CidrCollections.DataAwsccRoute53CidrCollections.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccRoute53CidrCollectionsConfig: dataAwsccRoute53CidrCollections.DataAwsccRoute53CidrCollectionsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53CidrCollections.DataAwsccRoute53CidrCollectionsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53CidrCollections.DataAwsccRoute53CidrCollectionsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53CidrCollections.DataAwsccRoute53CidrCollectionsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53CidrCollections.DataAwsccRoute53CidrCollectionsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
