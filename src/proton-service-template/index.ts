...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/proton_service_template
...
export class ProtonServiceTemplate extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ProtonServiceTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/proton_service_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/proton_service_template awscc_proton_service_template} Resource
  *
  * @param scope The scope in which to define this construct
