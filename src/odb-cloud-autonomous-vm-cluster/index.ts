...
export interface OdbCloudAutonomousVmClusterTags {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/odb_cloud_autonomous_vm_cluster#key OdbCloudAutonomousVmCluster#key}
  */
  readonly key?: string;
  /**
...
export class OdbCloudAutonomousVmCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OdbCloudAutonomousVmCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/odb_cloud_autonomous_vm_cluster#import import section} in the documentation of this resource for the id to use
