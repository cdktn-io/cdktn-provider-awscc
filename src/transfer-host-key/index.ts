...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/transfer_host_key
...
export class TransferHostKey extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TransferHostKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/transfer_host_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/transfer_host_key awscc_transfer_host_key} Resource
  *
  * @param scope The scope in which to define this construct
