...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/codestarnotifications_notification_rules
...
export class DataAwsccCodestarnotificationsNotificationRules extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCodestarnotificationsNotificationRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/codestarnotifications_notification_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/codestarnotifications_notification_rules awscc_codestarnotifications_notification_rules} Data Source
  *
  * @param scope The scope in which to define this construct
