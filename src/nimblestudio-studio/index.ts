...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/nimblestudio_studio
...
export class NimblestudioStudio extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NimblestudioStudio that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/nimblestudio_studio#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/nimblestudio_studio awscc_nimblestudio_studio} Resource
  *
  * @param scope The scope in which to define this construct
