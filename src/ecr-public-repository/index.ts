...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/ecr_public_repository
...
export class EcrPublicRepository extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EcrPublicRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/ecr_public_repository#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/ecr_public_repository awscc_ecr_public_repository} Resource
  *
  * @param scope The scope in which to define this construct
