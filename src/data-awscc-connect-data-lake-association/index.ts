...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/connect_data_lake_association
...
export class DataAwsccConnectDataLakeAssociation extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccConnectDataLakeAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/connect_data_lake_association#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/connect_data_lake_association awscc_connect_data_lake_association} Data Source
  *
  * @param scope The scope in which to define this construct
