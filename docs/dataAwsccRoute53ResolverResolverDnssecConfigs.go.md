...
Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/route53resolver_resolver_dnssec_configs awscc_route53resolver_resolver_dnssec_configs}.
...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccroute53resolverresolverdnssecconfigs"

dataawsccroute53resolverresolverdnssecconfigs.NewDataAwsccRoute53ResolverResolverDnssecConfigs(scope Construct, id *string, config DataAwsccRoute53ResolverResolverDnssecConfigsConfig) DataAwsccRoute53ResolverResolverDnssecConfigs
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53ResolverResolverDnssecConfigs.DataAwsccRoute53ResolverResolverDnssecConfigs.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
dataawsccroute53resolverresolverdnssecconfigs.DataAwsccRoute53ResolverResolverDnssecConfigs_IsConstruct(x interface{}) *bool
```
...
dataawsccroute53resolverresolverdnssecconfigs.DataAwsccRoute53ResolverResolverDnssecConfigs_IsTerraformElement(x interface{}) *bool
```
...
dataawsccroute53resolverresolverdnssecconfigs.DataAwsccRoute53ResolverResolverDnssecConfigs_IsTerraformDataSource(x interface{}) *bool
```
...
dataawsccroute53resolverresolverdnssecconfigs.DataAwsccRoute53ResolverResolverDnssecConfigs_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/route53resolver_resolver_dnssec_configs#import import section} in the documentation of this resource for the id to use
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53ResolverResolverDnssecConfigs.DataAwsccRoute53ResolverResolverDnssecConfigs.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53ResolverResolverDnssecConfigs.DataAwsccRoute53ResolverResolverDnssecConfigs.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53ResolverResolverDnssecConfigs.DataAwsccRoute53ResolverResolverDnssecConfigs.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53ResolverResolverDnssecConfigs.DataAwsccRoute53ResolverResolverDnssecConfigs.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53ResolverResolverDnssecConfigs.DataAwsccRoute53ResolverResolverDnssecConfigs.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53ResolverResolverDnssecConfigs.DataAwsccRoute53ResolverResolverDnssecConfigs.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53ResolverResolverDnssecConfigs.DataAwsccRoute53ResolverResolverDnssecConfigs.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
...
&dataawsccroute53resolverresolverdnssecconfigs.DataAwsccRoute53ResolverResolverDnssecConfigsConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53ResolverResolverDnssecConfigs.DataAwsccRoute53ResolverResolverDnssecConfigsConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53ResolverResolverDnssecConfigs.DataAwsccRoute53ResolverResolverDnssecConfigsConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53ResolverResolverDnssecConfigs.DataAwsccRoute53ResolverResolverDnssecConfigsConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53ResolverResolverDnssecConfigs.DataAwsccRoute53ResolverResolverDnssecConfigsConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53ResolverResolverDnssecConfigs.DataAwsccRoute53ResolverResolverDnssecConfigsConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53ResolverResolverDnssecConfigs.DataAwsccRoute53ResolverResolverDnssecConfigsConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53ResolverResolverDnssecConfigs.DataAwsccRoute53ResolverResolverDnssecConfigsConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
