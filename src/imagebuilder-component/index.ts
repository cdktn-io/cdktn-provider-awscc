...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/imagebuilder_component
...
export class ImagebuilderComponent extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ImagebuilderComponent that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/imagebuilder_component#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/imagebuilder_component awscc_imagebuilder_component} Resource
  *
  * @param scope The scope in which to define this construct
