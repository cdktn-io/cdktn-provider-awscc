...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/backup_restore_testing_plans
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/backup_restore_testing_plans awscc_backup_restore_testing_plans}
*/
export class DataAwsccBackupRestoreTestingPlans extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccBackupRestoreTestingPlans that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/backup_restore_testing_plans#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/backup_restore_testing_plans awscc_backup_restore_testing_plans} Data Source
  *
  * @param scope The scope in which to define this construct
