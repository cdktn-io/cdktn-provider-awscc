...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ce_anomaly_monitor
...
export class CeAnomalyMonitor extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CeAnomalyMonitor that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ce_anomaly_monitor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ce_anomaly_monitor awscc_ce_anomaly_monitor} Resource
  *
  * @param scope The scope in which to define this construct
