...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/omics_run_groups
...
export class DataAwsccOmicsRunGroups extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccOmicsRunGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/omics_run_groups#import import section} in the documentation of this resource for the id to use
