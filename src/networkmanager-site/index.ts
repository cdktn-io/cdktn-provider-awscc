...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/networkmanager_site
...
export function networkmanagerSiteLocationToTerraform(struct?: NetworkmanagerSiteLocation | cdktn.IResolvable): any {
...
export function networkmanagerSiteLocationToHclTerraform(struct?: NetworkmanagerSiteLocation | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class NetworkmanagerSiteLocationOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): NetworkmanagerSiteLocation | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: NetworkmanagerSiteLocation | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export function networkmanagerSiteTagsToTerraform(struct?: NetworkmanagerSiteTags | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function networkmanagerSiteTagsToHclTerraform(struct?: NetworkmanagerSiteTags | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class NetworkmanagerSiteTagsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): NetworkmanagerSiteTags | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: NetworkmanagerSiteTags | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._key = undefined;
...
export class NetworkmanagerSiteTagsList extends cdktn.ComplexList {
  public internalValue? : NetworkmanagerSiteTags[] | cdktn.IResolvable
  ...
  */
  public get(index: number): NetworkmanagerSiteTagsOutputReference {
    return new NetworkmanagerSiteTagsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class NetworkmanagerSite extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkmanagerSite that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/networkmanager_site#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/networkmanager_site awscc_networkmanager_site} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _tags = new NetworkmanagerSiteTagsList(this, "tags", true);
  public get tags() {
    return this._tags;
  }
  public putTags(value: NetworkmanagerSiteTags[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      tags: cdktn.listMapper(networkmanagerSiteTagsToTerraform, false)(this._tags.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      location: {
        ...
        isBlock: true,
        type: "struct",
        storageClassType: "NetworkmanagerSiteLocation",
      },
      tags: {
        value: cdktn.listMapperHcl(networkmanagerSiteTagsToHclTerraform, false)(this._tags.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "NetworkmanagerSiteTagsList",
      },
    };
