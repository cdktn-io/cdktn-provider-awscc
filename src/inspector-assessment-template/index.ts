...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/inspector_assessment_template
...
export class InspectorAssessmentTemplate extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing InspectorAssessmentTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/inspector_assessment_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/inspector_assessment_template awscc_inspector_assessment_template} Resource
  *
  * @param scope The scope in which to define this construct
