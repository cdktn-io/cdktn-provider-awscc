...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ssmguiconnect_preferences
...
export class SsmguiconnectPreferences extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SsmguiconnectPreferences that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ssmguiconnect_preferences#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ssmguiconnect_preferences awscc_ssmguiconnect_preferences} Resource
  *
  * @param scope The scope in which to define this construct
