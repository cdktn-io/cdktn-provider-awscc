...
```java
import io.cdktn.providers.awscc.drs_source_network.DrsSourceNetwork;

DrsSourceNetwork.Builder.create(Construct scope, java.lang.String id)
...
//  .tags(IResolvable|java.util.List<DrsSourceNetworkTags>)
    .build();
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.Initializer.parameter.scope">scope</a></code> | <code>software.constructs.Construct</code> | The scope in which to define this construct. |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.Initializer.parameter.id">id</a></code> | <code>java.lang.String</code> | The scoped construct ID. |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.Initializer.parameter.connection">connection</a></code> | <code>io.cdktn.cdktn.SSHProvisionerConnection\|io.cdktn.cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.Initializer.parameter.count">count</a></code> | <code>java.lang.Number\|io.cdktn.cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.Initializer.parameter.dependsOn">dependsOn</a></code> | <code>java.util.List<io.cdktn.cdktn.ITerraformDependable></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.Initializer.parameter.forEach">forEach</a></code> | <code>io.cdktn.cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.Initializer.parameter.lifecycle">lifecycle</a></code> | <code>io.cdktn.cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.Initializer.parameter.provider">provider</a></code> | <code>io.cdktn.cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.Initializer.parameter.provisioners">provisioners</a></code> | <code>java.util.List<io.cdktn.cdktn.FileProvisioner\|io.cdktn.cdktn.LocalExecProvisioner\|io.cdktn.cdktn.RemoteExecProvisioner></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.Initializer.parameter.originAccountId">originAccountId</a></code> | <code>java.lang.String</code> | The account ID containing the VPC to protect. |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.Initializer.parameter.originRegion">originRegion</a></code> | <code>java.lang.String</code> | The region containing the VPC to protect. |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.Initializer.parameter.vpcId">vpcId</a></code> | <code>java.lang.String</code> | The VPC ID to protect. |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.Initializer.parameter.tags">tags</a></code> | <code>io.cdktn.cdktn.IResolvable\|java.util.List<<a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkTags">DrsSourceNetworkTags</a>></code> | A set of tags associated with the Source Network. |
...
##### `connection`<sup>Optional</sup> <a name="connection" id="@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.Initializer.parameter.connection"></a>

- *Type:* io.cdktn.cdktn.SSHProvisionerConnection|io.cdktn.cdktn.WinrmProvisionerConnection

---

##### `count`<sup>Optional</sup> <a name="count" id="@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.Initializer.parameter.count"></a>

- *Type:* java.lang.Number|io.cdktn.cdktn.TerraformCount

---

##### `dependsOn`<sup>Optional</sup> <a name="dependsOn" id="@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.Initializer.parameter.dependsOn"></a>

- *Type:* java.util.List<io.cdktn.cdktn.ITerraformDependable>

---

##### `forEach`<sup>Optional</sup> <a name="forEach" id="@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.Initializer.parameter.forEach"></a>

- *Type:* io.cdktn.cdktn.ITerraformIterator

---

##### `lifecycle`<sup>Optional</sup> <a name="lifecycle" id="@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.Initializer.parameter.lifecycle"></a>

- *Type:* io.cdktn.cdktn.TerraformResourceLifecycle

---

##### `provider`<sup>Optional</sup> <a name="provider" id="@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.Initializer.parameter.provider"></a>

- *Type:* io.cdktn.cdktn.TerraformProvider

---

##### `provisioners`<sup>Optional</sup> <a name="provisioners" id="@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.Initializer.parameter.provisioners"></a>

- *Type:* java.util.List<io.cdktn.cdktn.FileProvisioner|io.cdktn.cdktn.LocalExecProvisioner|io.cdktn.cdktn.RemoteExecProvisioner>

---

##### `originAccountId`<sup>Required</sup> <a name="originAccountId" id="@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.Initializer.parameter.originAccountId"></a>
...
##### `originRegion`<sup>Required</sup> <a name="originRegion" id="@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.Initializer.parameter.originRegion"></a>
...
##### `vpcId`<sup>Required</sup> <a name="vpcId" id="@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.Initializer.parameter.vpcId"></a>
...
##### `tags`<sup>Optional</sup> <a name="tags" id="@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.Initializer.parameter.tags"></a>

- *Type:* io.cdktn.cdktn.IResolvable|java.util.List<<a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkTags">DrsSourceNetworkTags</a>>
...
```java
public void putTags(IResolvable|java.util.List<DrsSourceNetworkTags> value)
```
...
DrsSourceNetwork.isConstruct(java.lang.Object x)
```
...
DrsSourceNetwork.isTerraformElement(java.lang.Object x)
```
...
DrsSourceNetwork.isTerraformResource(java.lang.Object x)
```
...
DrsSourceNetwork.generateConfigForImport(Construct scope, java.lang.String importToId, java.lang.String importFromId),DrsSourceNetwork.generateConfigForImport(Construct scope, java.lang.String importToId, java.lang.String importFromId, TerraformProvider provider)
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.property.node">node</a></code> | <code>software.constructs.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.property.cdktfStack">cdktfStack</a></code> | <code>io.cdktn.cdktn.TerraformStack</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.property.fqn">fqn</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.property.friendlyUniqueId">friendlyUniqueId</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>java.util.Map<java.lang.String, java.lang.Object></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.property.terraformResourceType">terraformResourceType</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>io.cdktn.cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.property.connection">connection</a></code> | <code>io.cdktn.cdktn.SSHProvisionerConnection\|io.cdktn.cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.property.count">count</a></code> | <code>java.lang.Number\|io.cdktn.cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.property.dependsOn">dependsOn</a></code> | <code>java.util.List<java.lang.String></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.property.forEach">forEach</a></code> | <code>io.cdktn.cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.property.lifecycle">lifecycle</a></code> | <code>io.cdktn.cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.property.provider">provider</a></code> | <code>io.cdktn.cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.property.provisioners">provisioners</a></code> | <code>java.util.List<io.cdktn.cdktn.FileProvisioner\|io.cdktn.cdktn.LocalExecProvisioner\|io.cdktn.cdktn.RemoteExecProvisioner></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.property.arn">arn</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.property.id">id</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.property.sourceNetworkId">sourceNetworkId</a></code> | <code>java.lang.String</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.property.originAccountIdInput">originAccountIdInput</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.property.originRegionInput">originRegionInput</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.property.tagsInput">tagsInput</a></code> | <code>io.cdktn.cdktn.IResolvable\|java.util.List<<a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkTags">DrsSourceNetworkTags</a>></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.property.vpcIdInput">vpcIdInput</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.property.originAccountId">originAccountId</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.property.originRegion">originRegion</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.property.vpcId">vpcId</a></code> | <code>java.lang.String</code> | *No description.* |
...
```java
public DrsSourceNetworkTagsList getTags();
```
...
```java
public java.lang.String getOriginAccountIdInput();
```
...
```java
public IResolvable|java.util.List<DrsSourceNetworkTags> getTagsInput();
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetwork.property.tfResourceType">tfResourceType</a></code> | <code>java.lang.String</code> | *No description.* |
...
```java
import io.cdktn.providers.awscc.drs_source_network.DrsSourceNetworkConfig;

DrsSourceNetworkConfig.builder()
//  .connection(SSHProvisionerConnection|WinrmProvisionerConnection)
//  .count(java.lang.Number|TerraformCount)
//  .dependsOn(java.util.List<ITerraformDependable>)
//  .forEach(ITerraformIterator)
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkConfig.property.connection">connection</a></code> | <code>io.cdktn.cdktn.SSHProvisionerConnection\|io.cdktn.cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkConfig.property.count">count</a></code> | <code>java.lang.Number\|io.cdktn.cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkConfig.property.dependsOn">dependsOn</a></code> | <code>java.util.List<io.cdktn.cdktn.ITerraformDependable></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkConfig.property.forEach">forEach</a></code> | <code>io.cdktn.cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkConfig.property.lifecycle">lifecycle</a></code> | <code>io.cdktn.cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkConfig.property.provider">provider</a></code> | <code>io.cdktn.cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkConfig.property.provisioners">provisioners</a></code> | <code>java.util.List<io.cdktn.cdktn.FileProvisioner\|io.cdktn.cdktn.LocalExecProvisioner\|io.cdktn.cdktn.RemoteExecProvisioner></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkConfig.property.originAccountId">originAccountId</a></code> | <code>java.lang.String</code> | The account ID containing the VPC to protect. |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkConfig.property.originRegion">originRegion</a></code> | <code>java.lang.String</code> | The region containing the VPC to protect. |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkConfig.property.vpcId">vpcId</a></code> | <code>java.lang.String</code> | The VPC ID to protect. |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkConfig.property.tags">tags</a></code> | <code>io.cdktn.cdktn.IResolvable\|java.util.List<<a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkTags">DrsSourceNetworkTags</a>></code> | A set of tags associated with the Source Network. |
...
```java
public IResolvable|java.util.List<DrsSourceNetworkTags> getTags();
```
...
```java
import io.cdktn.providers.awscc.drs_source_network.DrsSourceNetworkTags;

DrsSourceNetworkTags.builder()
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkTags.property.key">key</a></code> | <code>java.lang.String</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/drs_source_network#key DrsSourceNetwork#key}. |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkTags.property.value">value</a></code> | <code>java.lang.String</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/drs_source_network#value DrsSourceNetwork#value}. |
...
```java
import io.cdktn.providers.awscc.drs_source_network.DrsSourceNetworkTagsList;

new DrsSourceNetworkTagsList(IInterpolatingParent terraformResource, java.lang.String terraformAttribute, java.lang.Boolean wrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>io.cdktn.cdktn.IInterpolatingParent</code> | The parent resource. |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkTagsList.Initializer.parameter.terraformAttribute">terraformAttribute</a></code> | <code>java.lang.String</code> | The attribute on the parent resource this class is referencing. |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>java.lang.Boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```java
public DrsSourceNetworkTagsOutputReference get(java.lang.Number index)
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkTagsList.property.creationStack">creationStack</a></code> | <code>java.util.List<java.lang.String></code> | The creation stack of this resolvable which will be appended to errors thrown during resolution. |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkTagsList.property.fqn">fqn</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkTagsList.property.internalValue">internalValue</a></code> | <code>io.cdktn.cdktn.IResolvable\|java.util.List<<a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkTags">DrsSourceNetworkTags</a>></code> | *No description.* |
...
```java
public IResolvable|java.util.List<DrsSourceNetworkTags> getInternalValue();
```
...
```java
import io.cdktn.providers.awscc.drs_source_network.DrsSourceNetworkTagsOutputReference;

new DrsSourceNetworkTagsOutputReference(IInterpolatingParent terraformResource, java.lang.String terraformAttribute, java.lang.Number complexObjectIndex, java.lang.Boolean complexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>io.cdktn.cdktn.IInterpolatingParent</code> | The parent resource. |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkTagsOutputReference.Initializer.parameter.terraformAttribute">terraformAttribute</a></code> | <code>java.lang.String</code> | The attribute on the parent resource this class is referencing. |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>java.lang.Number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkTagsOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>java.lang.Boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkTagsOutputReference.property.creationStack">creationStack</a></code> | <code>java.util.List<java.lang.String></code> | The creation stack of this resolvable which will be appended to errors thrown during resolution. |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkTagsOutputReference.property.fqn">fqn</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkTagsOutputReference.property.keyInput">keyInput</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkTagsOutputReference.property.valueInput">valueInput</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkTagsOutputReference.property.key">key</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkTagsOutputReference.property.value">value</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkTagsOutputReference.property.internalValue">internalValue</a></code> | <code>io.cdktn.cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkTags">DrsSourceNetworkTags</a></code> | *No description.* |
...
```java
public IResolvable|DrsSourceNetworkTags getInternalValue();
```

- *Type:* io.cdktn.cdktn.IResolvable|<a href="#@cdktn/provider-awscc.drsSourceNetwork.DrsSourceNetworkTags">DrsSourceNetworkTags</a>
