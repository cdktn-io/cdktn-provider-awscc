...
```typescript
import { dataAwsccAccountaccessApplications } from '@cdktn/provider-awscc'

new dataAwsccAccountaccessApplications.DataAwsccAccountaccessApplications(scope: Construct, id: string, config?: DataAwsccAccountaccessApplicationsConfig)
```
...
dataAwsccAccountaccessApplications.DataAwsccAccountaccessApplications.isConstruct(x: any)
```
...
dataAwsccAccountaccessApplications.DataAwsccAccountaccessApplications.isTerraformElement(x: any)
```
...
dataAwsccAccountaccessApplications.DataAwsccAccountaccessApplications.isTerraformDataSource(x: any)
```
...
dataAwsccAccountaccessApplications.DataAwsccAccountaccessApplications.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAccountaccessApplications.DataAwsccAccountaccessApplications.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAccountaccessApplications.DataAwsccAccountaccessApplications.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAccountaccessApplications.DataAwsccAccountaccessApplications.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAccountaccessApplications.DataAwsccAccountaccessApplications.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAccountaccessApplications.DataAwsccAccountaccessApplications.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccAccountaccessApplicationsConfig: dataAwsccAccountaccessApplications.DataAwsccAccountaccessApplicationsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAccountaccessApplications.DataAwsccAccountaccessApplicationsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAccountaccessApplications.DataAwsccAccountaccessApplicationsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAccountaccessApplications.DataAwsccAccountaccessApplicationsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAccountaccessApplications.DataAwsccAccountaccessApplicationsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
