...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/databrew_ruleset
...
export class DatabrewRuleset extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DatabrewRuleset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/databrew_ruleset#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/databrew_ruleset awscc_databrew_ruleset} Resource
  *
  * @param scope The scope in which to define this construct
