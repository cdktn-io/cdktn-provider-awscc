...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/gamelift_location
...
export class GameliftLocation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GameliftLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/gamelift_location#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/gamelift_location awscc_gamelift_location} Resource
  *
  * @param scope The scope in which to define this construct
