...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/logs_delivery_destination
...
export class LogsDeliveryDestination extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LogsDeliveryDestination that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/logs_delivery_destination#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/logs_delivery_destination awscc_logs_delivery_destination} Resource
  *
  * @param scope The scope in which to define this construct
