...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/fsx_data_repository_associations
...
export class DataAwsccFsxDataRepositoryAssociations extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccFsxDataRepositoryAssociations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/fsx_data_repository_associations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/fsx_data_repository_associations awscc_fsx_data_repository_associations} Data Source
  *
  * @param scope The scope in which to define this construct
