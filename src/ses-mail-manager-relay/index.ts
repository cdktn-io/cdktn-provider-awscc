...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ses_mail_manager_relay
...
export class SesMailManagerRelay extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SesMailManagerRelay that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ses_mail_manager_relay#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ses_mail_manager_relay awscc_ses_mail_manager_relay} Resource
  *
  * @param scope The scope in which to define this construct
