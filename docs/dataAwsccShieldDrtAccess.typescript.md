...
```typescript
import { dataAwsccShieldDrtAccess } from '@cdktn/provider-awscc'

new dataAwsccShieldDrtAccess.DataAwsccShieldDrtAccess(scope: Construct, id: string, config: DataAwsccShieldDrtAccessConfig)
```
...
dataAwsccShieldDrtAccess.DataAwsccShieldDrtAccess.isConstruct(x: any)
```
...
dataAwsccShieldDrtAccess.DataAwsccShieldDrtAccess.isTerraformElement(x: any)
```
...
dataAwsccShieldDrtAccess.DataAwsccShieldDrtAccess.isTerraformDataSource(x: any)
```
...
dataAwsccShieldDrtAccess.DataAwsccShieldDrtAccess.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccShieldDrtAccess.DataAwsccShieldDrtAccess.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccShieldDrtAccess.DataAwsccShieldDrtAccess.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccShieldDrtAccess.DataAwsccShieldDrtAccess.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccShieldDrtAccess.DataAwsccShieldDrtAccess.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccShieldDrtAccess.DataAwsccShieldDrtAccess.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccShieldDrtAccessConfig: dataAwsccShieldDrtAccess.DataAwsccShieldDrtAccessConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccShieldDrtAccess.DataAwsccShieldDrtAccessConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccShieldDrtAccess.DataAwsccShieldDrtAccessConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccShieldDrtAccess.DataAwsccShieldDrtAccessConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccShieldDrtAccess.DataAwsccShieldDrtAccessConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
