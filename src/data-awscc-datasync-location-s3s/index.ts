...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/datasync_location_s3s
...
export class DataAwsccDatasyncLocationS3S extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDatasyncLocationS3S that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/datasync_location_s3s#import import section} in the documentation of this resource for the id to use
