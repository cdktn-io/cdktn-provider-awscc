...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ce_cost_category
...
export class CeCostCategory extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CeCostCategory that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ce_cost_category#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ce_cost_category awscc_ce_cost_category} Resource
  *
  * @param scope The scope in which to define this construct
