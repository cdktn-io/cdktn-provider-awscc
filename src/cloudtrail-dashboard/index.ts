...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudtrail_dashboard
...
export interface CloudtrailDashboardRefreshScheduleFrequency {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudtrail_dashboard#unit CloudtrailDashboard#unit}
  */
  readonly unit?: string;
  /**
  * The frequency value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudtrail_dashboard#value CloudtrailDashboard#value}
  */
...
export interface CloudtrailDashboardRefreshSchedule {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudtrail_dashboard#frequency CloudtrailDashboard#frequency}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudtrail_dashboard#status CloudtrailDashboard#status}
  */
  readonly status?: string;
  /**
  * StartTime of the automatic schedule refresh.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudtrail_dashboard#time_of_day CloudtrailDashboard#time_of_day}
  */
...
export interface CloudtrailDashboardTags {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudtrail_dashboard#key CloudtrailDashboard#key}
  */
  readonly key?: string;
  /**
...
export interface CloudtrailDashboardWidgets {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudtrail_dashboard#query_parameters CloudtrailDashboard#query_parameters}
  */
  readonly queryParameters?: string[];
  /**
  * The SQL query statement on one or more event data stores.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudtrail_dashboard#query_statement CloudtrailDashboard#query_statement}
  */
  readonly queryStatement?: string;
  /**
  * The view properties of the widget.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudtrail_dashboard#view_properties CloudtrailDashboard#view_properties}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudtrail_dashboard awscc_cloudtrail_dashboard}
*/
export class CloudtrailDashboard extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudtrailDashboard that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudtrail_dashboard#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudtrail_dashboard awscc_cloudtrail_dashboard} Resource
  *
  * @param scope The scope in which to define this construct
