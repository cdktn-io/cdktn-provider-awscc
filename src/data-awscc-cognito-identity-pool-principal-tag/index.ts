...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/cognito_identity_pool_principal_tag
...
export class DataAwsccCognitoIdentityPoolPrincipalTag extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCognitoIdentityPoolPrincipalTag that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/cognito_identity_pool_principal_tag#import import section} in the documentation of this resource for the id to use
