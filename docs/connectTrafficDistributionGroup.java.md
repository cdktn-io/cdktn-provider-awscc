...
```java
import io.cdktn.providers.awscc.connect_traffic_distribution_group.ConnectTrafficDistributionGroup;

ConnectTrafficDistributionGroup.Builder.create(Construct scope, java.lang.String id)
...
//  .tags(IResolvable|java.util.List<ConnectTrafficDistributionGroupTags>)
    .build();
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.Initializer.parameter.scope">scope</a></code> | <code>software.constructs.Construct</code> | The scope in which to define this construct. |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.Initializer.parameter.id">id</a></code> | <code>java.lang.String</code> | The scoped construct ID. |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.Initializer.parameter.connection">connection</a></code> | <code>io.cdktn.cdktn.SSHProvisionerConnection\|io.cdktn.cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.Initializer.parameter.count">count</a></code> | <code>java.lang.Number\|io.cdktn.cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.Initializer.parameter.dependsOn">dependsOn</a></code> | <code>java.util.List<io.cdktn.cdktn.ITerraformDependable></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.Initializer.parameter.forEach">forEach</a></code> | <code>io.cdktn.cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.Initializer.parameter.lifecycle">lifecycle</a></code> | <code>io.cdktn.cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.Initializer.parameter.provider">provider</a></code> | <code>io.cdktn.cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.Initializer.parameter.provisioners">provisioners</a></code> | <code>java.util.List<io.cdktn.cdktn.FileProvisioner\|io.cdktn.cdktn.LocalExecProvisioner\|io.cdktn.cdktn.RemoteExecProvisioner></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.Initializer.parameter.instanceArn">instanceArn</a></code> | <code>java.lang.String</code> | The identifier of the Amazon Connect instance that has been replicated. |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.Initializer.parameter.name">name</a></code> | <code>java.lang.String</code> | The name for the traffic distribution group. |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.Initializer.parameter.description">description</a></code> | <code>java.lang.String</code> | A description for the traffic distribution group. |
...
##### `dependsOn`<sup>Optional</sup> <a name="dependsOn" id="@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.Initializer.parameter.dependsOn"></a>

- *Type:* java.util.List<io.cdktn.cdktn.ITerraformDependable>

---

##### `forEach`<sup>Optional</sup> <a name="forEach" id="@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.Initializer.parameter.forEach"></a>
...
##### `instanceArn`<sup>Required</sup> <a name="instanceArn" id="@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.Initializer.parameter.instanceArn"></a>
...
- *Type:* io.cdktn.cdktn.IResolvable|java.util.List<<a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupTags">ConnectTrafficDistributionGroupTags</a>>
...
```java
public void putTags(IResolvable|java.util.List<ConnectTrafficDistributionGroupTags> value)
```
...
ConnectTrafficDistributionGroup.isConstruct(java.lang.Object x)
```
...
ConnectTrafficDistributionGroup.isTerraformElement(java.lang.Object x)
```
...
ConnectTrafficDistributionGroup.isTerraformResource(java.lang.Object x)
```
...
ConnectTrafficDistributionGroup.generateConfigForImport(Construct scope, java.lang.String importToId, java.lang.String importFromId),ConnectTrafficDistributionGroup.generateConfigForImport(Construct scope, java.lang.String importToId, java.lang.String importFromId, TerraformProvider provider)
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.node">node</a></code> | <code>software.constructs.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.cdktfStack">cdktfStack</a></code> | <code>io.cdktn.cdktn.TerraformStack</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.fqn">fqn</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.friendlyUniqueId">friendlyUniqueId</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>java.util.Map<java.lang.String, java.lang.Object></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.terraformResourceType">terraformResourceType</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>io.cdktn.cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.connection">connection</a></code> | <code>io.cdktn.cdktn.SSHProvisionerConnection\|io.cdktn.cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.count">count</a></code> | <code>java.lang.Number\|io.cdktn.cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.dependsOn">dependsOn</a></code> | <code>java.util.List<java.lang.String></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.forEach">forEach</a></code> | <code>io.cdktn.cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.lifecycle">lifecycle</a></code> | <code>io.cdktn.cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.provider">provider</a></code> | <code>io.cdktn.cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.provisioners">provisioners</a></code> | <code>java.util.List<io.cdktn.cdktn.FileProvisioner\|io.cdktn.cdktn.LocalExecProvisioner\|io.cdktn.cdktn.RemoteExecProvisioner></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.id">id</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.isDefault">isDefault</a></code> | <code>io.cdktn.cdktn.IResolvable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.status">status</a></code> | <code>java.lang.String</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.trafficDistributionGroupArn">trafficDistributionGroupArn</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.descriptionInput">descriptionInput</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.instanceArnInput">instanceArnInput</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.nameInput">nameInput</a></code> | <code>java.lang.String</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.description">description</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.instanceArn">instanceArn</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.name">name</a></code> | <code>java.lang.String</code> | *No description.* |
...
```java
public ConnectTrafficDistributionGroupTagsList getTags();
```
...
```java
public java.lang.String getTrafficDistributionGroupArn();
```
...
```java
public IResolvable|java.util.List<ConnectTrafficDistributionGroupTags> getTagsInput();
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroup.property.tfResourceType">tfResourceType</a></code> | <code>java.lang.String</code> | *No description.* |
...
```java
import io.cdktn.providers.awscc.connect_traffic_distribution_group.ConnectTrafficDistributionGroupConfig;

ConnectTrafficDistributionGroupConfig.builder()
//  .connection(SSHProvisionerConnection|WinrmProvisionerConnection)
//  .count(java.lang.Number|TerraformCount)
//  .dependsOn(java.util.List<ITerraformDependable>)
//  .forEach(ITerraformIterator)
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupConfig.property.connection">connection</a></code> | <code>io.cdktn.cdktn.SSHProvisionerConnection\|io.cdktn.cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupConfig.property.count">count</a></code> | <code>java.lang.Number\|io.cdktn.cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupConfig.property.dependsOn">dependsOn</a></code> | <code>java.util.List<io.cdktn.cdktn.ITerraformDependable></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupConfig.property.forEach">forEach</a></code> | <code>io.cdktn.cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupConfig.property.lifecycle">lifecycle</a></code> | <code>io.cdktn.cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupConfig.property.provider">provider</a></code> | <code>io.cdktn.cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupConfig.property.provisioners">provisioners</a></code> | <code>java.util.List<io.cdktn.cdktn.FileProvisioner\|io.cdktn.cdktn.LocalExecProvisioner\|io.cdktn.cdktn.RemoteExecProvisioner></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupConfig.property.instanceArn">instanceArn</a></code> | <code>java.lang.String</code> | The identifier of the Amazon Connect instance that has been replicated. |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupConfig.property.name">name</a></code> | <code>java.lang.String</code> | The name for the traffic distribution group. |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupConfig.property.description">description</a></code> | <code>java.lang.String</code> | A description for the traffic distribution group. |
...
```java
public IResolvable|java.util.List<ConnectTrafficDistributionGroupTags> getTags();
```
...
```java
import io.cdktn.providers.awscc.connect_traffic_distribution_group.ConnectTrafficDistributionGroupTags;

ConnectTrafficDistributionGroupTags.builder()
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupTags.property.key">key</a></code> | <code>java.lang.String</code> | The key name of the tag. |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupTags.property.value">value</a></code> | <code>java.lang.String</code> | The value for the tag. |
...
```java
import io.cdktn.providers.awscc.connect_traffic_distribution_group.ConnectTrafficDistributionGroupTagsList;

new ConnectTrafficDistributionGroupTagsList(IInterpolatingParent terraformResource, java.lang.String terraformAttribute, java.lang.Boolean wrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>io.cdktn.cdktn.IInterpolatingParent</code> | The parent resource. |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupTagsList.Initializer.parameter.terraformAttribute">terraformAttribute</a></code> | <code>java.lang.String</code> | The attribute on the parent resource this class is referencing. |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>java.lang.Boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```java
public ConnectTrafficDistributionGroupTagsOutputReference get(java.lang.Number index)
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupTagsList.property.creationStack">creationStack</a></code> | <code>java.util.List<java.lang.String></code> | The creation stack of this resolvable which will be appended to errors thrown during resolution. |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupTagsList.property.fqn">fqn</a></code> | <code>java.lang.String</code> | *No description.* |
...
```java
public IResolvable|java.util.List<ConnectTrafficDistributionGroupTags> getInternalValue();
```
...
```java
import io.cdktn.providers.awscc.connect_traffic_distribution_group.ConnectTrafficDistributionGroupTagsOutputReference;

new ConnectTrafficDistributionGroupTagsOutputReference(IInterpolatingParent terraformResource, java.lang.String terraformAttribute, java.lang.Number complexObjectIndex, java.lang.Boolean complexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>io.cdktn.cdktn.IInterpolatingParent</code> | The parent resource. |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupTagsOutputReference.Initializer.parameter.terraformAttribute">terraformAttribute</a></code> | <code>java.lang.String</code> | The attribute on the parent resource this class is referencing. |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>java.lang.Number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupTagsOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>java.lang.Boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupTagsOutputReference.property.creationStack">creationStack</a></code> | <code>java.util.List<java.lang.String></code> | The creation stack of this resolvable which will be appended to errors thrown during resolution. |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupTagsOutputReference.property.fqn">fqn</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupTagsOutputReference.property.keyInput">keyInput</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupTagsOutputReference.property.valueInput">valueInput</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupTagsOutputReference.property.key">key</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupTagsOutputReference.property.value">value</a></code> | <code>java.lang.String</code> | *No description.* |
...
```java
public IResolvable|ConnectTrafficDistributionGroupTags getInternalValue();
```

- *Type:* io.cdktn.cdktn.IResolvable|<a href="#@cdktn/provider-awscc.connectTrafficDistributionGroup.ConnectTrafficDistributionGroupTags">ConnectTrafficDistributionGroupTags</a>
