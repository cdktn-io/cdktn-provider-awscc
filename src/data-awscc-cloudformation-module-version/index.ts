...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/cloudformation_module_version
...
export class DataAwsccCloudformationModuleVersion extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCloudformationModuleVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/cloudformation_module_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/cloudformation_module_version awscc_cloudformation_module_version} Data Source
  *
  * @param scope The scope in which to define this construct
