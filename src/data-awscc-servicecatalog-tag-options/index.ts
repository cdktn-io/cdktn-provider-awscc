...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/servicecatalog_tag_options
...
export class DataAwsccServicecatalogTagOptions extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccServicecatalogTagOptions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/servicecatalog_tag_options#import import section} in the documentation of this resource for the id to use
