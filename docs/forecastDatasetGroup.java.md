...
Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/forecast_dataset_group awscc_forecast_dataset_group}.

#### Initializers <a name="Initializers" id="@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.Initializer"></a>

```java
import io.cdktn.providers.awscc.forecast_dataset_group.ForecastDatasetGroup;

ForecastDatasetGroup.Builder.create(Construct scope, java.lang.String id)
...
//  .provisioners(java.util.List<FileProvisioner|LocalExecProvisioner|RemoteExecProvisioner>)
    .datasetGroupName(java.lang.String)
    .domain(java.lang.String)
//  .datasetArns(java.util.List<java.lang.String>)
//  .tags(IResolvable|java.util.List<ForecastDatasetGroupTags>)
    .build();
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.Initializer.parameter.scope">scope</a></code> | <code>software.constructs.Construct</code> | The scope in which to define this construct. |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.Initializer.parameter.id">id</a></code> | <code>java.lang.String</code> | The scoped construct ID. |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.Initializer.parameter.connection">connection</a></code> | <code>io.cdktn.cdktn.SSHProvisionerConnection\|io.cdktn.cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.Initializer.parameter.count">count</a></code> | <code>java.lang.Number\|io.cdktn.cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.Initializer.parameter.dependsOn">dependsOn</a></code> | <code>java.util.List<io.cdktn.cdktn.ITerraformDependable></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.Initializer.parameter.forEach">forEach</a></code> | <code>io.cdktn.cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.Initializer.parameter.lifecycle">lifecycle</a></code> | <code>io.cdktn.cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.Initializer.parameter.provider">provider</a></code> | <code>io.cdktn.cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.Initializer.parameter.provisioners">provisioners</a></code> | <code>java.util.List<io.cdktn.cdktn.FileProvisioner\|io.cdktn.cdktn.LocalExecProvisioner\|io.cdktn.cdktn.RemoteExecProvisioner></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.Initializer.parameter.datasetGroupName">datasetGroupName</a></code> | <code>java.lang.String</code> | A name for the dataset group. |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.Initializer.parameter.domain">domain</a></code> | <code>java.lang.String</code> | The domain associated with the dataset group. |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.Initializer.parameter.datasetArns">datasetArns</a></code> | <code>java.util.List<java.lang.String></code> | An array of Amazon Resource Names (ARNs) of the datasets that you want to include in the dataset group. |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.Initializer.parameter.tags">tags</a></code> | <code>io.cdktn.cdktn.IResolvable\|java.util.List<<a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTags">ForecastDatasetGroupTags</a>></code> | The tags of Application Insights application. |
...
##### `connection`<sup>Optional</sup> <a name="connection" id="@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.Initializer.parameter.connection"></a>

- *Type:* io.cdktn.cdktn.SSHProvisionerConnection|io.cdktn.cdktn.WinrmProvisionerConnection

---

##### `count`<sup>Optional</sup> <a name="count" id="@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.Initializer.parameter.count"></a>

- *Type:* java.lang.Number|io.cdktn.cdktn.TerraformCount

---

##### `dependsOn`<sup>Optional</sup> <a name="dependsOn" id="@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.Initializer.parameter.dependsOn"></a>

- *Type:* java.util.List<io.cdktn.cdktn.ITerraformDependable>

---

##### `forEach`<sup>Optional</sup> <a name="forEach" id="@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.Initializer.parameter.forEach"></a>

- *Type:* io.cdktn.cdktn.ITerraformIterator

---

##### `lifecycle`<sup>Optional</sup> <a name="lifecycle" id="@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.Initializer.parameter.lifecycle"></a>

- *Type:* io.cdktn.cdktn.TerraformResourceLifecycle

---

##### `provider`<sup>Optional</sup> <a name="provider" id="@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.Initializer.parameter.provider"></a>

- *Type:* io.cdktn.cdktn.TerraformProvider

---

##### `provisioners`<sup>Optional</sup> <a name="provisioners" id="@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.Initializer.parameter.provisioners"></a>

- *Type:* java.util.List<io.cdktn.cdktn.FileProvisioner|io.cdktn.cdktn.LocalExecProvisioner|io.cdktn.cdktn.RemoteExecProvisioner>

---

##### `datasetGroupName`<sup>Required</sup> <a name="datasetGroupName" id="@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.Initializer.parameter.datasetGroupName"></a>

- *Type:* java.lang.String

A name for the dataset group.

Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/forecast_dataset_group#dataset_group_name ForecastDatasetGroup#dataset_group_name}

---

##### `domain`<sup>Required</sup> <a name="domain" id="@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.Initializer.parameter.domain"></a>
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/forecast_dataset_group#domain ForecastDatasetGroup#domain}

---

##### `datasetArns`<sup>Optional</sup> <a name="datasetArns" id="@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.Initializer.parameter.datasetArns"></a>

- *Type:* java.util.List<java.lang.String>

An array of Amazon Resource Names (ARNs) of the datasets that you want to include in the dataset group.

Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/forecast_dataset_group#dataset_arns ForecastDatasetGroup#dataset_arns}

---

##### `tags`<sup>Optional</sup> <a name="tags" id="@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.Initializer.parameter.tags"></a>

- *Type:* io.cdktn.cdktn.IResolvable|java.util.List<<a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTags">ForecastDatasetGroupTags</a>>

The tags of Application Insights application.

Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/forecast_dataset_group#tags ForecastDatasetGroup#tags}
...
```java
public void putTags(IResolvable|java.util.List<ForecastDatasetGroupTags> value)
```
...
ForecastDatasetGroup.isConstruct(java.lang.Object x)
```
...
ForecastDatasetGroup.isTerraformElement(java.lang.Object x)
```
...
ForecastDatasetGroup.isTerraformResource(java.lang.Object x)
```
...
ForecastDatasetGroup.generateConfigForImport(Construct scope, java.lang.String importToId, java.lang.String importFromId),ForecastDatasetGroup.generateConfigForImport(Construct scope, java.lang.String importToId, java.lang.String importFromId, TerraformProvider provider)
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/forecast_dataset_group#import import section} in the documentation of this resource for the id to use
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.node">node</a></code> | <code>software.constructs.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.cdktfStack">cdktfStack</a></code> | <code>io.cdktn.cdktn.TerraformStack</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.fqn">fqn</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.friendlyUniqueId">friendlyUniqueId</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>java.util.Map<java.lang.String, java.lang.Object></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.terraformResourceType">terraformResourceType</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>io.cdktn.cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.connection">connection</a></code> | <code>io.cdktn.cdktn.SSHProvisionerConnection\|io.cdktn.cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.count">count</a></code> | <code>java.lang.Number\|io.cdktn.cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.dependsOn">dependsOn</a></code> | <code>java.util.List<java.lang.String></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.forEach">forEach</a></code> | <code>io.cdktn.cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.lifecycle">lifecycle</a></code> | <code>io.cdktn.cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.provider">provider</a></code> | <code>io.cdktn.cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.provisioners">provisioners</a></code> | <code>java.util.List<io.cdktn.cdktn.FileProvisioner\|io.cdktn.cdktn.LocalExecProvisioner\|io.cdktn.cdktn.RemoteExecProvisioner></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.datasetGroupArn">datasetGroupArn</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.id">id</a></code> | <code>java.lang.String</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.datasetArnsInput">datasetArnsInput</a></code> | <code>java.util.List<java.lang.String></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.datasetGroupNameInput">datasetGroupNameInput</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.domainInput">domainInput</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.tagsInput">tagsInput</a></code> | <code>io.cdktn.cdktn.IResolvable\|java.util.List<<a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTags">ForecastDatasetGroupTags</a>></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.datasetArns">datasetArns</a></code> | <code>java.util.List<java.lang.String></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.datasetGroupName">datasetGroupName</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.domain">domain</a></code> | <code>java.lang.String</code> | *No description.* |
...
```java
public ForecastDatasetGroupTagsList getTags();
```
...
```java
public java.util.List<java.lang.String> getDatasetArnsInput();
```
...
```java
public java.lang.String getDatasetGroupNameInput();
```
...
```java
public IResolvable|java.util.List<ForecastDatasetGroupTags> getTagsInput();
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroup.property.tfResourceType">tfResourceType</a></code> | <code>java.lang.String</code> | *No description.* |
...
```java
import io.cdktn.providers.awscc.forecast_dataset_group.ForecastDatasetGroupConfig;

ForecastDatasetGroupConfig.builder()
//  .connection(SSHProvisionerConnection|WinrmProvisionerConnection)
//  .count(java.lang.Number|TerraformCount)
//  .dependsOn(java.util.List<ITerraformDependable>)
//  .forEach(ITerraformIterator)
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupConfig.property.connection">connection</a></code> | <code>io.cdktn.cdktn.SSHProvisionerConnection\|io.cdktn.cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupConfig.property.count">count</a></code> | <code>java.lang.Number\|io.cdktn.cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupConfig.property.dependsOn">dependsOn</a></code> | <code>java.util.List<io.cdktn.cdktn.ITerraformDependable></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupConfig.property.forEach">forEach</a></code> | <code>io.cdktn.cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupConfig.property.lifecycle">lifecycle</a></code> | <code>io.cdktn.cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupConfig.property.provider">provider</a></code> | <code>io.cdktn.cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupConfig.property.provisioners">provisioners</a></code> | <code>java.util.List<io.cdktn.cdktn.FileProvisioner\|io.cdktn.cdktn.LocalExecProvisioner\|io.cdktn.cdktn.RemoteExecProvisioner></code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupConfig.property.datasetGroupName">datasetGroupName</a></code> | <code>java.lang.String</code> | A name for the dataset group. |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupConfig.property.domain">domain</a></code> | <code>java.lang.String</code> | The domain associated with the dataset group. |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupConfig.property.datasetArns">datasetArns</a></code> | <code>java.util.List<java.lang.String></code> | An array of Amazon Resource Names (ARNs) of the datasets that you want to include in the dataset group. |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupConfig.property.tags">tags</a></code> | <code>io.cdktn.cdktn.IResolvable\|java.util.List<<a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTags">ForecastDatasetGroupTags</a>></code> | The tags of Application Insights application. |
...
```java
public IResolvable|java.util.List<ForecastDatasetGroupTags> getTags();
```
...
```java
import io.cdktn.providers.awscc.forecast_dataset_group.ForecastDatasetGroupTags;

ForecastDatasetGroupTags.builder()
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTags.property.key">key</a></code> | <code>java.lang.String</code> | The key name of the tag. |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTags.property.value">value</a></code> | <code>java.lang.String</code> | The value for the tag. |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/forecast_dataset_group#key ForecastDatasetGroup#key}
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/forecast_dataset_group#value ForecastDatasetGroup#value}
...
```java
import io.cdktn.providers.awscc.forecast_dataset_group.ForecastDatasetGroupTagsList;

new ForecastDatasetGroupTagsList(IInterpolatingParent terraformResource, java.lang.String terraformAttribute, java.lang.Boolean wrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>io.cdktn.cdktn.IInterpolatingParent</code> | The parent resource. |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTagsList.Initializer.parameter.terraformAttribute">terraformAttribute</a></code> | <code>java.lang.String</code> | The attribute on the parent resource this class is referencing. |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>java.lang.Boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```java
public ForecastDatasetGroupTagsOutputReference get(java.lang.Number index)
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTagsList.property.creationStack">creationStack</a></code> | <code>java.util.List<java.lang.String></code> | The creation stack of this resolvable which will be appended to errors thrown during resolution. |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTagsList.property.fqn">fqn</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTagsList.property.internalValue">internalValue</a></code> | <code>io.cdktn.cdktn.IResolvable\|java.util.List<<a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTags">ForecastDatasetGroupTags</a>></code> | *No description.* |
...
```java
public IResolvable|java.util.List<ForecastDatasetGroupTags> getInternalValue();
```
...
```java
import io.cdktn.providers.awscc.forecast_dataset_group.ForecastDatasetGroupTagsOutputReference;

new ForecastDatasetGroupTagsOutputReference(IInterpolatingParent terraformResource, java.lang.String terraformAttribute, java.lang.Number complexObjectIndex, java.lang.Boolean complexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>io.cdktn.cdktn.IInterpolatingParent</code> | The parent resource. |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTagsOutputReference.Initializer.parameter.terraformAttribute">terraformAttribute</a></code> | <code>java.lang.String</code> | The attribute on the parent resource this class is referencing. |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>java.lang.Number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTagsOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>java.lang.Boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTagsOutputReference.property.creationStack">creationStack</a></code> | <code>java.util.List<java.lang.String></code> | The creation stack of this resolvable which will be appended to errors thrown during resolution. |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTagsOutputReference.property.fqn">fqn</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTagsOutputReference.property.keyInput">keyInput</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTagsOutputReference.property.valueInput">valueInput</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTagsOutputReference.property.key">key</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTagsOutputReference.property.value">value</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTagsOutputReference.property.internalValue">internalValue</a></code> | <code>io.cdktn.cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTags">ForecastDatasetGroupTags</a></code> | *No description.* |
...
```java
public IResolvable|ForecastDatasetGroupTags getInternalValue();
```

- *Type:* io.cdktn.cdktn.IResolvable|<a href="#@cdktn/provider-awscc.forecastDatasetGroup.ForecastDatasetGroupTags">ForecastDatasetGroupTags</a>
