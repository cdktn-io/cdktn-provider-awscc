...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/opensearch_data_source
...
export class DataAwsccOpensearchDataSource extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccOpensearchDataSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/opensearch_data_source#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/opensearch_data_source awscc_opensearch_data_source} Data Source
  *
  * @param scope The scope in which to define this construct
