...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/iotwireless_wireless_devices
...
export class DataAwsccIotwirelessWirelessDevices extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIotwirelessWirelessDevices that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/iotwireless_wireless_devices#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/iotwireless_wireless_devices awscc_iotwireless_wireless_devices} Data Source
  *
  * @param scope The scope in which to define this construct
