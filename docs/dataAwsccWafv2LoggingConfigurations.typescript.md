...
```typescript
import { dataAwsccWafv2LoggingConfigurations } from '@cdktn/provider-awscc'

new dataAwsccWafv2LoggingConfigurations.DataAwsccWafv2LoggingConfigurations(scope: Construct, id: string, config?: DataAwsccWafv2LoggingConfigurationsConfig)
```
...
dataAwsccWafv2LoggingConfigurations.DataAwsccWafv2LoggingConfigurations.isConstruct(x: any)
```
...
dataAwsccWafv2LoggingConfigurations.DataAwsccWafv2LoggingConfigurations.isTerraformElement(x: any)
```
...
dataAwsccWafv2LoggingConfigurations.DataAwsccWafv2LoggingConfigurations.isTerraformDataSource(x: any)
```
...
dataAwsccWafv2LoggingConfigurations.DataAwsccWafv2LoggingConfigurations.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWafv2LoggingConfigurations.DataAwsccWafv2LoggingConfigurations.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWafv2LoggingConfigurations.DataAwsccWafv2LoggingConfigurations.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWafv2LoggingConfigurations.DataAwsccWafv2LoggingConfigurations.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccWafv2LoggingConfigurations.DataAwsccWafv2LoggingConfigurations.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWafv2LoggingConfigurations.DataAwsccWafv2LoggingConfigurations.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccWafv2LoggingConfigurationsConfig: dataAwsccWafv2LoggingConfigurations.DataAwsccWafv2LoggingConfigurationsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWafv2LoggingConfigurations.DataAwsccWafv2LoggingConfigurationsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccWafv2LoggingConfigurations.DataAwsccWafv2LoggingConfigurationsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccWafv2LoggingConfigurations.DataAwsccWafv2LoggingConfigurationsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWafv2LoggingConfigurations.DataAwsccWafv2LoggingConfigurationsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
