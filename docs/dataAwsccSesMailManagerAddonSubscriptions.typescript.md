...
```typescript
import { dataAwsccSesMailManagerAddonSubscriptions } from '@cdktn/provider-awscc'

new dataAwsccSesMailManagerAddonSubscriptions.DataAwsccSesMailManagerAddonSubscriptions(scope: Construct, id: string, config?: DataAwsccSesMailManagerAddonSubscriptionsConfig)
```
...
dataAwsccSesMailManagerAddonSubscriptions.DataAwsccSesMailManagerAddonSubscriptions.isConstruct(x: any)
```
...
dataAwsccSesMailManagerAddonSubscriptions.DataAwsccSesMailManagerAddonSubscriptions.isTerraformElement(x: any)
```
...
dataAwsccSesMailManagerAddonSubscriptions.DataAwsccSesMailManagerAddonSubscriptions.isTerraformDataSource(x: any)
```
...
dataAwsccSesMailManagerAddonSubscriptions.DataAwsccSesMailManagerAddonSubscriptions.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerAddonSubscriptions.DataAwsccSesMailManagerAddonSubscriptions.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerAddonSubscriptions.DataAwsccSesMailManagerAddonSubscriptions.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerAddonSubscriptions.DataAwsccSesMailManagerAddonSubscriptions.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerAddonSubscriptions.DataAwsccSesMailManagerAddonSubscriptions.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerAddonSubscriptions.DataAwsccSesMailManagerAddonSubscriptions.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccSesMailManagerAddonSubscriptionsConfig: dataAwsccSesMailManagerAddonSubscriptions.DataAwsccSesMailManagerAddonSubscriptionsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerAddonSubscriptions.DataAwsccSesMailManagerAddonSubscriptionsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerAddonSubscriptions.DataAwsccSesMailManagerAddonSubscriptionsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerAddonSubscriptions.DataAwsccSesMailManagerAddonSubscriptionsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSesMailManagerAddonSubscriptions.DataAwsccSesMailManagerAddonSubscriptionsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
