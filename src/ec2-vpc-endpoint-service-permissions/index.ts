...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ec2_vpc_endpoint_service_permissions
...
export class Ec2VpcEndpointServicePermissions extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2VpcEndpointServicePermissions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ec2_vpc_endpoint_service_permissions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ec2_vpc_endpoint_service_permissions awscc_ec2_vpc_endpoint_service_permissions} Resource
  *
  * @param scope The scope in which to define this construct
