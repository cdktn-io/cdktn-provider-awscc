...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/securityhub_organization_configuration
...
export class DataAwsccSecurityhubOrganizationConfiguration extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccSecurityhubOrganizationConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/securityhub_organization_configuration#import import section} in the documentation of this resource for the id to use
