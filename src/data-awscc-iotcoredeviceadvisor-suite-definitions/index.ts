...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/iotcoredeviceadvisor_suite_definitions
...
export class DataAwsccIotcoredeviceadvisorSuiteDefinitions extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIotcoredeviceadvisorSuiteDefinitions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/iotcoredeviceadvisor_suite_definitions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/iotcoredeviceadvisor_suite_definitions awscc_iotcoredeviceadvisor_suite_definitions} Data Source
  *
  * @param scope The scope in which to define this construct
