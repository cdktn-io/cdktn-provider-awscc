...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccdeadlinequeuelimitassociation"

dataawsccdeadlinequeuelimitassociation.NewDataAwsccDeadlineQueueLimitAssociation(scope Construct, id *string, config DataAwsccDeadlineQueueLimitAssociationConfig) DataAwsccDeadlineQueueLimitAssociation
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDeadlineQueueLimitAssociation.DataAwsccDeadlineQueueLimitAssociation.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
dataawsccdeadlinequeuelimitassociation.DataAwsccDeadlineQueueLimitAssociation_IsConstruct(x interface{}) *bool
```
...
dataawsccdeadlinequeuelimitassociation.DataAwsccDeadlineQueueLimitAssociation_IsTerraformElement(x interface{}) *bool
```
...
dataawsccdeadlinequeuelimitassociation.DataAwsccDeadlineQueueLimitAssociation_IsTerraformDataSource(x interface{}) *bool
```
...
dataawsccdeadlinequeuelimitassociation.DataAwsccDeadlineQueueLimitAssociation_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDeadlineQueueLimitAssociation.DataAwsccDeadlineQueueLimitAssociation.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDeadlineQueueLimitAssociation.DataAwsccDeadlineQueueLimitAssociation.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDeadlineQueueLimitAssociation.DataAwsccDeadlineQueueLimitAssociation.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDeadlineQueueLimitAssociation.DataAwsccDeadlineQueueLimitAssociation.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDeadlineQueueLimitAssociation.DataAwsccDeadlineQueueLimitAssociation.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDeadlineQueueLimitAssociation.DataAwsccDeadlineQueueLimitAssociation.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDeadlineQueueLimitAssociation.DataAwsccDeadlineQueueLimitAssociation.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDeadlineQueueLimitAssociation.DataAwsccDeadlineQueueLimitAssociation.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
...
&dataawsccdeadlinequeuelimitassociation.DataAwsccDeadlineQueueLimitAssociationConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDeadlineQueueLimitAssociation.DataAwsccDeadlineQueueLimitAssociationConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDeadlineQueueLimitAssociation.DataAwsccDeadlineQueueLimitAssociationConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDeadlineQueueLimitAssociation.DataAwsccDeadlineQueueLimitAssociationConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDeadlineQueueLimitAssociation.DataAwsccDeadlineQueueLimitAssociationConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDeadlineQueueLimitAssociation.DataAwsccDeadlineQueueLimitAssociationConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDeadlineQueueLimitAssociation.DataAwsccDeadlineQueueLimitAssociationConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDeadlineQueueLimitAssociation.DataAwsccDeadlineQueueLimitAssociationConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
