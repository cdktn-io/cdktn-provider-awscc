...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/ec2_ipam_prefix_list_resolver_targets
...
export class DataAwsccEc2IpamPrefixListResolverTargets extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEc2IpamPrefixListResolverTargets that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/ec2_ipam_prefix_list_resolver_targets#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/ec2_ipam_prefix_list_resolver_targets awscc_ec2_ipam_prefix_list_resolver_targets} Data Source
  *
  * @param scope The scope in which to define this construct
