...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/fms_resource_set
...
export class FmsResourceSet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FmsResourceSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/fms_resource_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/fms_resource_set awscc_fms_resource_set} Resource
  *
  * @param scope The scope in which to define this construct
