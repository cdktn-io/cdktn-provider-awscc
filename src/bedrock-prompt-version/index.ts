...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/bedrock_prompt_version
...
export class BedrockPromptVersion extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BedrockPromptVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/bedrock_prompt_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/bedrock_prompt_version awscc_bedrock_prompt_version} Resource
  *
  * @param scope The scope in which to define this construct
