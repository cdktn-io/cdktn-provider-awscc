...
| <code><a href="#@cdktn/provider-awscc.snsTopic.SnsTopic.resetMaximumMessageSize">ResetMaximumMessageSize</a></code> | *No description.* |
...
##### `ResetMaximumMessageSize` <a name="ResetMaximumMessageSize" id="@cdktn/provider-awscc.snsTopic.SnsTopic.resetMaximumMessageSize"></a>
...
| <code><a href="#@cdktn/provider-awscc.snsTopic.SnsTopic.property.maximumMessageSizeInput">MaximumMessageSizeInput</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.snsTopic.SnsTopic.property.maximumMessageSize">MaximumMessageSize</a></code> | <code>*f64</code> | *No description.* |
...
##### `MaximumMessageSizeInput`<sup>Optional</sup> <a name="MaximumMessageSizeInput" id="@cdktn/provider-awscc.snsTopic.SnsTopic.property.maximumMessageSizeInput"></a>
...
##### `MaximumMessageSize`<sup>Required</sup> <a name="MaximumMessageSize" id="@cdktn/provider-awscc.snsTopic.SnsTopic.property.maximumMessageSize"></a>
...
| <code><a href="#@cdktn/provider-awscc.snsTopic.SnsTopicConfig.property.maximumMessageSize">MaximumMessageSize</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/sns_topic#maximum_message_size SnsTopic#maximum_message_size}. |
...
##### `MaximumMessageSize`<sup>Optional</sup> <a name="MaximumMessageSize" id="@cdktn/provider-awscc.snsTopic.SnsTopicConfig.property.maximumMessageSize"></a>
