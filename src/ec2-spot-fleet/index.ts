...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/ec2_spot_fleet
...
export class Ec2SpotFleet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2SpotFleet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/ec2_spot_fleet#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/ec2_spot_fleet awscc_ec2_spot_fleet} Resource
  *
  * @param scope The scope in which to define this construct
