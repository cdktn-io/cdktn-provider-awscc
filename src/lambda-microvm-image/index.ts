...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/lambda_microvm_image
...
export class LambdaMicrovmImage extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LambdaMicrovmImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/lambda_microvm_image#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/lambda_microvm_image awscc_lambda_microvm_image} Resource
  *
  * @param scope The scope in which to define this construct
