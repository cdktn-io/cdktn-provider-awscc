...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ssmincidents_response_plan
...
export class DataAwsccSsmincidentsResponsePlan extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccSsmincidentsResponsePlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ssmincidents_response_plan#import import section} in the documentation of this resource for the id to use
