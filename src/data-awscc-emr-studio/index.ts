...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/emr_studio
...
export class DataAwsccEmrStudio extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEmrStudio that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/emr_studio#import import section} in the documentation of this resource for the id to use
