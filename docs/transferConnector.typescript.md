...
```typescript
public readonly orderedUserSecretVersionStages: string[];
```
...
```typescript
public resetOrderedUserSecretVersionStages(): void
```
...
```typescript
public readonly orderedUserSecretVersionStagesInput: string[];
```
