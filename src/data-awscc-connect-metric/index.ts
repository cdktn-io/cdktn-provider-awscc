...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/connect_metric
...
export interface DataAwsccConnectMetricConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/connect_metric#id DataAwsccConnectMetric#id}
  *
...
export class DataAwsccConnectMetric extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccConnectMetric that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/connect_metric#import import section} in the documentation of this resource for the id to use
