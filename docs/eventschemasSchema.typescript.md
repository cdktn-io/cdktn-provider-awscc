...
```typescript
import { eventschemasSchema } from '@cdktn/provider-awscc'

new eventschemasSchema.EventschemasSchema(scope: Construct, id: string, config: EventschemasSchemaConfig)
```
...
```typescript
public putTags(value: IResolvable | EventschemasSchemaTags[]): void
```
...
eventschemasSchema.EventschemasSchema.isConstruct(x: any)
```
...
eventschemasSchema.EventschemasSchema.isTerraformElement(x: any)
```
...
eventschemasSchema.EventschemasSchema.isTerraformResource(x: any)
```
...
eventschemasSchema.EventschemasSchema.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.eventschemasSchema.EventschemasSchema.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.eventschemasSchema.EventschemasSchema.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.eventschemasSchema.EventschemasSchema.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.eventschemasSchema.EventschemasSchema.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.eventschemasSchema.EventschemasSchema.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.eventschemasSchema.EventschemasSchema.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.eventschemasSchema.EventschemasSchema.property.tagsInput">tagsInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.eventschemasSchema.EventschemasSchemaTags">EventschemasSchemaTags</a>[]</code> | *No description.* |
...
```typescript
public readonly tags: EventschemasSchemaTagsList;
```
...
```typescript
public readonly tagsInput: IResolvable | EventschemasSchemaTags[];
```
...
const eventschemasSchemaConfig: eventschemasSchema.EventschemasSchemaConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.eventschemasSchema.EventschemasSchemaConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.eventschemasSchema.EventschemasSchemaConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.eventschemasSchema.EventschemasSchemaConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.eventschemasSchema.EventschemasSchemaConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.eventschemasSchema.EventschemasSchemaConfig.property.tags">tags</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.eventschemasSchema.EventschemasSchemaTags">EventschemasSchemaTags</a>[]</code> | Tags associated with the resource. |
...
```typescript
public readonly tags: IResolvable | EventschemasSchemaTags[];
```
...
const eventschemasSchemaTags: eventschemasSchema.EventschemasSchemaTags = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.eventschemasSchema.EventschemasSchemaTags.property.key">key</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/eventschemas_schema#key EventschemasSchema#key}. |
| <code><a href="#@cdktn/provider-awscc.eventschemasSchema.EventschemasSchemaTags.property.value">value</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/eventschemas_schema#value EventschemasSchema#value}. |
...
new eventschemasSchema.EventschemasSchemaTagsList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.eventschemasSchema.EventschemasSchemaTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.eventschemasSchema.EventschemasSchemaTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| <code><a href="#@cdktn/provider-awscc.eventschemasSchema.EventschemasSchemaTagsList.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.eventschemasSchema.EventschemasSchemaTags">EventschemasSchemaTags</a>[]</code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | EventschemasSchemaTags[];
```
...
new eventschemasSchema.EventschemasSchemaTagsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.eventschemasSchema.EventschemasSchemaTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.eventschemasSchema.EventschemasSchemaTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-awscc.eventschemasSchema.EventschemasSchemaTagsOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| <code><a href="#@cdktn/provider-awscc.eventschemasSchema.EventschemasSchemaTagsOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.eventschemasSchema.EventschemasSchemaTags">EventschemasSchemaTags</a></code> | *No description.* |
