...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/cleanroomsml_training_datasets
...
export class DataAwsccCleanroomsmlTrainingDatasets extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCleanroomsmlTrainingDatasets that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/cleanroomsml_training_datasets#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/cleanroomsml_training_datasets awscc_cleanroomsml_training_datasets} Data Source
  *
  * @param scope The scope in which to define this construct
