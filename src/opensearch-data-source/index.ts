...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opensearch_data_source
...
export class OpensearchDataSource extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OpensearchDataSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opensearch_data_source#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opensearch_data_source awscc_opensearch_data_source} Resource
  *
  * @param scope The scope in which to define this construct
