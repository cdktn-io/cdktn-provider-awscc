...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/batch_consumable_resource
...
export class BatchConsumableResource extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BatchConsumableResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/batch_consumable_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/batch_consumable_resource awscc_batch_consumable_resource} Resource
  *
  * @param scope The scope in which to define this construct
