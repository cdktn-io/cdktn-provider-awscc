...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/iotanalytics_datasets
...
export class DataAwsccIotanalyticsDatasets extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIotanalyticsDatasets that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/iotanalytics_datasets#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/iotanalytics_datasets awscc_iotanalytics_datasets} Data Source
  *
  * @param scope The scope in which to define this construct
