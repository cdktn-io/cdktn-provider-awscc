...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/transfer_connectors
...
export class DataAwsccTransferConnectors extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccTransferConnectors that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/transfer_connectors#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/transfer_connectors awscc_transfer_connectors} Data Source
  *
  * @param scope The scope in which to define this construct
