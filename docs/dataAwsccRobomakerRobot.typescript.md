...
```typescript
import { dataAwsccRobomakerRobot } from '@cdktn/provider-awscc'

new dataAwsccRobomakerRobot.DataAwsccRobomakerRobot(scope: Construct, id: string, config: DataAwsccRobomakerRobotConfig)
```
...
dataAwsccRobomakerRobot.DataAwsccRobomakerRobot.isConstruct(x: any)
```
...
dataAwsccRobomakerRobot.DataAwsccRobomakerRobot.isTerraformElement(x: any)
```
...
dataAwsccRobomakerRobot.DataAwsccRobomakerRobot.isTerraformDataSource(x: any)
```
...
dataAwsccRobomakerRobot.DataAwsccRobomakerRobot.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRobomakerRobot.DataAwsccRobomakerRobot.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRobomakerRobot.DataAwsccRobomakerRobot.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRobomakerRobot.DataAwsccRobomakerRobot.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRobomakerRobot.DataAwsccRobomakerRobot.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRobomakerRobot.DataAwsccRobomakerRobot.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccRobomakerRobotConfig: dataAwsccRobomakerRobot.DataAwsccRobomakerRobotConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRobomakerRobot.DataAwsccRobomakerRobotConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRobomakerRobot.DataAwsccRobomakerRobotConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRobomakerRobot.DataAwsccRobomakerRobotConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRobomakerRobot.DataAwsccRobomakerRobotConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
