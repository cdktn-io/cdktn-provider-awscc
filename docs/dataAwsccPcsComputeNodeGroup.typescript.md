...
| <code><a href="#@cdktn/provider-awscc.dataAwsccPcsComputeNodeGroup.DataAwsccPcsComputeNodeGroupSlurmConfigurationOutputReference.property.gresCustomSettings">gresCustomSettings</a></code> | <code>cdktn.StringMapList</code> | *No description.* |
...
```typescript
public readonly gresCustomSettings: StringMapList;
```
