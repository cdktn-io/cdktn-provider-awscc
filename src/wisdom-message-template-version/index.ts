...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/wisdom_message_template_version
...
export class WisdomMessageTemplateVersion extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WisdomMessageTemplateVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/wisdom_message_template_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/wisdom_message_template_version awscc_wisdom_message_template_version} Resource
  *
  * @param scope The scope in which to define this construct
