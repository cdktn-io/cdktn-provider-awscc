...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/elementalinference_dictionary
...
export class ElementalinferenceDictionary extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ElementalinferenceDictionary that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/elementalinference_dictionary#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/elementalinference_dictionary awscc_elementalinference_dictionary} Resource
  *
  * @param scope The scope in which to define this construct
