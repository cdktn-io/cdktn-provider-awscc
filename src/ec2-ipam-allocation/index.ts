...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ec2_ipam_allocation
...
export class Ec2IpamAllocation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2IpamAllocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ec2_ipam_allocation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ec2_ipam_allocation awscc_ec2_ipam_allocation} Resource
  *
  * @param scope The scope in which to define this construct
