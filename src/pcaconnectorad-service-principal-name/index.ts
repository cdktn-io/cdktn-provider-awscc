...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/pcaconnectorad_service_principal_name
...
export class PcaconnectoradServicePrincipalName extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PcaconnectoradServicePrincipalName that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/pcaconnectorad_service_principal_name#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/pcaconnectorad_service_principal_name awscc_pcaconnectorad_service_principal_name} Resource
  *
  * @param scope The scope in which to define this construct
