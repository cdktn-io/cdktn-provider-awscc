...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/s3_storage_lens
...
export class S3StorageLens extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3StorageLens that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/s3_storage_lens#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/s3_storage_lens awscc_s3_storage_lens} Resource
  *
  * @param scope The scope in which to define this construct
