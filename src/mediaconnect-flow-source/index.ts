...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/mediaconnect_flow_source
...
export interface MediaconnectFlowSourceAConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly tags?: MediaconnectFlowSourceTagsA[] | cdktn.IResolvable;
  /**
...
export interface MediaconnectFlowSourceTagsA {
  /**
...
export function mediaconnectFlowSourceTagsAToTerraform(struct?: MediaconnectFlowSourceTagsA | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function mediaconnectFlowSourceTagsAToHclTerraform(struct?: MediaconnectFlowSourceTagsA | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class MediaconnectFlowSourceTagsAOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): MediaconnectFlowSourceTagsA | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: MediaconnectFlowSourceTagsA | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._key = undefined;
...
export class MediaconnectFlowSourceTagsAList extends cdktn.ComplexList {
  public internalValue? : MediaconnectFlowSourceTagsA[] | cdktn.IResolvable
  ...
  */
  public get(index: number): MediaconnectFlowSourceTagsAOutputReference {
    return new MediaconnectFlowSourceTagsAOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class MediaconnectFlowSourceA extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MediaconnectFlowSourceA that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/mediaconnect_flow_source#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _tags = new MediaconnectFlowSourceTagsAList(this, "tags", false);
  public get tags() {
    return this._tags;
  }
  public putTags(value: MediaconnectFlowSourceTagsA[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      tags: cdktn.listMapper(mediaconnectFlowSourceTagsAToTerraform, false)(this._tags.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      tags: {
        value: cdktn.listMapperHcl(mediaconnectFlowSourceTagsAToHclTerraform, false)(this._tags.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "MediaconnectFlowSourceTagsAList",
      },
      vpc_interface_name: {
