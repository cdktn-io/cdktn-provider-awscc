...
```typescript
import { dataAwsccCodeconnectionsConnections } from '@cdktn/provider-awscc'

new dataAwsccCodeconnectionsConnections.DataAwsccCodeconnectionsConnections(scope: Construct, id: string, config?: DataAwsccCodeconnectionsConnectionsConfig)
```
...
dataAwsccCodeconnectionsConnections.DataAwsccCodeconnectionsConnections.isConstruct(x: any)
```
...
dataAwsccCodeconnectionsConnections.DataAwsccCodeconnectionsConnections.isTerraformElement(x: any)
```
...
dataAwsccCodeconnectionsConnections.DataAwsccCodeconnectionsConnections.isTerraformDataSource(x: any)
```
...
dataAwsccCodeconnectionsConnections.DataAwsccCodeconnectionsConnections.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnections.DataAwsccCodeconnectionsConnections.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnections.DataAwsccCodeconnectionsConnections.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnections.DataAwsccCodeconnectionsConnections.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnections.DataAwsccCodeconnectionsConnections.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnections.DataAwsccCodeconnectionsConnections.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnections.DataAwsccCodeconnectionsConnections.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnections.DataAwsccCodeconnectionsConnections.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
...
const dataAwsccCodeconnectionsConnectionsConfig: dataAwsccCodeconnectionsConnections.DataAwsccCodeconnectionsConnectionsConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnections.DataAwsccCodeconnectionsConnectionsConfig.property.connection">connection</a></code> | <code>cdktn.SSHProvisionerConnection \| cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnections.DataAwsccCodeconnectionsConnectionsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnections.DataAwsccCodeconnectionsConnectionsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnections.DataAwsccCodeconnectionsConnectionsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnections.DataAwsccCodeconnectionsConnectionsConfig.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnections.DataAwsccCodeconnectionsConnectionsConfig.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeconnectionsConnections.DataAwsccCodeconnectionsConnectionsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
