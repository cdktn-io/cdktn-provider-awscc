...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/iotfleetwise_signal_catalog
...
export class IotfleetwiseSignalCatalog extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotfleetwiseSignalCatalog that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/iotfleetwise_signal_catalog#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/iotfleetwise_signal_catalog awscc_iotfleetwise_signal_catalog} Resource
  *
  * @param scope The scope in which to define this construct
