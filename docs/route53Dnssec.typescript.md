...
```typescript
import { route53Dnssec } from '@cdktn/provider-awscc'

new route53Dnssec.Route53Dnssec(scope: Construct, id: string, config: Route53DnssecConfig)
```
...
route53Dnssec.Route53Dnssec.isConstruct(x: any)
```
...
route53Dnssec.Route53Dnssec.isTerraformElement(x: any)
```
...
route53Dnssec.Route53Dnssec.isTerraformResource(x: any)
```
...
route53Dnssec.Route53Dnssec.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.route53Dnssec.Route53Dnssec.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.route53Dnssec.Route53Dnssec.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.route53Dnssec.Route53Dnssec.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.route53Dnssec.Route53Dnssec.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.route53Dnssec.Route53Dnssec.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.route53Dnssec.Route53Dnssec.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const route53DnssecConfig: route53Dnssec.Route53DnssecConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.route53Dnssec.Route53DnssecConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.route53Dnssec.Route53DnssecConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.route53Dnssec.Route53DnssecConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.route53Dnssec.Route53DnssecConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
