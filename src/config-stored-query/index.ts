...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/config_stored_query
...
export class ConfigStoredQuery extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConfigStoredQuery that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/config_stored_query#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/config_stored_query awscc_config_stored_query} Resource
  *
  * @param scope The scope in which to define this construct
