...
```typescript
import { dataAwsccSagemakerCodeRepositories } from '@cdktn/provider-awscc'

new dataAwsccSagemakerCodeRepositories.DataAwsccSagemakerCodeRepositories(scope: Construct, id: string, config?: DataAwsccSagemakerCodeRepositoriesConfig)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerCodeRepositories.DataAwsccSagemakerCodeRepositories.Initializer.parameter.scope">scope</a></code> | <code>constructs.Construct</code> | The scope in which to define this construct. |
...
dataAwsccSagemakerCodeRepositories.DataAwsccSagemakerCodeRepositories.isConstruct(x: any)
```
...
dataAwsccSagemakerCodeRepositories.DataAwsccSagemakerCodeRepositories.isTerraformElement(x: any)
```
...
dataAwsccSagemakerCodeRepositories.DataAwsccSagemakerCodeRepositories.isTerraformDataSource(x: any)
```
...
dataAwsccSagemakerCodeRepositories.DataAwsccSagemakerCodeRepositories.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerCodeRepositories.DataAwsccSagemakerCodeRepositories.property.node">node</a></code> | <code>constructs.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerCodeRepositories.DataAwsccSagemakerCodeRepositories.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerCodeRepositories.DataAwsccSagemakerCodeRepositories.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerCodeRepositories.DataAwsccSagemakerCodeRepositories.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerCodeRepositories.DataAwsccSagemakerCodeRepositories.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerCodeRepositories.DataAwsccSagemakerCodeRepositories.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerCodeRepositories.DataAwsccSagemakerCodeRepositories.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerCodeRepositories.DataAwsccSagemakerCodeRepositories.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
...
const dataAwsccSagemakerCodeRepositoriesConfig: dataAwsccSagemakerCodeRepositories.DataAwsccSagemakerCodeRepositoriesConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerCodeRepositories.DataAwsccSagemakerCodeRepositoriesConfig.property.connection">connection</a></code> | <code>cdktn.SSHProvisionerConnection \| cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerCodeRepositories.DataAwsccSagemakerCodeRepositoriesConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerCodeRepositories.DataAwsccSagemakerCodeRepositoriesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerCodeRepositories.DataAwsccSagemakerCodeRepositoriesConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerCodeRepositories.DataAwsccSagemakerCodeRepositoriesConfig.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerCodeRepositories.DataAwsccSagemakerCodeRepositoriesConfig.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerCodeRepositories.DataAwsccSagemakerCodeRepositoriesConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
