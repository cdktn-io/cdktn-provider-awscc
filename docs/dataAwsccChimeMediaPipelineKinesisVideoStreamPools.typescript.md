...
```typescript
import { dataAwsccChimeMediaPipelineKinesisVideoStreamPools } from '@cdktn/provider-awscc'

new dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPools(scope: Construct, id: string, config?: DataAwsccChimeMediaPipelineKinesisVideoStreamPoolsConfig)
```
...
dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPools.isConstruct(x: any)
```
...
dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPools.isTerraformElement(x: any)
```
...
dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPools.isTerraformDataSource(x: any)
```
...
dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPools.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPools.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPools.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPools.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPools.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPools.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccChimeMediaPipelineKinesisVideoStreamPoolsConfig: dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPoolsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPoolsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPoolsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPoolsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPoolsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
