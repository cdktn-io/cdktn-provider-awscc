...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/aps_anomaly_detector
...
export class DataAwsccApsAnomalyDetector extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccApsAnomalyDetector that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/aps_anomaly_detector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/aps_anomaly_detector awscc_aps_anomaly_detector} Data Source
  *
  * @param scope The scope in which to define this construct
