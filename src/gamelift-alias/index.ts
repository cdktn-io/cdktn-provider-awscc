...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/gamelift_alias
...
export class GameliftAlias extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GameliftAlias that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/gamelift_alias#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/gamelift_alias awscc_gamelift_alias} Resource
  *
  * @param scope The scope in which to define this construct
