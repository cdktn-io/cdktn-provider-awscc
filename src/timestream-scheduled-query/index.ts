...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/timestream_scheduled_query
...
export class TimestreamScheduledQuery extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TimestreamScheduledQuery that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/timestream_scheduled_query#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/timestream_scheduled_query awscc_timestream_scheduled_query} Resource
  *
  * @param scope The scope in which to define this construct
