...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/uxc_account_customization
...
export interface UxcAccountCustomizationConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/uxc_account_customization#account_color UxcAccountCustomization#account_color}
  */
  readonly accountColor?: string;
  /**
  * A list of AWS region identifiers visible to the account in the AWS Console.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/uxc_account_customization#visible_regions UxcAccountCustomization#visible_regions}
  */
  readonly visibleRegions?: string[];
  /**
  * A list of AWS service identifiers visible to the account in the AWS Console.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/uxc_account_customization#visible_services UxcAccountCustomization#visible_services}
  */
  readonly visibleServices?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/uxc_account_customization awscc_uxc_account_customization}
*/
export class UxcAccountCustomization extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing UxcAccountCustomization that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/uxc_account_customization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/uxc_account_customization awscc_uxc_account_customization} Resource
  *
  * @param scope The scope in which to define this construct
