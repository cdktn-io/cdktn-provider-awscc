...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/computeoptimizer_automation_rules
...
export class DataAwsccComputeoptimizerAutomationRules extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccComputeoptimizerAutomationRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/computeoptimizer_automation_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/computeoptimizer_automation_rules awscc_computeoptimizer_automation_rules} Data Source
  *
  * @param scope The scope in which to define this construct
