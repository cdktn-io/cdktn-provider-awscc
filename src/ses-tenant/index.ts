...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ses_tenant
...
export class SesTenant extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SesTenant that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ses_tenant#import import section} in the documentation of this resource for the id to use
