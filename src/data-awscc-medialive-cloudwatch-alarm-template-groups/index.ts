...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/medialive_cloudwatch_alarm_template_groups
...
export class DataAwsccMedialiveCloudwatchAlarmTemplateGroups extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccMedialiveCloudwatchAlarmTemplateGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/medialive_cloudwatch_alarm_template_groups#import import section} in the documentation of this resource for the id to use
