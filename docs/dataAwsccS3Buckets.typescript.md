...
```typescript
import { dataAwsccS3Buckets } from '@cdktn/provider-awscc'

new dataAwsccS3Buckets.DataAwsccS3Buckets(scope: Construct, id: string, config?: DataAwsccS3BucketsConfig)
```
...
dataAwsccS3Buckets.DataAwsccS3Buckets.isConstruct(x: any)
```
...
dataAwsccS3Buckets.DataAwsccS3Buckets.isTerraformElement(x: any)
```
...
dataAwsccS3Buckets.DataAwsccS3Buckets.isTerraformDataSource(x: any)
```
...
dataAwsccS3Buckets.DataAwsccS3Buckets.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3Buckets.DataAwsccS3Buckets.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3Buckets.DataAwsccS3Buckets.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3Buckets.DataAwsccS3Buckets.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3Buckets.DataAwsccS3Buckets.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3Buckets.DataAwsccS3Buckets.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccS3BucketsConfig: dataAwsccS3Buckets.DataAwsccS3BucketsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3Buckets.DataAwsccS3BucketsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3Buckets.DataAwsccS3BucketsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3Buckets.DataAwsccS3BucketsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3Buckets.DataAwsccS3BucketsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
