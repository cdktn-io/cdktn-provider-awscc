...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/elasticloadbalancingv2_load_balancers
...
export class DataAwsccElasticloadbalancingv2LoadBalancers extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccElasticloadbalancingv2LoadBalancers that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/elasticloadbalancingv2_load_balancers#import import section} in the documentation of this resource for the id to use
