...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/route53_cidr_collections
...
export class DataAwsccRoute53CidrCollections extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRoute53CidrCollections that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/route53_cidr_collections#import import section} in the documentation of this resource for the id to use
