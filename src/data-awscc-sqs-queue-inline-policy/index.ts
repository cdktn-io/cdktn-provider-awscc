...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/sqs_queue_inline_policy
...
export class DataAwsccSqsQueueInlinePolicy extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccSqsQueueInlinePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/sqs_queue_inline_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/sqs_queue_inline_policy awscc_sqs_queue_inline_policy} Data Source
  *
  * @param scope The scope in which to define this construct
