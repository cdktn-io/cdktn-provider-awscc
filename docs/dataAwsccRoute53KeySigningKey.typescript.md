...
```typescript
import { dataAwsccRoute53KeySigningKey } from '@cdktn/provider-awscc'

new dataAwsccRoute53KeySigningKey.DataAwsccRoute53KeySigningKey(scope: Construct, id: string, config: DataAwsccRoute53KeySigningKeyConfig)
```
...
dataAwsccRoute53KeySigningKey.DataAwsccRoute53KeySigningKey.isConstruct(x: any)
```
...
dataAwsccRoute53KeySigningKey.DataAwsccRoute53KeySigningKey.isTerraformElement(x: any)
```
...
dataAwsccRoute53KeySigningKey.DataAwsccRoute53KeySigningKey.isTerraformDataSource(x: any)
```
...
dataAwsccRoute53KeySigningKey.DataAwsccRoute53KeySigningKey.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53KeySigningKey.DataAwsccRoute53KeySigningKey.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53KeySigningKey.DataAwsccRoute53KeySigningKey.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53KeySigningKey.DataAwsccRoute53KeySigningKey.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53KeySigningKey.DataAwsccRoute53KeySigningKey.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53KeySigningKey.DataAwsccRoute53KeySigningKey.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccRoute53KeySigningKeyConfig: dataAwsccRoute53KeySigningKey.DataAwsccRoute53KeySigningKeyConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53KeySigningKey.DataAwsccRoute53KeySigningKeyConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53KeySigningKey.DataAwsccRoute53KeySigningKeyConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53KeySigningKey.DataAwsccRoute53KeySigningKeyConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53KeySigningKey.DataAwsccRoute53KeySigningKeyConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
