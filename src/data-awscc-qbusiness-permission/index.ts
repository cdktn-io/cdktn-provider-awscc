...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/qbusiness_permission
...
export class DataAwsccQbusinessPermission extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccQbusinessPermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/qbusiness_permission#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/qbusiness_permission awscc_qbusiness_permission} Data Source
  *
  * @param scope The scope in which to define this construct
