...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/codestarconnections_repository_links
...
export class DataAwsccCodestarconnectionsRepositoryLinks extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCodestarconnectionsRepositoryLinks that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/codestarconnections_repository_links#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/codestarconnections_repository_links awscc_codestarconnections_repository_links} Data Source
  *
  * @param scope The scope in which to define this construct
