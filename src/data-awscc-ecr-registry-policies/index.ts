...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ecr_registry_policies
...
export class DataAwsccEcrRegistryPolicies extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEcrRegistryPolicies that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ecr_registry_policies#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ecr_registry_policies awscc_ecr_registry_policies} Data Source
  *
  * @param scope The scope in which to define this construct
