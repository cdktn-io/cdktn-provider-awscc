...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/sagemaker_models
...
export class DataAwsccSagemakerModels extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccSagemakerModels that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/sagemaker_models#import import section} in the documentation of this resource for the id to use
