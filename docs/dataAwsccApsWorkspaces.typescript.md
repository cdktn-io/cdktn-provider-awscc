...
```typescript
import { dataAwsccApsWorkspaces } from '@cdktn/provider-awscc'

new dataAwsccApsWorkspaces.DataAwsccApsWorkspaces(scope: Construct, id: string, config?: DataAwsccApsWorkspacesConfig)
```
...
dataAwsccApsWorkspaces.DataAwsccApsWorkspaces.isConstruct(x: any)
```
...
dataAwsccApsWorkspaces.DataAwsccApsWorkspaces.isTerraformElement(x: any)
```
...
dataAwsccApsWorkspaces.DataAwsccApsWorkspaces.isTerraformDataSource(x: any)
```
...
dataAwsccApsWorkspaces.DataAwsccApsWorkspaces.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApsWorkspaces.DataAwsccApsWorkspaces.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApsWorkspaces.DataAwsccApsWorkspaces.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApsWorkspaces.DataAwsccApsWorkspaces.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApsWorkspaces.DataAwsccApsWorkspaces.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApsWorkspaces.DataAwsccApsWorkspaces.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccApsWorkspacesConfig: dataAwsccApsWorkspaces.DataAwsccApsWorkspacesConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApsWorkspaces.DataAwsccApsWorkspacesConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApsWorkspaces.DataAwsccApsWorkspacesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApsWorkspaces.DataAwsccApsWorkspacesConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApsWorkspaces.DataAwsccApsWorkspacesConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
