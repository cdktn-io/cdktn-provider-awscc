...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/panorama_packages
...
export class DataAwsccPanoramaPackages extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccPanoramaPackages that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/panorama_packages#import import section} in the documentation of this resource for the id to use
