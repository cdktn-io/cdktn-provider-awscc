...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cognito_identity_pool
...
export class CognitoIdentityPool extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CognitoIdentityPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cognito_identity_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cognito_identity_pool awscc_cognito_identity_pool} Resource
  *
  * @param scope The scope in which to define this construct
