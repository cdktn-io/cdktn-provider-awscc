...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDirectconnectPrivateVirtualInterface.DataAwsccDirectconnectPrivateVirtualInterface.property.rateLimit">rate_limit</a></code> | <code>str</code> | *No description.* |
...
##### `rate_limit`<sup>Required</sup> <a name="rate_limit" id="@cdktn/provider-awscc.dataAwsccDirectconnectPrivateVirtualInterface.DataAwsccDirectconnectPrivateVirtualInterface.property.rateLimit"></a>
