...
```typescript
import { dataAwsccSagemakerPartnerApps } from '@cdktn/provider-awscc'

new dataAwsccSagemakerPartnerApps.DataAwsccSagemakerPartnerApps(scope: Construct, id: string, config?: DataAwsccSagemakerPartnerAppsConfig)
```
...
dataAwsccSagemakerPartnerApps.DataAwsccSagemakerPartnerApps.isConstruct(x: any)
```
...
dataAwsccSagemakerPartnerApps.DataAwsccSagemakerPartnerApps.isTerraformElement(x: any)
```
...
dataAwsccSagemakerPartnerApps.DataAwsccSagemakerPartnerApps.isTerraformDataSource(x: any)
```
...
dataAwsccSagemakerPartnerApps.DataAwsccSagemakerPartnerApps.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerPartnerApps.DataAwsccSagemakerPartnerApps.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerPartnerApps.DataAwsccSagemakerPartnerApps.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerPartnerApps.DataAwsccSagemakerPartnerApps.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerPartnerApps.DataAwsccSagemakerPartnerApps.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerPartnerApps.DataAwsccSagemakerPartnerApps.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccSagemakerPartnerAppsConfig: dataAwsccSagemakerPartnerApps.DataAwsccSagemakerPartnerAppsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerPartnerApps.DataAwsccSagemakerPartnerAppsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerPartnerApps.DataAwsccSagemakerPartnerAppsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerPartnerApps.DataAwsccSagemakerPartnerAppsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerPartnerApps.DataAwsccSagemakerPartnerAppsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
