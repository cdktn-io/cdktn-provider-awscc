...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/iam_group_policy
...
export class IamGroupPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IamGroupPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/iam_group_policy#import import section} in the documentation of this resource for the id to use
