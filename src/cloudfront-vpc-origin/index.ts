...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/cloudfront_vpc_origin
...
export class CloudfrontVpcOrigin extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudfrontVpcOrigin that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/cloudfront_vpc_origin#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/cloudfront_vpc_origin awscc_cloudfront_vpc_origin} Resource
  *
  * @param scope The scope in which to define this construct
