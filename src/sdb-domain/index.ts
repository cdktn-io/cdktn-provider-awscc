...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/sdb_domain
...
export class SdbDomain extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SdbDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/sdb_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/sdb_domain awscc_sdb_domain} Resource
  *
  * @param scope The scope in which to define this construct
