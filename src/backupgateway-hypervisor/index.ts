...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/backupgateway_hypervisor
...
export class BackupgatewayHypervisor extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BackupgatewayHypervisor that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/backupgateway_hypervisor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/backupgateway_hypervisor awscc_backupgateway_hypervisor} Resource
  *
  * @param scope The scope in which to define this construct
