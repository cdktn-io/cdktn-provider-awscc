...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/evidently_segments
...
export class DataAwsccEvidentlySegments extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEvidentlySegments that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/evidently_segments#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/evidently_segments awscc_evidently_segments} Data Source
  *
  * @param scope The scope in which to define this construct
