...
```typescript
import { dataAwsccConfigDeliveryChannels } from '@cdktn/provider-awscc'

new dataAwsccConfigDeliveryChannels.DataAwsccConfigDeliveryChannels(scope: Construct, id: string, config?: DataAwsccConfigDeliveryChannelsConfig)
```
...
dataAwsccConfigDeliveryChannels.DataAwsccConfigDeliveryChannels.isConstruct(x: any)
```
...
dataAwsccConfigDeliveryChannels.DataAwsccConfigDeliveryChannels.isTerraformElement(x: any)
```
...
dataAwsccConfigDeliveryChannels.DataAwsccConfigDeliveryChannels.isTerraformDataSource(x: any)
```
...
dataAwsccConfigDeliveryChannels.DataAwsccConfigDeliveryChannels.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccConfigDeliveryChannels.DataAwsccConfigDeliveryChannels.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccConfigDeliveryChannels.DataAwsccConfigDeliveryChannels.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccConfigDeliveryChannels.DataAwsccConfigDeliveryChannels.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccConfigDeliveryChannels.DataAwsccConfigDeliveryChannels.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccConfigDeliveryChannels.DataAwsccConfigDeliveryChannels.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccConfigDeliveryChannelsConfig: dataAwsccConfigDeliveryChannels.DataAwsccConfigDeliveryChannelsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccConfigDeliveryChannels.DataAwsccConfigDeliveryChannelsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccConfigDeliveryChannels.DataAwsccConfigDeliveryChannelsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccConfigDeliveryChannels.DataAwsccConfigDeliveryChannelsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccConfigDeliveryChannels.DataAwsccConfigDeliveryChannelsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
