...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sso_assignment
...
export interface SsoAssignmentConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sso_assignment#instance_arn SsoAssignment#instance_arn}
  */
  readonly instanceArn: string;
  /**
  * The permission set that the assignment will be assigned
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sso_assignment#permission_set_arn SsoAssignment#permission_set_arn}
  */
  readonly permissionSetArn: string;
  /**
  * The assignee's identifier, user id/group id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sso_assignment#principal_id SsoAssignment#principal_id}
  */
  readonly principalId: string;
  /**
  * The assignee's type, user/group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sso_assignment#principal_type SsoAssignment#principal_type}
  */
  readonly principalType: string;
  /**
  * The account id to be provisioned.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sso_assignment#target_id SsoAssignment#target_id}
  */
  readonly targetId: string;
  /**
  * The type of resource to be provisioned to, only aws account now
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sso_assignment#target_type SsoAssignment#target_type}
  */
  readonly targetType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sso_assignment awscc_sso_assignment}
*/
export class SsoAssignment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SsoAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sso_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sso_assignment awscc_sso_assignment} Resource
  *
  * @param scope The scope in which to define this construct
