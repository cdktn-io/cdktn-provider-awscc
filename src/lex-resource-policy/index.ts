...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/lex_resource_policy
...
export class LexResourcePolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LexResourcePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/lex_resource_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/lex_resource_policy awscc_lex_resource_policy} Resource
  *
  * @param scope The scope in which to define this construct
