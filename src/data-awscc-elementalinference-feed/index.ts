...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/elementalinference_feed
...
export class DataAwsccElementalinferenceFeed extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccElementalinferenceFeed that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/elementalinference_feed#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/elementalinference_feed awscc_elementalinference_feed} Data Source
  *
  * @param scope The scope in which to define this construct
