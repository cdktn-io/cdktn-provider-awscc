...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.transferConnector.TransferConnectorAs2ConfigAsyncMdnConfig.property.serverIds">serverIds</a></code> | <code>java.util.List<java.lang.String></code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/transfer_connector#server_ids TransferConnector#server_ids}. |
...
//  .orderedUserSecretVersionStages(java.util.List<java.lang.String>)
...
| <code><a href="#@cdktn/provider-awscc.transferConnector.TransferConnectorSftpConfig.property.orderedUserSecretVersionStages">orderedUserSecretVersionStages</a></code> | <code>java.util.List<java.lang.String></code> | Specifies the order in which the connector attempts to use secret versions during authentication. |
...
```java
public java.util.List<java.lang.String> getOrderedUserSecretVersionStages();
```
...
```java
public void resetOrderedUserSecretVersionStages()
```
...
| <code><a href="#@cdktn/provider-awscc.transferConnector.TransferConnectorSftpConfigOutputReference.property.orderedUserSecretVersionStagesInput">orderedUserSecretVersionStagesInput</a></code> | <code>java.util.List<java.lang.String></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.transferConnector.TransferConnectorSftpConfigOutputReference.property.orderedUserSecretVersionStages">orderedUserSecretVersionStages</a></code> | <code>java.util.List<java.lang.String></code> | *No description.* |
...
```java
public java.util.List<java.lang.String> getOrderedUserSecretVersionStagesInput();
```
