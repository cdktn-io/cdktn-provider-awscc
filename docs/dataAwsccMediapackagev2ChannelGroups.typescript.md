...
```typescript
import { dataAwsccMediapackagev2ChannelGroups } from '@cdktn/provider-awscc'

new dataAwsccMediapackagev2ChannelGroups.DataAwsccMediapackagev2ChannelGroups(scope: Construct, id: string, config?: DataAwsccMediapackagev2ChannelGroupsConfig)
```
...
dataAwsccMediapackagev2ChannelGroups.DataAwsccMediapackagev2ChannelGroups.isConstruct(x: any)
```
...
dataAwsccMediapackagev2ChannelGroups.DataAwsccMediapackagev2ChannelGroups.isTerraformElement(x: any)
```
...
dataAwsccMediapackagev2ChannelGroups.DataAwsccMediapackagev2ChannelGroups.isTerraformDataSource(x: any)
```
...
dataAwsccMediapackagev2ChannelGroups.DataAwsccMediapackagev2ChannelGroups.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediapackagev2ChannelGroups.DataAwsccMediapackagev2ChannelGroups.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediapackagev2ChannelGroups.DataAwsccMediapackagev2ChannelGroups.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediapackagev2ChannelGroups.DataAwsccMediapackagev2ChannelGroups.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediapackagev2ChannelGroups.DataAwsccMediapackagev2ChannelGroups.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediapackagev2ChannelGroups.DataAwsccMediapackagev2ChannelGroups.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccMediapackagev2ChannelGroupsConfig: dataAwsccMediapackagev2ChannelGroups.DataAwsccMediapackagev2ChannelGroupsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediapackagev2ChannelGroups.DataAwsccMediapackagev2ChannelGroupsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediapackagev2ChannelGroups.DataAwsccMediapackagev2ChannelGroupsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediapackagev2ChannelGroups.DataAwsccMediapackagev2ChannelGroupsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediapackagev2ChannelGroups.DataAwsccMediapackagev2ChannelGroupsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
