...
Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/apigatewayv2_portal_product awscc_apigatewayv2_portal_product}.
...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccapigatewayv2portalproduct"

dataawsccapigatewayv2portalproduct.NewDataAwsccApigatewayv2PortalProduct(scope Construct, id *string, config DataAwsccApigatewayv2PortalProductConfig) DataAwsccApigatewayv2PortalProduct
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2PortalProduct.DataAwsccApigatewayv2PortalProduct.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
dataawsccapigatewayv2portalproduct.DataAwsccApigatewayv2PortalProduct_IsConstruct(x interface{}) *bool
```
...
dataawsccapigatewayv2portalproduct.DataAwsccApigatewayv2PortalProduct_IsTerraformElement(x interface{}) *bool
```
...
dataawsccapigatewayv2portalproduct.DataAwsccApigatewayv2PortalProduct_IsTerraformDataSource(x interface{}) *bool
```
...
dataawsccapigatewayv2portalproduct.DataAwsccApigatewayv2PortalProduct_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/apigatewayv2_portal_product#import import section} in the documentation of this resource for the id to use
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2PortalProduct.DataAwsccApigatewayv2PortalProduct.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2PortalProduct.DataAwsccApigatewayv2PortalProduct.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2PortalProduct.DataAwsccApigatewayv2PortalProduct.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2PortalProduct.DataAwsccApigatewayv2PortalProduct.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2PortalProduct.DataAwsccApigatewayv2PortalProduct.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2PortalProduct.DataAwsccApigatewayv2PortalProduct.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2PortalProduct.DataAwsccApigatewayv2PortalProduct.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2PortalProduct.DataAwsccApigatewayv2PortalProduct.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
...
```go
func Tags() DataAwsccApigatewayv2PortalProductTagsList
```
...
&dataawsccapigatewayv2portalproduct.DataAwsccApigatewayv2PortalProductConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2PortalProduct.DataAwsccApigatewayv2PortalProductConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2PortalProduct.DataAwsccApigatewayv2PortalProductConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2PortalProduct.DataAwsccApigatewayv2PortalProductConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2PortalProduct.DataAwsccApigatewayv2PortalProductConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2PortalProduct.DataAwsccApigatewayv2PortalProductConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2PortalProduct.DataAwsccApigatewayv2PortalProductConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2PortalProduct.DataAwsccApigatewayv2PortalProductConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/apigatewayv2_portal_product#id DataAwsccApigatewayv2PortalProduct#id}
...
&dataawsccapigatewayv2portalproduct.DataAwsccApigatewayv2PortalProductTags {
...
dataawsccapigatewayv2portalproduct.NewDataAwsccApigatewayv2PortalProductTagsList(terraformResource IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccApigatewayv2PortalProductTagsList
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2PortalProduct.DataAwsccApigatewayv2PortalProductTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2PortalProduct.DataAwsccApigatewayv2PortalProductTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>*bool</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```go
func Get(index *f64) DataAwsccApigatewayv2PortalProductTagsOutputReference
```
...
dataawsccapigatewayv2portalproduct.NewDataAwsccApigatewayv2PortalProductTagsOutputReference(terraformResource IInterpolatingParent, terraformAttribute *string, complexObjectIndex *f64, complexObjectIsFromSet *bool) DataAwsccApigatewayv2PortalProductTagsOutputReference
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2PortalProduct.DataAwsccApigatewayv2PortalProductTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayv2PortalProduct.DataAwsccApigatewayv2PortalProductTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>*f64</code> | the index of this item in the list. |
...
```go
func InternalValue() DataAwsccApigatewayv2PortalProductTags
```
