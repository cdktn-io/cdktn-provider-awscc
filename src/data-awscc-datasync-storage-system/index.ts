...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/datasync_storage_system
...
export class DataAwsccDatasyncStorageSystem extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDatasyncStorageSystem that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/datasync_storage_system#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/datasync_storage_system awscc_datasync_storage_system} Data Source
  *
  * @param scope The scope in which to define this construct
