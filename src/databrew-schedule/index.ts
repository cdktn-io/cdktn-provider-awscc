...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/databrew_schedule
...
export class DatabrewSchedule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DatabrewSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/databrew_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/databrew_schedule awscc_databrew_schedule} Resource
  *
  * @param scope The scope in which to define this construct
