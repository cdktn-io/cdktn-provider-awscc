...
```typescript
import { dataAwsccGreengrassv2Deployments } from '@cdktn/provider-awscc'

new dataAwsccGreengrassv2Deployments.DataAwsccGreengrassv2Deployments(scope: Construct, id: string, config?: DataAwsccGreengrassv2DeploymentsConfig)
```
...
dataAwsccGreengrassv2Deployments.DataAwsccGreengrassv2Deployments.isConstruct(x: any)
```
...
dataAwsccGreengrassv2Deployments.DataAwsccGreengrassv2Deployments.isTerraformElement(x: any)
```
...
dataAwsccGreengrassv2Deployments.DataAwsccGreengrassv2Deployments.isTerraformDataSource(x: any)
```
...
dataAwsccGreengrassv2Deployments.DataAwsccGreengrassv2Deployments.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGreengrassv2Deployments.DataAwsccGreengrassv2Deployments.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGreengrassv2Deployments.DataAwsccGreengrassv2Deployments.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGreengrassv2Deployments.DataAwsccGreengrassv2Deployments.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGreengrassv2Deployments.DataAwsccGreengrassv2Deployments.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGreengrassv2Deployments.DataAwsccGreengrassv2Deployments.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccGreengrassv2DeploymentsConfig: dataAwsccGreengrassv2Deployments.DataAwsccGreengrassv2DeploymentsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGreengrassv2Deployments.DataAwsccGreengrassv2DeploymentsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGreengrassv2Deployments.DataAwsccGreengrassv2DeploymentsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGreengrassv2Deployments.DataAwsccGreengrassv2DeploymentsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGreengrassv2Deployments.DataAwsccGreengrassv2DeploymentsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
