...
| <code><a href="#@cdktn/provider-awscc.pcsComputeNodeGroup.PcsComputeNodeGroupSlurmConfigurationOutputReference.property.gresCustomSettingsInput">GresCustomSettingsInput</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.pcsComputeNodeGroup.PcsComputeNodeGroupSlurmConfigurationOutputReference.property.gresCustomSettings">GresCustomSettings</a></code> | <code>interface{}</code> | *No description.* |
...
```go
func GresCustomSettingsInput() interface{}
```
...
```go
func GresCustomSettings() interface{}
```
