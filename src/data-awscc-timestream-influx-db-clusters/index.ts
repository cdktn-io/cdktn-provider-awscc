...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/timestream_influx_db_clusters
...
export class DataAwsccTimestreamInfluxDbClusters extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccTimestreamInfluxDbClusters that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/timestream_influx_db_clusters#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/timestream_influx_db_clusters awscc_timestream_influx_db_clusters} Data Source
  *
  * @param scope The scope in which to define this construct
