...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/deadline_queue_environment
...
export class DataAwsccDeadlineQueueEnvironment extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDeadlineQueueEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/deadline_queue_environment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/deadline_queue_environment awscc_deadline_queue_environment} Data Source
  *
  * @param scope The scope in which to define this construct
