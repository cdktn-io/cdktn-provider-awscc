...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/wisdom_message_template
...
export class DataAwsccWisdomMessageTemplate extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccWisdomMessageTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/wisdom_message_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/wisdom_message_template awscc_wisdom_message_template} Data Source
  *
  * @param scope The scope in which to define this construct
