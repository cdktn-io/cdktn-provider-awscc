...
new DataAwsccNotificationsManagedNotificationAccountContactAssociations(Construct Scope, string Id, DataAwsccNotificationsManagedNotificationAccountContactAssociationsConfig Config = null);
```
...
DataAwsccNotificationsManagedNotificationAccountContactAssociations.IsConstruct(object X);
```
...
DataAwsccNotificationsManagedNotificationAccountContactAssociations.IsTerraformElement(object X);
```
...
DataAwsccNotificationsManagedNotificationAccountContactAssociations.IsTerraformDataSource(object X);
```
...
DataAwsccNotificationsManagedNotificationAccountContactAssociations.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsManagedNotificationAccountContactAssociations.DataAwsccNotificationsManagedNotificationAccountContactAssociations.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsManagedNotificationAccountContactAssociations.DataAwsccNotificationsManagedNotificationAccountContactAssociations.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsManagedNotificationAccountContactAssociations.DataAwsccNotificationsManagedNotificationAccountContactAssociations.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsManagedNotificationAccountContactAssociations.DataAwsccNotificationsManagedNotificationAccountContactAssociations.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsManagedNotificationAccountContactAssociations.DataAwsccNotificationsManagedNotificationAccountContactAssociations.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
...
new DataAwsccNotificationsManagedNotificationAccountContactAssociationsConfig {
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsManagedNotificationAccountContactAssociations.DataAwsccNotificationsManagedNotificationAccountContactAssociationsConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsManagedNotificationAccountContactAssociations.DataAwsccNotificationsManagedNotificationAccountContactAssociationsConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsManagedNotificationAccountContactAssociations.DataAwsccNotificationsManagedNotificationAccountContactAssociationsConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsManagedNotificationAccountContactAssociations.DataAwsccNotificationsManagedNotificationAccountContactAssociationsConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationsManagedNotificationAccountContactAssociations.DataAwsccNotificationsManagedNotificationAccountContactAssociationsConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
