...
```typescript
import { dataAwsccSagemakerStudioLifecycleConfigs } from '@cdktn/provider-awscc'

new dataAwsccSagemakerStudioLifecycleConfigs.DataAwsccSagemakerStudioLifecycleConfigs(scope: Construct, id: string, config?: DataAwsccSagemakerStudioLifecycleConfigsConfig)
```
...
dataAwsccSagemakerStudioLifecycleConfigs.DataAwsccSagemakerStudioLifecycleConfigs.isConstruct(x: any)
```
...
dataAwsccSagemakerStudioLifecycleConfigs.DataAwsccSagemakerStudioLifecycleConfigs.isTerraformElement(x: any)
```
...
dataAwsccSagemakerStudioLifecycleConfigs.DataAwsccSagemakerStudioLifecycleConfigs.isTerraformDataSource(x: any)
```
...
dataAwsccSagemakerStudioLifecycleConfigs.DataAwsccSagemakerStudioLifecycleConfigs.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerStudioLifecycleConfigs.DataAwsccSagemakerStudioLifecycleConfigs.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerStudioLifecycleConfigs.DataAwsccSagemakerStudioLifecycleConfigs.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerStudioLifecycleConfigs.DataAwsccSagemakerStudioLifecycleConfigs.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerStudioLifecycleConfigs.DataAwsccSagemakerStudioLifecycleConfigs.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerStudioLifecycleConfigs.DataAwsccSagemakerStudioLifecycleConfigs.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccSagemakerStudioLifecycleConfigsConfig: dataAwsccSagemakerStudioLifecycleConfigs.DataAwsccSagemakerStudioLifecycleConfigsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerStudioLifecycleConfigs.DataAwsccSagemakerStudioLifecycleConfigsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerStudioLifecycleConfigs.DataAwsccSagemakerStudioLifecycleConfigsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerStudioLifecycleConfigs.DataAwsccSagemakerStudioLifecycleConfigsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerStudioLifecycleConfigs.DataAwsccSagemakerStudioLifecycleConfigsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
