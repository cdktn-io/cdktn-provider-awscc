...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/personalize_dataset
...
export interface PersonalizeDatasetConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/personalize_dataset#dataset_group_arn PersonalizeDataset#dataset_group_arn}
  */
  readonly datasetGroupArn: string;
  /**
  * Initial DatasetImportJob for the created dataset
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/personalize_dataset#dataset_import_job PersonalizeDataset#dataset_import_job}
  */
  readonly datasetImportJob?: PersonalizeDatasetDatasetImportJob;
  /**
  * The type of dataset
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/personalize_dataset#dataset_type PersonalizeDataset#dataset_type}
  */
  readonly datasetType: string;
  /**
  * The name for the dataset
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/personalize_dataset#name PersonalizeDataset#name}
  */
  readonly name: string;
  /**
  * The ARN of the schema to associate with the dataset. The schema defines the dataset fields.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/personalize_dataset#schema_arn PersonalizeDataset#schema_arn}
  */
  readonly schemaArn: string;
  /**
  * The tags used to organize, track, or control access for this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/personalize_dataset#tags PersonalizeDataset#tags}
  */
  readonly tags?: PersonalizeDatasetTags[] | cdktn.IResolvable;
}
export interface PersonalizeDatasetDatasetImportJobDataSource {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/personalize_dataset#data_location PersonalizeDataset#data_location}
  */
...
export interface PersonalizeDatasetDatasetImportJob {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/personalize_dataset#data_source PersonalizeDataset#data_source}
  */
  readonly dataSource?: PersonalizeDatasetDatasetImportJobDataSource;
  /**
  * The ARN of the dataset that receives the imported data
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/personalize_dataset#dataset_arn PersonalizeDataset#dataset_arn}
  */
  readonly datasetArn?: string;
  /**
  * The ARN of the dataset import job
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/personalize_dataset#dataset_import_job_arn PersonalizeDataset#dataset_import_job_arn}
  */
  readonly datasetImportJobArn?: string;
  /**
  * The name for the dataset import job.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/personalize_dataset#job_name PersonalizeDataset#job_name}
  */
  readonly jobName?: string;
  /**
  * The ARN of the IAM role that has permissions to read from the Amazon S3 data source.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/personalize_dataset#role_arn PersonalizeDataset#role_arn}
  */
...
export interface PersonalizeDatasetTags {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/personalize_dataset#key PersonalizeDataset#key}
  */
  readonly key?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/personalize_dataset#value PersonalizeDataset#value}
  */
  readonly value?: string;
}

export function personalizeDatasetTagsToTerraform(struct?: PersonalizeDatasetTags | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function personalizeDatasetTagsToHclTerraform(struct?: PersonalizeDatasetTags | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class PersonalizeDatasetTagsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): PersonalizeDatasetTags | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: PersonalizeDatasetTags | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._key = undefined;
...
export class PersonalizeDatasetTagsList extends cdktn.ComplexList {
  public internalValue? : PersonalizeDatasetTags[] | cdktn.IResolvable
  ...
  */
  public get(index: number): PersonalizeDatasetTagsOutputReference {
    return new PersonalizeDatasetTagsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/personalize_dataset awscc_personalize_dataset}
*/
export class PersonalizeDataset extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PersonalizeDataset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/personalize_dataset#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/personalize_dataset awscc_personalize_dataset} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _tags = new PersonalizeDatasetTagsList(this, "tags", false);
  public get tags() {
    return this._tags;
  }
  public putTags(value: PersonalizeDatasetTags[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      tags: cdktn.listMapper(personalizeDatasetTagsToTerraform, false)(this._tags.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      tags: {
        value: cdktn.listMapperHcl(personalizeDatasetTagsToHclTerraform, false)(this._tags.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "PersonalizeDatasetTagsList",
      },
    };
