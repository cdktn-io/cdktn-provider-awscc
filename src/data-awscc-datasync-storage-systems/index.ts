...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/datasync_storage_systems
...
export class DataAwsccDatasyncStorageSystems extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDatasyncStorageSystems that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/datasync_storage_systems#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/datasync_storage_systems awscc_datasync_storage_systems} Data Source
  *
  * @param scope The scope in which to define this construct
