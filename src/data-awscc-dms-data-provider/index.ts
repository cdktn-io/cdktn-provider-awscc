...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/dms_data_provider
...
export class DataAwsccDmsDataProvider extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDmsDataProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/dms_data_provider#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/dms_data_provider awscc_dms_data_provider} Data Source
  *
  * @param scope The scope in which to define this construct
