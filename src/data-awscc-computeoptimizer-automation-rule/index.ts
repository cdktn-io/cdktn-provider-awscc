...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/computeoptimizer_automation_rule
...
export class DataAwsccComputeoptimizerAutomationRule extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccComputeoptimizerAutomationRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/computeoptimizer_automation_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/computeoptimizer_automation_rule awscc_computeoptimizer_automation_rule} Data Source
  *
  * @param scope The scope in which to define this construct
