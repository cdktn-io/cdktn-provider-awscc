...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cognito_user_pool_ui_customization_attachment
...
export class CognitoUserPoolUiCustomizationAttachment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CognitoUserPoolUiCustomizationAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cognito_user_pool_ui_customization_attachment#import import section} in the documentation of this resource for the id to use
