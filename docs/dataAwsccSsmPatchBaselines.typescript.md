...
```typescript
import { dataAwsccSsmPatchBaselines } from '@cdktn/provider-awscc'

new dataAwsccSsmPatchBaselines.DataAwsccSsmPatchBaselines(scope: Construct, id: string, config?: DataAwsccSsmPatchBaselinesConfig)
```
...
dataAwsccSsmPatchBaselines.DataAwsccSsmPatchBaselines.isConstruct(x: any)
```
...
dataAwsccSsmPatchBaselines.DataAwsccSsmPatchBaselines.isTerraformElement(x: any)
```
...
dataAwsccSsmPatchBaselines.DataAwsccSsmPatchBaselines.isTerraformDataSource(x: any)
```
...
dataAwsccSsmPatchBaselines.DataAwsccSsmPatchBaselines.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmPatchBaselines.DataAwsccSsmPatchBaselines.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmPatchBaselines.DataAwsccSsmPatchBaselines.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmPatchBaselines.DataAwsccSsmPatchBaselines.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmPatchBaselines.DataAwsccSsmPatchBaselines.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmPatchBaselines.DataAwsccSsmPatchBaselines.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccSsmPatchBaselinesConfig: dataAwsccSsmPatchBaselines.DataAwsccSsmPatchBaselinesConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmPatchBaselines.DataAwsccSsmPatchBaselinesConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmPatchBaselines.DataAwsccSsmPatchBaselinesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmPatchBaselines.DataAwsccSsmPatchBaselinesConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmPatchBaselines.DataAwsccSsmPatchBaselinesConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
