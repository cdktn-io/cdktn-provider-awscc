...
```typescript
import { dataAwsccWellarchitectedAgentContext } from '@cdktn/provider-awscc'

new dataAwsccWellarchitectedAgentContext.DataAwsccWellarchitectedAgentContext(scope: Construct, id: string, config: DataAwsccWellarchitectedAgentContextConfig)
```
...
dataAwsccWellarchitectedAgentContext.DataAwsccWellarchitectedAgentContext.isConstruct(x: any)
```
...
dataAwsccWellarchitectedAgentContext.DataAwsccWellarchitectedAgentContext.isTerraformElement(x: any)
```
...
dataAwsccWellarchitectedAgentContext.DataAwsccWellarchitectedAgentContext.isTerraformDataSource(x: any)
```
...
dataAwsccWellarchitectedAgentContext.DataAwsccWellarchitectedAgentContext.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWellarchitectedAgentContext.DataAwsccWellarchitectedAgentContext.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWellarchitectedAgentContext.DataAwsccWellarchitectedAgentContext.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWellarchitectedAgentContext.DataAwsccWellarchitectedAgentContext.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccWellarchitectedAgentContext.DataAwsccWellarchitectedAgentContext.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWellarchitectedAgentContext.DataAwsccWellarchitectedAgentContext.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccWellarchitectedAgentContextConfig: dataAwsccWellarchitectedAgentContext.DataAwsccWellarchitectedAgentContextConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWellarchitectedAgentContext.DataAwsccWellarchitectedAgentContextConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccWellarchitectedAgentContext.DataAwsccWellarchitectedAgentContextConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccWellarchitectedAgentContext.DataAwsccWellarchitectedAgentContextConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWellarchitectedAgentContext.DataAwsccWellarchitectedAgentContextConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
