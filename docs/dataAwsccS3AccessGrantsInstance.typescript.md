...
```typescript
import { dataAwsccS3AccessGrantsInstance } from '@cdktn/provider-awscc'

new dataAwsccS3AccessGrantsInstance.DataAwsccS3AccessGrantsInstance(scope: Construct, id: string, config: DataAwsccS3AccessGrantsInstanceConfig)
```
...
dataAwsccS3AccessGrantsInstance.DataAwsccS3AccessGrantsInstance.isConstruct(x: any)
```
...
dataAwsccS3AccessGrantsInstance.DataAwsccS3AccessGrantsInstance.isTerraformElement(x: any)
```
...
dataAwsccS3AccessGrantsInstance.DataAwsccS3AccessGrantsInstance.isTerraformDataSource(x: any)
```
...
dataAwsccS3AccessGrantsInstance.DataAwsccS3AccessGrantsInstance.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/s3_access_grants_instance#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3AccessGrantsInstance.DataAwsccS3AccessGrantsInstance.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3AccessGrantsInstance.DataAwsccS3AccessGrantsInstance.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3AccessGrantsInstance.DataAwsccS3AccessGrantsInstance.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3AccessGrantsInstance.DataAwsccS3AccessGrantsInstance.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3AccessGrantsInstance.DataAwsccS3AccessGrantsInstance.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
```typescript
public readonly tags: DataAwsccS3AccessGrantsInstanceTagsList;
```
...
const dataAwsccS3AccessGrantsInstanceConfig: dataAwsccS3AccessGrantsInstance.DataAwsccS3AccessGrantsInstanceConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3AccessGrantsInstance.DataAwsccS3AccessGrantsInstanceConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3AccessGrantsInstance.DataAwsccS3AccessGrantsInstanceConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3AccessGrantsInstance.DataAwsccS3AccessGrantsInstanceConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3AccessGrantsInstance.DataAwsccS3AccessGrantsInstanceConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const dataAwsccS3AccessGrantsInstanceTags: dataAwsccS3AccessGrantsInstance.DataAwsccS3AccessGrantsInstanceTags = { ... }
```
...
new dataAwsccS3AccessGrantsInstance.DataAwsccS3AccessGrantsInstanceTagsList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3AccessGrantsInstance.DataAwsccS3AccessGrantsInstanceTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3AccessGrantsInstance.DataAwsccS3AccessGrantsInstanceTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
new dataAwsccS3AccessGrantsInstance.DataAwsccS3AccessGrantsInstanceTagsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3AccessGrantsInstance.DataAwsccS3AccessGrantsInstanceTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccS3AccessGrantsInstance.DataAwsccS3AccessGrantsInstanceTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
...
```typescript
public readonly internalValue: DataAwsccS3AccessGrantsInstanceTags;
```
