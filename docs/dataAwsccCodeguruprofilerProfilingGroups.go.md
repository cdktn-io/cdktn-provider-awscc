...
Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/codeguruprofiler_profiling_groups awscc_codeguruprofiler_profiling_groups}.
...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawscccodeguruprofilerprofilinggroups"

dataawscccodeguruprofilerprofilinggroups.NewDataAwsccCodeguruprofilerProfilingGroups(scope Construct, id *string, config DataAwsccCodeguruprofilerProfilingGroupsConfig) DataAwsccCodeguruprofilerProfilingGroups
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeguruprofilerProfilingGroups.DataAwsccCodeguruprofilerProfilingGroups.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
dataawscccodeguruprofilerprofilinggroups.DataAwsccCodeguruprofilerProfilingGroups_IsConstruct(x interface{}) *bool
```
...
dataawscccodeguruprofilerprofilinggroups.DataAwsccCodeguruprofilerProfilingGroups_IsTerraformElement(x interface{}) *bool
```
...
dataawscccodeguruprofilerprofilinggroups.DataAwsccCodeguruprofilerProfilingGroups_IsTerraformDataSource(x interface{}) *bool
```
...
dataawscccodeguruprofilerprofilinggroups.DataAwsccCodeguruprofilerProfilingGroups_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/codeguruprofiler_profiling_groups#import import section} in the documentation of this resource for the id to use
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeguruprofilerProfilingGroups.DataAwsccCodeguruprofilerProfilingGroups.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeguruprofilerProfilingGroups.DataAwsccCodeguruprofilerProfilingGroups.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeguruprofilerProfilingGroups.DataAwsccCodeguruprofilerProfilingGroups.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeguruprofilerProfilingGroups.DataAwsccCodeguruprofilerProfilingGroups.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeguruprofilerProfilingGroups.DataAwsccCodeguruprofilerProfilingGroups.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeguruprofilerProfilingGroups.DataAwsccCodeguruprofilerProfilingGroups.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeguruprofilerProfilingGroups.DataAwsccCodeguruprofilerProfilingGroups.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeguruprofilerProfilingGroups.DataAwsccCodeguruprofilerProfilingGroups.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
...
&dataawscccodeguruprofilerprofilinggroups.DataAwsccCodeguruprofilerProfilingGroupsConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeguruprofilerProfilingGroups.DataAwsccCodeguruprofilerProfilingGroupsConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeguruprofilerProfilingGroups.DataAwsccCodeguruprofilerProfilingGroupsConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeguruprofilerProfilingGroups.DataAwsccCodeguruprofilerProfilingGroupsConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeguruprofilerProfilingGroups.DataAwsccCodeguruprofilerProfilingGroupsConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeguruprofilerProfilingGroups.DataAwsccCodeguruprofilerProfilingGroupsConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeguruprofilerProfilingGroups.DataAwsccCodeguruprofilerProfilingGroupsConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCodeguruprofilerProfilingGroups.DataAwsccCodeguruprofilerProfilingGroupsConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
