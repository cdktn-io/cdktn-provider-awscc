...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lookoutvision_project
...
export class LookoutvisionProject extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LookoutvisionProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lookoutvision_project#import import section} in the documentation of this resource for the id to use
