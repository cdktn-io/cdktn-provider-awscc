...
Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/docdbelastic_cluster awscc_docdbelastic_cluster}.
...
```typescript
import { dataAwsccDocdbelasticCluster } from '@cdktn/provider-awscc'

new dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticCluster(scope: Construct, id: string, config: DataAwsccDocdbelasticClusterConfig)
```
...
dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticCluster.isConstruct(x: any)
```
...
dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticCluster.isTerraformElement(x: any)
```
...
dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticCluster.isTerraformDataSource(x: any)
```
...
dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticCluster.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/docdbelastic_cluster#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticCluster.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticCluster.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticCluster.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticCluster.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticCluster.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticCluster.property.backupRetentionPeriod">backupRetentionPeriod</a></code> | <code>number</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticCluster.property.shardCapacity">shardCapacity</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticCluster.property.shardCount">shardCount</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticCluster.property.shardInstanceCount">shardInstanceCount</a></code> | <code>number</code> | *No description.* |
...
```typescript
public readonly tags: DataAwsccDocdbelasticClusterTagsList;
```
...
const dataAwsccDocdbelasticClusterConfig: dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticClusterConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticClusterConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticClusterConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticClusterConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticClusterConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/docdbelastic_cluster#id DataAwsccDocdbelasticCluster#id}
...
const dataAwsccDocdbelasticClusterTags: dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticClusterTags = { ... }
```
...
new dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticClusterTagsList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticClusterTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticClusterTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```typescript
public get(index: number): DataAwsccDocdbelasticClusterTagsOutputReference
```
...
new dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticClusterTagsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticClusterTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticClusterTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbelasticCluster.DataAwsccDocdbelasticClusterTagsOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```typescript
public readonly internalValue: DataAwsccDocdbelasticClusterTags;
```
