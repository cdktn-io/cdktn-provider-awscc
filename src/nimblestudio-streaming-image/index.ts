...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/nimblestudio_streaming_image
...
export class NimblestudioStreamingImage extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NimblestudioStreamingImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/nimblestudio_streaming_image#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/nimblestudio_streaming_image awscc_nimblestudio_streaming_image} Resource
  *
  * @param scope The scope in which to define this construct
