...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/rtbfabric_responder_gateway
...
export class DataAwsccRtbfabricResponderGateway extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRtbfabricResponderGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/rtbfabric_responder_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/rtbfabric_responder_gateway awscc_rtbfabric_responder_gateway} Data Source
  *
  * @param scope The scope in which to define this construct
