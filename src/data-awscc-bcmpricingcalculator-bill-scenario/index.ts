...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/bcmpricingcalculator_bill_scenario
...
export class DataAwsccBcmpricingcalculatorBillScenario extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccBcmpricingcalculatorBillScenario that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/bcmpricingcalculator_bill_scenario#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/bcmpricingcalculator_bill_scenario awscc_bcmpricingcalculator_bill_scenario} Data Source
  *
  * @param scope The scope in which to define this construct
