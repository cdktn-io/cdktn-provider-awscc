...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ce_anomaly_subscriptions
...
export class DataAwsccCeAnomalySubscriptions extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCeAnomalySubscriptions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ce_anomaly_subscriptions#import import section} in the documentation of this resource for the id to use
