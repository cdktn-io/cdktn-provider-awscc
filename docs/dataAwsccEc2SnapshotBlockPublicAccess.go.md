...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccec2snapshotblockpublicaccess"

dataawsccec2snapshotblockpublicaccess.NewDataAwsccEc2SnapshotBlockPublicAccess(scope Construct, id *string, config DataAwsccEc2SnapshotBlockPublicAccessConfig) DataAwsccEc2SnapshotBlockPublicAccess
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SnapshotBlockPublicAccess.DataAwsccEc2SnapshotBlockPublicAccess.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
dataawsccec2snapshotblockpublicaccess.DataAwsccEc2SnapshotBlockPublicAccess_IsConstruct(x interface{}) *bool
```
...
dataawsccec2snapshotblockpublicaccess.DataAwsccEc2SnapshotBlockPublicAccess_IsTerraformElement(x interface{}) *bool
```
...
dataawsccec2snapshotblockpublicaccess.DataAwsccEc2SnapshotBlockPublicAccess_IsTerraformDataSource(x interface{}) *bool
```
...
dataawsccec2snapshotblockpublicaccess.DataAwsccEc2SnapshotBlockPublicAccess_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SnapshotBlockPublicAccess.DataAwsccEc2SnapshotBlockPublicAccess.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SnapshotBlockPublicAccess.DataAwsccEc2SnapshotBlockPublicAccess.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SnapshotBlockPublicAccess.DataAwsccEc2SnapshotBlockPublicAccess.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SnapshotBlockPublicAccess.DataAwsccEc2SnapshotBlockPublicAccess.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SnapshotBlockPublicAccess.DataAwsccEc2SnapshotBlockPublicAccess.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SnapshotBlockPublicAccess.DataAwsccEc2SnapshotBlockPublicAccess.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SnapshotBlockPublicAccess.DataAwsccEc2SnapshotBlockPublicAccess.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SnapshotBlockPublicAccess.DataAwsccEc2SnapshotBlockPublicAccess.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SnapshotBlockPublicAccess.DataAwsccEc2SnapshotBlockPublicAccessConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SnapshotBlockPublicAccess.DataAwsccEc2SnapshotBlockPublicAccessConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SnapshotBlockPublicAccess.DataAwsccEc2SnapshotBlockPublicAccessConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SnapshotBlockPublicAccess.DataAwsccEc2SnapshotBlockPublicAccessConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SnapshotBlockPublicAccess.DataAwsccEc2SnapshotBlockPublicAccessConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SnapshotBlockPublicAccess.DataAwsccEc2SnapshotBlockPublicAccessConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2SnapshotBlockPublicAccess.DataAwsccEc2SnapshotBlockPublicAccessConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
