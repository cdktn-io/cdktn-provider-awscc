...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/connect_user
...
export class DataAwsccConnectUser extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccConnectUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/connect_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/connect_user awscc_connect_user} Data Source
  *
  * @param scope The scope in which to define this construct
