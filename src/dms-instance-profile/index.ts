...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/dms_instance_profile
...
export class DmsInstanceProfile extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DmsInstanceProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/dms_instance_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/dms_instance_profile awscc_dms_instance_profile} Resource
  *
  * @param scope The scope in which to define this construct
