...
```typescript
import { dataAwsccIamManagedPolicies } from '@cdktn/provider-awscc'

new dataAwsccIamManagedPolicies.DataAwsccIamManagedPolicies(scope: Construct, id: string, config?: DataAwsccIamManagedPoliciesConfig)
```
...
dataAwsccIamManagedPolicies.DataAwsccIamManagedPolicies.isConstruct(x: any)
```
...
dataAwsccIamManagedPolicies.DataAwsccIamManagedPolicies.isTerraformElement(x: any)
```
...
dataAwsccIamManagedPolicies.DataAwsccIamManagedPolicies.isTerraformDataSource(x: any)
```
...
dataAwsccIamManagedPolicies.DataAwsccIamManagedPolicies.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIamManagedPolicies.DataAwsccIamManagedPolicies.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIamManagedPolicies.DataAwsccIamManagedPolicies.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIamManagedPolicies.DataAwsccIamManagedPolicies.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIamManagedPolicies.DataAwsccIamManagedPolicies.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccIamManagedPolicies.DataAwsccIamManagedPolicies.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIamManagedPolicies.DataAwsccIamManagedPolicies.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIamManagedPolicies.DataAwsccIamManagedPolicies.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
...
const dataAwsccIamManagedPoliciesConfig: dataAwsccIamManagedPolicies.DataAwsccIamManagedPoliciesConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIamManagedPolicies.DataAwsccIamManagedPoliciesConfig.property.connection">connection</a></code> | <code>cdktn.SSHProvisionerConnection \| cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIamManagedPolicies.DataAwsccIamManagedPoliciesConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIamManagedPolicies.DataAwsccIamManagedPoliciesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIamManagedPolicies.DataAwsccIamManagedPoliciesConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIamManagedPolicies.DataAwsccIamManagedPoliciesConfig.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIamManagedPolicies.DataAwsccIamManagedPoliciesConfig.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccIamManagedPolicies.DataAwsccIamManagedPoliciesConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
