...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/arczonalshift_autoshift_observer_notification_status
...
export interface ArczonalshiftAutoshiftObserverNotificationStatusConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/arczonalshift_autoshift_observer_notification_status#status ArczonalshiftAutoshiftObserverNotificationStatus#status}
  */
  readonly status: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/arczonalshift_autoshift_observer_notification_status awscc_arczonalshift_autoshift_observer_notification_status}
*/
export class ArczonalshiftAutoshiftObserverNotificationStatus extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ArczonalshiftAutoshiftObserverNotificationStatus that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/arczonalshift_autoshift_observer_notification_status#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/arczonalshift_autoshift_observer_notification_status awscc_arczonalshift_autoshift_observer_notification_status} Resource
  *
  * @param scope The scope in which to define this construct
