...
| <code><a href="#@cdktn/provider-awscc.dataAwsccOpensearchserviceDomain.DataAwsccOpensearchserviceDomainSoftwareUpdateOptionsOutputReference.property.useLatestServiceSoftwareForBlueGreen">use_latest_service_software_for_blue_green</a></code> | <code>cdktn.IResolvable</code> | *No description.* |
...
##### `use_latest_service_software_for_blue_green`<sup>Required</sup> <a name="use_latest_service_software_for_blue_green" id="@cdktn/provider-awscc.dataAwsccOpensearchserviceDomain.DataAwsccOpensearchserviceDomainSoftwareUpdateOptionsOutputReference.property.useLatestServiceSoftwareForBlueGreen"></a>

```python
use_latest_service_software_for_blue_green: IResolvable
```
