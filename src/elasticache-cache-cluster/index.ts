...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticache_cache_cluster
...
export class ElasticacheCacheCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ElasticacheCacheCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticache_cache_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticache_cache_cluster awscc_elasticache_cache_cluster} Resource
  *
  * @param scope The scope in which to define this construct
