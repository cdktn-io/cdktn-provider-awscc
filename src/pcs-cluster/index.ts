...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster
...
export interface PcsClusterConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster#name PcsCluster#name}
  */
  readonly name?: string;
  /**
  * The networking configuration for the cluster's control plane.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster#networking PcsCluster#networking}
  */
  readonly networking: PcsClusterNetworking;
  /**
  * The cluster management and job scheduling software associated with the cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster#scheduler PcsCluster#scheduler}
  */
  readonly scheduler: PcsClusterScheduler;
  /**
  * The size of the cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster#size PcsCluster#size}
  */
  readonly size: string;
  /**
  * Additional options related to the Slurm scheduler.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster#slurm_configuration PcsCluster#slurm_configuration}
  */
  readonly slurmConfiguration?: PcsClusterSlurmConfiguration;
  /**
  * 1 or more tags added to the resource. Each tag consists of a tag key and tag value. The tag value is optional and can be an empty string.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster#tags PcsCluster#tags}
  */
...
export interface PcsClusterNetworking {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster#network_type PcsCluster#network_type}
  */
  readonly networkType?: string;
  /**
  * The list of security group IDs associated with the Elastic Network Interface (ENI) created in subnets.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster#security_group_ids PcsCluster#security_group_ids}
  */
  readonly securityGroupIds?: string[];
  /**
  * The list of subnet IDs where AWS PCS creates an Elastic Network Interface (ENI) to enable communication between managed controllers and AWS PCS resources. The subnet must have an available IP address, cannot reside in AWS Outposts, AWS Wavelength, or an AWS Local Zone. AWS PCS currently supports only 1 subnet in this list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster#subnet_ids PcsCluster#subnet_ids}
  */
...
export interface PcsClusterScheduler {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster#type PcsCluster#type}
  */
  readonly type: string;
  /**
  * The version of the specified scheduling software that AWS PCS uses to manage cluster scaling and job scheduling.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster#version PcsCluster#version}
  */
...
export interface PcsClusterSlurmConfigurationAccounting {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster#default_purge_time_in_days PcsCluster#default_purge_time_in_days}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster#mode PcsCluster#mode}
  */
...
export interface PcsClusterSlurmConfigurationCgroupCustomSettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster#parameter_name PcsCluster#parameter_name}
  */
  readonly parameterName?: string;
  /**
  * The value for the cgroup.conf parameter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster#parameter_value PcsCluster#parameter_value}
  */
...
export interface PcsClusterSlurmConfigurationJwtAuth {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster#jwt_key PcsCluster#jwt_key}
  */
...
export interface PcsClusterSlurmConfiguration {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster#accounting PcsCluster#accounting}
  */
  readonly accounting?: PcsClusterSlurmConfigurationAccounting;
  /**
  * The shared Slurm key for authentication, also known as the cluster secret.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster#auth_key PcsCluster#auth_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster#cgroup_custom_settings PcsCluster#cgroup_custom_settings}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster#jwt_auth PcsCluster#jwt_auth}
  */
  readonly jwtAuth?: PcsClusterSlurmConfigurationJwtAuth;
  /**
  * The time before an idle node is scaled down.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster#scale_down_idle_time_in_seconds PcsCluster#scale_down_idle_time_in_seconds}
  */
  readonly scaleDownIdleTimeInSeconds?: number;
  /**
  * Additional Slurm-specific configuration that directly maps to Slurm settings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster#slurm_custom_settings PcsCluster#slurm_custom_settings}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster#slurm_rest PcsCluster#slurm_rest}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster#slurmdbd_custom_settings PcsCluster#slurmdbd_custom_settings}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster awscc_pcs_cluster}
*/
export class PcsCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PcsCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcs_cluster awscc_pcs_cluster} Resource
  *
  * @param scope The scope in which to define this construct
