...
export interface DataAwsccPersonalizeFilterConfig extends cdktn.TerraformMetaArguments {
  /**
...
export interface DataAwsccPersonalizeFilterTags {
}

export function dataAwsccPersonalizeFilterTagsToTerraform(struct?: DataAwsccPersonalizeFilterTags): any {
...
export function dataAwsccPersonalizeFilterTagsToHclTerraform(struct?: DataAwsccPersonalizeFilterTags): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsccPersonalizeFilterTagsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAwsccPersonalizeFilterTags | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsccPersonalizeFilterTags | undefined) {
    if (value === undefined) {
...
export class DataAwsccPersonalizeFilterTagsList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataAwsccPersonalizeFilterTagsOutputReference {
    return new DataAwsccPersonalizeFilterTagsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAwsccPersonalizeFilter extends cdktn.TerraformDataSource {
  ...
  * @param options DataAwsccPersonalizeFilterConfig
  */
  public constructor(scope: Construct, id: string, config: DataAwsccPersonalizeFilterConfig) {
    super(scope, id, {
  ...
  private _tags = new DataAwsccPersonalizeFilterTagsList(this, "tags", true);
  public get tags() {
    return this._tags;
  }
