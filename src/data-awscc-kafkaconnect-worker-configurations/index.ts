...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/kafkaconnect_worker_configurations
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/kafkaconnect_worker_configurations awscc_kafkaconnect_worker_configurations}
*/
export class DataAwsccKafkaconnectWorkerConfigurations extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccKafkaconnectWorkerConfigurations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/kafkaconnect_worker_configurations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/kafkaconnect_worker_configurations awscc_kafkaconnect_worker_configurations} Data Source
  *
  * @param scope The scope in which to define this construct
