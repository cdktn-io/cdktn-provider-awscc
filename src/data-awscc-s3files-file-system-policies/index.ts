...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/s3files_file_system_policies
...
export class DataAwsccS3FilesFileSystemPolicies extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccS3FilesFileSystemPolicies that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/s3files_file_system_policies#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/s3files_file_system_policies awscc_s3files_file_system_policies} Data Source
  *
  * @param scope The scope in which to define this construct
