...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/timestream_database
...
export class TimestreamDatabase extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TimestreamDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/timestream_database#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/timestream_database awscc_timestream_database} Resource
  *
  * @param scope The scope in which to define this construct
