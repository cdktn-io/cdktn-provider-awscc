...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/pcaconnectorad_service_principal_name
...
export class DataAwsccPcaconnectoradServicePrincipalName extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccPcaconnectoradServicePrincipalName that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/pcaconnectorad_service_principal_name#import import section} in the documentation of this resource for the id to use
