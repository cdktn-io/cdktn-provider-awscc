...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSnsTopic.DataAwsccSnsTopic.property.maximumMessageSize">maximumMessageSize</a></code> | <code>number</code> | *No description.* |
