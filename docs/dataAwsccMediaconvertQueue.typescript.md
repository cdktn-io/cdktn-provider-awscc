...
```typescript
import { dataAwsccMediaconvertQueue } from '@cdktn/provider-awscc'

new dataAwsccMediaconvertQueue.DataAwsccMediaconvertQueue(scope: Construct, id: string, config: DataAwsccMediaconvertQueueConfig)
```
...
dataAwsccMediaconvertQueue.DataAwsccMediaconvertQueue.isConstruct(x: any)
```
...
dataAwsccMediaconvertQueue.DataAwsccMediaconvertQueue.isTerraformElement(x: any)
```
...
dataAwsccMediaconvertQueue.DataAwsccMediaconvertQueue.isTerraformDataSource(x: any)
```
...
dataAwsccMediaconvertQueue.DataAwsccMediaconvertQueue.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconvertQueue.DataAwsccMediaconvertQueue.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconvertQueue.DataAwsccMediaconvertQueue.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconvertQueue.DataAwsccMediaconvertQueue.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconvertQueue.DataAwsccMediaconvertQueue.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconvertQueue.DataAwsccMediaconvertQueue.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconvertQueue.DataAwsccMediaconvertQueue.property.concurrentJobs">concurrentJobs</a></code> | <code>number</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconvertQueue.DataAwsccMediaconvertQueue.property.maximumConcurrentFeeds">maximumConcurrentFeeds</a></code> | <code>number</code> | *No description.* |
...
const dataAwsccMediaconvertQueueConfig: dataAwsccMediaconvertQueue.DataAwsccMediaconvertQueueConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconvertQueue.DataAwsccMediaconvertQueueConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconvertQueue.DataAwsccMediaconvertQueueConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconvertQueue.DataAwsccMediaconvertQueueConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMediaconvertQueue.DataAwsccMediaconvertQueueConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
