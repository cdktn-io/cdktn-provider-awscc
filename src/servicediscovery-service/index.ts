...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/servicediscovery_service
...
export class ServicediscoveryService extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ServicediscoveryService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/servicediscovery_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/servicediscovery_service awscc_servicediscovery_service} Resource
  *
  * @param scope The scope in which to define this construct
