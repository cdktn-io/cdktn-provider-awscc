...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/sagemaker_image_version
...
export class DataAwsccSagemakerImageVersion extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccSagemakerImageVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/sagemaker_image_version#import import section} in the documentation of this resource for the id to use
