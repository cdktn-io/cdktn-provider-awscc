...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/inspectorv2_filter
...
export class Inspectorv2Filter extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Inspectorv2Filter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/inspectorv2_filter#import import section} in the documentation of this resource for the id to use
