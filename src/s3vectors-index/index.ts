...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/s3vectors_index
...
export class S3VectorsIndex extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3VectorsIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/s3vectors_index#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/s3vectors_index awscc_s3vectors_index} Resource
  *
  * @param scope The scope in which to define this construct
