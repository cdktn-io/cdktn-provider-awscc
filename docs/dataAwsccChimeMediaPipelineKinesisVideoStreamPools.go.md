...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccchimemediapipelinekinesisvideostreampools"

dataawsccchimemediapipelinekinesisvideostreampools.NewDataAwsccChimeMediaPipelineKinesisVideoStreamPools(scope Construct, id *string, config DataAwsccChimeMediaPipelineKinesisVideoStreamPoolsConfig) DataAwsccChimeMediaPipelineKinesisVideoStreamPools
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPools.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
dataawsccchimemediapipelinekinesisvideostreampools.DataAwsccChimeMediaPipelineKinesisVideoStreamPools_IsConstruct(x interface{}) *bool
```
...
dataawsccchimemediapipelinekinesisvideostreampools.DataAwsccChimeMediaPipelineKinesisVideoStreamPools_IsTerraformElement(x interface{}) *bool
```
...
dataawsccchimemediapipelinekinesisvideostreampools.DataAwsccChimeMediaPipelineKinesisVideoStreamPools_IsTerraformDataSource(x interface{}) *bool
```
...
dataawsccchimemediapipelinekinesisvideostreampools.DataAwsccChimeMediaPipelineKinesisVideoStreamPools_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPools.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPools.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPools.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPools.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPools.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPools.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPools.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPoolsConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPoolsConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPoolsConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPoolsConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPoolsConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPoolsConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccChimeMediaPipelineKinesisVideoStreamPools.DataAwsccChimeMediaPipelineKinesisVideoStreamPoolsConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
