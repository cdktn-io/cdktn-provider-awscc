...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ec2_transit_gateway_metering_policy_entry
...
export class DataAwsccEc2TransitGatewayMeteringPolicyEntry extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEc2TransitGatewayMeteringPolicyEntry that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ec2_transit_gateway_metering_policy_entry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ec2_transit_gateway_metering_policy_entry awscc_ec2_transit_gateway_metering_policy_entry} Data Source
  *
  * @param scope The scope in which to define this construct
