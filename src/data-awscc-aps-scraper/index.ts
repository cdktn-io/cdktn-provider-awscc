...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/aps_scraper
...
export interface DataAwsccApsScraperDestinationCloudwatchConfiguration {
}

export function dataAwsccApsScraperDestinationCloudwatchConfigurationToTerraform(struct?: DataAwsccApsScraperDestinationCloudwatchConfiguration): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsccApsScraperDestinationCloudwatchConfigurationToHclTerraform(struct?: DataAwsccApsScraperDestinationCloudwatchConfiguration): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsccApsScraperDestinationCloudwatchConfigurationOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAwsccApsScraperDestinationCloudwatchConfiguration | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsccApsScraperDestinationCloudwatchConfiguration | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataAwsccApsScraperDestinationOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  // cloudwatch_configuration - computed: true, optional: false, required: false
  private _cloudwatchConfiguration = new DataAwsccApsScraperDestinationCloudwatchConfigurationOutputReference(this, "cloudwatch_configuration");
...
export class DataAwsccApsScraper extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccApsScraper that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/aps_scraper#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/aps_scraper awscc_aps_scraper} Data Source
  *
  * @param scope The scope in which to define this construct
