...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/fms_notification_channel
...
export class FmsNotificationChannel extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FmsNotificationChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/fms_notification_channel#import import section} in the documentation of this resource for the id to use
