...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/glue_connection
...
export class DataAwsccGlueConnection extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccGlueConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/glue_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/glue_connection awscc_glue_connection} Data Source
  *
  * @param scope The scope in which to define this construct
