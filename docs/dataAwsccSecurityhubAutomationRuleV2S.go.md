...
Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/securityhub_automation_rule_v2s awscc_securityhub_automation_rule_v2s}.
...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccsecurityhubautomationrulev2s"

dataawsccsecurityhubautomationrulev2s.NewDataAwsccSecurityhubAutomationRuleV2S(scope Construct, id *string, config DataAwsccSecurityhubAutomationRuleV2SConfig) DataAwsccSecurityhubAutomationRuleV2S
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAutomationRuleV2S.DataAwsccSecurityhubAutomationRuleV2S.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
dataawsccsecurityhubautomationrulev2s.DataAwsccSecurityhubAutomationRuleV2S_IsConstruct(x interface{}) *bool
```
...
dataawsccsecurityhubautomationrulev2s.DataAwsccSecurityhubAutomationRuleV2S_IsTerraformElement(x interface{}) *bool
```
...
dataawsccsecurityhubautomationrulev2s.DataAwsccSecurityhubAutomationRuleV2S_IsTerraformDataSource(x interface{}) *bool
```
...
dataawsccsecurityhubautomationrulev2s.DataAwsccSecurityhubAutomationRuleV2S_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/securityhub_automation_rule_v2s#import import section} in the documentation of this resource for the id to use
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAutomationRuleV2S.DataAwsccSecurityhubAutomationRuleV2S.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAutomationRuleV2S.DataAwsccSecurityhubAutomationRuleV2S.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAutomationRuleV2S.DataAwsccSecurityhubAutomationRuleV2S.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAutomationRuleV2S.DataAwsccSecurityhubAutomationRuleV2S.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAutomationRuleV2S.DataAwsccSecurityhubAutomationRuleV2S.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAutomationRuleV2S.DataAwsccSecurityhubAutomationRuleV2S.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAutomationRuleV2S.DataAwsccSecurityhubAutomationRuleV2S.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAutomationRuleV2S.DataAwsccSecurityhubAutomationRuleV2S.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
...
&dataawsccsecurityhubautomationrulev2s.DataAwsccSecurityhubAutomationRuleV2SConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAutomationRuleV2S.DataAwsccSecurityhubAutomationRuleV2SConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAutomationRuleV2S.DataAwsccSecurityhubAutomationRuleV2SConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAutomationRuleV2S.DataAwsccSecurityhubAutomationRuleV2SConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAutomationRuleV2S.DataAwsccSecurityhubAutomationRuleV2SConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAutomationRuleV2S.DataAwsccSecurityhubAutomationRuleV2SConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAutomationRuleV2S.DataAwsccSecurityhubAutomationRuleV2SConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubAutomationRuleV2S.DataAwsccSecurityhubAutomationRuleV2SConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
