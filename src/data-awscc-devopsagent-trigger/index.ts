...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/devopsagent_trigger
...
export class DataAwsccDevopsagentTrigger extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDevopsagentTrigger that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/devopsagent_trigger#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/devopsagent_trigger awscc_devopsagent_trigger} Data Source
  *
  * @param scope The scope in which to define this construct
