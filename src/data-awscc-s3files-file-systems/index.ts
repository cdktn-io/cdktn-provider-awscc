...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/s3files_file_systems
...
export class DataAwsccS3FilesFileSystems extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccS3FilesFileSystems that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/s3files_file_systems#import import section} in the documentation of this resource for the id to use
