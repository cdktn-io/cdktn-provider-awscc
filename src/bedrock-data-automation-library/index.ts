...
export class BedrockDataAutomationLibrary extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BedrockDataAutomationLibrary that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/bedrock_data_automation_library#import import section} in the documentation of this resource for the id to use
