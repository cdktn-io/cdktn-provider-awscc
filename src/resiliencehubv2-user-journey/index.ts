...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/resiliencehubv2_user_journey
...
export class Resiliencehubv2UserJourney extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Resiliencehubv2UserJourney that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/resiliencehubv2_user_journey#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/resiliencehubv2_user_journey awscc_resiliencehubv2_user_journey} Resource
  *
  * @param scope The scope in which to define this construct
