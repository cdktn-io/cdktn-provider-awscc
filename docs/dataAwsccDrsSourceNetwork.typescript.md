...
```typescript
import { dataAwsccDrsSourceNetwork } from '@cdktn/provider-awscc'

new dataAwsccDrsSourceNetwork.DataAwsccDrsSourceNetwork(scope: Construct, id: string, config: DataAwsccDrsSourceNetworkConfig)
```
...
dataAwsccDrsSourceNetwork.DataAwsccDrsSourceNetwork.isConstruct(x: any)
```
...
dataAwsccDrsSourceNetwork.DataAwsccDrsSourceNetwork.isTerraformElement(x: any)
```
...
dataAwsccDrsSourceNetwork.DataAwsccDrsSourceNetwork.isTerraformDataSource(x: any)
```
...
dataAwsccDrsSourceNetwork.DataAwsccDrsSourceNetwork.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDrsSourceNetwork.DataAwsccDrsSourceNetwork.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDrsSourceNetwork.DataAwsccDrsSourceNetwork.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDrsSourceNetwork.DataAwsccDrsSourceNetwork.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDrsSourceNetwork.DataAwsccDrsSourceNetwork.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDrsSourceNetwork.DataAwsccDrsSourceNetwork.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
```typescript
public readonly tags: DataAwsccDrsSourceNetworkTagsList;
```
...
const dataAwsccDrsSourceNetworkConfig: dataAwsccDrsSourceNetwork.DataAwsccDrsSourceNetworkConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDrsSourceNetwork.DataAwsccDrsSourceNetworkConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDrsSourceNetwork.DataAwsccDrsSourceNetworkConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDrsSourceNetwork.DataAwsccDrsSourceNetworkConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDrsSourceNetwork.DataAwsccDrsSourceNetworkConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const dataAwsccDrsSourceNetworkTags: dataAwsccDrsSourceNetwork.DataAwsccDrsSourceNetworkTags = { ... }
```
...
new dataAwsccDrsSourceNetwork.DataAwsccDrsSourceNetworkTagsList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDrsSourceNetwork.DataAwsccDrsSourceNetworkTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDrsSourceNetwork.DataAwsccDrsSourceNetworkTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
new dataAwsccDrsSourceNetwork.DataAwsccDrsSourceNetworkTagsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDrsSourceNetwork.DataAwsccDrsSourceNetworkTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDrsSourceNetwork.DataAwsccDrsSourceNetworkTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDrsSourceNetwork.DataAwsccDrsSourceNetworkTagsOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```typescript
public readonly internalValue: DataAwsccDrsSourceNetworkTags;
```
