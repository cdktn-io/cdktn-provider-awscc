...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/kinesisvideo_stream
...
export class KinesisvideoStream extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing KinesisvideoStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/kinesisvideo_stream#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/kinesisvideo_stream awscc_kinesisvideo_stream} Resource
  *
  * @param scope The scope in which to define this construct
