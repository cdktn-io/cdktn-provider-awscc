...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/lambda_url
...
export class DataAwsccLambdaUrl extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccLambdaUrl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/lambda_url#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/lambda_url awscc_lambda_url} Data Source
  *
  * @param scope The scope in which to define this construct
