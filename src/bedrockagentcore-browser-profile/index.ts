...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/bedrockagentcore_browser_profile
...
export class BedrockagentcoreBrowserProfile extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BedrockagentcoreBrowserProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/bedrockagentcore_browser_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/bedrockagentcore_browser_profile awscc_bedrockagentcore_browser_profile} Resource
  *
  * @param scope The scope in which to define this construct
