...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/gamelift_container_fleet
...
export class GameliftContainerFleet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GameliftContainerFleet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/gamelift_container_fleet#import import section} in the documentation of this resource for the id to use
