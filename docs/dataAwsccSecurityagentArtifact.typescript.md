...
```typescript
import { dataAwsccSecurityagentArtifact } from '@cdktn/provider-awscc'

new dataAwsccSecurityagentArtifact.DataAwsccSecurityagentArtifact(scope: Construct, id: string, config: DataAwsccSecurityagentArtifactConfig)
```
...
dataAwsccSecurityagentArtifact.DataAwsccSecurityagentArtifact.isConstruct(x: any)
```
...
dataAwsccSecurityagentArtifact.DataAwsccSecurityagentArtifact.isTerraformElement(x: any)
```
...
dataAwsccSecurityagentArtifact.DataAwsccSecurityagentArtifact.isTerraformDataSource(x: any)
```
...
dataAwsccSecurityagentArtifact.DataAwsccSecurityagentArtifact.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityagentArtifact.DataAwsccSecurityagentArtifact.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityagentArtifact.DataAwsccSecurityagentArtifact.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityagentArtifact.DataAwsccSecurityagentArtifact.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityagentArtifact.DataAwsccSecurityagentArtifact.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityagentArtifact.DataAwsccSecurityagentArtifact.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccSecurityagentArtifactConfig: dataAwsccSecurityagentArtifact.DataAwsccSecurityagentArtifactConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityagentArtifact.DataAwsccSecurityagentArtifactConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityagentArtifact.DataAwsccSecurityagentArtifactConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityagentArtifact.DataAwsccSecurityagentArtifactConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityagentArtifact.DataAwsccSecurityagentArtifactConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
