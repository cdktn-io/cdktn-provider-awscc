...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/dms_data_migration
...
export class DmsDataMigration extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DmsDataMigration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/dms_data_migration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/dms_data_migration awscc_dms_data_migration} Resource
  *
  * @param scope The scope in which to define this construct
