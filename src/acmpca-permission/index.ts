...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/acmpca_permission
...
export class AcmpcaPermission extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AcmpcaPermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/acmpca_permission#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/acmpca_permission awscc_acmpca_permission} Resource
  *
  * @param scope The scope in which to define this construct
