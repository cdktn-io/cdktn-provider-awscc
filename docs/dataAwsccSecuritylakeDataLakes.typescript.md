...
```typescript
import { dataAwsccSecuritylakeDataLakes } from '@cdktn/provider-awscc'

new dataAwsccSecuritylakeDataLakes.DataAwsccSecuritylakeDataLakes(scope: Construct, id: string, config?: DataAwsccSecuritylakeDataLakesConfig)
```
...
dataAwsccSecuritylakeDataLakes.DataAwsccSecuritylakeDataLakes.isConstruct(x: any)
```
...
dataAwsccSecuritylakeDataLakes.DataAwsccSecuritylakeDataLakes.isTerraformElement(x: any)
```
...
dataAwsccSecuritylakeDataLakes.DataAwsccSecuritylakeDataLakes.isTerraformDataSource(x: any)
```
...
dataAwsccSecuritylakeDataLakes.DataAwsccSecuritylakeDataLakes.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecuritylakeDataLakes.DataAwsccSecuritylakeDataLakes.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecuritylakeDataLakes.DataAwsccSecuritylakeDataLakes.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecuritylakeDataLakes.DataAwsccSecuritylakeDataLakes.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecuritylakeDataLakes.DataAwsccSecuritylakeDataLakes.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecuritylakeDataLakes.DataAwsccSecuritylakeDataLakes.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecuritylakeDataLakes.DataAwsccSecuritylakeDataLakes.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecuritylakeDataLakes.DataAwsccSecuritylakeDataLakes.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
...
const dataAwsccSecuritylakeDataLakesConfig: dataAwsccSecuritylakeDataLakes.DataAwsccSecuritylakeDataLakesConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecuritylakeDataLakes.DataAwsccSecuritylakeDataLakesConfig.property.connection">connection</a></code> | <code>cdktn.SSHProvisionerConnection \| cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecuritylakeDataLakes.DataAwsccSecuritylakeDataLakesConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecuritylakeDataLakes.DataAwsccSecuritylakeDataLakesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecuritylakeDataLakes.DataAwsccSecuritylakeDataLakesConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecuritylakeDataLakes.DataAwsccSecuritylakeDataLakesConfig.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecuritylakeDataLakes.DataAwsccSecuritylakeDataLakesConfig.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecuritylakeDataLakes.DataAwsccSecuritylakeDataLakesConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
