...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ssm_resource_data_sync
...
export class DataAwsccSsmResourceDataSync extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccSsmResourceDataSync that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ssm_resource_data_sync#import import section} in the documentation of this resource for the id to use
