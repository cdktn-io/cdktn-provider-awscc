...
new DataAwsccApplicationsignalsDiscoveries(Construct Scope, string Id, DataAwsccApplicationsignalsDiscoveriesConfig Config = null);
```
...
DataAwsccApplicationsignalsDiscoveries.IsConstruct(object X);
```
...
DataAwsccApplicationsignalsDiscoveries.IsTerraformElement(object X);
```
...
DataAwsccApplicationsignalsDiscoveries.IsTerraformDataSource(object X);
```
...
DataAwsccApplicationsignalsDiscoveries.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApplicationsignalsDiscoveries.DataAwsccApplicationsignalsDiscoveries.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApplicationsignalsDiscoveries.DataAwsccApplicationsignalsDiscoveries.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApplicationsignalsDiscoveries.DataAwsccApplicationsignalsDiscoveries.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApplicationsignalsDiscoveries.DataAwsccApplicationsignalsDiscoveries.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApplicationsignalsDiscoveries.DataAwsccApplicationsignalsDiscoveries.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApplicationsignalsDiscoveries.DataAwsccApplicationsignalsDiscoveries.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApplicationsignalsDiscoveries.DataAwsccApplicationsignalsDiscoveries.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
...
new DataAwsccApplicationsignalsDiscoveriesConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApplicationsignalsDiscoveries.DataAwsccApplicationsignalsDiscoveriesConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApplicationsignalsDiscoveries.DataAwsccApplicationsignalsDiscoveriesConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApplicationsignalsDiscoveries.DataAwsccApplicationsignalsDiscoveriesConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApplicationsignalsDiscoveries.DataAwsccApplicationsignalsDiscoveriesConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApplicationsignalsDiscoveries.DataAwsccApplicationsignalsDiscoveriesConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApplicationsignalsDiscoveries.DataAwsccApplicationsignalsDiscoveriesConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApplicationsignalsDiscoveries.DataAwsccApplicationsignalsDiscoveriesConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
