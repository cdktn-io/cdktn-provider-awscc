...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/cloudhsm_cluster
...
export class DataAwsccCloudhsmCluster extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCloudhsmCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/cloudhsm_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/cloudhsm_cluster awscc_cloudhsm_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
