...
export interface TimestreamScheduledQueryConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/timestream_scheduled_query#query_string TimestreamScheduledQuery#query_string}
  */
...
export class TimestreamScheduledQuery extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TimestreamScheduledQuery that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/timestream_scheduled_query#import import section} in the documentation of this resource for the id to use
