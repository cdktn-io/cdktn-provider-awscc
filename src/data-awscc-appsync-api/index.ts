...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/appsync_api
...
export class DataAwsccAppsyncApi extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccAppsyncApi that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/appsync_api#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/appsync_api awscc_appsync_api} Data Source
  *
  * @param scope The scope in which to define this construct
