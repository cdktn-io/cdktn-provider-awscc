...
```typescript
import { dataAwsccAppstreamImageBuilders } from '@cdktn/provider-awscc'

new dataAwsccAppstreamImageBuilders.DataAwsccAppstreamImageBuilders(scope: Construct, id: string, config?: DataAwsccAppstreamImageBuildersConfig)
```
...
dataAwsccAppstreamImageBuilders.DataAwsccAppstreamImageBuilders.isConstruct(x: any)
```
...
dataAwsccAppstreamImageBuilders.DataAwsccAppstreamImageBuilders.isTerraformElement(x: any)
```
...
dataAwsccAppstreamImageBuilders.DataAwsccAppstreamImageBuilders.isTerraformDataSource(x: any)
```
...
dataAwsccAppstreamImageBuilders.DataAwsccAppstreamImageBuilders.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppstreamImageBuilders.DataAwsccAppstreamImageBuilders.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppstreamImageBuilders.DataAwsccAppstreamImageBuilders.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppstreamImageBuilders.DataAwsccAppstreamImageBuilders.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppstreamImageBuilders.DataAwsccAppstreamImageBuilders.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppstreamImageBuilders.DataAwsccAppstreamImageBuilders.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccAppstreamImageBuildersConfig: dataAwsccAppstreamImageBuilders.DataAwsccAppstreamImageBuildersConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppstreamImageBuilders.DataAwsccAppstreamImageBuildersConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppstreamImageBuilders.DataAwsccAppstreamImageBuildersConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppstreamImageBuilders.DataAwsccAppstreamImageBuildersConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAppstreamImageBuilders.DataAwsccAppstreamImageBuildersConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
