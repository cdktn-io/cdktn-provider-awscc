...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/xray_sampling_rule
...
export class DataAwsccXraySamplingRule extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccXraySamplingRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/xray_sampling_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/xray_sampling_rule awscc_xray_sampling_rule} Data Source
  *
  * @param scope The scope in which to define this construct
