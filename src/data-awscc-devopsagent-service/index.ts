...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/devopsagent_service
...
export class DataAwsccDevopsagentService extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDevopsagentService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/devopsagent_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  // exchange_url_private_connection_name - computed: true, optional: false, required: false
  ...
  // private_connection_name - computed: true, optional: false, required: false
  ...
  // target_url_private_connection_name - computed: true, optional: false, required: false
