...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/iot_software_package_version
...
export class IotSoftwarePackageVersion extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotSoftwarePackageVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/iot_software_package_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/iot_software_package_version awscc_iot_software_package_version} Resource
  *
  * @param scope The scope in which to define this construct
