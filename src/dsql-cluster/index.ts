...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/dsql_cluster
...
export class DsqlCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DsqlCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/dsql_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/dsql_cluster awscc_dsql_cluster} Resource
  *
  * @param scope The scope in which to define this construct
