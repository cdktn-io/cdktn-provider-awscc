...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/comprehend_flywheel
...
export class ComprehendFlywheel extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ComprehendFlywheel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/comprehend_flywheel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/comprehend_flywheel awscc_comprehend_flywheel} Resource
  *
  * @param scope The scope in which to define this construct
