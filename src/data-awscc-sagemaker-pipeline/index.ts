...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/sagemaker_pipeline
...
export class DataAwsccSagemakerPipeline extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccSagemakerPipeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/sagemaker_pipeline#import import section} in the documentation of this resource for the id to use
