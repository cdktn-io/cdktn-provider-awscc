...
```typescript
import { mediaconvertPreset } from '@cdktn/provider-awscc'

new mediaconvertPreset.MediaconvertPreset(scope: Construct, id: string, config: MediaconvertPresetConfig)
```
...
mediaconvertPreset.MediaconvertPreset.isConstruct(x: any)
```
...
mediaconvertPreset.MediaconvertPreset.isTerraformElement(x: any)
```
...
mediaconvertPreset.MediaconvertPreset.isTerraformResource(x: any)
```
...
mediaconvertPreset.MediaconvertPreset.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.mediaconvertPreset.MediaconvertPreset.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.mediaconvertPreset.MediaconvertPreset.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.mediaconvertPreset.MediaconvertPreset.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.mediaconvertPreset.MediaconvertPreset.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.mediaconvertPreset.MediaconvertPreset.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.mediaconvertPreset.MediaconvertPreset.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const mediaconvertPresetConfig: mediaconvertPreset.MediaconvertPresetConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.mediaconvertPreset.MediaconvertPresetConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.mediaconvertPreset.MediaconvertPresetConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.mediaconvertPreset.MediaconvertPresetConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.mediaconvertPreset.MediaconvertPresetConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
