...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/workspacesinstances_workspace_instances
...
export class DataAwsccWorkspacesinstancesWorkspaceInstances extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccWorkspacesinstancesWorkspaceInstances that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/workspacesinstances_workspace_instances#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/workspacesinstances_workspace_instances awscc_workspacesinstances_workspace_instances} Data Source
  *
  * @param scope The scope in which to define this construct
