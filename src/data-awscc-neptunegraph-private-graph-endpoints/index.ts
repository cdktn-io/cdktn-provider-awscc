...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/neptunegraph_private_graph_endpoints
...
export class DataAwsccNeptunegraphPrivateGraphEndpoints extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccNeptunegraphPrivateGraphEndpoints that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/neptunegraph_private_graph_endpoints#import import section} in the documentation of this resource for the id to use
