...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/wisdom_assistant
...
export class WisdomAssistant extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WisdomAssistant that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/wisdom_assistant#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/wisdom_assistant awscc_wisdom_assistant} Resource
  *
  * @param scope The scope in which to define this construct
