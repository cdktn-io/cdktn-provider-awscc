...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/iam_managed_policy
...
export class IamManagedPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IamManagedPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/iam_managed_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/iam_managed_policy awscc_iam_managed_policy} Resource
  *
  * @param scope The scope in which to define this construct
