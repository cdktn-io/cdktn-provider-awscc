...
```typescript
import { dataAwsccSsmOpsItem } from '@cdktn/provider-awscc'

new dataAwsccSsmOpsItem.DataAwsccSsmOpsItem(scope: Construct, id: string, config: DataAwsccSsmOpsItemConfig)
```
...
dataAwsccSsmOpsItem.DataAwsccSsmOpsItem.isConstruct(x: any)
```
...
dataAwsccSsmOpsItem.DataAwsccSsmOpsItem.isTerraformElement(x: any)
```
...
dataAwsccSsmOpsItem.DataAwsccSsmOpsItem.isTerraformDataSource(x: any)
```
...
dataAwsccSsmOpsItem.DataAwsccSsmOpsItem.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmOpsItem.DataAwsccSsmOpsItem.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmOpsItem.DataAwsccSsmOpsItem.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmOpsItem.DataAwsccSsmOpsItem.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmOpsItem.DataAwsccSsmOpsItem.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmOpsItem.DataAwsccSsmOpsItem.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmOpsItem.DataAwsccSsmOpsItem.property.priority">priority</a></code> | <code>number</code> | *No description.* |
...
```typescript
public readonly tags: DataAwsccSsmOpsItemTagsList;
```
...
const dataAwsccSsmOpsItemConfig: dataAwsccSsmOpsItem.DataAwsccSsmOpsItemConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmOpsItem.DataAwsccSsmOpsItemConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmOpsItem.DataAwsccSsmOpsItemConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmOpsItem.DataAwsccSsmOpsItemConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmOpsItem.DataAwsccSsmOpsItemConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const dataAwsccSsmOpsItemTags: dataAwsccSsmOpsItem.DataAwsccSsmOpsItemTags = { ... }
```
...
new dataAwsccSsmOpsItem.DataAwsccSsmOpsItemTagsList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmOpsItem.DataAwsccSsmOpsItemTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmOpsItem.DataAwsccSsmOpsItemTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
new dataAwsccSsmOpsItem.DataAwsccSsmOpsItemTagsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmOpsItem.DataAwsccSsmOpsItemTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmOpsItem.DataAwsccSsmOpsItemTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSsmOpsItem.DataAwsccSsmOpsItemTagsOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```typescript
public readonly internalValue: DataAwsccSsmOpsItemTags;
```
