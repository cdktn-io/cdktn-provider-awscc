...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/logs_log_anomaly_detectors
...
export class DataAwsccLogsLogAnomalyDetectors extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccLogsLogAnomalyDetectors that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/logs_log_anomaly_detectors#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/logs_log_anomaly_detectors awscc_logs_log_anomaly_detectors} Data Source
  *
  * @param scope The scope in which to define this construct
