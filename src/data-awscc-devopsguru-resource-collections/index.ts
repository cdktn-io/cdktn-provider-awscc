...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/devopsguru_resource_collections
...
export class DataAwsccDevopsguruResourceCollections extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDevopsguruResourceCollections that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/devopsguru_resource_collections#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/devopsguru_resource_collections awscc_devopsguru_resource_collections} Data Source
  *
  * @param scope The scope in which to define this construct
