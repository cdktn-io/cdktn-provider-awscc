...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/translate_parallel_data
...
export class DataAwsccTranslateParallelData extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccTranslateParallelData that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/translate_parallel_data#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/translate_parallel_data awscc_translate_parallel_data} Data Source
  *
  * @param scope The scope in which to define this construct
