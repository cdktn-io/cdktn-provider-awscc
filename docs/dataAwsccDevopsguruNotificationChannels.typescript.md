...
```typescript
import { dataAwsccDevopsguruNotificationChannels } from '@cdktn/provider-awscc'

new dataAwsccDevopsguruNotificationChannels.DataAwsccDevopsguruNotificationChannels(scope: Construct, id: string, config?: DataAwsccDevopsguruNotificationChannelsConfig)
```
...
dataAwsccDevopsguruNotificationChannels.DataAwsccDevopsguruNotificationChannels.isConstruct(x: any)
```
...
dataAwsccDevopsguruNotificationChannels.DataAwsccDevopsguruNotificationChannels.isTerraformElement(x: any)
```
...
dataAwsccDevopsguruNotificationChannels.DataAwsccDevopsguruNotificationChannels.isTerraformDataSource(x: any)
```
...
dataAwsccDevopsguruNotificationChannels.DataAwsccDevopsguruNotificationChannels.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDevopsguruNotificationChannels.DataAwsccDevopsguruNotificationChannels.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDevopsguruNotificationChannels.DataAwsccDevopsguruNotificationChannels.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDevopsguruNotificationChannels.DataAwsccDevopsguruNotificationChannels.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDevopsguruNotificationChannels.DataAwsccDevopsguruNotificationChannels.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDevopsguruNotificationChannels.DataAwsccDevopsguruNotificationChannels.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccDevopsguruNotificationChannelsConfig: dataAwsccDevopsguruNotificationChannels.DataAwsccDevopsguruNotificationChannelsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDevopsguruNotificationChannels.DataAwsccDevopsguruNotificationChannelsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDevopsguruNotificationChannels.DataAwsccDevopsguruNotificationChannelsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDevopsguruNotificationChannels.DataAwsccDevopsguruNotificationChannelsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDevopsguruNotificationChannels.DataAwsccDevopsguruNotificationChannelsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
