...
new Ec2NetworkInterface(Construct Scope, string Id, Ec2NetworkInterfaceConfig Config);
```
...
```csharp
private void PutConnectionTrackingSpecification(Ec2NetworkInterfaceConnectionTrackingSpecification Value)
```
...
```csharp
private void PutIpv4Prefixes(IResolvable|Ec2NetworkInterfaceIpv4Prefixes[] Value)
```
...
- *Type:* Io.Cdktn.IResolvable|<a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv4Prefixes">Ec2NetworkInterfaceIpv4Prefixes</a>[]
...
```csharp
private void PutIpv6Addresses(IResolvable|Ec2NetworkInterfaceIpv6Addresses[] Value)
```
...
- *Type:* Io.Cdktn.IResolvable|<a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv6Addresses">Ec2NetworkInterfaceIpv6Addresses</a>[]
...
```csharp
private void PutIpv6Prefixes(IResolvable|Ec2NetworkInterfaceIpv6Prefixes[] Value)
```
...
- *Type:* Io.Cdktn.IResolvable|<a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv6Prefixes">Ec2NetworkInterfaceIpv6Prefixes</a>[]
...
```csharp
private void PutPrivateIpAddresses(IResolvable|Ec2NetworkInterfacePrivateIpAddresses[] Value)
```
...
- *Type:* Io.Cdktn.IResolvable|<a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfacePrivateIpAddresses">Ec2NetworkInterfacePrivateIpAddresses</a>[]
...
```csharp
private void PutTags(IResolvable|Ec2NetworkInterfaceTags[] Value)
```
...
- *Type:* Io.Cdktn.IResolvable|<a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceTags">Ec2NetworkInterfaceTags</a>[]
...
```csharp
private void ResetPublicIpDnsHostnameTypeSpecification()
```
...
Ec2NetworkInterface.IsConstruct(object X);
```
...
Ec2NetworkInterface.IsTerraformElement(object X);
```
...
Ec2NetworkInterface.IsTerraformResource(object X);
```
...
Ec2NetworkInterface.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterface.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterface.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterface.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterface.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterface.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterface.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterface.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterface.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterface.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterface.property.enablePrimaryIpv6Input">EnablePrimaryIpv6Input</a></code> | <code>bool\|Io.Cdktn.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterface.property.ipv4PrefixCountInput">Ipv4PrefixCountInput</a></code> | <code>double</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterface.property.ipv4PrefixesInput">Ipv4PrefixesInput</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv4Prefixes">Ec2NetworkInterfaceIpv4Prefixes</a>[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterface.property.ipv6AddressCountInput">Ipv6AddressCountInput</a></code> | <code>double</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterface.property.ipv6AddressesInput">Ipv6AddressesInput</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv6Addresses">Ec2NetworkInterfaceIpv6Addresses</a>[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterface.property.ipv6PrefixCountInput">Ipv6PrefixCountInput</a></code> | <code>double</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterface.property.ipv6PrefixesInput">Ipv6PrefixesInput</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv6Prefixes">Ec2NetworkInterfaceIpv6Prefixes</a>[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterface.property.secondaryPrivateIpAddressCountInput">SecondaryPrivateIpAddressCountInput</a></code> | <code>double</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterface.property.sourceDestCheckInput">SourceDestCheckInput</a></code> | <code>bool\|Io.Cdktn.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterface.property.tagsInput">TagsInput</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceTags">Ec2NetworkInterfaceTags</a>[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterface.property.enablePrimaryIpv6">EnablePrimaryIpv6</a></code> | <code>bool\|Io.Cdktn.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterface.property.ipv4PrefixCount">Ipv4PrefixCount</a></code> | <code>double</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterface.property.ipv6AddressCount">Ipv6AddressCount</a></code> | <code>double</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterface.property.ipv6PrefixCount">Ipv6PrefixCount</a></code> | <code>double</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterface.property.secondaryPrivateIpAddressCount">SecondaryPrivateIpAddressCount</a></code> | <code>double</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterface.property.sourceDestCheck">SourceDestCheck</a></code> | <code>bool\|Io.Cdktn.IResolvable</code> | *No description.* |
...
```csharp
public Ec2NetworkInterfaceConnectionTrackingSpecificationOutputReference ConnectionTrackingSpecification { get; }
```
...
```csharp
public Ec2NetworkInterfaceIpv4PrefixesList Ipv4Prefixes { get; }
```
...
```csharp
public Ec2NetworkInterfaceIpv6AddressesList Ipv6Addresses { get; }
```
...
```csharp
public Ec2NetworkInterfaceIpv6PrefixesList Ipv6Prefixes { get; }
```
...
```csharp
public Ec2NetworkInterfacePrivateIpAddressesList PrivateIpAddresses { get; }
```
...
```csharp
public Ec2NetworkInterfacePublicIpDnsNameOptionsOutputReference PublicIpDnsNameOptions { get; }
```
...
```csharp
public Ec2NetworkInterfaceTagsList Tags { get; }
```
...
```csharp
public IResolvable|Ec2NetworkInterfaceConnectionTrackingSpecification ConnectionTrackingSpecificationInput { get; }
```

- *Type:* Io.Cdktn.IResolvable|<a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceConnectionTrackingSpecification">Ec2NetworkInterfaceConnectionTrackingSpecification</a>
...
```csharp
public IResolvable|Ec2NetworkInterfaceIpv4Prefixes[] Ipv4PrefixesInput { get; }
```
...
```csharp
public IResolvable|Ec2NetworkInterfaceIpv6Addresses[] Ipv6AddressesInput { get; }
```
...
```csharp
public IResolvable|Ec2NetworkInterfaceIpv6Prefixes[] Ipv6PrefixesInput { get; }
```
...
```csharp
public IResolvable|Ec2NetworkInterfacePrivateIpAddresses[] PrivateIpAddressesInput { get; }
```
...
```csharp
public string PublicIpDnsHostnameTypeSpecificationInput { get; }
```
...
```csharp
public IResolvable|Ec2NetworkInterfaceTags[] TagsInput { get; }
```
...
new Ec2NetworkInterfaceConfig {
    ...
    string SubnetId,
    Ec2NetworkInterfaceConnectionTrackingSpecification ConnectionTrackingSpecification = null,
    string Description = null,
    bool|IResolvable EnablePrimaryIpv6 = null,
    string[] GroupSet = null,
    string InterfaceType = null,
    double Ipv4PrefixCount = null,
    IResolvable|Ec2NetworkInterfaceIpv4Prefixes[] Ipv4Prefixes = null,
    double Ipv6AddressCount = null,
    IResolvable|Ec2NetworkInterfaceIpv6Addresses[] Ipv6Addresses = null,
    double Ipv6PrefixCount = null,
    IResolvable|Ec2NetworkInterfaceIpv6Prefixes[] Ipv6Prefixes = null,
    string PrivateIpAddress = null,
    IResolvable|Ec2NetworkInterfacePrivateIpAddresses[] PrivateIpAddresses = null,
    string PublicIpDnsHostnameTypeSpecification = null,
    double SecondaryPrivateIpAddressCount = null,
    bool|IResolvable SourceDestCheck = null,
    IResolvable|Ec2NetworkInterfaceTags[] Tags = null
};
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceConfig.property.ipv4PrefixCount">Ipv4PrefixCount</a></code> | <code>double</code> | The number of IPv4 prefixes to assign to a network interface. |
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceConfig.property.ipv6AddressCount">Ipv6AddressCount</a></code> | <code>double</code> | The number of IPv6 addresses to assign to a network interface. |
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceConfig.property.ipv6PrefixCount">Ipv6PrefixCount</a></code> | <code>double</code> | The number of IPv6 prefixes to assign to a network interface. |
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceConfig.property.secondaryPrivateIpAddressCount">SecondaryPrivateIpAddressCount</a></code> | <code>double</code> | The number of secondary private IPv4 addresses to assign to a network interface. |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceConfig.property.sourceDestCheck">SourceDestCheck</a></code> | <code>bool\|Io.Cdktn.IResolvable</code> | Indicates whether traffic to or from the instance is validated. |
...
```csharp
public Ec2NetworkInterfaceConnectionTrackingSpecification ConnectionTrackingSpecification { get; set; }
```
...
```csharp
public IResolvable|Ec2NetworkInterfaceIpv4Prefixes[] Ipv4Prefixes { get; set; }
```
...
```csharp
public IResolvable|Ec2NetworkInterfaceIpv6Addresses[] Ipv6Addresses { get; set; }
```
...
```csharp
public IResolvable|Ec2NetworkInterfaceIpv6Prefixes[] Ipv6Prefixes { get; set; }
```
...
```csharp
public IResolvable|Ec2NetworkInterfacePrivateIpAddresses[] PrivateIpAddresses { get; set; }
```
...
```csharp
public string PublicIpDnsHostnameTypeSpecification { get; set; }
```
...
```csharp
public IResolvable|Ec2NetworkInterfaceTags[] Tags { get; set; }
```
...
new Ec2NetworkInterfaceConnectionTrackingSpecification {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceConnectionTrackingSpecification.property.tcpEstablishedTimeout">TcpEstablishedTimeout</a></code> | <code>double</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ec2_network_interface#tcp_established_timeout Ec2NetworkInterface#tcp_established_timeout}. |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceConnectionTrackingSpecification.property.udpStreamTimeout">UdpStreamTimeout</a></code> | <code>double</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ec2_network_interface#udp_stream_timeout Ec2NetworkInterface#udp_stream_timeout}. |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceConnectionTrackingSpecification.property.udpTimeout">UdpTimeout</a></code> | <code>double</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ec2_network_interface#udp_timeout Ec2NetworkInterface#udp_timeout}. |
...
new Ec2NetworkInterfaceIpv4Prefixes {
...
new Ec2NetworkInterfaceIpv6Addresses {
...
new Ec2NetworkInterfaceIpv6Prefixes {
...
new Ec2NetworkInterfacePrivateIpAddresses {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfacePrivateIpAddresses.property.primary">Primary</a></code> | <code>bool\|Io.Cdktn.IResolvable</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ec2_network_interface#primary Ec2NetworkInterface#primary}. |
...
new Ec2NetworkInterfacePublicIpDnsNameOptions {
...
new Ec2NetworkInterfaceConnectionTrackingSpecificationOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceConnectionTrackingSpecificationOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceConnectionTrackingSpecificationOutputReference.resolve.parameter._context"></a>
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceConnectionTrackingSpecificationOutputReference.property.tcpEstablishedTimeoutInput">TcpEstablishedTimeoutInput</a></code> | <code>double</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceConnectionTrackingSpecificationOutputReference.property.udpStreamTimeoutInput">UdpStreamTimeoutInput</a></code> | <code>double</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceConnectionTrackingSpecificationOutputReference.property.udpTimeoutInput">UdpTimeoutInput</a></code> | <code>double</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceConnectionTrackingSpecificationOutputReference.property.tcpEstablishedTimeout">TcpEstablishedTimeout</a></code> | <code>double</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceConnectionTrackingSpecificationOutputReference.property.udpStreamTimeout">UdpStreamTimeout</a></code> | <code>double</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceConnectionTrackingSpecificationOutputReference.property.udpTimeout">UdpTimeout</a></code> | <code>double</code> | *No description.* |
...
```csharp
public IResolvable|Ec2NetworkInterfaceConnectionTrackingSpecification InternalValue { get; }
```
...
new Ec2NetworkInterfaceIpv4PrefixesList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv4PrefixesList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv4PrefixesList.resolve.parameter._context"></a>
...
```csharp
private Ec2NetworkInterfaceIpv4PrefixesOutputReference Get(double Index)
```
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv4PrefixesList.property.internalValue">InternalValue</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv4Prefixes">Ec2NetworkInterfaceIpv4Prefixes</a>[]</code> | *No description.* |
...
```csharp
public IResolvable|Ec2NetworkInterfaceIpv4Prefixes[] InternalValue { get; }
```
...
new Ec2NetworkInterfaceIpv4PrefixesOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv4PrefixesOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv4PrefixesOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv4PrefixesOutputReference.resolve.parameter._context"></a>
...
```csharp
public string Ipv4PrefixInput { get; }
```
...
new Ec2NetworkInterfaceIpv6AddressesList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv6AddressesList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv6AddressesList.resolve.parameter._context"></a>
...
```csharp
private Ec2NetworkInterfaceIpv6AddressesOutputReference Get(double Index)
```
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv6AddressesList.property.internalValue">InternalValue</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv6Addresses">Ec2NetworkInterfaceIpv6Addresses</a>[]</code> | *No description.* |
...
```csharp
public IResolvable|Ec2NetworkInterfaceIpv6Addresses[] InternalValue { get; }
```
...
new Ec2NetworkInterfaceIpv6AddressesOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv6AddressesOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv6AddressesOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv6AddressesOutputReference.resolve.parameter._context"></a>
...
new Ec2NetworkInterfaceIpv6PrefixesList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv6PrefixesList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv6PrefixesList.resolve.parameter._context"></a>
...
```csharp
private Ec2NetworkInterfaceIpv6PrefixesOutputReference Get(double Index)
```
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv6PrefixesList.property.internalValue">InternalValue</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv6Prefixes">Ec2NetworkInterfaceIpv6Prefixes</a>[]</code> | *No description.* |
...
```csharp
public IResolvable|Ec2NetworkInterfaceIpv6Prefixes[] InternalValue { get; }
```
...
new Ec2NetworkInterfaceIpv6PrefixesOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv6PrefixesOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv6PrefixesOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceIpv6PrefixesOutputReference.resolve.parameter._context"></a>
...
```csharp
public string Ipv6PrefixInput { get; }
```
...
new Ec2NetworkInterfacePrivateIpAddressesList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfacePrivateIpAddressesList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfacePrivateIpAddressesList.resolve.parameter._context"></a>
...
```csharp
private Ec2NetworkInterfacePrivateIpAddressesOutputReference Get(double Index)
```
...
```csharp
public IResolvable|Ec2NetworkInterfacePrivateIpAddresses[] InternalValue { get; }
```
...
new Ec2NetworkInterfacePrivateIpAddressesOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfacePrivateIpAddressesOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfacePrivateIpAddressesOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfacePrivateIpAddressesOutputReference.resolve.parameter._context"></a>
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfacePrivateIpAddressesOutputReference.property.primaryInput">PrimaryInput</a></code> | <code>bool\|Io.Cdktn.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfacePrivateIpAddressesOutputReference.property.primary">Primary</a></code> | <code>bool\|Io.Cdktn.IResolvable</code> | *No description.* |
...
new Ec2NetworkInterfacePublicIpDnsNameOptionsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfacePublicIpDnsNameOptionsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfacePublicIpDnsNameOptionsOutputReference.resolve.parameter._context"></a>
...
```csharp
public Ec2NetworkInterfacePublicIpDnsNameOptions InternalValue { get; }
```
...
new Ec2NetworkInterfaceTagsList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceTagsList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceTagsList.resolve.parameter._context"></a>
...
```csharp
private Ec2NetworkInterfaceTagsOutputReference Get(double Index)
```
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceTagsList.property.internalValue">InternalValue</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceTags">Ec2NetworkInterfaceTags</a>[]</code> | *No description.* |
...
```csharp
public IResolvable|Ec2NetworkInterfaceTags[] InternalValue { get; }
```
...
new Ec2NetworkInterfaceTagsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceTagsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceTagsOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceTagsOutputReference.resolve.parameter._context"></a>
...
| <code><a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceTagsOutputReference.property.internalValue">InternalValue</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfaceTags">Ec2NetworkInterfaceTags</a></code> | *No description.* |
