...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iot_thing_type
...
export class IotThingType extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotThingType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iot_thing_type#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iot_thing_type awscc_iot_thing_type} Resource
  *
  * @param scope The scope in which to define this construct
