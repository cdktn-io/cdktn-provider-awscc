...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/cassandra_type
...
export class CassandraType extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CassandraType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/cassandra_type#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/cassandra_type awscc_cassandra_type} Resource
  *
  * @param scope The scope in which to define this construct
