...
```typescript
import { dataAwsccResourcegroupsTagSyncTasks } from '@cdktn/provider-awscc'

new dataAwsccResourcegroupsTagSyncTasks.DataAwsccResourcegroupsTagSyncTasks(scope: Construct, id: string, config?: DataAwsccResourcegroupsTagSyncTasksConfig)
```
...
dataAwsccResourcegroupsTagSyncTasks.DataAwsccResourcegroupsTagSyncTasks.isConstruct(x: any)
```
...
dataAwsccResourcegroupsTagSyncTasks.DataAwsccResourcegroupsTagSyncTasks.isTerraformElement(x: any)
```
...
dataAwsccResourcegroupsTagSyncTasks.DataAwsccResourcegroupsTagSyncTasks.isTerraformDataSource(x: any)
```
...
dataAwsccResourcegroupsTagSyncTasks.DataAwsccResourcegroupsTagSyncTasks.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccResourcegroupsTagSyncTasks.DataAwsccResourcegroupsTagSyncTasks.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccResourcegroupsTagSyncTasks.DataAwsccResourcegroupsTagSyncTasks.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccResourcegroupsTagSyncTasks.DataAwsccResourcegroupsTagSyncTasks.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccResourcegroupsTagSyncTasks.DataAwsccResourcegroupsTagSyncTasks.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccResourcegroupsTagSyncTasks.DataAwsccResourcegroupsTagSyncTasks.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccResourcegroupsTagSyncTasksConfig: dataAwsccResourcegroupsTagSyncTasks.DataAwsccResourcegroupsTagSyncTasksConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccResourcegroupsTagSyncTasks.DataAwsccResourcegroupsTagSyncTasksConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccResourcegroupsTagSyncTasks.DataAwsccResourcegroupsTagSyncTasksConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccResourcegroupsTagSyncTasks.DataAwsccResourcegroupsTagSyncTasksConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccResourcegroupsTagSyncTasks.DataAwsccResourcegroupsTagSyncTasksConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
