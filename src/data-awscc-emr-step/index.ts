...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/emr_step
...
export class DataAwsccEmrStep extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEmrStep that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/emr_step#import import section} in the documentation of this resource for the id to use
