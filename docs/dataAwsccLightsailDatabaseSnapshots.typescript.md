...
Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/lightsail_database_snapshots awscc_lightsail_database_snapshots}.
...
```typescript
import { dataAwsccLightsailDatabaseSnapshots } from '@cdktn/provider-awscc'

new dataAwsccLightsailDatabaseSnapshots.DataAwsccLightsailDatabaseSnapshots(scope: Construct, id: string, config?: DataAwsccLightsailDatabaseSnapshotsConfig)
```
...
dataAwsccLightsailDatabaseSnapshots.DataAwsccLightsailDatabaseSnapshots.isConstruct(x: any)
```
...
dataAwsccLightsailDatabaseSnapshots.DataAwsccLightsailDatabaseSnapshots.isTerraformElement(x: any)
```
...
dataAwsccLightsailDatabaseSnapshots.DataAwsccLightsailDatabaseSnapshots.isTerraformDataSource(x: any)
```
...
dataAwsccLightsailDatabaseSnapshots.DataAwsccLightsailDatabaseSnapshots.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/lightsail_database_snapshots#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccLightsailDatabaseSnapshots.DataAwsccLightsailDatabaseSnapshots.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccLightsailDatabaseSnapshots.DataAwsccLightsailDatabaseSnapshots.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccLightsailDatabaseSnapshots.DataAwsccLightsailDatabaseSnapshots.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLightsailDatabaseSnapshots.DataAwsccLightsailDatabaseSnapshots.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccLightsailDatabaseSnapshots.DataAwsccLightsailDatabaseSnapshots.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLightsailDatabaseSnapshots.DataAwsccLightsailDatabaseSnapshots.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLightsailDatabaseSnapshots.DataAwsccLightsailDatabaseSnapshots.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
...
const dataAwsccLightsailDatabaseSnapshotsConfig: dataAwsccLightsailDatabaseSnapshots.DataAwsccLightsailDatabaseSnapshotsConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLightsailDatabaseSnapshots.DataAwsccLightsailDatabaseSnapshotsConfig.property.connection">connection</a></code> | <code>cdktn.SSHProvisionerConnection \| cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLightsailDatabaseSnapshots.DataAwsccLightsailDatabaseSnapshotsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLightsailDatabaseSnapshots.DataAwsccLightsailDatabaseSnapshotsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLightsailDatabaseSnapshots.DataAwsccLightsailDatabaseSnapshotsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLightsailDatabaseSnapshots.DataAwsccLightsailDatabaseSnapshotsConfig.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLightsailDatabaseSnapshots.DataAwsccLightsailDatabaseSnapshotsConfig.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccLightsailDatabaseSnapshots.DataAwsccLightsailDatabaseSnapshotsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
