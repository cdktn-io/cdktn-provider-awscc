...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/msk_serverless_cluster
...
export class DataAwsccMskServerlessCluster extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccMskServerlessCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/msk_serverless_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/msk_serverless_cluster awscc_msk_serverless_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
