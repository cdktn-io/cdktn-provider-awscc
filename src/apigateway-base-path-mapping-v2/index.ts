...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/apigateway_base_path_mapping_v2
...
export class ApigatewayBasePathMappingV2 extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApigatewayBasePathMappingV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/apigateway_base_path_mapping_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/apigateway_base_path_mapping_v2 awscc_apigateway_base_path_mapping_v2} Resource
  *
  * @param scope The scope in which to define this construct
