...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ecr_repository
...
export class EcrRepository extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EcrRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ecr_repository#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ecr_repository awscc_ecr_repository} Resource
  *
  * @param scope The scope in which to define this construct
