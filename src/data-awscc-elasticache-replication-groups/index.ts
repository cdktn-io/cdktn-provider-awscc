...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/elasticache_replication_groups
...
export class DataAwsccElasticacheReplicationGroups extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccElasticacheReplicationGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/elasticache_replication_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/elasticache_replication_groups awscc_elasticache_replication_groups} Data Source
  *
  * @param scope The scope in which to define this construct
