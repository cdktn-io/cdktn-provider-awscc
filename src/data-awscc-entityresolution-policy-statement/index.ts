...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/entityresolution_policy_statement
...
export class DataAwsccEntityresolutionPolicyStatement extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEntityresolutionPolicyStatement that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/entityresolution_policy_statement#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/entityresolution_policy_statement awscc_entityresolution_policy_statement} Data Source
  *
  * @param scope The scope in which to define this construct
