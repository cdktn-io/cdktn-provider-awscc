...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/eventschemas_registry
...
export class EventschemasRegistry extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EventschemasRegistry that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/eventschemas_registry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/eventschemas_registry awscc_eventschemas_registry} Resource
  *
  * @param scope The scope in which to define this construct
