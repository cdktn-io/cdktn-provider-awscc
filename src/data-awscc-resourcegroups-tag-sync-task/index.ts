...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/resourcegroups_tag_sync_task
...
export class DataAwsccResourcegroupsTagSyncTask extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccResourcegroupsTagSyncTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/resourcegroups_tag_sync_task#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/resourcegroups_tag_sync_task awscc_resourcegroups_tag_sync_task} Data Source
  *
  * @param scope The scope in which to define this construct
