...
Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/notificationscontacts_email_contacts awscc_notificationscontacts_email_contacts}.
...
```typescript
import { dataAwsccNotificationscontactsEmailContacts } from '@cdktn/provider-awscc'

new dataAwsccNotificationscontactsEmailContacts.DataAwsccNotificationscontactsEmailContacts(scope: Construct, id: string, config?: DataAwsccNotificationscontactsEmailContactsConfig)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationscontactsEmailContacts.DataAwsccNotificationscontactsEmailContacts.Initializer.parameter.scope">scope</a></code> | <code>constructs.Construct</code> | The scope in which to define this construct. |
...
dataAwsccNotificationscontactsEmailContacts.DataAwsccNotificationscontactsEmailContacts.isConstruct(x: any)
```
...
dataAwsccNotificationscontactsEmailContacts.DataAwsccNotificationscontactsEmailContacts.isTerraformElement(x: any)
```
...
dataAwsccNotificationscontactsEmailContacts.DataAwsccNotificationscontactsEmailContacts.isTerraformDataSource(x: any)
```
...
dataAwsccNotificationscontactsEmailContacts.DataAwsccNotificationscontactsEmailContacts.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/notificationscontacts_email_contacts#import import section} in the documentation of this resource for the id to use
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationscontactsEmailContacts.DataAwsccNotificationscontactsEmailContacts.property.node">node</a></code> | <code>constructs.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationscontactsEmailContacts.DataAwsccNotificationscontactsEmailContacts.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationscontactsEmailContacts.DataAwsccNotificationscontactsEmailContacts.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationscontactsEmailContacts.DataAwsccNotificationscontactsEmailContacts.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationscontactsEmailContacts.DataAwsccNotificationscontactsEmailContacts.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationscontactsEmailContacts.DataAwsccNotificationscontactsEmailContacts.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationscontactsEmailContacts.DataAwsccNotificationscontactsEmailContacts.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationscontactsEmailContacts.DataAwsccNotificationscontactsEmailContacts.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
...
const dataAwsccNotificationscontactsEmailContactsConfig: dataAwsccNotificationscontactsEmailContacts.DataAwsccNotificationscontactsEmailContactsConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationscontactsEmailContacts.DataAwsccNotificationscontactsEmailContactsConfig.property.connection">connection</a></code> | <code>cdktn.SSHProvisionerConnection \| cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationscontactsEmailContacts.DataAwsccNotificationscontactsEmailContactsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationscontactsEmailContacts.DataAwsccNotificationscontactsEmailContactsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationscontactsEmailContacts.DataAwsccNotificationscontactsEmailContactsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationscontactsEmailContacts.DataAwsccNotificationscontactsEmailContactsConfig.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationscontactsEmailContacts.DataAwsccNotificationscontactsEmailContactsConfig.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNotificationscontactsEmailContacts.DataAwsccNotificationscontactsEmailContactsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
