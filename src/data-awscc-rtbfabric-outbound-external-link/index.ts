...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/rtbfabric_outbound_external_link
...
export class DataAwsccRtbfabricOutboundExternalLink extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRtbfabricOutboundExternalLink that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/rtbfabric_outbound_external_link#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/rtbfabric_outbound_external_link awscc_rtbfabric_outbound_external_link} Data Source
  *
  * @param scope The scope in which to define this construct
