...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ecr_pull_through_cache_rule
...
export class EcrPullThroughCacheRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EcrPullThroughCacheRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ecr_pull_through_cache_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ecr_pull_through_cache_rule awscc_ecr_pull_through_cache_rule} Resource
  *
  * @param scope The scope in which to define this construct
