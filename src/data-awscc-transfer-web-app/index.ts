...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/transfer_web_app
...
export class DataAwsccTransferWebApp extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccTransferWebApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/transfer_web_app#import import section} in the documentation of this resource for the id to use
