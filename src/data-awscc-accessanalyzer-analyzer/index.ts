...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/accessanalyzer_analyzer
...
export class DataAwsccAccessanalyzerAnalyzer extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccAccessanalyzerAnalyzer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/accessanalyzer_analyzer#import import section} in the documentation of this resource for the id to use
