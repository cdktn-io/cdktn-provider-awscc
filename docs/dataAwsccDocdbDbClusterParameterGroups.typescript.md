...
```typescript
import { dataAwsccDocdbDbClusterParameterGroups } from '@cdktn/provider-awscc'

new dataAwsccDocdbDbClusterParameterGroups.DataAwsccDocdbDbClusterParameterGroups(scope: Construct, id: string, config?: DataAwsccDocdbDbClusterParameterGroupsConfig)
```
...
dataAwsccDocdbDbClusterParameterGroups.DataAwsccDocdbDbClusterParameterGroups.isConstruct(x: any)
```
...
dataAwsccDocdbDbClusterParameterGroups.DataAwsccDocdbDbClusterParameterGroups.isTerraformElement(x: any)
```
...
dataAwsccDocdbDbClusterParameterGroups.DataAwsccDocdbDbClusterParameterGroups.isTerraformDataSource(x: any)
```
...
dataAwsccDocdbDbClusterParameterGroups.DataAwsccDocdbDbClusterParameterGroups.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbDbClusterParameterGroups.DataAwsccDocdbDbClusterParameterGroups.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbDbClusterParameterGroups.DataAwsccDocdbDbClusterParameterGroups.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbDbClusterParameterGroups.DataAwsccDocdbDbClusterParameterGroups.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbDbClusterParameterGroups.DataAwsccDocdbDbClusterParameterGroups.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbDbClusterParameterGroups.DataAwsccDocdbDbClusterParameterGroups.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbDbClusterParameterGroups.DataAwsccDocdbDbClusterParameterGroups.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbDbClusterParameterGroups.DataAwsccDocdbDbClusterParameterGroups.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
...
const dataAwsccDocdbDbClusterParameterGroupsConfig: dataAwsccDocdbDbClusterParameterGroups.DataAwsccDocdbDbClusterParameterGroupsConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbDbClusterParameterGroups.DataAwsccDocdbDbClusterParameterGroupsConfig.property.connection">connection</a></code> | <code>cdktn.SSHProvisionerConnection \| cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbDbClusterParameterGroups.DataAwsccDocdbDbClusterParameterGroupsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbDbClusterParameterGroups.DataAwsccDocdbDbClusterParameterGroupsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbDbClusterParameterGroups.DataAwsccDocdbDbClusterParameterGroupsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbDbClusterParameterGroups.DataAwsccDocdbDbClusterParameterGroupsConfig.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbDbClusterParameterGroups.DataAwsccDocdbDbClusterParameterGroupsConfig.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDocdbDbClusterParameterGroups.DataAwsccDocdbDbClusterParameterGroupsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
