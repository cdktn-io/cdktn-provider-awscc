...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_ipam
...
export class Ec2Ipam extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2Ipam that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_ipam#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_ipam awscc_ec2_ipam} Resource
  *
  * @param scope The scope in which to define this construct
