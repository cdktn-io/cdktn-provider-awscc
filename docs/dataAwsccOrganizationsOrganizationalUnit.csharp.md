...
new DataAwsccOrganizationsOrganizationalUnit(Construct Scope, string Id, DataAwsccOrganizationsOrganizationalUnitConfig Config);
```
...
DataAwsccOrganizationsOrganizationalUnit.IsConstruct(object X);
```
...
DataAwsccOrganizationsOrganizationalUnit.IsTerraformElement(object X);
```
...
DataAwsccOrganizationsOrganizationalUnit.IsTerraformDataSource(object X);
```
...
DataAwsccOrganizationsOrganizationalUnit.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccOrganizationsOrganizationalUnit.DataAwsccOrganizationsOrganizationalUnit.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccOrganizationsOrganizationalUnit.DataAwsccOrganizationsOrganizationalUnit.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccOrganizationsOrganizationalUnit.DataAwsccOrganizationsOrganizationalUnit.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccOrganizationsOrganizationalUnit.DataAwsccOrganizationsOrganizationalUnit.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccOrganizationsOrganizationalUnit.DataAwsccOrganizationsOrganizationalUnit.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccOrganizationsOrganizationalUnit.DataAwsccOrganizationsOrganizationalUnit.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccOrganizationsOrganizationalUnit.DataAwsccOrganizationsOrganizationalUnit.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
...
```csharp
public DataAwsccOrganizationsOrganizationalUnitTagsList Tags { get; }
```
...
new DataAwsccOrganizationsOrganizationalUnitConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccOrganizationsOrganizationalUnit.DataAwsccOrganizationsOrganizationalUnitConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccOrganizationsOrganizationalUnit.DataAwsccOrganizationsOrganizationalUnitConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccOrganizationsOrganizationalUnit.DataAwsccOrganizationsOrganizationalUnitConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccOrganizationsOrganizationalUnit.DataAwsccOrganizationsOrganizationalUnitConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccOrganizationsOrganizationalUnit.DataAwsccOrganizationsOrganizationalUnitConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccOrganizationsOrganizationalUnit.DataAwsccOrganizationsOrganizationalUnitConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccOrganizationsOrganizationalUnit.DataAwsccOrganizationsOrganizationalUnitConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
new DataAwsccOrganizationsOrganizationalUnitTags {
...
new DataAwsccOrganizationsOrganizationalUnitTagsList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccOrganizationsOrganizationalUnit.DataAwsccOrganizationsOrganizationalUnitTagsList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccOrganizationsOrganizationalUnit.DataAwsccOrganizationsOrganizationalUnitTagsList.Initializer.parameter.wrapsSet">WrapsSet</a></code> | <code>bool</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.dataAwsccOrganizationsOrganizationalUnit.DataAwsccOrganizationsOrganizationalUnitTagsList.resolve.parameter._context"></a>
...
```csharp
private DataAwsccOrganizationsOrganizationalUnitTagsOutputReference Get(double Index)
```
...
new DataAwsccOrganizationsOrganizationalUnitTagsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccOrganizationsOrganizationalUnit.DataAwsccOrganizationsOrganizationalUnitTagsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccOrganizationsOrganizationalUnit.DataAwsccOrganizationsOrganizationalUnitTagsOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.dataAwsccOrganizationsOrganizationalUnit.DataAwsccOrganizationsOrganizationalUnitTagsOutputReference.resolve.parameter._context"></a>
...
```csharp
public DataAwsccOrganizationsOrganizationalUnitTags InternalValue { get; }
```
