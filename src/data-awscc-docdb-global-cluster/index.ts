...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/docdb_global_cluster
...
export class DataAwsccDocdbGlobalCluster extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDocdbGlobalCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/docdb_global_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/docdb_global_cluster awscc_docdb_global_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
