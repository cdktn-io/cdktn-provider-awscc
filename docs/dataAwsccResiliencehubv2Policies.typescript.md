...
```typescript
import { dataAwsccResiliencehubv2Policies } from '@cdktn/provider-awscc'

new dataAwsccResiliencehubv2Policies.DataAwsccResiliencehubv2Policies(scope: Construct, id: string, config?: DataAwsccResiliencehubv2PoliciesConfig)
```
...
dataAwsccResiliencehubv2Policies.DataAwsccResiliencehubv2Policies.isConstruct(x: any)
```
...
dataAwsccResiliencehubv2Policies.DataAwsccResiliencehubv2Policies.isTerraformElement(x: any)
```
...
dataAwsccResiliencehubv2Policies.DataAwsccResiliencehubv2Policies.isTerraformDataSource(x: any)
```
...
dataAwsccResiliencehubv2Policies.DataAwsccResiliencehubv2Policies.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccResiliencehubv2Policies.DataAwsccResiliencehubv2Policies.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccResiliencehubv2Policies.DataAwsccResiliencehubv2Policies.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccResiliencehubv2Policies.DataAwsccResiliencehubv2Policies.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccResiliencehubv2Policies.DataAwsccResiliencehubv2Policies.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccResiliencehubv2Policies.DataAwsccResiliencehubv2Policies.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccResiliencehubv2PoliciesConfig: dataAwsccResiliencehubv2Policies.DataAwsccResiliencehubv2PoliciesConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccResiliencehubv2Policies.DataAwsccResiliencehubv2PoliciesConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccResiliencehubv2Policies.DataAwsccResiliencehubv2PoliciesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccResiliencehubv2Policies.DataAwsccResiliencehubv2PoliciesConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccResiliencehubv2Policies.DataAwsccResiliencehubv2PoliciesConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
