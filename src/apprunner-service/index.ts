...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/apprunner_service
...
export class ApprunnerService extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApprunnerService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/apprunner_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/apprunner_service awscc_apprunner_service} Resource
  *
  * @param scope The scope in which to define this construct
