...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/s3tables_table
...
export class DataAwsccS3TablesTable extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccS3TablesTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/s3tables_table#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/s3tables_table awscc_s3tables_table} Data Source
  *
  * @param scope The scope in which to define this construct
