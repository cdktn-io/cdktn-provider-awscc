...
Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/pcs_compute_node_group awscc_pcs_compute_node_group}.
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/pcs_compute_node_group#import import section} in the documentation of this resource for the id to use
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/pcs_compute_node_group#id DataAwsccPcsComputeNodeGroup#id}
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccPcsComputeNodeGroup.DataAwsccPcsComputeNodeGroupSlurmConfigurationOutputReference.property.gresCustomSettings">GresCustomSettings</a></code> | <code>Io.Cdktn.StringMapList</code> | *No description.* |
...
##### `GresCustomSettings`<sup>Required</sup> <a name="GresCustomSettings" id="@cdktn/provider-awscc.dataAwsccPcsComputeNodeGroup.DataAwsccPcsComputeNodeGroupSlurmConfigurationOutputReference.property.gresCustomSettings"></a>

```csharp
public StringMapList GresCustomSettings { get; }
```
