...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/sagemaker_user_profile
...
export interface DataAwsccSagemakerUserProfileConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/sagemaker_user_profile#id DataAwsccSagemakerUserProfile#id}
  *
...
export interface DataAwsccSagemakerUserProfileUserSettingsJupyterLabAppSettingsEmrSettings {
}

export function dataAwsccSagemakerUserProfileUserSettingsJupyterLabAppSettingsEmrSettingsToTerraform(struct?: DataAwsccSagemakerUserProfileUserSettingsJupyterLabAppSettingsEmrSettings): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsccSagemakerUserProfileUserSettingsJupyterLabAppSettingsEmrSettingsToHclTerraform(struct?: DataAwsccSagemakerUserProfileUserSettingsJupyterLabAppSettingsEmrSettings): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsccSagemakerUserProfileUserSettingsJupyterLabAppSettingsEmrSettingsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAwsccSagemakerUserProfileUserSettingsJupyterLabAppSettingsEmrSettings | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsccSagemakerUserProfileUserSettingsJupyterLabAppSettingsEmrSettings | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  // assumable_role_arns - computed: true, optional: false, required: false
  public get assumableRoleArns() {
    return this.getListAttribute('assumable_role_arns');
  }

  // execution_role_arns - computed: true, optional: false, required: false
...
export class DataAwsccSagemakerUserProfileUserSettingsJupyterLabAppSettingsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  // emr_settings - computed: true, optional: false, required: false
  private _emrSettings = new DataAwsccSagemakerUserProfileUserSettingsJupyterLabAppSettingsEmrSettingsOutputReference(this, "emr_settings");
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/sagemaker_user_profile awscc_sagemaker_user_profile}
*/
export class DataAwsccSagemakerUserProfile extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccSagemakerUserProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/sagemaker_user_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/sagemaker_user_profile awscc_sagemaker_user_profile} Data Source
  *
  * @param scope The scope in which to define this construct
