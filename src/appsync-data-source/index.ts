...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/appsync_data_source
...
export class AppsyncDataSource extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AppsyncDataSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/appsync_data_source#import import section} in the documentation of this resource for the id to use
