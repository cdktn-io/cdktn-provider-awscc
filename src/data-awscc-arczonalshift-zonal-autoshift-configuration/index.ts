...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/arczonalshift_zonal_autoshift_configuration
...
export class DataAwsccArczonalshiftZonalAutoshiftConfiguration extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccArczonalshiftZonalAutoshiftConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/arczonalshift_zonal_autoshift_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/arczonalshift_zonal_autoshift_configuration awscc_arczonalshift_zonal_autoshift_configuration} Data Source
  *
  * @param scope The scope in which to define this construct
