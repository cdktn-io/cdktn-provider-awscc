...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/appsync_apis
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/appsync_apis awscc_appsync_apis}
*/
export class DataAwsccAppsyncApis extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccAppsyncApis that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/appsync_apis#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/appsync_apis awscc_appsync_apis} Data Source
  *
  * @param scope The scope in which to define this construct
