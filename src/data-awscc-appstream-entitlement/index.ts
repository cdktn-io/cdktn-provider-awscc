...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/appstream_entitlement
...
export class DataAwsccAppstreamEntitlement extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccAppstreamEntitlement that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/appstream_entitlement#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/appstream_entitlement awscc_appstream_entitlement} Data Source
  *
  * @param scope The scope in which to define this construct
