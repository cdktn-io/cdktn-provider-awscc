...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/securitylake_aws_log_sources
...
export class DataAwsccSecuritylakeAwsLogSources extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccSecuritylakeAwsLogSources that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/securitylake_aws_log_sources#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/securitylake_aws_log_sources awscc_securitylake_aws_log_sources} Data Source
  *
  * @param scope The scope in which to define this construct
