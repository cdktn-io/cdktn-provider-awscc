...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/evs_environment
...
export class DataAwsccEvsEnvironment extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEvsEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/evs_environment#import import section} in the documentation of this resource for the id to use
