...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ses_mail_manager_traffic_policy
...
export class SesMailManagerTrafficPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SesMailManagerTrafficPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ses_mail_manager_traffic_policy#import import section} in the documentation of this resource for the id to use
