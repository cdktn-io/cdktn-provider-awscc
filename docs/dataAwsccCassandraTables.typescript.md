...
```typescript
import { dataAwsccCassandraTables } from '@cdktn/provider-awscc'

new dataAwsccCassandraTables.DataAwsccCassandraTables(scope: Construct, id: string, config?: DataAwsccCassandraTablesConfig)
```
...
dataAwsccCassandraTables.DataAwsccCassandraTables.isConstruct(x: any)
```
...
dataAwsccCassandraTables.DataAwsccCassandraTables.isTerraformElement(x: any)
```
...
dataAwsccCassandraTables.DataAwsccCassandraTables.isTerraformDataSource(x: any)
```
...
dataAwsccCassandraTables.DataAwsccCassandraTables.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCassandraTables.DataAwsccCassandraTables.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCassandraTables.DataAwsccCassandraTables.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCassandraTables.DataAwsccCassandraTables.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCassandraTables.DataAwsccCassandraTables.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCassandraTables.DataAwsccCassandraTables.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccCassandraTablesConfig: dataAwsccCassandraTables.DataAwsccCassandraTablesConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCassandraTables.DataAwsccCassandraTablesConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCassandraTables.DataAwsccCassandraTablesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCassandraTables.DataAwsccCassandraTablesConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCassandraTables.DataAwsccCassandraTablesConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
