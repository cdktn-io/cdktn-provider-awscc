...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/uxc_account_customization
...
export class UxcAccountCustomization extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing UxcAccountCustomization that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/uxc_account_customization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/uxc_account_customization awscc_uxc_account_customization} Resource
  *
  * @param scope The scope in which to define this construct
