...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/macie_custom_data_identifier
...
export class MacieCustomDataIdentifier extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MacieCustomDataIdentifier that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/macie_custom_data_identifier#import import section} in the documentation of this resource for the id to use
