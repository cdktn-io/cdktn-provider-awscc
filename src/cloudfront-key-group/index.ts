...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/cloudfront_key_group
...
export class CloudfrontKeyGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudfrontKeyGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/cloudfront_key_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/cloudfront_key_group awscc_cloudfront_key_group} Resource
  *
  * @param scope The scope in which to define this construct
