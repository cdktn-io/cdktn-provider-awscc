...
```typescript
import { ec2IPv4Pool } from '@cdktn/provider-awscc'

new ec2IPv4Pool.Ec2IPv4Pool(scope: Construct, id: string, config?: Ec2IPv4PoolConfig)
```
...
```typescript
public putTags(value: IResolvable | Ec2IPv4PoolTags[]): void
```
...
ec2IPv4Pool.Ec2IPv4Pool.isConstruct(x: any)
```
...
ec2IPv4Pool.Ec2IPv4Pool.isTerraformElement(x: any)
```
...
ec2IPv4Pool.Ec2IPv4Pool.isTerraformResource(x: any)
```
...
ec2IPv4Pool.Ec2IPv4Pool.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.ec2IPv4Pool.Ec2IPv4Pool.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2IPv4Pool.Ec2IPv4Pool.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2IPv4Pool.Ec2IPv4Pool.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2IPv4Pool.Ec2IPv4Pool.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2IPv4Pool.Ec2IPv4Pool.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2IPv4Pool.Ec2IPv4Pool.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2IPv4Pool.Ec2IPv4Pool.property.totalAddressCount">totalAddressCount</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2IPv4Pool.Ec2IPv4Pool.property.totalAvailableAddressCount">totalAvailableAddressCount</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2IPv4Pool.Ec2IPv4Pool.property.tagsInput">tagsInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.ec2IPv4Pool.Ec2IPv4PoolTags">Ec2IPv4PoolTags</a>[]</code> | *No description.* |
...
```typescript
public readonly tags: Ec2IPv4PoolTagsList;
```
...
```typescript
public readonly tagsInput: IResolvable | Ec2IPv4PoolTags[];
```
...
const ec2IPv4PoolConfig: ec2IPv4Pool.Ec2IPv4PoolConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.ec2IPv4Pool.Ec2IPv4PoolConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2IPv4Pool.Ec2IPv4PoolConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2IPv4Pool.Ec2IPv4PoolConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2IPv4Pool.Ec2IPv4PoolConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2IPv4Pool.Ec2IPv4PoolConfig.property.tags">tags</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.ec2IPv4Pool.Ec2IPv4PoolTags">Ec2IPv4PoolTags</a>[]</code> | Any tags assigned to the public IPv4 pool. |
...
```typescript
public readonly tags: IResolvable | Ec2IPv4PoolTags[];
```
...
const ec2IPv4PoolTags: ec2IPv4Pool.Ec2IPv4PoolTags = { ... }
```
...
new ec2IPv4Pool.Ec2IPv4PoolTagsList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.ec2IPv4Pool.Ec2IPv4PoolTagsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.ec2IPv4Pool.Ec2IPv4PoolTagsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| <code><a href="#@cdktn/provider-awscc.ec2IPv4Pool.Ec2IPv4PoolTagsList.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.ec2IPv4Pool.Ec2IPv4PoolTags">Ec2IPv4PoolTags</a>[]</code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | Ec2IPv4PoolTags[];
```
...
new ec2IPv4Pool.Ec2IPv4PoolTagsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.ec2IPv4Pool.Ec2IPv4PoolTagsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.ec2IPv4Pool.Ec2IPv4PoolTagsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-awscc.ec2IPv4Pool.Ec2IPv4PoolTagsOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| <code><a href="#@cdktn/provider-awscc.ec2IPv4Pool.Ec2IPv4PoolTagsOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-awscc.ec2IPv4Pool.Ec2IPv4PoolTags">Ec2IPv4PoolTags</a></code> | *No description.* |
