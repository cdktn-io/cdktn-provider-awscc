...
```typescript
import { dataAwsccDmsReplicationTasks } from '@cdktn/provider-awscc'

new dataAwsccDmsReplicationTasks.DataAwsccDmsReplicationTasks(scope: Construct, id: string, config?: DataAwsccDmsReplicationTasksConfig)
```
...
dataAwsccDmsReplicationTasks.DataAwsccDmsReplicationTasks.isConstruct(x: any)
```
...
dataAwsccDmsReplicationTasks.DataAwsccDmsReplicationTasks.isTerraformElement(x: any)
```
...
dataAwsccDmsReplicationTasks.DataAwsccDmsReplicationTasks.isTerraformDataSource(x: any)
```
...
dataAwsccDmsReplicationTasks.DataAwsccDmsReplicationTasks.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDmsReplicationTasks.DataAwsccDmsReplicationTasks.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDmsReplicationTasks.DataAwsccDmsReplicationTasks.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDmsReplicationTasks.DataAwsccDmsReplicationTasks.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDmsReplicationTasks.DataAwsccDmsReplicationTasks.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDmsReplicationTasks.DataAwsccDmsReplicationTasks.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccDmsReplicationTasksConfig: dataAwsccDmsReplicationTasks.DataAwsccDmsReplicationTasksConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDmsReplicationTasks.DataAwsccDmsReplicationTasksConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDmsReplicationTasks.DataAwsccDmsReplicationTasksConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccDmsReplicationTasks.DataAwsccDmsReplicationTasksConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccDmsReplicationTasks.DataAwsccDmsReplicationTasksConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
