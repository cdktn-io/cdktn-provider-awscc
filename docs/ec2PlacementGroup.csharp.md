...
new Ec2PlacementGroup(Construct Scope, string Id, Ec2PlacementGroupConfig Config = null);
```
...
```csharp
private void PutTags(IResolvable|Ec2PlacementGroupTags[] Value)
```
...
- *Type:* Io.Cdktn.IResolvable|<a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroupTags">Ec2PlacementGroupTags</a>[]
...
Ec2PlacementGroup.IsConstruct(object X);
```
...
Ec2PlacementGroup.IsTerraformElement(object X);
```
...
Ec2PlacementGroup.IsTerraformResource(object X);
```
...
Ec2PlacementGroup.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroup.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroup.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroup.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroup.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroup.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroup.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroup.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroup.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroup.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroup.property.partitionCountInput">PartitionCountInput</a></code> | <code>double</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroup.property.tagsInput">TagsInput</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroupTags">Ec2PlacementGroupTags</a>[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroup.property.partitionCount">PartitionCount</a></code> | <code>double</code> | *No description.* |
...
```csharp
public Ec2PlacementGroupTagsList Tags { get; }
```
...
```csharp
public IResolvable|Ec2PlacementGroupTags[] TagsInput { get; }
```
...
new Ec2PlacementGroupConfig {
    ...
    IResolvable|Ec2PlacementGroupTags[] Tags = null
};
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroupConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroupConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroupConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroupConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroupConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroupConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroupConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroupConfig.property.partitionCount">PartitionCount</a></code> | <code>double</code> | The number of partitions. Valid only when **Strategy** is set to `partition`. |
...
| <code><a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroupConfig.property.tags">Tags</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroupTags">Ec2PlacementGroupTags</a>[]</code> | An array of key-value pairs to apply to this resource. |
...
```csharp
public IResolvable|Ec2PlacementGroupTags[] Tags { get; set; }
```
...
new Ec2PlacementGroupTagsList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroupTagsList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroupTagsList.resolve.parameter._context"></a>
...
```csharp
private Ec2PlacementGroupTagsOutputReference Get(double Index)
```
...
| <code><a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroupTagsList.property.internalValue">InternalValue</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroupTags">Ec2PlacementGroupTags</a>[]</code> | *No description.* |
...
```csharp
public IResolvable|Ec2PlacementGroupTags[] InternalValue { get; }
```
...
new Ec2PlacementGroupTagsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroupTagsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroupTagsOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroupTagsOutputReference.resolve.parameter._context"></a>
...
| <code><a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroupTagsOutputReference.property.internalValue">InternalValue</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.ec2PlacementGroup.Ec2PlacementGroupTags">Ec2PlacementGroupTags</a></code> | *No description.* |
