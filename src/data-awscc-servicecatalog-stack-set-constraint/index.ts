...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/servicecatalog_stack_set_constraint
...
export class DataAwsccServicecatalogStackSetConstraint extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccServicecatalogStackSetConstraint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/servicecatalog_stack_set_constraint#import import section} in the documentation of this resource for the id to use
