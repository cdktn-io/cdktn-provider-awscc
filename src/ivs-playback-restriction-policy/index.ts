...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ivs_playback_restriction_policy
...
export class IvsPlaybackRestrictionPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IvsPlaybackRestrictionPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ivs_playback_restriction_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ivs_playback_restriction_policy awscc_ivs_playback_restriction_policy} Resource
  *
  * @param scope The scope in which to define this construct
