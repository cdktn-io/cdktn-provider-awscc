...
```typescript
import { dataAwsccInspectorAssessmentTargets } from '@cdktn/provider-awscc'

new dataAwsccInspectorAssessmentTargets.DataAwsccInspectorAssessmentTargets(scope: Construct, id: string, config?: DataAwsccInspectorAssessmentTargetsConfig)
```
...
dataAwsccInspectorAssessmentTargets.DataAwsccInspectorAssessmentTargets.isConstruct(x: any)
```
...
dataAwsccInspectorAssessmentTargets.DataAwsccInspectorAssessmentTargets.isTerraformElement(x: any)
```
...
dataAwsccInspectorAssessmentTargets.DataAwsccInspectorAssessmentTargets.isTerraformDataSource(x: any)
```
...
dataAwsccInspectorAssessmentTargets.DataAwsccInspectorAssessmentTargets.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorAssessmentTargets.DataAwsccInspectorAssessmentTargets.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorAssessmentTargets.DataAwsccInspectorAssessmentTargets.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorAssessmentTargets.DataAwsccInspectorAssessmentTargets.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorAssessmentTargets.DataAwsccInspectorAssessmentTargets.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorAssessmentTargets.DataAwsccInspectorAssessmentTargets.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorAssessmentTargets.DataAwsccInspectorAssessmentTargets.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorAssessmentTargets.DataAwsccInspectorAssessmentTargets.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
...
const dataAwsccInspectorAssessmentTargetsConfig: dataAwsccInspectorAssessmentTargets.DataAwsccInspectorAssessmentTargetsConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorAssessmentTargets.DataAwsccInspectorAssessmentTargetsConfig.property.connection">connection</a></code> | <code>cdktn.SSHProvisionerConnection \| cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorAssessmentTargets.DataAwsccInspectorAssessmentTargetsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorAssessmentTargets.DataAwsccInspectorAssessmentTargetsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorAssessmentTargets.DataAwsccInspectorAssessmentTargetsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorAssessmentTargets.DataAwsccInspectorAssessmentTargetsConfig.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorAssessmentTargets.DataAwsccInspectorAssessmentTargetsConfig.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorAssessmentTargets.DataAwsccInspectorAssessmentTargetsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
