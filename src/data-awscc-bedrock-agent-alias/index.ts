...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/bedrock_agent_alias
...
export class DataAwsccBedrockAgentAlias extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccBedrockAgentAlias that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/bedrock_agent_alias#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/bedrock_agent_alias awscc_bedrock_agent_alias} Data Source
  *
  * @param scope The scope in which to define this construct
