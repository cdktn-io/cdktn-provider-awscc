...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/neptune_db_cluster
...
export class DataAwsccNeptuneDbCluster extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccNeptuneDbCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/neptune_db_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/neptune_db_cluster awscc_neptune_db_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
