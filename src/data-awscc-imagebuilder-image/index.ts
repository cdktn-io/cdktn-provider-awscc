...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/imagebuilder_image
...
export class DataAwsccImagebuilderImage extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccImagebuilderImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/imagebuilder_image#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/imagebuilder_image awscc_imagebuilder_image} Data Source
  *
  * @param scope The scope in which to define this construct
