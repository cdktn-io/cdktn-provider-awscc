...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/cloudwatch_log_alarm
...
export interface CloudwatchLogAlarmConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly warmUpConfiguration?: CloudwatchLogAlarmWarmUpConfiguration;
}
...
export interface CloudwatchLogAlarmWarmUpConfiguration {
  /**
...
export function cloudwatchLogAlarmWarmUpConfigurationToTerraform(struct?: CloudwatchLogAlarmWarmUpConfiguration | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function cloudwatchLogAlarmWarmUpConfigurationToHclTerraform(struct?: CloudwatchLogAlarmWarmUpConfiguration | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class CloudwatchLogAlarmWarmUpConfigurationOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): CloudwatchLogAlarmWarmUpConfiguration | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: CloudwatchLogAlarmWarmUpConfiguration | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class CloudwatchLogAlarm extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudwatchLogAlarm that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/cloudwatch_log_alarm#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _warmUpConfiguration = new CloudwatchLogAlarmWarmUpConfigurationOutputReference(this, "warm_up_configuration");
  public get warmUpConfiguration() {
    return this._warmUpConfiguration;
  }
  public putWarmUpConfiguration(value: CloudwatchLogAlarmWarmUpConfiguration) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      warm_up_configuration: cloudwatchLogAlarmWarmUpConfigurationToTerraform(this._warmUpConfiguration.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      warm_up_configuration: {
        value: cloudwatchLogAlarmWarmUpConfigurationToHclTerraform(this._warmUpConfiguration.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "CloudwatchLogAlarmWarmUpConfiguration",
      },
    };
