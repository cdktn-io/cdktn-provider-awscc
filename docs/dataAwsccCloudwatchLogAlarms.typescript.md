...
```typescript
import { dataAwsccCloudwatchLogAlarms } from '@cdktn/provider-awscc'

new dataAwsccCloudwatchLogAlarms.DataAwsccCloudwatchLogAlarms(scope: Construct, id: string, config?: DataAwsccCloudwatchLogAlarmsConfig)
```
...
dataAwsccCloudwatchLogAlarms.DataAwsccCloudwatchLogAlarms.isConstruct(x: any)
```
...
dataAwsccCloudwatchLogAlarms.DataAwsccCloudwatchLogAlarms.isTerraformElement(x: any)
```
...
dataAwsccCloudwatchLogAlarms.DataAwsccCloudwatchLogAlarms.isTerraformDataSource(x: any)
```
...
dataAwsccCloudwatchLogAlarms.DataAwsccCloudwatchLogAlarms.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchLogAlarms.DataAwsccCloudwatchLogAlarms.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchLogAlarms.DataAwsccCloudwatchLogAlarms.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchLogAlarms.DataAwsccCloudwatchLogAlarms.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchLogAlarms.DataAwsccCloudwatchLogAlarms.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchLogAlarms.DataAwsccCloudwatchLogAlarms.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchLogAlarms.DataAwsccCloudwatchLogAlarms.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchLogAlarms.DataAwsccCloudwatchLogAlarms.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
...
const dataAwsccCloudwatchLogAlarmsConfig: dataAwsccCloudwatchLogAlarms.DataAwsccCloudwatchLogAlarmsConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchLogAlarms.DataAwsccCloudwatchLogAlarmsConfig.property.connection">connection</a></code> | <code>cdktn.SSHProvisionerConnection \| cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchLogAlarms.DataAwsccCloudwatchLogAlarmsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchLogAlarms.DataAwsccCloudwatchLogAlarmsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchLogAlarms.DataAwsccCloudwatchLogAlarmsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchLogAlarms.DataAwsccCloudwatchLogAlarmsConfig.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchLogAlarms.DataAwsccCloudwatchLogAlarmsConfig.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchLogAlarms.DataAwsccCloudwatchLogAlarmsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
