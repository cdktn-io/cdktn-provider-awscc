...
Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/imagebuilder_workflow awscc_imagebuilder_workflow}.
...
```typescript
import { dataAwsccImagebuilderWorkflow } from '@cdktn/provider-awscc'

new dataAwsccImagebuilderWorkflow.DataAwsccImagebuilderWorkflow(scope: Construct, id: string, config: DataAwsccImagebuilderWorkflowConfig)
```
...
dataAwsccImagebuilderWorkflow.DataAwsccImagebuilderWorkflow.isConstruct(x: any)
```
...
dataAwsccImagebuilderWorkflow.DataAwsccImagebuilderWorkflow.isTerraformElement(x: any)
```
...
dataAwsccImagebuilderWorkflow.DataAwsccImagebuilderWorkflow.isTerraformDataSource(x: any)
```
...
dataAwsccImagebuilderWorkflow.DataAwsccImagebuilderWorkflow.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/imagebuilder_workflow#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccImagebuilderWorkflow.DataAwsccImagebuilderWorkflow.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccImagebuilderWorkflow.DataAwsccImagebuilderWorkflow.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccImagebuilderWorkflow.DataAwsccImagebuilderWorkflow.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccImagebuilderWorkflow.DataAwsccImagebuilderWorkflow.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccImagebuilderWorkflow.DataAwsccImagebuilderWorkflow.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
```typescript
public readonly latestVersion: DataAwsccImagebuilderWorkflowLatestVersionOutputReference;
```
...
const dataAwsccImagebuilderWorkflowConfig: dataAwsccImagebuilderWorkflow.DataAwsccImagebuilderWorkflowConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccImagebuilderWorkflow.DataAwsccImagebuilderWorkflowConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccImagebuilderWorkflow.DataAwsccImagebuilderWorkflowConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccImagebuilderWorkflow.DataAwsccImagebuilderWorkflowConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccImagebuilderWorkflow.DataAwsccImagebuilderWorkflowConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/imagebuilder_workflow#id DataAwsccImagebuilderWorkflow#id}
...
const dataAwsccImagebuilderWorkflowLatestVersion: dataAwsccImagebuilderWorkflow.DataAwsccImagebuilderWorkflowLatestVersion = { ... }
```
...
new dataAwsccImagebuilderWorkflow.DataAwsccImagebuilderWorkflowLatestVersionOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccImagebuilderWorkflow.DataAwsccImagebuilderWorkflowLatestVersionOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public readonly internalValue: DataAwsccImagebuilderWorkflowLatestVersion;
```
