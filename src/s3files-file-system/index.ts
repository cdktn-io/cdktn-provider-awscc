...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/s3files_file_system
...
export class S3FilesFileSystem extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3FilesFileSystem that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/s3files_file_system#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/s3files_file_system awscc_s3files_file_system} Resource
  *
  * @param scope The scope in which to define this construct
