...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/cloudwatch_alarms
...
export class DataAwsccCloudwatchAlarms extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCloudwatchAlarms that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/cloudwatch_alarms#import import section} in the documentation of this resource for the id to use
