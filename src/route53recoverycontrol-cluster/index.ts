...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/route53recoverycontrol_cluster
...
export class Route53RecoverycontrolCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53RecoverycontrolCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/route53recoverycontrol_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/route53recoverycontrol_cluster awscc_route53recoverycontrol_cluster} Resource
  *
  * @param scope The scope in which to define this construct
