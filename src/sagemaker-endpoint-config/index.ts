...
export class SagemakerEndpointConfigA extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SagemakerEndpointConfigA that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/sagemaker_endpoint_config#import import section} in the documentation of this resource for the id to use
