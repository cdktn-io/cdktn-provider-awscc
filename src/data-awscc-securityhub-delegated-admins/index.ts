...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/securityhub_delegated_admins
...
export class DataAwsccSecurityhubDelegatedAdmins extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccSecurityhubDelegatedAdmins that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/securityhub_delegated_admins#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/securityhub_delegated_admins awscc_securityhub_delegated_admins} Data Source
  *
  * @param scope The scope in which to define this construct
