...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/s3vectors_vector_bucket_policy
...
export class S3VectorsVectorBucketPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3VectorsVectorBucketPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/s3vectors_vector_bucket_policy#import import section} in the documentation of this resource for the id to use
