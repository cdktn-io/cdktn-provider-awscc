...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/omicsvariantstore"

omicsvariantstore.NewOmicsVariantStore(scope Construct, id *string, config OmicsVariantStoreConfig) OmicsVariantStore
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStore.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
```go
func PutReference(value OmicsVariantStoreReference)
```
...
```go
func PutSseConfig(value OmicsVariantStoreSseConfig)
```
...
omicsvariantstore.OmicsVariantStore_IsConstruct(x interface{}) *bool
```
...
omicsvariantstore.OmicsVariantStore_IsTerraformElement(x interface{}) *bool
```
...
omicsvariantstore.OmicsVariantStore_IsTerraformResource(x interface{}) *bool
```
...
omicsvariantstore.OmicsVariantStore_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStore.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStore.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStore.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStore.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStore.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStore.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStore.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStore.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStore.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStore.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStore.property.storeSizeBytes">StoreSizeBytes</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStore.property.referenceInput">ReferenceInput</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStore.property.sseConfigInput">SseConfigInput</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStore.property.tagsInput">TagsInput</a></code> | <code>*map[string]*string</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStore.property.tags">Tags</a></code> | <code>*map[string]*string</code> | *No description.* |
...
```go
func Reference() OmicsVariantStoreReferenceOutputReference
```
...
```go
func SseConfig() OmicsVariantStoreSseConfigOutputReference
```
...
&omicsvariantstore.OmicsVariantStoreConfig {
	...
	Name: *string,
	Reference: github.com/cdktn-io/cdktn-provider-awscc-go/awscc.omicsVariantStore.OmicsVariantStoreReference,
	Description: *string,
	SseConfig: github.com/cdktn-io/cdktn-provider-awscc-go/awscc.omicsVariantStore.OmicsVariantStoreSseConfig,
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStoreConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStoreConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStoreConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStoreConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStoreConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStoreConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStoreConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStoreConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/omics_variant_store#tags OmicsVariantStore#tags}. |
...
omicsvariantstore.NewOmicsVariantStoreReferenceOutputReference(terraformResource IInterpolatingParent, terraformAttribute *string) OmicsVariantStoreReferenceOutputReference
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStoreReferenceOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStoreReferenceOutputReference.property.internalValue">InternalValue</a></code> | <code>interface{}</code> | *No description.* |
...
omicsvariantstore.NewOmicsVariantStoreSseConfigOutputReference(terraformResource IInterpolatingParent, terraformAttribute *string) OmicsVariantStoreSseConfigOutputReference
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStoreSseConfigOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.omicsVariantStore.OmicsVariantStoreSseConfigOutputReference.property.internalValue">InternalValue</a></code> | <code>interface{}</code> | *No description.* |
