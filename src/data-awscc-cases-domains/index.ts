...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/cases_domains
...
export class DataAwsccCasesDomains extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCasesDomains that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/cases_domains#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/cases_domains awscc_cases_domains} Data Source
  *
  * @param scope The scope in which to define this construct
