...
```typescript
import { dataAwsccApigatewayResource } from '@cdktn/provider-awscc'

new dataAwsccApigatewayResource.DataAwsccApigatewayResource(scope: Construct, id: string, config: DataAwsccApigatewayResourceConfig)
```
...
dataAwsccApigatewayResource.DataAwsccApigatewayResource.isConstruct(x: any)
```
...
dataAwsccApigatewayResource.DataAwsccApigatewayResource.isTerraformElement(x: any)
```
...
dataAwsccApigatewayResource.DataAwsccApigatewayResource.isTerraformDataSource(x: any)
```
...
dataAwsccApigatewayResource.DataAwsccApigatewayResource.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayResource.DataAwsccApigatewayResource.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayResource.DataAwsccApigatewayResource.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayResource.DataAwsccApigatewayResource.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayResource.DataAwsccApigatewayResource.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayResource.DataAwsccApigatewayResource.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccApigatewayResourceConfig: dataAwsccApigatewayResource.DataAwsccApigatewayResourceConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayResource.DataAwsccApigatewayResourceConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayResource.DataAwsccApigatewayResourceConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayResource.DataAwsccApigatewayResourceConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccApigatewayResource.DataAwsccApigatewayResourceConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
