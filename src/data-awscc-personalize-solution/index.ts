...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/personalize_solution
...
export interface DataAwsccPersonalizeSolutionTags {
}

export function dataAwsccPersonalizeSolutionTagsToTerraform(struct?: DataAwsccPersonalizeSolutionTags): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsccPersonalizeSolutionTagsToHclTerraform(struct?: DataAwsccPersonalizeSolutionTags): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsccPersonalizeSolutionTagsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAwsccPersonalizeSolutionTags | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsccPersonalizeSolutionTags | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataAwsccPersonalizeSolutionTagsList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataAwsccPersonalizeSolutionTagsOutputReference {
    return new DataAwsccPersonalizeSolutionTagsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAwsccPersonalizeSolution extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccPersonalizeSolution that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/personalize_solution#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/personalize_solution awscc_personalize_solution} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _tags = new DataAwsccPersonalizeSolutionTagsList(this, "tags", false);
  public get tags() {
    return this._tags;
  }
