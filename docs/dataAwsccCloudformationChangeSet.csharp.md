...
Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/cloudformation_change_set awscc_cloudformation_change_set}.
...
new DataAwsccCloudformationChangeSet(Construct Scope, string Id, DataAwsccCloudformationChangeSetConfig Config);
```
...
DataAwsccCloudformationChangeSet.IsConstruct(object X);
```
...
DataAwsccCloudformationChangeSet.IsTerraformElement(object X);
```
...
DataAwsccCloudformationChangeSet.IsTerraformDataSource(object X);
```
...
DataAwsccCloudformationChangeSet.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/cloudformation_change_set#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationChangeSet.DataAwsccCloudformationChangeSet.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationChangeSet.DataAwsccCloudformationChangeSet.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationChangeSet.DataAwsccCloudformationChangeSet.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationChangeSet.DataAwsccCloudformationChangeSet.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationChangeSet.DataAwsccCloudformationChangeSet.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationChangeSet.DataAwsccCloudformationChangeSet.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationChangeSet.DataAwsccCloudformationChangeSet.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationChangeSet.DataAwsccCloudformationChangeSet.property.importExistingResources">ImportExistingResources</a></code> | <code>Io.Cdktn.IResolvable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationChangeSet.DataAwsccCloudformationChangeSet.property.includeNestedStacks">IncludeNestedStacks</a></code> | <code>Io.Cdktn.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationChangeSet.DataAwsccCloudformationChangeSet.property.usePreviousTemplate">UsePreviousTemplate</a></code> | <code>Io.Cdktn.IResolvable</code> | *No description.* |
...
```csharp
public IResolvable ImportExistingResources { get; }
```
...
```csharp
public IResolvable IncludeNestedStacks { get; }
```
...
```csharp
public DataAwsccCloudformationChangeSetTagsList Tags { get; }
```
...
```csharp
public IResolvable UsePreviousTemplate { get; }
```
...
new DataAwsccCloudformationChangeSetConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationChangeSet.DataAwsccCloudformationChangeSetConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationChangeSet.DataAwsccCloudformationChangeSetConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationChangeSet.DataAwsccCloudformationChangeSetConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationChangeSet.DataAwsccCloudformationChangeSetConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationChangeSet.DataAwsccCloudformationChangeSetConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationChangeSet.DataAwsccCloudformationChangeSetConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationChangeSet.DataAwsccCloudformationChangeSetConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/cloudformation_change_set#id DataAwsccCloudformationChangeSet#id}
...
new DataAwsccCloudformationChangeSetTags {
...
new DataAwsccCloudformationChangeSetTagsList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationChangeSet.DataAwsccCloudformationChangeSetTagsList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.dataAwsccCloudformationChangeSet.DataAwsccCloudformationChangeSetTagsList.resolve.parameter._context"></a>
...
```csharp
private DataAwsccCloudformationChangeSetTagsOutputReference Get(double Index)
```
...
new DataAwsccCloudformationChangeSetTagsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationChangeSet.DataAwsccCloudformationChangeSetTagsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationChangeSet.DataAwsccCloudformationChangeSetTagsOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.dataAwsccCloudformationChangeSet.DataAwsccCloudformationChangeSetTagsOutputReference.resolve.parameter._context"></a>
...
```csharp
public DataAwsccCloudformationChangeSetTags InternalValue { get; }
```
