...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/servicecatalog_launch_notification_constraint
...
export class DataAwsccServicecatalogLaunchNotificationConstraint extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccServicecatalogLaunchNotificationConstraint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/servicecatalog_launch_notification_constraint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/servicecatalog_launch_notification_constraint awscc_servicecatalog_launch_notification_constraint} Data Source
  *
  * @param scope The scope in which to define this construct
