...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/appsync_graph_ql_api
...
export class AppsyncGraphQlApi extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AppsyncGraphQlApi that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/appsync_graph_ql_api#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/appsync_graph_ql_api awscc_appsync_graph_ql_api} Resource
  *
  * @param scope The scope in which to define this construct
