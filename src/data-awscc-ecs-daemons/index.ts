...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ecs_daemons
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ecs_daemons awscc_ecs_daemons}
*/
export class DataAwsccEcsDaemons extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEcsDaemons that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ecs_daemons#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ecs_daemons awscc_ecs_daemons} Data Source
  *
  * @param scope The scope in which to define this construct
