...
export interface DataAwsccOutpostsOutpostConfig extends cdktn.TerraformMetaArguments {
  /**
...
export interface DataAwsccOutpostsOutpostTags {
}

export function dataAwsccOutpostsOutpostTagsToTerraform(struct?: DataAwsccOutpostsOutpostTags): any {
...
export function dataAwsccOutpostsOutpostTagsToHclTerraform(struct?: DataAwsccOutpostsOutpostTags): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsccOutpostsOutpostTagsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAwsccOutpostsOutpostTags | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsccOutpostsOutpostTags | undefined) {
    if (value === undefined) {
...
export class DataAwsccOutpostsOutpostTagsList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataAwsccOutpostsOutpostTagsOutputReference {
    return new DataAwsccOutpostsOutpostTagsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAwsccOutpostsOutpost extends cdktn.TerraformDataSource {
  ...
  * @param options DataAwsccOutpostsOutpostConfig
  */
  public constructor(scope: Construct, id: string, config: DataAwsccOutpostsOutpostConfig) {
    super(scope, id, {
  ...
  private _tags = new DataAwsccOutpostsOutpostTagsList(this, "tags", false);
  public get tags() {
    return this._tags;
  }
