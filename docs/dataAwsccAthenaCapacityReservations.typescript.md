...
```typescript
import { dataAwsccAthenaCapacityReservations } from '@cdktn/provider-awscc'

new dataAwsccAthenaCapacityReservations.DataAwsccAthenaCapacityReservations(scope: Construct, id: string, config?: DataAwsccAthenaCapacityReservationsConfig)
```
...
dataAwsccAthenaCapacityReservations.DataAwsccAthenaCapacityReservations.isConstruct(x: any)
```
...
dataAwsccAthenaCapacityReservations.DataAwsccAthenaCapacityReservations.isTerraformElement(x: any)
```
...
dataAwsccAthenaCapacityReservations.DataAwsccAthenaCapacityReservations.isTerraformDataSource(x: any)
```
...
dataAwsccAthenaCapacityReservations.DataAwsccAthenaCapacityReservations.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAthenaCapacityReservations.DataAwsccAthenaCapacityReservations.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAthenaCapacityReservations.DataAwsccAthenaCapacityReservations.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAthenaCapacityReservations.DataAwsccAthenaCapacityReservations.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAthenaCapacityReservations.DataAwsccAthenaCapacityReservations.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAthenaCapacityReservations.DataAwsccAthenaCapacityReservations.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccAthenaCapacityReservationsConfig: dataAwsccAthenaCapacityReservations.DataAwsccAthenaCapacityReservationsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAthenaCapacityReservations.DataAwsccAthenaCapacityReservationsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAthenaCapacityReservations.DataAwsccAthenaCapacityReservationsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccAthenaCapacityReservations.DataAwsccAthenaCapacityReservationsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccAthenaCapacityReservations.DataAwsccAthenaCapacityReservationsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
