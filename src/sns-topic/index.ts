...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/sns_topic
...
export class SnsTopic extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SnsTopic that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/sns_topic#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/sns_topic awscc_sns_topic} Resource
  *
  * @param scope The scope in which to define this construct
