...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/route53_delegation_set
...
export interface DataAwsccRoute53DelegationSetConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataAwsccRoute53DelegationSet extends cdktn.TerraformDataSource {
  ...
  * @param importToId The construct id used in the generated config for the DataAwsccRoute53DelegationSet to import
  * @param importFromId The id of the existing DataAwsccRoute53DelegationSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/route53_delegation_set#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAwsccRoute53DelegationSet to import is found
  */
  ...
  * @param options DataAwsccRoute53DelegationSetConfig
  */
  public constructor(scope: Construct, id: string, config: DataAwsccRoute53DelegationSetConfig) {
    super(scope, id, {
