...
```typescript
import { dataAwsccForecastDatasets } from '@cdktn/provider-awscc'

new dataAwsccForecastDatasets.DataAwsccForecastDatasets(scope: Construct, id: string, config?: DataAwsccForecastDatasetsConfig)
```
...
dataAwsccForecastDatasets.DataAwsccForecastDatasets.isConstruct(x: any)
```
...
dataAwsccForecastDatasets.DataAwsccForecastDatasets.isTerraformElement(x: any)
```
...
dataAwsccForecastDatasets.DataAwsccForecastDatasets.isTerraformDataSource(x: any)
```
...
dataAwsccForecastDatasets.DataAwsccForecastDatasets.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccForecastDatasets.DataAwsccForecastDatasets.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccForecastDatasets.DataAwsccForecastDatasets.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccForecastDatasets.DataAwsccForecastDatasets.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccForecastDatasets.DataAwsccForecastDatasets.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccForecastDatasets.DataAwsccForecastDatasets.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccForecastDatasetsConfig: dataAwsccForecastDatasets.DataAwsccForecastDatasetsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccForecastDatasets.DataAwsccForecastDatasetsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccForecastDatasets.DataAwsccForecastDatasetsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccForecastDatasets.DataAwsccForecastDatasetsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccForecastDatasets.DataAwsccForecastDatasetsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
