...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/rds_global_cluster
...
export class RdsGlobalCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RdsGlobalCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/rds_global_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/rds_global_cluster awscc_rds_global_cluster} Resource
  *
  * @param scope The scope in which to define this construct
