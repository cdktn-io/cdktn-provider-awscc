...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_route_server_propagation
...
export class Ec2RouteServerPropagation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2RouteServerPropagation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_route_server_propagation#import import section} in the documentation of this resource for the id to use
