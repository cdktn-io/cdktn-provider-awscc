...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/ecr_repository_creation_templates
...
export class DataAwsccEcrRepositoryCreationTemplates extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEcrRepositoryCreationTemplates that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/ecr_repository_creation_templates#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/ecr_repository_creation_templates awscc_ecr_repository_creation_templates} Data Source
  *
  * @param scope The scope in which to define this construct
