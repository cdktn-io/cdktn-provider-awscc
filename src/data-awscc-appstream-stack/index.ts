...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/appstream_stack
...
export class DataAwsccAppstreamStack extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccAppstreamStack that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/appstream_stack#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/appstream_stack awscc_appstream_stack} Data Source
  *
  * @param scope The scope in which to define this construct
