...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawscccontroltowerenabledcontrol"

dataawscccontroltowerenabledcontrol.NewDataAwsccControltowerEnabledControl(scope Construct, id *string, config DataAwsccControltowerEnabledControlConfig) DataAwsccControltowerEnabledControl
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccControltowerEnabledControl.DataAwsccControltowerEnabledControl.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
dataawscccontroltowerenabledcontrol.DataAwsccControltowerEnabledControl_IsConstruct(x interface{}) *bool
```
...
dataawscccontroltowerenabledcontrol.DataAwsccControltowerEnabledControl_IsTerraformElement(x interface{}) *bool
```
...
dataawscccontroltowerenabledcontrol.DataAwsccControltowerEnabledControl_IsTerraformDataSource(x interface{}) *bool
```
...
dataawscccontroltowerenabledcontrol.DataAwsccControltowerEnabledControl_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccControltowerEnabledControl.DataAwsccControltowerEnabledControl.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccControltowerEnabledControl.DataAwsccControltowerEnabledControl.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccControltowerEnabledControl.DataAwsccControltowerEnabledControl.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccControltowerEnabledControl.DataAwsccControltowerEnabledControl.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccControltowerEnabledControl.DataAwsccControltowerEnabledControl.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccControltowerEnabledControl.DataAwsccControltowerEnabledControl.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccControltowerEnabledControl.DataAwsccControltowerEnabledControl.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccControltowerEnabledControl.DataAwsccControltowerEnabledControl.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
...
&dataawscccontroltowerenabledcontrol.DataAwsccControltowerEnabledControlConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccControltowerEnabledControl.DataAwsccControltowerEnabledControlConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccControltowerEnabledControl.DataAwsccControltowerEnabledControlConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccControltowerEnabledControl.DataAwsccControltowerEnabledControlConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccControltowerEnabledControl.DataAwsccControltowerEnabledControlConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccControltowerEnabledControl.DataAwsccControltowerEnabledControlConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccControltowerEnabledControl.DataAwsccControltowerEnabledControlConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccControltowerEnabledControl.DataAwsccControltowerEnabledControlConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
