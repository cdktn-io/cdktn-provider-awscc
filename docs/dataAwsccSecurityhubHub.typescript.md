...
```typescript
import { dataAwsccSecurityhubHub } from '@cdktn/provider-awscc'

new dataAwsccSecurityhubHub.DataAwsccSecurityhubHub(scope: Construct, id: string, config: DataAwsccSecurityhubHubConfig)
```
...
dataAwsccSecurityhubHub.DataAwsccSecurityhubHub.isConstruct(x: any)
```
...
dataAwsccSecurityhubHub.DataAwsccSecurityhubHub.isTerraformElement(x: any)
```
...
dataAwsccSecurityhubHub.DataAwsccSecurityhubHub.isTerraformDataSource(x: any)
```
...
dataAwsccSecurityhubHub.DataAwsccSecurityhubHub.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubHub.DataAwsccSecurityhubHub.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubHub.DataAwsccSecurityhubHub.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubHub.DataAwsccSecurityhubHub.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubHub.DataAwsccSecurityhubHub.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubHub.DataAwsccSecurityhubHub.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubHub.DataAwsccSecurityhubHub.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubHub.DataAwsccSecurityhubHub.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubHub.DataAwsccSecurityhubHub.property.autoEnableControls">autoEnableControls</a></code> | <code>cdktn.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubHub.DataAwsccSecurityhubHub.property.enableDefaultStandards">enableDefaultStandards</a></code> | <code>cdktn.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubHub.DataAwsccSecurityhubHub.property.tags">tags</a></code> | <code>cdktn.StringMap</code> | *No description.* |
...
```typescript
public readonly autoEnableControls: IResolvable;
```
...
```typescript
public readonly enableDefaultStandards: IResolvable;
```
...
const dataAwsccSecurityhubHubConfig: dataAwsccSecurityhubHub.DataAwsccSecurityhubHubConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubHub.DataAwsccSecurityhubHubConfig.property.connection">connection</a></code> | <code>cdktn.SSHProvisionerConnection \| cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubHub.DataAwsccSecurityhubHubConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubHub.DataAwsccSecurityhubHubConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubHub.DataAwsccSecurityhubHubConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubHub.DataAwsccSecurityhubHubConfig.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubHub.DataAwsccSecurityhubHubConfig.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSecurityhubHub.DataAwsccSecurityhubHubConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
