...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/omics_sequence_store
...
export class OmicsSequenceStore extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OmicsSequenceStore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/omics_sequence_store#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/omics_sequence_store awscc_omics_sequence_store} Resource
  *
  * @param scope The scope in which to define this construct
