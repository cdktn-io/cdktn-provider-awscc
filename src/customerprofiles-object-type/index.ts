...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/customerprofiles_object_type
...
export class CustomerprofilesObjectType extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomerprofilesObjectType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/customerprofiles_object_type#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/customerprofiles_object_type awscc_customerprofiles_object_type} Resource
  *
  * @param scope The scope in which to define this construct
