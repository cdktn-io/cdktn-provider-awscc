...
```typescript
import { dataAwsccNeptuneDbSubnetGroups } from '@cdktn/provider-awscc'

new dataAwsccNeptuneDbSubnetGroups.DataAwsccNeptuneDbSubnetGroups(scope: Construct, id: string, config?: DataAwsccNeptuneDbSubnetGroupsConfig)
```
...
dataAwsccNeptuneDbSubnetGroups.DataAwsccNeptuneDbSubnetGroups.isConstruct(x: any)
```
...
dataAwsccNeptuneDbSubnetGroups.DataAwsccNeptuneDbSubnetGroups.isTerraformElement(x: any)
```
...
dataAwsccNeptuneDbSubnetGroups.DataAwsccNeptuneDbSubnetGroups.isTerraformDataSource(x: any)
```
...
dataAwsccNeptuneDbSubnetGroups.DataAwsccNeptuneDbSubnetGroups.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNeptuneDbSubnetGroups.DataAwsccNeptuneDbSubnetGroups.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNeptuneDbSubnetGroups.DataAwsccNeptuneDbSubnetGroups.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNeptuneDbSubnetGroups.DataAwsccNeptuneDbSubnetGroups.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNeptuneDbSubnetGroups.DataAwsccNeptuneDbSubnetGroups.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNeptuneDbSubnetGroups.DataAwsccNeptuneDbSubnetGroups.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccNeptuneDbSubnetGroupsConfig: dataAwsccNeptuneDbSubnetGroups.DataAwsccNeptuneDbSubnetGroupsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNeptuneDbSubnetGroups.DataAwsccNeptuneDbSubnetGroupsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNeptuneDbSubnetGroups.DataAwsccNeptuneDbSubnetGroupsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccNeptuneDbSubnetGroups.DataAwsccNeptuneDbSubnetGroupsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccNeptuneDbSubnetGroups.DataAwsccNeptuneDbSubnetGroupsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
