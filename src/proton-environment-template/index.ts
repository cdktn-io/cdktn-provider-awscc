...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/proton_environment_template
...
export class ProtonEnvironmentTemplate extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ProtonEnvironmentTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/proton_environment_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/proton_environment_template awscc_proton_environment_template} Resource
  *
  * @param scope The scope in which to define this construct
