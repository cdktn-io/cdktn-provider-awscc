...
```typescript
import { dataAwsccInspectorv2CodeSecurityIntegrations } from '@cdktn/provider-awscc'

new dataAwsccInspectorv2CodeSecurityIntegrations.DataAwsccInspectorv2CodeSecurityIntegrations(scope: Construct, id: string, config?: DataAwsccInspectorv2CodeSecurityIntegrationsConfig)
```
...
dataAwsccInspectorv2CodeSecurityIntegrations.DataAwsccInspectorv2CodeSecurityIntegrations.isConstruct(x: any)
```
...
dataAwsccInspectorv2CodeSecurityIntegrations.DataAwsccInspectorv2CodeSecurityIntegrations.isTerraformElement(x: any)
```
...
dataAwsccInspectorv2CodeSecurityIntegrations.DataAwsccInspectorv2CodeSecurityIntegrations.isTerraformDataSource(x: any)
```
...
dataAwsccInspectorv2CodeSecurityIntegrations.DataAwsccInspectorv2CodeSecurityIntegrations.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorv2CodeSecurityIntegrations.DataAwsccInspectorv2CodeSecurityIntegrations.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorv2CodeSecurityIntegrations.DataAwsccInspectorv2CodeSecurityIntegrations.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorv2CodeSecurityIntegrations.DataAwsccInspectorv2CodeSecurityIntegrations.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorv2CodeSecurityIntegrations.DataAwsccInspectorv2CodeSecurityIntegrations.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorv2CodeSecurityIntegrations.DataAwsccInspectorv2CodeSecurityIntegrations.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccInspectorv2CodeSecurityIntegrationsConfig: dataAwsccInspectorv2CodeSecurityIntegrations.DataAwsccInspectorv2CodeSecurityIntegrationsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorv2CodeSecurityIntegrations.DataAwsccInspectorv2CodeSecurityIntegrationsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorv2CodeSecurityIntegrations.DataAwsccInspectorv2CodeSecurityIntegrationsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorv2CodeSecurityIntegrations.DataAwsccInspectorv2CodeSecurityIntegrationsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccInspectorv2CodeSecurityIntegrations.DataAwsccInspectorv2CodeSecurityIntegrationsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
