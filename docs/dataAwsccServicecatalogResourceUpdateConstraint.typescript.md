...
```typescript
import { dataAwsccServicecatalogResourceUpdateConstraint } from '@cdktn/provider-awscc'

new dataAwsccServicecatalogResourceUpdateConstraint.DataAwsccServicecatalogResourceUpdateConstraint(scope: Construct, id: string, config: DataAwsccServicecatalogResourceUpdateConstraintConfig)
```
...
dataAwsccServicecatalogResourceUpdateConstraint.DataAwsccServicecatalogResourceUpdateConstraint.isConstruct(x: any)
```
...
dataAwsccServicecatalogResourceUpdateConstraint.DataAwsccServicecatalogResourceUpdateConstraint.isTerraformElement(x: any)
```
...
dataAwsccServicecatalogResourceUpdateConstraint.DataAwsccServicecatalogResourceUpdateConstraint.isTerraformDataSource(x: any)
```
...
dataAwsccServicecatalogResourceUpdateConstraint.DataAwsccServicecatalogResourceUpdateConstraint.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccServicecatalogResourceUpdateConstraint.DataAwsccServicecatalogResourceUpdateConstraint.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccServicecatalogResourceUpdateConstraint.DataAwsccServicecatalogResourceUpdateConstraint.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccServicecatalogResourceUpdateConstraint.DataAwsccServicecatalogResourceUpdateConstraint.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccServicecatalogResourceUpdateConstraint.DataAwsccServicecatalogResourceUpdateConstraint.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccServicecatalogResourceUpdateConstraint.DataAwsccServicecatalogResourceUpdateConstraint.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccServicecatalogResourceUpdateConstraintConfig: dataAwsccServicecatalogResourceUpdateConstraint.DataAwsccServicecatalogResourceUpdateConstraintConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccServicecatalogResourceUpdateConstraint.DataAwsccServicecatalogResourceUpdateConstraintConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccServicecatalogResourceUpdateConstraint.DataAwsccServicecatalogResourceUpdateConstraintConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccServicecatalogResourceUpdateConstraint.DataAwsccServicecatalogResourceUpdateConstraintConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccServicecatalogResourceUpdateConstraint.DataAwsccServicecatalogResourceUpdateConstraintConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
