...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/bedrockagentcore_code_interpreter_customs
...
export class DataAwsccBedrockagentcoreCodeInterpreterCustoms extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccBedrockagentcoreCodeInterpreterCustoms that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/bedrockagentcore_code_interpreter_customs#import import section} in the documentation of this resource for the id to use
