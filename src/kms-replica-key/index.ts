...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/kms_replica_key
...
export class KmsReplicaKey extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing KmsReplicaKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/kms_replica_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/kms_replica_key awscc_kms_replica_key} Resource
  *
  * @param scope The scope in which to define this construct
