...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iotwireless_multicast_group
...
export class IotwirelessMulticastGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotwirelessMulticastGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iotwireless_multicast_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/iotwireless_multicast_group awscc_iotwireless_multicast_group} Resource
  *
  * @param scope The scope in which to define this construct
