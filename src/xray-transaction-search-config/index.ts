...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/xray_transaction_search_config
...
export class XrayTransactionSearchConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing XrayTransactionSearchConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/xray_transaction_search_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/xray_transaction_search_config awscc_xray_transaction_search_config} Resource
  *
  * @param scope The scope in which to define this construct
