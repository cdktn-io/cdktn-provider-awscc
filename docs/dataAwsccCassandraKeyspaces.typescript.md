...
```typescript
import { dataAwsccCassandraKeyspaces } from '@cdktn/provider-awscc'

new dataAwsccCassandraKeyspaces.DataAwsccCassandraKeyspaces(scope: Construct, id: string, config?: DataAwsccCassandraKeyspacesConfig)
```
...
dataAwsccCassandraKeyspaces.DataAwsccCassandraKeyspaces.isConstruct(x: any)
```
...
dataAwsccCassandraKeyspaces.DataAwsccCassandraKeyspaces.isTerraformElement(x: any)
```
...
dataAwsccCassandraKeyspaces.DataAwsccCassandraKeyspaces.isTerraformDataSource(x: any)
```
...
dataAwsccCassandraKeyspaces.DataAwsccCassandraKeyspaces.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCassandraKeyspaces.DataAwsccCassandraKeyspaces.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCassandraKeyspaces.DataAwsccCassandraKeyspaces.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCassandraKeyspaces.DataAwsccCassandraKeyspaces.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCassandraKeyspaces.DataAwsccCassandraKeyspaces.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCassandraKeyspaces.DataAwsccCassandraKeyspaces.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccCassandraKeyspacesConfig: dataAwsccCassandraKeyspaces.DataAwsccCassandraKeyspacesConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCassandraKeyspaces.DataAwsccCassandraKeyspacesConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCassandraKeyspaces.DataAwsccCassandraKeyspacesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCassandraKeyspaces.DataAwsccCassandraKeyspacesConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCassandraKeyspaces.DataAwsccCassandraKeyspacesConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
