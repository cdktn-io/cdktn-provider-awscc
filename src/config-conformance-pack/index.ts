...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/config_conformance_pack
...
export class ConfigConformancePack extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConfigConformancePack that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/config_conformance_pack#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/config_conformance_pack awscc_config_conformance_pack} Resource
  *
  * @param scope The scope in which to define this construct
