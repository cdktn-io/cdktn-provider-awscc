...
export class Ec2RouteServerEndpoint extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2RouteServerEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_route_server_endpoint#import import section} in the documentation of this resource for the id to use
