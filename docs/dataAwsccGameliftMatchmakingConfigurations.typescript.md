...
```typescript
import { dataAwsccGameliftMatchmakingConfigurations } from '@cdktn/provider-awscc'

new dataAwsccGameliftMatchmakingConfigurations.DataAwsccGameliftMatchmakingConfigurations(scope: Construct, id: string, config?: DataAwsccGameliftMatchmakingConfigurationsConfig)
```
...
dataAwsccGameliftMatchmakingConfigurations.DataAwsccGameliftMatchmakingConfigurations.isConstruct(x: any)
```
...
dataAwsccGameliftMatchmakingConfigurations.DataAwsccGameliftMatchmakingConfigurations.isTerraformElement(x: any)
```
...
dataAwsccGameliftMatchmakingConfigurations.DataAwsccGameliftMatchmakingConfigurations.isTerraformDataSource(x: any)
```
...
dataAwsccGameliftMatchmakingConfigurations.DataAwsccGameliftMatchmakingConfigurations.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingConfigurations.DataAwsccGameliftMatchmakingConfigurations.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingConfigurations.DataAwsccGameliftMatchmakingConfigurations.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingConfigurations.DataAwsccGameliftMatchmakingConfigurations.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingConfigurations.DataAwsccGameliftMatchmakingConfigurations.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingConfigurations.DataAwsccGameliftMatchmakingConfigurations.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingConfigurations.DataAwsccGameliftMatchmakingConfigurations.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingConfigurations.DataAwsccGameliftMatchmakingConfigurations.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
...
const dataAwsccGameliftMatchmakingConfigurationsConfig: dataAwsccGameliftMatchmakingConfigurations.DataAwsccGameliftMatchmakingConfigurationsConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingConfigurations.DataAwsccGameliftMatchmakingConfigurationsConfig.property.connection">connection</a></code> | <code>cdktn.SSHProvisionerConnection \| cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingConfigurations.DataAwsccGameliftMatchmakingConfigurationsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingConfigurations.DataAwsccGameliftMatchmakingConfigurationsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingConfigurations.DataAwsccGameliftMatchmakingConfigurationsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingConfigurations.DataAwsccGameliftMatchmakingConfigurationsConfig.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingConfigurations.DataAwsccGameliftMatchmakingConfigurationsConfig.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccGameliftMatchmakingConfigurations.DataAwsccGameliftMatchmakingConfigurationsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
