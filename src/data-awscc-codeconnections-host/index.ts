...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/codeconnections_host
...
export class DataAwsccCodeconnectionsHost extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCodeconnectionsHost that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/codeconnections_host#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/codeconnections_host awscc_codeconnections_host} Data Source
  *
  * @param scope The scope in which to define this construct
