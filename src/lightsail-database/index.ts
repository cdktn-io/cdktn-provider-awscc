...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/lightsail_database
...
export class LightsailDatabase extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LightsailDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/lightsail_database#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/lightsail_database awscc_lightsail_database} Resource
  *
  * @param scope The scope in which to define this construct
