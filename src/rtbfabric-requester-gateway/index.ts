...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/rtbfabric_requester_gateway
...
export class RtbfabricRequesterGateway extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RtbfabricRequesterGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/rtbfabric_requester_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/rtbfabric_requester_gateway awscc_rtbfabric_requester_gateway} Resource
  *
  * @param scope The scope in which to define this construct
