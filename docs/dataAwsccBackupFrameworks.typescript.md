...
```typescript
import { dataAwsccBackupFrameworks } from '@cdktn/provider-awscc'

new dataAwsccBackupFrameworks.DataAwsccBackupFrameworks(scope: Construct, id: string, config?: DataAwsccBackupFrameworksConfig)
```
...
dataAwsccBackupFrameworks.DataAwsccBackupFrameworks.isConstruct(x: any)
```
...
dataAwsccBackupFrameworks.DataAwsccBackupFrameworks.isTerraformElement(x: any)
```
...
dataAwsccBackupFrameworks.DataAwsccBackupFrameworks.isTerraformDataSource(x: any)
```
...
dataAwsccBackupFrameworks.DataAwsccBackupFrameworks.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBackupFrameworks.DataAwsccBackupFrameworks.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBackupFrameworks.DataAwsccBackupFrameworks.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBackupFrameworks.DataAwsccBackupFrameworks.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBackupFrameworks.DataAwsccBackupFrameworks.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBackupFrameworks.DataAwsccBackupFrameworks.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccBackupFrameworksConfig: dataAwsccBackupFrameworks.DataAwsccBackupFrameworksConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBackupFrameworks.DataAwsccBackupFrameworksConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBackupFrameworks.DataAwsccBackupFrameworksConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBackupFrameworks.DataAwsccBackupFrameworksConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBackupFrameworks.DataAwsccBackupFrameworksConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
