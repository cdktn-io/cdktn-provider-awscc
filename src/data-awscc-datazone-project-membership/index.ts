...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/datazone_project_membership
...
export class DataAwsccDatazoneProjectMembership extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDatazoneProjectMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/datazone_project_membership#import import section} in the documentation of this resource for the id to use
