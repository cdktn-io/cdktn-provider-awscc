...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/apigateway_domain_name
...
export class DataAwsccApigatewayDomainName extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccApigatewayDomainName that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/apigateway_domain_name#import import section} in the documentation of this resource for the id to use
