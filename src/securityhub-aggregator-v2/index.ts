...
export class SecurityhubAggregatorV2 extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityhubAggregatorV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/securityhub_aggregator_v2#import import section} in the documentation of this resource for the id to use
