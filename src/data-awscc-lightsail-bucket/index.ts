...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/lightsail_bucket
...
export class DataAwsccLightsailBucket extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccLightsailBucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/lightsail_bucket#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/lightsail_bucket awscc_lightsail_bucket} Data Source
  *
  * @param scope The scope in which to define this construct
