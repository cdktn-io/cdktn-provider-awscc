...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/workspacesinstances_volumes
...
export class DataAwsccWorkspacesinstancesVolumes extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccWorkspacesinstancesVolumes that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/workspacesinstances_volumes#import import section} in the documentation of this resource for the id to use
