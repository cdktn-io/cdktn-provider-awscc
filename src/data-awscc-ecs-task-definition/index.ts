...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/ecs_task_definition
...
export class DataAwsccEcsTaskDefinition extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEcsTaskDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/ecs_task_definition#import import section} in the documentation of this resource for the id to use
