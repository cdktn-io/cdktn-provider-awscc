...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/s3vectors_index
...
export class DataAwsccS3VectorsIndex extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccS3VectorsIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/s3vectors_index#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/s3vectors_index awscc_s3vectors_index} Data Source
  *
  * @param scope The scope in which to define this construct
