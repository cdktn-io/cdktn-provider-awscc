...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/ec2_transit_gateway_peering_attachment
...
export class DataAwsccEc2TransitGatewayPeeringAttachment extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEc2TransitGatewayPeeringAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/ec2_transit_gateway_peering_attachment#import import section} in the documentation of this resource for the id to use
