...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticache_serverless_cache_snapshot
...
export class ElasticacheServerlessCacheSnapshot extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ElasticacheServerlessCacheSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticache_serverless_cache_snapshot#import import section} in the documentation of this resource for the id to use
