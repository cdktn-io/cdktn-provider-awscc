...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_vdm_attributes
...
export class SesVdmAttributes extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SesVdmAttributes that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_vdm_attributes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_vdm_attributes awscc_ses_vdm_attributes} Resource
  *
  * @param scope The scope in which to define this construct
