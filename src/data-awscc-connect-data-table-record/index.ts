...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/connect_data_table_record
...
export class DataAwsccConnectDataTableRecord extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccConnectDataTableRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/connect_data_table_record#import import section} in the documentation of this resource for the id to use
