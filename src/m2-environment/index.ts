...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/m2_environment
...
export class M2Environment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing M2Environment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/m2_environment#import import section} in the documentation of this resource for the id to use
