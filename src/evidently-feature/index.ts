...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/evidently_feature
...
export class EvidentlyFeature extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EvidentlyFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/evidently_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/evidently_feature awscc_evidently_feature} Resource
  *
  * @param scope The scope in which to define this construct
