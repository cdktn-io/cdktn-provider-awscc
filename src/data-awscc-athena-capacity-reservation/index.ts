...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/athena_capacity_reservation
...
export class DataAwsccAthenaCapacityReservation extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccAthenaCapacityReservation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/athena_capacity_reservation#import import section} in the documentation of this resource for the id to use
