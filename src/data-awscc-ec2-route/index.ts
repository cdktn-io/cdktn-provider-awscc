...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/ec2_route
...
export class DataAwsccEc2Route extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEc2Route that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/ec2_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/ec2_route awscc_ec2_route} Data Source
  *
  * @param scope The scope in which to define this construct
