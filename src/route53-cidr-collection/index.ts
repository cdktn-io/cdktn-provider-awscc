...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/route53_cidr_collection
...
export class Route53CidrCollection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53CidrCollection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/route53_cidr_collection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/route53_cidr_collection awscc_route53_cidr_collection} Resource
  *
  * @param scope The scope in which to define this construct
