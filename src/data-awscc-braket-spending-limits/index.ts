...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/braket_spending_limits
...
export class DataAwsccBraketSpendingLimits extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccBraketSpendingLimits that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/braket_spending_limits#import import section} in the documentation of this resource for the id to use
