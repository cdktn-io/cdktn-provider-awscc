...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/pcaconnectorscep_connector
...
export class PcaconnectorscepConnector extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PcaconnectorscepConnector that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/pcaconnectorscep_connector#import import section} in the documentation of this resource for the id to use
