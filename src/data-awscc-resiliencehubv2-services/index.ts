...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/resiliencehubv2_services
...
export class DataAwsccResiliencehubv2Services extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccResiliencehubv2Services that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/resiliencehubv2_services#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/resiliencehubv2_services awscc_resiliencehubv2_services} Data Source
  *
  * @param scope The scope in which to define this construct
