...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/deadline_storage_profile
...
export class DeadlineStorageProfile extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DeadlineStorageProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/deadline_storage_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/deadline_storage_profile awscc_deadline_storage_profile} Resource
  *
  * @param scope The scope in which to define this construct
