...
```typescript
import { dataAwsccObservabilityadminOrganizationTelemetryRules } from '@cdktn/provider-awscc'

new dataAwsccObservabilityadminOrganizationTelemetryRules.DataAwsccObservabilityadminOrganizationTelemetryRules(scope: Construct, id: string, config?: DataAwsccObservabilityadminOrganizationTelemetryRulesConfig)
```
...
dataAwsccObservabilityadminOrganizationTelemetryRules.DataAwsccObservabilityadminOrganizationTelemetryRules.isConstruct(x: any)
```
...
dataAwsccObservabilityadminOrganizationTelemetryRules.DataAwsccObservabilityadminOrganizationTelemetryRules.isTerraformElement(x: any)
```
...
dataAwsccObservabilityadminOrganizationTelemetryRules.DataAwsccObservabilityadminOrganizationTelemetryRules.isTerraformDataSource(x: any)
```
...
dataAwsccObservabilityadminOrganizationTelemetryRules.DataAwsccObservabilityadminOrganizationTelemetryRules.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccObservabilityadminOrganizationTelemetryRules.DataAwsccObservabilityadminOrganizationTelemetryRules.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccObservabilityadminOrganizationTelemetryRules.DataAwsccObservabilityadminOrganizationTelemetryRules.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccObservabilityadminOrganizationTelemetryRules.DataAwsccObservabilityadminOrganizationTelemetryRules.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccObservabilityadminOrganizationTelemetryRules.DataAwsccObservabilityadminOrganizationTelemetryRules.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccObservabilityadminOrganizationTelemetryRules.DataAwsccObservabilityadminOrganizationTelemetryRules.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccObservabilityadminOrganizationTelemetryRulesConfig: dataAwsccObservabilityadminOrganizationTelemetryRules.DataAwsccObservabilityadminOrganizationTelemetryRulesConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccObservabilityadminOrganizationTelemetryRules.DataAwsccObservabilityadminOrganizationTelemetryRulesConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccObservabilityadminOrganizationTelemetryRules.DataAwsccObservabilityadminOrganizationTelemetryRulesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccObservabilityadminOrganizationTelemetryRules.DataAwsccObservabilityadminOrganizationTelemetryRulesConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccObservabilityadminOrganizationTelemetryRules.DataAwsccObservabilityadminOrganizationTelemetryRulesConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
