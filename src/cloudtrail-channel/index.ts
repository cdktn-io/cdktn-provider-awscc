...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudtrail_channel
...
export class CloudtrailChannel extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudtrailChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudtrail_channel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudtrail_channel awscc_cloudtrail_channel} Resource
  *
  * @param scope The scope in which to define this construct
