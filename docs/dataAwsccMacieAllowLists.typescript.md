...
```typescript
import { dataAwsccMacieAllowLists } from '@cdktn/provider-awscc'

new dataAwsccMacieAllowLists.DataAwsccMacieAllowLists(scope: Construct, id: string, config?: DataAwsccMacieAllowListsConfig)
```
...
dataAwsccMacieAllowLists.DataAwsccMacieAllowLists.isConstruct(x: any)
```
...
dataAwsccMacieAllowLists.DataAwsccMacieAllowLists.isTerraformElement(x: any)
```
...
dataAwsccMacieAllowLists.DataAwsccMacieAllowLists.isTerraformDataSource(x: any)
```
...
dataAwsccMacieAllowLists.DataAwsccMacieAllowLists.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMacieAllowLists.DataAwsccMacieAllowLists.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMacieAllowLists.DataAwsccMacieAllowLists.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMacieAllowLists.DataAwsccMacieAllowLists.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMacieAllowLists.DataAwsccMacieAllowLists.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMacieAllowLists.DataAwsccMacieAllowLists.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccMacieAllowListsConfig: dataAwsccMacieAllowLists.DataAwsccMacieAllowListsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMacieAllowLists.DataAwsccMacieAllowListsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMacieAllowLists.DataAwsccMacieAllowListsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccMacieAllowLists.DataAwsccMacieAllowListsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccMacieAllowLists.DataAwsccMacieAllowListsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
