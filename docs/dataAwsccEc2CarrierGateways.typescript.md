...
```typescript
import { dataAwsccEc2CarrierGateways } from '@cdktn/provider-awscc'

new dataAwsccEc2CarrierGateways.DataAwsccEc2CarrierGateways(scope: Construct, id: string, config?: DataAwsccEc2CarrierGatewaysConfig)
```
...
dataAwsccEc2CarrierGateways.DataAwsccEc2CarrierGateways.isConstruct(x: any)
```
...
dataAwsccEc2CarrierGateways.DataAwsccEc2CarrierGateways.isTerraformElement(x: any)
```
...
dataAwsccEc2CarrierGateways.DataAwsccEc2CarrierGateways.isTerraformDataSource(x: any)
```
...
dataAwsccEc2CarrierGateways.DataAwsccEc2CarrierGateways.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2CarrierGateways.DataAwsccEc2CarrierGateways.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2CarrierGateways.DataAwsccEc2CarrierGateways.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2CarrierGateways.DataAwsccEc2CarrierGateways.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2CarrierGateways.DataAwsccEc2CarrierGateways.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2CarrierGateways.DataAwsccEc2CarrierGateways.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccEc2CarrierGatewaysConfig: dataAwsccEc2CarrierGateways.DataAwsccEc2CarrierGatewaysConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2CarrierGateways.DataAwsccEc2CarrierGatewaysConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2CarrierGateways.DataAwsccEc2CarrierGatewaysConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2CarrierGateways.DataAwsccEc2CarrierGatewaysConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEc2CarrierGateways.DataAwsccEc2CarrierGatewaysConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
