...
```typescript
import { lakeformationTag } from '@cdktn/provider-awscc'

new lakeformationTag.LakeformationTag(scope: Construct, id: string, config: LakeformationTagConfig)
```
...
lakeformationTag.LakeformationTag.isConstruct(x: any)
```
...
lakeformationTag.LakeformationTag.isTerraformElement(x: any)
```
...
lakeformationTag.LakeformationTag.isTerraformResource(x: any)
```
...
lakeformationTag.LakeformationTag.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.lakeformationTag.LakeformationTag.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.lakeformationTag.LakeformationTag.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.lakeformationTag.LakeformationTag.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.lakeformationTag.LakeformationTag.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.lakeformationTag.LakeformationTag.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.lakeformationTag.LakeformationTag.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const lakeformationTagConfig: lakeformationTag.LakeformationTagConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.lakeformationTag.LakeformationTagConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.lakeformationTag.LakeformationTagConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.lakeformationTag.LakeformationTagConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.lakeformationTag.LakeformationTagConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
