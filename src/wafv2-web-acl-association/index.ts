...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/wafv2_web_acl_association
...
export class Wafv2WebAclAssociation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Wafv2WebAclAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/wafv2_web_acl_association#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/wafv2_web_acl_association awscc_wafv2_web_acl_association} Resource
  *
  * @param scope The scope in which to define this construct
