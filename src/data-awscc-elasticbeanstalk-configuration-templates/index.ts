...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/elasticbeanstalk_configuration_templates
...
export class DataAwsccElasticbeanstalkConfigurationTemplates extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccElasticbeanstalkConfigurationTemplates that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/elasticbeanstalk_configuration_templates#import import section} in the documentation of this resource for the id to use
