...
new RedshiftClusterSubnetGroup(Construct Scope, string Id, RedshiftClusterSubnetGroupConfig Config);
```
...
```csharp
private void PutTags(IResolvable|RedshiftClusterSubnetGroupTags[] Value)
```
...
- *Type:* Io.Cdktn.IResolvable|<a href="#@cdktn/provider-awscc.redshiftClusterSubnetGroup.RedshiftClusterSubnetGroupTags">RedshiftClusterSubnetGroupTags</a>[]
...
RedshiftClusterSubnetGroup.IsConstruct(object X);
```
...
RedshiftClusterSubnetGroup.IsTerraformElement(object X);
```
...
RedshiftClusterSubnetGroup.IsTerraformResource(object X);
```
...
RedshiftClusterSubnetGroup.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktn/provider-awscc.redshiftClusterSubnetGroup.RedshiftClusterSubnetGroup.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.redshiftClusterSubnetGroup.RedshiftClusterSubnetGroup.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.redshiftClusterSubnetGroup.RedshiftClusterSubnetGroup.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.redshiftClusterSubnetGroup.RedshiftClusterSubnetGroup.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.redshiftClusterSubnetGroup.RedshiftClusterSubnetGroup.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.redshiftClusterSubnetGroup.RedshiftClusterSubnetGroup.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.redshiftClusterSubnetGroup.RedshiftClusterSubnetGroup.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.redshiftClusterSubnetGroup.RedshiftClusterSubnetGroup.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.redshiftClusterSubnetGroup.RedshiftClusterSubnetGroup.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.redshiftClusterSubnetGroup.RedshiftClusterSubnetGroup.property.tagsInput">TagsInput</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.redshiftClusterSubnetGroup.RedshiftClusterSubnetGroupTags">RedshiftClusterSubnetGroupTags</a>[]</code> | *No description.* |
...
```csharp
public RedshiftClusterSubnetGroupTagsList Tags { get; }
```
...
```csharp
public IResolvable|RedshiftClusterSubnetGroupTags[] TagsInput { get; }
```
...
new RedshiftClusterSubnetGroupConfig {
    ...
    string Description,
    string[] SubnetIds,
    IResolvable|RedshiftClusterSubnetGroupTags[] Tags = null
};
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.redshiftClusterSubnetGroup.RedshiftClusterSubnetGroupConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.redshiftClusterSubnetGroup.RedshiftClusterSubnetGroupConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.redshiftClusterSubnetGroup.RedshiftClusterSubnetGroupConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.redshiftClusterSubnetGroup.RedshiftClusterSubnetGroupConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.redshiftClusterSubnetGroup.RedshiftClusterSubnetGroupConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.redshiftClusterSubnetGroup.RedshiftClusterSubnetGroupConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.redshiftClusterSubnetGroup.RedshiftClusterSubnetGroupConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
```csharp
public IResolvable|RedshiftClusterSubnetGroupTags[] Tags { get; set; }
```
...
new RedshiftClusterSubnetGroupTags {
    string Key = null,
    string Value = null
};
```
...
new RedshiftClusterSubnetGroupTagsList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.redshiftClusterSubnetGroup.RedshiftClusterSubnetGroupTagsList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.redshiftClusterSubnetGroup.RedshiftClusterSubnetGroupTagsList.resolve.parameter._context"></a>
...
```csharp
private RedshiftClusterSubnetGroupTagsOutputReference Get(double Index)
```
...
```csharp
public IResolvable|RedshiftClusterSubnetGroupTags[] InternalValue { get; }
```
...
new RedshiftClusterSubnetGroupTagsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.redshiftClusterSubnetGroup.RedshiftClusterSubnetGroupTagsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.redshiftClusterSubnetGroup.RedshiftClusterSubnetGroupTagsOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.redshiftClusterSubnetGroup.RedshiftClusterSubnetGroupTagsOutputReference.resolve.parameter._context"></a>
