...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/mediaconnect_router_network_interfaces
...
export class DataAwsccMediaconnectRouterNetworkInterfaces extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccMediaconnectRouterNetworkInterfaces that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/mediaconnect_router_network_interfaces#import import section} in the documentation of this resource for the id to use
