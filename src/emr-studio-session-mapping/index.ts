...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/emr_studio_session_mapping
...
export class EmrStudioSessionMapping extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EmrStudioSessionMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/emr_studio_session_mapping#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/emr_studio_session_mapping awscc_emr_studio_session_mapping} Resource
  *
  * @param scope The scope in which to define this construct
