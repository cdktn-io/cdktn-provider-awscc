...
```typescript
import { dataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations } from '@cdktn/provider-awscc'

new dataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations.DataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations(scope: Construct, id: string, config?: DataAwsccCleanroomsmlConfiguredModelAlgorithmAssociationsConfig)
```
...
dataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations.DataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations.isConstruct(x: any)
```
...
dataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations.DataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations.isTerraformElement(x: any)
```
...
dataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations.DataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations.isTerraformDataSource(x: any)
```
...
dataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations.DataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations.DataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations.DataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations.DataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations.DataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations.DataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccCleanroomsmlConfiguredModelAlgorithmAssociationsConfig: dataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations.DataAwsccCleanroomsmlConfiguredModelAlgorithmAssociationsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations.DataAwsccCleanroomsmlConfiguredModelAlgorithmAssociationsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations.DataAwsccCleanroomsmlConfiguredModelAlgorithmAssociationsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations.DataAwsccCleanroomsmlConfiguredModelAlgorithmAssociationsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations.DataAwsccCleanroomsmlConfiguredModelAlgorithmAssociationsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
