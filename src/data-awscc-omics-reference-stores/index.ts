...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/omics_reference_stores
...
export class DataAwsccOmicsReferenceStores extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccOmicsReferenceStores that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/omics_reference_stores#import import section} in the documentation of this resource for the id to use
