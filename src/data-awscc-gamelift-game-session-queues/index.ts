...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/gamelift_game_session_queues
...
export class DataAwsccGameliftGameSessionQueues extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccGameliftGameSessionQueues that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/gamelift_game_session_queues#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/gamelift_game_session_queues awscc_gamelift_game_session_queues} Data Source
  *
  * @param scope The scope in which to define this construct
