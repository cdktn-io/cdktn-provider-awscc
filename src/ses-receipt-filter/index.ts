...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ses_receipt_filter
...
export interface SesReceiptFilterConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ses_receipt_filter#filter SesReceiptFilter#filter}
  */
...
export interface SesReceiptFilterFilter {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ses_receipt_filter#ip_filter SesReceiptFilter#ip_filter}
  */
  readonly ipFilter: SesReceiptFilterFilterIpFilter;
  /**
  * The name of the IP address filter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ses_receipt_filter#name SesReceiptFilter#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ses_receipt_filter awscc_ses_receipt_filter}
*/
export class SesReceiptFilter extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SesReceiptFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ses_receipt_filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ses_receipt_filter awscc_ses_receipt_filter} Resource
  *
  * @param scope The scope in which to define this construct
