...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/grafana_workspace
...
export class DataAwsccGrafanaWorkspace extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccGrafanaWorkspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/grafana_workspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/grafana_workspace awscc_grafana_workspace} Data Source
  *
  * @param scope The scope in which to define this construct
