...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/scheduler_schedule
...
export class SchedulerSchedule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SchedulerSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/scheduler_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/scheduler_schedule awscc_scheduler_schedule} Resource
  *
  * @param scope The scope in which to define this construct
