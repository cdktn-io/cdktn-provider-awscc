...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/pcs_compute_node_group
...
export interface PcsComputeNodeGroupSlurmConfiguration {
  ...
  */
  readonly gresCustomSettings?: { [key: string]: string }[] | cdktn.IResolvable;
  /**
...
export function pcsComputeNodeGroupSlurmConfigurationToTerraform(struct?: PcsComputeNodeGroupSlurmConfiguration | cdktn.IResolvable): any {
  ...
  return {
    gres_custom_settings: cdktn.listMapper(cdktn.hashMapper(cdktn.stringToTerraform), false)(struct!.gresCustomSettings),
...
export function pcsComputeNodeGroupSlurmConfigurationToHclTerraform(struct?: PcsComputeNodeGroupSlurmConfiguration | cdktn.IResolvable): any {
  ...
  const attrs = {
    gres_custom_settings: {
      value: cdktn.listMapperHcl(cdktn.hashMapperHcl(cdktn.stringToHclTerraform), false)(struct!.gresCustomSettings),
      isBlock: false,
      type: "list",
...
export class PcsComputeNodeGroupSlurmConfigurationOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PcsComputeNodeGroupSlurmConfiguration | cdktn.IResolvable | undefined {
    ...
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._gresCustomSettings !== undefined) {
      hasAnyValues = true;
      internalValueResult.gresCustomSettings = this._gresCustomSettings;
    }
  ...
  public set internalValue(value: PcsComputeNodeGroupSlurmConfiguration | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._gresCustomSettings = undefined;
      ...
      this.isEmptyObject = Object.keys(value).length === 0;
      this.resolvableValue = undefined;
      this._gresCustomSettings = value.gresCustomSettings;
  ...
  // gres_custom_settings - computed: true, optional: true, required: false
  private _gresCustomSettings?: { [key: string]: string }[] | cdktn.IResolvable; 
  public get gresCustomSettings() {
    return this.interpolationForAttribute('gres_custom_settings');
  }
  public set gresCustomSettings(value: { [key: string]: string }[] | cdktn.IResolvable) {
    this._gresCustomSettings = value;
  }
  public resetGresCustomSettings() {
    this._gresCustomSettings = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get gresCustomSettingsInput() {
...
export class PcsComputeNodeGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PcsComputeNodeGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/pcs_compute_node_group#import import section} in the documentation of this resource for the id to use
