...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/iot_thing_group
...
export class IotThingGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotThingGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/iot_thing_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/iot_thing_group awscc_iot_thing_group} Resource
  *
  * @param scope The scope in which to define this construct
