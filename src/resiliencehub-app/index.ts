...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/resiliencehub_app
...
export class ResiliencehubApp extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ResiliencehubApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/resiliencehub_app#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/resiliencehub_app awscc_resiliencehub_app} Resource
  *
  * @param scope The scope in which to define this construct
