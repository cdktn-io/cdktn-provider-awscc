...
new DataAwsccRoute53RecoverycontrolCluster(Construct Scope, string Id, DataAwsccRoute53RecoverycontrolClusterConfig Config);
```
...
DataAwsccRoute53RecoverycontrolCluster.IsConstruct(object X);
```
...
DataAwsccRoute53RecoverycontrolCluster.IsTerraformElement(object X);
```
...
DataAwsccRoute53RecoverycontrolCluster.IsTerraformDataSource(object X);
```
...
DataAwsccRoute53RecoverycontrolCluster.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53RecoverycontrolCluster.DataAwsccRoute53RecoverycontrolCluster.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53RecoverycontrolCluster.DataAwsccRoute53RecoverycontrolCluster.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53RecoverycontrolCluster.DataAwsccRoute53RecoverycontrolCluster.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53RecoverycontrolCluster.DataAwsccRoute53RecoverycontrolCluster.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53RecoverycontrolCluster.DataAwsccRoute53RecoverycontrolCluster.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53RecoverycontrolCluster.DataAwsccRoute53RecoverycontrolCluster.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53RecoverycontrolCluster.DataAwsccRoute53RecoverycontrolCluster.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
...
```csharp
public DataAwsccRoute53RecoverycontrolClusterClusterEndpointsList ClusterEndpoints { get; }
```
...
```csharp
public DataAwsccRoute53RecoverycontrolClusterTagsList Tags { get; }
```
...
new DataAwsccRoute53RecoverycontrolClusterClusterEndpoints {
...
new DataAwsccRoute53RecoverycontrolClusterConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53RecoverycontrolCluster.DataAwsccRoute53RecoverycontrolClusterConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53RecoverycontrolCluster.DataAwsccRoute53RecoverycontrolClusterConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53RecoverycontrolCluster.DataAwsccRoute53RecoverycontrolClusterConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53RecoverycontrolCluster.DataAwsccRoute53RecoverycontrolClusterConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53RecoverycontrolCluster.DataAwsccRoute53RecoverycontrolClusterConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53RecoverycontrolCluster.DataAwsccRoute53RecoverycontrolClusterConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53RecoverycontrolCluster.DataAwsccRoute53RecoverycontrolClusterConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
new DataAwsccRoute53RecoverycontrolClusterTags {
...
new DataAwsccRoute53RecoverycontrolClusterClusterEndpointsList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53RecoverycontrolCluster.DataAwsccRoute53RecoverycontrolClusterClusterEndpointsList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.dataAwsccRoute53RecoverycontrolCluster.DataAwsccRoute53RecoverycontrolClusterClusterEndpointsList.resolve.parameter._context"></a>
...
```csharp
private DataAwsccRoute53RecoverycontrolClusterClusterEndpointsOutputReference Get(double Index)
```
...
new DataAwsccRoute53RecoverycontrolClusterClusterEndpointsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53RecoverycontrolCluster.DataAwsccRoute53RecoverycontrolClusterClusterEndpointsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53RecoverycontrolCluster.DataAwsccRoute53RecoverycontrolClusterClusterEndpointsOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.dataAwsccRoute53RecoverycontrolCluster.DataAwsccRoute53RecoverycontrolClusterClusterEndpointsOutputReference.resolve.parameter._context"></a>
...
```csharp
public DataAwsccRoute53RecoverycontrolClusterClusterEndpoints InternalValue { get; }
```
...
new DataAwsccRoute53RecoverycontrolClusterTagsList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53RecoverycontrolCluster.DataAwsccRoute53RecoverycontrolClusterTagsList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.dataAwsccRoute53RecoverycontrolCluster.DataAwsccRoute53RecoverycontrolClusterTagsList.resolve.parameter._context"></a>
...
```csharp
private DataAwsccRoute53RecoverycontrolClusterTagsOutputReference Get(double Index)
```
...
new DataAwsccRoute53RecoverycontrolClusterTagsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53RecoverycontrolCluster.DataAwsccRoute53RecoverycontrolClusterTagsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53RecoverycontrolCluster.DataAwsccRoute53RecoverycontrolClusterTagsOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.dataAwsccRoute53RecoverycontrolCluster.DataAwsccRoute53RecoverycontrolClusterTagsOutputReference.resolve.parameter._context"></a>
...
```csharp
public DataAwsccRoute53RecoverycontrolClusterTags InternalValue { get; }
```
