...
```typescript
import { dataAwsccSagemakerModelPackageGroups } from '@cdktn/provider-awscc'

new dataAwsccSagemakerModelPackageGroups.DataAwsccSagemakerModelPackageGroups(scope: Construct, id: string, config?: DataAwsccSagemakerModelPackageGroupsConfig)
```
...
dataAwsccSagemakerModelPackageGroups.DataAwsccSagemakerModelPackageGroups.isConstruct(x: any)
```
...
dataAwsccSagemakerModelPackageGroups.DataAwsccSagemakerModelPackageGroups.isTerraformElement(x: any)
```
...
dataAwsccSagemakerModelPackageGroups.DataAwsccSagemakerModelPackageGroups.isTerraformDataSource(x: any)
```
...
dataAwsccSagemakerModelPackageGroups.DataAwsccSagemakerModelPackageGroups.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerModelPackageGroups.DataAwsccSagemakerModelPackageGroups.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerModelPackageGroups.DataAwsccSagemakerModelPackageGroups.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerModelPackageGroups.DataAwsccSagemakerModelPackageGroups.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerModelPackageGroups.DataAwsccSagemakerModelPackageGroups.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerModelPackageGroups.DataAwsccSagemakerModelPackageGroups.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccSagemakerModelPackageGroupsConfig: dataAwsccSagemakerModelPackageGroups.DataAwsccSagemakerModelPackageGroupsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerModelPackageGroups.DataAwsccSagemakerModelPackageGroupsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerModelPackageGroups.DataAwsccSagemakerModelPackageGroupsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerModelPackageGroups.DataAwsccSagemakerModelPackageGroupsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccSagemakerModelPackageGroups.DataAwsccSagemakerModelPackageGroupsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
