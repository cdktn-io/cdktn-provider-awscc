...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/autoscaling_warm_pool
...
export class DataAwsccAutoscalingWarmPool extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccAutoscalingWarmPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/autoscaling_warm_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/autoscaling_warm_pool awscc_autoscaling_warm_pool} Data Source
  *
  * @param scope The scope in which to define this construct
