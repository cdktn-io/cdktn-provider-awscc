...
export class GlueIntegration extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GlueIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/glue_integration#import import section} in the documentation of this resource for the id to use
