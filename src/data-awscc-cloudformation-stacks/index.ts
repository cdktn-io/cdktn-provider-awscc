...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/cloudformation_stacks
...
export class DataAwsccCloudformationStacks extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCloudformationStacks that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/cloudformation_stacks#import import section} in the documentation of this resource for the id to use
