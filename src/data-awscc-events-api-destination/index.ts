...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/events_api_destination
...
export interface DataAwsccEventsApiDestinationConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/events_api_destination#id DataAwsccEventsApiDestination#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/events_api_destination awscc_events_api_destination}
*/
export class DataAwsccEventsApiDestination extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEventsApiDestination that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/events_api_destination#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/events_api_destination awscc_events_api_destination} Data Source
  *
  * @param scope The scope in which to define this construct
