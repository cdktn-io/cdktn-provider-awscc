...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/m2_deployment
...
export interface M2DeploymentConfig extends cdktn.TerraformMetaArguments {
  ...
  * The application ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/m2_deployment#application_id M2Deployment#application_id}
  */
  readonly applicationId: string;
  /**
  * The version number of the application to deploy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/m2_deployment#application_version M2Deployment#application_version}
  */
  readonly applicationVersion: number;
  /**
  * The environment ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/m2_deployment#environment_id M2Deployment#environment_id}
  */
  readonly environmentId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/m2_deployment awscc_m2_deployment}
*/
export class M2Deployment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing M2Deployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/m2_deployment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/m2_deployment awscc_m2_deployment} Resource
  *
  * @param scope The scope in which to define this construct
