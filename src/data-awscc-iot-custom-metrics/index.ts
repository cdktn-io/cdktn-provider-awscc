...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/iot_custom_metrics
...
export class DataAwsccIotCustomMetrics extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIotCustomMetrics that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/iot_custom_metrics#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/iot_custom_metrics awscc_iot_custom_metrics} Data Source
  *
  * @param scope The scope in which to define this construct
