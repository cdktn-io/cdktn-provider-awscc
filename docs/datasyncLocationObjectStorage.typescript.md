...
```typescript
public putFederatedIdentity(value: DatasyncLocationObjectStorageFederatedIdentity): void
```
...
```typescript
public readonly federatedIdentity: DatasyncLocationObjectStorageFederatedIdentityOutputReference;
```
...
```typescript
public readonly federatedIdentityInput: IResolvable | DatasyncLocationObjectStorageFederatedIdentity;
```
...
```typescript
public readonly federatedIdentity: DatasyncLocationObjectStorageFederatedIdentity;
```
...
const datasyncLocationObjectStorageFederatedIdentity: datasyncLocationObjectStorage.DatasyncLocationObjectStorageFederatedIdentity = { ... }
```
...
```typescript
public readonly externalIdentity: DatasyncLocationObjectStorageFederatedIdentityExternalIdentity;
```
...
const datasyncLocationObjectStorageFederatedIdentityExternalIdentity: datasyncLocationObjectStorage.DatasyncLocationObjectStorageFederatedIdentityExternalIdentity = { ... }
```
...
```typescript
public readonly googleOidc: DatasyncLocationObjectStorageFederatedIdentityExternalIdentityGoogleOidc;
```
...
const datasyncLocationObjectStorageFederatedIdentityExternalIdentityGoogleOidc: datasyncLocationObjectStorage.DatasyncLocationObjectStorageFederatedIdentityExternalIdentityGoogleOidc = { ... }
```
...
new datasyncLocationObjectStorage.DatasyncLocationObjectStorageFederatedIdentityExternalIdentityGoogleOidcOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.datasyncLocationObjectStorage.DatasyncLocationObjectStorageFederatedIdentityExternalIdentityGoogleOidcOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public resetIdentityProviderName(): void
```
...
```typescript
public readonly internalValue: IResolvable | DatasyncLocationObjectStorageFederatedIdentityExternalIdentityGoogleOidc;
```
...
new datasyncLocationObjectStorage.DatasyncLocationObjectStorageFederatedIdentityExternalIdentityOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.datasyncLocationObjectStorage.DatasyncLocationObjectStorageFederatedIdentityExternalIdentityOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public putGoogleOidc(value: DatasyncLocationObjectStorageFederatedIdentityExternalIdentityGoogleOidc): void
```
...
```typescript
public readonly googleOidc: DatasyncLocationObjectStorageFederatedIdentityExternalIdentityGoogleOidcOutputReference;
```
...
```typescript
public readonly googleOidcInput: IResolvable | DatasyncLocationObjectStorageFederatedIdentityExternalIdentityGoogleOidc;
```
...
```typescript
public readonly internalValue: IResolvable | DatasyncLocationObjectStorageFederatedIdentityExternalIdentity;
```
...
new datasyncLocationObjectStorage.DatasyncLocationObjectStorageFederatedIdentityOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.datasyncLocationObjectStorage.DatasyncLocationObjectStorageFederatedIdentityOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public putExternalIdentity(value: DatasyncLocationObjectStorageFederatedIdentityExternalIdentity): void
```
...
```typescript
public resetExternalIdentity(): void
```
...
```typescript
public readonly externalIdentity: DatasyncLocationObjectStorageFederatedIdentityExternalIdentityOutputReference;
```
...
```typescript
public readonly externalIdentityInput: IResolvable | DatasyncLocationObjectStorageFederatedIdentityExternalIdentity;
```
...
```typescript
public readonly internalValue: IResolvable | DatasyncLocationObjectStorageFederatedIdentity;
```
