...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/iot_role_aliases
...
export class DataAwsccIotRoleAliases extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIotRoleAliases that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/iot_role_aliases#import import section} in the documentation of this resource for the id to use
