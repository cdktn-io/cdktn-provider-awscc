...
new DataAwsccRoute53GlobalresolverFirewallDomainLists(Construct Scope, string Id, DataAwsccRoute53GlobalresolverFirewallDomainListsConfig Config = null);
```
...
DataAwsccRoute53GlobalresolverFirewallDomainLists.IsConstruct(object X);
```
...
DataAwsccRoute53GlobalresolverFirewallDomainLists.IsTerraformElement(object X);
```
...
DataAwsccRoute53GlobalresolverFirewallDomainLists.IsTerraformDataSource(object X);
```
...
DataAwsccRoute53GlobalresolverFirewallDomainLists.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53GlobalresolverFirewallDomainLists.DataAwsccRoute53GlobalresolverFirewallDomainLists.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53GlobalresolverFirewallDomainLists.DataAwsccRoute53GlobalresolverFirewallDomainLists.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53GlobalresolverFirewallDomainLists.DataAwsccRoute53GlobalresolverFirewallDomainLists.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53GlobalresolverFirewallDomainLists.DataAwsccRoute53GlobalresolverFirewallDomainLists.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53GlobalresolverFirewallDomainLists.DataAwsccRoute53GlobalresolverFirewallDomainLists.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53GlobalresolverFirewallDomainLists.DataAwsccRoute53GlobalresolverFirewallDomainLists.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53GlobalresolverFirewallDomainLists.DataAwsccRoute53GlobalresolverFirewallDomainLists.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
...
new DataAwsccRoute53GlobalresolverFirewallDomainListsConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53GlobalresolverFirewallDomainLists.DataAwsccRoute53GlobalresolverFirewallDomainListsConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53GlobalresolverFirewallDomainLists.DataAwsccRoute53GlobalresolverFirewallDomainListsConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53GlobalresolverFirewallDomainLists.DataAwsccRoute53GlobalresolverFirewallDomainListsConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53GlobalresolverFirewallDomainLists.DataAwsccRoute53GlobalresolverFirewallDomainListsConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53GlobalresolverFirewallDomainLists.DataAwsccRoute53GlobalresolverFirewallDomainListsConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53GlobalresolverFirewallDomainLists.DataAwsccRoute53GlobalresolverFirewallDomainListsConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53GlobalresolverFirewallDomainLists.DataAwsccRoute53GlobalresolverFirewallDomainListsConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
