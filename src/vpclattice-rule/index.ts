...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/vpclattice_rule
...
export class VpclatticeRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VpclatticeRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/vpclattice_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/vpclattice_rule awscc_vpclattice_rule} Resource
  *
  * @param scope The scope in which to define this construct
