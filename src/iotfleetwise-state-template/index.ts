...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/iotfleetwise_state_template
...
export class IotfleetwiseStateTemplate extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotfleetwiseStateTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/iotfleetwise_state_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/iotfleetwise_state_template awscc_iotfleetwise_state_template} Resource
  *
  * @param scope The scope in which to define this construct
