...
```typescript
import { dataAwsccRtbfabricResponderGateways } from '@cdktn/provider-awscc'

new dataAwsccRtbfabricResponderGateways.DataAwsccRtbfabricResponderGateways(scope: Construct, id: string, config?: DataAwsccRtbfabricResponderGatewaysConfig)
```
...
dataAwsccRtbfabricResponderGateways.DataAwsccRtbfabricResponderGateways.isConstruct(x: any)
```
...
dataAwsccRtbfabricResponderGateways.DataAwsccRtbfabricResponderGateways.isTerraformElement(x: any)
```
...
dataAwsccRtbfabricResponderGateways.DataAwsccRtbfabricResponderGateways.isTerraformDataSource(x: any)
```
...
dataAwsccRtbfabricResponderGateways.DataAwsccRtbfabricResponderGateways.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRtbfabricResponderGateways.DataAwsccRtbfabricResponderGateways.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRtbfabricResponderGateways.DataAwsccRtbfabricResponderGateways.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRtbfabricResponderGateways.DataAwsccRtbfabricResponderGateways.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRtbfabricResponderGateways.DataAwsccRtbfabricResponderGateways.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRtbfabricResponderGateways.DataAwsccRtbfabricResponderGateways.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccRtbfabricResponderGatewaysConfig: dataAwsccRtbfabricResponderGateways.DataAwsccRtbfabricResponderGatewaysConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRtbfabricResponderGateways.DataAwsccRtbfabricResponderGatewaysConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRtbfabricResponderGateways.DataAwsccRtbfabricResponderGatewaysConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRtbfabricResponderGateways.DataAwsccRtbfabricResponderGatewaysConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRtbfabricResponderGateways.DataAwsccRtbfabricResponderGatewaysConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
