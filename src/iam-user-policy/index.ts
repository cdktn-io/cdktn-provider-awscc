...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/iam_user_policy
...
export class IamUserPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IamUserPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/iam_user_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/iam_user_policy awscc_iam_user_policy} Resource
  *
  * @param scope The scope in which to define this construct
