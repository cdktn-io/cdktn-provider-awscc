...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/iam_oidc_providers
...
export class DataAwsccIamOidcProviders extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIamOidcProviders that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/iam_oidc_providers#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/iam_oidc_providers awscc_iam_oidc_providers} Data Source
  *
  * @param scope The scope in which to define this construct
