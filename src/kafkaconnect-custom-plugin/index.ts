...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/kafkaconnect_custom_plugin
...
export class KafkaconnectCustomPlugin extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing KafkaconnectCustomPlugin that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/kafkaconnect_custom_plugin#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/kafkaconnect_custom_plugin awscc_kafkaconnect_custom_plugin} Resource
  *
  * @param scope The scope in which to define this construct
