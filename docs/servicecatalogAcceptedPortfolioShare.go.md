...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/servicecatalogacceptedportfolioshare"

servicecatalogacceptedportfolioshare.NewServicecatalogAcceptedPortfolioShare(scope Construct, id *string, config ServicecatalogAcceptedPortfolioShareConfig) ServicecatalogAcceptedPortfolioShare
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.servicecatalogAcceptedPortfolioShare.ServicecatalogAcceptedPortfolioShare.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
servicecatalogacceptedportfolioshare.ServicecatalogAcceptedPortfolioShare_IsConstruct(x interface{}) *bool
```
...
servicecatalogacceptedportfolioshare.ServicecatalogAcceptedPortfolioShare_IsTerraformElement(x interface{}) *bool
```
...
servicecatalogacceptedportfolioshare.ServicecatalogAcceptedPortfolioShare_IsTerraformResource(x interface{}) *bool
```
...
servicecatalogacceptedportfolioshare.ServicecatalogAcceptedPortfolioShare_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.servicecatalogAcceptedPortfolioShare.ServicecatalogAcceptedPortfolioShare.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.servicecatalogAcceptedPortfolioShare.ServicecatalogAcceptedPortfolioShare.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.servicecatalogAcceptedPortfolioShare.ServicecatalogAcceptedPortfolioShare.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.servicecatalogAcceptedPortfolioShare.ServicecatalogAcceptedPortfolioShare.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.servicecatalogAcceptedPortfolioShare.ServicecatalogAcceptedPortfolioShare.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.servicecatalogAcceptedPortfolioShare.ServicecatalogAcceptedPortfolioShare.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.servicecatalogAcceptedPortfolioShare.ServicecatalogAcceptedPortfolioShare.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.servicecatalogAcceptedPortfolioShare.ServicecatalogAcceptedPortfolioShare.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.servicecatalogAcceptedPortfolioShare.ServicecatalogAcceptedPortfolioShare.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.servicecatalogAcceptedPortfolioShare.ServicecatalogAcceptedPortfolioShare.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.servicecatalogAcceptedPortfolioShare.ServicecatalogAcceptedPortfolioShareConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.servicecatalogAcceptedPortfolioShare.ServicecatalogAcceptedPortfolioShareConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.servicecatalogAcceptedPortfolioShare.ServicecatalogAcceptedPortfolioShareConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.servicecatalogAcceptedPortfolioShare.ServicecatalogAcceptedPortfolioShareConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.servicecatalogAcceptedPortfolioShare.ServicecatalogAcceptedPortfolioShareConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.servicecatalogAcceptedPortfolioShare.ServicecatalogAcceptedPortfolioShareConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.servicecatalogAcceptedPortfolioShare.ServicecatalogAcceptedPortfolioShareConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
