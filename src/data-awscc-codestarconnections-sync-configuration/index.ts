...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/codestarconnections_sync_configuration
...
export class DataAwsccCodestarconnectionsSyncConfiguration extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCodestarconnectionsSyncConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/codestarconnections_sync_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/codestarconnections_sync_configuration awscc_codestarconnections_sync_configuration} Data Source
  *
  * @param scope The scope in which to define this construct
