...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/rds_db_snapshot
...
export interface DataAwsccRdsDbSnapshotConfig extends cdktn.TerraformMetaArguments {
  /**
...
export interface DataAwsccRdsDbSnapshotTags {
}

export function dataAwsccRdsDbSnapshotTagsToTerraform(struct?: DataAwsccRdsDbSnapshotTags): any {
...
export function dataAwsccRdsDbSnapshotTagsToHclTerraform(struct?: DataAwsccRdsDbSnapshotTags): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsccRdsDbSnapshotTagsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAwsccRdsDbSnapshotTags | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsccRdsDbSnapshotTags | undefined) {
    if (value === undefined) {
...
export class DataAwsccRdsDbSnapshotTagsList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataAwsccRdsDbSnapshotTagsOutputReference {
    return new DataAwsccRdsDbSnapshotTagsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
*/
export class DataAwsccRdsDbSnapshot extends cdktn.TerraformDataSource {
  ...
  * @param importToId The construct id used in the generated config for the DataAwsccRdsDbSnapshot to import
  * @param importFromId The id of the existing DataAwsccRdsDbSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/rds_db_snapshot#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAwsccRdsDbSnapshot to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/rds_db_snapshot awscc_rds_db_snapshot} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataAwsccRdsDbSnapshotConfig
  */
  public constructor(scope: Construct, id: string, config: DataAwsccRdsDbSnapshotConfig) {
    super(scope, id, {
  ...
  private _tags = new DataAwsccRdsDbSnapshotTagsList(this, "tags", false);
  public get tags() {
    return this._tags;
  }
