...
new MedialiveSdiSource(Construct Scope, string Id, MedialiveSdiSourceConfig Config);
```
...
```csharp
private void PutTags(IResolvable|MedialiveSdiSourceTags[] Value)
```
...
- *Type:* Io.Cdktn.IResolvable|<a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSourceTags">MedialiveSdiSourceTags</a>[]
...
MedialiveSdiSource.IsConstruct(object X);
```
...
MedialiveSdiSource.IsTerraformElement(object X);
```
...
MedialiveSdiSource.IsTerraformResource(object X);
```
...
MedialiveSdiSource.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSource.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSource.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSource.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSource.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSource.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSource.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSource.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSource.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSource.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSource.property.tagsInput">TagsInput</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSourceTags">MedialiveSdiSourceTags</a>[]</code> | *No description.* |
...
```csharp
public MedialiveSdiSourceTagsList Tags { get; }
```
...
```csharp
public IResolvable|MedialiveSdiSourceTags[] TagsInput { get; }
```
...
new MedialiveSdiSourceConfig {
    ...
    string Type,
    string Mode = null,
    IResolvable|MedialiveSdiSourceTags[] Tags = null
};
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSourceConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSourceConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSourceConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSourceConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSourceConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSourceConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSourceConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSourceConfig.property.tags">Tags</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSourceTags">MedialiveSdiSourceTags</a>[]</code> | A collection of key-value pairs. |
...
```csharp
public IResolvable|MedialiveSdiSourceTags[] Tags { get; set; }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSourceTags.property.key">Key</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/medialive_sdi_source#key MedialiveSdiSource#key}. |
| <code><a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSourceTags.property.value">Value</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/medialive_sdi_source#value MedialiveSdiSource#value}. |
...
new MedialiveSdiSourceTagsList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSourceTagsList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSourceTagsList.resolve.parameter._context"></a>
...
```csharp
private MedialiveSdiSourceTagsOutputReference Get(double Index)
```
...
| <code><a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSourceTagsList.property.internalValue">InternalValue</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSourceTags">MedialiveSdiSourceTags</a>[]</code> | *No description.* |
...
```csharp
public IResolvable|MedialiveSdiSourceTags[] InternalValue { get; }
```
...
new MedialiveSdiSourceTagsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSourceTagsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSourceTagsOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSourceTagsOutputReference.resolve.parameter._context"></a>
...
| <code><a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSourceTagsOutputReference.property.internalValue">InternalValue</a></code> | <code>Io.Cdktn.IResolvable\|<a href="#@cdktn/provider-awscc.medialiveSdiSource.MedialiveSdiSourceTags">MedialiveSdiSourceTags</a></code> | *No description.* |
