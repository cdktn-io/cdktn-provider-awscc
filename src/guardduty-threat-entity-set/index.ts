...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/guardduty_threat_entity_set
...
export class GuarddutyThreatEntitySet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GuarddutyThreatEntitySet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/guardduty_threat_entity_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/guardduty_threat_entity_set awscc_guardduty_threat_entity_set} Resource
  *
  * @param scope The scope in which to define this construct
