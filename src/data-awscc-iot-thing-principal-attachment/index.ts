...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/iot_thing_principal_attachment
...
export interface DataAwsccIotThingPrincipalAttachmentConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataAwsccIotThingPrincipalAttachment extends cdktn.TerraformDataSource {
  ...
  * @param importToId The construct id used in the generated config for the DataAwsccIotThingPrincipalAttachment to import
  * @param importFromId The id of the existing DataAwsccIotThingPrincipalAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/iot_thing_principal_attachment#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAwsccIotThingPrincipalAttachment to import is found
  */
  ...
  * @param options DataAwsccIotThingPrincipalAttachmentConfig
  */
  public constructor(scope: Construct, id: string, config: DataAwsccIotThingPrincipalAttachmentConfig) {
    super(scope, id, {
  ...
  // thing_principal_type - computed: true, optional: false, required: false
