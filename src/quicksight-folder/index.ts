...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/quicksight_folder
...
export class QuicksightFolder extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing QuicksightFolder that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/quicksight_folder#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/quicksight_folder awscc_quicksight_folder} Resource
  *
  * @param scope The scope in which to define this construct
