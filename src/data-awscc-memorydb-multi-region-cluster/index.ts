...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/memorydb_multi_region_cluster
...
export class DataAwsccMemorydbMultiRegionCluster extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccMemorydbMultiRegionCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/memorydb_multi_region_cluster#import import section} in the documentation of this resource for the id to use
