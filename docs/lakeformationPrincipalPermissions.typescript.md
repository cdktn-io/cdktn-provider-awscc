...
```typescript
public readonly catalog: LakeformationPrincipalPermissionsResourceCatalog;
```
...
const lakeformationPrincipalPermissionsResourceCatalog: lakeformationPrincipalPermissions.LakeformationPrincipalPermissionsResourceCatalog = { ... }
```
...
new lakeformationPrincipalPermissions.LakeformationPrincipalPermissionsResourceCatalogOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.lakeformationPrincipalPermissions.LakeformationPrincipalPermissionsResourceCatalogOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public readonly internalValue: IResolvable | LakeformationPrincipalPermissionsResourceCatalog;
```
...
```typescript
public putCatalog(value: LakeformationPrincipalPermissionsResourceCatalog): void
```
...
```typescript
public readonly catalog: LakeformationPrincipalPermissionsResourceCatalogOutputReference;
```
...
```typescript
public readonly catalogInput: IResolvable | LakeformationPrincipalPermissionsResourceCatalog;
```
