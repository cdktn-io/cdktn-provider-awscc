...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/athena_named_query
...
export class DataAwsccAthenaNamedQuery extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccAthenaNamedQuery that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/athena_named_query#import import section} in the documentation of this resource for the id to use
