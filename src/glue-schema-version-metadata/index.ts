...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/glue_schema_version_metadata
...
export class GlueSchemaVersionMetadata extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GlueSchemaVersionMetadata that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/glue_schema_version_metadata#import import section} in the documentation of this resource for the id to use
