...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/lakeformation_tag
...
export class DataAwsccLakeformationTag extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccLakeformationTag that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/lakeformation_tag#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/lakeformation_tag awscc_lakeformation_tag} Data Source
  *
  * @param scope The scope in which to define this construct
