...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/servicecatalogappregistry_applications
...
export class DataAwsccServicecatalogappregistryApplications extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccServicecatalogappregistryApplications that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/servicecatalogappregistry_applications#import import section} in the documentation of this resource for the id to use
