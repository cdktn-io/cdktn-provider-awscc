...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ce_anomaly_subscription
...
export class CeAnomalySubscription extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CeAnomalySubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ce_anomaly_subscription#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ce_anomaly_subscription awscc_ce_anomaly_subscription} Resource
  *
  * @param scope The scope in which to define this construct
