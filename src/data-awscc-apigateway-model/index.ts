...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/apigateway_model
...
export class DataAwsccApigatewayModel extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccApigatewayModel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/apigateway_model#import import section} in the documentation of this resource for the id to use
