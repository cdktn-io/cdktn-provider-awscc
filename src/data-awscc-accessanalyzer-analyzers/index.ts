...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/accessanalyzer_analyzers
...
export class DataAwsccAccessanalyzerAnalyzers extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccAccessanalyzerAnalyzers that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/accessanalyzer_analyzers#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/accessanalyzer_analyzers awscc_accessanalyzer_analyzers} Data Source
  *
  * @param scope The scope in which to define this construct
