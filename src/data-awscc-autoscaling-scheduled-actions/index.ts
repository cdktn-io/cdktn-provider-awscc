...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/autoscaling_scheduled_actions
...
export class DataAwsccAutoscalingScheduledActions extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccAutoscalingScheduledActions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/autoscaling_scheduled_actions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/autoscaling_scheduled_actions awscc_autoscaling_scheduled_actions} Data Source
  *
  * @param scope The scope in which to define this construct
