...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_multi_region_endpoint
...
export class SesMultiRegionEndpoint extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SesMultiRegionEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_multi_region_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_multi_region_endpoint awscc_ses_multi_region_endpoint} Resource
  *
  * @param scope The scope in which to define this construct
