...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/eks_capability
...
export class DataAwsccEksCapability extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEksCapability that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/eks_capability#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/data-sources/eks_capability awscc_eks_capability} Data Source
  *
  * @param scope The scope in which to define this construct
