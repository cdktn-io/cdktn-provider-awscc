...
export class PcaconnectoradTemplate extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PcaconnectoradTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/pcaconnectorad_template#import import section} in the documentation of this resource for the id to use
