...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/datazone_environment_actions
...
export class DataAwsccDatazoneEnvironmentActions extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDatazoneEnvironmentActions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/datazone_environment_actions#import import section} in the documentation of this resource for the id to use
