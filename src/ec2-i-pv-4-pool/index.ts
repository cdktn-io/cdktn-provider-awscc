...
export interface Ec2IPv4PoolConfig extends cdktn.TerraformMetaArguments {
  /**
...
export interface Ec2IPv4PoolTags {
  /**
  * The tag key.
  *
...
export function ec2IPv4PoolTagsToTerraform(struct?: Ec2IPv4PoolTags | cdktn.IResolvable): any {
...
export function ec2IPv4PoolTagsToHclTerraform(struct?: Ec2IPv4PoolTags | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class Ec2IPv4PoolTagsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): Ec2IPv4PoolTags | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: Ec2IPv4PoolTags | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class Ec2IPv4PoolTagsList extends cdktn.ComplexList {
  public internalValue? : Ec2IPv4PoolTags[] | cdktn.IResolvable
  ...
  */
  public get(index: number): Ec2IPv4PoolTagsOutputReference {
    return new Ec2IPv4PoolTagsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class Ec2IPv4Pool extends cdktn.TerraformResource {
  ...
  * @param options Ec2IPv4PoolConfig = {}
  */
  public constructor(scope: Construct, id: string, config: Ec2IPv4PoolConfig = {}) {
    super(scope, id, {
  ...
  private _tags = new Ec2IPv4PoolTagsList(this, "tags", false);
  public get tags() {
    return this._tags;
  }
  public putTags(value: Ec2IPv4PoolTags[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      tags: cdktn.listMapper(ec2IPv4PoolTagsToTerraform, false)(this._tags.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      tags: {
        value: cdktn.listMapperHcl(ec2IPv4PoolTagsToHclTerraform, false)(this._tags.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "Ec2IPv4PoolTagsList",
      },
    };
