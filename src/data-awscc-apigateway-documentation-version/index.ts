...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/apigateway_documentation_version
...
export class DataAwsccApigatewayDocumentationVersion extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccApigatewayDocumentationVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/apigateway_documentation_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/apigateway_documentation_version awscc_apigateway_documentation_version} Data Source
  *
  * @param scope The scope in which to define this construct
