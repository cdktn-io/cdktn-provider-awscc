...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wellarchitected_workload
...
export class WellarchitectedWorkload extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WellarchitectedWorkload that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wellarchitected_workload#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wellarchitected_workload awscc_wellarchitected_workload} Resource
  *
  * @param scope The scope in which to define this construct
