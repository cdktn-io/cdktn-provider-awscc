...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/apigateway_base_path_mapping
...
export class DataAwsccApigatewayBasePathMapping extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccApigatewayBasePathMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/apigateway_base_path_mapping#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/apigateway_base_path_mapping awscc_apigateway_base_path_mapping} Data Source
  *
  * @param scope The scope in which to define this construct
