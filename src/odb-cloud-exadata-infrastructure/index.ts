...
export interface OdbCloudExadataInfrastructureTags {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/odb_cloud_exadata_infrastructure#key OdbCloudExadataInfrastructure#key}
  */
  readonly key?: string;
  /**
...
export class OdbCloudExadataInfrastructure extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OdbCloudExadataInfrastructure that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/odb_cloud_exadata_infrastructure#import import section} in the documentation of this resource for the id to use
