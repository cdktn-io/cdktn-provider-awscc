...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm
...
export interface CloudwatchAlarmConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#actions_enabled CloudwatchAlarm#actions_enabled}
  */
  readonly actionsEnabled?: boolean | cdktn.IResolvable;
  /**
  * The list of actions to execute when this alarm transitions into an ALARM state from any other state. Specify each action as an Amazon Resource Name (ARN). For more information about creating alarms and the actions that you can specify, see [PutMetricAlarm](https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_PutMetricAlarm.html) in the *API Reference*.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#alarm_actions CloudwatchAlarm#alarm_actions}
  */
  readonly alarmActions?: string[];
  /**
  * The description of the alarm.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#alarm_description CloudwatchAlarm#alarm_description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#alarm_name CloudwatchAlarm#alarm_name}
  */
  readonly alarmName?: string;
  /**
  * The arithmetic operation to use when comparing the specified statistic and threshold. The specified statistic value is used as the first operand.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#comparison_operator CloudwatchAlarm#comparison_operator}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#datapoints_to_alarm CloudwatchAlarm#datapoints_to_alarm}
  */
  readonly datapointsToAlarm?: number;
  /**
  * The dimensions for the metric associated with the alarm. For an alarm based on a math expression, you can't specify ``Dimensions``. Instead, you use ``Metrics``.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#dimensions CloudwatchAlarm#dimensions}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#evaluate_low_sample_count_percentile CloudwatchAlarm#evaluate_low_sample_count_percentile}
  */
  readonly evaluateLowSampleCountPercentile?: string;
  /**
  * The evaluation criteria for the alarm.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#evaluation_criteria CloudwatchAlarm#evaluation_criteria}
  */
  readonly evaluationCriteria?: CloudwatchAlarmEvaluationCriteria;
  /**
  * The frequency, in seconds, at which the alarm is evaluated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#evaluation_interval CloudwatchAlarm#evaluation_interval}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#evaluation_periods CloudwatchAlarm#evaluation_periods}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#evaluation_window CloudwatchAlarm#evaluation_window}
  */
  readonly evaluationWindow?: CloudwatchAlarmEvaluationWindow;
  /**
  * The percentile statistic for the metric associated with the alarm. Specify a value between p0.0 and p100.
  *  For an alarm based on a metric, you must specify either ``Statistic`` or ``ExtendedStatistic`` but not both.
  *  For an alarm based on a math expression, you can't specify ``ExtendedStatistic``. Instead, you use ``Metrics``.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#extended_statistic CloudwatchAlarm#extended_statistic}
  */
  readonly extendedStatistic?: string;
  /**
  * The actions to execute when this alarm transitions to the ``INSUFFICIENT_DATA`` state from any other state. Each action is specified as an Amazon Resource Name (ARN).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#insufficient_data_actions CloudwatchAlarm#insufficient_data_actions}
  */
  readonly insufficientDataActions?: string[];
  /**
  * The name of the metric associated with the alarm. This is required for an alarm based on a metric. For an alarm based on a math expression, you use ``Metrics`` instead and you can't specify ``MetricName``.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#metric_name CloudwatchAlarm#metric_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#metrics CloudwatchAlarm#metrics}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#namespace CloudwatchAlarm#namespace}
  */
  readonly namespace?: string;
  /**
  * The actions to execute when this alarm transitions to the ``OK`` state from any other state. Each action is specified as an Amazon Resource Name (ARN).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#ok_actions CloudwatchAlarm#ok_actions}
  */
  ...
  *  *Minimum:* 10
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#period CloudwatchAlarm#period}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#statistic CloudwatchAlarm#statistic}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#tags CloudwatchAlarm#tags}
  */
  readonly tags?: CloudwatchAlarmTags[] | cdktn.IResolvable;
  /**
  * The value to compare with the specified statistic.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#threshold CloudwatchAlarm#threshold}
  */
  readonly threshold?: number;
  /**
  * In an alarm based on an anomaly detection model, this is the ID of the ``ANOMALY_DETECTION_BAND`` function used as the threshold for the alarm.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#threshold_metric_id CloudwatchAlarm#threshold_metric_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#treat_missing_data CloudwatchAlarm#treat_missing_data}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#unit CloudwatchAlarm#unit}
  */
  readonly unit?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#warm_up_configuration CloudwatchAlarm#warm_up_configuration}
  */
  readonly warmUpConfiguration?: CloudwatchAlarmWarmUpConfiguration;
}
export interface CloudwatchAlarmDimensions {
  /**
  * The name of the dimension, from 1–255 characters in length. This dimension name must have been included when the metric was published.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#name CloudwatchAlarm#name}
  */
  readonly name?: string;
  /**
  * The value for the dimension, from 1–255 characters in length.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#value CloudwatchAlarm#value}
  */
...
export interface CloudwatchAlarmEvaluationCriteriaPromQlCriteria {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#pending_period CloudwatchAlarm#pending_period}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#query CloudwatchAlarm#query}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#recovery_period CloudwatchAlarm#recovery_period}
  */
...
export interface CloudwatchAlarmEvaluationCriteria {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#prom_ql_criteria CloudwatchAlarm#prom_ql_criteria}
  */
...
export interface CloudwatchAlarmEvaluationWindowWallClockWindow {
  /**
...
export function cloudwatchAlarmEvaluationWindowWallClockWindowToTerraform(struct?: CloudwatchAlarmEvaluationWindowWallClockWindow | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function cloudwatchAlarmEvaluationWindowWallClockWindowToHclTerraform(struct?: CloudwatchAlarmEvaluationWindowWallClockWindow | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class CloudwatchAlarmEvaluationWindowWallClockWindowOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): CloudwatchAlarmEvaluationWindowWallClockWindow | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: CloudwatchAlarmEvaluationWindowWallClockWindow | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export interface CloudwatchAlarmEvaluationWindow {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#sliding_window CloudwatchAlarm#sliding_window}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#wall_clock_window CloudwatchAlarm#wall_clock_window}
  */
  readonly wallClockWindow?: CloudwatchAlarmEvaluationWindowWallClockWindow;
}

export function cloudwatchAlarmEvaluationWindowToTerraform(struct?: CloudwatchAlarmEvaluationWindow | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    sliding_window: cdktn.stringToTerraform(struct!.slidingWindow),
    wall_clock_window: cloudwatchAlarmEvaluationWindowWallClockWindowToTerraform(struct!.wallClockWindow),
  }
}


export function cloudwatchAlarmEvaluationWindowToHclTerraform(struct?: CloudwatchAlarmEvaluationWindow | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    sliding_window: {
      value: cdktn.stringToHclTerraform(struct!.slidingWindow),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    wall_clock_window: {
      value: cloudwatchAlarmEvaluationWindowWallClockWindowToHclTerraform(struct!.wallClockWindow),
      isBlock: true,
      type: "struct",
      storageClassType: "CloudwatchAlarmEvaluationWindowWallClockWindow",
    },
  };
...
export class CloudwatchAlarmEvaluationWindowOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): CloudwatchAlarmEvaluationWindow | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._slidingWindow !== undefined) {
      hasAnyValues = true;
      internalValueResult.slidingWindow = this._slidingWindow;
    }
    if (this._wallClockWindow?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.wallClockWindow = this._wallClockWindow?.internalValue;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: CloudwatchAlarmEvaluationWindow | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._slidingWindow = undefined;
      this._wallClockWindow.internalValue = undefined;
    }
    else if (cdktn.Tokenization.isResolvable(value)) {
      this.isEmptyObject = false;
      this.resolvableValue = value;
      ...
      this.isEmptyObject = Object.keys(value).length === 0;
      this.resolvableValue = undefined;
      this._slidingWindow = value.slidingWindow;
      this._wallClockWindow.internalValue = value.wallClockWindow;
    }
  }

  // sliding_window - computed: true, optional: true, required: false
  private _slidingWindow?: string; 
  public get slidingWindow() {
    return this.getStringAttribute('sliding_window');
  }
  public set slidingWindow(value: string) {
    this._slidingWindow = value;
  }
  ...
  // wall_clock_window - computed: true, optional: true, required: false
  private _wallClockWindow = new CloudwatchAlarmEvaluationWindowWallClockWindowOutputReference(this, "wall_clock_window");
  public get wallClockWindow() {
    return this._wallClockWindow;
  }
  public putWallClockWindow(value: CloudwatchAlarmEvaluationWindowWallClockWindow) {
    this._wallClockWindow.internalValue = value;
  }
  public resetWallClockWindow() {
    this._wallClockWindow.internalValue = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get wallClockWindowInput() {
    return this._wallClockWindow.internalValue;
  }
}
...
export interface CloudwatchAlarmMetricsMetricStat {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#metric CloudwatchAlarm#metric}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#stat CloudwatchAlarm#stat}
  */
...
export interface CloudwatchAlarmMetrics {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#account_id CloudwatchAlarm#account_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#expression CloudwatchAlarm#expression}
  */
  readonly expression?: string;
  /**
  * A short name used to tie this object to the results in the response. This name must be unique within a single call to ``GetMetricData``. If you are performing math expressions on this set of data, this name represents that data and can serve as a variable in the mathematical expression. The valid characters are letters, numbers, and underscore. The first character must be a lowercase letter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#id CloudwatchAlarm#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#label CloudwatchAlarm#label}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#metric_stat CloudwatchAlarm#metric_stat}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#return_data CloudwatchAlarm#return_data}
  */
...
export interface CloudwatchAlarmTags {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#key CloudwatchAlarm#key}
  */
  readonly key?: string;
  /**
...
export interface CloudwatchAlarmWarmUpConfiguration {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#only_start_evaluating_after_warm_up_period_ends CloudwatchAlarm#only_start_evaluating_after_warm_up_period_ends}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#warm_up_period_duration_in_minutes CloudwatchAlarm#warm_up_period_duration_in_minutes}
  */
  readonly warmUpPeriodDurationInMinutes?: number;
}

export function cloudwatchAlarmWarmUpConfigurationToTerraform(struct?: CloudwatchAlarmWarmUpConfiguration | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function cloudwatchAlarmWarmUpConfigurationToHclTerraform(struct?: CloudwatchAlarmWarmUpConfiguration | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class CloudwatchAlarmWarmUpConfigurationOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): CloudwatchAlarmWarmUpConfiguration | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: CloudwatchAlarmWarmUpConfiguration | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm awscc_cloudwatch_alarm}
*/
export class CloudwatchAlarm extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudwatchAlarm that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_alarm awscc_cloudwatch_alarm} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: CloudwatchAlarmConfig = {}) {
    ...
    this._evaluationWindow.internalValue = config.evaluationWindow;
  ...
  private _evaluationWindow = new CloudwatchAlarmEvaluationWindowOutputReference(this, "evaluation_window");
  public get evaluationWindow() {
    return this._evaluationWindow;
  }
  public putEvaluationWindow(value: CloudwatchAlarmEvaluationWindow) {
  ...
  private _warmUpConfiguration = new CloudwatchAlarmWarmUpConfigurationOutputReference(this, "warm_up_configuration");
  public get warmUpConfiguration() {
    return this._warmUpConfiguration;
  }
  public putWarmUpConfiguration(value: CloudwatchAlarmWarmUpConfiguration) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      evaluation_window: cloudwatchAlarmEvaluationWindowToTerraform(this._evaluationWindow.internalValue),
      ...
      warm_up_configuration: cloudwatchAlarmWarmUpConfigurationToTerraform(this._warmUpConfiguration.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      evaluation_window: {
        value: cloudwatchAlarmEvaluationWindowToHclTerraform(this._evaluationWindow.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "CloudwatchAlarmEvaluationWindow",
      },
      extended_statistic: {
      ...
      warm_up_configuration: {
        value: cloudwatchAlarmWarmUpConfigurationToHclTerraform(this._warmUpConfiguration.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "CloudwatchAlarmWarmUpConfiguration",
      },
    };
