...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_vpn_connection_route
...
export class Ec2VpnConnectionRoute extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2VpnConnectionRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_vpn_connection_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_vpn_connection_route awscc_ec2_vpn_connection_route} Resource
  *
  * @param scope The scope in which to define this construct
