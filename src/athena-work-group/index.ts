...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/athena_work_group
...
export class AthenaWorkGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AthenaWorkGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/athena_work_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/athena_work_group awscc_athena_work_group} Resource
  *
  * @param scope The scope in which to define this construct
