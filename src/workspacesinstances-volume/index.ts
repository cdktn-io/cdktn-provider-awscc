...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/workspacesinstances_volume
...
export class WorkspacesinstancesVolume extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkspacesinstancesVolume that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/workspacesinstances_volume#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/workspacesinstances_volume awscc_workspacesinstances_volume} Resource
  *
  * @param scope The scope in which to define this construct
