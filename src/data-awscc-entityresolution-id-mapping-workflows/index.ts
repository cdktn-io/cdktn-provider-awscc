...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/entityresolution_id_mapping_workflows
...
export class DataAwsccEntityresolutionIdMappingWorkflows extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEntityresolutionIdMappingWorkflows that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/entityresolution_id_mapping_workflows#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/entityresolution_id_mapping_workflows awscc_entityresolution_id_mapping_workflows} Data Source
  *
  * @param scope The scope in which to define this construct
