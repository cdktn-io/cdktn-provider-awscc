...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/logs_delivery
...
export class DataAwsccLogsDelivery extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccLogsDelivery that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/logs_delivery#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/logs_delivery awscc_logs_delivery} Data Source
  *
  * @param scope The scope in which to define this construct
