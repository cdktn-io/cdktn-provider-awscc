...
```typescript
import { dataAwsccWisdomAiPromptVersion } from '@cdktn/provider-awscc'

new dataAwsccWisdomAiPromptVersion.DataAwsccWisdomAiPromptVersion(scope: Construct, id: string, config: DataAwsccWisdomAiPromptVersionConfig)
```
...
dataAwsccWisdomAiPromptVersion.DataAwsccWisdomAiPromptVersion.isConstruct(x: any)
```
...
dataAwsccWisdomAiPromptVersion.DataAwsccWisdomAiPromptVersion.isTerraformElement(x: any)
```
...
dataAwsccWisdomAiPromptVersion.DataAwsccWisdomAiPromptVersion.isTerraformDataSource(x: any)
```
...
dataAwsccWisdomAiPromptVersion.DataAwsccWisdomAiPromptVersion.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWisdomAiPromptVersion.DataAwsccWisdomAiPromptVersion.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWisdomAiPromptVersion.DataAwsccWisdomAiPromptVersion.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWisdomAiPromptVersion.DataAwsccWisdomAiPromptVersion.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccWisdomAiPromptVersion.DataAwsccWisdomAiPromptVersion.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWisdomAiPromptVersion.DataAwsccWisdomAiPromptVersion.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWisdomAiPromptVersion.DataAwsccWisdomAiPromptVersion.property.modifiedTimeSeconds">modifiedTimeSeconds</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccWisdomAiPromptVersion.DataAwsccWisdomAiPromptVersion.property.versionNumber">versionNumber</a></code> | <code>number</code> | *No description.* |
...
const dataAwsccWisdomAiPromptVersionConfig: dataAwsccWisdomAiPromptVersion.DataAwsccWisdomAiPromptVersionConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWisdomAiPromptVersion.DataAwsccWisdomAiPromptVersionConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccWisdomAiPromptVersion.DataAwsccWisdomAiPromptVersionConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccWisdomAiPromptVersion.DataAwsccWisdomAiPromptVersionConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccWisdomAiPromptVersion.DataAwsccWisdomAiPromptVersionConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
