...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/quicksight_template
...
export class DataAwsccQuicksightTemplate extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccQuicksightTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/quicksight_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/quicksight_template awscc_quicksight_template} Data Source
  *
  * @param scope The scope in which to define this construct
