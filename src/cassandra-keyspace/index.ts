...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cassandra_keyspace
...
export class CassandraKeyspace extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CassandraKeyspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cassandra_keyspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cassandra_keyspace awscc_cassandra_keyspace} Resource
  *
  * @param scope The scope in which to define this construct
