...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/kendra_thesaurus
...
export class KendraThesaurus extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing KendraThesaurus that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/kendra_thesaurus#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/kendra_thesaurus awscc_kendra_thesaurus} Resource
  *
  * @param scope The scope in which to define this construct
