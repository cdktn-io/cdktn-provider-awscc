...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/stepfunctions_activity
...
export class StepfunctionsActivity extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing StepfunctionsActivity that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/stepfunctions_activity#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/stepfunctions_activity awscc_stepfunctions_activity} Resource
  *
  * @param scope The scope in which to define this construct
