...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/emr_studio_session_mapping
...
export class DataAwsccEmrStudioSessionMapping extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEmrStudioSessionMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/emr_studio_session_mapping#import import section} in the documentation of this resource for the id to use
