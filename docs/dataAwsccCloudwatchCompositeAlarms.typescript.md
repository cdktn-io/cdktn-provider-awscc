...
Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/cloudwatch_composite_alarms awscc_cloudwatch_composite_alarms}.
...
```typescript
import { dataAwsccCloudwatchCompositeAlarms } from '@cdktn/provider-awscc'

new dataAwsccCloudwatchCompositeAlarms.DataAwsccCloudwatchCompositeAlarms(scope: Construct, id: string, config?: DataAwsccCloudwatchCompositeAlarmsConfig)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchCompositeAlarms.DataAwsccCloudwatchCompositeAlarms.Initializer.parameter.scope">scope</a></code> | <code>constructs.Construct</code> | The scope in which to define this construct. |
...
dataAwsccCloudwatchCompositeAlarms.DataAwsccCloudwatchCompositeAlarms.isConstruct(x: any)
```
...
dataAwsccCloudwatchCompositeAlarms.DataAwsccCloudwatchCompositeAlarms.isTerraformElement(x: any)
```
...
dataAwsccCloudwatchCompositeAlarms.DataAwsccCloudwatchCompositeAlarms.isTerraformDataSource(x: any)
```
...
dataAwsccCloudwatchCompositeAlarms.DataAwsccCloudwatchCompositeAlarms.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/cloudwatch_composite_alarms#import import section} in the documentation of this resource for the id to use
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchCompositeAlarms.DataAwsccCloudwatchCompositeAlarms.property.node">node</a></code> | <code>constructs.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchCompositeAlarms.DataAwsccCloudwatchCompositeAlarms.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchCompositeAlarms.DataAwsccCloudwatchCompositeAlarms.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchCompositeAlarms.DataAwsccCloudwatchCompositeAlarms.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchCompositeAlarms.DataAwsccCloudwatchCompositeAlarms.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchCompositeAlarms.DataAwsccCloudwatchCompositeAlarms.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchCompositeAlarms.DataAwsccCloudwatchCompositeAlarms.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchCompositeAlarms.DataAwsccCloudwatchCompositeAlarms.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
...
const dataAwsccCloudwatchCompositeAlarmsConfig: dataAwsccCloudwatchCompositeAlarms.DataAwsccCloudwatchCompositeAlarmsConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchCompositeAlarms.DataAwsccCloudwatchCompositeAlarmsConfig.property.connection">connection</a></code> | <code>cdktn.SSHProvisionerConnection \| cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchCompositeAlarms.DataAwsccCloudwatchCompositeAlarmsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchCompositeAlarms.DataAwsccCloudwatchCompositeAlarmsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchCompositeAlarms.DataAwsccCloudwatchCompositeAlarmsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchCompositeAlarms.DataAwsccCloudwatchCompositeAlarmsConfig.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchCompositeAlarms.DataAwsccCloudwatchCompositeAlarmsConfig.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudwatchCompositeAlarms.DataAwsccCloudwatchCompositeAlarmsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
