...
```go
func ProxyConfig() DataAwsccTransferServerProtocolDetailsProxyConfigOutputReference
```
...
dataawscctransferserver.NewDataAwsccTransferServerProtocolDetailsProxyConfigOutputReference(terraformResource IInterpolatingParent, terraformAttribute *string) DataAwsccTransferServerProtocolDetailsProxyConfigOutputReference
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccTransferServer.DataAwsccTransferServerProtocolDetailsProxyConfigOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.IInterpolatingParent</code> | The parent resource. |
...
```go
func InternalValue() DataAwsccTransferServerProtocolDetailsProxyConfig
```
