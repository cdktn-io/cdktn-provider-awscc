...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/mpa_identity_source
...
export class MpaIdentitySource extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MpaIdentitySource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/mpa_identity_source#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/mpa_identity_source awscc_mpa_identity_source} Resource
  *
  * @param scope The scope in which to define this construct
