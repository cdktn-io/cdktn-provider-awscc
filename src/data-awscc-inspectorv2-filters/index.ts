...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/inspectorv2_filters
...
export class DataAwsccInspectorv2Filters extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccInspectorv2Filters that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/data-sources/inspectorv2_filters#import import section} in the documentation of this resource for the id to use
