...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/cognito_user_pool_group
...
export class DataAwsccCognitoUserPoolGroup extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCognitoUserPoolGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/cognito_user_pool_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/cognito_user_pool_group awscc_cognito_user_pool_group} Data Source
  *
  * @param scope The scope in which to define this construct
