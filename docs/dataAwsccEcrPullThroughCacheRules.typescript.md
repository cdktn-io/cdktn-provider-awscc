...
```typescript
import { dataAwsccEcrPullThroughCacheRules } from '@cdktn/provider-awscc'

new dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRules(scope: Construct, id: string, config?: DataAwsccEcrPullThroughCacheRulesConfig)
```
...
dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRules.isConstruct(x: any)
```
...
dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRules.isTerraformElement(x: any)
```
...
dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRules.isTerraformDataSource(x: any)
```
...
dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRules.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRules.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRules.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRules.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRules.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRules.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccEcrPullThroughCacheRulesConfig: dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRulesConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRulesConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRulesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRulesConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccEcrPullThroughCacheRules.DataAwsccEcrPullThroughCacheRulesConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
