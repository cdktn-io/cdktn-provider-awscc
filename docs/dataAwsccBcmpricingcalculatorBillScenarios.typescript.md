...
```typescript
import { dataAwsccBcmpricingcalculatorBillScenarios } from '@cdktn/provider-awscc'

new dataAwsccBcmpricingcalculatorBillScenarios.DataAwsccBcmpricingcalculatorBillScenarios(scope: Construct, id: string, config?: DataAwsccBcmpricingcalculatorBillScenariosConfig)
```
...
dataAwsccBcmpricingcalculatorBillScenarios.DataAwsccBcmpricingcalculatorBillScenarios.isConstruct(x: any)
```
...
dataAwsccBcmpricingcalculatorBillScenarios.DataAwsccBcmpricingcalculatorBillScenarios.isTerraformElement(x: any)
```
...
dataAwsccBcmpricingcalculatorBillScenarios.DataAwsccBcmpricingcalculatorBillScenarios.isTerraformDataSource(x: any)
```
...
dataAwsccBcmpricingcalculatorBillScenarios.DataAwsccBcmpricingcalculatorBillScenarios.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBcmpricingcalculatorBillScenarios.DataAwsccBcmpricingcalculatorBillScenarios.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBcmpricingcalculatorBillScenarios.DataAwsccBcmpricingcalculatorBillScenarios.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBcmpricingcalculatorBillScenarios.DataAwsccBcmpricingcalculatorBillScenarios.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBcmpricingcalculatorBillScenarios.DataAwsccBcmpricingcalculatorBillScenarios.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBcmpricingcalculatorBillScenarios.DataAwsccBcmpricingcalculatorBillScenarios.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccBcmpricingcalculatorBillScenariosConfig: dataAwsccBcmpricingcalculatorBillScenarios.DataAwsccBcmpricingcalculatorBillScenariosConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBcmpricingcalculatorBillScenarios.DataAwsccBcmpricingcalculatorBillScenariosConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBcmpricingcalculatorBillScenarios.DataAwsccBcmpricingcalculatorBillScenariosConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBcmpricingcalculatorBillScenarios.DataAwsccBcmpricingcalculatorBillScenariosConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBcmpricingcalculatorBillScenarios.DataAwsccBcmpricingcalculatorBillScenariosConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
