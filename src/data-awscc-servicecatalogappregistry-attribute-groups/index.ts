...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/servicecatalogappregistry_attribute_groups
...
export class DataAwsccServicecatalogappregistryAttributeGroups extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccServicecatalogappregistryAttributeGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/servicecatalogappregistry_attribute_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/servicecatalogappregistry_attribute_groups awscc_servicecatalogappregistry_attribute_groups} Data Source
  *
  * @param scope The scope in which to define this construct
