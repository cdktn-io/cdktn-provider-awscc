...
| <code><a href="#@cdktn/provider-awscc.dataAwsccConnectQueue.DataAwsccConnectQueue.property.lastModifiedTime">LastModifiedTime</a></code> | <code>double</code> | *No description.* |
