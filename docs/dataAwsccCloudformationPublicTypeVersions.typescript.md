...
```typescript
import { dataAwsccCloudformationPublicTypeVersions } from '@cdktn/provider-awscc'

new dataAwsccCloudformationPublicTypeVersions.DataAwsccCloudformationPublicTypeVersions(scope: Construct, id: string, config?: DataAwsccCloudformationPublicTypeVersionsConfig)
```
...
dataAwsccCloudformationPublicTypeVersions.DataAwsccCloudformationPublicTypeVersions.isConstruct(x: any)
```
...
dataAwsccCloudformationPublicTypeVersions.DataAwsccCloudformationPublicTypeVersions.isTerraformElement(x: any)
```
...
dataAwsccCloudformationPublicTypeVersions.DataAwsccCloudformationPublicTypeVersions.isTerraformDataSource(x: any)
```
...
dataAwsccCloudformationPublicTypeVersions.DataAwsccCloudformationPublicTypeVersions.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationPublicTypeVersions.DataAwsccCloudformationPublicTypeVersions.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationPublicTypeVersions.DataAwsccCloudformationPublicTypeVersions.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationPublicTypeVersions.DataAwsccCloudformationPublicTypeVersions.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationPublicTypeVersions.DataAwsccCloudformationPublicTypeVersions.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationPublicTypeVersions.DataAwsccCloudformationPublicTypeVersions.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccCloudformationPublicTypeVersionsConfig: dataAwsccCloudformationPublicTypeVersions.DataAwsccCloudformationPublicTypeVersionsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationPublicTypeVersions.DataAwsccCloudformationPublicTypeVersionsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationPublicTypeVersions.DataAwsccCloudformationPublicTypeVersionsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationPublicTypeVersions.DataAwsccCloudformationPublicTypeVersionsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccCloudformationPublicTypeVersions.DataAwsccCloudformationPublicTypeVersionsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
