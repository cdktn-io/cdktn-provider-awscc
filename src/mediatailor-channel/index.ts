...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/mediatailor_channel
...
export class MediatailorChannel extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MediatailorChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/mediatailor_channel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/mediatailor_channel awscc_mediatailor_channel} Resource
  *
  * @param scope The scope in which to define this construct
