...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/agentregistry_registry
...
export class DataAwsccAgentregistryRegistry extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccAgentregistryRegistry that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/agentregistry_registry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/agentregistry_registry awscc_agentregistry_registry} Data Source
  *
  * @param scope The scope in which to define this construct
