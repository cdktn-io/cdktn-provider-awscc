...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/rolesanywhere_trust_anchor
...
export class RolesanywhereTrustAnchor extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RolesanywhereTrustAnchor that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/rolesanywhere_trust_anchor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/rolesanywhere_trust_anchor awscc_rolesanywhere_trust_anchor} Resource
  *
  * @param scope The scope in which to define this construct
