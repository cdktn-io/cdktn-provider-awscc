...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/simspaceweaver_simulation
...
export class SimspaceweaverSimulation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SimspaceweaverSimulation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/simspaceweaver_simulation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/simspaceweaver_simulation awscc_simspaceweaver_simulation} Resource
  *
  * @param scope The scope in which to define this construct
