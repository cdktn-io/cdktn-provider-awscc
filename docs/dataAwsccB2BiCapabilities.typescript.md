...
```typescript
import { dataAwsccB2BiCapabilities } from '@cdktn/provider-awscc'

new dataAwsccB2BiCapabilities.DataAwsccB2BiCapabilities(scope: Construct, id: string, config?: DataAwsccB2BiCapabilitiesConfig)
```
...
dataAwsccB2BiCapabilities.DataAwsccB2BiCapabilities.isConstruct(x: any)
```
...
dataAwsccB2BiCapabilities.DataAwsccB2BiCapabilities.isTerraformElement(x: any)
```
...
dataAwsccB2BiCapabilities.DataAwsccB2BiCapabilities.isTerraformDataSource(x: any)
```
...
dataAwsccB2BiCapabilities.DataAwsccB2BiCapabilities.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccB2BiCapabilities.DataAwsccB2BiCapabilities.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccB2BiCapabilities.DataAwsccB2BiCapabilities.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccB2BiCapabilities.DataAwsccB2BiCapabilities.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccB2BiCapabilities.DataAwsccB2BiCapabilities.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccB2BiCapabilities.DataAwsccB2BiCapabilities.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccB2BiCapabilitiesConfig: dataAwsccB2BiCapabilities.DataAwsccB2BiCapabilitiesConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccB2BiCapabilities.DataAwsccB2BiCapabilitiesConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccB2BiCapabilities.DataAwsccB2BiCapabilitiesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccB2BiCapabilities.DataAwsccB2BiCapabilitiesConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccB2BiCapabilities.DataAwsccB2BiCapabilitiesConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
