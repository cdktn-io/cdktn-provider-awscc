...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/dms_migration_project
...
export class DmsMigrationProject extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DmsMigrationProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/dms_migration_project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/dms_migration_project awscc_dms_migration_project} Resource
  *
  * @param scope The scope in which to define this construct
