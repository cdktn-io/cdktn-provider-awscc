...
```go
import "github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawscchealthimagingdatastores"

dataawscchealthimagingdatastores.NewDataAwsccHealthimagingDatastores(scope Construct, id *string, config DataAwsccHealthimagingDatastoresConfig) DataAwsccHealthimagingDatastores
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccHealthimagingDatastores.DataAwsccHealthimagingDatastores.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
dataawscchealthimagingdatastores.DataAwsccHealthimagingDatastores_IsConstruct(x interface{}) *bool
```
...
dataawscchealthimagingdatastores.DataAwsccHealthimagingDatastores_IsTerraformElement(x interface{}) *bool
```
...
dataawscchealthimagingdatastores.DataAwsccHealthimagingDatastores_IsTerraformDataSource(x interface{}) *bool
```
...
dataawscchealthimagingdatastores.DataAwsccHealthimagingDatastores_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccHealthimagingDatastores.DataAwsccHealthimagingDatastores.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-awscc.dataAwsccHealthimagingDatastores.DataAwsccHealthimagingDatastores.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccHealthimagingDatastores.DataAwsccHealthimagingDatastores.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccHealthimagingDatastores.DataAwsccHealthimagingDatastores.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccHealthimagingDatastores.DataAwsccHealthimagingDatastores.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccHealthimagingDatastores.DataAwsccHealthimagingDatastores.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccHealthimagingDatastores.DataAwsccHealthimagingDatastores.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccHealthimagingDatastores.DataAwsccHealthimagingDatastores.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
...
&dataawscchealthimagingdatastores.DataAwsccHealthimagingDatastoresConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-awscc.dataAwsccHealthimagingDatastores.DataAwsccHealthimagingDatastoresConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccHealthimagingDatastores.DataAwsccHealthimagingDatastoresConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccHealthimagingDatastores.DataAwsccHealthimagingDatastoresConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccHealthimagingDatastores.DataAwsccHealthimagingDatastoresConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccHealthimagingDatastores.DataAwsccHealthimagingDatastoresConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccHealthimagingDatastores.DataAwsccHealthimagingDatastoresConfig.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccHealthimagingDatastores.DataAwsccHealthimagingDatastoresConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
