...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/shield_proactive_engagement
...
export class ShieldProactiveEngagement extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ShieldProactiveEngagement that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/shield_proactive_engagement#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/shield_proactive_engagement awscc_shield_proactive_engagement} Resource
  *
  * @param scope The scope in which to define this construct
