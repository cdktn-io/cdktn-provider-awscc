...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/omics_sequence_store
...
export interface OmicsSequenceStoreConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/omics_sequence_store#access_log_location OmicsSequenceStore#access_log_location}
  */
  readonly accessLogLocation?: string;
  /**
  * A description for the store.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/omics_sequence_store#description OmicsSequenceStore#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/omics_sequence_store#e_tag_algorithm_family OmicsSequenceStore#e_tag_algorithm_family}
  */
  readonly eTagAlgorithmFamily?: string;
  /**
  * An S3 location that is used to store files that have failed a direct upload.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/omics_sequence_store#fallback_location OmicsSequenceStore#fallback_location}
  */
  readonly fallbackLocation?: string;
  /**
  * A name for the store.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/omics_sequence_store#name OmicsSequenceStore#name}
  */
  readonly name: string;
  /**
  * The tags keys to propagate to the S3 objects associated with read sets in the sequence store.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/omics_sequence_store#propagated_set_level_tags OmicsSequenceStore#propagated_set_level_tags}
  */
  readonly propagatedSetLevelTags?: string[];
  /**
  * The resource policy that controls S3 access on the store
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/omics_sequence_store#s3_access_policy OmicsSequenceStore#s3_access_policy}
  */
  readonly s3AccessPolicy?: string;
  /**
  * Server-side encryption (SSE) settings for a store.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/omics_sequence_store#sse_config OmicsSequenceStore#sse_config}
  */
  readonly sseConfig?: OmicsSequenceStoreSseConfig;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/omics_sequence_store#tags OmicsSequenceStore#tags}
  */
...
export interface OmicsSequenceStoreSseConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/omics_sequence_store#key_arn OmicsSequenceStore#key_arn}
  */
  readonly keyArn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/omics_sequence_store#type OmicsSequenceStore#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/omics_sequence_store awscc_omics_sequence_store}
*/
export class OmicsSequenceStore extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OmicsSequenceStore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/omics_sequence_store#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/omics_sequence_store awscc_omics_sequence_store} Resource
  *
  * @param scope The scope in which to define this construct
