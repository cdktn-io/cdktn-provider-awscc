...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/transcribe_vocabulary_filter
...
export interface DataAwsccTranscribeVocabularyFilterConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/transcribe_vocabulary_filter#id DataAwsccTranscribeVocabularyFilter#id}
  *
...
export class DataAwsccTranscribeVocabularyFilter extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccTranscribeVocabularyFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/data-sources/transcribe_vocabulary_filter#import import section} in the documentation of this resource for the id to use
