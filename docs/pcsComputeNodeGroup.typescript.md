...
```typescript
public readonly gresCustomSettings: IResolvable | {[ key: string ]: string}[];
```
...
```typescript
public resetGresCustomSettings(): void
```
...
| <code><a href="#@cdktn/provider-awscc.pcsComputeNodeGroup.PcsComputeNodeGroupSlurmConfigurationOutputReference.property.gresCustomSettingsInput">gresCustomSettingsInput</a></code> | <code>cdktn.IResolvable \| {[ key: string ]: string}[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.pcsComputeNodeGroup.PcsComputeNodeGroupSlurmConfigurationOutputReference.property.gresCustomSettings">gresCustomSettings</a></code> | <code>cdktn.IResolvable \| {[ key: string ]: string}[]</code> | *No description.* |
...
```typescript
public readonly gresCustomSettingsInput: IResolvable | {[ key: string ]: string}[];
```
