...
```typescript
import { dataAwsccRoute53TrafficPolicies } from '@cdktn/provider-awscc'

new dataAwsccRoute53TrafficPolicies.DataAwsccRoute53TrafficPolicies(scope: Construct, id: string, config?: DataAwsccRoute53TrafficPoliciesConfig)
```
...
dataAwsccRoute53TrafficPolicies.DataAwsccRoute53TrafficPolicies.isConstruct(x: any)
```
...
dataAwsccRoute53TrafficPolicies.DataAwsccRoute53TrafficPolicies.isTerraformElement(x: any)
```
...
dataAwsccRoute53TrafficPolicies.DataAwsccRoute53TrafficPolicies.isTerraformDataSource(x: any)
```
...
dataAwsccRoute53TrafficPolicies.DataAwsccRoute53TrafficPolicies.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53TrafficPolicies.DataAwsccRoute53TrafficPolicies.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53TrafficPolicies.DataAwsccRoute53TrafficPolicies.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53TrafficPolicies.DataAwsccRoute53TrafficPolicies.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53TrafficPolicies.DataAwsccRoute53TrafficPolicies.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53TrafficPolicies.DataAwsccRoute53TrafficPolicies.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccRoute53TrafficPoliciesConfig: dataAwsccRoute53TrafficPolicies.DataAwsccRoute53TrafficPoliciesConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53TrafficPolicies.DataAwsccRoute53TrafficPoliciesConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53TrafficPolicies.DataAwsccRoute53TrafficPoliciesConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53TrafficPolicies.DataAwsccRoute53TrafficPoliciesConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccRoute53TrafficPolicies.DataAwsccRoute53TrafficPoliciesConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
