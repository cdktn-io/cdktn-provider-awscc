...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_security_group_ingress
...
export class Ec2SecurityGroupIngress extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2SecurityGroupIngress that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_security_group_ingress#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_security_group_ingress awscc_ec2_security_group_ingress} Resource
  *
  * @param scope The scope in which to define this construct
