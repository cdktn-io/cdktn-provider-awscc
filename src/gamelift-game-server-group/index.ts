...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/gamelift_game_server_group
...
export class GameliftGameServerGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GameliftGameServerGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/gamelift_game_server_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/gamelift_game_server_group awscc_gamelift_game_server_group} Resource
  *
  * @param scope The scope in which to define this construct
