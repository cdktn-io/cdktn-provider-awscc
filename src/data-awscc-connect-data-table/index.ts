...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/connect_data_table
...
export class DataAwsccConnectDataTable extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccConnectDataTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/connect_data_table#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/connect_data_table awscc_connect_data_table} Data Source
  *
  * @param scope The scope in which to define this construct
