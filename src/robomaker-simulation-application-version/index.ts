...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/robomaker_simulation_application_version
...
export class RobomakerSimulationApplicationVersion extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RobomakerSimulationApplicationVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/robomaker_simulation_application_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/robomaker_simulation_application_version awscc_robomaker_simulation_application_version} Resource
  *
  * @param scope The scope in which to define this construct
