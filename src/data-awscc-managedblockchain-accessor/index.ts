...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/managedblockchain_accessor
...
export class DataAwsccManagedblockchainAccessor extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccManagedblockchainAccessor that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/managedblockchain_accessor#import import section} in the documentation of this resource for the id to use
