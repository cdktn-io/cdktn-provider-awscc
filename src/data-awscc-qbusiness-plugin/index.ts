...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/qbusiness_plugin
...
export class DataAwsccQbusinessPlugin extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccQbusinessPlugin that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/qbusiness_plugin#import import section} in the documentation of this resource for the id to use
