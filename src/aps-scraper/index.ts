...
// https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/aps_scraper
...
export interface ApsScraperDestinationCloudwatchConfiguration {
  /**
...
export function apsScraperDestinationCloudwatchConfigurationToTerraform(struct?: ApsScraperDestinationCloudwatchConfiguration | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function apsScraperDestinationCloudwatchConfigurationToHclTerraform(struct?: ApsScraperDestinationCloudwatchConfiguration | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class ApsScraperDestinationCloudwatchConfigurationOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): ApsScraperDestinationCloudwatchConfiguration | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: ApsScraperDestinationCloudwatchConfiguration | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export interface ApsScraperDestination {
  ...
  */
  readonly cloudwatchConfiguration?: ApsScraperDestinationCloudwatchConfiguration;
}
...
export function apsScraperDestinationToTerraform(struct?: ApsScraperDestination | cdktn.IResolvable): any {
  ...
  return {
    ...
    cloudwatch_configuration: apsScraperDestinationCloudwatchConfigurationToTerraform(struct!.cloudwatchConfiguration),
  }
}
...
export function apsScraperDestinationToHclTerraform(struct?: ApsScraperDestination | cdktn.IResolvable): any {
  ...
  const attrs = {
    ...
    cloudwatch_configuration: {
      value: apsScraperDestinationCloudwatchConfigurationToHclTerraform(struct!.cloudwatchConfiguration),
      isBlock: true,
      type: "struct",
      storageClassType: "ApsScraperDestinationCloudwatchConfiguration",
    },
  };
...
export class ApsScraperDestinationOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _cloudwatchConfiguration = new ApsScraperDestinationCloudwatchConfigurationOutputReference(this, "cloudwatch_configuration");
  public get cloudwatchConfiguration() {
    return this._cloudwatchConfiguration;
  }
  public putCloudwatchConfiguration(value: ApsScraperDestinationCloudwatchConfiguration) {
...
export class ApsScraper extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApsScraper that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/aps_scraper#import import section} in the documentation of this resource for the id to use
