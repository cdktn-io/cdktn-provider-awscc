...
```typescript
import { dataAwsccBillingconductorCustomLineItems } from '@cdktn/provider-awscc'

new dataAwsccBillingconductorCustomLineItems.DataAwsccBillingconductorCustomLineItems(scope: Construct, id: string, config?: DataAwsccBillingconductorCustomLineItemsConfig)
```
...
dataAwsccBillingconductorCustomLineItems.DataAwsccBillingconductorCustomLineItems.isConstruct(x: any)
```
...
dataAwsccBillingconductorCustomLineItems.DataAwsccBillingconductorCustomLineItems.isTerraformElement(x: any)
```
...
dataAwsccBillingconductorCustomLineItems.DataAwsccBillingconductorCustomLineItems.isTerraformDataSource(x: any)
```
...
dataAwsccBillingconductorCustomLineItems.DataAwsccBillingconductorCustomLineItems.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBillingconductorCustomLineItems.DataAwsccBillingconductorCustomLineItems.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBillingconductorCustomLineItems.DataAwsccBillingconductorCustomLineItems.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBillingconductorCustomLineItems.DataAwsccBillingconductorCustomLineItems.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBillingconductorCustomLineItems.DataAwsccBillingconductorCustomLineItems.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBillingconductorCustomLineItems.DataAwsccBillingconductorCustomLineItems.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataAwsccBillingconductorCustomLineItemsConfig: dataAwsccBillingconductorCustomLineItems.DataAwsccBillingconductorCustomLineItemsConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBillingconductorCustomLineItems.DataAwsccBillingconductorCustomLineItemsConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBillingconductorCustomLineItems.DataAwsccBillingconductorCustomLineItemsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-awscc.dataAwsccBillingconductorCustomLineItems.DataAwsccBillingconductorCustomLineItemsConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-awscc.dataAwsccBillingconductorCustomLineItems.DataAwsccBillingconductorCustomLineItemsConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
