...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/dms_replication_task
...
export interface DataAwsccDmsReplicationTaskConfig extends cdktn.TerraformMetaArguments {
  /**
...
export interface DataAwsccDmsReplicationTaskTags {
}

export function dataAwsccDmsReplicationTaskTagsToTerraform(struct?: DataAwsccDmsReplicationTaskTags): any {
...
export function dataAwsccDmsReplicationTaskTagsToHclTerraform(struct?: DataAwsccDmsReplicationTaskTags): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsccDmsReplicationTaskTagsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAwsccDmsReplicationTaskTags | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsccDmsReplicationTaskTags | undefined) {
    if (value === undefined) {
...
export class DataAwsccDmsReplicationTaskTagsList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataAwsccDmsReplicationTaskTagsOutputReference {
    return new DataAwsccDmsReplicationTaskTagsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
*/
export class DataAwsccDmsReplicationTask extends cdktn.TerraformDataSource {
  ...
  * @param importToId The construct id used in the generated config for the DataAwsccDmsReplicationTask to import
  * @param importFromId The id of the existing DataAwsccDmsReplicationTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/dms_replication_task#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAwsccDmsReplicationTask to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/dms_replication_task awscc_dms_replication_task} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataAwsccDmsReplicationTaskConfig
  */
  public constructor(scope: Construct, id: string, config: DataAwsccDmsReplicationTaskConfig) {
    super(scope, id, {
  ...
  // cdc_stop_position - computed: true, optional: false, required: false
  ...
  // replication_task_identifier - computed: true, optional: false, required: false
  ...
  private _tags = new DataAwsccDmsReplicationTaskTagsList(this, "tags", true);
  public get tags() {
    return this._tags;
  }
  ...
  // task_data - computed: true, optional: false, required: false
  public get taskData() {
