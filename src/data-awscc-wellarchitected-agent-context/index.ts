...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/wellarchitected_agent_context
...
export interface DataAwsccWellarchitectedAgentContextConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataAwsccWellarchitectedAgentContext extends cdktn.TerraformDataSource {
  ...
  * @param importToId The construct id used in the generated config for the DataAwsccWellarchitectedAgentContext to import
  * @param importFromId The id of the existing DataAwsccWellarchitectedAgentContext that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/wellarchitected_agent_context#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAwsccWellarchitectedAgentContext to import is found
  */
  ...
  * @param options DataAwsccWellarchitectedAgentContextConfig
  */
  public constructor(scope: Construct, id: string, config: DataAwsccWellarchitectedAgentContextConfig) {
    super(scope, id, {
