...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/connect_routing_profile
...
export class DataAwsccConnectRoutingProfile extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccConnectRoutingProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/connect_routing_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/connect_routing_profile awscc_connect_routing_profile} Data Source
  *
  * @param scope The scope in which to define this construct
