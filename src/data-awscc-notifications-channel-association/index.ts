...
// https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/notifications_channel_association
...
export class DataAwsccNotificationsChannelAssociation extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccNotificationsChannelAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/data-sources/notifications_channel_association#import import section} in the documentation of this resource for the id to use
