...
// https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/servicecatalogappregistry_applications
...
export class DataAwsccServicecatalogappregistryApplications extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccServicecatalogappregistryApplications that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/servicecatalogappregistry_applications#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/servicecatalogappregistry_applications awscc_servicecatalogappregistry_applications} Data Source
  *
  * @param scope The scope in which to define this construct
