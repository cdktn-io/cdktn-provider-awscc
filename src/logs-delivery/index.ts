...
// https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/logs_delivery
...
export class LogsDelivery extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LogsDelivery that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/logs_delivery#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.97.0/docs/resources/logs_delivery awscc_logs_delivery} Resource
  *
  * @param scope The scope in which to define this construct
